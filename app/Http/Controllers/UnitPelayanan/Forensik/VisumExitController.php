...
class VisumExitController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.forensik.pelayanan.visum-exit.index', compact('dataMedis'));
    }
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.forensik.pelayanan.visum-exit.create', compact('dataMedis'));
    }
}
