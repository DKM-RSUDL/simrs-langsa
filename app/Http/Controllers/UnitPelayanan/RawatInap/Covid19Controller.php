...
class Covid19Controller extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.covid-19.index', compact(
            'dataMedis',
            'covidData'
        ));
    }
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.covid-19.create', compact(
            'dataMedis',
            'dokter'
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()
                ->route('rawat-inap.covid-19.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function show(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.covid-19.show', compact(
            'dataMedis',
            'covidData'
        ));
    }
    ...
    public function edit(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.covid-19.edit', compact(
            'dataMedis',
            'covidData'
        ));
    }
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            // Load view untuk PDF
            $pdf = PDF::loadView('unit-pelayanan.rawat-inap.pelayanan.covid-19.print', compact(
                'dataMedis',
                'covidData',
                'dokter'
            ));
