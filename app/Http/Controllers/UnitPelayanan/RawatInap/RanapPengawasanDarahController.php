...
class RanapPengawasanDarahController extends Controller
{
    ...
    private function monitoringTab($dataMedis, $request)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.monitoring', compact(
                'dataMedis',
                'monitoringDarah'
            ));
        } catch (\Exception $e) {
    ...
    private function pengelolaanTab($dataMedis, $request)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.pengelolaan', compact(
                'dataMedis',
                'pengelolaanDarah'
            ));
        } catch (\Exception $e) {
    ...
    public function createPengelolaan(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.pengelolaan.create', compact(
                'dataMedis',
                'dokter',
                'perawat'
    ...
    public function storePengelolaan(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-inap.pengawasan-darah.index', [
                'kd_unit' => $kd_unit,
                'kd_pasien' => $kd_pasien,
                'tgl_masuk' => $tgl_masuk,
    ...
    public function showPengelolaan(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.pengelolaan.show', compact(
                'dataMedis',
                'pengelolaan'
            ));
        } catch (\Exception $e) {
    ...
    public function editPengelolaan(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.pengelolaan.edit', compact(
                'dataMedis',
                'pengelolaan',
                'dokter',
                'perawat'
    ...
    public function createMonitoring(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.monitoring.create', compact(
                'dataMedis',
                'dokter',
                'perawat'
            ));
    ...
    public function editMonitoring(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.monitoring.edit', compact(
                'dataMedis',
                'monitoring',
                'dokter',
                'perawat'
    ...
    public function showMonitoring(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.monitoring.show', compact(
                'dataMedis',
                'monitoring'
            ));
        } catch (\Exception $e) {
    ...
    public function printPengawasanDarah(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        try {
            ...
            // Generate PDF
            $pdf = Pdf::loadView('unit-pelayanan.rawat-inap.pelayanan.pengawasan-darah.print', compact(
                'dataMedis',
                'pengelolaanDarah',
                'monitoringDarah',
                'logoPath'
