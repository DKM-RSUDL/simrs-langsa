...
namespace App\Http\Controllers\UnitPelayanan\RawatInap\StatusNyeri;
...
class SkalaNumerikController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-numerik.index', compact(
            'dataMedis',
            'dataSkalaNumerik'
        ));
    }
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-numerik.create', compact(
            'dataMedis',
            'kualitasnyeri',
            'faktorpemberat',
            'faktorperingan',
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-inap.status-nyeri.skala-numerik.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function show(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-numerik.show', compact(
            'dataMedis',
            'skalaNumerik'
        ));
    }
    ...
    public function edit(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-numerik.edit', compact(
            'dataMedis',
            'skalaNumerik',
            'kualitasnyeri',
            'faktorpemberat',
    ...
    public function update(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-inap.status-nyeri.skala-numerik.show', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id])
