...
class SkalaCriesController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-cries.index', compact(
            'dataMedis',
            'dataSkalaCries'
        ));
    }
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-cries.create', compact(
            'dataMedis',
            'kualitasnyeri',
            'faktorpemberat',
            'faktorperingan',
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-inap.status-nyeri.skala-cries.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function edit(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-cries.edit', compact(
            'dataMedis',
            'skalaCries',
            'kualitasnyeri',
            'faktorpemberat',
    ...
    public function update(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-inap.status-nyeri.skala-cries.show', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id])
    ...
    public function show(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-inap.pelayanan.status-nyeri.skala-cries.show', compact(
            'dataMedis',
            'skalaCries'
        ));
    }
