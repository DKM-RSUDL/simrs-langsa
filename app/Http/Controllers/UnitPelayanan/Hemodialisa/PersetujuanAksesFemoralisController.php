...
use App\Models\RmePersetujuanTindakanFemoralis;
...
class PersetujuanAksesFemoralisController extends Controller
{
    ...
    public function index($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        $dataPersetujuan = RmePersetujuanTindakanFemoralis::with(['dokter', 'userCreated'])
        ...
        return view('unit-pelayanan.hemodialisa.pelayanan.persetujuan.akses-femoralis.index', compact(
            'dataMedis',
            'dataPersetujuan'
        ));
    }
    ...
    public function create($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.hemodialisa.pelayanan.persetujuan.akses-femoralis.create', compact(
            'dataMedis',
            'dokter',
            'karyawan',
        ));
    ...
    public function store(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            $dataHasilLab = new RmePersetujuanTindakanFemoralis();
            ...
            return redirect()->route('hemodialisa.pelayanan.persetujuan.akses-femoralis.index', [$kd_pasien, $tgl_masuk, $urut_masuk])
                ->with('success', 'Data Persetujuan Tindakan Akses Femoralis berhasil disimpan!');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $dataPersetujuan = RmePersetujuanTindakanFemoralis::findOrFail($id);

        $dokter = Dokter::where('status', 1)->get();
        $karyawan = HrdKaryawan::where('status_peg', 1)->get();

        return view('unit-pelayanan.hemodialisa.pelayanan.persetujuan.akses-femoralis.edit', compact(
            'dataMedis',
            'dataPersetujuan',
            'dokter',
            'karyawan'
    ...
    public function update(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        try {
            $dataHasilLab = RmePersetujuanTindakanFemoralis::findOrFail($id);
            ...
            return redirect()->route('hemodialisa.pelayanan.persetujuan.akses-femoralis.index', [$kd_pasien, $tgl_masuk, $urut_masuk])
                ->with('success', 'Data Persetujuan Tindakan Akses Femoralis berhasil diperbarui!');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function destroy($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return redirect()->route('hemodialisa.pelayanan.persetujuan.akses-femoralis.index', [$kd_pasien, $tgl_masuk, $urut_masuk])
                ->with('success', 'Data Persetujuan Tindakan Akses Femoralis berhasil dihapus!');
        } catch (\Exception $e) {
    ...
    public function generatePDF($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $pdf = Pdf::loadView('unit-pelayanan.hemodialisa.pelayanan.persetujuan.akses-femoralis.print', compact(
            'dataMedis',
            'dataPersetujuan',
            'logoPath'
        ));
