...
class LaporanOperasiController extends Controller
{
    public function create($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.operasi.pelayanan.laporan-operatif.laporan-operasi.create', compact('dataMedis', 'jenisAnastesi', 'dokterAnastesi'));
    }
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.operasi.pelayanan.laporan-operatif.laporan-operasi.edit', compact('dataMedis', 'asesmen'));
    }
    ...
    public function show($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.operasi.pelayanan.laporan-operatif.laporan-operasi.show', compact('dataMedis', 'asesmen'));
        } catch (Exception $e) {
