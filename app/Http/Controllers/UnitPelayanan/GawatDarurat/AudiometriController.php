...
class AudiometriController extends Controller
{
    ...
    public function index(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.audiometri.index', compact(
            'dataMedis',
            'dataAudiometri'
        ));
    }
    ...
    public function show($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.audiometri.show', compact(
            'dataMedis',
            'dataAudiometri',
            'acKanan',
            'bcKanan',
    ...
    public function create($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.audiometri.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('audiometri.index', [$kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.audiometri.edit', compact(
            'dataMedis',
            'dataAudiometri',
            'acKanan',
            'bcKanan',
