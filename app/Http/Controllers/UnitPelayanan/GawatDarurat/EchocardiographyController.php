...
class EchocardiographyController extends Controller
{
    ...
    private function getTransaksiData($kd_pasien, $tgl_masuk, $urut_masuk)
    {
    ...
    public function index(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        $transaksi = $this->getTransaksiData( $kd_pasien, $tgl_masuk, $urut_masuk);
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.echocardiography.index', compact(
            'dataMedis',
    ...
    public function create(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.echocardiography.create', compact(
            'dataMedis',
            'dokter'
        ));
    }
    ...
    public function store(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('echocardiography.index', [$kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function show($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.echocardiography.show', compact(
            'dataMedis',
            'echocardiography',
            'dokter'
        ));
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.echocardiography.edit', compact(
            'dataMedis',
            'echocardiography',
            'dokter'
        ));
