...
class PengawasanDarahController extends Controller
{
    ...
    private function monitoringTab($dataMedis, $request)
    {
        try {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.monitoring', compact(
                'dataMedis',
                'monitoringDarah'
            ));
        } catch (\Exception $e) {
    ...
    private function pengelolaanTab($dataMedis, $request)
    {
        try {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.pengelolaan', compact(
                'dataMedis',
                'pengelolaanDarah'
            ));
        } catch (\Exception $e) {
    ...
    public function createPengelolaan(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        try {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.pengelolaan.create', compact(
                'dataMedis',
                'dokter',
                'perawat'
    ...
    public function storePengelolaan(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            $dataMedis = Kunjungan::where('kd_unit', $this->kdUnit)
            ...
            $dataPengelolaan->kd_unit = $this->kdUnit;
            ...
            return redirect()->route('pengawasan-darah.index', [
                'kd_pasien' => $kd_pasien,
                'tgl_masuk' => $tgl_masuk,
    ...
    public function showPengelolaan(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            $dataMedis = Kunjungan::with(['pasien', 'dokter', 'customer', 'unit'])
                ->join('transaksi as t', function ($join) {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.pengelolaan.show', compact(
                'dataMedis',
                'pengelolaan'
            ));
        } catch (\Exception $e) {
    ...
    public function editPengelolaan(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            $dataMedis = Kunjungan::with(['pasien', 'dokter', 'customer', 'unit'])
                ->join('transaksi as t', function ($join) {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.pengelolaan.edit', compact(
                'dataMedis',
                'pengelolaan',
                'dokter',
                'perawat'
    ...
    public function updatePengelolaan(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        DB::beginTransaction();
    ...
    public function destroyPengelolaan(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        DB::beginTransaction();
    ...
    public function createMonitoring(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        try {
            $dataMedis = Kunjungan::with(['pasien', 'dokter', 'customer', 'unit'])
                ->join('transaksi as t', function ($join) {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.monitoring.create', compact(
                'dataMedis',
                'dokter',
                'perawat'
            ));
    ...
    public function storeMonitoring(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        DB::beginTransaction();
        ...
        try {
            ...
            $dataMonitoring->kd_unit = $this->kdUnit;
    ...
    public function editMonitoring(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            $dataMedis = Kunjungan::with(['pasien', 'dokter', 'customer', 'unit'])
                ->join('transaksi as t', function ($join) {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.monitoring.edit', compact(
                'dataMedis',
                'monitoring',
                'dokter',
                'perawat'
    ...
    public function updateMonitoring(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        DB::beginTransaction();
    ...
    public function showMonitoring(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            $dataMedis = Kunjungan::with(['pasien', 'dokter', 'customer', 'unit'])
                ->join('transaksi as t', function ($join) {
            ...
            return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.monitoring.show', compact(
                'dataMedis',
                'monitoring'
            ));
        } catch (\Exception $e) {
    ...
    public function destroyMonitoring(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        DB::beginTransaction();
    ...
    public function printPengawasanDarah(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        try {
            $dataMedis = Kunjungan::with(['pasien', 'dokter', 'customer', 'unit'])
                ->join('transaksi as t', function ($join) {
            ...
            // Generate PDF
            $pdf = Pdf::loadView('unit-pelayanan.gawat-darurat.action-gawat-darurat.pengawasan-darah.print', compact(
                'dataMedis',
                'pengelolaanDarah',
                'monitoringDarah',
                'logoPath'
