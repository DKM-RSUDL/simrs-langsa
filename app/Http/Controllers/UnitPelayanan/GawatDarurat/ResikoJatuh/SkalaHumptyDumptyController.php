...
class SkalaHumptyDumptyController extends Controller
{
    ...
    public function index(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-jatuh.skala-humpty-dumpty.index', compact(
            'dataMedis',
            'dataHumptyDumpty'
        ));
    }
    ...
    public function create($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-jatuh.skala-humpty-dumpty.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('resiko-jatuh.humpty-dumpty.index', [$kd_pasien, $tgl_masuk, $request->urut_masuk])
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-jatuh.skala-humpty-dumpty.edit', compact(
            'dataMedis',
            'dataHumptyDumpty'
        ));
    }
    ...
    public function show($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-jatuh.skala-humpty-dumpty.show', compact(
            'dataMedis',
            'dataHumptyDumpty'
        ));
    }
