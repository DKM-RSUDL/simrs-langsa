...
class PapsController extends Controller
{
    ...
    public function index($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.paps.index', compact(
            'dataMedis',
            'paps'
        ));
    }
    ...
    public function create($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.paps.create', compact('dataMedis', 'dokter'));
    }
    ...
    public function store($kd_pasien, $tgl_masuk, $urut_masuk, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('paps.index', [$kd_pasien, $tgl_masuk, $urut_masuk])->with('success', 'Pernyataan PAPS berhasil di tambah !');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.paps.edit', compact('dataMedis', 'dokter', 'paps'));
    }
    ...
    public function update($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('paps.index', [$kd_pasien, $tgl_masuk, $urut_masuk])->with('success', 'Pernyataan PAPS berhasil di ubah !');
        } catch (Exception $e) {
            DB::rollBack();
            return back()->with('error', $e->getMessage());
        }
    ...
    public function show($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.paps.show', compact('dataMedis', 'dokter', 'paps'));
    }
    ...
    public function pdf($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        $pdf = Pdf::loadView('unit-pelayanan.gawat-darurat.action-gawat-darurat.paps.pdf', compact(
            'dataMedis',
            'paps'
        ))
            ->setPaper('a4', 'potrait');
