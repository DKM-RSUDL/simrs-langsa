...
class PenundaanPelayananController extends Controller
{
    ...
    public function index($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.penundaan.index', compact(
            'dataMedis',
            'penundaan'
        ));
    }
    ...
    public function create($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.penundaan.create', compact('dataMedis', 'dokter'));
    }
    ...
    public function store($kd_pasien, $tgl_masuk, $urut_masuk, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('penundaan.index', [$kd_pasien, $tgl_masuk, $urut_masuk])->with('success', 'Pernyataan penundaan pelayanan berhasil di tambah !');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.penundaan.edit', compact('dataMedis', 'dokter', 'penundaan'));
    }
    ...
    public function update($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('penundaan.index', [$kd_pasien, $tgl_masuk, $urut_masuk])->with('success', 'Pernyataan penundaan pelayanan berhasil di ubah !');
        } catch (Exception $e) {
            DB::rollBack();
            return back()->with('error', $e->getMessage());
        }
    ...
    public function show($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.penundaan.show', compact('dataMedis', 'dokter', 'penundaan'));
    }
    ...
    public function pdf($kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        $pdf = Pdf::loadView('unit-pelayanan.gawat-darurat.action-gawat-darurat.penundaan.pdf', compact(
            'dataMedis',
            'penundaan'
        ))
            ->setPaper('a4', 'potrait');
