...
class MppAController extends Controller
{
    ...
    public function index($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.mpp.form-a.index', compact(
            'dataMedis',
            'kd_pasien',
            'tgl_masuk',
            'urut_masuk',
    ...
    public function create(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.mpp.form-a.create', compact(
            'dataMedis',
            'kd_pasien',
            'tgl_masuk',
            'urut_masuk',
    ...
    public function store(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return redirect()->route('mpp.form-a.index', [
            'kd_unit' => $this->kdUnit,
            'kd_pasien' => $kd_pasien,
            'tgl_masuk' => $tgl_masuk,
            'urut_masuk' => $urut_masuk
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.mpp.form-a.edit', compact(
            'dataMedis',
            'kd_pasien',
            'tgl_masuk',
            'urut_masuk',
    ...
    public function print($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $pdf = Pdf::loadView('unit-pelayanan.gawat-darurat.action-gawat-darurat.mpp.form-a.print', compact(
            'dataMedis',
            'mppData',
            'dpjpUtama',
            'dpjpTambahan',
