...
class ResikoDecubitusController extends Controller
{
    ...
    public function index(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-decubitus.index', compact(
            'dataMedis',
            'dataDecubitus'
        ));
    }
    ...
    public function create($kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-decubitus.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            $dataDecubitus->kd_unit = $this->kdUnit;
            ...
            return redirect()->route('resiko-decubitus.index', [
                'kd_unit' => $this->kdUnit,
                'kd_pasien' => $kd_pasien,
                'tgl_masuk' => $tgl_masuk,
    ...
    public function edit($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-decubitus.edit', compact(
            'dataMedis',
            'dataDecubitus'
        ));
    }
    ...
    public function show($kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-decubitus.show', compact(
            'dataMedis',
            'dataDecubitus'
        ));
    }
