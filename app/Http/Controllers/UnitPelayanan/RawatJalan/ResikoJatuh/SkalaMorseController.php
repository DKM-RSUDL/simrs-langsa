...
class SkalaMorseController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-morse.index', compact(
            'dataMedis',
            'skalaMorseData'
        ));
    }
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-morse.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return to_route('rawat-jalan.resiko-jatuh.morse.index', [
                $kd_unit,
                $kd_pasien,
                $tgl_masuk,
                $urut_masuk,
    ...
    public function show(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-morse.show', compact(
            'dataMedis',
            'skalaMorse'
        ));
    }
    ...
    public function edit(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-morse.edit', compact(
            'dataMedis',
            'skalaMorse'
        ));
    }
