...
namespace App\Http\Controllers\UnitPelayanan\RawatJalan\ResikoJatuh;
...
class SkalaHumptyDumptyController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-humpty-dumpty.index', compact(
            'dataMedis',
            'dataHumptyDumpty'
        ));
    }
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-humpty-dumpty.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.resiko-jatuh.humpty-dumpty.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-humpty-dumpty.edit', compact(
            'dataMedis',
            'dataHumptyDumpty'
        ));
    }
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-humpty-dumpty.show', compact(
            'dataMedis',
            'dataHumptyDumpty'
        ));
    }
