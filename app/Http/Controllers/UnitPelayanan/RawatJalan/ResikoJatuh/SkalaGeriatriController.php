...
class SkalaGeriatriController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-geriatri.index', compact(
            'dataMedis',
            'dataGeriatri'
        ));
    }
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-geriatri.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.resiko-jatuh.geriatri.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-geriatri.edit', compact(
            'dataMedis',
            'dataSkalaGeriatri'
        ));
    }
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-geriatri.show', compact(
            'dataMedis',
            'dataGeriatri'
        ));
    }
