...
class MppBController extends Controller
{
    ...
    public function index($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.mpp.form-b.index', compact(
            'dataMedis',
            'kd_unit',
            'kd_pasien',
            'tgl_masuk',
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.mpp.form-b.create', compact(
            'dataMedis',
            'kd_unit',
            'kd_pasien',
            'tgl_masuk',
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return redirect()->route('rawat-jalan.mpp.form-b.index', [
            'kd_unit' => $kd_unit,
            'kd_pasien' => $kd_pasien,
            'tgl_masuk' => $tgl_masuk,
            'urut_masuk' => $urut_masuk
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.mpp.form-b.edit', compact(
            'dataMedis',
            'kd_unit',
            'kd_pasien',
            'tgl_masuk',
    ...
    public function print($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $pdf = Pdf::loadView('unit-pelayanan.rawat-jalan.pelayanan.mpp.form-b.print', compact(
            'dataMedis',
            'mppData',
            'dpjpUtama',
            'dokterTambahan',
