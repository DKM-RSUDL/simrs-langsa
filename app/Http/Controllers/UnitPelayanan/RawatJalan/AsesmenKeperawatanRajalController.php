...
class AsesmenKeperawatanRajalController extends Controller
{
    ...
    public function index($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-keperawatan.create', compact(
            'kd_pasien',
            'tgl_masuk',
            'dataMedis',
            'user',
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-keperawatan.edit', $data);
        } catch (ModelNotFoundException $e) {
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.asesmen-keperawatan.print', [
