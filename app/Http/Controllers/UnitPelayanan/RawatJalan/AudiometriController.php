...
class AudiometriController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.audiometri.index', compact(
            'dataMedis',
            'dataAudiometri'
        ));
    }
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.audiometri.show', compact(
            'dataMedis',
            'dataAudiometri',
            'acKanan',
            'bcKanan',
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.audiometri.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.audiometri.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.audiometri.edit', compact(
            'dataMedis',
            'dataAudiometri',
            'acKanan',
            'bcKanan',
