...
class RajalPernyataandpjpController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.pernyataan-bpjp.index', compact(
            'dataMedis',
            'pernyataanDPJP',
            'dokter'
        ));
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.pernyataan-dpjp.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function show(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.pernyataan-bpjp.show', compact(
            'dataMedis',
            'pernyataanDPJP',
            'dokter'
        ));
    ...
    public function destroy($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return redirect()->route('rawat-jalan.pernyataan-bpjp.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.pernyataan-bpjp.print', [
