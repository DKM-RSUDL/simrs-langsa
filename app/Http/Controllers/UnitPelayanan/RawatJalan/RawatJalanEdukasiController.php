...
class RawatJalanEdukasiController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.edukasi.index', compact(
            'dataMedis',
            'edukasi',
        ));
    }
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.edukasi.create', compact(
            'dataMedis',
            'pendidikan'
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.edukasi.index', [
                $kd_unit,
                $kd_pasien,
                $tgl_masuk,
                $request->urut_masuk,
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.edukasi.show', compact('edukasi', 'pendidikan', 'dataMedis'));
    }
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.edukasi.edit', compact('edukasi', 'pendidikan', 'dataMedis'));
    }
