...
class AsesmenGinekologikController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-ginekologik.create', compact(
            'kd_unit',
            'kd_pasien',
            'tgl_masuk',
            'urut_masuk',
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-ginekologik.show', compact(
                'asesmen',
                'dataMedis',
                'itemFisik'
            ));
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-ginekologik.edit', compact(
                'asesmen',
                'dataMedis',
                'itemFisik'
            ));
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.asesmen-ginekologik.print', [
