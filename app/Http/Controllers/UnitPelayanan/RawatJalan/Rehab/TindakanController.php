...
class TindakanController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.rehab.tindakan.index', compact(
            'dataMedis',
            'tindakan'
        ));
    }
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        $programs = RmeRehabMedikProgramDetail::with(['program', 'produk'])
            ->whereRelation('program', function ($q) use ($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk) {
                $q->where('kd_pasien', $kd_pasien);
                $q->where('kd_unit', $kd_unit);
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.rehab.tindakan.create', compact('dataMedis', 'programs', 'petugas'));
    }
    ...
    public function store($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('rawat-jalan.tindakan-rehab-medik.index', [$kd_unit,$kd_pasien, $tgl_masuk, $urut_masuk])->with('success', 'Tindakan berhasil di tambah !');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.rehab.tindakan.edit', compact('dataMedis', 'programs', 'petugas', 'tindakan'));
    }
