...
class GiziAnakController extends Controller
{
    ...
    private function anakTab($dataMedis, $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.gizi.anak.index', compact(
            'dataMedis',
            'dataPengkajianGizi'
        ));
    }
    ...
    {
        return view('unit-pelayanan.rawat-jalan.pelayanan.gizi.dewasa.index', compact(
            'dataMedis'
        ));
    }
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.gizi.anak.create', compact(
            'kd_unit',
            'kd_pasien',
            'tgl_masuk',
            'urut_masuk',
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->to(url("unit-pelayanan/rawat-jalan/unit/$kd_unit/pelayanan/$kd_pasien/$tgl_masuk/$urut_masuk/gizi/anak"))
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.gizi.anak.edit', compact(
            'kd_unit',
            'kd_pasien',
            'tgl_masuk',
            'urut_masuk',
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.gizi.anak.show', compact(
            'dataPengkajianGizi',
            'dataMedis',
            'alergiPasien',
            'monitoringGizi'
    ...
    public function grafik($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.gizi.anak.grafik', compact(
            'dataPengkajianGizi',
            'dataMedis',
            'monitoringGizi',
            'WhoWeightForAge',
