...
class EWSPasienDewasaController extends Controller
{
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-dewasa.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return to_route('rawat-jalan.ews-pasien-dewasa.index', [
                $kd_unit,
                $kd_pasien,
                $tgl_masuk,
                $urut_masuk,
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-dewasa.show', compact(
            'dataMedis',
            'ewsPasienDewasa'
        ));
    }
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-dewasa.edit', compact(
            'dataMedis',
            'ewsPasienDewasa'
        ));
    }
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-dewasa.print', compact(
            'dataMedis',
            'ewsPasienDewasa',
            'ewsRecords',
            'recordDate'
