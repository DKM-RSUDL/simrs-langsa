...
class RajalPermintaanSecondOpinionController extends Controller
{
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.permintaan-second-opinion.index', compact(
            'dataMedis',
            'dataDokter',
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.permintaan-second-opinion.create',  compact('dataMedis'));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.permintaan-second-opinion.index', [
                'kd_unit' => $kd_unit,
                'kd_pasien' => $kd_pasien,
                'tgl_masuk' => $tgl_masuk,
                'urut_masuk' => $urut_masuk
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.permintaan-second-opinion.show', compact(
            'dataMedis',
            'secondOpinion'
        ));
    }
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.permintaan-second-opinion.edit', compact(
            'dataMedis',
            'secondOpinion'
        ));
    }
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.permintaan-second-opinion.print', compact(
            'dataMedis',
            'secondOpinion'
        ));
