...
class PenundaanPelayananController extends Controller
{
    ...
    public function index($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.penundaan.index', compact(
            'dataMedis',
            'penundaan'
        ));
    }
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.penundaan.create', compact('dataMedis', 'dokter'));
    }
    ...
    public function store($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('rawat-jalan.penundaan.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])->with('success', 'Pernyataan penundaan pelayanan berhasil di tambah !');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.penundaan.edit', compact('dataMedis', 'dokter', 'penundaan'));
    }
    ...
    public function update($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt, Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('rawat-jalan.penundaan.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])->with('success', 'Pernyataan penundaan pelayanan berhasil di ubah !');
        } catch (Exception $e) {
            DB::rollBack();
            return back()->with('error', $e->getMessage());
        }
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.penundaan.show', compact('dataMedis', 'dokter', 'penundaan'));
    }
    ...
    public function pdf($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $idEncrypt)
    {
        ...
        $pdf = Pdf::loadView('unit-pelayanan.rawat-jalan.pelayanan.penundaan.pdf', compact(
            'dataMedis',
            'penundaan'
        ))
            ->setPaper('a4', 'potrait');
