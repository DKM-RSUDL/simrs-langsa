...
class EWSPasienObstetrikController extends Controller
{
    ...
    public function create($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-obstetrik.create', compact(
            'dataMedis',
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return to_route('rawat-jalan.ews-pasien-obstetrik.index', [
                $kd_unit,
                $kd_pasien,
                $tgl_masuk,
                $urut_masuk,
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-obstetrik.show', compact(
            'dataMedis',
            'ewsPsienObstetrik'
        ));
    }
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-obstetrik.edit', compact(
            'dataMedis',
            'ewsPsienObstetrik'
        ));
    }
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.ews-pasien-obstetrik.print', compact(
            'dataMedis',
            'ewsPsienObstetrik',
            'ewsRecords',
            'recordDate'
