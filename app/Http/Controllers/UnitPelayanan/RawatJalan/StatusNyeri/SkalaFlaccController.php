...
class SkalaFlaccController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.status-nyeri.skala-flacc.index', compact(
            'dataMedis',
            'dataSkalaFlacc'
        ));
    }
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.status-nyeri.skala-flacc.create', compact(
            'dataMedis',
            'kualitasnyeri',
            'faktorpemberat',
            'faktorperingan',
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.status-nyeri.skala-flacc.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function edit(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.status-nyeri.skala-flacc.edit', compact(
            'dataMedis',
            'skalaFlacc',
            'kualitasnyeri',
            'faktorpemberat',
    ...
    public function update(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        try {
            ...
            return redirect()->route('rawat-jalan.status-nyeri.skala-flacc.show', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id])
    ...
    public function show(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.status-nyeri.skala-flacc.show', compact(
            'dataMedis',
            'skalaFlacc'
        ));
    }
