...
class AsesmenParuController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-paru.create', [
            'kd_unit' => $kd_unit,
            'kd_pasien' => $kd_pasien,
            'tgl_masuk' => $tgl_masuk,
            ...
            $uploadFile = function ($fieldName) use ($request, &$uploadedFiles, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk) {
                if ($request->hasFile($fieldName)) {
                    try {
                        ...
                        $path = $file->store("uploads/rajal/asesmen-paru/$kd_unit/$kd_pasien/$tgl_masuk/$urut_masuk");
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-paru.show', compact(
                'asesmen',
                'dataMedis',
                'itemFisik',
                'satsetPrognosis'
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            return view('unit-pelayanan.rawat-jalan.pelayanan.asesmen-paru.edit', compact(
                'asesmen',
                'dataMedis',
                'itemFisik',
                'rmeMasterDiagnosis',
                ...
                if ($request->has("delete_$field")) {
                    if ($paruDiagnosisImplementasi->$field) {
                        Storage::disk('public')->delete(
                            "uploads/rajal/asesmen-paru/$kd_unit/$kd_pasien/$tgl_masuk/$urut_masuk/" . $paruDiagnosisImplementasi->$field
                        );
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.asesmen-paru.print', [
