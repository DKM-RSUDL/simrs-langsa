...
class PersetujuanTransfusiDarahController extends Controller
{
    ...
    public function index(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.persetujuan-transfusi-darah.index', compact(
            'dataMedis',
            'persetujuanData',
            'dokter'
        ));
    ...
    public function create(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.persetujuan-transfusi-darah.create', compact(
            'dataMedis',
            'dokter'
        ));
    }
    ...
    public function store(Request $request, $kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        ...
        try {
            ...
            return redirect()
                ->route('rawat-jalan.persetujuan-transfusi-darah.index', [$kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk])
    ...
    public function show($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.persetujuan-transfusi-darah.show', compact(
            'dataMedis',
            'persetujuan',
            'dokter'
        ));
    ...
    public function edit($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.persetujuan-transfusi-darah.edit', compact(
            'dataMedis',
            'persetujuan',
            'dokter'
        ));
    ...
    public function generatePDF($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk, $id)
    {
        try {
            ...
            // Load view untuk PDF
            $pdf = PDF::loadView('unit-pelayanan.rawat-jalan.pelayanan.persetujuan-transfusi-darah.print', compact(
                'dataMedis',
                'persetujuan',
                'dokter'
            ));
