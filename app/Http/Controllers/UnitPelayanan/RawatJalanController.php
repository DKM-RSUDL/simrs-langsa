...
class RawatJalanController extends Controller
{
    ...
    public function rujukAntarRs($kd_unit, $kd_pasien, $tgl_masuk, $urut_masuk)
    {
        $dataMedis = Kunjungan::with(['pasien', 'dokter', 'customer', 'unit'])
        ...
        return view('unit-pelayanan.rawat-jalan.pelayanan.rujuk-antar-rs.index', compact('dataMedis'));
    }
}
