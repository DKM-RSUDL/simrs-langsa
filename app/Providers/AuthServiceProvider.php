...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('is-farmasi', function ($user) {
            // jenis tenaga
            $kdJenisTenaga = $user->karyawan->kd_jenis_tenaga;
            $kdDetailJenisTenaga = $user->karyawan->kd_detail_jenis_tenaga;

            return $kdJenisTenaga == 3 && $kdDetailJenisTenaga == 2;
        });

        Gate::define('is-gizi', function ($user) {
            // jenis tenaga
            $kdJenisTenaga = $user->karyawan->kd_jenis_tenaga;
            $kdDetailJenisTenaga = $user->karyawan->kd_detail_jenis_tenaga;

            return $kdJenisTenaga == 3 && $kdDetailJenisTenaga == 5;
        });
    }
}