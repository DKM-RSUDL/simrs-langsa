...
<div class="mt-2 patient-card">
    ...
    <div class="card-body">
        <ol class="list-group list-group-flush assessment-list">
            ...
            <li class="list-group-item">
                <a href="#status-nyeri" class="text-decoration-none assessment-link">4. Status Nyeri</a>
            </li>
            <li class="list-group-item">
            ...
            <li class="list-group-item">
                <a href="#decubitus" class="text-decoration-none assessment-link">8. Risiko Decubitus</a>
            </li>
            <li class="list-group-item">
                <a href="#statusPsikologis" class="text-decoration-none assessment-link">9. Status Psikologis</a>
            </li>
            <li class="list-group-item">
                <a href="#status-spiritual" class="text-decoration-none assessment-link">10. Status Spiritual</a>
            </li>
            <li class="list-group-item">
                <a href="#status-sosial-ekonomi" class="text-decoration-none assessment-link">11. Status Sosial
                    Ekonomi</a>
            </li>
            <li class="list-group-item">
                <a href="#status-gizi" class="text-decoration-none assessment-link">12. Status Gizi</a>
            </li>
            <li class="list-group-item">
                <a href="#status-fungsional" class="text-decoration-none assessment-link">13. Status Fungsional</a>
            </li>
            <li class="list-group-item">
                <a href="#kebutuhan-edukasi" class="text-decoration-none assessment-link">14. Kebutuhan Edukasi</a>
            </li>
            <li class="list-group-item">
                <a href="#discharge-planning" class="text-decoration-none assessment-link">15. Discharge Planning</a>
            </li>
            <li class="list-group-item">
                <a href="#diagnosis" class="text-decoration-none assessment-link">16. Diagnosis</a>
            </li>
            <li class="list-group-item">
                <a href="#implementasi" class="text-decoration-none assessment-link">17. Implementasi</a>
            </li>
            <li class="list-group-item">
                <a href="#evaluasi" class="text-decoration-none assessment-link">18. Evaluasi</a>
            </li>
        </ol>
    </div>
</div>
