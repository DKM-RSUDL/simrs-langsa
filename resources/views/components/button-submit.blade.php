@props([
    'id' => 'global-button-submit', // default ID
    'type' => 'submit',
    ...
    @push('scripts')
        <script>
            (function() {
                    ...
                    form.addEventListener('submit', function(e) {
                        ...
                        try {
                            ...
                            if (showSpinner) {
                                ...
                                if (t) t.textContent = loadingLabel;
                                else btn.textContent = loadingLabel;
                            }
                        } catch (err) {
                            btn.disabled = true;
                        }
                ...
                // Jaga-jaga untuk elemen dinamis (Inertia/Livewire/Alpine)
