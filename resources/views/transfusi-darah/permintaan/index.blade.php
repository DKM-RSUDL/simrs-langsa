                ...
                <div class="d-flex align-items-center" id="filter-list">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control date" type="text" id="tgl_awal" name="tgl_awal" value=""
                                readonly="" data-table-target="#dataTable">
                            <span class="bg-primary text-light px-3 justify-content-center align-items-center d-flex">
                                <i class="fa-solid fa-arrows-left-right"></i>
                            </span>
                            <input class="form-control date" type="text" id="tgl_akhir" name="tgl_akhir" value=""
                                readonly="" data-table-target="#dataTable">
                        </div>
                    </div>
                </div>
