                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('hemodialisa.pelayanan.persetujuan-transfusi-darah.destroy', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
