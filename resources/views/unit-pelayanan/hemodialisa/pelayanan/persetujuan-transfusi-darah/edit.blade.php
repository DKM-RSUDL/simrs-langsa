...
@include('unit-pelayanan.rawat-inap.pelayanan.persetujuan-transfusi-darah.include-edit')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between">
                <a href="{{ route('hemodialisa.pelayanan.persetujuan-transfusi-darah.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                    class="btn btn-outline-primary mb-3">
                    <i class="ti-arrow-left"></i> Kembali
                </a>
                <div class="d-flex gap-2">
                    <a href="{{ route('hemodialisa.pelayanan.persetujuan-transfusi-darah.show', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $persetujuan->id]) }}"
            ...
            <form id="transfusi_form" method="POST"
                action="{{ route('hemodialisa.pelayanan.persetujuan-transfusi-darah.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $persetujuan->id]) }}">
                @csrf
                @method('PUT')
                ...
                <div class="container-fluid">
                    ...
                    <div class="form-content">
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-4">
                            <a href="{{ route('rawat-inap.persetujuan-transfusi-darah.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
