...
@include('unit-pelayanan.rawat-inap.pelayanan.persetujuan-transfusi-darah.include-create')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="transfusi_form" method="POST"
                action="{{ route('hemodialisa.pelayanan.persetujuan-transfusi-darah.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                @csrf
