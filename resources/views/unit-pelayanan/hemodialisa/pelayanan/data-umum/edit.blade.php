        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Data Umum Hemodialisa',
                    'description' => 'Perbarui data umum medis Hemodialisa dengan mengisi formulir di bawah ini.',
                ])
        ...
        <div class="px-3">
            <div class="section-separator">
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="pj_pekerjaan" id="pj_pekerjaan" value="{{ $dataUmum->pj_pekerjaan }}"
                        class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="px-3">
            <div class="section-separator">
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="frekuensi_hd" id="frekuensi_hd" value="{{ $dataUmum->frekuensi_hd }}"
                        class="form-control">
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="dokter_pengirim" id="dokter_pengirim"
                        value="{{ $dataUmum->dokter_pengirim }}" class="form-control">
                </div>

                <div class="form-row">
                    <label for="asal_rujukan">Asal rujukan</label>
                    <input type="text" name="asal_rujukan" id="asal_rujukan" value="{{ $dataUmum->asal_rujukan }}"
                        class="form-control">
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="penyakit_penyerta" value="{{ $dataUmum->penyakit_penyerta }}"
                        id="penyakit_penyerta" class="form-control">
                </div>
                <div class="text-end">
                    ...
                    alergiDataArray.forEach((item, index) => {
                        ...
                        row.innerHTML = `
                            ...
                            <td>
                                ...
                                <input type="hidden" name="jenis_alergi[]" value="${item.jenis_alergi}">
                                <input type="hidden" name="nama_alergi[]" value="${item.alergen}">
                                <input type="hidden" name="reaksi[]" value="${item.reaksi}">
                                <input type="hidden" name="tingkat_keparahan[]" value="${item.tingkat_keparahan}">
                            </td>
                        `;
                        tbody.appendChild(row);
                    });
