        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Data Umum Hemodialisis',
                ...
                <form id="hemodialisisForm" method="POST"
                    ...
                    <div class="section-separator mt-0">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" name="pasien_no_telpon" id="pasien_no_telpon" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="px-3">
                        <div class="section-separator">
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" name="hd_pertama_kali" id="hd_pertama_kali" class="form-control date"
                                    readonly>
                            </div>

                            <div class="form-row">
                                <label for="mulai_hd_rutin">Mulai HD rutin tanggal</label>
                                <input type="text" name="mulai_hd_rutin" id="mulai_hd_rutin" class="form-control date"
                                    readonly>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" name="dokter_pengirim" id="dokter_pengirim" class="form-control">
                            </div>
