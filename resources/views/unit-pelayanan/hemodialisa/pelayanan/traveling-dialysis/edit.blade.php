                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="diagnosis" name="diagnosis"
                                value="{{ $dataTraveling->diagnosis }}" placeholder="Masukkan diagnosis pasien" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="dialysis_location" name="dialysis_location"
                                value="{{ $dataTraveling->dialysis_location }}" placeholder="Contoh: Home Dialyzed"
                                required>
                        </div>
                    </div>
                            ...
                            <div class="blood-pressure-item">
                                ...
                                <div class="input-with-unit">
                                    <input type="text" class="form-control" name="post_dialysis_bp"
                                        value="{{ $dataTraveling->post_dialysis_bp }}" placeholder="110/70" required>
                                    <span class="unit-label">mmHg</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-unit">
                                        <input type="number" class="form-control" id="dialysate_flow_rate"
                                            name="dialysate_flow_rate" value="{{ $dataTraveling->dialysate_flow_rate }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="type_dialysate" name="type_dialysate"
                                value="{{ $dataTraveling->type_dialysate }}" placeholder="Masukkan jenis dialysate"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="anticoagulant" name="anticoagulant"
                                value="{{ $dataTraveling->anticoagulant }}" placeholder="Contoh: Heparin" required>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-unit">
                                        <input type="number" class="form-control" id="loading_dose" name="loading_dose"
                                            value="{{ $dataTraveling->loading_dose }}" placeholder="Contoh :1000"
                                            required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-unit">
                                        <input type="number" class="form-control" id="maintenance" name="maintenance"
                                            value="{{ $dataTraveling->maintenance }}" placeholder="Contoh : 500"
                                            required>
                                        <span class="unit-label">UI</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-unit">
                                        <input type="number" class="form-control" id="patient_dry_weight"
                                            name="patient_dry_weight" value="{{ $dataTraveling->patient_dry_weight }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-unit">
                                        <input type="number" class="form-control" id="number_run_per_week"
                                            name="number_run_per_week" value="{{ $dataTraveling->number_run_per_week }}">
