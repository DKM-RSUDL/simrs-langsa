        ...
        <div class="col-md-9">
            ...
            <form id="beratBadanForm" method="POST"
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h4 class="header-asesmen">Form Edit Data Traveling Hemodialisis</h4>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <div class="datetime-group">
                                    <div class="datetime-item">
                                        <label>Tanggal</label>
                                        <input type="date" class="form-control" name="date_first_dialysis" value="{{ $dataTraveling->date_first_dialysis ? \Carbon\Carbon::parse($dataTraveling->date_first_dialysis)->format('Y-m-d') : '' }}" required>
                                    </div>
                                    <div class="datetime-item">
                                        <label>Waktu</label>
                                        <input type="time" class="form-control" name="time_first_dialysis" value="{{ $dataTraveling->time_first_dialysis ? \Carbon\Carbon::parse($dataTraveling->time_first_dialysis)->format('H:i') : '' }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="diagnosis" name="diagnosis" value="{{ $dataTraveling->diagnosis }}" placeholder="Masukkan diagnosis pasien" required>
                            </div>

                            <div class="form-group">
                                <label for="dialysis_location" class="form-label">Home Dialyzed or Center Dialyzed</label>
                                <input type="text" class="form-control" id="dialysis_location" name="dialysis_location" value="{{ $dataTraveling->dialysis_location }}" placeholder="Contoh: Home Dialyzed" required>
                            </div>
                        </div>
                            ...
                            <div class="blood-pressure-container">
                                <div class="blood-pressure-item">
                                    ...
                                    <div class="input-with-unit">
                                        <input type="text" class="form-control" name="pre_dialysis_bp" value="{{ $dataTraveling->pre_dialysis_bp }}" placeholder="120/80" required>
                                ...
                                <div class="blood-pressure-item">
                                    ...
                                    <div class="input-with-unit">
                                        <input type="text" class="form-control" name="post_dialysis_bp" value="{{ $dataTraveling->post_dialysis_bp }}" placeholder="110/70" required>
                                        <span class="unit-label">mmHg</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox-group">
                                    ...
                                    <div class="checkbox-item">
                                        <input type="checkbox" id="av_shunt" name="vascular_access[]" value="av_shunt" {{ in_array('av_shunt', $vascularAccess) ? 'checked' : '' }}>
                                        <label>AV Shunt</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" id="cdl" name="vascular_access[]" value="cdl" {{ in_array('cdl', $vascularAccess) ? 'checked' : '' }}>
                                        <label>CDL</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" id="femoral" name="vascular_access[]" value="femoral" {{ in_array('femoral', $vascularAccess) ? 'checked' : '' }}>
                                        <label>Femoral</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox-group">
                                    ...
                                    @endphp
                                    <div class="checkbox-item">
                                        <input type="checkbox" id="f7_hps" name="type_dialyzer[]" value="f7_hps" {{ in_array('f7_hps', $typeDialyzer) ? 'checked' : '' }}>
                                        <label>F7 HPS</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" id="f8_hps" name="type_dialyzer[]" value="f8_hps" {{ in_array('f8_hps', $typeDialyzer) ? 'checked' : '' }}>
                                        <label>F8 HPS</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" id="elisio" name="type_dialyzer[]" value="elisio" {{ in_array('elisio', $typeDialyzer) ? 'checked' : '' }}>
                                        <label>Elisio</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="blood_flow_rate" name="blood_flow_rate" value="{{ $dataTraveling->blood_flow_rate }}" placeholder="250" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="dialysate_flow_rate" name="dialysate_flow_rate" value="{{ $dataTraveling->dialysate_flow_rate }}" placeholder="500" required>
                                            <span class="unit-label">ml/minute</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="type_dialysate" name="type_dialysate" value="{{ $dataTraveling->type_dialysate }}" placeholder="Masukkan jenis dialysate" required>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="anticoagulant" name="anticoagulant" value="{{ $dataTraveling->anticoagulant }}" placeholder="Contoh: Heparin" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="loading_dose" name="loading_dose" value="{{ $dataTraveling->loading_dose }}" placeholder="Contoh :1000" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="maintenance" name="maintenance" value="{{ $dataTraveling->maintenance }}" placeholder="Contoh : 500" required>
                                            <span class="unit-label">UI</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="patient_dry_weight" name="patient_dry_weight" value="{{ $dataTraveling->patient_dry_weight }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="uf_goal" name="uf_goal" value="{{ $dataTraveling->uf_goal }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="uf_rate" name="uf_rate" value="{{ $dataTraveling->uf_rate }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="number_run_per_week" name="number_run_per_week" value="{{ $dataTraveling->number_run_per_week }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="length_dialysis" name="length_dialysis" value="{{ $dataTraveling->length_dialysis }}">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="complication_dialysis" name="complication_dialysis" rows="3" placeholder="Masukkan komplikasi jika ada">{{ $dataTraveling->complication_dialysis }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="w-100">
                                    ...
                                    <input type="hidden" name="alergis" id="alergisInput" value="{{ json_encode($alergiPasien->map(function($item) { return ['jenis_alergi' => $item->jenis_alergi, 'alergen' => $item->nama_alergi, 'reaksi' => $item->reaksi, 'tingkat_keparahan' => $item->tingkat_keparahan]; })) }}">
                                                ...
                                                @if($alergiPasien->count() > 0)
                                                    @foreach($alergiPasien as $alergi)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-danger btn-sm remove-alergi-row">
                                                                    <i class="ti-trash"></i>
                                                                </button>
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <select class="form-control" name="hbsag_result" required>
                                                        ...
                                                        <option value="Non Reactive (-)" {{ $dataTraveling->hbsag_result == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                                        <option value="Reactive (+)" {{ $dataTraveling->hbsag_result == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <input type="date" class="form-control" name="hbsag_date" value="{{ $dataTraveling->hbsag_date ? \Carbon\Carbon::parse($dataTraveling->hbsag_date)->format('Y-m-d') : '' }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <select class="form-control" name="anti_hcv_result" required>
                                                        <option value="">Pilih Hasil</option>
                                                        <option value="Non Reactive (-)" {{ $dataTraveling->anti_hcv_result == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                                        <option value="Reactive (+)" {{ $dataTraveling->anti_hcv_result == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <input type="date" class="form-control" name="anti_hcv_date" value="{{ $dataTraveling->anti_hcv_date ? \Carbon\Carbon::parse($dataTraveling->anti_hcv_date)->format('Y-m-d') : '' }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <select class="form-control" name="anti_hiv_result" required>
                                                        <option value="">Pilih Hasil</option>
                                                        <option value="Non Reactive (-)" {{ $dataTraveling->anti_hiv_result == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                                        <option value="Reactive (+)" {{ $dataTraveling->anti_hiv_result == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                                    </select>
                                                </div>
                                                <div class="col-6">
                                                    <input type="date" class="form-control" name="anti_hiv_date" value="{{ $dataTraveling->anti_hiv_date ? \Carbon\Carbon::parse($dataTraveling->anti_hiv_date)->format('Y-m-d') : '' }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <div id="medication-container">
                                    @php
                                        $medications = $dataTraveling->relevant_clinical_history ? json_decode($dataTraveling->relevant_clinical_history, true) : [['name' => '', 'frequency' => '']];
                                    @endphp
                                    @foreach($medications as $index => $medication)
                                        <div class="medication-item row mb-2">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="medication_name[]" value="{{ $medication['name'] ?? '' }}" placeholder="Nama obat (contoh: Candesartan 8mg)">
                                            </div>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="medication_frequency[]" value="{{ $medication['frequency'] ?? '' }}" placeholder="Frekuensi (contoh: 1 x 1)">
                                            </div>
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-danger btn-sm remove-medication" style="{{ count($medications) <= 1 ? 'display: none;' : '' }}">
                                                    <i class="ti-trash"></i>
                                                </button>
                                            </div>
                                        </div>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
                if (e.target.classList.contains('remove-alergi-row') || e.target.closest('.remove-alergi-row')) {
                    ...
                    if (tbody.children.length === 0) {
                        tbody.innerHTML = '<tr id="no-alergi-row"><td colspan="5" class="text-center text-muted">Tidak ada data alergi</td></tr>';
                    }
                }
            });
