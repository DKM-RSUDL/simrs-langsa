                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_i') is-invalid @enderror" name="lead_i"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_i', $hasilEkg->lead_i) }}</textarea>
                                    @error('lead_i')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_ii') is-invalid @enderror" name="lead_ii"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_ii', $hasilEkg->lead_ii) }}</textarea>
                                    @error('lead_ii')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('lead_iii') is-invalid @enderror" name="lead_iii"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_iii', $hasilEkg->lead_iii) }}</textarea>
                                    @error('lead_iii')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_avr') is-invalid @enderror" name="lead_avr"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_avr', $hasilEkg->lead_avr) }}</textarea>
                                    @error('lead_avr')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_avl') is-invalid @enderror" name="lead_avl"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_avl', $hasilEkg->lead_avl) }}</textarea>
                                    @error('lead_avl')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('lead_avf') is-invalid @enderror" name="lead_avf"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_avf', $hasilEkg->lead_avf) }}</textarea>
                                    @error('lead_avf')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_v1') is-invalid @enderror" name="lead_v1"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_v1', $hasilEkg->lead_v1) }}</textarea>
                                    @error('lead_v1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_v2') is-invalid @enderror" name="lead_v2"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_v2', $hasilEkg->lead_v2) }}</textarea>
                                    @error('lead_v2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control @error('lead_v3') is-invalid @enderror" name="lead_v3"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_v3', $hasilEkg->lead_v3) }}</textarea>
                                    @error('lead_v3')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_v4') is-invalid @enderror" name="lead_v4"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_v4', $hasilEkg->lead_v4) }}</textarea>
                                    @error('lead_v4')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_v5') is-invalid @enderror" name="lead_v5"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_v5', $hasilEkg->lead_v5) }}</textarea>
                                    @error('lead_v5')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('lead_v6') is-invalid @enderror" name="lead_v6"
                                        rows="4" style="min-height: 100px;" disabled>{{ old('lead_v6', $hasilEkg->lead_v6) }}</textarea>
                                    @error('lead_v6')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <textarea
                                            ...
                                            name="diagnosis" rows="10" 
                                            style="min-height: 250px; resize: vertical;" disabled>{{ old('diagnosis', $hasilEkg->diagnosis) }}</textarea>
                                        @error('diagnosis')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row g-3 mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror"
                                            name="tanggal" value="{{ old('tanggal', $hasilEkg->tanggal) }}" required disabled>
                                        @error('tanggal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="time" class="form-control @error('jam') is-invalid @enderror"
                                            name="jam" value="{{ old('jam', $hasilEkg->jam ? date('H:i', strtotime($hasilEkg->jam)) : '') }}" required disabled>
                                        @error('jam')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="kd_dokter" id="dokter_pelaksana" class="form-select select2" disabled>
                                            <option value="">--Pilih--</option>
                                            @foreach ($dokter as $item)
                                                <option value="{{ $item->kd_dokter }}" 
                                                    {{ old('kd_dokter', $hasilEkg->kd_dokter) == $item->kd_dokter ? 'selected' : '' }} disabled>
                                                    {{ $item->nama_lengkap }}
                                                </option>
                                            @endforeach
                                        </select>
...
@push('js')
    <script>
        ...
        document.addEventListener('keydown', function(e) {
            ...
            // Escape to cancel
            if (e.key === 'Escape') {
                window.location.href = "{{ route('hemodialisa.pelayanan.hasil-ekg.show', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $hasilEkg->id]) }}";
            }
        });
