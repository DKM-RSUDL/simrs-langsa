                ...
                <form
                    ...
                    <div class="section-separator">
                        ...
                        <div class="row row-cols-1 row-cols-md-2 g-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[hak_kewajiban_pasien][tgl_reedukasi]" id="tgl_reedukasi_1">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                ...
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[hak_kewajiban_pasien][pasien_nama]" id="pasien_nama_1"
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[identitas_pasien_gelang][edukator_kd]" id="edukator_2">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_2" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[identitas_pasien_gelang][pasien_nama]" id="pasien_nama_2"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="tgl_reedukasi_3" class="form-label">Tgl Rencana
                                                Reedukasi/Redemonstrasi</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[penyebab_gagal_ginjal][tgl_reedukasi]" id="tgl_reedukasi_3">
                                        </div>
                                        <div class="mb-3">
                                            <label for="edukator_3" class="form-label">Edukator</label>
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[penyebab_gagal_ginjal][edukator_kd]" id="edukator_3">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_3" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[penyebab_gagal_ginjal][pasien_nama]" id="pasien_nama_3"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" class="form-control form-control-sm"
                                                name="edukasi[arti_kegunaan_hemodialisis][tgl_jam]" id="tgl_jam_4">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Hasil Verifikasi</label>
                                            <div class="checkbox-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[arti_kegunaan_hemodialisis][edukator_kd]" id="edukator_4">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_4" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[arti_kegunaan_hemodialisis][pasien_nama]" id="pasien_nama_4"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[jumlah_jam_hemodialisis][edukator_kd]" id="edukator_5">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_5" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[jumlah_jam_hemodialisis][pasien_nama]" id="pasien_nama_5"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[kepatuhan_intake_cairan][edukator_kd]" id="edukator_6">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_6" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[kepatuhan_intake_cairan][pasien_nama]" id="pasien_nama_6"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="tgl_reedukasi_7" class="form-label">Tgl Rencana
                                                Reedukasi/Redemonstrasi</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[makanan_tidak_boleh][tgl_reedukasi]" id="tgl_reedukasi_7">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_7" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[makanan_tidak_boleh][pasien_nama]" id="pasien_nama_7"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-header">Cara mengkonsumsi buah-buahan dan sayur-sayuran
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="tgl_reedukasi_8" class="form-label">Tgl Rencana
                                                Reedukasi/Redemonstrasi</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[cara_konsumsi_buah][tgl_reedukasi]" id="tgl_reedukasi_8">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[komplikasi_hemodialisis][edukator_kd]" id="edukator_9">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_9" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[komplikasi_hemodialisis][pasien_nama]" id="pasien_nama_9"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="tgl_reedukasi_10" class="form-label">Tgl Rencana
                                                Reedukasi/Redemonstrasi</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[penyebab_anemis][tgl_reedukasi]" id="tgl_reedukasi_10">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[monitor_tekanan_darah][edukator_kd]" id="edukator_11">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_11" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[monitor_tekanan_darah][pasien_nama]" id="pasien_nama_11"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-header">Kepatuhan pasien dalam menjalani proses
                                        hemodialisis
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="tgl_reedukasi_12" class="form-label">Tgl Rencana
                                                Reedukasi/Redemonstrasi</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[kepatuhan_proses_hd][tgl_reedukasi]" id="tgl_reedukasi_12">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_12" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[kepatuhan_proses_hd][pasien_nama]" id="pasien_nama_12"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="tgl_reedukasi_13" class="form-label">Tgl Rencana
                                                Reedukasi/Redemonstrasi</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[kenaikan_bb_pasien][tgl_reedukasi]" id="tgl_reedukasi_13">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[kualitas_hidup_pasien][edukator_kd]" id="edukator_14">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_14" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[kualitas_hidup_pasien][pasien_nama]" id="pasien_nama_14"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-header">Kegunaan cimino, femoral, double lumen catheter
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[kegunaan_cimino_femoral][edukator_kd]" id="edukator_15">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_15" class="form-label">Pasien/Keluarga <i
                                                    ...
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[kegunaan_cimino_femoral][pasien_nama]" id="pasien_nama_15"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-header">Cara perawatan cimino dan kateter double lumen
                                    </div>
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="tgl_jam_16" class="form-label">Tgl/Jam
                                                Edukasi</label>
                                            <input type="datetime-local" class="form-control form-control-sm"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[cara_perawatan_cimino][edukator_kd]" id="edukator_16">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_16" class="form-label">Pasien/Keluarga
                                                <i class="fas fa-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[cara_perawatan_cimino][pasien_nama]" id="pasien_nama_16"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="tgl_jam_17" class="form-label">Tgl/Jam
                                                Edukasi</label>
                                            <input type="datetime-local" class="form-control form-control-sm"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[kepatuhan_minum_obat][edukator_kd]" id="edukator_17">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_17" class="form-label">Pasien/Keluarga
                                                <i class="fas fa-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[kepatuhan_minum_obat][pasien_nama]" id="pasien_nama_17"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="tgl_jam_18" class="form-label">Tgl/Jam
                                                Edukasi</label>
                                            <input type="datetime-local" class="form-control form-control-sm"
                                        ...
                                        <div class="mb-3">
                                            <label for="tgl_reedukasi_18" class="form-label">Tgl Rencana
                                                Reedukasi/Redemonstrasi</label>
                                            <input type="date" class="form-control form-control-sm"
                                                name="edukasi[cara_cuci_tangan][tgl_reedukasi]" id="tgl_reedukasi_18">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_18" class="form-label">Pasien/Keluarga
                                                <i class="fas fa-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
                                                name="edukasi[cara_cuci_tangan][pasien_nama]" id="pasien_nama_18"
                                                placeholder="Nama Keluarga">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label for="tgl_jam_19" class="form-label">Tgl/Jam
                                                Edukasi</label>
                                            <input type="datetime-local" class="form-control form-control-sm"
                                                name="edukasi[kepatuhan_membawa_rujukan][tgl_jam]" id="tgl_jam_19">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Hasil Verifikasi</label>
                                            <div class="checkbox-group">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="foem-control select2" style="width: 100%"
                                                name="edukasi[kepatuhan_membawa_rujukan][edukator_kd]" id="edukator_19">
                                                <option value="" selected disabled>Pilih Edukator
                                                </option>
                                                @foreach ($perawat as $staff)
                                                    <option value="{{ $staff->kd_karyawan }}">
                                        ...
                                        <div class="mb-3">
                                            <label for="pasien_nama_19" class="form-label">Pasien/Keluarga
                                                <i class="fas fa-info-circle tooltip-icon" data-bs-toggle="tooltip"
                                                    title="Masukkan nama pasien atau anggota keluarga yang menerima edukasi"></i></label>
                                            <input type="text" class="form-control form-control-sm"
