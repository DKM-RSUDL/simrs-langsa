                    ...
                    <div class="card-body">
                        ...
                        <div class="section-separator">
                            ...
                            @php
                                ...
                                // Function untuk mencari data berdasarkan topik atau ID
                                function findDataForTopic($topik, $edukasiData, $emptyTopicData) {
                                    // Cek di data dengan topik yang benar
                                    if (isset($edukasiData[$topik])) {
                                        return $edukasiData[$topik];
                                    }
                                    
                                    // Jika tidak ada, cek di empty topic data (untuk backward compatibility)
                                    // Ini untuk handle data existing yang topiknya masih NULL
                                    if (!empty($emptyTopicData)) {
                                        // Ambil data pertama yang available (bisa disesuaikan logic nya)
                                        foreach ($emptyTopicData as $key => $data) {
                                            return $data; // Return data pertama yang ditemukan
                                            break;
                                        }
                                    }
                            ...
                            <div class="row row-cols-1 row-cols-md-2 g-4">
                                ...
                                @php
                                    // Cari data untuk topik ini
                                    $topicData = findDataForTopic($topik, $edukasiData ?? [], $emptyTopicData ?? []);
                                    $hasData = !is_null($topicData);
                                @endphp
                                <div class="col">
                                    <div class="card h-100">
                                        <div class="card-header {{ $hasData ? 'bg-success text-white' : 'bg-light' }}">
                                            {{ $topik }}
                                            @if($hasData)
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($hasData && isset($topicData['id']))
                                                <input type="hidden" name="edukasi[{{ $topik }}][id]" value="{{ $topicData['id'] }}">
                                            @endif
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="datetime-local" class="form-control form-control-sm"
                                                    ...
                                                    id="tgl_jam_{{ $index + 1 }}"
                                                    value="{{ $hasData && isset($topicData['tgl_jam']) ? $topicData['tgl_jam'] : '' }}">
                                            </div>
                                                ...
                                                <div class="checkbox-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ ($hasData && isset($topicData['hasil_verifikasi']) && $topicData['hasil_verifikasi'] == $hasil) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control form-control-sm"
                                                    ...
                                                    value="{{ $hasData && isset($topicData['tgl_reedukasi']) ? $topicData['tgl_reedukasi'] : '' }}">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2" style="width: 100%"
                                                    ...
                                                    <option value="{{ $staff->kd_karyawan }}"
                                                        {{ ($hasData && isset($topicData['edukator_kd']) && $topicData['edukator_kd'] == $staff->kd_karyawan) ? 'selected' : '' }}>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    ...
                                                    value="{{ $hasData && isset($topicData['pasien_nama']) ? $topicData['pasien_nama'] : '' }}">
                                            </div>
                                            ...
                                            {{-- @if($hasData)
                                                <div class="alert alert-success alert-sm p-2 mt-2">
                                                    <small>
                                                        ...
                                                        Data telah diisi pada: {{ isset($topicData['tgl_jam']) ? \Carbon\Carbon::parse($topicData['tgl_jam'])->format('d/m/Y H:i') : '-' }}
                                                        @if(isset($topicData['edukator_nama']) && $topicData['edukator_nama'])
                                                            <br>Edukator: {{ $topicData['edukator_nama'] }}
                                                        @endif
                                                        <br>ID: {{ $topicData['id'] ?? '-' }}
                                                    </small>
                                                </div>
