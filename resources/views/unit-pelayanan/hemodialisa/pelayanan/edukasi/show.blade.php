        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                <div class="section-separator mt-0">
                            ...
                            @foreach ($perluPenerjemahOptions as $option)
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="perlu_penerjemah"
                                        value="{{ $option['value'] }}" id="penerjemah_{{ strtolower($option['value']) }}"
                    ...
                    @php
                        $bacaTulisOptions = [['value' => '1', 'label' => 'Bisa'], ['value' => '0', 'label' => 'Tidak']];
                    @endphp
                    <div class="form-group">
                            ...
                            @foreach ($bacaTulisOptions as $option)
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="baca_tulis"
                                        value="{{ $option['value'] }}" id="baca_tulis_{{ strtolower($option['value']) }}"
                    ...
                    <div class="form-group">
                        <label class="form-label">Hambatan <i class="fas fa-info-circle tooltip-icon"
                                data-bs-toggle="tooltip" title="Pilih apakah ada hambatan yang dialami pasien"></i></label>
                        <div class="checkbox-group">
                    ...
                    @endphp
                    <div class="form-group">
                        <label class="form-label">Ketersediaan Menerima Edukasi <i class="fas fa-info-circle tooltip-icon"
                                data-bs-toggle="tooltip" title="Apakah pasien bersedia menerima edukasi?"></i></label>
                        <div class="checkbox-group">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="datetime-local" class="form-control form-control-sm"
                                                    ...
                                                    id="tgl_jam_{{ $loop->iteration }}" value="" disabled>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control form-control-sm"
                                                    ...
                                                    id="tgl_reedukasi_{{ $loop->iteration }}" value="" disabled>
                                            </div>
            ...
            hambatanRadios.forEach(radio => {
                radio.addEventListener('change', () => {
                    if (radio.value === '1') {
                        ...
                        document.querySelectorAll('input[name="hambatan[]"]').forEach(cb => cb
                            .checked = false);
                    }
                });
            });
