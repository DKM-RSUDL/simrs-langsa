        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    ...
                    'description' =>
                        'Tambah Data Persetujuan Tindakan Akses Femoralis dengan mengisi formulir di bawah ini.',
                ])
                <form id="consentForm" method="POST"
                    action="{{ route('hemodialisa.pelayanan.persetujuan.akses-femoralis.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                    @csrf
