...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('hemodialisa.pelayanan.persetujuan.akses-femoralis.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" class="btn btn-outline-primary mb-2">
            ...
            <form id="consentForm" method="POST"
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h4 class="header-asesmen">Edit Form Persetujuan Tindakan Akses Femoralis</h4>
                        ...
                        <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%" id="dpjp" name="dpjp">
                                            ...
                                            @foreach ($dokter as $dok)
                                                <option value="{{ $dok->kd_dokter }}" {{ $dataPersetujuan->kd_dokter == $dok->kd_dokter ? 'selected' : '' }}>
                                                    {{ $dok->nama_lengkap }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%" id="pemberi_informasi" name="pemberi_informasi">
                                            ...
                                            <optgroup label="Dokter">
                                                @foreach ($dokter as $dok)
                                                    <option value="dokter_{{ $dok->kd_dokter }}" {{ $dataPersetujuan->kd_karyawan == 'dokter_'.$dok->kd_dokter ? 'selected' : '' }}>
                                                        {{ $dok->nama_lengkap }}
                                                    </option>
                                                @endforeach
                                            </optgroup>
                                            <optgroup label="Perawat/Staff">
                                                @foreach ($karyawan as $staff)
                                                    <option value="karyawan_{{ $staff->kd_karyawan }}" {{ $dataPersetujuan->kd_karyawan == 'karyawan_'.$staff->kd_karyawan ? 'selected' : '' }}>
                            ...
                            <div id="section_pasien" class="form-group" style="display: {{ $dataPersetujuan->tipe_penerima == 'pasien' ? 'block' : 'none' }};">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                            ...
                            <div id="section_keluarga" style="display: {{ $dataPersetujuan->tipe_penerima == 'keluarga' ? 'block' : 'none' }};">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="umur_keluarga" name="umur_keluarga" placeholder="Umur" min="1" max="120" value="{{ $dataPersetujuan->umur_keluarga }}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="jk_keluarga" name="jk_keluarga">
                                                <option value="">Pilih</option>
                                                <option value="Laki-laki" {{ $dataPersetujuan->jk_keluarga == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                                <option value="Perempuan" {{ $dataPersetujuan->jk_keluarga == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status_keluarga" name="status_keluarga">
                                                ...
                                                <option value="saudara_kandung" {{ $dataPersetujuan->status_keluarga == 'saudara_kandung' ? 'selected' : '' }}>Saudara Kandung</option>
                                    ...
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_diagnosis" id="info_diagnosis" value="1" {{ $dataPersetujuan->info_diagnosis ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_dasar_diagnosis" id="info_dasar_diagnosis" value="1" {{ $dataPersetujuan->info_dasar_diagnosis ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_tindakan" id="info_tindakan" value="1" {{ $dataPersetujuan->info_tindakan ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_indikasi" id="info_indikasi" value="1" {{ $dataPersetujuan->info_indikasi ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_tata_cara" id="info_tata_cara" value="1" {{ $dataPersetujuan->info_tata_cara ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_tujuan" id="info_tujuan" value="1" {{ $dataPersetujuan->info_tujuan ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_resiko" id="info_resiko" value="1" {{ $dataPersetujuan->info_resiko ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_prognosis" id="info_prognosis" value="1" {{ $dataPersetujuan->info_prognosis ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_alternatif" id="info_alternatif" value="1" {{ $dataPersetujuan->info_alternatif ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>10. Lain-lain</td>
                                        <td>
                                            <textarea class="form-control" name="info_lain_lain" id="info_lain_lain" rows="2" placeholder="Keterangan tambahan...">{{ $dataPersetujuan->info_lain_lain }}</textarea>
                                        </td>
                                        <td class="checkbox-column">
                                            <div class="checkbox-wrapper">
                                                <input type="checkbox" class="form-check-input" name="info_lain_lain_check" id="info_lain_lain_check" value="1" {{ $dataPersetujuan->info_lain_lain_check ? 'checked' : '' }}>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="keputusan" id="keputusan">
                                            ...
                                            <option value="setuju" {{ $dataPersetujuan->keputusan == 'setuju' ? 'selected' : '' }}>SETUJU</option>
                                            <option value="menolak" {{ $dataPersetujuan->keputusan == 'menolak' ? 'selected' : '' }}>MENOLAK</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
