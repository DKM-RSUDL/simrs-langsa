        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                <form id="consentForm" method="POST"
                    action="{{ route('hemodialisa.pelayanan.persetujuan.akses-femoralis.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $dataPersetujuan->id]) }}">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-section">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="dpjp" class="form-label">DPJP (Dokter Penanggung Jawab
                                                Pelayanan)</label>
                                            <select class="form-control select2" style="width: 100%" id="dpjp"
                                                name="dpjp">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tipe_penerima" name="tipe_penerima">
                                        ...
                                        <option value="pasien"
                                            {{ $dataPersetujuan->tipe_penerima == 'pasien' ? 'selected' : '' }}>Pasien
                                        </option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama_pasien"
                                                    name="nama_pasien" value="{{ $dataMedis->pasien->nama ?? '' }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="umur_pasien"
                                                    name="umur_pasien" value="{{ $dataMedis->pasien->umur ?? '' }}"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="alamat_pasien"
                                                    name="alamat_pasien" value="{{ $dataMedis->pasien->alamat ?? '' }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="umur_keluarga"
                                                    name="umur_keluarga" placeholder="Umur" min="1"
                                                    max="120" value="{{ $dataPersetujuan->umur_keluarga }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                ...
                                <table class="information-table">
                                    ...
                                    <tbody>
                                            ...
                                            <td class="checkbox-column">
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" class="form-check-input"
                                                        name="info_dasar_diagnosis" id="info_dasar_diagnosis"
                                                        value="1"
                                        ...
                                        <tr>
                                            ...
                                            <td>Akses (jalan masuk keluarnya darah) untuk tindakan hemodialisis</td>
                                            <td class="checkbox-column">
                                                <div class="checkbox-wrapper">
                                        ...
                                        <tr>
                                            <td>5. Tata cara</td>
                                            <td>Melakukan penusukan di vena femoralis dengan menggunakan jarum fistula</td>
                                            <td class="checkbox-column">
                                                <div class="checkbox-wrapper">
                                        ...
                                        <tr>
                                            <td>6. Tujuan</td>
                                            <td>Mendapatkan aliran darah yang cukup untuk proses hemodialisis</td>
                                            <td class="checkbox-column">
                                                <div class="checkbox-wrapper">
                                        ...
                                        <tr>
                                            ...
                                            <td>Nyeri, pembengkakan, perdarahan</td>
                                            <td class="checkbox-column">
                                                <div class="checkbox-wrapper">
                                        ...
                                        <tr>
                                            <td>9. Alternatif</td>
                                            <td>Pemasangan kateter double lumen, AV-Shunt</td>
                                            <td class="checkbox-column">
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" class="form-check-input"
                                                        name="info_alternatif" id="info_alternatif" value="1"
                                        ...
                                        <tr>
                                            ...
                                            <td class="checkbox-column">
                                                <div class="checkbox-wrapper">
                                                    <input type="checkbox" class="form-check-input"
                                                        name="info_lain_lain_check" id="info_lain_lain_check"
                                                        value="1"
                            ...
                            <div class="form-section">
                                ...
                                <p style="font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">
                                    ...
                                    <strong>HEMODIALISIS</strong> terhadap: <span id="display_target_pasien"
                                        ...
                                        suami/ istri/ anak/ ayah/ ibu*</span> saya yang bernama: <span
                                        id="display_nama_target"
                                        style="border-bottom: 1px solid #000; min-width: 200px; display: inline-block; margin: 0 5px;">_________________</span>,
