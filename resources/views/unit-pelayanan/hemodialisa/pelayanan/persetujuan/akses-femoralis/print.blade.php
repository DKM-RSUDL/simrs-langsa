...
<head>
    <meta charset="UTF-8">
    <title>Form Persetujuan Tindakan Akses Femoralis</title>
    <style>
        @page {
    ...
    <div class="content-section">
        <table style="width: 100%; margin-bottom: 8px;">
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 70%;"><b>AKSES FEMORALIS</b></td>
            </tr>
            <tr>
                <td>DPJP</td>
                <td>:</td>
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td class="content-cell">Akses Femoralis</td>
                <td class="check-cell">
            ...
            <tr>
                ...
                <td class="content-cell">Akses (jalan masuk keluarnya darah) untuk tindakan hemodialisis</td>
                <td class="check-cell">
            ...
            <tr>
                ...
                <td class="content-cell">Melakukan penusukan di vena femoralis dengan menggunakan jarum fistula</td>
                <td class="check-cell">
            ...
            <tr>
                ...
                <td class="content-cell">Mendapatkan aliran darah yang cukup untuk proses hemodialisis</td>
                <td class="check-cell">
            ...
            <tr>
                ...
                <td class="content-cell">Nyeri, pembengkakan, perdarahan</td>
                <td class="check-cell">
            ...
            <tr>
                ...
                <td class="content-cell">Pemasangan kateter double lumen, AV-Shunt</td>
                <td class="check-cell">
