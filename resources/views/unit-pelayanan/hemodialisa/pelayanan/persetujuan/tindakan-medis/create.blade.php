                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tempat_tgl_lahir_pasien" name="tempat_tgl_lahir_pasien" 
                                                value="{{ ($dataMedis->pasien->tempat_lahir ?? '') . ($dataMedis->pasien->tempat_lahir && $dataMedis->pasien->tgl_lahir ? ', ' : '') . ($dataMedis->pasien->tgl_lahir ? \Carbon\Carbon::parse($dataMedis->pasien->tgl_lahir)->format('d-m-Y') : '') }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tempat_tgl_lahir_keluarga" name="tempat_tgl_lahir_keluarga" placeholder="Contoh: Jakarta, 15-01-1980">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="alamat_keluarga" name="alamat_keluarga" placeholder="Alamat lengkap">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tindakan[]" value="hemodialisis" id="hemodialisis" checked>
                                    <label class="form-check-label" for="hemodialisis">HEMODIALISIS</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tindakan[]" value="akses_vascular_fmoralis" id="akses_vascular_fmoralis" checked>
                                    <label class="form-check-label" for="akses_vascular_fmoralis">AKSES VASCULAR FMORALIS</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tindakan[]" value="akses_vascular_subclavicula" id="akses_vascular_subclavicula" checked>
                                    <label class="form-check-label" for="akses_vascular_subclavicula">AKSES VASCULAR SUBCLAVICULA CATHETER</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tindakan[]" value="akses_vascular_cimino" id="akses_vascular_cimino" checked>
