        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                <form id="consentForm" method="POST"
                    action="{{ route('hemodialisa.pelayanan.persetujuan.tindakan-hd.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $dataPersetujuan->id]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="dpjp" class="form-label">DPJP (Dokter Penanggung Jawab
                                        Pelayanan)</label>
                                    <select class="form-control select2" style="width: 100%" id="dpjp" name="dpjp">
                                        <option value="">Pilih Dokter</option>
                                        @foreach ($dokter as $dok)
                                            <option value="{{ $dok->kd_dokter }}"
                                                {{ $dataPersetujuan->kd_dokter == $dok->kd_dokter ? 'selected' : '' }}>
                                                {{ $dok->nama_lengkap }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%" id="pemberi_informasi"
                                        name="pemberi_informasi">
                                        <option value="">Pilih Dokter/Perawat</option>
                                        <optgroup label="Dokter">
                                            @foreach ($dokter as $dok)
                                                <option value="dokter_{{ $dok->kd_dokter }}"
                                                    {{ $dataPersetujuan->kd_karyawan == 'dokter_' . $dok->kd_dokter ? 'selected' : '' }}>
                                                    {{ $dok->nama_lengkap }}
                                                </option>
                                            @endforeach
                                        </optgroup>
                                        <optgroup label="Perawat/Staff">
                                            @foreach ($karyawan as $staff)
                                                <option value="karyawan_{{ $staff->kd_karyawan }}"
                                                    {{ $dataPersetujuan->kd_karyawan == 'karyawan_' . $staff->kd_karyawan ? 'selected' : '' }}>
                        ...
                        <div id="section_pasien" class="form-group"
                            style="display: {{ $dataPersetujuan->tipe_penerima == 'pasien' ? 'block' : 'none' }};">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        <div id="section_keluarga"
                            style="display: {{ $dataPersetujuan->tipe_penerima == 'keluarga' ? 'block' : 'none' }};">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="nama_keluarga" class="form-label">Nama Keluarga</label>
                                        <input type="text" class="form-control" id="nama_keluarga"
                                            name="nama_keluarga" placeholder="Nama lengkap keluarga"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="umur_keluarga"
                                            name="umur_keluarga" placeholder="Umur" min="1" max="120"
                                            value="{{ $dataPersetujuan->umur_keluarga }}">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="jk_keluarga" name="jk_keluarga">
                                            ...
                                            <option value="Laki-laki"
                                                {{ $dataPersetujuan->jk_keluarga == 'Laki-laki' ? 'selected' : '' }}>
                                                Laki-laki</option>
                                            <option value="Perempuan"
                                                {{ $dataPersetujuan->jk_keluarga == 'Perempuan' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status_keluarga" name="status_keluarga">
                                            ...
                                            <option value="anak"
                                                ...
                                                Anak</option>
                                            <option value="saudara_kandung"
                                                {{ $dataPersetujuan->status_keluarga == 'saudara_kandung' ? 'selected' : '' }}>
                        ...
                        <table class="information-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Penyakit Gagal Ginjal Kronik (PGK/ CKD) stadium V, Acute Kidney Injury
                                        (AKI), Acute on CKD</td>
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_diagnosis"
                                                id="info_diagnosis" value="1"
                                                {{ $dataPersetujuan->info_diagnosis ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_dasar_diagnosis"
                                                id="info_dasar_diagnosis" value="1"
                                                {{ $dataPersetujuan->info_dasar_diagnosis ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_tindakan"
                                                id="info_tindakan" value="1"
                                                {{ $dataPersetujuan->info_tindakan ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>4. Indikasi tindakan</td>
                                    <td>Hypercalemi, Enchephalopaty uremicum, Acidosis Metabolic, Edema paru,
                                        Overhydrasi, Azotemia</td>
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_indikasi"
                                                id="info_indikasi" value="1"
                                                {{ $dataPersetujuan->info_indikasi ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>5. Tata cara</td>
                                    <td>Darah dikeluarkan dari tubuh dan diedarkan menuju tabung (dialyser) di luar
                                        mesin. Selama penyaringan darah terjadi difusi dan ultrafiltrasi</td>
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_tata_cara"
                                                id="info_tata_cara" value="1"
                                                {{ $dataPersetujuan->info_tata_cara ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>6. Tujuan</td>
                                    <td>Mengeluarkan toksin uremic dan mengatur cairan akibat penurunan laju
                                        filtrasi glomerulus</td>
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_tujuan"
                                                id="info_tujuan" value="1"
                                                {{ $dataPersetujuan->info_tujuan ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>7. Resiko/ komplikasi</td>
                                    <td>Hypotensi, kram otot, mual, muntah, sakit kepala, kejang, perdarahan, emboli
                                        udara, gatal-gatal, penurunan kesadaran, kematian</td>
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_resiko"
                                                id="info_resiko" value="1"
                                                {{ $dataPersetujuan->info_resiko ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_prognosis"
                                                id="info_prognosis" value="1"
                                                {{ $dataPersetujuan->info_prognosis ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_alternatif"
                                                id="info_alternatif" value="1"
                                                {{ $dataPersetujuan->info_alternatif ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>10. Lain-lain</td>
                                    <td>
                                        <textarea class="form-control" name="info_lain_lain" id="info_lain_lain" rows="2"
                                            placeholder="Keterangan tambahan...">{{ $dataPersetujuan->info_lain_lain }}</textarea>
                                    </td>
                                    <td class="checkbox-column">
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" class="form-check-input" name="info_lain_lain_check"
                                                id="info_lain_lain_check" value="1"
                                                {{ $dataPersetujuan->info_lain_lain_check ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="form-section">
                        ...
                        <p style="font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">
                            Dengan ini menyatakan bahwa saya, dr.<span id="display_dpjp"
                                style="border-bottom: 1px solid #000; min-width: 200px; display: inline-block; margin: 0 5px;">_________________</span>
                            telah menerangkan hal-hal diatas secara benar dan jelas dan memberikan kesempatan untuk
                            bertanya dan/atau berdiskusi.
                        </p>

                        <p style="font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">
                            Dengan ini menyatakan bahwa saya <span id="display_penerima_info"
                                style="border-bottom: 1px solid #000; min-width: 200px; display: inline-block; margin: 0 5px;">_________________</span>
                            telah menerima informasi sebagaimana di atas dan saya beri tanda/ paraf di kolom
                            kanannya serta telah diberi kesempatan untuk bertanya, berdiskusi dan memahaminya.
                        </p>

                        <p style="font-size: 0.85rem; font-style: italic; margin-bottom: 1.5rem;">
                            <strong>Cat: Apabila pasien tidak kompeten atau tidak mau menerima informasi, maka
                                penerima informasi adalah wali atau keluarga terdekat.</strong>
                        </p>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <p style="font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">
                            Saya yang bertanda tangan di bawah ini, nama: <span id="display_nama_penandatangan"
                                style="border-bottom: 1px solid #000; min-width: 200px; display: inline-block; margin: 0 5px;">_________________</span>,
                            umur: <span id="display_umur_penandatangan"
                                style="border-bottom: 1px solid #000; min-width: 50px; display: inline-block; margin: 0 5px;">____</span>
                            th, jenis kelamin: <span id="display_jk_penandatangan"
                                style="border-bottom: 1px solid #000; min-width: 100px; display: inline-block; margin: 0 5px;">____</span>,
                            alamat: <span id="display_alamat_penandatangan"
                                style="border-bottom: 1px solid #000; min-width: 300px; display: inline-block; margin: 0 5px;">_________________________________</span>,
                        </p>

                        <p style="font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">
                            dengan ini menyatakan <strong>SETUJU/ MENOLAK</strong> dilakukan tindakan
                            <strong>HEMODIALISIS</strong> terhadap: <span id="display_target_pasien"
                                style="border-bottom: 1px solid #000; min-width: 150px; display: inline-block; margin: 0 5px;">saya/
                                suami/ istri/ anak/ ayah/ ibu*</span> saya yang bernama: <span id="display_nama_target"
                                style="border-bottom: 1px solid #000; min-width: 200px; display: inline-block; margin: 0 5px;">_________________</span>,
                            umur: <span id="display_umur_target"
                                style="border-bottom: 1px solid #000; min-width: 50px; display: inline-block; margin: 0 5px;">____</span>
                            th, jenis kelamin: <span id="display_jk_target"
                                style="border-bottom: 1px solid #000; min-width: 100px; display: inline-block; margin: 0 5px;">____</span>
                        </p>

                        <p style="font-size: 0.9rem; line-height: 1.5; margin-bottom: 1rem;">
                            Saya memahami perlunya dan manfaat tindakan tersebut sebagaimana telah dijelaskan kepada
                            saya, termasuk resiko dan komplikasi yang mungkin timbul. Saya juga menyadari bahwa ilmu
                            kedokteran bukanlah ilmu pasti, maka keberhasilan dan kesembuhan sangat bergantung atas
                            izin Tuhan Yang Maha Kuasa.
                        </p>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="keputusan" id="keputusan">
                                        ...
                                        <option value="setuju"
                                            {{ $dataPersetujuan->keputusan == 'setuju' ? 'selected' : '' }}>SETUJU
                                        </option>
                                        <option value="menolak"
                                            {{ $dataPersetujuan->keputusan == 'menolak' ? 'selected' : '' }}>
                                            MENOLAK</option>
                                    </select>
                                </div>
                            </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            // Initialize displays on page load with existing data
            initializeDisplays();
                ...
                if (tipe === 'pasien') {
                    ...
                    switch (statusKeluarga) {
                        ...
                        case 'wali':
                            ...
                            break;
                        default:
                            targetText = statusKeluarga || 'saya';
                    }
            ...
            // Initialize displays with existing data
            function initializeDisplays() {
                // Initialize DPJP display
                const selectedDpjp = $('#dpjp option:selected').text();
                if (selectedDpjp && selectedDpjp !== 'Pilih Dokter') {
                    $('#display_dpjp').text(selectedDpjp);
                }

                // Initialize other displays based on current form state
                updatePenandatangan();
            }

            // Bind update events untuk semua fields yang mempengaruhi display
            $('#nama_keluarga, #umur_keluarga, #jk_keluarga, #status_keluarga, #alamat_keluarga').on(
                'input keyup change',
                function() {
                    updatePenandatangan();
                });
            ...
            // Trigger initial display when page loads
            const initialTipe = $('#tipe_penerima').val();
            if (initialTipe === 'pasien') {
                $('#section_pasien').show();
                $('#section_keluarga').hide();
            } else if (initialTipe === 'keluarga') {
                $('#section_pasien').hide();
                $('#section_keluarga').show();
            }
        });
