        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Hasil Lab',
                    'description' => 'Tambah Hasil Lab Pasien Hemodialisa dengan mengisi formulir di bawah ini.',
                ])
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control" id="hematokrit"
                                                    name="hematokrit" placeholder="38.5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control" id="eritrosit"
                                                    name="eritrosit" placeholder="4.5">
                                                <span class="unit-label">10⁶/µL</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pre-post-container">
                                        <div class="pre-post-item">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    name="ureum_pre" placeholder="120">
                                        ...
                                        <div class="pre-post-item">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    name="ureum_post" placeholder="40">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control" id="asam_urat"
                                                    name="asam_urat" placeholder="7.5">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pre-post-container">
                                        <div class="pre-post-item">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    name="kreatinin_pre" placeholder="8.5">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                        <div class="pre-post-item">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    name="kreatinin_post" placeholder="3.2">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="saturasi_transferin" name="saturasi_transferin" placeholder="25">
                                                <span class="unit-label">%</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="bilirubin_total" name="bilirubin_total" placeholder="1.2">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="bilirubin_direct" name="bilirubin_direct" placeholder="0.3">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="protein_total" name="protein_total" placeholder="7.5">
                                                <span class="unit-label">g/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="fosfatase_alkali" name="fosfatase_alkali" placeholder="120">
                                                <span class="unit-label">U/L</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="glukosa_puasa" name="glukosa_puasa" placeholder="100">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="glukosa_2jam_pp" name="glukosa_2jam_pp" placeholder="140">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="glukosa_sewaktu" name="glukosa_sewaktu" placeholder="120">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="kolesterol_total" name="kolesterol_total" placeholder="200">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="trigliserida" name="trigliserida" placeholder="150">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.01" class="form-control"
                                                    id="troponin_t" name="troponin_t" placeholder="0.02">
                                                <span class="unit-label">ng/mL</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.01" class="form-control"
                                                    id="troponin_i" name="troponin_i" placeholder="0.04">
                                                <span class="unit-label">ng/mL</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.01" class="form-control"
                                                    id="calcium_ion" name="calcium_ion" placeholder="1.20">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.01" class="form-control" id="magnesium"
                                                    name="magnesium" placeholder="1.80">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-with-unit">
                                                <input type="number" step="0.1" class="form-control"
                                                    id="calcium_total" name="calcium_total" placeholder="9.5">
                                                <span class="unit-label">mg/dL</span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $form.on('submit', function(e) {
                ...
                $submitButton.html(
                    '<i class="spinner-border spinner-border-sm mr-2" role="status"></i> Menyimpan...');
