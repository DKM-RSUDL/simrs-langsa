        ...
        <div class="col-md-9">
            ...
            <form id="hasilLabForm" method="POST"
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h4 class="header-asesmen">Form Edit Data Hasil Lab</h4>
                                ...
                                <div class="datetime-group">
                                    <div class="datetime-item">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_implementasi" 
                                               value="{{ old('tanggal_implementasi', date('Y-m-d', strtotime($dataHasilLab->tanggal_implementasi))) }}" required>
                                    </div>
                                    <div class="datetime-item">
                                        <label>Jam</label>
                                        <input type="time" class="form-control" name="jam_implementasi" 
                                               value="{{ old('jam_implementasi', date('H:i', strtotime($dataHasilLab->jam_implementasi))) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="thrombosit" name="thrombosit" 
                                                   value="{{ old('thrombosit', $dataHasilLab->detail ? $dataHasilLab->detail->thrombosit : '') }}" placeholder="250000">
                                            <span class="unit-label">10³/µL</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" class="form-control" id="led" name="led" 
                                                   value="{{ old('led', $dataHasilLab->detail ? $dataHasilLab->detail->led : '') }}" placeholder="15">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="golongan_darah" name="golongan_darah">
                                            ...
                                            <option value="A" {{ old('golongan_darah', $dataHasilLab->detail ? $dataHasilLab->detail->golongan_darah : '') == 'A' ? 'selected' : '' }}>A</option>
                                            <option value="B" {{ old('golongan_darah', $dataHasilLab->detail ? $dataHasilLab->detail->golongan_darah : '') == 'B' ? 'selected' : '' }}>B</option>
                                            <option value="AB" {{ old('golongan_darah', $dataHasilLab->detail ? $dataHasilLab->detail->golongan_darah : '') == 'AB' ? 'selected' : '' }}>AB</option>
                                            <option value="O" {{ old('golongan_darah', $dataHasilLab->detail ? $dataHasilLab->detail->golongan_darah : '') == 'O' ? 'selected' : '' }}>O</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="pre-post-item">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" name="ureum_pre" 
                                                   value="{{ old('ureum_pre', $dataHasilLab->detail ? $dataHasilLab->detail->ureum_pre : '') }}" placeholder="120">
                                    ...
                                    <div class="pre-post-item">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" name="ureum_post" 
                                                   value="{{ old('ureum_post', $dataHasilLab->detail ? $dataHasilLab->detail->ureum_post : '') }}" placeholder="40">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="urr" name="urr" 
                                                   value="{{ old('urr', $dataHasilLab->detail ? $dataHasilLab->detail->urr : '') }}" placeholder="65">
                                            <span class="unit-label">%</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="asam_urat" name="asam_urat" 
                                                   value="{{ old('asam_urat', $dataHasilLab->detail ? $dataHasilLab->detail->asam_urat : '') }}" placeholder="7.5">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="besi_fe" name="besi_fe" 
                                                   value="{{ old('besi_fe', $dataHasilLab->detail ? $dataHasilLab->detail->besi_fe : '') }}" placeholder="80">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="tibc" name="tibc" 
                                                   value="{{ old('tibc', $dataHasilLab->detail ? $dataHasilLab->detail->tibc : '') }}" placeholder="300">
                                            <span class="unit-label">µg/dL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="saturasi_transferin" name="saturasi_transferin" 
                                                   value="{{ old('saturasi_transferin', $dataHasilLab->detail ? $dataHasilLab->detail->saturasi_transferin : '') }}" placeholder="25">
                                            <span class="unit-label">%</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="feritin" name="feritin" 
                                                   value="{{ old('feritin', $dataHasilLab->detail ? $dataHasilLab->detail->feritin : '') }}" placeholder="200">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="glukosa_puasa" name="glukosa_puasa" 
                                                   value="{{ old('glukosa_puasa', $dataHasilLab->detail ? $dataHasilLab->detail->glukosa_puasa : '') }}" placeholder="100">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="glukosa_2jam_pp" name="glukosa_2jam_pp" 
                                                   value="{{ old('glukosa_2jam_pp', $dataHasilLab->detail ? $dataHasilLab->detail->glukosa_2jam_pp : '') }}" placeholder="140">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="glukosa_sewaktu" name="glukosa_sewaktu" 
                                                   value="{{ old('glukosa_sewaktu', $dataHasilLab->detail ? $dataHasilLab->detail->glukosa_sewaktu : '') }}" placeholder="120">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="hb1a1c" name="hb1a1c" 
                                                   value="{{ old('hb1a1c', $dataHasilLab->detail ? $dataHasilLab->detail->hb1a1c : '') }}" placeholder="7.0">
                                            <span class="unit-label">%</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="kolesterol_total" name="kolesterol_total" 
                                                   value="{{ old('kolesterol_total', $dataHasilLab->detail ? $dataHasilLab->detail->kolesterol_total : '') }}" placeholder="200">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="ldl_c" name="ldl_c" 
                                                   value="{{ old('ldl_c', $dataHasilLab->detail ? $dataHasilLab->detail->ldl_c : '') }}" placeholder="130">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="hdl_c" name="hdl_c" 
                                                   value="{{ old('hdl_c', $dataHasilLab->detail ? $dataHasilLab->detail->hdl_c : '') }}" placeholder="40">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="trigliserida" name="trigliserida" 
                                                   value="{{ old('trigliserida', $dataHasilLab->detail ? $dataHasilLab->detail->trigliserida : '') }}" placeholder="150">
                                            <span class="unit-label">mg/dL</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="ck" name="ck" 
                                                   value="{{ old('ck', $dataHasilLab->detail ? $dataHasilLab->detail->ck : '') }}" placeholder="100">
                                            <span class="unit-label">U/L</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="ck_mb" name="ck_mb" 
                                                   value="{{ old('ck_mb', $dataHasilLab->detail ? $dataHasilLab->detail->ck_mb : '') }}" placeholder="25">
                                            <span class="unit-label">U/L</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.01" class="form-control" id="troponin_t" name="troponin_t" 
                                                   value="{{ old('troponin_t', $dataHasilLab->detail ? $dataHasilLab->detail->troponin_t : '') }}" placeholder="0.02">
                                            <span class="unit-label">ng/mL</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.01" class="form-control" id="troponin_i" name="troponin_i" 
                                                   value="{{ old('troponin_i', $dataHasilLab->detail ? $dataHasilLab->detail->troponin_i : '') }}" placeholder="0.04">
                                            <span class="unit-label">ng/mL</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-with-unit">
                                            <input type="number" step="0.1" class="form-control" id="ldh" name="ldh" 
                                                   value="{{ old('ldh', $dataHasilLab->detail ? $dataHasilLab->detail->ldh : '') }}" placeholder="200">
                                            <span class="unit-label">U/L</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="hbsag_rapid" name="hbsag_rapid">
                                            ...
                                            <option value="Non Reactive (-)" {{ old('hbsag_rapid', $dataHasilLab->detail ? $dataHasilLab->detail->hbsag_rapid : '') == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                            <option value="Reactive (+)" {{ old('hbsag_rapid', $dataHasilLab->detail ? $dataHasilLab->detail->hbsag_rapid : '') == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="hbsag_elisa" name="hbsag_elisa">
                                            <option value="">Pilih Hasil</option>
                                            <option value="Non Reactive (-)" {{ old('hbsag_elisa', $dataHasilLab->detail ? $dataHasilLab->detail->hbsag_elisa : '') == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                            <option value="Reactive (+)" {{ old('hbsag_elisa', $dataHasilLab->detail ? $dataHasilLab->detail->hbsag_elisa : '') == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="anti_hcv_rapid" name="anti_hcv_rapid">
                                            <option value="">Pilih Hasil</option>
                                            <option value="Non Reactive (-)" {{ old('anti_hcv_rapid', $dataHasilLab->detail ? $dataHasilLab->detail->anti_hcv_rapid : '') == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                            <option value="Reactive (+)" {{ old('anti_hcv_rapid', $dataHasilLab->detail ? $dataHasilLab->detail->anti_hcv_rapid : '') == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="anti_hiv_rapid" name="anti_hiv_rapid">
                                            <option value="">Pilih Hasil</option>
                                            <option value="Non Reactive (-)" {{ old('anti_hiv_rapid', $dataHasilLab->detail ? $dataHasilLab->detail->anti_hiv_rapid : '') == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                            <option value="Reactive (+)" {{ old('anti_hiv_rapid', $dataHasilLab->detail ? $dataHasilLab->detail->anti_hiv_rapid : '') == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="anti_hiv_3_metode" name="anti_hiv_3_metode">
                                            <option value="">Pilih Hasil</option>
                                            <option value="Non Reactive (-)" {{ old('anti_hiv_3_metode', $dataHasilLab->detail ? $dataHasilLab->detail->anti_hiv_3_metode : '') == 'Non Reactive (-)' ? 'selected' : '' }}>Non Reactive (-)</option>
                                            <option value="Reactive (+)" {{ old('anti_hiv_3_metode', $dataHasilLab->detail ? $dataHasilLab->detail->anti_hiv_3_metode : '') == 'Reactive (+)' ? 'selected' : '' }}>Reactive (+)</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="fob" name="fob">
                                            <option value="">Pilih Hasil</option>
                                            <option value="Negatif (-)" {{ old('fob', $dataHasilLab->detail ? $dataHasilLab->detail->fob : '') == 'Negatif (-)' ? 'selected' : '' }}>Negatif (-)</option>
                                            <option value="Positif (+)" {{ old('fob', $dataHasilLab->detail ? $dataHasilLab->detail->fob : '') == 'Positif (+)' ? 'selected' : '' }}>Positif (+)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $form.on('submit', function(e) {
                ...
                $submitButton.html('<i class="spinner-border spinner-border-sm mr-2" role="status"></i> Memperbarui...');
