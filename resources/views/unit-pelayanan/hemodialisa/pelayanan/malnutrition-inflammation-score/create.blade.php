    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="text-center mt-1 mb-2">
                <h5 class="text-secondary fw-bold">Malnutrition Inflammation Score (MIS) <br> Pasien Hemodialisa</h5>
            </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_0" value="0">
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_1" value="1">
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_2" value="2">
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_3" value="3">
