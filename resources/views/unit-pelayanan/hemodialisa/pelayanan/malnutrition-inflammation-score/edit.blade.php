    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="text-center mt-1 mb-2">
                <h5 class="text-secondary fw-bold">Edit Malnutrition Inflammation Score (MIS) <br> Pasien Hemodialisa</h5>
            </div>
            ...
            <div class="form-section">
                <form id="beratBadanForm" method="POST"
                    action="{{ route('hemodialisa.pelayanan.malnutrition-inflammation-score.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $skorMalnutrisi->id]) }}">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" name="tgl_rawat"
                                                        value="{{ $skorMalnutrisi->tgl_rawat }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="time" class="form-control" name="jam_rawat"
                                                        value="{{ date('H:i', strtotime($skorMalnutrisi->jam_rawat)) }}" required>
                                                 </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="diagnosis_medis" rows="2">{{ $skorMalnutrisi->diagnosis_medis }}</textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.01" class="form-control"
                                                        name="berat_badan" placeholder="kg" value="{{ $skorMalnutrisi->berat_badan }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.01" class="form-control"
                                                        name="tinggi_badan" placeholder="cm" value="{{ $skorMalnutrisi->tinggi_badan }}">
                            ...
                            <div class="card border-0 shadow-sm mb-2">
                                <div class="card-body py-2">
                                    <h6 class="fw-bold text-primary mb-3" style="font-size: 1.1rem;">
                                        ...
                                        <small class="text-muted d-block" style="font-size: 0.9rem; font-weight: normal;">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="perubahan_bb_kering"
                                                    id="bb_kering_0" value="0" {{ $skorMalnutrisi->perubahan_bb_kering == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="perubahan_bb_kering"
                                                    id="bb_kering_1" value="1" {{ $skorMalnutrisi->perubahan_bb_kering == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="perubahan_bb_kering"
                                                    id="bb_kering_2" value="2" {{ $skorMalnutrisi->perubahan_bb_kering == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="perubahan_bb_kering"
                                                    id="bb_kering_3" value="3" {{ $skorMalnutrisi->perubahan_bb_kering == 3 ? 'checked' : '' }}>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="asupan_diet"
                                                    id="asupan_diet_0" value="0" {{ $skorMalnutrisi->asupan_diet == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="asupan_diet"
                                                    id="asupan_diet_1" value="1" {{ $skorMalnutrisi->asupan_diet == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="asupan_diet"
                                                    id="asupan_diet_2" value="2" {{ $skorMalnutrisi->asupan_diet == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="asupan_diet"
                                                    id="asupan_diet_3" value="3" {{ $skorMalnutrisi->asupan_diet == 3 ? 'checked' : '' }}>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio"
                                                    name="gejala_gastrointestinal" id="gejala_gi_0" value="0" {{ $skorMalnutrisi->gejala_gastrointestinal == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="gejala_gastrointestinal" id="gejala_gi_1" value="1" {{ $skorMalnutrisi->gejala_gastrointestinal == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="gejala_gastrointestinal" id="gejala_gi_2" value="2" {{ $skorMalnutrisi->gejala_gastrointestinal == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="gejala_gastrointestinal" id="gejala_gi_3" value="3" {{ $skorMalnutrisi->gejala_gastrointestinal == 3 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="gejala_gi_3">
                                                    <span
                                                        class="badge bg-danger position-absolute top-0 end-0 m-2">3</span>
                                                    <strong class="d-block mb-2">Sering diare atau muntah atau anoreksia
                                                        berat</strong>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="kapasitas_fungsional" id="kapasitas_0" value="0" {{ $skorMalnutrisi->kapasitas_fungsional == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="kapasitas_fungsional" id="kapasitas_1" value="1" {{ $skorMalnutrisi->kapasitas_fungsional == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="kapasitas_fungsional" id="kapasitas_2" value="2" {{ $skorMalnutrisi->kapasitas_fungsional == 2 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="kapasitas_2">
                                                    <span class="badge bg-orange position-absolute top-0 end-0 m-2"
                                                        style="background-color: #fd7e14;">2</span>
                                                    <strong class="d-block mb-2">Sulit melakukan aktivitas mandiri</strong>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="kapasitas_fungsional" id="kapasitas_3" value="3" {{ $skorMalnutrisi->kapasitas_fungsional == 3 ? 'checked' : '' }}>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="komorbiditas"
                                                    id="komorbiditas_0" value="0" {{ $skorMalnutrisi->komorbiditas == 0 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="komorbiditas_0">
                                                    <span
                                                        class="badge bg-success position-absolute top-0 end-0 m-2">0</span>
                                                    <strong class="d-block mb-2">Tanpa komorbiditas dalam Dialysis selama 1
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="komorbiditas"
                                                    id="komorbiditas_1" value="1" {{ $skorMalnutrisi->komorbiditas == 1 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="komorbiditas_1">
                                                    <span
                                                        class="badge bg-warning position-absolute top-0 end-0 m-2">1</span>
                                                    <strong class="d-block mb-2">Komorbiditas ringan, dalam Dialysis 1-4
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="komorbiditas"
                                                    id="komorbiditas_2" value="2" {{ $skorMalnutrisi->komorbiditas == 2 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="komorbiditas_2">
                                                    <span class="badge bg-orange position-absolute top-0 end-0 m-2"
                                                        style="background-color: #fd7e14;">2</span>
                                                    <strong class="d-block mb-2">Komorbiditas sedang, dalam Dialysis > 4
                                                        tahun (termasuk MMC*)</strong>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="komorbiditas"
                                                    id="komorbiditas_3" value="3" {{ $skorMalnutrisi->komorbiditas == 3 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="komorbiditas_3">
                                                    <span
                                                        class="badge bg-danger position-absolute top-0 end-0 m-2">3</span>
                                                    <strong class="d-block mb-2">Setiap Komorditas berta multiple (2 atau
                                                        lebih MMC)</strong>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_0" value="0" {{ $skorMalnutrisi->berkurang_cadangan_lemak == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_1" value="1" {{ $skorMalnutrisi->berkurang_cadangan_lemak == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_2" value="2" {{ $skorMalnutrisi->berkurang_cadangan_lemak == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio"
                                                    name="berkurang_cadangan_lemak" id="cadangan_lemak_3" value="3" {{ $skorMalnutrisi->berkurang_cadangan_lemak == 3 ? 'checked' : '' }}>
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="kehilangan_masa_oto"
                                                    id="masa_oto_0" value="0" {{ $skorMalnutrisi->kehilangan_masa_oto == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="kehilangan_masa_oto"
                                                    id="masa_oto_1" value="1" {{ $skorMalnutrisi->kehilangan_masa_oto == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="kehilangan_masa_oto"
                                                    id="masa_oto_2" value="2" {{ $skorMalnutrisi->kehilangan_masa_oto == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="kehilangan_masa_oto"
                                                    id="masa_oto_3" value="3" {{ $skorMalnutrisi->kehilangan_masa_oto == 3 ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" class="form-control bg-light"
                                            id="imt_result" name="imt_result" value="{{ $skorMalnutrisi->imt_result }}" readonly>
                                ...
                                <div class="card-body py-2">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="indeks_masa_tubuh"
                                                    id="imt_0" value="0" {{ $skorMalnutrisi->indeks_masa_tubuh == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="indeks_masa_tubuh"
                                                    id="imt_1" value="1" {{ $skorMalnutrisi->indeks_masa_tubuh == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="indeks_masa_tubuh"
                                                    id="imt_2" value="2" {{ $skorMalnutrisi->indeks_masa_tubuh == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="indeks_masa_tubuh"
                                                    id="imt_3" value="3" {{ $skorMalnutrisi->indeks_masa_tubuh == 3 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="imt_3">
                                                    <span
                                                        class="badge bg-danger position-absolute top-0 end-0 m-2">3</span>
                                                    <strong class="d-block mb-2">< 16</strong>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="albumin_serum"
                                                    id="albumin_0" value="0" {{ $skorMalnutrisi->albumin_serum == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="albumin_serum"
                                                    id="albumin_1" value="1" {{ $skorMalnutrisi->albumin_serum == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="albumin_serum"
                                                    id="albumin_2" value="2" {{ $skorMalnutrisi->albumin_serum == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="albumin_serum"
                                                    id="albumin_3" value="3" {{ $skorMalnutrisi->albumin_serum == 3 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="albumin_3">
                                                    <span
                                                        class="badge bg-danger position-absolute top-0 end-0 m-2">3</span>
                                                    <strong class="d-block mb-2">< 3,0</strong>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                ...
                                                <input class="form-check-input" type="radio" name="tibc"
                                                    id="tibc_0" value="0" {{ $skorMalnutrisi->tibc == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="tibc"
                                                    id="tibc_1" value="1" {{ $skorMalnutrisi->tibc == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="tibc"
                                                    id="tibc_2" value="2" {{ $skorMalnutrisi->tibc == 2 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-6 col-xl-3">
                                            <div
                                                class="form-check p-3 border rounded-3 h-100 position-relative hover-shadow">
                                                <input class="form-check-input" type="radio" name="tibc"
                                                    id="tibc_3" value="3" {{ $skorMalnutrisi->tibc == 3 ? 'checked' : '' }}>
                                                <label class="form-check-label w-100" for="tibc_3">
                                                    <span
                                                        class="badge bg-danger position-absolute top-0 end-0 m-2">3</span>
                                                    <strong class="d-block mb-2">< 150</strong>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="text-center p-3 border rounded bg-light">
                                        ...
                                        <h2 class="text-primary mb-0" id="total_score">{{ $skorMalnutrisi->total_skor }}</h2>
                                ...
                                <div class="col-md-6">
                                    <div class="text-center p-3 border rounded" id="interpretation_box">
                                        ...
                                        <small id="interpretation_desc" class="text-muted">{{ $skorMalnutrisi->interpretasi }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="alert alert-info border-0 shadow-sm">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                *MMC (Mayor Comorbid Condition) termasuk CHF kelas III atau IV, penyakit AIDS total (full
                                ...
                                ** Peningkatan serum transferrin yang diharapkan adalah : > 200(0), 170-199 (1), 140-162
                                (2), dan < 140 mg/dl (3).<br><br>
                                    <strong>Kesimpulan :</strong> tanpa malnutrisi total nilai < 6 apabila malnutrisi nilai>
                    ...
                    <div class="row">
                        <div class="col-12 text-end">
                            ...
                            <a href="{{ route('hemodialisa.pelayanan.malnutrition-inflammation-score.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                class="btn">
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Calculate on page load to show existing data properly
            calculateTotal();
        });
    </script>
@endpush