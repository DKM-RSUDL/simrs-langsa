                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="time" class="form-control" name="jam_rawat"
                                                            value="{{ date('H:i', strtotime($skorMalnutrisi->jam_rawat)) }}"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.01" class="form-control"
                                                            ...
                                                            value="{{ $skorMalnutrisi->berat_badan }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" step="0.01" class="form-control"
                                                            ...
                                                            value="{{ $skorMalnutrisi->tinggi_badan }}">
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->perubahan_bb_kering == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->perubahan_bb_kering == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->perubahan_bb_kering == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->perubahan_bb_kering == 3 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="asupan_diet"
                                                        ...
                                                        {{ $skorMalnutrisi->asupan_diet == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="asupan_diet"
                                                        ...
                                                        {{ $skorMalnutrisi->asupan_diet == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="asupan_diet"
                                                        ...
                                                        {{ $skorMalnutrisi->asupan_diet == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="asupan_diet"
                                                        ...
                                                        {{ $skorMalnutrisi->asupan_diet == 3 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->gejala_gastrointestinal == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->gejala_gastrointestinal == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->gejala_gastrointestinal == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->gejala_gastrointestinal == 3 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kapasitas_fungsional == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kapasitas_fungsional == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kapasitas_fungsional == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kapasitas_fungsional == 3 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="komorbiditas"
                                                        ...
                                                        {{ $skorMalnutrisi->komorbiditas == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="komorbiditas"
                                                        ...
                                                        {{ $skorMalnutrisi->komorbiditas == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="komorbiditas"
                                                        ...
                                                        {{ $skorMalnutrisi->komorbiditas == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="komorbiditas"
                                                        ...
                                                        {{ $skorMalnutrisi->komorbiditas == 3 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        value="0"
                                                        {{ $skorMalnutrisi->berkurang_cadangan_lemak == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        value="1"
                                                        {{ $skorMalnutrisi->berkurang_cadangan_lemak == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        value="2"
                                                        {{ $skorMalnutrisi->berkurang_cadangan_lemak == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        value="3"
                                                        {{ $skorMalnutrisi->berkurang_cadangan_lemak == 3 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kehilangan_masa_oto == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kehilangan_masa_oto == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kehilangan_masa_oto == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->kehilangan_masa_oto == 3 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="0.01" class="form-control bg-light"
                                                id="imt_result" name="imt_result"
                                                value="{{ $skorMalnutrisi->imt_result }}" readonly>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->indeks_masa_tubuh == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->indeks_masa_tubuh == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->indeks_masa_tubuh == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $skorMalnutrisi->indeks_masa_tubuh == 3 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="albumin_serum"
                                                        ...
                                                        {{ $skorMalnutrisi->albumin_serum == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="albumin_serum"
                                                        ...
                                                        {{ $skorMalnutrisi->albumin_serum == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="albumin_serum"
                                                        ...
                                                        {{ $skorMalnutrisi->albumin_serum == 2 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-6 col-xl-3">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="albumin_serum"
                                                        ...
                                                        {{ $skorMalnutrisi->albumin_serum == 3 ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="text-center p-3 border rounded bg-light">
                                            ...
                                            <h2 class="text-primary mb-0" id="total_score">
                                                {{ $skorMalnutrisi->total_skor }}</h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-center p-3 border rounded" id="interpretation_box">
                                            ...
                                            <small id="interpretation_desc"
                                                class="text-muted">{{ $skorMalnutrisi->interpretasi }}</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
