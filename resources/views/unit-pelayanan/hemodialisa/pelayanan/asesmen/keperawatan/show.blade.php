            ...
            <x-content-card>
                    ...
                    @if ($asesmen->keperawatanPemeriksaanFisik)
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPemeriksaanFisik->fisik_sistole ?? '-' }}" disabled>
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Diastole</label>
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPemeriksaanFisik->fisik_diastole ?? '-' }}" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Nadi (Per
                                Menit)</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanPemeriksaanFisik->fisik_nadi ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Nafas (Per
                                Menit)</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanPemeriksaanFisik->fisik_nafas ?? '-' }}" disabled>
                        </div>

                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Suhu (C)</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanPemeriksaanFisik->fisik_suhu ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group align-items-center mb-3">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPemeriksaanFisik->so_tb_o2 ?? '-' }}" disabled>
                                </div>
                                <div class="col-6">
                                    <label class="form-label">Dengan bantuan O2</label>
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPemeriksaanFisik->so_db_o2 ?? '-' }}" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Tinggi Badan
                                (Cm)</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanPemeriksaanFisik->tinggi_badan ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Berat Badan
                                (Kg)</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanPemeriksaanFisik->berat_badan ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Index Massa Tubuh
                                (IMT)</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanPemeriksaanFisik->imt ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Luas Permukaan Tubuh
                                (LPT)</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanPemeriksaanFisik->lpt ?? '-' }}" disabled>
                        </div>
                    @else
                        <div class="alert alert-info">
                ...
                <div class="section-separator">
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($asesmen->keperawatan)
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatan->status_skala_nyeri ?? 'Tidak ada data' }}" disabled>
                        @else
                    ...
                    @if ($asesmen->keperawatan)
                        <div class="form-group mb-3">
                            <label style="min-width: 200px;" class="fw-bold">Gagal Ginjal
                                Stadium</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatan->gagal_ginjal_stadium ?? 'Tidak ada data' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatan->jadwal_hd_rutin ?? 'Tidak ada data' }}" disabled>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control"
                    ...
                    @if ($asesmen->keperawatanPempen)
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPempen->pre_ekg ?? 'Tidak ada data' }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPempen->pre_usg ?? 'Tidak ada data' }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPempen->pre_dll ?? 'Tidak ada data' }}" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPempen->post_ekg ?? 'Tidak ada data' }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPempen->post_usg ?? 'Tidak ada data' }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"
                                        value="{{ $asesmen->keperawatanPempen->post_dll ?? 'Tidak ada data' }}" disabled>
                                </div>
                            </div>
                        </div>
                    @else
                ...
                <div class="section-separator">
                    ...
                    @if ($asesmen->keperawatanStatusGizi)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control"
                                    value="{{ $asesmen->keperawatanStatusGizi->gizi_skore_mis ?? '-' }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control"
                                    value="{{ $asesmen->keperawatanStatusGizi->gizi_kesimpulan ?? '-' }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control"
                                    value="{{ $asesmen->keperawatanStatusGizi->gizi_rekomendasi ?? '-' }}" disabled>
                            </div>
                        </div>
                    @else
                        <div class="alert alert-info">
                ...
                <div class="section-separator">
                    ...
                    @if ($asesmen->keperawatanRisikoJatuh)
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanRisikoJatuh->riwayat_jatuh ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label fw-bold">Pasien memiliki Diagnosa medis
                                sekunder > 1 ?</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanRisikoJatuh->diagnosa_sekunder ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label fw-bold">Pasien membutuhkan bantuan Alat bantu
                                jalan ?</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanRisikoJatuh->alat_bantu ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label fw-bold">Bagaimana cara berjalan
                                pasien?</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanRisikoJatuh->cara_berjalan ?? '-' }}" disabled>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label fw-bold">Bagaimana status mental
                                pasien?</label>
                            <input type="text" class="form-control"
                                value="{{ $asesmen->keperawatanRisikoJatuh->status_mental ?? '-' }}" disabled>
                        </div>
                ...
                <div class="section-separator">
                    ...
                    @if ($asesmen->keperawatanStatusPsikososial)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control"
                                    value="{{ $asesmen->keperawatanStatusPsikososial->yang_merawat ?? '-' }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                @php
                                    $kondisiPsikologis = $asesmen->keperawatanStatusPsikososial->kondisi_psikologis_json
                                        ? json_decode(
                                            $asesmen->keperawatanStatusPsikososial->kondisi_psikologis_json,
                                            true,
                                        )
                                        : [];
                                @endphp
                ...
                <div class="section-separator">
                    ...
                    <div class="tindakan__keperawatan">
                        ...
                        <div class="intraHD">
                            ...
                            <!-- Waktu Intra Pre HD -->
                            <div class="row mb-3">
                                <label for="waktu_intra_pre_hd" class="col-sm-2 col-form-label text-end">Waktu Intra Pre
                                    HD</label>
                                <div class="col-sm-10">
                            ...
                            <!-- Parameter Mesin HD (QB dan QD) -->
                            <div class="row mb-3">
                                <label for="parameter_mesin_hd_intra" class="col-sm-2 col-form-label text-end">Parameter
                                    Mesin
                                    HD</label>
                                <div class="col-sm-10">
                                    <div class="row">
                            ...
                            <!-- Tek. Darah (mmHg) - Sistole & Diastole -->
                            <div class="row mb-3">
                                <label for="tekanan_darah_intra" class="col-sm-2 col-form-label text-end">Tek. Darah
                                    (mmHg)</label>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text">Sistole</span>
                                                <input type="number" class="form-control" id="sistole_intra"
                                                    name="sistole_intra"
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-text">Diastole</span>
                                                <input type="number" class="form-control" id="diastole_intra"
                                                    name="diastole_intra"
                            ...
                            <!-- Nadi (Per Menit) -->
                            <div class="row mb-3">
                                <label for="nadi_intra" class="col-sm-2 col-form-label text-end">Nadi (Per
                                    Menit)</label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                            ...
                            <!-- Nafas (Per Menit) -->
                            <div class="row mb-3">
                                <label for="nafas_intra" class="col-sm-2 col-form-label text-end">Nafas (Per
                                    Menit)</label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="input-group">
                                                <span class="input-group-text">Lain-Lain</span>
                                                <input type="text" class="form-control" id="intake_lain_intra"
                        ...
                        <div class="post__HD">
                            ...
                            @if ($asesmen->keperawatanMonitoringPosthd)
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label text-end fw-bold">Ultrafiltration
                                        Total</label>
                                    <div class="col-sm-10">
                ...
                <div class="section-separator">
                    ...
                    @if ($asesmen->keperawatan)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                @php
                                    $rencanaPulangValues = $asesmen->keperawatan->rencana_pulang_values
                                        ? json_decode($asesmen->keperawatan->rencana_pulang_values, true)
                                        : [];
                                    $rencanaPulangDisplay = !empty($rencanaPulangValues)
                                        ? implode(', ', $rencanaPulangValues)
                                        : '-';
                                @endphp
                                <input type="text" class="form-control" value="{{ $rencanaPulangDisplay }}"
                                    disabled>
                            </div>
                        </div>
                    @else
                ...
                <div class="section-separator mb-0">
