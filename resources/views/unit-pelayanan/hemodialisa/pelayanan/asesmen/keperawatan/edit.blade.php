            ...
            <x-content-card>
                <x-button-previous />
                    @include('components.page-header', [
                        ...
                        'description' =>
                        'Edit data asesmen keperawatan pasien hemodialisa di unit pelayanan hemodialisa.',
                    ])
                <form
                                        ...
                                        <div>
                                            <div class="section-separator">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="anamnesis" id="anamnesis"
                                                        ...
                                                        rows="4">{{ old('anamnesis', $asesmen->keperawatan->anamnesis ?? '') }}</textarea>
                                                    @error('anamnesis')
                                            ...
                                            <div class="section-separator">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="avpu" id="avpu"
                                                        ...
                                                        <option value="2" {{ old('avpu', $asesmen->keperawatanPemeriksaanFisik->avpu ?? '') === '2' ? 'selected' : '' }}>Hanya berespons jika dirangsang nyeri/Pain: 2
                                                        </option>
                                            ...
                                            <div class="section-separator">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="status_skala_nyeri" class="form-control" min="0"
                                                        max="10" value="{{ $asesmen->keperawatan->status_skala_nyeri ?? '' }}">
                                                </div>
                                            </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" id="gizi_kesimpulan" name="gizi_kesimpulan">
                                                            <option value="">pilih</option>
                                                            <option value="Tampa mainutrisi (<6)" {{ ($asesmen->keperawatanStatusGizi->gizi_kesimpulan ?? '') == 'Tampa mainutrisi (<6)' ? 'selected' : '' }}>Tampa mainutrisi (6)
                                                            </option>
                                                            <option value="Malnutrisi(>6)" {{ ($asesmen->keperawatanStatusGizi->gizi_kesimpulan ?? '') == 'Malnutrisi(>6)' ? 'selected' : '' }}>Malnutrisi(>6)
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="section-separator">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select risiko-jatuh-select" id="alat_bantu"
                                                        ...
                                                        <option value="">pilih</option>
                                                        <option value="Tidak ada/ bed rest/ bantuan perawat" data-skor="0" {{ ($asesmen->keperawatanRisikoJatuh->alat_bantu ?? '') == 'Tidak ada/ bed rest/ bantuan perawat' ? 'selected' : '' }}>Tidak ada/ bed rest/
                                                            bantuan perawat</option>
                                                        <option value="kruk/ tongkat/ alat bantu berjalan" data-skor="15" {{ ($asesmen->keperawatanRisikoJatuh->alat_bantu ?? '') == 'kruk/ tongkat/ alat bantu berjalan' ? 'selected' : '' }}>kruk/ tongkat/
                                                            alat bantu berjalan</option>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select risiko-jatuh-select" id="cara_berjalan"
                                                        ...
                                                        <option value="">pilih</option>
                                                        <option value="Normal/ bed rest/ kursi roda" data-skor="0" {{ ($asesmen->keperawatanRisikoJatuh->cara_berjalan ?? '') == 'Normal/ bed rest/ kursi roda' ? 'selected' : '' }}>Normal/ bed rest/ kursi
                                                            roda</option>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select risiko-jatuh-select" id="status_mental"
                                                        ...
                                                        <option value="">pilih</option>
                                                        <option value="Orientasi sesuai kemampuan" data-skor="0" {{ ($asesmen->keperawatanRisikoJatuh->status_mental ?? '') == 'Orientasi sesuai kemampuan' ? 'selected' : '' }}>Orientasi sesuai kemampuan
                                                        </option>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <input type="checkbox" class="btn-check" id="kondisi_cemas"
                                                                name="kondisi_psikologis[]" value="Cemas" autocomplete="off" {{ in_array('Cemas', $kondisi_array) ? 'checked' : '' }}>
                                                            ...
                                                            <input type="checkbox" class="btn-check" id="kondisi_marah"
                                                                name="kondisi_psikologis[]" value="Marah" autocomplete="off" {{ in_array('Marah', $kondisi_array) ? 'checked' : '' }}>
                                                            ...
                                                            <input type="checkbox" class="btn-check" id="kondisi_sedih"
                                                                name="kondisi_psikologis[]" value="Sedih" autocomplete="off" {{ in_array('Sedih', $kondisi_array) ? 'checked' : '' }}>
                                                            ...
                                                            <input type="checkbox" class="btn-check" id="kondisi_takut"
                                                                name="kondisi_psikologis[]" value="Takut" autocomplete="off" {{ in_array('Takut', $kondisi_array) ? 'checked' : '' }}>
                                            ...
                                            <div class="section-separator">
                                                ...
                                                <div class="preekripsi__hemodialisis">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                ...
                                                                                value="UF Profiling Mode" {{ in_array('UF Profiling Mode', explode(',', $asesmen->keperawatanMonitoringPreekripsi->program_profiling ?? '')) ? 'checked' : '' }}>
                                                                            <label class="form-check-label"
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                ...
                                                                                value="Bicarbonat Profiling" {{ in_array('Bicarbonat Profiling', explode(',', $asesmen->keperawatanMonitoringPreekripsi->program_profiling ?? '')) ? 'checked' : '' }}>
                                                                            <label class="form-check-label"
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                ...
                                                                                value="Na Profiling Mode" {{ in_array('Na Profiling Mode', explode(',', $asesmen->keperawatanMonitoringPreekripsi->program_profiling ?? '')) ? 'checked' : '' }}>
                                                                            <label class="form-check-label"
                                                    ...
                                                    <div class="akut">
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="laju_uf" class="col-sm-2 col-form-label text-end">ISO
                                                                UF</label>
                                                            <div class="col-sm-10">
                                                                <div class="input-group">
                                                    ...
                                                    <div class="preop">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                ...
                                                                                value="Asetat" {{ ($asesmen->keperawatanMonitoringPreekripsi->preop_dialisat ?? '') == 'Asetat' ? 'checked' : '' }}>
                                                                            <label class="form-check-label"
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                ...
                                                                                value="Bicarbonat" {{ ($asesmen->keperawatanMonitoringPreekripsi->preop_bicarbonat ?? '') == 'Bicarbonat' ? 'checked' : '' }}>
                                                                            <label class="form-check-label"
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        value="1" {{ !empty($asesmen->keperawatanMonitoringPreekripsi->preop_conductivity) ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="kalium_check" name="kalium_check" value="1" {{ !empty($asesmen->keperawatanMonitoringPreekripsi->preop_kalium) ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        ...
                                                                        value="1" {{ !empty($asesmen->keperawatanMonitoringPreekripsi->preop_suhu_dialisat) ? 'checked' : '' }}>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        id="base_na_check" name="base_na_check" value="1" {{ !empty($asesmen->keperawatanMonitoringPreekripsi->preop_base_na) ? 'checked' : '' }}>
                                                    ...
                                                    <div class="preHD">
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="waktu_pre_hd"
                                                                class="col-sm-2 col-form-label text-end">Waktu Pra HD</label>
                                                            <div class="col-sm-10">
                                                ...
                                                <div class="post__HD">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label class="col-sm-2 col-form-label text-end">Ultrafiltration
                                                            Total</label>
                                                        <div class="col-sm-10">
                                            ...
                                            <div class="section-separator mt-5">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        ...
                                                        <textarea class="form-control" id="soap_s" name="soap_s"
                                                            rows="4">{{ $asesmen->keperawatan->soap_s ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-12">
                                                        ...
                                                        <textarea class="form-control" id="soap_o" name="soap_o"
                                                            rows="4">{{ $asesmen->keperawatan->soap_o ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-12">
                                                        ...
                                                        <textarea class="form-control" id="soap_a" name="soap_a"
                                                            rows="4">{{ $asesmen->keperawatan->soap_a ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col-12">
                                                        ...
                                                        <textarea class="form-control" id="soap_p" name="soap_p"
                                                            rows="4">{{ $asesmen->keperawatan->soap_p ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 text-center">
                                                                ...
                                                                <div class="mt-2" id="no-pemeriksa">No..........................
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-4">
                                                                <button type="button" id="btn-tambah-perawat"
                                                        ...
                                                        <!-- Hidden input untuk menyimpan data JSON -->
                                                        <input type="hidden" name="perawat_bertugas" id="perawat-bertugas-json"
                                                            value="">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 text-center">
                                                                ...
                                                                <div class="mt-2" id="no-dokter">No..........................
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
