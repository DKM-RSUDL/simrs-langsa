                                        ...
                                        <div class="section-separator">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="number" name="sistole" id="sistole"
                                                            class="form-control" value="{{ $asesmen->fisik->sistole }}">
                                                    </div>
                                                    <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="tinggi_badan" id="tinggi_badan"
                                                    ...
                                                    value="{{ $asesmen->fisik->tinggi_badan }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="berat_badan" id="berat_badan"
                                                    class="form-control" onkeyup="hitungImtLpt()"
                                                    value="{{ $asesmen->fisik->berat_badan }}">
                                            </div>
                                        ...
                                        <div class="section-separator">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="skala_nyeri"
                                                    ...
                                                    value="{{ $asesmen->fisik->skala_nyeri }}">
                                            </div>
                                        ...
                                        <div class="section-separator">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="efek_samping"
                                                    id="efek_samping" value="{{ $asesmen->fisik->efek_samping }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="section-separator">
                                            ...
                                            <div class="form-group">
                                                <div class="row w-100">
                                                    <div class="col-12">
                                                        <button type="button" class="btn btn-sm" data-bs-toggle="modal"
                                                            data-bs-target="#terapiObatModal"><i
                                                                class="bi bi-plus-square"></i> Tambah</button>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" name="m_intermiten" id="m_intermiten"
                                                                class="form-control"
                                                                value="{{ $asesmen->deskripsi->m_intermiten }}">
                                                            <span class="input-group-text">IU</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" name="tanpa_heparin" id="tanpa_heparin"
                                                            class="form-control"
                                                            value="{{ $asesmen->deskripsi->tanpa_heparin }}">
                                                    </div>
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="natrium_mode" id="natrium_mode"
                                                                class="form-control"
                                                                value="{{ $asesmen->deskripsi->natrium_mode }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="bicabornat_mode"
                                                                id="bicabornat_mode" class="form-control"
                                                                value="{{ $asesmen->deskripsi->bicabornat_mode }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div id="diagnosis-banding-list"
                                                    ...
                                                    @forelse($diagnosisBanding as $index => $diagnosis)
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-sm text-danger delete-diagnosis"
                                                ...
                                                <select name="dpjp" id="dpjp" class="form-select select2">
                                                    ...
                                                    @foreach ($dokter as $dok)
                                                        <option value="{{ $dok->kd_dokter }}"
                                                            @selected($dok->kd_dokter == $asesmen->evaluasi->dpjp)>{{ $dok->nama_lengkap }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
