        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Asesmen Medis',
                    'description' =>
                        'Perbarui data Asesmen medis Hemodialisa dengan mengisi formulir di bawah ini.',
                ])
                <form
                    action="{{ route('hemodialisa.pelayanan.asesmen.medis.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, encrypt($asesmen->id)]) }}"
                    method="post">
                    @csrf
                    @method('put')
                        ...
                        <div class="section-separator">
                            ...
                            <div class="form-group">
                                ...
                                <select name="avpu" id="avpu" class="form-select">
                                    ...
                                    <option value="0" @selected($asesmen->fisik->avpu == 0)>Sadar
                                        Baik/Alert: 0
                                    </option>
                                    <option value="1" @selected($asesmen->fisik->avpu == 1)>Berespon dengan
                                        kata-kata/Voice: 1</option>
                                    <option value="2" @selected($asesmen->fisik->avpu == 2)>Hanya berespons
                                        jika
                                        dirangsang nyeri/Pain: 2</option>
                                    <option value="3" @selected($asesmen->fisik->avpu == 3)>Pasien tidak
                                        sadar/Unresponsive: 3</option>
                                    <option value="4" @selected($asesmen->fisik->avpu == 4)>Gelisah atau
                                        bingung: 4</option>
                                    <option value="5" @selected($asesmen->fisik->avpu == 5)>Acute
                                        Confusional
                                        States: 5</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-control"
                                    onkeyup="hitungImtLpt()" value="{{ $asesmen->fisik->tinggi_badan }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="berat_badan" id="berat_badan" class="form-control"
                                    onkeyup="hitungImtLpt()" value="{{ $asesmen->fisik->berat_badan }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="imt" id="imt" class="form-control"
                                    value="{{ $asesmen->fisik->imt }}" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="lpt" id="lpt" class="form-control"
                                    value="{{ $asesmen->fisik->lpt }}" readonly>
                            </div>
                        ...
                        <div class="section-separator">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="skala_nyeri" id="skala_nyeri"
                                    min="0" max="10" value="{{ $asesmen->fisik->skala_nyeri }}">
                            </div>
                        ...
                        <div class="section-separator">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="efek_samping" id="efek_samping"
                                    value="{{ $asesmen->fisik->efek_samping }}">
                            </div>
                        </div>
                                            ...
                                            <tbody>
                                                @foreach ($asesmen->fisik->terapi_obat ?? [] as $to)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                class="btn btn-sm btn-danger btn-delete-terapiobat">
                                                                <i class="fas fa-trash"></i>
                                                            </button>
                                                            <input type='hidden' name='terapi_obat[]'
                                                                value='{{ '{"nama_obat": "' . $to['nama_obat'] . '", "dosis": "' . $to['dosis'] . '", "waktu": "' . $to['waktu'] . '"}' }}'>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                        ...
                        <div class="section-separator">
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_hd" id="jenis_hd" class="form-select">
                                    ...
                                    <option value="2" @selected($asesmen->deskripsi->jenis_hd == 2)>Kronik
                                    </option>
                                    <option value="3" @selected($asesmen->deskripsi->jenis_hd == 3)>Pra Operasi
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jenis_dialisat" id="jenis_dialisat" class="form-select">
                                    <option value="">--Pilih--</option>
                                    <option value="1" @selected($asesmen->deskripsi->jenis_dialisat == 1)>Asetat
                                    </option>
                                    <option value="2" @selected($asesmen->deskripsi->jenis_dialisat == 2)>Bicabornat
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="suhu_dialisat" id="suhu_dialisat" class="form-control"
                                    value="{{ $asesmen->deskripsi->suhu_dialisat }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="akses_vaskular" id="akses_vaskular" class="form-select">
                                    <option value="">--Pilih--</option>
                                    <option value="1" @selected($asesmen->deskripsi->akses_vaskular == 1)>Cimino
                                    </option>
                                    <option value="2" @selected($asesmen->deskripsi->akses_vaskular == 2)>Femoral
                                    </option>
                                    <option value="3" @selected($asesmen->deskripsi->akses_vaskular == 3)>CDL Jugularis
                                    </option>
                                    <option value="4" @selected($asesmen->deskripsi->akses_vaskular == 4)>CDL Subclavia
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="lama_hd" id="lama_hd" class="form-control"
                                    value="{{ $asesmen->deskripsi->lama_hd }}">
                            </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="uf_goal" id="uf_goal" class="form-control"
                                                value="{{ $asesmen->deskripsi->uf_goal }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="dosis_awal" id="dosis_awal" class="form-control"
                                                value="{{ $asesmen->deskripsi->dosis_awal }}">
                                    ...
                                    <div class="col-6">
                                        <label for="m_kontinyu" class="form-label">Maintenance
                                            Kontinyu</label>
                                        <div class="input-group">
                                            <input type="number" name="m_kontinyu" id="m_kontinyu" class="form-control"
                                                value="{{ $asesmen->deskripsi->m_kontinyu }}">
                                            <span class="input-group-text">IU</span>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="m_intermiten" id="m_intermiten"
                                                class="form-control" value="{{ $asesmen->deskripsi->m_intermiten }}">
                                            <span class="input-group-text">IU</span>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="natrium_mode" id="natrium_mode"
                                                class="form-control" value="{{ $asesmen->deskripsi->natrium_mode }}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bicabornat_mode" id="bicabornat_mode"
                                                class="form-control" value="{{ $asesmen->deskripsi->bicabornat_mode }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="section-separator">
                            ...
                            <div class="mb-4">
                                ...
                                <div id="diagnosis-banding-list" class="diagnosis-list bg-light p-3 rounded">
                                    ...
                                    @empty
                                        <div class="text-muted fst-italic">Belum ada diagnosis banding
                                        </div>
                                    @endforelse
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="diagnosis-kerja-list" class="diagnosis-list bg-light p-3 rounded">
                                    ...
                                    @empty
                                        <div class="text-muted fst-italic">Belum ada diagnosis kerja
                                        </div>
                                    @endforelse
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="dokter_pelaksana" id="dokter_pelaksana" class="form-select">
                                    ...
                                    @foreach ($dokterPelaksana as $item)
                                        <option value="{{ $item->dokter->kd_dokter }}" @selected($item->dokter->kd_dokter == $asesmen->evaluasi->dokter_pelaksana)>
