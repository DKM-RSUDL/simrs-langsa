...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form action="{{ route('forensik.unit.pelayanan.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" method="post">
                @csrf
                            ...
                            <div class="px-3">
                                <div>
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            <label for="evaluasi" style="min-width: 200px;">Evaluasi Medis</label>
                                            <textarea name="evaluasi" id="evaluasi" class="form-control"></textarea>
                                        </div>
                                    </div>
