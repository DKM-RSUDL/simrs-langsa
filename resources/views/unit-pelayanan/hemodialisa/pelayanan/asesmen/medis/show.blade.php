        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Detail Asesmen Pasien Hemodialisa',
                ])
                <div>
                    ...
                    <div class="section-separator">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="number" name="diastole" id="diastole" class="form-control"
                                        value="{{ $asesmen->fisik->diastole }}" disabled>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="number" name="so_tb_o2" id="so_tb_o2" class="form-control"
                                        value="{{ $asesmen->fisik->so_tb_o2 }}" disabled>
                                </div>
                                <div class="col-6">
                                    ...
                                    <input type="number" name="so_db_o2" id="so_db_o2" class="form-control"
                                        value="{{ $asesmen->fisik->so_db_o2 }}" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-control"
                                onkeyup="hitungImtLpt()" value="{{ $asesmen->fisik->tinggi_badan }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="berat_badan" id="berat_badan" class="form-control"
                                onkeyup="hitungImtLpt()" value="{{ $asesmen->fisik->berat_badan }}" disabled>
                        </div>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="skala_nyeri" id="skala_nyeri"
                                min="0" max="10" value="{{ $asesmen->fisik->skala_nyeri }}" disabled>
                        </div>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="efek_samping" id="efek_samping"
                                value="{{ $asesmen->fisik->efek_samping }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="suhu_dialisat" id="suhu_dialisat" class="form-control"
                                value="{{ $asesmen->deskripsi->suhu_dialisat }}" disabled>
                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="qb" id="qb" class="form-control"
                                            value="{{ $asesmen->deskripsi->qb }}" disabled>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="qd" id="qd" class="form-control"
                                            value="{{ $asesmen->deskripsi->qd }}" disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="m_intermiten" class="form-label">Maintenance
                                        Intermiten</label>
                                    <div class="input-group">
                                        <input type="number" name="m_intermiten" id="m_intermiten" class="form-control"
                                ...
                                <div class="col-6">
                                    <label for="tanpa_heparin" class="form-label">Tanpa
                                        Heparin</label>
                                    <input type="text" name="tanpa_heparin" id="tanpa_heparin" class="form-control"
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="lmwh" id="lmwh" class="form-control"
                                            value="{{ $asesmen->deskripsi->lmwh }}" disabled>
                                        <span class="input-group-text">IU</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ultrafiltrasi_mode" id="ultrafiltrasi_mode"
                                            class="form-control" value="{{ $asesmen->deskripsi->ultrafiltrasi_mode }}"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="natrium_mode" class="form-label" style="width: 200px">Natrium
                                            Mode</label>
                                        <input type="text" name="natrium_mode" id="natrium_mode" class="form-control"
                                            value="{{ $asesmen->deskripsi->natrium_mode }}" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="bicabornat_mode" class="form-label" style="width: 200px">Bicabornat
                                            Mode</label>
