                            ...
                            <div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group align-items-center">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="number" name="sistole" id="sistole" class="form-control" value="{{ $asesmen->fisik->sistole }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="diastole" class="form-label">Diastole</label>
                                                <input type="number" name="diastole" id="diastole" class="form-control" value="{{ $asesmen->fisik->diastole }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nadi" id="nadi" class="form-control" value="{{ $asesmen->fisik->nadi }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="nafas" style="min-width: 200px;">Nafas (Per Menit)</label>
                                        <input type="number" name="nafas" id="nafas" class="form-control" value="{{ $asesmen->fisik->nafas }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="suhu" style="min-width: 200px;">Suhu (C)</label>
                                        <input type="number" name="suhu" id="suhu" class="form-control" value="{{ $asesmen->fisik->suhu }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group align-items-center">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="number" name="so_tb_o2" id="so_tb_o2" class="form-control" value="{{ $asesmen->fisik->so_tb_o2 }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="so_db_o2" class="form-label">Dengan bantuan O2</label>
                                                <input type="number" name="so_db_o2" id="so_db_o2" class="form-control" value="{{ $asesmen->fisik->so_db_o2 }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-control" onkeyup="hitungImtLpt()" value="{{ $asesmen->fisik->tinggi_badan }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="berat_badan" style="min-width: 200px;">Berat Badan (Kg)</label>
                                        <input type="number" name="berat_badan" id="berat_badan" class="form-control" onkeyup="hitungImtLpt()" value="{{ $asesmen->fisik->berat_badan }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="imt" style="min-width: 200px;">Index Massa Tubuh (IMT)</label>
                                        <input type="number" name="imt" id="imt" class="form-control" value="{{ $asesmen->fisik->imt }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="lpt" style="min-width: 200px;">Luas Permukaan Tubuh (LPT)</label>
                                        <input type="number" name="lpt" id="lpt" class="form-control" value="{{ $asesmen->fisik->lpt }}" disabled>
                                    </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="skala_nyeri" id="skala_nyeri" min="0" max="10" value="{{ $asesmen->fisik->skala_nyeri }}" disabled>
                                    </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="efek_samping" id="efek_samping" value="{{ $asesmen->fisik->efek_samping }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="hb" id="hb" class="form-control" value="{{ $asesmen->penunjang->hb }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="hbsag" class="form-label">HbsAg</label>
                                                <input type="text" name="hbsag" id="hbsag" class="form-control" value="{{ $asesmen->penunjang->hbsag }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="phospor" class="form-label">Phospor</label>
                                                <input type="text" name="phospor" id="phospor" class="form-control" value="{{ $asesmen->penunjang->phospor }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="fe_serum" class="form-label">Fe Serum</label>
                                                <input type="text" name="fe_serum" id="fe_serum" class="form-control" value="{{ $asesmen->penunjang->fe_serum }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="gol_darah" class="form-label">Gol Darah</label>
                                                <input type="text" name="gol_darah" id="gol_darah" class="form-control" value="{{ $asesmen->penunjang->gol_darah }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="calcium" class="form-label">Calcium</label>
                                                <input type="text" name="calcium" id="calcium" class="form-control" value="{{ $asesmen->penunjang->calcium }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="kalium" class="form-label">Kalium</label>
                                                <input type="text" name="kalium" id="kalium" class="form-control" value="{{ $asesmen->penunjang->kalium }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="natrium" class="form-label">Natrium</label>
                                                <input type="text" name="natrium" id="natrium" class="form-control" value="{{ $asesmen->penunjang->natrium }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="ureum" class="form-label">Ureum</label>
                                                <input type="text" name="ureum" id="ureum" class="form-control" value="{{ $asesmen->penunjang->ureum }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="asam_urat" class="form-label">Asam Urat</label>
                                                <input type="text" name="asam_urat" id="asam_urat" class="form-control" value="{{ $asesmen->penunjang->asam_urat }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="creatinin" class="form-label">Creatinin</label>
                                                <input type="text" name="creatinin" id="creatinin" class="form-control" value="{{ $asesmen->penunjang->creatinin }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="tibc" class="form-label">TIBC</label>
                                                <input type="text" name="tibc" id="tibc" class="form-control" value="{{ $asesmen->penunjang->tibc }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="hcv" class="form-label">Anti HCV</label>
                                                <input type="text" name="hcv" id="hcv" class="form-control" value="{{ $asesmen->penunjang->hcv }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="hiv" class="form-label">Anti HIV</label>
                                                <input type="text" name="hiv" id="hiv" class="form-control" value="{{ $asesmen->penunjang->hiv }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="gula_darah" class="form-label">Gula Darah</label>
                                                <input type="text" name="gula_darah" id="gula_darah" class="form-control" value="{{ $asesmen->penunjang->gula_darah }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="lab_lainnya" class="form-label">Lainnya</label>
                                                <input type="text" name="lab_lainnya" id="lab_lainnya" class="form-control" value="{{ $asesmen->penunjang->lab_lainnya }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="ekg" id="ekg" value="{{ $asesmen->penunjang->ekg }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="rongent" style="min-width: 200px;">Rongent</label>
                                        <input type="text" class="form-control" name="rongent" id="rongent" value="{{ $asesmen->penunjang->rongent }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="usg" style="min-width: 200px;">USG</label>
                                        <input type="text" class="form-control" name="usg" id="usg" value="{{ $asesmen->penunjang->usg }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="rutin" id="rutin" class="form-control" value="{{ $asesmen->deskripsi->rutin }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="jenis_dialisat" style="min-width: 200px;">Jenis Dialisat</label>
                                        <select name="jenis_dialisat" id="jenis_dialisat" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="suhu_dialisat" id="suhu_dialisat" class="form-control" value="{{ $asesmen->deskripsi->suhu_dialisat }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="akses_vaskular" style="min-width: 200px;">Akses Vaskular</label>
                                        <select name="akses_vaskular" id="akses_vaskular" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="lama_hd" id="lama_hd" class="form-control" value="{{ $asesmen->deskripsi->lama_hd }}" disabled>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="qb" id="qb" class="form-control" value="{{ $asesmen->deskripsi->qb }}" disabled>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="qd" id="qd" class="form-control" value="{{ $asesmen->deskripsi->qd }}" disabled>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="uf_goal" id="uf_goal" class="form-control"  value="{{ $asesmen->deskripsi->uf_goal }}" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="dosis_awal" id="dosis_awal" class="form-control"  value="{{ $asesmen->deskripsi->dosis_awal }}" disabled>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="m_kontinyu" id="m_kontinyu" class="form-control" value="{{ $asesmen->deskripsi->m_kontinyu }}" disabled>
                                                    <span class="input-group-text">IU</span>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="m_intermiten" id="m_intermiten" class="form-control" value="{{ $asesmen->deskripsi->m_intermiten }}" disabled>
                                                    <span class="input-group-text">IU</span>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <label for="tanpa_heparin" class="form-label">Tanpa Heparin</label>
                                                <input type="text" name="tanpa_heparin" id="tanpa_heparin" class="form-control" value="{{ $asesmen->deskripsi->tanpa_heparin }}" disabled>
                                            </div>
                                            <div class="col-6">
                                                <label for="lmwh" class="form-label">LMWH</label>
                                                <div class="input-group">
                                                    <input type="number" name="lmwh" id="lmwh" class="form-control" value="{{ $asesmen->deskripsi->lmwh }}" disabled>
                                                    <span class="input-group-text">IU</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="ultrafiltrasi_mode" id="ultrafiltrasi_mode" class="form-control" value="{{ $asesmen->deskripsi->ultrafiltrasi_mode }}" disabled>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="natrium_mode" class="form-label" style="width: 200px">Natrium Mode</label>
                                                    <input type="text" name="natrium_mode" id="natrium_mode" class="form-control" value="{{ $asesmen->deskripsi->natrium_mode }}" disabled>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="bicabornat_mode" class="form-label" style="width: 200px">Bicabornat Mode</label>
                                                    <input type="text" name="bicabornat_mode" id="bicabornat_mode" class="form-control" value="{{ $asesmen->deskripsi->bicabornat_mode }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="dokter_pelaksana" id="dokter_pelaksana" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
