...
@push('js')
    <script>
        var hdIndexUrl = "{{ route('hemodialisa.pending-order') }}";
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="dropdown"></div>
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('hemodialisa.terima-order', [':id_hash']) }}">Terima Order</a></li>
                                </ul>
                            </div>
                        </div>`.replace(':id_hash', row.id_hash);
                        }
                    },
                    {
                        data: 'nama_pasien',
