    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="extraLargeModalLabel">Catatan Perkembangan Pasien Terintegrasi (CPPT)</h5>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="#" class="btn btn-sm btn-secondary"><i class="bi bi-plus-square"></i>
                                    ICD-10</a>
                            </div>
                            <div class="row">
                                <div class="col-12">
