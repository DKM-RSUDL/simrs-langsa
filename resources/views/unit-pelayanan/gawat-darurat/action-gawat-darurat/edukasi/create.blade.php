    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="edukasiForm" method="POST"
                    ...
                    route('edukasi.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $existingEdukasi->id]) :
                    route('edukasi.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                @csrf
                @if($hasExistingData)
                    @method('PUT')
                @endif
                ...
                {{-- <form id="edukasiForm" method="POST"
                    action="{{ route('edukasi.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $edukasi->id]) }}">
                    @csrf --}}
