        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Edukasi Pasien dan Keluarga Terintegrasi',
                    'description' =>
                        'Tambah data edukasi pasien dan keluarga terintegrasi pasien gawat darurat dengan mengisi formulir di bawah ini.',
                ])
                @php
                ...
                <form id="edukasiForm" method="POST"
                    ...
                    <div class="section-separator" id="kemampuan-baca-tulis">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="kemampuan_baca_tulis">
                                <option value="">--Pilih--</option>
                                <option value="baik"
                                    {{ getExistingValue($edukasiPasien, 'kemampuan_baca_tulis') == 'baik' ? 'selected' : '' }}>
                                    Baik
                                </option>
                                <option value="kurang"
                                    {{ getExistingValue($edukasiPasien, 'kemampuan_baca_tulis') == 'kurang' ? 'selected' : '' }}>
                                    Kurang
                                </option>
                                <option value="tidak_mampu"
                                    {{ getExistingValue($edukasiPasien, 'kemampuan_baca_tulis') == 'tidak_mampu' ? 'selected' : '' }}>
                                    Tidak mampu
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="edukasi-cards">
                            ...
                            @if (in_array(1, $sectionAccess))
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        <h6 class="card-title">1. Kondisi medis, diagnosis, rencana perawatan dan terapi
                                            yang diberikan</h6>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    value="re_demonstrasi"
                                                    {{ isExistingChecked($kebutuhanEdukasi, 'evaluasi_4', 're_demonstrasi') ? 'checked' : '' }}>
                                                <label class="form-check-label"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="lama_edukasi_4"
                                                placeholder="Masukkan lama edukasi"
                                                value="{{ getExistingValue($kebutuhanEdukasi, 'lama_edukasi_4') }}">
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tanggal_5"
                                                placeholder="Masukkan lama edukasi"
                                                value="{{ getExistingValue($kebutuhanEdukasi, 'tanggal_5') }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Sasaran</label>
                    ...
                    <div class="text-end">
                        <x-button-submit id="simpan"></x-button-submit>
                    </div>
