                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="penerjemah_tidak"
                                                name="kebutuhan_penerjemah" value="0" {{ old('kebutuhan_penerjemah',
                                                getRelationValue($edukasi->edukasiPasien, 'kebutuhan_penerjemah')) ==
                                            '0' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="penerjemah_tidak">Tidak</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="penerjemah_ya"
                                                name="kebutuhan_penerjemah" value="1" {{ old('kebutuhan_penerjemah',
                                                getRelationValue($edukasi->edukasiPasien, 'kebutuhan_penerjemah')) ==
                                            '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                $pemahaman_awal_1 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_1)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_1_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_1_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                $metode_1 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_1_lisan" name="metode_1[]" value="lisan" {{
                                                            in_array('lisan', $metode_1) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_1_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_1_demonstrasi" name="metode_1[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_1)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                $media_1 = isset($edukasi->kebutuhanEdukasi) &&
                                                $edukasi->kebutuhanEdukasi->media_1 ?
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_1_leaflet" name="media_1[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_1_booklet" name="media_1[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_1_audiovisual" name="media_1[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_1)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                ...
                                                @php
                                                $evaluasi_1 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_1)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_1_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_1)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_2 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_2)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_2_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_2_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_2 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_2_lisan" name="metode_2[]" value="lisan" {{
                                                            in_array('lisan', $metode_2) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_2_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_2_demonstrasi" name="metode_2[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_2)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_2 = isset($edukasi->kebutuhanEdukasi) &&
                                                $edukasi->kebutuhanEdukasi->media_2 ?
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_2_leaflet" name="media_2[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_2_booklet" name="media_2[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_2_audiovisual" name="media_2[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_2)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_2 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_2)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_2_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_2)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_3 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_3)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_3_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_3_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_3 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_3_lisan" name="metode_3[]" value="lisan" {{
                                                            in_array('lisan', $metode_3) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_3_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_3_demonstrasi" name="metode_3[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_3)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_3 = isset($edukasi->kebutuhanEdukasi) &&
                                                $edukasi->kebutuhanEdukasi->media_3 ?
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_3_leaflet" name="media_3[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_3_booklet" name="media_3[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_3_audiovisual" name="media_3[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_3)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_3 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_3)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_3_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_3)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_4 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_4)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_4_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_4_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_4 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_4_lisan" name="metode_4[]" value="lisan" {{
                                                            in_array('lisan', $metode_4) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_4_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_4_demonstrasi" name="metode_4[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_4)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_4 = isset($edukasi->kebutuhanEdukasi) &&
                                                $edukasi->kebutuhanEdukasi->media_4 ?
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_4_leaflet" name="media_4[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_4_booklet" name="media_4[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_4_audiovisual" name="media_4[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_4)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_4 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_4)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_4_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_4)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_5 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_5)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_5_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_5_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_5 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_5_lisan" name="metode_5[]" value="lisan" {{
                                                            in_array('lisan', $metode_5) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_5_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_5_demonstrasi" name="metode_5[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_5)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_5 = isset($edukasi->kebutuhanEdukasi) &&
                                                $edukasi->kebutuhanEdukasi->media_5 ?
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_5_leaflet" name="media_5[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_5_booklet" name="media_5[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_5_audiovisual" name="media_5[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_5)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_5 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_5)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_5_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_5)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_6 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_6)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_6_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_6_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_6 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_6_lisan" name="metode_6[]" value="lisan" {{
                                                            in_array('lisan', $metode_6) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_6_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_6_demonstrasi" name="metode_6[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_6)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_6 = isset($edukasi->kebutuhanEdukasi) &&
                                                $edukasi->kebutuhanEdukasi->media_6 ?
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_6_leaflet" name="media_6[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_6_booklet" name="media_6[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_6_audiovisual" name="media_6[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_6)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_6 = isset($edukasi->kebutuhanEdukasi) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_6)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_6_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_6)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_7 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_7)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_7_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_7_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_7 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_7_lisan" name="metode_7[]" value="lisan" {{
                                                            in_array('lisan', $metode_7) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_7_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_7_demonstrasi" name="metode_7[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_7)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_7 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_7_leaflet" name="media_7[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_7_booklet" name="media_7[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_7_audiovisual" name="media_7[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_7)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_7 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_7)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_7_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_7)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_9 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_9)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_9_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_9_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_9 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_9_lisan" name="metode_9[]" value="lisan" {{
                                                            in_array('lisan', $metode_9) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_9_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_9_demonstrasi" name="metode_9[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_9)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_9 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_9_leaflet" name="media_9[]" value="leaflet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_9_booklet" name="media_9[]" value="booklet" {{
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_9_audiovisual" name="media_9[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_9)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_9 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_9)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_9_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_9)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_10 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_10)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_10_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_10_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_10 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_10_lisan" name="metode_10[]" value="lisan" {{
                                                            in_array('lisan', $metode_10) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_10_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_10_demonstrasi" name="metode_10[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_10)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_10 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_10_audiovisual" name="media_10[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_10)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_10 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_10)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_10_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_10)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_11 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_11)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_11_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_11_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_11 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_11_lisan" name="metode_11[]" value="lisan" {{
                                                            in_array('lisan', $metode_11) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_11_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_11_demonstrasi" name="metode_11[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_11)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_11 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_11_audiovisual" name="media_11[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_11)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_11 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_11)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_11_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_11)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_12 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_12)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_12_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_12_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_12 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_12_lisan" name="metode_12[]" value="lisan" {{
                                                            in_array('lisan', $metode_12) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_12_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_12_demonstrasi" name="metode_12[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_12)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_12 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_12_audiovisual" name="media_12[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_12)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_12 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_12)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_12_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_12)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_13 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_13)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_13_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_13_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_13 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_13_lisan" name="metode_13[]" value="lisan" {{
                                                            in_array('lisan', $metode_13) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_13_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_13_demonstrasi" name="metode_13[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_13)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_13 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_13_audiovisual" name="media_13[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_13)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_13 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_13)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_13_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_13)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_14 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_14)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_14_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_14_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_14 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_14_lisan" name="metode_14[]" value="lisan" {{
                                                            in_array('lisan', $metode_14) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_14_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_14_demonstrasi" name="metode_14[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_14)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_14 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_14_audiovisual" name="media_14[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_14)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_14 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_14)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_14_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_14)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_15 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_15)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_15_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_15_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_15 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_15_lisan" name="metode_15[]" value="lisan" {{
                                                            in_array('lisan', $metode_15) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_15_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_15_demonstrasi" name="metode_15[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_15)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_15 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_15_audiovisual" name="media_15[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_15)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_15 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_15)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_15_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_15)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                    ...
                                    <div class="card edukasi-card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                                @php
                                                $pemahaman_awal_16 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="hal_baru" {{ in_array('hal_baru', $pemahaman_awal_16)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="pemahaman_awal_16_hal_baru">Hal Baru</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="pemahaman_awal_16_edukasi_ulang"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Metode</label>
                                                @php
                                                $metode_16 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_16_lisan" name="metode_16[]" value="lisan" {{
                                                            in_array('lisan', $metode_16) ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="metode_16_lisan">Lisan</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="metode_16_demonstrasi" name="metode_16[]"
                                                            value="demonstrasi" {{ in_array('demonstrasi', $metode_16)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Media</label>
                                                @php
                                                $media_16 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="media_16_audiovisual" name="media_16[]"
                                                            value="audiovisual" {{ in_array('audiovisual', $media_16)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="form-group">
                                                <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                                @php
                                                $evaluasi_16 = isset($edukasi->kebutuhanEdukasiLanjutan) &&
                                                ...
                                                <div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="sudah_paham" {{ in_array('sudah_paham', $evaluasi_16)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
                                                            for="evaluasi_16_sudah_paham">Sudah Paham</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="re_edukasi" {{ in_array('re_edukasi', $evaluasi_16)
                                                            ? 'checked' : '' }}>
                                                        <label class="form-check-label"
