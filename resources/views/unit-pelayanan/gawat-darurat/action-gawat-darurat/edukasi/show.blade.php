        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Rincian Edukasi Pasien dan Keluarga Terintegrasi',
                    'description' =>
                        'Rincian data edukasi pasien dan keluarga terintegrasi pasien gawat darurat.',
                ])
                        ...
                        <div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="penerjemah_tidak"
                                    ...
                                    {{ isset($edukasi->edukasiPasien) && $edukasi->edukasiPasien->kebutuhan_penerjemah == 0 ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="penerjemah_ya"
                                    ...
                                    {{ isset($edukasi->edukasiPasien) && $edukasi->edukasiPasien->kebutuhan_penerjemah == 1 ? 'checked' : '' }}>
                ...
                <div class="section-separator" id="tipe-pembelajaran">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            @php
                                $tipe_pembelajaran =
                                    isset($edukasi->edukasiPasien) && $edukasi->edukasiPasien->tipe_pembelajaran
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input tipe-pembelajaran" id="tipe_verbal"
                                    name="tipe_pembelajaran[]" value="verbal" disabled
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input tipe-pembelajaran" id="tipe_tulisan"
                                    name="tipe_pembelajaran[]" value="tulisan" disabled
                ...
                <div class="section-separator" id="hambatan-komunikasi">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            @php
                                $hambatan_komunikasi =
                                    isset($edukasi->edukasiPasien) && $edukasi->edukasiPasien->hambatan_komunikasi
                            ...
                            @endphp
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input hambatan-komunikasi" id="hambatan_tidak_ada"
                                    name="hambatan_komunikasi[]" value="tidak_ada" disabled
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input hambatan-komunikasi"
                                    id="hambatan_penglihatan" name="hambatan_komunikasi[]" value="penglihatan" disabled
                ...
                <div class="section-separator" id="kebutuhan-edukasi-table">
                    ...
                    <div class="edukasi-cards">
                        ...
                        <div class="card edukasi-card mb-4">
                            <div class="card-body">
                                <h6 class="card-title">1. Kondisi medis, diagnosis, rencana perawatan dan terapi yang
                                    diberikan</h6>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Keterangan</label>
                                    <input type="text" class="form-control" name="ket_Kondisi_medis_1"
                                        value="{{ $edukasi->kebutuhanEdukasi->ket_kondisi_medis_1 ?? '' }}" readonly>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                ...
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_1) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                ...
                                                value="edukasi_ulang" disabled
                                                {{ in_array('edukasi_ulang', $pemahaman_awal_1) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="pemahaman_awal_1_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @php
                                        $metode_1 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_1
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $evaluasi_1 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_1
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                ...
                                                disabled {{ in_array('re_demonstrasi', $evaluasi_1) ? 'checked' : '' }}>
                        ...
                        <div class="card edukasi-card mb-4">
                            <div class="card-body">
                                <h6 class="card-title">2. Kemungkinan hasil yang tidak dapat diantisipasi dari terapi dan
                                    perawatan</h6>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Tanggal</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="pemahaman_awal_2_hal_baru" name="pemahaman_awal_2[]" value="hal_baru"
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_2) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="pemahaman_awal_2_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @php
                                        $metode_2 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_2
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $evaluasi_2 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_2
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_2_re_demonstrasi" name="evaluasi_2[]" value="re_demonstrasi"
                                                disabled {{ in_array('re_demonstrasi', $evaluasi_2) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                        ...
                        <div class="card edukasi-card mb-4">
                            <div class="card-body">
                                <h6 class="card-title">3. Manfaat obat-obatan, efek samping, serta interaksi obat dan
                                    makanan yang diberikan</h6>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Tanggal</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="pemahaman_awal_3_hal_baru" name="pemahaman_awal_3[]" value="hal_baru"
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_3) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="pemahaman_awal_3_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @php
                                        $metode_3 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_3
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $evaluasi_3 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_3
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_3_re_demonstrasi" name="evaluasi_3[]" value="re_demonstrasi"
                                                disabled {{ in_array('re_demonstrasi', $evaluasi_3) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="pemahaman_awal_4_hal_baru" name="pemahaman_awal_4[]" value="hal_baru"
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_4) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="pemahaman_awal_4_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @php
                                        $metode_4 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_4
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $evaluasi_4 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_4
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_4_re_demonstrasi" name="evaluasi_4[]" value="re_demonstrasi"
                                                disabled {{ in_array('re_demonstrasi', $evaluasi_4) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                        ...
                        <div class="card edukasi-card mb-4">
                            <div class="card-body">
                                <h6 class="card-title">5. Manajemen Nyeri kemungkinan timbulnya nyeri setelah menerima
                                    terapi/prosedur/perawatan medis/Pilihan tatalaksana Nyeri</h6>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Tanggal</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="pemahaman_awal_5_hal_baru" name="pemahaman_awal_5[]" value="hal_baru"
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_5) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="pemahaman_awal_5_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @php
                                        $metode_5 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_5
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $evaluasi_5 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_5
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_5_re_demonstrasi" name="evaluasi_5[]" value="re_demonstrasi"
                                                disabled {{ in_array('re_demonstrasi', $evaluasi_5) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="pemahaman_awal_6_hal_baru" name="pemahaman_awal_6[]" value="hal_baru"
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_6) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="pemahaman_awal_6_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @php
                                        $metode_6 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_6
                                ...
                                <div class="form-group">
                                    ...
                                    @php
                                        $evaluasi_6 =
                                            isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_6
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_6_re_demonstrasi" name="evaluasi_6[]" value="re_demonstrasi"
                                                disabled {{ in_array('re_demonstrasi', $evaluasi_6) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="pemahaman_awal_7_hal_baru" name="pemahaman_awal_7[]" value="hal_baru"
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_7) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="pemahaman_awal_7_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_7_re_demonstrasi" name="evaluasi_7[]" value="re_demonstrasi"
                                                disabled {{ in_array('re_demonstrasi', $evaluasi_7) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="pemahaman_awal_9_hal_baru" name="pemahaman_awal_9[]" value="hal_baru"
                                                disabled {{ in_array('hal_baru', $pemahaman_awal_9) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="pemahaman_awal_9_edukasi_ulang">Edukasi
                                                Ulang</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_9_sudah_paham" name="evaluasi_9[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_9) ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_10_sudah_paham" name="evaluasi_10[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_10) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_10_re_edukasi" name="evaluasi_10[]" value="re_edukasi"
                                                disabled {{ in_array('re_edukasi', $evaluasi_10) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_11_sudah_paham" name="evaluasi_11[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_11) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_11_re_edukasi" name="evaluasi_11[]" value="re_edukasi"
                                                disabled {{ in_array('re_edukasi', $evaluasi_11) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_12_sudah_paham" name="evaluasi_12[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_12) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_12_re_edukasi" name="evaluasi_12[]" value="re_edukasi"
                                                disabled {{ in_array('re_edukasi', $evaluasi_12) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_13_sudah_paham" name="evaluasi_13[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_13) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_13_re_edukasi" name="evaluasi_13[]" value="re_edukasi"
                                                disabled {{ in_array('re_edukasi', $evaluasi_13) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_14_sudah_paham" name="evaluasi_14[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_14) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_14_re_edukasi" name="evaluasi_14[]" value="re_edukasi"
                                                disabled {{ in_array('re_edukasi', $evaluasi_14) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_15_sudah_paham" name="evaluasi_15[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_15) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_15_re_edukasi" name="evaluasi_15[]" value="re_edukasi"
                                                disabled {{ in_array('re_edukasi', $evaluasi_15) ? 'checked' : '' }}>
                                            <label class="form-check-label"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_16_sudah_paham" name="evaluasi_16[]" value="sudah_paham"
                                                disabled {{ in_array('sudah_paham', $evaluasi_16) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input"
                                                id="evaluasi_16_re_edukasi" name="evaluasi_16[]" value="re_edukasi"
                                                disabled {{ in_array('re_edukasi', $evaluasi_16) ? 'checked' : '' }}>
                                            <label class="form-check-label"
