        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Persetujuan Transfusi Darah/Produk Darah',
                    'description' =>
                        'Tambah data persetujuan transfusi darah/produk darah pasien rawat inap dengan mengisi formulir di bawah ini.',
                ])
                        ...
                        <div class="radio-group">
                            <div class="radio-item">
                                <input type="radio" id="diri_sendiri" name="persetujuan_untuk" value="diri_sendiri"
                                    {{ old('persetujuan_untuk') == 'diri_sendiri' ? 'checked' : '' }} required>
                            ...
                            <div class="radio-item">
                                <input type="radio" id="keluarga" name="persetujuan_untuk" value="keluarga"
                                    {{ old('persetujuan_untuk') == 'keluarga' ? 'checked' : '' }} required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="no_telp_keluarga"
                                        name="no_telp_keluarga" value="{{ old('no_telp_keluarga') }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="no_ktp_keluarga"
                                        name="no_ktp_keluarga" value="{{ old('no_ktp_keluarga') }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jk_saksi1" name="jk_saksi1">
                                        <option value="">Pilih Jenis Kelamin</option>
                                        <option value="1" {{ old('jk_saksi1') == 'Laki-laki' ? 'selected' : '' }}>
                                            Laki-laki
                                        </option>
                                        <option value="0" {{ old('jk_saksi1') == 'Perempuan' ? 'selected' : '' }}>
                                            Perempuan
                                        </option>
                                    </select>
                                    @error('jk_saksi1')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="no_telp_saksi1" name="no_telp_saksi1"
                                        value="{{ old('no_telp_saksi1') }}" placeholder="Contoh: 08226742xxxx"
                                        maxlength="12">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="no_ktp_saksi1" name="no_ktp_saksi1"
                                        value="{{ old('no_ktp_saksi1') }}" placeholder="Masukkan nomor KTP/SIM"
                                        maxlength="16">
                                    @error('no_ktp_saksi1')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="no_telp_saksi2" name="no_telp_saksi2"
                                        value="{{ old('no_telp_saksi2') }}" placeholder="Contoh: 08226742xxxx"
                                        maxlength="12">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="no_ktp_saksi2" name="no_ktp_saksi2"
                                        value="{{ old('no_ktp_saksi2') }}" placeholder="Masukkan nomor KTP/SIM"
                                        maxlength="16">
                                    @error('no_ktp_saksi2')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="radio-group">
                            <div class="radio-item">
                                <input type="radio" id="setuju" name="persetujuan" value="setuju"
                                    {{ old('persetujuan') == 'setuju' ? 'checked' : '' }} required>
                            ...
                            <div class="radio-item">
                                <input type="radio" id="tidak_setuju" name="persetujuan" value="tidak_setuju"
                                    {{ old('persetujuan') == 'tidak_setuju' ? 'checked' : '' }} required>
