        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Persetujuan Transfusi Darah/Produk Darah',
                    'description' =>
                        'Perbarui data persetujuan transfusi darah/produk darah pasien rawat inap dengan mengisi formulir di bawah ini.',
                ])
                ...
                <form id="transfusi_form" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal" name="tanggal"
                                        value="{{ old('tanggal', $persetujuan->tanggal ? $persetujuan->tanggal->format('Y-m-d') : '') }}"
                                        required>
                                    @error('tanggal')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control" id="jam" name="jam"
                                        value="{{ $persetujuan->jam_masuk ? \Carbon\Carbon::parse($persetujuan->jam_masuk)->format('H:i') : date('H:i') }}"
                                        required>
                                    @error('jam')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="diagnosa" name="diagnosa"
                                        value="{{ old('diagnosa', $persetujuan->diagnosa) }}"
                                        placeholder="Masukkan diagnosa pasien" required>
                                    @error('diagnosa')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="radio-group">
                            <div class="radio-item">
                                <input type="radio" id="diri_sendiri" name="persetujuan_untuk" value="diri_sendiri"
                                    {{ old('persetujuan_untuk', $persetujuan->persetujuan_untuk) == 'diri_sendiri' ? 'checked' : '' }}
                                    required>
                            ...
                            <div class="radio-item">
                                <input type="radio" id="keluarga" name="persetujuan_untuk" value="keluarga"
                                    {{ old('persetujuan_untuk', $persetujuan->persetujuan_untuk) == 'keluarga' ? 'checked' : '' }}
                                    required>
                    ...
                    <div id="keluarga-section" class="section-card hidden-section"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_keluarga" name="nama_keluarga"
                                        value="{{ old('nama_keluarga', $persetujuan->nama_keluarga) }}"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jk_keluarga" name="jk_keluarga">
                                        ...
                                        <option value="1"
                                            {{ old('jk_keluarga', $persetujuan->jk_keluarga) == '1' ? 'selected' : '' }}>
                                            Laki-laki</option>
                                        <option value="0"
                                            {{ old('jk_keluarga', $persetujuan->jk_keluarga) == '0' ? 'selected' : '' }}>
                                            Perempuan</option>
                                    </select>
                                    @error('jk_keluarga')
                                        <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="no_telp_keluarga"
                                        name="no_telp_keluarga"
                                        value="{{ old('no_telp_keluarga', $persetujuan->no_telp_keluarga) }}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_ktp_keluarga"
                                        name="no_ktp_keluarga"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Hubungan dengan pihak yang diwakili <span
                    ...
                    <div class="info-box">
                        ...
                        <p class="mb-3">
                            Telah membaca atau dibacakan keterangan pada <span class="fw-bold">form edukasi
                                transfusi
                                darah</span> (di halaman belakang) dan telah
                            dijelaskan hal-hal terkait mengenai prosedur transfusi darah yang akan dilakukan
                            terhadap
                            diri saya sendiri /
                        ...
                        <ul class="info-list">
                            ...
                            <li>Memahami risiko yang mungkin terjadi saat atau sesudah pelaksanaan pemberian darah
                                dan
                                produk darah</li>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jk_saksi1" name="jk_saksi1">
                                        <option value="">Pilih Jenis Kelamin</option>
                                        <option value="1"
                                            {{ old('jk_saksi1', $persetujuan->jk_saksi1) == '1' ? 'selected' : '' }}>
                                            Laki-laki</option>
                                        <option value="0"
                                            {{ old('jk_saksi1', $persetujuan->jk_saksi1) == '0' ? 'selected' : '' }}>
                                            Perempuan</option>
                                    </select>
                                    @error('jk_saksi1')
                                        <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jk_saksi2" name="jk_saksi2">
                                        <option value="">Pilih Jenis Kelamin</option>
                                        <option value="1"
                                            {{ old('jk_saksi2', $persetujuan->jk_saksi2) == '1' ? 'selected' : '' }}>
                                            Laki-laki</option>
                                        <option value="0"
                                            {{ old('jk_saksi2', $persetujuan->jk_saksi2) == '0' ? 'selected' : '' }}>
                                            Perempuan</option>
                                    </select>
                                    @error('jk_saksi2')
                                        <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="radio-group">
                            <div class="radio-item">
                                <input type="radio" id="setuju" name="persetujuan" value="setuju"
                                    {{ old('persetujuan', $persetujuan->persetujuan) == 'setuju' ? 'checked' : '' }}
                                    required>
                            ...
                            <div class="radio-item">
                                <input type="radio" id="tidak_setuju" name="persetujuan" value="tidak_setuju"
                                    {{ old('persetujuan', $persetujuan->persetujuan) == 'tidak_setuju' ? 'checked' : '' }}
                                    required>
                    ...
                    <!-- Bagian Tanda Tangan -->
                    <div class="row">
                        <p class="fw-bold">Atas pemberian darah dan produk darah terhadap diri saya sendiri / pihak
                            yang
                            saya wakili. </p>
                    ...
                    @if ($persetujuan->userEdit)
                        <div class="alert alert-info mt-3">
                            ...
                            pada
                            {{ $persetujuan->updated_at ? $persetujuan->updated_at->format('d/m/Y H:i') : '-' }}
                        </div>
                    @endif
