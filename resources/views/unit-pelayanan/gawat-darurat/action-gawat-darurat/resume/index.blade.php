                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="resep" role="tabpanel"
                                ...
                                @if (!empty($dataGet) && count($dataGet) > 0)
                                    @include('unit-pelayanan.gawat-darurat.action-gawat-darurat.resume.resume-medis.resume-medis')
                                @else
                            ...
                            <div class="tab-pane fade" id="riwayat" role="tabpanel" aria-labelledby="riwayat-tab">
                                ...
                                @if (!empty($dataProfileRingkas) && count($dataProfileRingkas) > 0)
                                    @include('unit-pelayanan.gawat-darurat.action-gawat-darurat.resume.resume-profil-ringkas-medis.profil_ringkas_medis')
                                @else
                                    <div>Tidak ada data yang ditampilkan.</div>
                                @endif
                            </div>
