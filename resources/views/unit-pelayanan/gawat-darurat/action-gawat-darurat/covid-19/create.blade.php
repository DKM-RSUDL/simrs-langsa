...
@include('unit-pelayanan.gawat-darurat.action-gawat-darurat.covid-19.include-create')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="covid_form" method="POST"
                action="{{ route('covid-19.store', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
