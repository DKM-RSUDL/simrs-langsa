...
<!-- Modal Alergi -->
<div class="modal fade" id="addAlergiModal" tabindex="-1" aria-labelledby="addAlergiModalLabel" aria-hidden="true"
    style="z-index: 1060;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" id="alergenInput" placeholder="Nama Alergen"
                        autocomplete="off">
                </div>
                <div class="mb-3">
                ...
                <button type="button" id="btnAddListAlergi"
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateModalView() {
            listAlergi.innerHTML = alergis.map(a =>
                `<li>${a.jenis} - ${a.alergen} - ${a.reaksi} (${a.keparahan})</li>`).join('');
        }
        ...
        document.getElementById('btnAddListAlergi').addEventListener('click', function() {
            ...
            if (jenisAlergiInput.value.trim() !== '' && alergenInput.value.trim() !== '' && reaksiInput
                .value.trim() !== '' && keparahanInput.value !== '') {
                alergis.push({
