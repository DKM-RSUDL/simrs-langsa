            ...
            <div class="card">
                <div class="card-body">
                    <div class="px-3">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <h4 class="header-asesmen">Asesmen Awal Gawat Darurat Medis</h4>
                                <p class="text-muted">
                        ...
                        <div class="px-3">
                                                ...
                                                <td class="p-3">
                                                    ...
                                                    <div class="form-check mb-2">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="Bersihkan jalan nafas" id="bersihkanJalanNafas">
                                                ...
                                                <td class="p-3">
                                                    <div class="form-check mb-2">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="Kompresi jantung" id="kompresiJantung">
                            ...
                            <div class="text-end mt-4 mb-3">
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="ti-check"></i> Simpan Asesmen
                                </button>
                            </div>
