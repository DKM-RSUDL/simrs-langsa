        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Data Asesmen Medis',
                    'description' =>
                        'Perbarui data asesmen medis pasien gawat darurat dengan mengisi formulir di bawah ini.',
                ])
                                    ...
                                    <tr>
                                        @php
                                            ...
                                            if (isset($asesmen->tindakan_resusitasi)) {
                                                if (is_array($asesmen->tindakan_resusitasi)) {
                                                    ...
                                                    $decoded = json_decode($asesmen->tindakan_resusitasi, true);
                                                    $tindakanResusitasi = is_array($decoded) ? $decoded : [];
                                                }
                                            }
                                        ...
                                        <td class="p-3">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="hyperekstesi_edit">Hyperekstesi</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input"
                                                    name="tindakan_resusitasi[air_way][]" value="Bersihkan jalan nafas"
                                                    id="bersihkanJalanNafas_edit"
                                                    {{ in_array('Bersihkan jalan nafas', $airWay) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="bersihkanJalanNafas_edit">Bersihkan
                                                    jalan nafas</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    name="tindakan_resusitasi[air_way][]" value="Intubasi"
                                                    id="intubasi_edit" {{ in_array('Intubasi', $airWay) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="intubasi_edit">Intubasi</label>
                                            </div>
                                        </td>
                                        <td class="p-3">
                                            <div class="form-check mb-2">
                                        ...
                                        <td class="p-3">
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    id="kompresiJantung_edit"
                                                    {{ in_array('Kompresi jantung', $circulation) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="kompresiJantung_edit">Kompresi
                                                    jantung</label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input"
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="operasi_edit">Operasi</label>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <div class="col-md-6">
                                <div class="vital-sign-group">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" step="0.1" class="form-control"
                                            name="antropometri[lpt]" value="{{ $antropometriData['lpt'] ?? '' }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="lokasi"
                                        placeholder="Contoh: Kepala, Dada" value="{{ $asesmen->lokasi ?? '' }}">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="durasi"
                                        placeholder="Contoh: 2 jam, 30 menit" value="{{ $asesmen->durasi ?? '' }}">
                                </div>
