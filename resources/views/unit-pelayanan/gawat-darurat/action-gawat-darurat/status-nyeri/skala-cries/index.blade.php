                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="statusNyeriTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('status-nyeri.skala-numerik.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                    class="nav-link @if (request()->routeIs('status-nyeri.skala-numerik.*')) active @endif">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('status-nyeri.skala-cries.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                    class="nav-link @if (request()->routeIs('status-nyeri.skala-cries.*')) active @endif">
                                    <i class="bi bi-person-heart me-2"></i>
                                    Skala CRIES
                                </a>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active">
                                ...
                                <div class="row">
                                    <form method="GET" action="{{ route('status-nyeri.skala-cries.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                                        <div class="row m-3">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3 text-end">
                                                <a href="{{ route('status-nyeri.skala-cries.create', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ route('status-nyeri.skala-cries.show', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                   class="btn btn-info btn-sm me-2" title="Lihat Detail">
                                                                    <i class="ti-eye"></i>
                                                                </a>
                                                                <a href="{{ route('status-nyeri.skala-cries.edit', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                   class="btn btn-warning btn-sm me-2" title="Edit">
                                                                    <i class="ti-pencil"></i>
                                                                </a>
                                                                <form action="{{ route('status-nyeri.skala-cries.destroy', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}" 
