        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Rincian Data Monitoring Transfusi Darah',
                    'description' => 'Rincian data monitoring transfusi darah pasien gawat darurat.',
                ])
                <div>
                    <!-- Informasi Dasar -->
                    <div class="card mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            {{ date('H:i', strtotime($monitoring->jam_mulai_transfusi)) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value">
                                            {{ date('H:i', strtotime($monitoring->jam_selesai_transfusi)) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <div
                                    class="alert {{ $monitoring->reaksi_selama_transfusi || $monitoring->reaksi_transfusi ? 'alert-warning' : 'alert-success' }}">
