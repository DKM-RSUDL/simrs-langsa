...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('permintaan-second-opinion.show', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $secondOpinion->id]) }}" class="btn btn-outline-info">
