        ...
        <form action="{{ route('gawat-darurat.store-triase') }}" method="post" enctype="multipart/form-data">
            ...
            <x-content-card>
                @include('components.page-header', [
                    'title' => 'Triase Pasien Gawat Darurat (Skala ATS)',
                    'description' => 'Isikan triase pada saat pasien masuk.',
                ])
                <div class="row">
                    <div class="col-md-4">
                        <x-content-card>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="dokter_triase" id="dokter_triase"
                                            class="form-select w-100 select2 @error('dokter_triase') is-invalid @enderror"
                                            required>
                                    ...
                                    <div class="form-group mt-3">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input type="number" name="usia_bulan" id="usia_bulan" min="0"
                                                    max="11" class="form-control" value="{{ old('usia_bulan') }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group mt-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="form-check mx-5">
                                                <input class="form-check-input @error('rujukan') is-invalid @enderror"
                                                    type="radio" name="rujukan" id="rujukan_yes" value="1"
                                                    @checked(old('rujukan') == '1') required>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('rujukan') is-invalid @enderror"
                                                    type="radio" name="rujukan" id="rujukan_no" value="0"
                                                    @checked(old('rujukan') == '0') required>
                                    ...
                                    <div class="form-group mt-1">
                                        <label for="#rujukan_ket" class="text-primary">Jika ya,
                                            dari</label>
                                        <input type="text" name="rujukan_ket" id="rujukan_ket" class="form-control"
                                            value="{{ old('rujukan_ket') }}">
                                    </div>
                        ...
                        <div class="row g-4">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="spo2_tanpa_o2" id="spo2_tanpa_o2"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="spo2_dengan_o2">SpO2 (dengan
                                                        O2)</label>
                                                    <input type="number" name="spo2_dengan_o2" id="spo2_dengan_o2"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-check mt-3">
                                            <input class="form-check-input false-emergency-check" type="checkbox"
                                                name="airway[]" value="Bebas" id="airway_bebas">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input doa-check" type="checkbox" name="airway[]"
                                                value="Tidak ada tanda-tanda kehidupan" id="airway_mati">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-check mt-3">
                                            <input class="form-check-input false-emergency-check" type="checkbox"
                                                name="breathing[]" value="Normal" id="breathing_normal">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="breathing[]" value="Takipnoe" id="breathing_takipnoe">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="breathing[]" value="RR > 20 X/mnt" id="breathing_rr">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="breathing[]" value="Henti Nafas" id="breathing_henti_nafas">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="breathing[]" value="Bradipnoe" id="breathing_bradipnoe">
                                            <label class="form-check-label" for="breathing_bradipnoe">
                                                Bradipnoe
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input doa-check" type="checkbox" name="breathing[]"
                                                value="Tidak ada denyut nadi" id="breathing_mati">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-check mt-3">
                                            <input class="form-check-input false-emergency-check" type="checkbox"
                                                name="circulation[]" value="Nadi Kuat" id="circulation_nadi_kuat">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input false-emergency-check" type="checkbox"
                                                name="circulation[]" value="Frekuensi Normal"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input false-emergency-check" type="checkbox"
                                                name="circulation[]" value="TD sistole 90-159 mmHg"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="circulation[]" value="Nadi Lemah" id="circulation_nadi_lemah">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="circulation[]" value="Bradikardia" id="circulation_bradikardia">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="circulation[]" value="Takikardi" id="circulation_takikardi">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="circulation[]" value="Pucat" id="circulation_pucat">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="circulation[]" value="CRT > 2 detik" id="circulation_crt">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="circulation[]" value="Tanda-tanda dehidrasi sedang-berat"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="circulation[]" value="Suhu > 40 C" id="circulation_suhu">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="circulation[]" value="Henti Jantung / Ketiadaan Sirkulasi"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="circulation[]" value="Nadi tak teraba"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="circulation[]" value="Sianosis" id="circulation_cianosis">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-check mt-3">
                                            <input class="form-check-input false-emergency-check" type="checkbox"
                                                name="disability[]" value="Sadar" id="disability_sadar">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input false-emergency-check" type="checkbox"
                                                name="disability[]" value="GCS 15" id="disability_gcs_15">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input urgent-check" type="checkbox"
                                                name="disability[]" value="GCS >= 12" id="disability_gcs_12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="disability[]" value="GCS 9-12" id="disability_gcs_9_12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="disability[]" value="Gelisah" id="disability_gelisah">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="disability[]" value="Nyeri Dada" id="disability_nyeri_dada">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input emergency-check" type="checkbox"
                                                name="disability[]" value="Hemiparese Akut"
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="disability[]" value="GCS < 9" id="disability_gcs_under_9">
                                            <label class="form-check-label" for="disability_gcs_under_9">
                                                GCS < 9 </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="disability[]" value="Tidak ada respon" id="disability_no_respon">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input resusitasi-check" type="checkbox"
                                                name="disability[]" value="Kejang" id="disability_kejang">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center w-100">
                                    <p class="fw-medium text-nowrap text-primary m-0 p-0">Kesimpulan Triase :</p>
                                    <button type="button" id="triaseStatusLabel" class="btn btn-block ms-3 w-100"
                                        data-bs-toggle="modal" data-bs-target="#kodeTriaseModal"></button>
