...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <!-- Tombol Kembali -->
            <div class="mb-3">
                <a href="{{ route('status-fungsional.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
            ...
            <div class="text-center mt-4">
                ...
                <a href="{{ route('status-fungsional.edit', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $statusFungsional->id]) }}"
                    class="btn btn-warning btn-action">
                    <i class="ti-pencil"></i> Edit Data
                </a>
                <form action="{{ route('status-fungsional.destroy', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $statusFungsional->id]) }}"
