...
@include('unit-pelayanan.gawat-darurat.action-gawat-darurat.status-fungsional.include-edit')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="barthel_form" method="POST"
                action="{{ route('status-fungsional.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $statusFungsional->id]) }}">
                @csrf
                @method('PUT')
