                    ...
                    <div class="card-body">
                        ...
                        <div class="px-3">
                            ...
                            <div class="section-separator">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tanggal" id="tanggal" class="form-control date"
                                        value="{{ date('Y-m-d', strtotime($dnr->tanggal)) }}" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_hp_dokter" name="no_hp_dokter"
                                        value="{{ $dnr->no_hp_dokter }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-control">
                                    <input type="radio" name="instruksi" id="instruksi" class="form-check-input me-1"
                                        value="1" @checked($dnr->instruksi == 1) disabled>
                                    <label for="instruksi">
                                ...
                                <div class="form-control mt-2">
                                    <input type="radio" name="instruksi" id="intruksi1" class="form-check-input me-1"
                                        value="2" @checked($dnr->instruksi == 2) disabled>
                                    <label for="intruksi1">
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-control">
                                    <input type="radio" name="keputusan" id="keputusan1" class="form-check-input me-1"
                                        value="1" @checked($dnr->keputusan == 1) disabled>
                                ...
                                <div class="form-control mt-2">
                                    <input type="radio" name="keputusan" id="keputusan2" class="form-check-input me-1"
                                        value="2" @checked($dnr->keputusan == 2) disabled>
                                ...
                                <div class="form-control mt-2">
                                    <input type="radio" name="keputusan" id="keputusan3" class="form-check-input me-1"
                                        value="3" @checked($dnr->keputusan == 3) disabled>
                                ...
                                <div class="form-control mt-2">
                                    <input type="radio" name="keputusan" id="keputusan4" class="form-check-input me-1"
                                        value="4" @checked($dnr->keputusan == 4) disabled>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-control">
                                    <input type="radio" name="dasar_perintah" id="perintah1" class="form-check-input me-1"
                                        value="1" @checked($dnr->dasar_perintah == 1) disabled>
                                    <label for="perintah1">
                                ...
                                <div class="form-control">
                                    <input type="radio" name="dasar_perintah" id="perintah2" class="form-check-input me-1"
                                        value="2" @checked($dnr->dasar_perintah == 2) disabled>
                                    <label for="perintah2">
