                    ...
                    <tbody>
                        @forelse($rujukan ?? [] as $r)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-info show-btn" data-id="{{ $r->id }}" data-bs-toggle="modal"
                                        data-bs-target="#showRujukAntarRs" title="Lihat Detail">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                    <button class="btn btn-sm btn-warning edit-btn" data-id="{{ $r->id }}" data-bs-toggle="modal"
                                        data-bs-target="#editRujukAntarRs" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <form action="/unit-pelayanan/gawat-darurat/pelayanan/{{ $dataMedis->kd_pasien }}/{{ $dataMedis->tgl_masuk }}/{{ $dataMedis->urut_masuk }}/rujuk-antar-rs/{{ $r->id }}" method="POST" class="d-inline delete-form">
                                        @csrf
                                        @method('DELETE')
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.show-btn', function() {
            ...
            // Fetch rujukan data
            $.ajax({
                url: "/unit-pelayanan/gawat-darurat/pelayanan/{{ $dataMedis->kd_pasien }}/{{ $dataMedis->tgl_masuk }}/{{ $dataMedis->urut_masuk }}/rujuk-antar-rs/" + id,
                type: 'GET',
                dataType: 'json',
