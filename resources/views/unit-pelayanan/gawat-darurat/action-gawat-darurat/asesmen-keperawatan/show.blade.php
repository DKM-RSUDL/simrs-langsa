                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="waktu_asesmen" id="tgl_asesmen_keperawatan"
                                                class="form-control"
                                                value="{{ old('waktu_asesmen', date('Y-m-d', strtotime($asesmen->waktu_asesmen))) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="jam_asesmen" id="jam_asesmen_keperawatan"
                                                class="form-control"
                                                value="{{ old('jam_asesmen', date('H:i', strtotime($asesmen->waktu_asesmen))) }}" disabled>
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-7">
                                ...
                                <div>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="1" {{ $asesmen->asesmenKepUmum && !is_null($asesmen->asesmenKepUmum->airway_diagnosis) ? 'checked' : '' }} disabled>
                                                                <!-- Tambahkan hidden input untuk memastikan field selalu dikirim -->
                                                                <input type="hidden" name="current_airway_diagnosis"
                                                                    value="{{ $asesmen->asesmenKepUmum->airway_diagnosis ?? '' }}" disabled>
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        value="1" {{ $asesmen->asesmenKepUmum && $asesmen->asesmenKepUmum->airway_diagnosis == '1' ? 'checked' : '' }} {{ !$asesmen->asesmenKepUmum || is_null($asesmen->asesmenKepUmum->airway_diagnosis) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        value="2" {{ $asesmen->asesmenKepUmum && $asesmen->asesmenKepUmum->airway_diagnosis == '2' ? 'checked' : '' }} {{ !$asesmen->asesmenKepUmum || is_null($asesmen->asesmenKepUmum->airway_diagnosis) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="w-100">
                                                <input type="hidden" id="existingTindakan-airway"
                                                    value="{{ optional($asesmen->asesmenKepUmum)->airway_tindakan }}" disabled>
                                    ...
                                    <div class="section-separator" id="status-breathing">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="breathing_frekuensi_nafas"
                                                value="{{ optional($asesmen->asesmenKepUmumBreathing)->breathing_frekuensi_nafas }}" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="breathing_lainnya"
                                                value="{{ old('breathing_lainnya', $asesmen->asesmenKepUmumBreathing->breathing_lainnya ?? '') }}" disabled>
                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    name="breathing_diagnosis_nafas[]" value="pola_nafas" {{ !empty($asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden"
                                                                    name="current_breathing_diagnosis_nafas"
                                                                    value="{{ $asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas ?? '' }}" disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        id="breathing_aktual"
                                                                        name="breathing_diagnosis_type" value="1" {{ $asesmen->asesmenKepUmumBreathing && $asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        id="breathing_risiko"
                                                                        name="breathing_diagnosis_type" value="2" {{ $asesmen->asesmenKepUmumBreathing && $asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="gangguan" {{ !empty($asesmen->asesmenKepUmumBreathing->breathing_gangguan) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="current_breathing_gangguan"
                                                                    value="{{ $asesmen->asesmenKepUmumBreathing->breathing_gangguan ?? '' }}" disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        name="breathing_gangguan_type" value="1" {{ $asesmen->asesmenKepUmumBreathing && $asesmen->asesmenKepUmumBreathing->breathing_gangguan == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumBreathing->breathing_gangguan) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        name="breathing_gangguan_type" value="2" {{ $asesmen->asesmenKepUmumBreathing && $asesmen->asesmenKepUmumBreathing->breathing_gangguan == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumBreathing->breathing_gangguan) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="w-100">
                                                <input type="hidden" id="existingTindakan-breathing"
                                                    value="{{ optional($asesmen->asesmenKepUmumBreathing)->breathing_tindakan }}" disabled>
                                    ...
                                    <div class="section-separator">
                                            ...
                                            <div class="d-flex gap-3" style="width: 100%;">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <input class="form-control" type="number"
                                                        ...
                                                        value="{{ optional($asesmen->asesmenKepUmumCirculation)->circulation_transfusi_jumlah }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                ...
                                                value="{{ optional($asesmen->asesmenKepUmumCirculation)->circulation_lain }}" disabled>
                                        </div>
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    name="circulation_diagnosis_perfusi" value="1" {{ !empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="circulation_diagnosis_perfusi"
                                                                    value="{{ $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi ?? '' }}" disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumCirculation && $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumCirculation && $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    name="circulation_diagnosis_defisit" value="1" {{ !empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="circulation_diagnosis_defisit"
                                                                    value="{{ $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit ?? '' }}" disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumCirculation && $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumCirculation && $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="w-100">
                                                <input type="hidden" id="existingTindakan-circulation"
                                                    value='{{ optional($asesmen->asesmenKepUmumCirculation)->circulation_tindakan ?? '[]' }}' disabled>
                                                {{-- <button type="button"
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="disability_diameter_pupil"
                                                value="{{ optional($asesmen->asesmenKepUmumDisability)->disability_diameter_pupil }}" disabled>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="disability_kekuatan_otot"
                                                value="{{ optional($asesmen->asesmenKepUmumDisability)->disability_kekuatan_otot }}" disabled>
                                        </div>
                                        <div class="form-group diagnosis-section">
                                            <label style="min-width: 200px;">Diagnosis Keperawatan</label>
                                            <div class="w-100">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="perfusi_jaringan_cereberal_tidak_efektif" {{ !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="disability_diagnosis_perfusi"
                                                                    value="{{ $asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi ?? '' }}" disabled>
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="intoleransi_aktivitas" {{ !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="disability_diagnosis_intoleransi"
                                                                    value="{{ $asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi ?? '' }}" disabled>
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        value="1" {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        name="disability_diagnosis_intoleransi_type"
                                                                        value="2" {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="kendala_komunikasi_verbal" {{ !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="disability_diagnosis_komunikasi"
                                                                    value="{{ $asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi ?? '' }}" disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        value="1" {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        name="disability_diagnosis_komunikasi_type"
                                                                        value="2" {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="kejang_ulang" {{ !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="disability_diagnosis_perfusi"
                                                                    value="{{ $asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang ?? '' }}" disabled>
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        name="disability_diagnosis_kejang_type" value="1" {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        name="disability_diagnosis_kejang_type" value="2" {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="penurunan_kesadaran" {{ !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="disability_diagnosis_kesadaran"
                                                                    value="{{ $asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran ?? '' }}" disabled>
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumDisability && $asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ optional($asesmen->asesmenKepUmumDisability)->disability_lainnya }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="w-100">
                                                <input type="hidden" id="existingTindakan-disability"
                                                    value='{{ optional($asesmen->asesmenKepUmumDisability)->disability_tindakan ?? '[]' }}' disabled>
                                                {{-- <button type="button"
                                    ...
                                    <div class="section-separator">
                                            ...
                                            <div class="d-flex align-items-center gap-4" style="width: 100%;">
                                                <div class="d-flex gap-4">
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="deformitas_tidak"
                                                            name="exposure_deformitas" value="0" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_deformitas == '0' ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="deformitas_tidak">Tidak</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="deformitas_ya"
                                                            name="exposure_deformitas" value="1" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_deformitas == '1' ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="flex-grow-1">
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_deformitas_daerah }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center gap-4" style="width: 100%;">
                                                <div class="d-flex gap-4">
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="kontusion_tidak"
                                                            name="exposure_kontusion" value="0" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_kontusion == '0' ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="kontusion_tidak">Tidak</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="kontusion_ya"
                                                            name="exposure_kontusion" value="1" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_kontusion == '1' ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="flex-grow-1">
                                                    <input type="text" class="form-control" name="exposure_kontusion_daerah"
                                                        placeholder="Daerah"
                                                        value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_kontusion_daerah }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center gap-4" style="width: 100%;">
                                                <div class="d-flex gap-4">
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="abrasi_tidak"
                                                            name="exposure_abrasi" value="0" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_abrasi == '0' ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="abrasi_tidak">Tidak</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="abrasi_ya"
                                                            name="exposure_abrasi" value="1" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_abrasi == '1' ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="flex-grow-1">
                                                    <input type="text" class="form-control" name="exposure_abrasi_daerah"
                                                        placeholder="Daerah"
                                                        value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_abrasi_daerah }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex gap-4">
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="penetrasi_tidak"
                                                            name="exposure_penetrasi" value="0" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_penetrasi == '0' ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="penetrasi_tidak">Tidak</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="penetrasi_ya"
                                                            name="exposure_penetrasi" value="1" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_penetrasi == '1' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="d-flex align-items-center gap-4" style="width: 100%;">
                                                <div class="d-flex gap-4">
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="laserasi_tidak"
                                                            name="exposure_laserasi" value="0" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_laserasi == '0' ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="laserasi_tidak">Tidak</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="laserasi_ya"
                                                            name="exposure_laserasi" value="1" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_laserasi == '1' ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="flex-grow-1">
                                                    <input type="text" class="form-control" name="exposure_laserasi_daerah"
                                                        placeholder="Daerah"
                                                        value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_laserasi_daerah }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center gap-4" style="width: 100%;">
                                                <div class="d-flex gap-4">
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="edema_tidak"
                                                            name="exposure_edema" value="0" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_edema == '0' ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="edema_tidak">Tidak</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="radio" class="form-check-input" id="edema_ya"
                                                            name="exposure_edema" value="1" {{ optional($asesmen->asesmenKepUmumExposure)->exposure_edema == '1' ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="flex-grow-1">
                                                    <input type="text" class="form-control" name="exposure_edema_daerah"
                                                        placeholder="Daerah"
                                                        value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_edema_daerah }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="exposure_kedalaman_luka"
                                                value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_kedalaman_luka }}" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label style="min-width: 200px;">Lainnya</label>
                                            <input type="text" class="form-control" name="exposure_lainnya"
                                                value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_lainnya }}" disabled>
                                        </div>
                                            ...
                                            <div class="w-100">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="mobilitasi_type" {{ !empty($asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="exposure_diagnosis_mobilitasi"
                                                                    value="{{ $asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi ?? '' }}" disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumExposure && $asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumExposure && $asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="integritas_type" {{ !empty($asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas) ? 'checked' : '' }} disabled>
                                                                <!-- Hidden input untuk menjaga nilai saat ini -->
                                                                <input type="hidden" name="exposure_diagosis_integritas"
                                                                    value="{{ $asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas ?? '' }}" disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumExposure && $asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas == '1' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                                ...
                                                                <div class="form-check">
                                                                    <input type="radio" class="form-check-input"
                                                                        ...
                                                                        {{ $asesmen->asesmenKepUmumExposure && $asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas == '2' ? 'checked' : '' }} {{ empty($asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas) ? 'disabled' : '' }} disabled>
                                                                    <label class="form-check-label"
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ optional($asesmen->asesmenKepUmumExposure)->exposure_diagnosis_lainnya }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="w-100">
                                                <input type="hidden" id="existingTindakan-exposure"
                                                    value='{{ optional($asesmen->asesmenKepUmumExposure)->exposure_tindakan ?? '[]' }}' disabled>
                                                {{-- <button type="button"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="skala_nyeri_lokasi"
                                                        value="{{ old('skala_nyeri_lokasi', $asesmen->asesmenKepUmumSkalaNyeri->skala_nyeri_lokasi ?? '') }}" disabled>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="skala_nyeri_durasi"
                                                        value="{{ old('skala_nyeri_durasi', $asesmen->asesmenKepUmumSkalaNyeri->skala_nyeri_durasi ?? '') }}" disabled>
                                                </div>
                                        ...
                                        <div id="skala_umumForm" class="risk-form"
                                            ...
                                            <div class="conclusion bg-success">
                                                ...
                                                <input type="hidden" name="risiko_jatuh_umum_kesimpulan"
                                                    ...
                                                    value="{{ old('risiko_jatuh_umum_kesimpulan', $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_kesimpulan ?? '') }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div id="skala_morseForm" class="risk-form"
                                            ...
                                            <div class="conclusion bg-success">
                                                ...
                                                <input type="hidden" name="risiko_jatuh_morse_kesimpulan"
                                                    ...
                                                    value="{{ old('risiko_jatuh_morse_kesimpulan', $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_kesimpulan ?? '') }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div id="skala_humptyForm" class="risk-form"
                                            ...
                                            <div class="conclusion bg-success">
                                                ...
                                                <input type="hidden" name="risiko_jatuh_pediatrik_kesimpulan"
                                                    ...
                                                    value="{{ old('risiko_jatuh_pediatrik_kesimpulan', $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_kesimpulan ?? '') }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div id="skala_ontarioForm" class="risk-form"
                                            ...
                                            <div class="conclusion bg-success">
                                                ...
                                                <input type="hidden" name="risiko_jatuh_lansia_kesimpulan"
                                                    ...
                                                    value="{{ old('risiko_jatuh_lansia_kesimpulan', $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_kesimpulan ?? '') }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="hidden" id="existingTindakan-risikojatuh"
                                            value='{{ old('risik_jatuh_tindakan', optional($asesmen->asesmenKepUmumRisikoJatuh)->risik_jatuh_tindakan ?? '[]') }}' disabled>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('psikologis_lainnya') is-invalid @enderror"
                                            ...
                                            rows="3" disabled>{{ old('psikologis_lainnya', $asesmen->asesmenKepUmum->psikologis_lainnya ?? '') }}</textarea>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="spiritual_nilai"
                                            rows="3" disabled>{{ old('spiritual_nilai', $asesmen->asesmenKepUmum->spiritual_nilai ?? '') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sosial_ekonomi_curiga_suku"
                                            value="{{ old('sosial_ekonomi_curiga_suku', $asesmen->asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_suku ?? '') }}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label style="min-width: 200px;">Budaya</label>
                                        <input type="text" class="form-control" name="sosial_ekonomi_curiga_budaya"
                                            value="{{ old('sosial_ekonomi_curiga_budaya', $asesmen->asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_budaya ?? '') }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea
                                            ...
                                            rows="3" disabled>{{ old('sosial_ekonomi_keterangan_lain', $asesmen->asesmenKepUmumSosialEkonomi->sosial_ekonomi_keterangan_lain ?? '') }}</textarea>
                                    ...
                                    <div id="mna" class="assessment-form"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="gizi_mna_berat_badan"
                                                ...
                                                value="{{ old('gizi_mna_berat_badan', $asesmen->asesmenKepUmumGizi->gizi_mna_berat_badan ?? '') }}" disabled>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="gizi_mna_tinggi_badan"
                                                ...
                                                value="{{ old('gizi_mna_tinggi_badan', $asesmen->asesmenKepUmumGizi->gizi_mna_tinggi_badan ?? '') }}" disabled>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="gizi_mna_imt"
                                                ...
                                                value="{{ old('gizi_mna_imt', $asesmen->asesmenKepUmumGizi->gizi_mna_imt ?? '') }}" disabled>
                                            @error('gizi_mna_imt')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea
                                            ...
                                            rows="3" disabled>{{ old('kebutuhan_edukasi_keterangan_lain', $asesmen->asesmenKepUmum->kebutuhan_edukasi_keterangan_lain ?? '') }}</textarea>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('discharge_planning_diagnosis_medis', $asesmen->asesmenKepUmum->discharge_planning_diagnosis_medis ?? '') }}" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            name="discharge_planning_pelayanan_medis" id="pelayanan_medis_berkelanjutan" disabled>
                                            <option value="">pilih</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            id="ketergantungan_aktivitas" disabled>
                                            <option value="">pilih</option>
                    ...
                    <form id="evaluationForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control soap-format" id="eval_objective" rows="2"
                                placeholder="O: TD: 120/80 mmHg, N: 80x/menit, RR: 20x/menit, S: 36.5°C..." disabled></textarea>
                        </div>
                        <div class="mb-3">
