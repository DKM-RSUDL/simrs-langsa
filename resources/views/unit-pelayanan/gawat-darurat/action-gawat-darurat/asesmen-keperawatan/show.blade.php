...
@section('content')
@include('unit-pelayanan.gawat-darurat.action-gawat-darurat.asesmen-keperawatan.include-show')
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <form id="asesmenForm" method="" action="">
            @csrf
                            ...
                            <div>
                                <div class="section-separator" id="status-airway">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="airway_status" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="bebas" {{ $asesmen->asesmenKepUmum->airway_status == 'bebas'
                                                ? 'selected' : '' }}>
                                                Bebas</option>
                                            <option value="pangkal lidah jatuh" {{ $asesmen->
                                                asesmenKepUmum->airway_status == 'pangkal lidah jatuh' ? 'selected' : ''
                                                }}>
                                                Tidak Bebas (Pangkal Lidah Jatuh)</option>
                                            <option value="sputum" {{ $asesmen->asesmenKepUmum->airway_status ==
                                                'sputum' ? 'selected' : '' }}>
                                                Tidak Bebas (Sputum)</option>
                                            <option value="darah" {{ $asesmen->asesmenKepUmum->airway_status == 'darah'
                                                ? 'selected' : '' }}>
                                                Tidak Bebas (darah)</option>
                                            <option value="spasm" {{ $asesmen->asesmenKepUmum->airway_status == 'spasm'
                                                ? 'selected' : '' }}>
                                                Tidak Bebas (Spasm)</option>
                                            <option value="benda asing" {{ $asesmen->asesmenKepUmum->airway_status ==
                                                'benda asing' ? 'selected' : '' }}>
                                                Tidak Bebas (Benda Asing)</option>
                                            <option value="lainnya" {{ $asesmen->asesmenKepUmum->airway_status ==
                                                'lainnya' ? 'selected' : '' }}>
                                                Lainnya</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="airway_suara_nafas" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="normal" {{ $asesmen->asesmenKepUmum->airway_suara_nafas ==
                                                'normal' ? 'selected' : '' }}>
                                                Normal</option>
                                            <option value="whezing" {{ $asesmen->asesmenKepUmum->airway_suara_nafas ==
                                                'whezing' ? 'selected' : '' }}>
                                                Whezing</option>
                                            <option value="ronchi" {{ $asesmen->asesmenKepUmum->airway_suara_nafas ==
                                                'ronchi' ? 'selected' : '' }}>
                                                Ronchi</option>
                                            <option value="crackles" {{ $asesmen->asesmenKepUmum->airway_suara_nafas ==
                                                'crackles' ? 'selected' : '' }}>
                                                Crackles</option>
                                            <option value="stridor" {{ $asesmen->asesmenKepUmum->airway_suara_nafas ==
                                                'stridor' ? 'selected' : '' }}>
                                                Stridor</option>
                                        </select>
                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                value="1" {{ $asesmen->asesmenKepUmum &&
                                                            !is_null($asesmen->asesmenKepUmum->airway_diagnosis) ?
                                                            'checked' : '' }} disabled>
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    value="1" {{ $asesmen->asesmenKepUmum &&
                                                                $asesmen->asesmenKepUmum->airway_diagnosis == '1' ?
                                                                'checked' : '' }} {{ !$asesmen->asesmenKepUmum ||
                                                                is_null($asesmen->asesmenKepUmum->airway_diagnosis) ?
                                                                'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    value="2" {{ $asesmen->asesmenKepUmum &&
                                                                $asesmen->asesmenKepUmum->airway_diagnosis == '2' ?
                                                                'checked' : '' }} {{ !$asesmen->asesmenKepUmum ||
                                                                is_null($asesmen->asesmenKepUmum->airway_diagnosis) ?
                                                                'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                ...
                                <div class="section-separator" id="status-breathing">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="breathing_pola_nafas" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="Normal" {{ old('breathing_pola_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_pola_nafas ?? '') == 'Normal' ?
                                                'selected' : '' }}>
                                                Normal</option>
                                            <option value="Apnea" {{ old('breathing_pola_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_pola_nafas ?? '') == 'Apnea' ?
                                                'selected' : '' }}>
                                                Apnea</option>
                                            <option value="Sesak" {{ old('breathing_pola_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_pola_nafas ?? '') == 'Sesak' ?
                                                'selected' : '' }}>
                                                Sesak</option>
                                            <option value="Bradipnea" {{ old('breathing_pola_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_pola_nafas ?? '') == 'Bradipnea' ?
                                                'selected' : '' }}>
                                                Bradipnea</option>
                                            <option value="Takipnea" {{ old('breathing_pola_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_pola_nafas ?? '') == 'Takipnea' ?
                                                'selected' : '' }}>
                                                Takipnea</option>
                                            <option value="Othopnea" {{ old('breathing_pola_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_pola_nafas ?? '') == 'Othopnea' ?
                                                'selected' : '' }}>
                                                Othopnea</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="breathing_bunyi_nafas" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="Normal" {{ old('breathing_bunyi_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_bunyi_nafas ?? '') == 'Normal' ?
                                                'selected' : '' }}>
                                                Normal</option>
                                            <option value="Veskuler" {{ old('breathing_bunyi_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_bunyi_nafas ?? '') == 'Veskuler' ?
                                                'selected' : '' }}>
                                                Veskuler</option>
                                            <option value="Wheezing" {{ old('breathing_bunyi_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_bunyi_nafas ?? '') == 'Wheezing' ?
                                                'selected' : '' }}>
                                                Whezing</option>
                                            <option value="Stridor" {{ old('breathing_bunyi_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_bunyi_nafas ?? '') == 'Stridor' ?
                                                'selected' : '' }}>
                                                Stridor</option>
                                            <option value="Ronchi" {{ old('breathing_bunyi_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_bunyi_nafas ?? '') == 'Ronchi' ?
                                                'selected' : '' }}>
                                                Ronchi</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="breathing_irama_nafas" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="1" {{ old('breathing_irama_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_irama_nafas ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Teratur</option>
                                            <option value="0" {{ old('breathing_irama_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_irama_nafas ?? '') == '0' ?
                                                'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="breathing_tanda_distress" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="Tidak Ada Tanda Distress" {{ old('breathing_tanda_distress',
                                                $asesmen->asesmenKepUmumBreathing->breathing_tanda_distress ?? '') ==
                                                'Tidak Ada Tanda Distress' ? 'selected' : '' }}>
                                                Tidak Ada Tanda Distress</option>
                                            <option value="Penggunaan Otot Bantu" {{ old('breathing_tanda_distress',
                                                $asesmen->asesmenKepUmumBreathing->breathing_tanda_distress ?? '') ==
                                                'Penggunaan Otot Bantu' ? 'selected' : '' }}>
                                                Penggunaan Otot Bantu</option>
                                            <option value="Retraksi Dada/Intercosta" {{ old('breathing_tanda_distress',
                                                $asesmen->asesmenKepUmumBreathing->breathing_tanda_distress ?? '') ==
                                                'Retraksi Dada/Intercosta' ? 'selected' : '' }}>
                                                Retraksi Dada/Intercosta</option>
                                            <option value="Cupling Hidung" {{ old('breathing_tanda_distress', $asesmen->
                                                asesmenKepUmumBreathing->breathing_tanda_distress ?? '') == 'Cupling
                                                Hidung' ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="breathing_jalan_nafas" disabled>
                                            <option value="">Pilih</option>
                                            <option value="1" {{ old('breathing_jalan_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_jalan_nafas ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Pernafasan Dada</option>
                                            <option value="2" {{ old('breathing_jalan_nafas', $asesmen->
                                                asesmenKepUmumBreathing->breathing_jalan_nafas ?? '') == '2' ?
                                                'selected' : '' }}>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                !empty($asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas)
                                                            ? 'checked' : '' }} disabled>
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    $asesmen->asesmenKepUmumBreathing &&
                                                                $asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumBreathing->breathing_diagnosis_nafas)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                value="gangguan" {{
                                                                !empty($asesmen->asesmenKepUmumBreathing->breathing_gangguan)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    $asesmen->asesmenKepUmumBreathing &&
                                                                $asesmen->asesmenKepUmumBreathing->breathing_gangguan ==
                                                                '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumBreathing->breathing_gangguan)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="circulation_akral" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="1" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_akral == '1' ? 'selected' : ''
                                                }}>
                                                Hangat</option>
                                            <option value="2" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_akral == '2' ? 'selected' : ''
                                                }}>
                                                Dingin</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="circulation_pucat" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="1" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_pucat == '1' ? 'selected' : ''
                                                }}>
                                                Ya</option>
                                            <option value="0" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_pucat == '0' ? 'selected' : ''
                                                }}>
                                                Tidak</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="circulation_cianosis" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="1" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_cianosis == '1' ? 'selected' :
                                                '' }}>
                                                Ya</option>
                                            <option value="0" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_cianosis == '0' ? 'selected' :
                                                '' }}>
                                                Tidak</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="circulation_kapiler" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="1" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_kapiler == '1' ? 'selected' : ''
                                                }}>
                                                < 2 Detik</option>
                                            <option value="2" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_kapiler == '2' ? 'selected' : ''
                                                }}>
                                                > 2 Detik</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-3" style="width: 100%;">
                                            <div class="flex-grow-1">
                                                ...
                                                <select class="form-select" name="circulation_transfusi" disabled>
                                                    <option value="">--Pilih--</option>
                                                    <option value="1" {{ optional($asesmen->
                                                        asesmenKepUmumCirculation)->circulation_transfusi == '1' ?
                                                        'selected' : '' }}>Ya</option>
                                                    <option value="0" {{ optional($asesmen->
                                                        asesmenKepUmumCirculation)->circulation_transfusi == '0' ?
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="circulation_nadi_irama" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="reguler" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_nadi_irama == 'reguler' ?
                                                'selected' : '' }}>Reguler</option>
                                            <option value="irreguler" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_nadi_irama == 'irreguler' ?
                                                'selected' : '' }}>Irreguler</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label style="min-width: 200px;">Nadi Kekuatan</label>
                                        <select class="form-select" name="circulation_nadi_kekuatan" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="kuat" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_nadi_kekuatan == 'kuat' ?
                                                'selected' : '' }}>Kuat</option>
                                            <option value="lemah" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_nadi_kekuatan == 'lemah' ?
                                                'selected' : '' }}>Lemah</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label style="min-width: 200px;">Kelembapan Kulit</label>
                                        <select class="form-select" name="circulation_kelembapan_kulit" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="1" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_kelembapan_kulit == '1' ?
                                                'selected' : '' }}>
                                                Lembab</option>
                                            <option value="2" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_kelembapan_kulit == '2' ?
                                                'selected' : '' }}>
                                                Kering</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="circulation_turgor" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="1" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_turgor == '1' ? 'selected' : ''
                                                }}>
                                                Normal</option>
                                            <option value="0" {{ optional($asesmen->
                                                asesmenKepUmumCirculation)->circulation_turgor == '0' ? 'selected' : ''
                                                }}>
                                                Kurang</option>
                                        </select>
                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                name="circulation_diagnosis_perfusi" value="1" {{
                                                                !empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    {{ $asesmen->asesmenKepUmumCirculation &&
                                                                $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_perfusi)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                name="circulation_diagnosis_defisit" value="1" {{
                                                                !empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    {{ $asesmen->asesmenKepUmumCirculation &&
                                                                $asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumCirculation->circulation_diagnosis_defisit)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            $vitalSigns = json_decode($asesmen->asesmenKepUmumDisability->vital_sign,
                                            true);
                                            ...
                                            <button type="button" class="btn btn-outline-primary"
                                                ...
                                                <i class="ti-calculator"></i> Detail GCS
                                            </button>
                                        </div>

                                        @push('modals')
                                        @include('unit-pelayanan.gawat-darurat.action-gawat-darurat.asesmen-keperawatan.show-gcs-modal')
                                        @endpush
                                    </div>

                                    <div class="form-group">
                                        <label style="min-width: 200px;">Kesadaran</label>
                                        <select class="form-select" name="disability_kesadaran" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="Compos Mentis" {{ optional($asesmen->
                                                asesmenKepUmumDisability)->disability_kesadaran == 'Compos Mentis' ?
                                                'selected' : '' }}>
                                                Compos Mentis</option>
                                            <option value="Apatis" {{ optional($asesmen->
                                                asesmenKepUmumDisability)->disability_kesadaran == 'Apatis' ? 'selected'
                                                : '' }}>
                                                Apatis</option>
                                            <option value="Somnolen" {{ optional($asesmen->
                                                asesmenKepUmumDisability)->disability_kesadaran == 'Somnolen' ?
                                                'selected' : '' }}>
                                                Somnolen</option>
                                            <option value="Sopor" {{ optional($asesmen->
                                                asesmenKepUmumDisability)->disability_kesadaran == 'Sopor' ? 'selected'
                                                : '' }}>
                                                Sopor</option>
                                            <option value="Coma" {{ optional($asesmen->
                                                asesmenKepUmumDisability)->disability_kesadaran == 'Coma' ? 'selected' :
                                                '' }}>
                                                Coma</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-3" style="width: 100%;">
                                            <div class="flex-grow-1">
                                                ...
                                                <select class="form-select" name="disability_isokor" disabled>
                                                    <option value="">--Pilih--</option>
                                                    <option value="1" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_isokor == '1' ? 'selected'
                                                        : '' }}>
                                                        Isokor</option>
                                                    <option value="2" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_isokor == '2' ? 'selected'
                                                        : '' }}>
                                                        Anisokor</option>
                                                </select>
                                            </div>
                                            <div class="flex-grow-1">
                                                ...
                                                <select class="form-select" name="disability_respon_cahaya" disabled>
                                                    <option value="">--Pilih--</option>
                                                    <option value="1" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_respon_cahaya == '1' ?
                                                        'selected' : '' }}>
                                                        Ya</option>
                                                    <option value="0" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_respon_cahaya == '0' ?
                                                        'selected' : '' }}>
                                                        Tidak</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-3" style="width: 100%;">
                                            <div class="flex-grow-1">
                                                ...
                                                <select class="form-select" name="disability_motorik" disabled>
                                                    <option value="">--Pilih--</option>
                                                    <option value="1" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_motorik == '1' ?
                                                        'selected' : '' }}>
                                                        Ya</option>
                                                    <option value="0" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_motorik == '0' ?
                                                        'selected' : '' }}>
                                                        Tidak</option>
                                                </select>
                                            </div>
                                            <div class="flex-grow-1">
                                                ...
                                                <select class="form-select" name="disability_sensorik" disabled>
                                                    <option value="">--Pilih--</option>
                                                    <option value="1" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_sensorik == '1' ?
                                                        'selected' : '' }}>
                                                        Ya</option>
                                                    <option value="0" {{ optional($asesmen->
                                                        asesmenKepUmumDisability)->disability_sensorik == '0' ?
                                                        'selected' : '' }}>
                                                        Tidak</option>
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    {{ $asesmen->asesmenKepUmumDisability &&
                                                                $asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_perfusi)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    value="1" {{ $asesmen->asesmenKepUmumDisability &&
                                                                $asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    name="disability_diagnosis_intoleransi_type"
                                                                    value="2" {{ $asesmen->asesmenKepUmumDisability &&
                                                                $asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi
                                                                == '2' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_intoleransi)
                                                                ? 'disabled' : '' }} disabled>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    value="1" {{ $asesmen->asesmenKepUmumDisability &&
                                                                $asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_komunikasi)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                value="kejang_ulang" {{
                                                                !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                            <input type="hidden" name="disability_diagnosis_perfusi"
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    $asesmen->asesmenKepUmumDisability &&
                                                                $asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kejang)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                !empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    {{ $asesmen->asesmenKepUmumDisability &&
                                                                $asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumDisability->disability_diagnosis_kesadaran)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="deformitas_tidak"
                                                        ...
                                                        optional($asesmen->asesmenKepUmumExposure)->exposure_deformitas
                                                    == '0' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="kontusion_tidak"
                                                        ...
                                                        optional($asesmen->asesmenKepUmumExposure)->exposure_kontusion
                                                    == '0' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="abrasi_tidak"
                                                        ...
                                                        optional($asesmen->asesmenKepUmumExposure)->exposure_abrasi ==
                                                    '0' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="penetrasi_tidak"
                                                        ...
                                                        optional($asesmen->asesmenKepUmumExposure)->exposure_penetrasi
                                                    == '0' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="laserasi_tidak"
                                                        ...
                                                        optional($asesmen->asesmenKepUmumExposure)->exposure_laserasi ==
                                                    '0' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="d-flex gap-4">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input" id="edema_tidak"
                                                        ...
                                                        optional($asesmen->asesmenKepUmumExposure)->exposure_edema ==
                                                    '0' ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                !empty($asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    {{ $asesmen->asesmenKepUmumExposure &&
                                                                $asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumExposure->exposure_diagnosis_mobilitasi)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-check">
                                                            <input type="checkbox"
                                                                ...
                                                                !empty($asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas)
                                                            ? 'checked' : '' }} disabled>
                                                            <!-- Hidden input untuk menjaga nilai saat ini -->
                                                        ...
                                                        <div class="d-flex gap-4">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input"
                                                                    ...
                                                                    {{ $asesmen->asesmenKepUmumExposure &&
                                                                $asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas
                                                                == '1' ? 'checked' : '' }} {{
                                                                empty($asesmen->asesmenKepUmumExposure->exposure_diagosis_integritas)
                                                                ? 'disabled' : '' }} disabled>
                                                                <label class="form-check-label"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="skala_nyeri_pemberat_id" disabled>
                                                    ...
                                                    <option value="{{ $pemberat->id }}" {{
                                                        old('skala_nyeri_pemberat_id', $asesmen->
                                                        asesmenKepUmumSkalaNyeri->skala_nyeri_pemberat_id ?? '') ==
                                                        $pemberat->id ? 'selected' : '' }}>
                                                        {{ $pemberat->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="skala_nyeri_kualitas_id" disabled>
                                                    <option value="">--Pilih--</option>
                                                    @foreach ($kualitasNyeri as $kualitas)
                                                    <option value="{{ $kualitas->id }}" {{
                                                        old('skala_nyeri_kualitas_id', $asesmen->
                                                        asesmenKepUmumSkalaNyeri->skala_nyeri_kualitas_id ?? '') ==
                                                        $kualitas->id ? 'selected' : '' }}>
                                                        {{ $kualitas->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="skala_nyeri_menjalar_id" disabled>
                                                    ...
                                                    <option value="{{ $menj->id }}" {{ old('skala_nyeri_menjalar_id',
                                                        $asesmen->asesmenKepUmumSkalaNyeri->skala_nyeri_menjalar_id ??
                                                        '') == $menj->id ? 'selected' : '' }}>
                                                        {{ $menj->name }}
                                                    </option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="skala_nyeri_peringan_id" disabled>
                                                    ...
                                                    <option value="{{ $peringan->id }}" {{
                                                        old('skala_nyeri_peringan_id', $asesmen->
                                                        asesmenKepUmumSkalaNyeri->skala_nyeri_peringan_id ?? '') ==
                                                        $peringan->id ? 'selected' : '' }}>
                                                        {{ $peringan->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="skala_nyeri_frekuensi_id" disabled>
                                                    ...
                                                    <option value="{{ $frekuensi->id }}" {{
                                                        old('skala_nyeri_frekuensi_id', $asesmen->
                                                        asesmenKepUmumSkalaNyeri->skala_nyeri_frekuensi_id ?? '') ==
                                                        $frekuensi->id ? 'selected' : '' }}>
                                                        {{ $frekuensi->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="skala_nyeri_jenis_id" disabled>
                                                    ...
                                                    <option value="{{ $jenis->id }}" {{ old('skala_nyeri_jenis_id',
                                                        $asesmen->asesmenKepUmumSkalaNyeri->skala_nyeri_jenis_id ?? '')
                                                        == $jenis->id ? 'selected' : '' }}>
                                                        {{ $jenis->name }}
                                                    </option>
                                                    @endforeach
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" id="risikoJatuhSkala" name="resiko_jatuh_jenis"
                                            ...
                                            <option value="1" {{ old('resiko_jatuh_jenis', $asesmen->
                                                asesmenKepUmumRisikoJatuh->resiko_jatuh_jenis ?? '') == '1' ? 'selected'
                                                : '' }}>
                                                Skala Umum</option>
                                            <option value="2" {{ old('resiko_jatuh_jenis', $asesmen->
                                                asesmenKepUmumRisikoJatuh->resiko_jatuh_jenis ?? '') == '2' ? 'selected'
                                                : '' }}>
                                                Skala Morse</option>
                                            <option value="3" {{ old('resiko_jatuh_jenis', $asesmen->
                                                asesmenKepUmumRisikoJatuh->resiko_jatuh_jenis ?? '') == '3' ? 'selected'
                                                : '' }}>
                                                Skala Humpty-Dumpty / Pediatrik</option>
                                            <option value="4" {{ old('resiko_jatuh_jenis', $asesmen->
                                                asesmenKepUmumRisikoJatuh->resiko_jatuh_jenis ?? '') == '4' ? 'selected'
                                                : '' }}>
                                                Skala Ontario Modified Stratify Sydney / Lansia</option>
                                            <option value="5" {{ old('resiko_jatuh_jenis', $asesmen->
                                                asesmenKepUmumRisikoJatuh->resiko_jatuh_jenis ?? '') == '5' ? 'selected'
                                                : '' }}>
                                                Lainnya</option>
                                        </select>
                                    </div>
                                    ...
                                    <div id="skala_umumForm" class="risk-form"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Apakah pasien berusia < dari 2 tahun?</label>
                                                    <select class="form-select" name="risiko_jatuh_umum_usia"
                                                        onchange="updateConclusion('umum')" disabled>
                                                        <option value="">pilih</option>
                                                        <option value="1" {{ old('risiko_jatuh_umum_usia', $asesmen->
                                                            asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_usia ?? '') ==
                                                            '1' ? 'selected' : '' }}>
                                                            Ya</option>
                                                        <option value="0" {{ old('risiko_jatuh_umum_usia', $asesmen->
                                                            asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_usia ?? '') ==
                                                            '0' ? 'selected' : '' }}>
                                                            Tidak</option>
                                                    </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_umum_kondisi_khusus"
                                                onchange="updateConclusion('umum')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_umum_kondisi_khusus', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_kondisi_khusus ?? '')
                                                    == '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_umum_kondisi_khusus', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_kondisi_khusus ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_umum_diagnosis_parkinson"
                                                onchange="updateConclusion('umum')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_umum_diagnosis_parkinson',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_diagnosis_parkinson ??
                                                    '') == '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_umum_diagnosis_parkinson',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_diagnosis_parkinson ??
                                                    '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_umum_pengobatan_berisiko"
                                                onchange="updateConclusion('umum')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_umum_pengobatan_berisiko',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_pengobatan_berisiko ??
                                                    '') == '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_umum_pengobatan_berisiko',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_pengobatan_berisiko ??
                                                    '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_umum_lokasi_berisiko"
                                                onchange="updateConclusion('umum')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_umum_lokasi_berisiko', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_lokasi_berisiko ?? '')
                                                    == '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_umum_lokasi_berisiko', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_lokasi_berisiko ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                            </select>
                                        ...
                                        <div class="conclusion bg-success">
                                            <p class="conclusion-text">Kesimpulan: <span id="kesimpulanTextForm">{{
                                                    old('risiko_jatuh_umum_kesimpulan',
                                                    $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_umum_kesimpulan ??
                                                    'Tidak berisiko jatuh') }}</span>
                                            </p>
                                    ...
                                    <div id="skala_morseForm" class="risk-form"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_morse_riwayat_jatuh"
                                                onchange="updateConclusion('morse')" disabled>
                                                <option value="">pilih</option>
                                                <option value="25" {{ old('risiko_jatuh_morse_riwayat_jatuh', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_riwayat_jatuh ?? '')
                                                    == '25' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_morse_riwayat_jatuh', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_riwayat_jatuh ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_morse_diagnosis_sekunder"
                                                onchange="updateConclusion('morse')" disabled>
                                                <option value="">pilih</option>
                                                <option value="15" {{ old('risiko_jatuh_morse_diagnosis_sekunder',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_diagnosis_sekunder ??
                                                    '') == '15' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_morse_diagnosis_sekunder',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_diagnosis_sekunder ??
                                                    '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_morse_bantuan_ambulasi"
                                                onchange="updateConclusion('morse')" disabled>
                                                <option value="">pilih</option>
                                                <option value="30" {{ old('risiko_jatuh_morse_bantuan_ambulasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_bantuan_ambulasi ??
                                                    '') == '30' ? 'selected' : '' }}>
                                                    Meja/ kursi</option>
                                                <option value="15" {{ old('risiko_jatuh_morse_bantuan_ambulasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_bantuan_ambulasi ??
                                                    '') == '15' ? 'selected' : '' }}>
                                                    Kruk/ tongkat/ alat bantu berjalan</option>
                                                <option value="0" {{ old('risiko_jatuh_morse_bantuan_ambulasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_bantuan_ambulasi ??
                                                    '') == '0' ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_morse_terpasang_infus"
                                                onchange="updateConclusion('morse')" disabled>
                                                <option value="">pilih</option>
                                                <option value="20" {{ old('risiko_jatuh_morse_terpasang_infus',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_terpasang_infus ?? '')
                                                    == '20' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_morse_terpasang_infus',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_terpasang_infus ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_morse_cara_berjalan"
                                                onchange="updateConclusion('morse')" disabled>
                                                <option value="">pilih</option>
                                                <option value="0" {{ old('risiko_jatuh_morse_cara_berjalan', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_cara_berjalan ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Normal/ bed rest/ kursi roda</option>
                                                <option value="20" {{ old('risiko_jatuh_morse_cara_berjalan', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_cara_berjalan ?? '')
                                                    == '20' ? 'selected' : '' }}>
                                                    Terganggu</option>
                                                <option value="10" {{ old('risiko_jatuh_morse_cara_berjalan', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_cara_berjalan ?? '')
                                                    == '10' ? 'selected' : '' }}>
                                                    Lemah</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_morse_status_mental"
                                                onchange="updateConclusion('morse')" disabled>
                                                <option value="">pilih</option>
                                                <option value="0" {{ old('risiko_jatuh_morse_status_mental', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_status_mental ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Beroroentasi pada kemampuannya</option>
                                                <option value="15" {{ old('risiko_jatuh_morse_status_mental', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_status_mental ?? '')
                                                    == '15' ? 'selected' : '' }}>
                                        ...
                                        <div class="conclusion bg-success">
                                            <p class="conclusion-text">Kesimpulan: <span id="kesimpulanTextForm">{{
                                                    old('risiko_jatuh_morse_kesimpulan',
                                                    $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_morse_kesimpulan
                                                    ?? 'Risiko Rendah') }}</span>
                                            </p>
                                    ...
                                    <div id="skala_humptyForm" class="risk-form"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_pediatrik_usia_anak"
                                                onchange="updateConclusion('humpty')" disabled>
                                                <option value="">pilih</option>
                                                <option value="4" {{ old('risiko_jatuh_pediatrik_usia_anak', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_usia_anak ?? '')
                                                    == '4' ? 'selected' : '' }}>
                                                    Dibawah 3 tahun</option>
                                                <option value="3" {{ old('risiko_jatuh_pediatrik_usia_anak', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_usia_anak ?? '')
                                                    == '3' ? 'selected' : '' }}>
                                                    3-7 tahun</option>
                                                <option value="2" {{ old('risiko_jatuh_pediatrik_usia_anak', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_usia_anak ?? '')
                                                    == '2' ? 'selected' : '' }}>
                                                    7-13 tahun</option>
                                                <option value="1" {{ old('risiko_jatuh_pediatrik_usia_anak', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_usia_anak ?? '')
                                                    == '1' ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_pediatrik_jenis_kelamin"
                                                onchange="updateConclusion('humpty')" disabled>
                                                <option value="">pilih</option>
                                                <option value="2" {{ old('risiko_jatuh_pediatrik_jenis_kelamin',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_jenis_kelamin ??
                                                    '') == '2' ? 'selected' : '' }}>
                                                    Laki-laki</option>
                                                <option value="1" {{ old('risiko_jatuh_pediatrik_jenis_kelamin',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_jenis_kelamin ??
                                                    '') == '1' ? 'selected' : '' }}>
                                                    Perempuan</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_pediatrik_diagnosis"
                                                onchange="updateConclusion('humpty')" disabled>
                                                <option value="">pilih</option>
                                                <option value="4" {{ old('risiko_jatuh_pediatrik_diagnosis', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_diagnosis ?? '')
                                                    == '4' ? 'selected' : '' }}>
                                                    Diagnosis Neurologis</option>
                                                <option value="3" {{ old('risiko_jatuh_pediatrik_diagnosis', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_diagnosis ?? '')
                                                    == '3' ? 'selected' : '' }}>
                                                    Perubahan oksigennasi (diangnosis respiratorik, dehidrasi, anemia,
                                                    syncope, pusing, dsb)</option>
                                                <option value="2" {{ old('risiko_jatuh_pediatrik_diagnosis', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_diagnosis ?? '')
                                                    == '2' ? 'selected' : '' }}>
                                                    Gangguan perilaku /psikiatri</option>
                                                <option value="1" {{ old('risiko_jatuh_pediatrik_diagnosis', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_diagnosis ?? '')
                                                    == '1' ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_pediatrik_gangguan_kognitif"
                                                onchange="updateConclusion('humpty')" disabled>
                                                <option value="">pilih</option>
                                                <option value="3" {{ old('risiko_jatuh_pediatrik_gangguan_kognitif',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_gangguan_kognitif
                                                    ?? '') == '3' ? 'selected' : '' }}>
                                                    Tidak menyadari keterbatasan dirinya</option>
                                                <option value="2" {{ old('risiko_jatuh_pediatrik_gangguan_kognitif',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_gangguan_kognitif
                                                    ?? '') == '2' ? 'selected' : '' }}>
                                                    Lupa akan adanya keterbatasan</option>
                                                <option value="1" {{ old('risiko_jatuh_pediatrik_gangguan_kognitif',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_gangguan_kognitif
                                                    ?? '') == '1' ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_pediatrik_faktor_lingkungan"
                                                onchange="updateConclusion('humpty')" disabled>
                                                <option value="">pilih</option>
                                                <option value="4" {{ old('risiko_jatuh_pediatrik_faktor_lingkungan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_faktor_lingkungan
                                                    ?? '') == '4' ? 'selected' : '' }}>
                                                    Riwayat jatuh /bayi diletakkan di tempat tidur dewasa</option>
                                                <option value="3" {{ old('risiko_jatuh_pediatrik_faktor_lingkungan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_faktor_lingkungan
                                                    ?? '') == '3' ? 'selected' : '' }}>
                                                    Pasien menggunakan alat bantu /bayi diletakkan di tempat tidur bayi
                                                    / perabot rumah</option>
                                                <option value="2" {{ old('risiko_jatuh_pediatrik_faktor_lingkungan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_faktor_lingkungan
                                                    ?? '') == '2' ? 'selected' : '' }}>
                                                    Pasien diletakkan di tempat tidur</option>
                                                <option value="1" {{ old('risiko_jatuh_pediatrik_faktor_lingkungan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_faktor_lingkungan
                                                    ?? '') == '1' ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_pediatrik_pembedahan"
                                                onchange="updateConclusion('humpty')" disabled>
                                                <option value="">pilih</option>
                                                <option value="3" {{ old('risiko_jatuh_pediatrik_pembedahan', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_pembedahan ?? '')
                                                    == '3' ? 'selected' : '' }}>
                                                    Dalam 24 jam</option>
                                                <option value="2" {{ old('risiko_jatuh_pediatrik_pembedahan', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_pembedahan ?? '')
                                                    == '2' ? 'selected' : '' }}>
                                                    Dalam 48 jam</option>
                                                <option value="1" {{ old('risiko_jatuh_pediatrik_pembedahan', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_pembedahan ?? '')
                                                    == '1' ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_pediatrik_penggunaan_mentosa"
                                                onchange="updateConclusion('humpty')" disabled>
                                                <option value="">pilih</option>
                                                <option value="3" {{ old('risiko_jatuh_pediatrik_penggunaan_mentosa',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_penggunaan_mentosa
                                                    ?? '') == '3' ? 'selected' : '' }}>
                                                    Penggunaan multiple: sedative, obat hipnosis, barbiturate,
                                                    fenotiazi, antidepresan, pencahar, diuretik, narkose</option>
                                                <option value="2" {{ old('risiko_jatuh_pediatrik_penggunaan_mentosa',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_penggunaan_mentosa
                                                    ?? '') == '2' ? 'selected' : '' }}>
                                                    Penggunaan salah satu obat diatas</option>
                                                <option value="1" {{ old('risiko_jatuh_pediatrik_penggunaan_mentosa',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_penggunaan_mentosa
                                                    ?? '') == '1' ? 'selected' : '' }}>
                                        ...
                                        <div class="conclusion bg-success">
                                            <p class="conclusion-text">Kesimpulan: <span id="kesimpulanTextForm">{{
                                                    old('risiko_jatuh_pediatrik_kesimpulan',
                                                    $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_pediatrik_kesimpulan
                                                    ?? 'Risiko Rendah') }}</span>
                                            </p>
                                    ...
                                    <div id="skala_ontarioForm" class="risk-form"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_jatuh_saat_masuk_rs"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="6" {{ old('risiko_jatuh_lansia_jatuh_saat_masuk_rs',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_jatuh_saat_masuk_rs
                                                    ?? '') == '6' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_jatuh_saat_masuk_rs',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_jatuh_saat_masuk_rs
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_riwayat_jatuh_2_bulan"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="6" {{ old('risiko_jatuh_lansia_riwayat_jatuh_2_bulan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_riwayat_jatuh_2_bulan
                                                    ?? '') == '6' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_riwayat_jatuh_2_bulan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_riwayat_jatuh_2_bulan
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_status_bingung"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="14" {{ old('risiko_jatuh_lansia_status_bingung',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_status_bingung ?? '')
                                                    == '14' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_status_bingung',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_status_bingung ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_status_disorientasi"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="14" {{ old('risiko_jatuh_lansia_status_disorientasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_status_disorientasi
                                                    ?? '') == '14' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_status_disorientasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_status_disorientasi
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_status_agitasi"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="14" {{ old('risiko_jatuh_lansia_status_agitasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_status_agitasi ?? '')
                                                    == '14' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_status_agitasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_status_agitasi ?? '')
                                                    == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_kacamata"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_lansia_kacamata', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_kacamata ?? '') ==
                                                    '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_kacamata', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_kacamata ?? '') ==
                                                    '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_kelainan_penglihatan"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_lansia_kelainan_penglihatan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_kelainan_penglihatan
                                                    ?? '') == '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_kelainan_penglihatan',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_kelainan_penglihatan
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_glukoma"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_lansia_glukoma', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_glukoma ?? '') == '1'
                                                    ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_glukoma', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_glukoma ?? '') == '0'
                                                    ? 'selected' : '' }}>
                                                    Tidak</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_perubahan_berkemih"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="2" {{ old('risiko_jatuh_lansia_perubahan_berkemih',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_perubahan_berkemih ??
                                                    '') == '2' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_perubahan_berkemih',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_perubahan_berkemih ??
                                                    '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_transfer_mandiri"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_transfer_mandiri',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_transfer_mandiri ??
                                                    '') == '0' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_transfer_mandiri',
                                                    $asesmen->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select"
                                                ...
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="1" {{ old('risiko_jatuh_lansia_transfer_bantuan_sedikit',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_transfer_bantuan_sedikit
                                                    ?? '') == '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_transfer_bantuan_sedikit',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_transfer_bantuan_sedikit
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select"
                                                ...
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="2" {{ old('risiko_jatuh_lansia_transfer_bantuan_nyata',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_transfer_bantuan_nyata
                                                    ?? '') == '2' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_transfer_bantuan_nyata',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_transfer_bantuan_nyata
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select"
                                                ...
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="3" {{ old('risiko_jatuh_lansia_transfer_bantuan_total',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_transfer_bantuan_total
                                                    ?? '') == '3' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_transfer_bantuan_total',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_transfer_bantuan_total
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_mobilitas_mandiri"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_mobilitas_mandiri',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_mobilitas_mandiri ??
                                                    '') == '0' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_mobilitas_mandiri',
                                                    $asesmen->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select"
                                                ...
                                                <option value="">pilih</option>
                                                <option value="1" {{
                                                    old('risiko_jatuh_lansia_mobilitas_bantuan_1_orang', $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_mobilitas_bantuan_1_orang
                                                    ?? '') == '1' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{
                                                    old('risiko_jatuh_lansia_mobilitas_bantuan_1_orang', $asesmen->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_mobilitas_kursi_roda"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="2" {{ old('risiko_jatuh_lansia_mobilitas_kursi_roda',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_mobilitas_kursi_roda
                                                    ?? '') == '2' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_mobilitas_kursi_roda',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_mobilitas_kursi_roda
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="risiko_jatuh_lansia_mobilitas_imobilisasi"
                                                onchange="updateConclusion('ontario')" disabled>
                                                <option value="">pilih</option>
                                                <option value="3" {{ old('risiko_jatuh_lansia_mobilitas_imobilisasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_mobilitas_imobilisasi
                                                    ?? '') == '3' ? 'selected' : '' }}>
                                                    Ya</option>
                                                <option value="0" {{ old('risiko_jatuh_lansia_mobilitas_imobilisasi',
                                                    $asesmen->
                                                    asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_mobilitas_imobilisasi
                                                    ?? '') == '0' ? 'selected' : '' }}>
                                                    Tidak</option>
                                        ...
                                        <div class="conclusion bg-success">
                                            <p class="conclusion-text">Kesimpulan: <span id="kesimpulanTextForm">{{
                                                    old('risiko_jatuh_lansia_kesimpulan',
                                                    $asesmen->asesmenKepUmumRisikoJatuh->risiko_jatuh_lansia_kesimpulan
                                                    ?? 'Risiko Rendah') }}</span>
                                            </p>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="hidden" id="existingTindakan-risikojatuh" value='{{ old('
                                        risik_jatuh_tindakan',
                                        optional($asesmen->asesmenKepUmumRisikoJatuh)->risik_jatuh_tindakan ?? '[]') }}'
                                    disabled>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="psikologis_kondisi" disabled>
                                        <option value="">--Pilih--</option>
                                        <option value="Tidak Ada Kelainan" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Tidak Ada Kelainan' ?
                                            'selected' : '' }}>
                                            Tidak Ada Kelainan</option>
                                        <option value="Cemas" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Cemas' ? 'selected' : '' }}>
                                            Cemas</option>
                                        <option value="Takut" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Takut' ? 'selected' : '' }}>
                                            Takut</option>
                                        <option value="Marah" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Marah' ? 'selected' : '' }}>
                                            Marah</option>
                                        <option value="Sedih" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Sedih' ? 'selected' : '' }}>
                                            Sedih</option>
                                        <option value="Tenang" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Tenang' ? 'selected' : '' }}>
                                            Tenang</option>
                                        <option value="Tidak Semangat" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Tidak Semangat' ? 'selected' :
                                            '' }}>
                                            Tidak Semangat</option>
                                        <option value="Tertekan" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Tertekan' ? 'selected' : ''
                                            }}>
                                            Tertekan</option>
                                        <option value="Depresi" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Depresi' ? 'selected' : '' }}>
                                            Depresi</option>
                                        <option value="Sulit Tidur" {{ old('psikologis_kondisi', $asesmen->
                                            asesmenKepUmum->psikologis_kondisi ?? '') == 'Sulit Tidur' ? 'selected' : ''
                                            }}>
                                            Sulit Tidur</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label style="min-width: 300px;">Potensi menyakiti diri sendiri/orang
                                        lain</label>
                                    <select class="form-select" name="psikologis_potensi_menyakiti" disabled>
                                        <option value="">--Pilih--</option>
                                        <option value="0" {{ old('psikologis_potensi_menyakiti', $asesmen->
                                            asesmenKepUmum->psikologis_potensi_menyakiti ?? '') == '0' ? 'selected' : ''
                                            }}>
                                            Tidak</option>
                                        <option value="1" {{ old('psikologis_potensi_menyakiti', $asesmen->
                                            asesmenKepUmum->psikologis_potensi_menyakiti ?? '') == '1' ? 'selected' : ''
                                            }}>
                                            Ya</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('psikologis_lainnya') is-invalid @enderror"
                                        name="psikologis_lainnya" rows="3"
                                        disabled>{{ old('psikologis_lainnya', $asesmen->asesmenKepUmum->psikologis_lainnya ?? '') }}</textarea>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="spiritual_agama" disabled>
                                        ...
                                        <option value="{{ $agam->kd_agama }}" {{ old('spiritual_agama', $asesmen->
                                            asesmenKepUmum->spiritual_agama ?? '') == $agam->kd_agama ? 'selected' : ''
                                            }}>
                                            {{ $agam->agama }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="spiritual_nilai" rows="3"
                                        disabled>{{ old('spiritual_nilai', $asesmen->asesmenKepUmum->spiritual_nilai ?? '') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select
                                        ...
                                        name="sosial_ekonomi_pekerjaan" id="sosial_pekerjaan" disabled>
                                        <option value="">--Pilih Pekerjaan--</option>
                                        @foreach ($pekerjaan as $kerjaan)
                                        <option value="{{ $kerjaan->kd_pekerjaan }}" {{ old('sosial_ekonomi_pekerjaan',
                                            $asesmen->asesmenKepUmumSosialEkonomi->sosial_ekonomi_pekerjaan ?? '') ==
                                            $kerjaan->kd_pekerjaan ? 'selected' : '' }}>
                                            {{ $kerjaan->pekerjaan }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="sosial_ekonomi_tingkat_penghasilan" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $penghasilanOptions = [
                                        'Penghasilan Tinggi',
                                        ...
                                        <option value="{{ $option }}" {{ old('sosial_ekonomi_tingkat_penghasilan',
                                            $asesmen->asesmenKepUmumSosialEkonomi->sosial_ekonomi_tingkat_penghasilan ??
                                            '') == $option ? 'selected' : '' }}>
                                            {{ $option }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="sosial_ekonomi_status_pernikahan" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $pernikahanOptions = [
                                        '0' => 'Belum Kawin',
                                        ...
                                        <option value="{{ $value }}" {{ old('sosial_ekonomi_status_pernikahan',
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="sosial_ekonomi_status_pendidikan" disabled>
                                        <option value="">--Pilih--</option>
                                        @foreach ($pendidikan as $pendidik)
                                        <option value="{{ $pendidik->kd_pendidikan }}" {{
                                            old('sosial_ekonomi_status_pendidikan', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_status_pendidikan ?? '') ==
                                            $pendidik->kd_pendidikan ? 'selected' : '' }}>
                                            {{ $pendidik->pendidikan }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="sosial_ekonomi_tempat_tinggal" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        ...
                                        <option value="{{ $option }}" {{ old('sosial_ekonomi_tempat_tinggal', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_tempat_tinggal ?? '') == $option
                                            ? 'selected' : '' }}>
                                            {{ $option }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="sosial_ekonomi_tinggal_dengan_keluarga" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        ...
                                        <option value="{{ $option }}" {{ old('sosial_ekonomi_tinggal_dengan_keluarga',
                                            $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_tinggal_dengan_keluarga ?? '')
                                            == $option ? 'selected' : '' }}>
                                            {{ $option }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="sosial_ekonomi_curiga_penganiayaan" disabled>
                                        <option value="">--Pilih--</option>
                                        <option value="1" {{ old('sosial_ekonomi_curiga_penganiayaan', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_penganiayaan ?? '') ==
                                            '1' ? 'selected' : '' }}>
                                            Ada</option>
                                        <option value="0" {{ old('sosial_ekonomi_curiga_penganiayaan', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_penganiayaan ?? '') ==
                                            '0' ? 'selected' : '' }}>
                                            Tidak Ada</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="sosial_ekonomi_curiga_kesulitan" disabled>
                                        <option value="">--Pilih--</option>
                                        <option value="1" {{ old('sosial_ekonomi_curiga_kesulitan', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_kesulitan ?? '') == '1' ?
                                            'selected' : '' }}>Ya</option>
                                        <option value="0" {{ old('sosial_ekonomi_curiga_kesulitan', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_kesulitan ?? '') == '0' ?
                                            'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Hubungan dengan anggota keluarga</label>
                                    <select class="form-select" name="sosial_ekonomi_curiga_hubungan_keluarga" disabled>
                                        <option value="">--Pilih--</option>
                                        <option value="1" {{ old('sosial_ekonomi_curiga_hubungan_keluarga', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_hubungan_keluarga ?? '')
                                            == '1' ? 'selected' : '' }}>Baik</option>
                                        <option value="0" {{ old('sosial_ekonomi_curiga_hubungan_keluarga', $asesmen->
                                            asesmenKepUmumSosialEkonomi->sosial_ekonomi_curiga_hubungan_keluarga ?? '')
                                            == '0' ? 'selected' : '' }}>Tidak Baik</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        name="sosial_ekonomi_keterangan_lain" rows="3"
                                        disabled>{{ old('sosial_ekonomi_keterangan_lain', $asesmen->asesmenKepUmumSosialEkonomi->sosial_ekonomi_keterangan_lain ?? '') }}</textarea>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group mb-4">
                                    <select class="form-select @error('gizi_jenis') is-invalid @enderror"
                                        name="gizi_jenis" id="nutritionAssessment" disabled>
                                        <option value="">--Pilih--</option>
                                        <option value="1" {{ old('gizi_jenis', $asesmen->asesmenKepUmumGizi->gizi_jenis
                                            ?? '') == '1' ? 'selected' : '' }}>
                                            Malnutrition Screening Tool (MST)
                                        </option>
                                        <option value="2" {{ old('gizi_jenis', $asesmen->asesmenKepUmumGizi->gizi_jenis
                                            ?? '') == '2' ? 'selected' : '' }}>
                                            The Mini Nutritional Assessment (MNA)
                                        </option>
                                        <option value="3" {{ old('gizi_jenis', $asesmen->asesmenKepUmumGizi->gizi_jenis
                                            ?? '') == '3' ? 'selected' : '' }}>
                                            Strong Kids (1 bln - 18 Tahun)
                                        </option>
                                        <option value="5" {{ old('gizi_jenis', $asesmen->asesmenKepUmumGizi->gizi_jenis
                                            ?? '') == '5' ? 'selected' : '' }}>
                                            Tidak Dapat Dinilai
                                        </option>
                                    </select>
                                ...
                                <div id="mst" class="assessment-form"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('gizi_mst_penurunan_bb') is-invalid @enderror"
                                            name="gizi_mst_penurunan_bb" disabled>
                                            <option value="">pilih</option>
                                            <option value="0" {{ old('gizi_mst_penurunan_bb', $asesmen->
                                                asesmenKepUmumGizi->gizi_mst_penurunan_bb ?? '') == '0' ? 'selected' :
                                                '' }}>
                                                Tidak ada penurunan Berat Badan (BB)
                                            </option>
                                            <option value="2" {{ old('gizi_mst_penurunan_bb', $asesmen->
                                                asesmenKepUmumGizi->gizi_mst_penurunan_bb ?? '') == '2' ? 'selected' :
                                                '' }}>
                                                Tidak yakin/ tidak tahu/ terasa baju lebih longgar
                                            </option>
                                            <option value="3" {{ old('gizi_mst_penurunan_bb', $asesmen->
                                                asesmenKepUmumGizi->gizi_mst_penurunan_bb ?? '') == '3' ? 'selected' :
                                                '' }}>
                                                Ya ada penurunan BB
                                            </option>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_mst_jumlah_penurunan_bb" disabled>
                                            ...
                                            <option value="{{ $value }}" {{ old('gizi_mst_jumlah_penurunan_bb',
                                                $asesmen->asesmenKepUmumGizi->gizi_mst_jumlah_penurunan_bb ?? '') ==
                                                $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                            @endforeach
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_mst_nafsu_makan_berkurang" disabled>
                                            <option value="">pilih</option>
                                            <option value="1" {{ old('gizi_mst_nafsu_makan_berkurang', $asesmen->
                                                asesmenKepUmumGizi->gizi_mst_nafsu_makan_berkurang ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Ya</option>
                                            <option value="0" {{ old('gizi_mst_nafsu_makan_berkurang', $asesmen->
                                                asesmenKepUmumGizi->gizi_mst_nafsu_makan_berkurang ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Tidak</option>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_mst_diagnosis_khusus" disabled>
                                            <option value="">pilih</option>
                                            <option value="1" {{ old('gizi_mst_diagnosis_khusus', $asesmen->
                                                asesmenKepUmumGizi->gizi_mst_diagnosis_khusus ?? '') == '1' ? 'selected'
                                                : '' }}>
                                                Ya</option>
                                            <option value="0" {{ old('gizi_mst_diagnosis_khusus', $asesmen->
                                                asesmenKepUmumGizi->gizi_mst_diagnosis_khusus ?? '') == '0' ? 'selected'
                                                : '' }}>
                                                Tidak</option>
                                        </select>
                                ...
                                <div id="mna" class="assessment-form"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_mna_penurunan_asupan_3_bulan" disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="0" {{ old('gizi_mna_penurunan_asupan_3_bulan', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_penurunan_asupan_3_bulan ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Mengalami penurunan asupan makanan yang parah
                                            </option>
                                            <option value="1" {{ old('gizi_mna_penurunan_asupan_3_bulan', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_penurunan_asupan_3_bulan ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Mengalami penurunan asupan makanan sedang
                                            </option>
                                            <option value="2" {{ old('gizi_mna_penurunan_asupan_3_bulan', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_penurunan_asupan_3_bulan ?? '') == '2' ?
                                                'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_mna_kehilangan_bb_3_bulan" disabled>
                                            <option value="">-- Pilih --</option>
                                            <option value="0" {{ old('gizi_mna_kehilangan_bb_3_bulan', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_kehilangan_bb_3_bulan ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Kehilangan BB lebih dari 3 Kg
                                            </option>
                                            <option value="1" {{ old('gizi_mna_kehilangan_bb_3_bulan', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_kehilangan_bb_3_bulan ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Tidak tahu
                                            </option>
                                            <option value="2" {{ old('gizi_mna_kehilangan_bb_3_bulan', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_kehilangan_bb_3_bulan ?? '') == '2' ?
                                                'selected' : '' }}>
                                                Kehilangan BB antara 1 s.d 3 Kg
                                            </option>
                                            <option value="3" {{ old('gizi_mna_kehilangan_bb_3_bulan', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_kehilangan_bb_3_bulan ?? '') == '3' ?
                                                'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('gizi_mna_mobilisasi') is-invalid @enderror"
                                            name="gizi_mna_mobilisasi" disabled>
                                            <option value="">-- Pilih --</option>
                                            <option value="0" {{ old('gizi_mna_mobilisasi', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_mobilisasi ?? '') == '0' ? 'selected' : ''
                                                }}>
                                                Hanya di tempat tidur atau kursi roda
                                            </option>
                                            <option value="1" {{ old('gizi_mna_mobilisasi', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_mobilisasi ?? '') == '1' ? 'selected' : ''
                                                }}>
                                                Dapat turun dari tempat tidur tapi tidak dapat jalan-jalan
                                            </option>
                                            <option value="2" {{ old('gizi_mna_mobilisasi', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_mobilisasi ?? '') == '2' ? 'selected' : ''
                                                }}>
                                                Dapat jalan-jalan
                                            </option>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_mna_stress_penyakit_akut" disabled>
                                            <option value="">-- Pilih --</option>
                                            <option value="1" {{ old('gizi_mna_stress_penyakit_akut', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_stress_penyakit_akut ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Tidak
                                            </option>
                                            <option value="0" {{ old('gizi_mna_stress_penyakit_akut', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_stress_penyakit_akut ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Ya
                                            </option>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_mna_status_neuropsikologi" disabled>
                                            <option value="">-- Pilih --</option>
                                            <option value="0" {{ old('gizi_mna_status_neuropsikologi', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_status_neuropsikologi ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Demensia atau depresi berat
                                            </option>
                                            <option value="1" {{ old('gizi_mna_status_neuropsikologi', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_status_neuropsikologi ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Demensia ringan
                                            </option>
                                            <option value="2" {{ old('gizi_mna_status_neuropsikologi', $asesmen->
                                                asesmenKepUmumGizi->gizi_mna_status_neuropsikologi ?? '') == '2' ?
                                                'selected' : '' }}>
                                ...
                                <div id="strong-kids" class="assessment-form"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_strong_status_kurus" disabled>
                                            <option value="">pilih</option>
                                            <option value="1" {{ old('gizi_strong_status_kurus', $asesmen->
                                                asesmenKepUmumGizi->gizi_strong_status_kurus ?? '') == '1' ? 'selected'
                                                : '' }}>
                                                Ya</option>
                                            <option value="0" {{ old('gizi_strong_status_kurus', $asesmen->
                                                asesmenKepUmumGizi->gizi_strong_status_kurus ?? '') == '0' ? 'selected'
                                                : '' }}>
                                                Tidak</option>
                                        </select>
                                        ...
                                        <label class="form-label">Apakah terdapat penurunan BB selama satu bulan
                                            ...
                                            tidak ada peningkatan berat badan atau tinggi badan (pada bayi < 1 tahun)
                                                ...
                                                <select
                                                    ...
                                                    name="gizi_strong_penurunan_bb" disabled>
                                                    <option value="">pilih</option>
                                                    <option value="1" {{ old('gizi_strong_penurunan_bb', $asesmen->
                                                        asesmenKepUmumGizi->gizi_strong_penurunan_bb ?? '') == '1' ?
                                                        'selected' : '' }}>
                                                        Ya</option>
                                                    <option value="0" {{ old('gizi_strong_penurunan_bb', $asesmen->
                                                        asesmenKepUmumGizi->gizi_strong_penurunan_bb ?? '') == '0' ?
                                                        'selected' : '' }}>
                                                        Tidak</option>
                                                </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_strong_gangguan_pencernaan" disabled>
                                            <option value="">pilih</option>
                                            <option value="1" {{ old('gizi_strong_gangguan_pencernaan', $asesmen->
                                                asesmenKepUmumGizi->gizi_strong_gangguan_pencernaan ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Ya</option>
                                            <option value="0" {{ old('gizi_strong_gangguan_pencernaan', $asesmen->
                                                asesmenKepUmumGizi->gizi_strong_gangguan_pencernaan ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Tidak</option>
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            name="gizi_strong_penyakit_berisiko" disabled>
                                            <option value="">pilih</option>
                                            <option value="2" {{ old('gizi_strong_penyakit_berisiko', $asesmen->
                                                asesmenKepUmumGizi->gizi_strong_penyakit_berisiko ?? '') == '2' ?
                                                'selected' : '' }}>
                                                Ya</option>
                                            <option value="0" {{ old('gizi_strong_penyakit_berisiko', $asesmen->
                                                asesmenKepUmumGizi->gizi_strong_penyakit_berisiko ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Tidak</option>
                                        </select>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('status_fungsional') is-invalid @enderror"
                                        name="status_fungsional" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        ...
                                        <option value="{{ $option }}" {{ old('status_fungsional', $asesmen->
                                            asesmenKepUmum->status_fungsional ?? '') == $option ? 'selected' : '' }}>
                                            {{ $option }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="kebutuhan_edukasi_gaya_bicara" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $gayaBicaraOptions = [
                                        '0' => 'Normal',
                                        ...
                                        <option value="{{ $value }}" {{ old('kebutuhan_edukasi_gaya_bicara', $asesmen->
                                            asesmenKepUmum->kebutuhan_edukasi_gaya_bicara ?? '') == $value ? 'selected'
                                            : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="kebutuhan_edukasi_bahasa_sehari_hari" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $bahasaOptions = [
                                        'aceh' => 'Aceh',
                                        ...
                                        <option value="{{ $value }}" {{ old('kebutuhan_edukasi_bahasa_sehari_hari',
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="kebutuhan_edukasi_perlu_penerjemah" disabled>
                                        <option value="">--Pilih--</option>
                                        <option value="0" {{ old('kebutuhan_edukasi_perlu_penerjemah', $asesmen->
                                            asesmenKepUmum->kebutuhan_edukasi_perlu_penerjemah ?? '') == '0' ?
                                            'selected' : '' }}>
                                            Tidak</option>
                                        <option value="1" {{ old('kebutuhan_edukasi_perlu_penerjemah', $asesmen->
                                            asesmenKepUmum->kebutuhan_edukasi_perlu_penerjemah ?? '') == '1' ?
                                            'selected' : '' }}>
                                            Ya</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="kebutuhan_edukasi_hambatan_komunikasi" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $hambatanOptions = [
                                        'bahasa' => 'Bahasa',
                                        ...
                                        <option value="{{ $value }}" {{ old('kebutuhan_edukasi_hambatan_komunikasi',
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="kebutuhan_edukasi_media_belajar" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $mediaBelajarOptions = [
                                        'audio' => 'Audio-Visual',
                                        ...
                                        <option value="{{ $value }}" {{ old('kebutuhan_edukasi_media_belajar',
                                            $asesmen->asesmenKepUmum->kebutuhan_edukasi_media_belajar ?? '') == $value ?
                                            'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="kebutuhan_edukasi_tingkat_pendidikan" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $pendidikanOptions = [
                                        'sd' => 'SD',
                                        ...
                                        <option value="{{ $value }}" {{ old('kebutuhan_edukasi_tingkat_pendidikan',
                                            $asesmen->asesmenKepUmum->kebutuhan_edukasi_tingkat_pendidikan ?? '') ==
                                            $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="kebutuhan_edukasi_edukasi_dibutuhkan" disabled>
                                        <option value="">--Pilih--</option>
                                        @php
                                        $edukasiOptions = [
                                        ...
                                        <option value="{{ $value }}" {{ old('kebutuhan_edukasi_edukasi_dibutuhkan',
                                            $asesmen->asesmenKepUmum->kebutuhan_edukasi_edukasi_dibutuhkan ?? '') ==
                                            $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        name="kebutuhan_edukasi_keterangan_lain" rows="3"
                                        disabled>{{ old('kebutuhan_edukasi_keterangan_lain', $asesmen->asesmenKepUmum->kebutuhan_edukasi_keterangan_lain ?? '') }}</textarea>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="discharge_planning_usia_lanjut" id="usia_lanjut" disabled>
                                        <option value="">pilih</option>
                                        <option value="ya" {{ old('discharge_planning_usia_lanjut', $asesmen->
                                            asesmenKepUmum->discharge_planning_usia_lanjut ?? '') == 'ya' ? 'selected' :
                                            '' }}>
                                            Ya</option>
                                        <option value="tidak" {{ old('discharge_planning_usia_lanjut', $asesmen->
                                            asesmenKepUmum->discharge_planning_usia_lanjut ?? '') == 'tidak' ?
                                            'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="discharge_planning_hambatan_mobilisasi" id="hambatan_mobilisasi" disabled>
                                        <option value="">pilih</option>
                                        <option value="ya" {{ old('discharge_planning_hambatan_mobilisasi', $asesmen->
                                            asesmenKepUmum->discharge_planning_hambatan_mobilisasi ?? '') == 'ya' ?
                                            'selected' : '' }}>
                                            Ya</option>
                                        <option value="tidak" {{ old('discharge_planning_hambatan_mobilisasi',
                                            $asesmen->asesmenKepUmum->discharge_planning_hambatan_mobilisasi ?? '') ==
                                            'tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        disabled>
                                        <option value="">pilih</option>
                                        <option value="ya" {{ old('discharge_planning_pelayanan_medis', $asesmen->
                                            asesmenKepUmum->discharge_planning_pelayanan_medis ?? '') == 'ya' ?
                                            'selected' : '' }}>
                                            Ya</option>
                                        <option value="tidak" {{ old('discharge_planning_pelayanan_medis', $asesmen->
                                            asesmenKepUmum->discharge_planning_pelayanan_medis ?? '') == 'tidak' ?
                                            'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="discharge_planning_ketergantungan_aktivitas" id="ketergantungan_aktivitas"
                                        disabled>
                                        <option value="">pilih</option>
                                        <option value="ya" {{ old('discharge_planning_ketergantungan_aktivitas',
                                            $asesmen->asesmenKepUmum->discharge_planning_ketergantungan_aktivitas ?? '')
                                            == 'ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="tidak" {{ old('discharge_planning_ketergantungan_aktivitas',
                                            $asesmen->asesmenKepUmum->discharge_planning_ketergantungan_aktivitas ?? '')
                                            == 'tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
            ...
            <div class="modal-body">
                <form id="implementationForm">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="impl_date" required disabled>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Jam Tindakan</label>
                        <input type="time" class="form-control" id="impl_time" required disabled>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tindakan Keperawatan</label>
                        <textarea class="form-control" id="impl_action" rows="4" required
                            placeholder="Masukkan detail tindakan keperawatan yang dilakukan..." disabled></textarea>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form id="evaluationForm">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="eval_date" required disabled>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Jam Evaluasi</label>
                        <input type="time" class="form-control" id="eval_time" required disabled>
                    </div>
                    <div class="mb-3">
    ...
    function updateImplementationTable() {
        ...
        tbody.innerHTML = implementationData.map((item, index) => `
                    <tr>
                        ...
                        <td>${item.action}</td>
                        <td>
                            <button class="btn btn-sm btn-info btn-action" onclick="event.preventDefault(); openImplementationModal(${index}); return false;">
        ...
        tbody.innerHTML = evaluationData.map((item, index) => {
            ...
            return `
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info btn-action" onclick="event.preventDefault(); openEvaluationModal(${index}); return false;">
                                    <i class="fas fa-eye me-1"></i>
                                </button>
                            </td>
                        </tr>
