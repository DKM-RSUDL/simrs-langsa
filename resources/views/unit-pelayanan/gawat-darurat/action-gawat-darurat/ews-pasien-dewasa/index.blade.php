                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between m-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{ route('ews-pasien-dewasa.create', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ route('ews-pasien-dewasa.print-pdf', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $item->id]) }}"
                                                                    class="btn btn-secondary btn-sm ms-2" target="_blank">
                                                                    <i class="bi bi-printer"></i>
                                                                </a>

                                                                <a href="{{ route('ews-pasien-dewasa.show', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                    class="btn btn-info btn-sm ms-2" title="Detail">
                                                                    <i class="ti-eye"></i>
                                                                </a>
                                                                @if ($item->status == 0)
                                                                    <a href="{{ route('ews-pasien-dewasa.edit', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                ...
                                                                <form
                                                                    action="{{ route('ews-pasien-dewasa.destroy', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
