        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Persetujuan Anestesi dan Sedasi',
                    'description' =>
                        'Form untuk memperbarui data persetujuan anestesi dan sedasi pasien gawat darurat.',
                ])
                <form id="edukasiForm" method="POST"
                    action="{{ route('anestesi-sedasi.update', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, encrypt($anestesi->id)]) }}">
                    @csrf
                    @method('put')
                    {{-- Info Umum --}}
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal" id="tanggal" class="form-control"
                                        value="{{ date('Y-m-d', strtotime($anestesi->tanggal)) }}" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_saksi_keluarga"
                                    name="nama_saksi_keluarga" value="{{ $anestesi->nama_saksi_keluarga }}" required>
                            </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="">
                                            <input type="checkbox" name="tindakan[]" id="lainnya"
                                                class="form-check-input" value="Lain-lain" @checked(in_array('Lain-lain', $anestesi->tindakan))>
