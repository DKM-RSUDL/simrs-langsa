    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="text-center mt-1 mb-2">
                <h5 class="text-secondary fw-bold">EDIT FORM A-EVALUASI AWAL MPP</h5>
            </div>
            ...
            <div class="form-section">
                <form
                    action="{{ route('mpp.form-a.update', [
                        'kd_pasien' => $kd_pasien,
                        'tgl_masuk' => $tgl_masuk,
                        ...
                        <div class="card-body p-0">
                            <table class="mpp-table">
                                ...
                                <tbody>
                                        ...
                                        <td class="criteria-column">
                                            <div class="criteria-item">
                                                <input type="checkbox" name="screening_criteria[]" value="fungsi_kognitif"
                                                    ...
                                                    {{ $mppData->fungsi_kognitif ? 'checked' : '' }}>
                                        ...
                                        <td class="criteria-column">
                                            <div class="criteria-item">
                                                <input type="checkbox" name="screening_criteria[]" value="potensi_komplain"
                                                    ...
                                                    {{ $mppData->potensi_komplain ? 'checked' : '' }}>
                                    ...
                                    <!-- Section IV: Rencana Asuhan - FIXED VERSION -->
                                    <tr class="section-header">
                                        ...
                                        <td class="criteria-column">
                                            <div class="criteria-item">
                                                <input type="checkbox" name="planning_criteria[]"
                                                    ...
                                                    id="p1" {{ $mppData->validasi_rencana ? 'checked' : '' }}>
                                        ...
                                        <td class="criteria-column">
                                            <div class="criteria-item">
                                                <input type="checkbox" name="planning_criteria[]"
                                                    ...
                                                    id="p2" {{ $mppData->rencana_informasi ? 'checked' : '' }}>
                                        ...
                                        <td class="criteria-column">
                                            <div class="criteria-item">
                                                <input type="checkbox" name="planning_criteria[]"
                                                    ...
                                                    id="p3" {{ $mppData->rencana_melibatkan ? 'checked' : '' }}>
                                        ...
                                        <td class="criteria-column">
                                            <div class="criteria-item">
                                                <input type="checkbox" name="planning_criteria[]"
                                                    ...
                                                    {{ $mppData->fasilitas_penyelesaian ? 'checked' : '' }}>
                                        ...
                                        <td class="criteria-column">
                                            <div class="criteria-item">
                                                <input type="checkbox" name="planning_criteria[]"
                                                    ...
                                                    id="p5" {{ $mppData->bantuan_alternatif ? 'checked' : '' }}>
