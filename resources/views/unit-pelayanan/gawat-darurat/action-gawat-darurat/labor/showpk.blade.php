...
@else
    <a href="#" class="btn btn-sm btn-secondary btn-edit-rad"><i class="ti-pencil"></i></a>

    <a href="#" class="mb-2" data-bs-toggle="modal"
        data-bs-target="#deleteModal{{ $laborPK->kd_order }}">
