...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <a href="{{ route('permintaan-darah.edit', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $permintaanDarah->id]) }}" class="btn btn-warning btn-sm" title="Edit">
