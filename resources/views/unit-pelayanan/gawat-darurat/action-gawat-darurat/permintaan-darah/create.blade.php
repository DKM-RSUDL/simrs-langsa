        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Order Permintaan Darah',
                    'description' =>
                        'Tambah data order permintaan darah pasien gawat darurat dengan mengisi form dibawah ini.',
                ])
                <form id="edukasiForm" method="POST"
                    ...
                    <!-- Petunjuk Permintaan -->
                    <div class="section-separator mb-3 mt-0">
                    ...
                    <div class="section-separator mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="TGL_PENGIRIMAN" value="{{ date('Y-m-d') }}"
                                    required>
                            </div>

                            <div class="form-group">
                                <label for="diperlukan" style="min-width: 200px;">Diperlukan</label>
                                <input type="date" class="form-control" name="TGL_DIPERLUKAN" value="{{ date('Y-m-d') }}"
                                    required>
                            </div>
                    ...
                    <div class="section-separator mb-3">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="REAKSI_TRANFUSI" placeholder="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="pernah-hamil-jumlah" name="PERNAH_HAMIL"
                                    placeholder="">
                            </div>
