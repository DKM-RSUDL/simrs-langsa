...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('resiko-jatuh.humpty-dumpty.index', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}" class="btn btn-outline-primary mb-3">
                <i class="ti-arrow-left"></i> Kembali
            </a>

            <form id="humptyDumptyForm" method="POST"
                action="{{ route('resiko-jatuh.humpty-dumpty.store', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
                        ...
                        <div class="form-section">
                                ...
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item">
                                            <input type="radio" id="usia_1" name="usia" value="4" class="assessment-field" data-field="usia" required>
                                            <label for="usia_1">&lt;3 tahun</label>
                                            <span class="radio-value">4</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="usia_2" name="usia" value="3" class="assessment-field" data-field="usia" required>
                                            <label for="usia_2">3 sampai 7 tahun</label>
                                            <span class="radio-value">3</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="usia_3" name="usia" value="2" class="assessment-field" data-field="usia" required>
                                            <label for="usia_3">7 sampai 13 tahun</label>
                                            <span class="radio-value">2</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="usia_4" name="usia" value="1" class="assessment-field" data-field="usia" required>
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item">
                                            <input type="radio" id="jk_1" name="jenis_kelamin" value="2" class="assessment-field" data-field="jenis_kelamin" required>
                                            <label for="jk_1">Laki-laki</label>
                                            <span class="radio-value">2</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="jk_2" name="jenis_kelamin" value="1" class="assessment-field" data-field="jenis_kelamin" required>
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item">
                                            <input type="radio" id="diagnosis_1" name="diagnosis" value="3" class="assessment-field" data-field="diagnosis" required>
                                            <label for="diagnosis_1">Perubahan oksigenasi (diagnosis respiratorik, dehidrasi, anemia, syncope, pusing)</label>
                                            <span class="radio-value">3</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="diagnosis_2" name="diagnosis" value="2" class="assessment-field" data-field="diagnosis" required>
                                            <label for="diagnosis_2">Gangguan perilaku / psikiatri</label>
                                            <span class="radio-value">2</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="diagnosis_3" name="diagnosis" value="1" class="assessment-field" data-field="diagnosis" required>
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item">
                                            <input type="radio" id="kognitif_1" name="gangguan_kognitif" value="3" class="assessment-field" data-field="gangguan_kognitif" required>
                                            <label for="kognitif_1">Tidak menyadari keterbatasan dirinya</label>
                                            <span class="radio-value">3</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="kognitif_2" name="gangguan_kognitif" value="2" class="assessment-field" data-field="gangguan_kognitif" required>
                                            <label for="kognitif_2">Lupa akan adanya keterbatasan</label>
                                            <span class="radio-value">2</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="kognitif_3" name="gangguan_kognitif" value="1" class="assessment-field" data-field="gangguan_kognitif" required>
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item">
                                            <input type="radio" id="lingkungan_1" name="faktor_lingkungan" value="4" class="assessment-field" data-field="faktor_lingkungan" required>
                                            <label for="lingkungan_1">Riwayat jatuh / bayi diletakkan di tempat tidur dewasa</label>
                                            <span class="radio-value">4</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="lingkungan_2" name="faktor_lingkungan" value="3" class="assessment-field" data-field="faktor_lingkungan" required>
                                            <label for="lingkungan_2">Pasien menggunakan alat bantu / bayi diletakkan di tempat tidur bayi / perabot rumah</label>
                                            <span class="radio-value">3</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="lingkungan_3" name="faktor_lingkungan" value="2" class="assessment-field" data-field="faktor_lingkungan" required>
                                            <label for="lingkungan_3">Pasien diletakkan di tempat tidur</label>
                                            <span class="radio-value">2</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="lingkungan_4" name="faktor_lingkungan" value="1" class="assessment-field" data-field="faktor_lingkungan" required>
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item">
                                            <input type="radio" id="bedah_1" name="pembedahan_sedasi" value="3" class="assessment-field" data-field="pembedahan_sedasi" required>
                                            <label for="bedah_1">Dalam 24 jam</label>
                                            <span class="radio-value">3</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="bedah_2" name="pembedahan_sedasi" value="2" class="assessment-field" data-field="pembedahan_sedasi" required>
                                            <label for="bedah_2">Dalam 48 jam</label>
                                            <span class="radio-value">2</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="bedah_3" name="pembedahan_sedasi" value="1" class="assessment-field" data-field="pembedahan_sedasi" required>
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item">
                                            <input type="radio" id="obat_1" name="penggunaan_medikamentosa" value="3" class="assessment-field" data-field="penggunaan_medikamentosa" required>
                                        ...
                                        <div class="radio-item">
                                            <input type="radio" id="obat_2" name="penggunaan_medikamentosa" value="2" class="assessment-field" data-field="penggunaan_medikamentosa" required>
                                            <label for="obat_2">Penggunaan salah satu obat di atas</label>
                                            <span class="radio-value">2</span>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="obat_3" name="penggunaan_medikamentosa" value="1" class="assessment-field" data-field="penggunaan_medikamentosa" required>
