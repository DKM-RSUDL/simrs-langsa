                                ...
                                <div class="row">
                                    <div class="row m-3">
                                        ...
                                        <div class="col-md-3 text-end">
                                            <a href="{{ route('resiko-jatuh.humpty-dumpty.create', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ route('resiko-jatuh.humpty-dumpty.show', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $data->id]) }}"
                                                                   class="btn btn-sm btn-outline-info" title="Lihat Detail">
                                                                    <i class="ti-eye"></i>
                                                                </a>
                                                                <a href="{{ route('resiko-jatuh.humpty-dumpty.edit', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $data->id]) }}"
                                                            ...
                                                            <form id="delete-form-{{ $data->id }}"
                                                                  action="{{ route('resiko-jatuh.humpty-dumpty.destroy', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $data->id]) }}"
                                                    ...
                                                    <tr>
                                                        <td colspan="7" class="text-center py-4">
                                                            <div class="text-muted">
                                                                ...
                                                                <a href="{{ route('resiko-jatuh.humpty-dumpty.create', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
