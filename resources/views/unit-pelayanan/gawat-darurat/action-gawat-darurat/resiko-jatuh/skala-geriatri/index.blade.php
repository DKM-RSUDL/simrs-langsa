                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="skalaMorseTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('resiko-jatuh.morse.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('resiko-jatuh.humpty-dumpty.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active">
                                ...
                                <div class="row">
                                    <form method="GET" action="{{ route('resiko-jatuh.geriatri.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                                        <div class="row m-3">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3 text-end">
                                                <a href="{{ route('resiko-jatuh.geriatri.create', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ route('resiko-jatuh.geriatri.show', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                    class="btn btn-sm btn-outline-info" title="Lihat Detail">
                                                                    <i class="ti-eye"></i>
                                                                </a>
                                                                <a href="{{ route('resiko-jatuh.geriatri.edit', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
...
@push('js')
    <script>
        function confirmDelete(id) {
            ...
            deleteForm.action = `{{ route('resiko-jatuh.geriatri.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}/${id}`;
