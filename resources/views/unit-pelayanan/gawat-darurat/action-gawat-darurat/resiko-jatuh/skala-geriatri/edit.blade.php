...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('resiko-jatuh.geriatri.index', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" class="btn btn-outline-primary mb-3">
                <i class="ti-arrow-left"></i> Kembali
            </a>

            <form id="humptyDumptyForm" method="POST"
                action="{{ route('resiko-jatuh.geriatri.update', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $dataSkalaGeriatri->id]) }}">
                @csrf
                @method('PUT')

                <div class="card shadow-sm">
                    <div class="card-body">
                        <h4 class="header-asesmen">Edit Pengkajian Resiko Khusus Lansia (Geriatri)</h4>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="shift" name="shift" required>
                                    ...
                                    <option value="pagi" {{ $dataSkalaGeriatri->shift == 'pagi' ? 'selected' : '' }}>Pagi</option>
                                    <option value="siang" {{ $dataSkalaGeriatri->shift == 'siang' ? 'selected' : '' }}>Siang</option>
                                    <option value="malam" {{ $dataSkalaGeriatri->shift == 'malam' ? 'selected' : '' }}>Malam</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                                ...
                                <div class="radio-group">
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->riwayat_jatuh_1a == 6 ? 'selected' : '' }}">
                                                <input type="radio" id="riwayat_jatuh_1a_ya" name="riwayat_jatuh_1a" value="6"
                                                       {{ $dataSkalaGeriatri->riwayat_jatuh_1a == 6 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="riwayat_jatuh_1a" required>
                                                <label for="riwayat_jatuh_1a_ya">Ya</label>
                                                <span class="radio-value">6</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->riwayat_jatuh_1a == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="riwayat_jatuh_1a_tidak" name="riwayat_jatuh_1a" value="0"
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->riwayat_jatuh_1b == 6 ? 'selected' : '' }}">
                                                <input type="radio" id="riwayat_jatuh_1b_ya" name="riwayat_jatuh_1b" value="6"
                                                       {{ $dataSkalaGeriatri->riwayat_jatuh_1b == 6 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="riwayat_jatuh_1b" required>
                                                <label for="riwayat_jatuh_1b_ya">Ya</label>
                                                <span class="radio-value">6</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->riwayat_jatuh_1b == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="riwayat_jatuh_1b_tidak" name="riwayat_jatuh_1b" value="0"
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->status_mental_2a == 14 ? 'selected' : '' }}">
                                                <input type="radio" id="status_mental_2a_ya" name="status_mental_2a" value="14"
                                                       {{ $dataSkalaGeriatri->status_mental_2a == 14 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="status_mental_2a" required>
                                                <label for="status_mental_2a_ya">Ya</label>
                                                <span class="radio-value">14</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->status_mental_2a == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="status_mental_2a_tidak" name="status_mental_2a" value="0"
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->status_mental_2b == 14 ? 'selected' : '' }}">
                                                <input type="radio" id="status_mental_2b_ya" name="status_mental_2b" value="14"
                                                       {{ $dataSkalaGeriatri->status_mental_2b == 14 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="status_mental_2b" required>
                                                <label for="status_mental_2b_ya">Ya</label>
                                                <span class="radio-value">14</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->status_mental_2b == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="status_mental_2b_tidak" name="status_mental_2b" value="0"
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->status_mental_2c == 14 ? 'selected' : '' }}">
                                                <input type="radio" id="status_mental_2c_ya" name="status_mental_2c" value="14"
                                                       {{ $dataSkalaGeriatri->status_mental_2c == 14 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="status_mental_2c" required>
                                                <label for="status_mental_2c_ya">Ya</label>
                                                <span class="radio-value">14</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->status_mental_2c == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="status_mental_2c_tidak" name="status_mental_2c" value="0"
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->penglihatan_3a == 1 ? 'selected' : '' }}">
                                                <input type="radio" id="penglihatan_3a_ya" name="penglihatan_3a" value="1"
                                                       {{ $dataSkalaGeriatri->penglihatan_3a == 1 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="penglihatan_3a" required>
                                                <label for="penglihatan_3a_ya">Ya</label>
                                                <span class="radio-value">1</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->penglihatan_3a == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="penglihatan_3a_tidak" name="penglihatan_3a" value="0"
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->penglihatan_3b == 1 ? 'selected' : '' }}">
                                                <input type="radio" id="penglihatan_3b_ya" name="penglihatan_3b" value="1"
                                                       {{ $dataSkalaGeriatri->penglihatan_3b == 1 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="penglihatan_3b" required>
                                                <label for="penglihatan_3b_ya">Ya</label>
                                                <span class="radio-value">1</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->penglihatan_3b == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="penglihatan_3b_tidak" name="penglihatan_3b" value="0"
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->penglihatan_3c == 1 ? 'selected' : '' }}">
                                                <input type="radio" id="penglihatan_3c_ya" name="penglihatan_3c" value="1"
                                                       {{ $dataSkalaGeriatri->penglihatan_3c == 1 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="penglihatan_3c" required>
                                                <label for="penglihatan_3c_ya">Ya</label>
                                                <span class="radio-value">1</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->penglihatan_3c == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="penglihatan_3c_tidak" name="penglihatan_3c" value="0"
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        ...
                                        <div class="radio-options">
                                            <div class="radio-item {{ $dataSkalaGeriatri->kebiasaan_berkemih_4a == 2 ? 'selected' : '' }}">
                                                <input type="radio" id="kebiasaan_berkemih_4a_ya" name="kebiasaan_berkemih_4a" value="2"
                                                       {{ $dataSkalaGeriatri->kebiasaan_berkemih_4a == 2 ? 'checked' : '' }}
                                                       class="assessment-field" data-field="kebiasaan_berkemih_4a" required>
                                                <label for="kebiasaan_berkemih_4a_ya">Ya</label>
                                                <span class="radio-value">2</span>
                                            </div>
                                            <div class="radio-item {{ $dataSkalaGeriatri->kebiasaan_berkemih_4a == 0 ? 'selected' : '' }}">
                                                <input type="radio" id="kebiasaan_berkemih_4a_tidak" name="kebiasaan_berkemih_4a" value="0"
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item {{ $dataSkalaGeriatri->transfer == 0 ? 'selected' : '' }}">
                                            <input type="radio" id="transfer_5a" name="transfer" value="0"
                                                   {{ $dataSkalaGeriatri->transfer == 0 ? 'checked' : '' }}
                                                   class="assessment-field" data-field="transfer" required>
                                            <label for="transfer_5a">Mandiri (boleh memakai alat bantu jalan)</label>
                                            <span class="radio-value">0</span>
                                        </div>
                                        <div class="radio-item {{ $dataSkalaGeriatri->transfer == 1 ? 'selected' : '' }}">
                                        ...
                                        <div class="radio-item {{ $dataSkalaGeriatri->transfer == 2 ? 'selected' : '' }}">
                                        ...
                                        <div class="radio-item {{ $dataSkalaGeriatri->transfer == 3 ? 'selected' : '' }}">
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <div class="radio-item {{ $dataSkalaGeriatri->mobilitas == 0 ? 'selected' : '' }}">
                                            <input type="radio" id="mobilitas_6a" name="mobilitas" value="0"
                                                   {{ $dataSkalaGeriatri->mobilitas == 0 ? 'checked' : '' }}
                                                   class="assessment-field" data-field="mobilitas" required>
                                            <label for="mobilitas_6a">Mandiri (boleh menggunakan alat bantu jalan)</label>
                                            <span class="radio-value">0</span>
                                        </div>
                                        <div class="radio-item {{ $dataSkalaGeriatri->mobilitas == 1 ? 'selected' : '' }}">
                                        ...
                                        <div class="radio-item {{ $dataSkalaGeriatri->mobilitas == 2 ? 'selected' : '' }}">
                                        ...
                                        <div class="radio-item {{ $dataSkalaGeriatri->mobilitas == 3 ? 'selected' : '' }}">
                        ...
                        <div class="score-display" id="scoreDisplay">
                            ...
                            <div class="score-category" id="riskCategory">{{ $dataSkalaGeriatri->kategori_risiko }}</div>
                        ...
                        <div class="form-section" id="interventionSection">
                            ...
                            <div id="lowRiskInterventions" style="{{ $dataSkalaGeriatri->kategori_risiko == 'Risiko Rendah' ? 'display: block;' : 'display: none;' }}">
                            ...
                            <div id="mediumRiskInterventions" style="{{ $dataSkalaGeriatri->kategori_risiko == 'Risiko Sedang' ? 'display: block;' : 'display: none;' }}">
                            ...
                            <div id="highRiskInterventions" style="{{ $dataSkalaGeriatri->kategori_risiko == 'Risiko Tinggi' ? 'display: block;' : 'display: none;' }}">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-warning btn-lg px-4" id="simpan">
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            // Function untuk mengecek duplikasi (exclude current data)
            function checkDuplicateDateTime() {
                ...
                if (tanggal && shift) {
                    ...
                    $.ajax({
                        url: "{{ route('resiko-jatuh.geriatri.check-duplicate', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}",
                        method: 'POST',
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            tanggal_implementasi: tanggal,
                            shift: shift,
                            current_id: "{{ $dataSkalaGeriatri->id }}" // Exclude current data
                        },
            ...
            // Function to initialize existing data
            function initializeExistingData() {
                // Mark selected radio items
                ...
                // Set initial risk category styling
                const currentCategory = $('#riskCategory').text().trim();
                if (currentCategory === 'Risiko Rendah') {
                    $('#riskCategory').addClass('low-risk');
                } else if (currentCategory === 'Risiko Sedang') {
                    $('#riskCategory').addClass('medium-risk');
                } else if (currentCategory === 'Risiko Tinggi') {
                    $('#riskCategory').addClass('high-risk');
                }

                // Show current intervention section
                $('#interventionSection').show();
            }
