...
@include('unit-pelayanan.gawat-darurat.action-gawat-darurat.resiko-jatuh.skala-morse.include-create')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="resikoJatuh_form" method="POST"
                action="{{ route('resiko-jatuh.morse.store', [$dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
