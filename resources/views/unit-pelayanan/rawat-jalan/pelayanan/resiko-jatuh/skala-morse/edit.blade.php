...
@include('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-morse.include-edit')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="resikoJatuh_form" method="POST"
                action="{{ route('rawat-jalan.resiko-jatuh.morse.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $skalaMorse->id]) }}">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-md-4">
                                <div class="form-group resiko_jatuh__form-group">
                                    ...
                                    <input type="date" class="form-control resiko_jatuh__form-control" name="tanggal"
                                        value="{{ old('tanggal', date('Y-m-d', strtotime($skalaMorse->tanggal))) }}" id="tanggal" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group resiko_jatuh__form-group">
