...
@include('unit-pelayanan.rawat-jalan.pelayanan.resiko-jatuh.skala-morse.include')
@push('css')
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="skalaMorseTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('rawat-jalan.resiko-jatuh.morse.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('rawat-jalan.resiko-jatuh.humpty-dumpty.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between m-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{ route('rawat-jalan.resiko-jatuh.morse.create', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <a href="{{ route('rawat-jalan.resiko-jatuh.morse.show', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                    class="btn btn-info btn-sm ms-1" title="Detail">
                                                                    <i class="ti-eye"></i>
                                                                </a>

                                                                <a href="{{ route('rawat-jalan.resiko-jatuh.morse.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                    class="btn btn-warning btn-sm ms-1" title="Edit">
                                                                    <i class="ti-pencil"></i>
                                                                </a>

                                                                <form
                                                                    action="{{ route('rawat-jalan.resiko-jatuh.morse.destroy', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
