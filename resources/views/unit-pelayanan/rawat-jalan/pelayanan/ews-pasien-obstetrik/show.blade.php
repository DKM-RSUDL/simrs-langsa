    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('rawat-jalan.ews-pasien-obstetrik.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $ewsPsienObstetrik->id]) }}"
                    class="btn btn-warning mr-2">
                    <i class="ti-pencil"></i> Edit
                </a>
                <a href="{{ route('rawat-jalan.ews-pasien-obstetrik.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $ewsPsienObstetrik->id]) }}"
