                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between m-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{ route('rawat-jalan.ews-pasien-obstetrik.create', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ route('rawat-jalan.ews-pasien-obstetrik.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $item->id]) }}"
                                                                    class="btn btn-secondary btn-sm ms-2" target="_blank">
                                                                    <i class="bi bi-printer"></i>
                                                                </a>

                                                                <a href="{{ route('rawat-jalan.ews-pasien-obstetrik.show', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                    class="btn btn-info btn-sm ms-2" title="Detail">
                                                                    <i class="ti-eye"></i>
                                                                </a>
                                                                @if ($item->status == 0)
                                                                    <a href="{{ route('rawat-jalan.ews-pasien-obstetrik.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                                                ...
                                                                <form
                                                                    action="{{ route('rawat-jalan.ews-pasien-obstetrik.destroy', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
