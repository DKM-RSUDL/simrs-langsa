            ...
            <div class="d-flex justify-content-center">
                <div class="card w-100 h-100">
                    <div class="card-body">
                        ...
                        <form method="POST"
                            action="{{ route('rawat-jalan.asesmen.medis.kulit-kelamin.index', [
                                'kd_unit' => $kd_unit,
                                'kd_pasien' => $kd_pasien,
                                'tgl_masuk' => $tgl_masuk,
...
@include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-kulitkelamin.modal-riwayatkeluarga')
@include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-kulitkelamin.modal-create-obat')
@include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-kulitkelamin.include')
