...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('rawat-jalan.asesmen.medis.kulit-kelamin.show', [
                'kd_unit' => $kd_unit,
                'kd_pasien' => $kd_pasien,
                'tgl_masuk' => $tgl_masuk,
            ...
            <div class="d-flex justify-content-center">
                <div class="card w-100 h-100">
                    <div class="card-body">
                        ...
                        <form method="POST"
                            action="{{ route('rawat-jalan.asesmen.medis.kulit-kelamin.update', [
                                'kd_unit' => $kd_unit,
                                'kd_pasien' => $kd_pasien,
                                'tgl_masuk' => $tgl_masuk,
                                'urut_masuk' => $urut_masuk,
                                    ...
                                    <div class="section-separator" id="implementasi" style="margin-bottom: 2rem;">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <small class="d-block text-secondary mb-3">Pilih tanda dokumen untuk mencari
                                                ...
                                                rencana Penatalaksanaan dan Pengobatan yang tidak ditemukan.</small>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div id="observasi-list" class="list-group mb-2 bg-light rounded p-3 mt-2">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div id="terapeutik-list" class="list-group mb-2 bg-light rounded p-3 mt-2">
                                                <!-- Items will be added here dynamically -->
                                            </div>
                                            <!-- Hidden input to store JSON data -->
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div id="edukasi-list" class="list-group mb-2 bg-light rounded p-3 mt-2">
                                                <!-- Items will be added here dynamically -->
                                            </div>
                                            <!-- Hidden input to store JSON data -->
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div id="kolaborasi-list" class="list-group mb-2 bg-light rounded p-3 mt-2">
                                                <!-- Items will be added here dynamically -->
                                            </div>
                                            <!-- Hidden input to store JSON data -->
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div id="rencana-list" class="list-group mb-3 bg-light rounded p-3">
                                                <!-- Items will be added here dynamically -->
                                            </div>
                                            <!-- Hidden input to store JSON data -->
                                            <input type="hidden" id="rencana_penatalaksanaan" name="prognosis"
                                                value="{{ $asesmenKulitKelamin->prognosis ?? '[]' }}">
                                        </div>
                                    </div>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            initImplementationSectionEdit('rencana', 'rencana_penatalaksanaan', 'prognosis');
