...
@include('unit-pelayanan.rawat-jalan.pelayanan.status-fungsional.include-create')
...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('rawat-jalan.status-fungsional.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
            ...
            <form id="barthel_form" method="POST"
                action="{{ route('rawat-jalan.status-fungsional.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
