...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('rawat-jalan.status-nyeri.skala-cries.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" class="btn btn-outline-primary mb-3">
                <i class="ti-arrow-left"></i> Kembali
            </a>

            <form id="criesAssessmentForm" method="POST"
                action="{{ route('rawat-jalan.status-nyeri.skala-cries.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf

                <div class="card shadow-sm">
                    <div class="card-body">
                        <h4 class="header-asesmen">Form Pengkajian Status Nyeri Skala CRIES</h4>
                            ...
                            <div class="cries-assessment">
                                ...
                                <div class="cries-category">
                                    ...
                                    <div class="cries-options">
                                        <div class="cries-option" data-category="crying" data-score="0">
                                            <input type="radio" name="crying" value="0" id="crying_0" required>
                                            <div class="cries-description">Tidak menangis atau tangisan tidak melengking</div>
                                            <span class="cries-score">0</span>
                                        </div>
                                        <div class="cries-option" data-category="crying" data-score="1">
                                            <input type="radio" name="crying" value="1" id="crying_1" required>
                                            <div class="cries-description">Tangisan melengking tetapi mudah dihibur</div>
                                            <span class="cries-score">1</span>
                                        </div>
                                        <div class="cries-option" data-category="crying" data-score="2">
                                            <input type="radio" name="crying" value="2" id="crying_2" required>
                                            <div class="cries-description">Tangisan melengking dan tidak mudah dihibur</div>
                                ...
                                <div class="cries-category">
                                    ...
                                    <div class="cries-options">
                                        <div class="cries-option" data-category="requires" data-score="0">
                                            <input type="radio" name="requires" value="0" id="requires_0" required>
                                            <div class="cries-description">Tidak membutuhkan O2 ekstra</div>
                                            <span class="cries-score">0</span>
                                        </div>
                                        <div class="cries-option" data-category="requires" data-score="1">
                                            <input type="radio" name="requires" value="1" id="requires_1" required>
                                            <div class="cries-description">Membutuhkan oksigen < 30%</div>
                                            <span class="cries-score">1</span>
                                        </div>
                                        <div class="cries-option" data-category="requires" data-score="2">
                                            <input type="radio" name="requires" value="2" id="requires_2" required>
                                            <div class="cries-description">Membutuhkan oksigen > 30%</div>
                                            <span class="cries-score">2</span>
                                        </div>
                                    </div>
                                ...
                                <div class="cries-category">
                                    ...
                                    <div class="cries-options">
                                        <div class="cries-option" data-category="increased" data-score="0">
                                            <input type="radio" name="increased" value="0" id="increased_0" required>
                                            <div class="cries-description">Berdenyut Jantung dan TD tidak mengalami perubahan</div>
                                            <span class="cries-score">0</span>
                                        </div>
                                        <div class="cries-option" data-category="increased" data-score="1">
                                            <input type="radio" name="increased" value="1" id="increased_1" required>
                                            <div class="cries-description">Denyut jantung dan TD meningkat < 20% dari baseline</div>
                                            <span class="cries-score">1</span>
                                        </div>
                                        <div class="cries-option" data-category="increased" data-score="2">
                                            <input type="radio" name="increased" value="2" id="increased_2" required>
                                            <div class="cries-description">Denyut jantung dan TD meningkat > 20% dari baseline</div>
                                            <span class="cries-score">2</span>
                                        </div>
                                    </div>
                                ...
                                <div class="cries-category">
                                    ...
                                    <div class="cries-options">
                                        <div class="cries-option" data-category="expression" data-score="0">
                                            <input type="radio" name="expression" value="0" id="expression_0" required>
                                            <div class="cries-description">Tidak ada seringai</div>
                                            <span class="cries-score">0</span>
                                        </div>
                                        <div class="cries-option" data-category="expression" data-score="1">
                                            <input type="radio" name="expression" value="1" id="expression_1" required>
                                            <div class="cries-description">Seringai ada</div>
                                            <span class="cries-score">1</span>
                                        </div>
                                        <div class="cries-option" data-category="expression" data-score="2">
                                            <input type="radio" name="expression" value="2" id="expression_2" required>
                                ...
                                <div class="cries-category">
                                    ...
                                    <div class="cries-options">
                                        <div class="cries-option" data-category="sleepless" data-score="0">
                                            <input type="radio" name="sleepless" value="0" id="sleepless_0" required>
                                            <div class="cries-description">Terus menerus tidur</div>
                                            <span class="cries-score">0</span>
                                        </div>
                                        <div class="cries-option" data-category="sleepless" data-score="1">
                                            <input type="radio" name="sleepless" value="1" id="sleepless_1" required>
                                            <div class="cries-description">Terbangun pada interval berulang</div>
                                            <span class="cries-score">1</span>
                                        </div>
                                        <div class="cries-option" data-category="sleepless" data-score="2">
                                            <input type="radio" name="sleepless" value="2" id="sleepless_2" required>
