...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('rawat-jalan.status-nyeri.skala-flacc.show', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $skalaFlacc->id]) }}" class="btn btn-outline-primary mb-3">
                <i class="ti-arrow-left"></i> Kembali
            </a>

            <form id="flaccAssessmentForm" method="POST"
                action="{{ route('rawat-jalan.status-nyeri.skala-flacc.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $skalaFlacc->id]) }}">
                @csrf
                @method('PUT')

                <div class="card shadow-sm">
                    <div class="card-body">
                        <h4 class="header-asesmen">Edit Pengkajian Status Nyeri Skala FLACC</h4>
                                ...
                                <div class="datetime-group">
                                    <div class="datetime-item">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_implementasi" id="tanggal_implementasi" 
                                               value="{{ old('tanggal_implementasi', \Carbon\Carbon::parse($skalaFlacc->tanggal_implementasi)->format('Y-m-d')) }}" required>
                                    </div>
                                    <div class="datetime-item">
                                        <label>Jam</label>
                                        <input type="time" class="form-control" name="jam_implementasi" id="jam_implementasi" 
                                               value="{{ old('jam_implementasi', \Carbon\Carbon::parse($skalaFlacc->jam_implementasi)->format('H:i')) }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flacc-assessment">
                                ...
                                <div class="flacc-category">
                                    ...
                                    <div class="flacc-options">
                                        <div class="flacc-option {{ old('face', $skalaFlacc->face) == '0' ? 'selected' : '' }}" data-category="face" data-score="0">
                                            <input type="radio" name="face" value="0" id="face_0" {{ old('face', $skalaFlacc->face) == '0' ? 'checked' : '' }} required>
                                            <div class="flacc-description">Tersenyum tidak ada ekspresi</div>
                                            <span class="flacc-score">0</span>
                                        </div>
                                        <div class="flacc-option {{ old('face', $skalaFlacc->face) == '1' ? 'selected' : '' }}" data-category="face" data-score="1">
                                            <input type="radio" name="face" value="1" id="face_1" {{ old('face', $skalaFlacc->face) == '1' ? 'checked' : '' }} required>
                                        ...
                                        <div class="flacc-option {{ old('face', $skalaFlacc->face) == '2' ? 'selected' : '' }}" data-category="face" data-score="2">
                                            <input type="radio" name="face" value="2" id="face_2" {{ old('face', $skalaFlacc->face) == '2' ? 'checked' : '' }} required>
                                ...
                                <div class="flacc-category">
                                    ...
                                    <div class="flacc-options">
                                        <div class="flacc-option {{ old('legs', $skalaFlacc->legs) == '0' ? 'selected' : '' }}" data-category="legs" data-score="0">
                                            <input type="radio" name="legs" value="0" id="legs_0" {{ old('legs', $skalaFlacc->legs) == '0' ? 'checked' : '' }} required>
                                            <div class="flacc-description">Posisi normal atau santai</div>
                                            <span class="flacc-score">0</span>
                                        </div>
                                        <div class="flacc-option {{ old('legs', $skalaFlacc->legs) == '1' ? 'selected' : '' }}" data-category="legs" data-score="1">
                                            <input type="radio" name="legs" value="1" id="legs_1" {{ old('legs', $skalaFlacc->legs) == '1' ? 'checked' : '' }} required>
                                        ...
                                        <div class="flacc-option {{ old('legs', $skalaFlacc->legs) == '2' ? 'selected' : '' }}" data-category="legs" data-score="2">
                                            <input type="radio" name="legs" value="2" id="legs_2" {{ old('legs', $skalaFlacc->legs) == '2' ? 'checked' : '' }} required>
                                ...
                                <div class="flacc-category">
                                    ...
                                    <div class="flacc-options">
                                        <div class="flacc-option {{ old('activity', $skalaFlacc->activity) == '0' ? 'selected' : '' }}" data-category="activity" data-score="0">
                                            <input type="radio" name="activity" value="0" id="activity_0" {{ old('activity', $skalaFlacc->activity) == '0' ? 'checked' : '' }} required>
                                            <div class="flacc-description">Berbaring tenang dengan tenang posisi normal, bergerak dengan mudah dan bebas</div>
                                            <span class="flacc-score">0</span>
                                        </div>
                                        <div class="flacc-option {{ old('activity', $skalaFlacc->activity) == '1' ? 'selected' : '' }}" data-category="activity" data-score="1">
                                            <input type="radio" name="activity" value="1" id="activity_1" {{ old('activity', $skalaFlacc->activity) == '1' ? 'checked' : '' }} required>
                                        ...
                                        <div class="flacc-option {{ old('activity', $skalaFlacc->activity) == '2' ? 'selected' : '' }}" data-category="activity" data-score="2">
                                            <input type="radio" name="activity" value="2" id="activity_2" {{ old('activity', $skalaFlacc->activity) == '2' ? 'checked' : '' }} required>
                                ...
                                <div class="flacc-category">
                                    ...
                                    <div class="flacc-options">
                                        <div class="flacc-option {{ old('cry', $skalaFlacc->cry) == '0' ? 'selected' : '' }}" data-category="cry" data-score="0">
                                            <input type="radio" name="cry" value="0" id="cry_0" {{ old('cry', $skalaFlacc->cry) == '0' ? 'checked' : '' }} required>
                                            <div class="flacc-description">Tidak menangis (pada saat terjaga atau saat tidur)</div>
                                            <span class="flacc-score">0</span>
                                        </div>
                                        <div class="flacc-option {{ old('cry', $skalaFlacc->cry) == '1' ? 'selected' : '' }}" data-category="cry" data-score="1">
                                            <input type="radio" name="cry" value="1" id="cry_1" {{ old('cry', $skalaFlacc->cry) == '1' ? 'checked' : '' }} required>
                                            <div class="flacc-description">Erangan atau rengekan,sesekali menangis, mendesah, sesekalai mengeluh</div>
                                            <span class="flacc-score">1</span>
                                        </div>
                                        <div class="flacc-option {{ old('cry', $skalaFlacc->cry) == '2' ? 'selected' : '' }}" data-category="cry" data-score="2">
                                            <input type="radio" name="cry" value="2" id="cry_2" {{ old('cry', $skalaFlacc->cry) == '2' ? 'checked' : '' }} required>
                                ...
                                <div class="flacc-category">
                                    ...
                                    <div class="flacc-options">
                                        <div class="flacc-option {{ old('consolability', $skalaFlacc->consolability) == '0' ? 'selected' : '' }}" data-category="consolability" data-score="0">
                                            <input type="radio" name="consolability" value="0" id="consolability_0" {{ old('consolability', $skalaFlacc->consolability) == '0' ? 'checked' : '' }} required>
                                            <div class="flacc-description">Tenang, santai dan riang</div>
                                            <span class="flacc-score">0</span>
                                        </div>
                                        <div class="flacc-option {{ old('consolability', $skalaFlacc->consolability) == '1' ? 'selected' : '' }}" data-category="consolability" data-score="1">
                                            <input type="radio" name="consolability" value="1" id="consolability_1" {{ old('consolability', $skalaFlacc->consolability) == '1' ? 'checked' : '' }} required>
                                            <div class="flacc-description">Perlu diyakinkan dengan sentuhan pelukan, mengajak berbicara. Perhatian dapat dialihkan</div>
                                            <span class="flacc-score">1</span>
                                        </div>
                                        <div class="flacc-option {{ old('consolability', $skalaFlacc->consolability) == '2' ? 'selected' : '' }}" data-category="consolability" data-score="2">
                                            <input type="radio" name="consolability" value="2" id="consolability_2" {{ old('consolability', $skalaFlacc->consolability) == '2' ? 'checked' : '' }} required>
                                ...
                                <div class="total-score-display" id="totalScoreDisplay">
                                    <div class="total-score-value" id="totalScoreValue">{{ $skalaFlacc->pain_value }}</div>
                                ...
                                <input type="hidden" name="pain_value" id="pain_value" value="{{ old('pain_value', $skalaFlacc->pain_value) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lokasi_nyeri" id="lokasi_nyeri" 
                                       value="{{ old('lokasi_nyeri', $skalaFlacc->lokasi_nyeri) }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="durasi_nyeri" id="durasi_nyeri" 
                                       value="{{ old('durasi_nyeri', $skalaFlacc->durasi_nyeri) }}" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="menjalar-group">
                                    <button type="button" class="menjalar-btn {{ old('menjalar', $skalaFlacc->menjalar) == 'ya' ? 'selected' : '' }}" data-menjalar="ya">Ya</button>
                                    <button type="button" class="menjalar-btn {{ old('menjalar', $skalaFlacc->menjalar) == 'tidak' ? 'selected' : '' }}" data-menjalar="tidak">Tidak</button>
                                </div>
                                <input type="hidden" name="menjalar" id="menjalar_value" value="{{ old('menjalar', $skalaFlacc->menjalar) }}" required>
                                
                                <div id="menjalar_keterangan" class="menjalar-keterangan {{ old('menjalar', $skalaFlacc->menjalar) == 'ya' ? 'show' : '' }}">
                                    <label class="form-label">Ke : </label>
                                    <input type="text" class="form-control" name="menjalar_keterangan" id="menjalar_keterangan_text" 
                                           value="{{ old('menjalar_keterangan', $skalaFlacc->menjalar_keterangan) }}" 
                                           placeholder="Contoh: Kepala, Dada, Perut..." 
                                           {{ old('menjalar', $skalaFlacc->menjalar) == 'ya' ? 'required' : '' }}>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @foreach($kualitasnyeri as $item)
                                        <div class="radio-item">
                                            <input type="radio" name="kualitas_nyeri" value="{{ $item->id }}" id="kualitas_{{ $item->id }}" 
                                                   {{ old('kualitas_nyeri', $skalaFlacc->kualitas_nyeri) == $item->id ? 'checked' : '' }} required>
                                    ...
                                    @foreach($faktorpemberat as $item)
                                        <div class="radio-item">
                                            <input type="radio" name="faktor_pemberat" value="{{ $item->id }}" id="pemberat_{{ $item->id }}" 
                                                   {{ old('faktor_pemberat', $skalaFlacc->faktor_pemberat) == $item->id ? 'checked' : '' }} required>
                                    ...
                                    @foreach($faktorperingan as $item)
                                        <div class="radio-item">
                                            <input type="radio" name="faktor_peringan" value="{{ $item->id }}" id="peringan_{{ $item->id }}" 
                                                   {{ old('faktor_peringan', $skalaFlacc->faktor_peringan) == $item->id ? 'checked' : '' }} required>
                                    ...
                                    @foreach($efeknyeri as $item)
                                        <div class="radio-item">
                                            <input type="radio" name="efek_nyeri" value="{{ $item->id }}" id="efek_{{ $item->id }}" 
                                                   {{ old('efek_nyeri', $skalaFlacc->efek_nyeri) == $item->id ? 'checked' : '' }} required>
                                    ...
                                    @foreach($jenisnyeri as $item)
                                        <div class="radio-item">
                                            <input type="radio" name="jenis_nyeri" value="{{ $item->id }}" id="jenis_{{ $item->id }}" 
                                                   {{ old('jenis_nyeri', $skalaFlacc->jenis_nyeri) == $item->id ? 'checked' : '' }} required>
                                    ...
                                    @foreach($frekuensinyeri as $item)
                                        <div class="radio-item">
                                            <input type="radio" name="frekuensi_nyeri" value="{{ $item->id }}" id="frekuensi_{{ $item->id }}" 
                                                   {{ old('frekuensi_nyeri', $skalaFlacc->frekuensi_nyeri) == $item->id ? 'checked' : '' }} required>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="nr_kaji_ulang_8jam" name="nr_kaji_ulang_8jam" value="1"
                                               {{ old('nr_kaji_ulang_8jam', $skalaFlacc->nr_kaji_ulang_8jam) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="nr_edukasi_pasien" name="nr_edukasi_pasien" value="1"
                                               {{ old('nr_edukasi_pasien', $skalaFlacc->nr_edukasi_pasien) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="nr_teknik_relaksasi" name="nr_teknik_relaksasi" value="1"
                                               {{ old('nr_teknik_relaksasi', $skalaFlacc->nr_teknik_relaksasi) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="nr_posisi_nyaman" name="nr_posisi_nyaman" value="1"
                                               {{ old('nr_posisi_nyaman', $skalaFlacc->nr_posisi_nyaman) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="nr_nsaid" name="nr_nsaid" value="1"
                                               {{ old('nr_nsaid', $skalaFlacc->nr_nsaid) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_beritahu_tim_nyeri" name="ns_beritahu_tim_nyeri" value="1"
                                               {{ old('ns_beritahu_tim_nyeri', $skalaFlacc->ns_beritahu_tim_nyeri) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_rujuk_tim_nyeri" name="ns_rujuk_tim_nyeri" value="1"
                                               {{ old('ns_rujuk_tim_nyeri', $skalaFlacc->ns_rujuk_tim_nyeri) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_kolaborasi_obat" name="ns_kolaborasi_obat" value="1"
                                               {{ old('ns_kolaborasi_obat', $skalaFlacc->ns_kolaborasi_obat) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_teknik_relaksasi" name="ns_teknik_relaksasi" value="1"
                                               {{ old('ns_teknik_relaksasi', $skalaFlacc->ns_teknik_relaksasi) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_posisi_nyaman" name="ns_posisi_nyaman" value="1"
                                               {{ old('ns_posisi_nyaman', $skalaFlacc->ns_posisi_nyaman) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_edukasi_pasien" name="ns_edukasi_pasien" value="1"
                                               {{ old('ns_edukasi_pasien', $skalaFlacc->ns_edukasi_pasien) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_kaji_ulang_2jam" name="ns_kaji_ulang_2jam" value="1"
                                               {{ old('ns_kaji_ulang_2jam', $skalaFlacc->ns_kaji_ulang_2jam) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="ns_konsultasi_tim" name="ns_konsultasi_tim" value="1"
                                               {{ old('ns_konsultasi_tim', $skalaFlacc->ns_konsultasi_tim) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="nt_semua_langkah_sedang" name="nt_semua_langkah_sedang" value="1"
                                               {{ old('nt_semua_langkah_sedang', $skalaFlacc->nt_semua_langkah_sedang) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="nt_kaji_ulang_1jam" name="nt_kaji_ulang_1jam" value="1"
                                               {{ old('nt_kaji_ulang_1jam', $skalaFlacc->nt_kaji_ulang_1jam) ? 'checked' : '' }}>
...
@push('js')
    <script>
        ...
        function initializeForm() {
            ...
            const menjalar = $('#menjalar_value').val();
            if (menjalar === 'ya') {
                $('#menjalar_keterangan').addClass('show');
                $('#menjalar_keterangan_text').prop('required', true);
            }
