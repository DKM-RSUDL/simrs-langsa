...
@section('content')
    @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-ginekologik.show-include')
    <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex justify-content-end">
                    {{-- <a href="{{ route('rawat-jalan.asesmen.medis.ginekologik.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $asesmen->id]) }}"
                        class="btn btn-sm btn-info">
                        <i class="fas fa-print"></i> print
                    </a> --}}
                    <a href="{{ route('rawat-jalan.asesmen.medis.ginekologik.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $asesmen->id]) }}"
