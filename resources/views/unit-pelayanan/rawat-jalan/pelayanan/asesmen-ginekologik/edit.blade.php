...
@include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-ginekologik.edit-include')
            ...
            <div class="d-flex justify-content-center">
                <div class="card w-100 h-100">
                    <div class="card-body">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('rawat-jalan.asesmen.medis.ginekologik.update', [
