...
@push('js')
    <script type="text/javascript">
        ...
        $('#filterButton').click(function(e) {
            ...
            window.location.href = "{{ route('rawat-jalan.lab-patologi-klinik.index', ['kd_unit' => $dataMedis->kd_unit, 'kd_pasien' => $dataMedis->kd_pasien, 'tgl_masuk' => \Carbon\Carbon::parse($dataMedis->tgl_masuk)->format('Y-m-d'), 'urut_masuk' => $dataMedis->urut_masuk]) }}" + queryString;
        });
    });
    </script>
@endpush
