    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="edukasiForm" method="POST"
                action="{{ route('rawat-jalan.penundaan.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
                ...
                <div class="d-flex justify-content-center">
                    <div class="card w-100 h-100 shadow-sm">
                        <div class="card-body">
                            <div class="px-3">
                                <h4 class="header-asesmen">Tambah Penundaan Pelayanan</h4>
                            </div>
                            ...
                            <div class="px-3">
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status_penerima_informasi" id="status_penerima_informasi"
                                            ...
                                            <option value="3">Penanggungjawab pasien</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" id="penerima-informasi-wrap">
                                        ...
                                        <input type="text" class="form-control" id="nama_penerima_informasi"
                                            name="nama_penerima_informasi" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pelayanan_diberikan"
                                            name="pelayanan_diberikan" required>
                                    </div>
                                ...
                                <div class="section-separator" id="identitas-keluarga">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="penyebab_kerusakan_alat" class="form-control" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="penyebab_lainnya" class="form-control" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="identitas-keluarga">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input type="date" name="alternatif_tgl" class="form-control me-2 date"
                                                disabled>
                                            <input type="time" name="alternatif_jam" class="form-control" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alternatif_rujuk" class="form-control" disabled>
                                    </div>

                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="checkbox" name="alternatif_kembali" id="alternatif_kembali"
                                                class="form-check-input me-1" value="1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alternatif_lainnya" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>
