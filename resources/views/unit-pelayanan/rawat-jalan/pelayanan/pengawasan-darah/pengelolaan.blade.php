                                    ...
                                    <div class="d-flex justify-content-between m-3">
                                        <div class="row w-100">
                                            ...
                                            <div class="col-md-4 text-end">
                                                ...
                                                <a href="{{ route('rawat-jalan.pengawasan-darah.pengelolaan.create', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm" role="group">
                                                                <a href="{{ route('rawat-jalan.pengawasan-darah.pengelolaan.show', [
                                                                    'kd_unit' => $dataMedis->kd_unit,
                                                                    'kd_pasien' => $dataMedis->kd_pasien,
                                                                    'tgl_masuk' => date('Y-m-d', strtotime($dataMedis->tgl_masuk)),
                                                                    'urut_masuk' => $dataMedis->urut_masuk,
                                                                ...
                                                                <a href="{{ route('rawat-jalan.pengawasan-darah.pengelolaan.edit', [
                                                                    'kd_unit' => $dataMedis->kd_unit,
                                                                    'kd_pasien' => $dataMedis->kd_pasien,
                                                                    'tgl_masuk' => date('Y-m-d', strtotime($dataMedis->tgl_masuk)),
                                                                    'urut_masuk' => $dataMedis->urut_masuk,
                                                                ...
                                                                <form action="{{ route('rawat-jalan.pengawasan-darah.pengelolaan.destroy', [
                                                                    'kd_unit' => $dataMedis->kd_unit,
                                                                    'kd_pasien' => $dataMedis->kd_pasien,
                                                                    'tgl_masuk' => date('Y-m-d', strtotime($dataMedis->tgl_masuk)),
                                                                    'urut_masuk' => $dataMedis->urut_masuk,
