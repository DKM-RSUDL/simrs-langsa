    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-section">
                <form
                    action="{{ route('rawat-jalan.pengawasan-darah.pengelolaan.store', [
                    ...
                    <div class="row">
                        <div class="col-12 text-end">
                            ...
                            <a href="{{ route('rawat-jalan.pengawasan-darah.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}?tab=pengelolaan"
