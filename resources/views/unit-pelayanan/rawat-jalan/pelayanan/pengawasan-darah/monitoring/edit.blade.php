            ...
            <div class="form-section">
                <form
                    action="{{ isset($monitoring) ? 
                        route('rawat-jalan.pengawasan-darah.monitoring.update', [
                        ...
                        route('rawat-jalan.pengawasan-darah.monitoring.store', [
                            'kd_unit' => $dataMedis->kd_unit,
                            'kd_pasien' => $dataMedis->kd_pasien,
                            'tgl_masuk' => date('Y-m-d', strtotime($dataMedis->tgl_masuk)),
                            'urut_masuk' => $dataMedis->urut_masuk,
                    ...
                    <div class="row">
                        <div class="col-12 text-end">
                            ...
                            <a href="{{ route('rawat-jalan.pengawasan-darah.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}?tab=monitoring"
