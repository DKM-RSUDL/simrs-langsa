            ...
            <div class="d-flex justify-content-center">
                <div class="card w-100 h-100">
                    <div class="card-body">
                        ...
                        <form method="POST"
                            action="{{ route('rawat-jalan.asesmen.medis.geriatri.index', [
                                'kd_unit' => $kd_unit,
                                'kd_pasien' => $kd_pasien,
                                'tgl_masuk' => $tgl_masuk,
...
@endsection
@include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-geriatri.modal-create-alergi')
@include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-geriatri.include')