...
@push('js')
        ...
        $(document).ready(function() {
            $('#SelectOption').change(function() {
                ...
                window.location.href =
                    "{{ route('rawat-jalan.radiologi.index', ['kd_unit' => $dataMedis->kd_unit, 'kd_pasien' => $dataMedis->kd_pasien, 'tgl_masuk' => \Carbon\Carbon::parse($dataMedis->tgl_masuk)->format('Y-m-d'), 'urut_masuk' => $dataMedis->urut_masuk]) }}" +
                    queryString;
            });
        });
    ...
    <script>
        ...
        $(document).on('click', '.btn-edit-rad', function(e) {
            ...
            let $modal = $(target);
            let url =
                "{{ route('rawat-jalan.radiologi.get-rad-detail-ajax', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}";
