    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header  bg-primary">
                <h5 class="modal-title text-white" id="extraLargeModalLabel">Resume Medis Rawat Jalan</h5>
...
@include('unit-pelayanan.rawat-jalan.pelayanan.resume.resume-medis.components.modal-create-diagnosi')
@include('unit-pelayanan.rawat-jalan.pelayanan.resume.resume-medis.components.modal-input-diagnosis')
@include('unit-pelayanan.rawat-jalan.pelayanan.resume.resume-medis.components.modal-kode-icd')
...
@include('unit-pelayanan.rawat-jalan.pelayanan.resume.resume-medis.components.modal-view-labor-create')
