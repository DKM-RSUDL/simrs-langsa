                    ...
                    <form id="editAsesmenForm">
                        ...
                        <div class="form-line">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen.edit-alergimodal')
                            </div>
                            <div class="table-responsive">
                        ...
                        <div class="form-line">
                            ...
                            <div class="row mb-3">
                                <div class="col-2 position-relative">
                                    ...
                                    @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen.edit-gcs')
                                </div>
                                <div class="col-4">
                                    <label>AVPU</label>
                        ...
                        <div class="form-line">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen.edit-diagnosismodal')
                            </div>
                            <div class="row">
                                <div class="col-12">
                        ...
                        <div class="form-line">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen.edit-retriasemodal')
                            </div>
                        ...
                        <div class="form-line">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen.edit-alatyangterpasang')
                            </div>
                            <div class="table-responsive mb-3">
                        ...
                        <div class="form-line">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen.edit-tindaklanjut')
                            </div>
