        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    ...
                    'description' =>
                        'Rincian data echocardiography pasien rawat jalan dengan mengisi formulir di bawah ini.',
                ])
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.1" class="form-control" name="rv_ann_diameter"
                                        value="{{ old('rv_ann_diameter', $echocardiography->rv_ann_diameter) }}" disabled>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.1" class="form-control" name="e_e_prime_ratio"
                                        value="{{ old('e_e_prime_ratio', $echocardiography->e_e_prime_ratio) }}" disabled>
                                </div>
                                <div class="col-md-4">
