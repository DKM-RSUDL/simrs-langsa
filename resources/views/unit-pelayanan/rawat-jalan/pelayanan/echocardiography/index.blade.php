                                ...
                                <tr>
                                    ...
                                    <td>
                                        <x-table-action>
                                            ...
                                            <!-- Delete Button -->
                                            <form
                                                action="{{ route('rawat-jalan.echocardiography.destroy', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
