                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-info text-white text-center py-3">
                            <h5 class="mb-0 font-weight-bold">
                                ...
                                DETAIL IKHTISAR FOLLOW-UP PERAWATAN PASIEN HIV DAN TERAPI ANTIRETROVIRAL (ART)
                            </h5>
                        </div>
                                ...
                                <div class="form-container">
                                    <div class="info-card">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="mb-1">Detail Data Follow-Up</h6>
                                                <p class="mb-0">Menampilkan informasi lengkap data kunjungan follow-up
                                                    perawatan HIV ART pasien.
                                                    Data ini bersifat read-only dan tidak dapat diubah.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="legend-section">
                                        ...
                                        <div class="legend-grid">
                                            <div class="legend-item">
                                                <h6><i class="fas fa-calendar-check me-2"></i>Tanggal Kunjungan [Kolom 1]
                                                </h6>
                                                <p>Tulis tanggal kunjungan yang sebenarnya sejak kunjungan pertama perawatan
                                                    HIV</p>
                                            </div>
                                            ...
                                            <div class="legend-item">
                                                <h6><i class="fas fa-prescription-bottle-alt me-2"></i>Adherence ART [Kolom
                                                    14]</h6>
                                                <p>Perkiraan adherence dgn menanyakan apakah pasien melupakan dosis obat.
                                                </p>
                                                ...
                                                <p>1 = (>95%) artinya < 3 dosis lupa diminum dalam 30 hari</p>
                                                        ...
                                                        <p>Jika paduan ART yang diberikan terdiri dari berbagai dosis, maka
                                                            pilihlah adherence obat yang terjelek</p>
                                            </div>

                                            <div class="legend-item">
                                                <h6><i class="fas fa-exclamation-triangle me-2"></i>Efek Samping [Kolom 15]
                                                </h6>
                                            ...
                                            <div class="legend-item">
                                                <h6><i class="fas fa-flag-checkered me-2"></i>Akhir Follow Up [Kolom 20]
                                                </h6>
                                                <p><strong>M</strong> = jika pasien meninggal → tulis tanggal meninggal</p>
                                                <p><strong>LFU</strong> = jika pasien >3 bulan tidak datang ke layanan →
                                                    tulis tanggal terakhir</p>
                                                <p><strong>RK</strong> = jika pasien dirujuk keluar → tulis tanggal rujuk
                                                    keluar dan nama klinik barunya</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('js')
    <script>
                        ...
                        <div class="form-section">
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_kunjungan_${visitCount}" class="form-control"
                                           value="${getValue('tanggal_kunjungan')}" required disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_rencana_${visitCount}" class="form-control"
                                           value="${getValue('tanggal_rencana')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <select name="pasien_rujuk_masuk_${visitCount}" class="form-select" onchange="toggleRujukanFields(this, ${visitCount})" disabled>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nama_klinik_art_${visitCount}" id="nama_klinik_art_${visitCount}"
                                                ...
                                                value="${getValue('nama_klinik_art')}" disabled>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        value="${getValue('dengan_art')}" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="four-col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="bb_${visitCount}" class="form-control" step="0.1"
                                               placeholder="0" required min="0" max="500" value="${getValue('bb')}" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="tb_${visitCount}" class="form-control" step="0.1"
                                               placeholder="0" min="0" max="300" value="${getValue('tb')}" disabled>
                                        <span class="input-group-text">cm</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Status Fungsional <span class="text-danger">*</span></label>
                                    <select name="status_fungsional_${visitCount}" class="form-select" required disabled>
                                        <option value="">-- Pilih --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="stad_klinis_${visitCount}" class="form-control"
                                           value="${getValue('stad_klinis')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <select name="hamil_${visitCount}" class="form-select" disabled>
                                        <option value="">-- Pilih --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="infeksi_opportunistik_${visitCount}" class="form-select" disabled>
                                        <option value="">-- Pilih --</option>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="obat_io_${visitCount}" class="form-control"
                                           value="${getValue('obat_io')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <select name="status_tb_${visitCount}" class="form-select" disabled>
                                        <option value="">-- Pilih --</option>
                            ...
                            <div class="three-col">
                                <div class="form-group">
                                    ...
                                    <select name="pp_inh_${visitCount}" class="form-select" onchange="toggleField(this, 'pp_inh_kode_${visitCount}')" disabled>
                                        <option value="">-- Pilih --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ppk_${visitCount}" class="form-select" onchange="toggleField(this, 'ppk_hasil_${visitCount}')" disabled>
                                        <option value="">-- Pilih --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pp_inh_hasil_${visitCount}" class="form-select" disabled>
                                        <option value="">-- Pilih --</option>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    <input type="text" name="pp_inh_kode_${visitCount}" id="pp_inh_kode_${visitCount}"
                                           ...
                                           placeholder="Masukkan kode PP INH" value="${getValue('pp_inh_kode')}" disabled>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="ppk_hasil_${visitCount}" id="ppk_hasil_${visitCount}"
                                           ...
                                           placeholder="Hasil akhir PPK" value="${getValue('ppk_hasil')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="obat_arv_${visitCount}" class="form-control" rows="3"
                                          placeholder="Contoh: TDF+3TC+EFV 1x1 tablet per hari" disabled>${getValue('obat_arv')}</textarea>
                            ...
                            <div class="three-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sisa_obat_${visitCount}" class="form-control"
                                           value="${getValue('sisa_obat')}" disabled>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Adherence ART</label>
                                    <select name="adherence_art_${visitCount}" class="form-select" disabled>
                                        <option value="">-- Pilih --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="efek_samping_${visitCount}" class="form-control"
                                           value="${getValue('efek_samping')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="cd4_${visitCount}" class="form-control"
                                               placeholder="0" min="0" value="${getValue('cd4')}" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="hasil_lab_${visitCount}" class="form-control"
                                           placeholder="Hasil pemeriksaan lab lain" value="${getValue('hasil_lab')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <select name="diberikan_kondom_${visitCount}" class="form-select" onchange="toggleField(this, 'diberikan_kondom_detail_${visitCount}')" disabled>
                                        <option value="">-- Pilih --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rujuk_spesialis_${visitCount}" class="form-control"
                                           value="${getValue('rujuk_spesialis')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    <input type="text" name="diberikan_kondom_detail_${visitCount}" id="diberikan_kondom_detail_${visitCount}"
                                           ...
                                           placeholder="tuliskan jumlah" value="${getValue('diberikan_kondom_detail')}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="two-col">
                                <div class="form-group">
                                    ...
                                    <select name="akhir_followup_${visitCount}" class="form-select" onchange="toggleField(this, 'akhir_detail_${visitCount}')" disabled>
                                        <option value="">-- Pilih --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="catatan_${visitCount}" class="form-control" rows="3"
                                              placeholder="Catatan kondisi pasien, efek samping, atau rencana tindak lanjut..." disabled>${getValue('catatan')}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="text" name="akhir_detail_${visitCount}" id="akhir_detail_${visitCount}"
                                       ...
                                       value="${getValue('akhir_detail')}" disabled>
        ...
        function removeVisit(visitId) {
            ...
            if (visitId === 1) {
                showToast('Kunjungan pertama tidak bisa dihapus!', 'error');
                return;
            }
        ...
        function showToast(message, type = 'success') {
            ...
            if (toastElement && toastMessage) {
                ...
                toastHeader.className = type === 'error' ? 'fas fa-exclamation-circle text-danger me-2' : 'fas fa-check-circle text-success me-2';
        ...
        function validateForm() {
            const cards = document.querySelectorAll('.visit-card');
            if (cards.length === 0) {
                showToast('Minimal harus ada 1 kunjungan yang diisi!', 'error');
                return false;
            }
            ...
            cards.forEach((card, index) => {
                ...
                const tanggalKunjungan = card.querySelector(`input[name="tanggal_kunjungan_${visitNumber}"]`);
                const bb = card.querySelector(`input[name="bb_${visitNumber}"]`);
                const statusFungsional = card.querySelector(`select[name="status_fungsional_${visitNumber}"]`);

                if (!tanggalKunjungan || !tanggalKunjungan.value) {
                    errorMessages.push(`Kunjungan #${visitNumber}: Tanggal kunjungan harus diisi`);
                    isValid = false;
                }

                if (!bb || !bb.value || parseFloat(bb.value) <= 0) {
                    errorMessages.push(`Kunjungan #${visitNumber}: Berat badan harus diisi dan lebih dari 0`);
                    isValid = false;
                }

                if (!statusFungsional || !statusFungsional.value) {
                    errorMessages.push(`Kunjungan #${visitNumber}: Status fungsional harus dipilih`);
                    isValid = false;
                }

                // Validasi conditional fields
                const rujukanMasuk = card.querySelector(`select[name="pasien_rujuk_masuk_${visitNumber}"]`);
                if (rujukanMasuk && rujukanMasuk.value === 'ya') {
                    const namaKlinik = card.querySelector(`input[name="nama_klinik_art_${visitNumber}"]`);
                    if (!namaKlinik || !namaKlinik.value) {
                        errorMessages.push(`Kunjungan #${visitNumber}: Nama klinik ART sebelumnya harus diisi`);
                        isValid = false;
                    }
                }
            });
            ...
            if (!isValid) {
                ...
                const alertContainer = document.querySelector('.col-lg-9');
                ...
                alertDiv.innerHTML = `
                            <strong>Validasi Error:</strong><br>
                            ${errorHtml}
                            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                        `;

                alertContainer.insertBefore(alertDiv, alertContainer.querySelector('form'));
        ...
        function validateAndPreview() {
            ...
            cards.forEach((card, index) => {
                ...
                const tanggalKunjungan = card.querySelector(`input[name="tanggal_kunjungan_${visitNumber}"]`)?.value || '-';
                const bb = card.querySelector(`input[name="bb_${visitNumber}"]`)?.value || '-';
                const tb = card.querySelector(`input[name="tb_${visitNumber}"]`)?.value || '-';
                const statusFungsional = card.querySelector(`select[name="status_fungsional_${visitNumber}"] option:checked`)?.text || '-';
                const hamil = card.querySelector(`select[name="hamil_${visitNumber}"] option:checked`)?.text || '-';
                const cd4 = card.querySelector(`input[name="cd4_${visitNumber}"]`)?.value || '-';
                const obatArv = card.querySelector(`textarea[name="obat_arv_${visitNumber}"]`)?.value || '-';
                const akhirFollowup = card.querySelector(`select[name="akhir_followup_${visitNumber}"] option:checked`)?.text || 'Aktif';

                previewHtml += `
                            <div class="col-md-6 mb-3">
                                <div class="card">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0"><i class="fas fa-calendar-check me-2"></i>Kunjungan #${visitNumber}</h6>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-sm">
                                            <tr><td><strong>Tanggal:</strong></td><td>${tanggalKunjungan}</td></tr>
                                            <tr><td><strong>BB:</strong></td><td>${bb} kg</td></tr>
                                            <tr><td><strong>TB:</strong></td><td>${tb} cm</td></tr>
                                            <tr><td><strong>Status Fungsional:</strong></td><td>${statusFungsional}</td></tr>
                                            <tr><td><strong>Kehamilan:</strong></td><td>${hamil}</td></tr>
                                            <tr><td><strong>CD4:</strong></td><td>${cd4} sel/mm³</td></tr>
                                            <tr><td><strong>Obat ARV:</strong></td><td>${obatArv.substring(0, 50)}${obatArv.length > 50 ? '...' : ''}</td></tr>
                                            <tr><td><strong>Status Akhir:</strong></td><td>${akhirFollowup}</td></tr>
                                        </table>
                                    </div>
                                </div>
                            </div>
