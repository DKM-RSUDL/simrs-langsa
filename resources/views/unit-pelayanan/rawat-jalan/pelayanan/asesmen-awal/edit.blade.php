                                    ...
                                    <div class="section-separator" id="data-masuk">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex gap-3" style="width: 100%;">
                                                <input type="date" class="form-control" name="waktu_asesmen"
                                                    id="waktu_asesmen"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="pemeriksaan_fisik" rows="4" placeholder="Masukkan pemeriksaan fisik">{{ old('pemeriksaan_fisik', $rmeAsesmen->asesmenMedisAwal->pemeriksaan_fisik ?? '') }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label style="min-width: 220px;">Planning</label>
                                            <textarea class="form-control" name="planning" rows="4" placeholder="Masukkan planning">{{ old('planning', $rmeAsesmen->asesmenMedisAwal->planning ?? '') }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label style="min-width: 220px;">Edukasi</label>
                                            <textarea class="form-control" name="edukasi" rows="4" placeholder="Masukkan edukasi">{{ old('edukasi', $rmeAsesmen->asesmenMedisAwal->edukasi ?? '') }}</textarea>
                                        </div>
                                    </div>
