                        ...
                        <div class="tab-content mt-3" id="mppTabContent">
                            <div class="tab-pane fade show active">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <a href="{{ route('rawat-jalan.mpp.form-b.create', [
                                        $dataMedis->kd_unit,
                                        $dataMedis->kd_pasien,
                                        date('Y-m-d', strtotime($dataMedis->tgl_masuk)),
                                        $dataMedis->urut_masuk,
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group" role="group">
                                                                <a href="{{ route('rawat-jalan.mpp.form-b.print', [
                                                                    'kd_unit' => $kd_unit,
                                                                    'kd_pasien' => $kd_pasien,
                                                                    'tgl_masuk' => $tgl_masuk,
                                                                ...
                                                                <a href="{{ route('rawat-jalan.mpp.form-b.edit', [
                                                                    $dataMedis->kd_unit,
                                                                    $dataMedis->kd_pasien,
                                                                    date('Y-m-d', strtotime($dataMedis->tgl_masuk)),
                                                                    $dataMedis->urut_masuk,
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    data-id="{{ $mppData->id }}"
                                                                    data-url="{{ route('rawat-jalan.mpp.form-b.destroy', [
                                                                        $dataMedis->kd_unit,
                                                                        $dataMedis->kd_pasien,
                                                                        date('Y-m-d', strtotime($dataMedis->tgl_masuk)),
                                                                        $dataMedis->urut_masuk,
