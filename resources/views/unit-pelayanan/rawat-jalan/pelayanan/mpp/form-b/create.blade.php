    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-section">
                <form
                    action="{{ route('rawat-jalan.mpp.form-b.store', [
                        'kd_unit' => $kd_unit,
                        'kd_pasien' => $kd_pasien,
                        'tgl_masuk' => $tgl_masuk,
                                        ...
                                        <select name="dpjp_utama" class="form-select select2" style="width: 100%">
                                            ...
                                            @foreach ($dokter as $dok)
                                                <option value="{{ $dok->kd_dokter }}"
                                                    {{ isset($latestFormA) && $latestFormA->dpjp_utama == $dok->kd_dokter ? 'selected' : '' }}>
                                                    {{ $dok->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div id="dokter-tambahan-container">
                                            @if (isset($latestFormA) && $latestFormA->dpjp_tambahan)
                                                @php
                                                    $dpjpTambahanArray = json_decode($latestFormA->dpjp_tambahan, true);
                                                    if (!is_array($dpjpTambahanArray)) {
                                                        $dpjpTambahanArray = [$latestFormA->dpjp_tambahan];
                                                    }
                                                @endphp
                    ...
                    <div class="row">
                        <div class="col-12 text-end">
                            ...
                            <a href="{{ route('rawat-jalan.mpp.form-b.index', [
                                'kd_unit' => $kd_unit,
                                'kd_pasien' => $kd_pasien,
                                'tgl_masuk' => $tgl_masuk,
                                'urut_masuk' => $urut_masuk,
