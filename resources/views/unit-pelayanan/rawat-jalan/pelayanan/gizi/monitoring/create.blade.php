                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form id="formTambahMonitoring" method="POST"
                                            action="{{ route('rawat-jalan.gizi.monitoring.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                                            @csrf
                                            ...
                                            <div class="form-group mt-4">
                                                <div class="d-flex justify-content-end gap-2">
                                                    <a href="{{ route('rawat-jalan.gizi.monitoring.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
