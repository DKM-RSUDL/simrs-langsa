                ...
                <div class="card w-100 h-100">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="{{ route('rawat-jalan.gizi.monitoring.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" class="nav-link active" aria-selected="true">
                                    ...
                                    <div class="d-flex justify-content-between m-3">
                                        <div class="row w-100">
                                            ...
                                            <div class="col-md-4 text-end">
                                                <a href="{{ route('rawat-jalan.gizi.monitoring.create', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" class="btn btn-primary">
                                            ...
                                            @forelse($monitoringGizi as $index => $monitoring)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form method="POST" action="{{ route('rawat-jalan.gizi.monitoring.destroy', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                                            @csrf
                                                            @method('DELETE')
