            ...
            <div class="d-flex justify-content-center">
                <div class="card w-100 h-100">
                    <div class="card-body">
                        ...
                        {{-- FORM gizi dewasa --}}
                        <form method="POST"
                            action="{{ route('rawat-jalan.gizi.dewasa.store', [
                                'kd_unit' => $kd_unit,
                                'kd_pasien' => $kd_pasien,
                                'tgl_masuk' => $tgl_masuk,
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="input-group input-group-sm">
                                                                            <input type="number" class="form-control" name="protein_persen" 
                                                                                   id="protein_persen" placeholder="%" step="0.1">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="input-group input-group-sm">
                                                                            <input type="number" class="form-control" name="lemak_persen" 
                                                                                   id="lemak_persen" placeholder="%" step="0.1">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="input-group input-group-sm">
                                                                            <input type="number" class="form-control" name="kh_persen" 
                                                                                   id="kh_persen" placeholder="%" step="0.1">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6">
...
@include('unit-pelayanan.rawat-jalan.pelayanan.gizi.dewasa.include')
