...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ url("unit-pelayanan/rawat-jalan/unit/$kd_unit/pelayanan/$kd_pasien/$tgl_masuk/$urut_masuk/gizi/anak") }}"
                class="btn">
            ...
            <div class="d-flex justify-content-center">
                <div class="card w-100 h-100">
                    <div class="card-body">
                        ...
                        {{-- FORM gizi anak --}}
                        <form method="POST"
                            action="{{ route('rawat-jalan.gizi.anak.store', [
                                'kd_unit' => $kd_unit,
                                'kd_pasien' => $kd_pasien,
                                'tgl_masuk' => $tgl_masuk,
...
@endsection
@include('unit-pelayanan.rawat-jalan.pelayanan.gizi.anak.modal-create-alergi')
@include('unit-pelayanan.rawat-jalan.pelayanan.gizi.anak.include')
