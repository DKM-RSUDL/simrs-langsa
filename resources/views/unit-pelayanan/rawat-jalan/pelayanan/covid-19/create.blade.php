...
@include('unit-pelayanan.rawat-jalan.pelayanan.covid-19.include-create')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="covid_form" method="POST"
                action="{{ route('rawat-jalan.covid-19.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
