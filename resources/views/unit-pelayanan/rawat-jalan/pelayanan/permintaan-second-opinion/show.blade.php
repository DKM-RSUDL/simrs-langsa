...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('rawat-jalan.permintaan-second-opinion.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" class="btn btn-outline-info">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('rawat-jalan.permintaan-second-opinion.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $secondOpinion->id]) }}" class="btn btn-warning btn-sm me-2">
                    <i class="ti-pencil"></i> Edit
                </a>
                <a href="{{ route('rawat-jalan.permintaan-second-opinion.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $secondOpinion->id]) }}" class="btn btn-info btn-sm" target="_blank">
