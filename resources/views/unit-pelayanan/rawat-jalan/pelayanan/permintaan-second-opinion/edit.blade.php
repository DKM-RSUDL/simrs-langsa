...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('rawat-jalan.permintaan-second-opinion.show', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $secondOpinion->id]) }}" class="btn btn-outline-info">
            ...
            <div class="form-section">
                <form action="{{ route('rawat-jalan.permintaan-second-opinion.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $secondOpinion->id]) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card mb-4 border-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="rs_second_opinion" class="form-label">RS Second Opinion <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('rs_second_opinion') is-invalid @enderror"
                                            ...
                                            value="{{ old('rs_second_opinion', $secondOpinion->rs_second_opinion) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                            ...
                                            value="{{ old('tgl_lahir', date('Y-m-d', strtotime($secondOpinion->tgl_lahir))) }}" required>
                                        @error('tgl_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
