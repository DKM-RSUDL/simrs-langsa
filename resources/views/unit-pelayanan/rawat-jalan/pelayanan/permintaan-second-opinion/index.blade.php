                ...
                <div class="w-100 h-100">
                    <div class="d-flex justify-content-between m-3">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('rawat-jalan.permintaan-second-opinion.create', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                ...
                                @foreach ($permintaanSecondOpinion as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('rawat-jalan.permintaan-second-opinion.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
        ...
        $('.btn-delete').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let destroyUrl = "{{ route('rawat-jalan.permintaan-second-opinion.destroy', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, ':id']) }}";
