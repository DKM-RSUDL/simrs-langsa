    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('rawat-jalan.ews-pasien-dewasa.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $ewsPasienDewasa->id]) }}"
                    class="btn btn-warning mr-2">
                    <i class="ti-pencil"></i> Edit
                </a>
                <a
                    href="{{ route('rawat-jalan.ews-pasien-dewasa.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $ewsPasienDewasa->id]) }}"
