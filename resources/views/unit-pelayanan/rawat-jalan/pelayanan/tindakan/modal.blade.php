<div class="modal fade" id="addTindakanModal" tabindex="-1" aria-labelledby="addTindakanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form
                action="{{ route('rawat-jalan.tindakan.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
...
<div class="modal fade" id="editTindakanModal" tabindex="-1" aria-labelledby="editTindakanModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form
                action="{{ route('rawat-jalan.tindakan.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
