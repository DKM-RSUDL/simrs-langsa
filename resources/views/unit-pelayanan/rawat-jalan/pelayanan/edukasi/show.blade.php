                    ...
                    <div class="px-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex justify-content-end algn-items-end">
                                <a href="{{ route('rawat-jalan.edukasi.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $edukasi->id]) }}"
                                    class="btn btn-primary">
                                    <i class="ti-pencil"></i> Edit
                                </a>
                                {{-- <div class="ms-2">
                                    <a href="#" class="btn btn-danger" target="_blank">
                                        <i class="ti-file"></i> Cetak PDF
                                    </a>
                                </div> --}}
                            </div>
                        </div>
                        <p>Detail edukasi pasien dan keluarga terintegrasi</p>
                    </div>
                    ...
                    <div class="px-3">
                                ...
                                <div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="penerjemah_tidak"
                                            name="kebutuhan_penerjemah" value="0" disabled {{
                                            isset($edukasi->edukasiPasien) &&
                                        $edukasi->edukasiPasien->kebutuhan_penerjemah == 0 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="penerjemah_tidak">Tidak</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="penerjemah_ya"
                                            name="kebutuhan_penerjemah" value="1" disabled {{
                                            isset($edukasi->edukasiPasien) &&
                                        $edukasi->edukasiPasien->kebutuhan_penerjemah == 1 ? 'checked' : '' }}>
                                        ...
                                        <input type="text" class="form-control mt-2" name="penerjemah_bahasa"
                                            value="{{ isset($edukasi->edukasiPasien) ? $edukasi->edukasiPasien->penerjemah_bahasa : '' }}"
                                            style="{{ isset($edukasi->edukasiPasien) && $edukasi->edukasiPasien->kebutuhan_penerjemah == 1 ? 'display: block;' : 'display: none;' }}"
                                            id="penerjemah_bahasa_input" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="pendidikan">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="pendidikan" disabled>
                                    ...
                                    <option value="{{ $didikan->kd_pendidikan }}" {{ isset($edukasi->edukasiPasien) &&
                                        $edukasi->edukasiPasien->pendidikan == $didikan->kd_pendidikan ? 'selected' : ''
                                        }}>
                                        {{ $didikan->pendidikan }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="section-separator" id="kemampuan-baca-tulis">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="kemampuan_baca_tulis" disabled>
                                    <option value="">--Pilih--</option>
                                    <option value="baik" {{ isset($edukasi->edukasiPasien) &&
                                        $edukasi->edukasiPasien->kemampuan_baca_tulis == 'baik' ? 'selected' : ''
                                        }}>Baik</option>
                                    <option value="kurang" {{ isset($edukasi->edukasiPasien) &&
                                        $edukasi->edukasiPasien->kemampuan_baca_tulis == 'kurang' ? 'selected' : ''
                                        }}>Kurang</option>
                                    <option value="tidak_mampu" {{ isset($edukasi->edukasiPasien) &&
                                        $edukasi->edukasiPasien->kemampuan_baca_tulis == 'tidak_mampu' ? 'selected' : ''
                                        }}>Tidak mampu</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="tipe-pembelajaran">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    @php
                                    $tipe_pembelajaran = isset($edukasi->edukasiPasien) &&
                                    $edukasi->edukasiPasien->tipe_pembelajaran ?
                                    json_decode($edukasi->edukasiPasien->tipe_pembelajaran) : [];
                                    if (!is_array($tipe_pembelajaran)) {
                                    $tipe_pembelajaran = [$tipe_pembelajaran];
                                    }
                                    @endphp
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input tipe-pembelajaran"
                                            id="tipe_verbal" name="tipe_pembelajaran[]" value="verbal" disabled {{
                                            in_array('verbal', $tipe_pembelajaran) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="tipe_verbal">Verbal</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input tipe-pembelajaran"
                                            id="tipe_tulisan" name="tipe_pembelajaran[]" value="tulisan" disabled {{
                                            in_array('tulisan', $tipe_pembelajaran) ? 'checked' : '' }}>
                        ...
                        <div class="section-separator" id="hambatan-komunikasi">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    @php
                                    $hambatan_komunikasi = isset($edukasi->edukasiPasien) &&
                                    $edukasi->edukasiPasien->hambatan_komunikasi ?
                                    json_decode($edukasi->edukasiPasien->hambatan_komunikasi) : [];
                                    if (!is_array($hambatan_komunikasi)) {
                                    $hambatan_komunikasi = [$hambatan_komunikasi];
                                    }
                                    @endphp
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input hambatan-komunikasi"
                                            ...
                                            disabled {{ in_array('tidak_ada', $hambatan_komunikasi) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input hambatan-komunikasi"
                                            ...
                                            disabled {{ in_array('penglihatan', $hambatan_komunikasi) ? 'checked' : ''
                                            }}>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input hambatan-komunikasi"
                                            id="hambatan_bahasa" name="hambatan_komunikasi[]" value="bahasa" disabled {{
                                            in_array('bahasa', $hambatan_komunikasi) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input hambatan-komunikasi"
                                            ...
                                            disabled {{ in_array('kognitif', $hambatan_komunikasi) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input hambatan-komunikasi"
                                            ...
                                            disabled {{ in_array('motivasi', $hambatan_komunikasi) ? 'checked' : '' }}>
                        ...
                        <div class="section-separator" id="kebutuhan-edukasi-table">
                            ...
                            <div class="edukasi-cards">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ket_Kondisi_medis_1"
                                                value="{{ $edukasi->kebutuhanEdukasi->ket_kondisi_medis_1 ?? '' }}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tanggal</label>
                                            <input type="date" class="form-control" name="tanggal_1"
                                                value="{{ isset($edukasi->kebutuhanEdukasi) ? $edukasi->kebutuhanEdukasi->tanggal_1 : '' }}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Sasaran</label>
                                            <input type="text" class="form-control" name="sasaran_nama_1"
                                                value="{{ isset($edukasi->kebutuhanEdukasi) ? $edukasi->kebutuhanEdukasi->sasaran_nama_1 : '' }}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Edukator</label>
                                            <input type="text" class="form-control" name="edukator_nama_1"
                                                value="{{ isset($edukasi->kebutuhanEdukasi) ? $edukasi->kebutuhanEdukasi->edukator_nama_1 : '' }}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_1 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->pemahaman_awal_1 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_1_hal_baru"
                                                        name="pemahaman_awal_1[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_1) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_1_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_1_edukasi_ulang"
                                                        name="pemahaman_awal_1[]" value="edukasi_ulang" disabled
                                        ...
                                        <div class="form-group">
                                            ...
                                            @php
                                                $metode_1 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_1 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_1_lisan"
                                                        name="metode_1[]" value="lisan" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_1_demonstrasi"
                                                        name="metode_1[]" value="demonstrasi" disabled
                                        ...
                                        <div class="form-group">
                                            ...
                                            @php
                                                $media_1 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->media_1 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_1_leaflet"
                                                        name="media_1[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_1_booklet"
                                                        name="media_1[]" value="booklet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_1_audiovisual"
                                                        name="media_1[]" value="audiovisual" disabled
                                        ...
                                        <div class="form-group">
                                            ...
                                            @php
                                                $evaluasi_1 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_1 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_1_sudah_paham"
                                                        name="evaluasi_1[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_1) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_1_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_1_re_demonstrasi"
                                                        name="evaluasi_1[]" value="re_demonstrasi" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_1_re_edukasi"
                                                        name="evaluasi_1[]" value="re_edukasi" disabled
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        <h6 class="card-title">2. Kemungkinan hasil yang tidak dapat diantisipasi dari terapi dan perawatan</h6>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tanggal</label>
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_2 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->pemahaman_awal_2 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_2_hal_baru"
                                                        name="pemahaman_awal_2[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_2) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_2_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_2_edukasi_ulang"
                                                        name="pemahaman_awal_2[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_2) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_2_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_2 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_2 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_2_lisan"
                                                        name="metode_2[]" value="lisan" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_2_demonstrasi"
                                                        name="metode_2[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_2) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_2_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_2 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->media_2 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_2_leaflet"
                                                        name="media_2[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_2_booklet"
                                                        name="media_2[]" value="booklet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_2_audiovisual"
                                                        name="media_2[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_2) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_2_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_2 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_2 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_2_sudah_paham"
                                                        name="evaluasi_2[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_2) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_2_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_2_re_demonstrasi"
                                                        name="evaluasi_2[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_2) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_2_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_2_re_edukasi"
                                                        name="evaluasi_2[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_2) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_2_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        <h6 class="card-title">3. Manfaat obat-obatan, efek samping, serta interaksi obat dan makanan yang diberikan</h6>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tanggal</label>
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_3 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->pemahaman_awal_3 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_3_hal_baru"
                                                        name="pemahaman_awal_3[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_3) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_3_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_3_edukasi_ulang"
                                                        name="pemahaman_awal_3[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_3) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_3_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_3 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_3 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_3_lisan"
                                                        name="metode_3[]" value="lisan" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_3_demonstrasi"
                                                        name="metode_3[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_3) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_3_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_3 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->media_3 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_3_leaflet"
                                                        name="media_3[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_3_booklet"
                                                        name="media_3[]" value="booklet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_3_audiovisual"
                                                        name="media_3[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_3) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_3_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_3 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_3 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_3_sudah_paham"
                                                        name="evaluasi_3[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_3) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_3_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_3_re_demonstrasi"
                                                        name="evaluasi_3[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_3) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_3_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_3_re_edukasi"
                                                        name="evaluasi_3[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_3) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_3_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_4 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->pemahaman_awal_4 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_4_hal_baru"
                                                        name="pemahaman_awal_4[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_4) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_4_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_4_edukasi_ulang"
                                                        name="pemahaman_awal_4[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_4) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_4_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_4 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_4 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_4_lisan"
                                                        name="metode_4[]" value="lisan" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_4_demonstrasi"
                                                        name="metode_4[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_4) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_4_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_4 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->media_4 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_4_leaflet"
                                                        name="media_4[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_4_booklet"
                                                        name="media_4[]" value="booklet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_4_audiovisual"
                                                        name="media_4[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_4) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_4_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_4 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_4 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_4_sudah_paham"
                                                        name="evaluasi_4[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_4) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_4_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_4_re_demonstrasi"
                                                        name="evaluasi_4[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_4) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_4_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_4_re_edukasi"
                                                        name="evaluasi_4[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_4) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_4_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        <h6 class="card-title">5. Manajemen Nyeri kemungkinan timbulnya nyeri setelah menerima terapi/prosedur/perawatan medis/Pilihan tatalaksana Nyeri</h6>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tanggal</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="sasaran_nama_5"
                                                value="{{ isset($edukasi->kebutuhanEdukasi) ? $edukasi->kebutuhanEdukasi->sasaran_nama_5 : '' }}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Edukator</label>
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_5 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->pemahaman_awal_5 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_5_hal_baru"
                                                        name="pemahaman_awal_5[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_5) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_5_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_5_edukasi_ulang"
                                                        name="pemahaman_awal_5[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_5) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_5_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_5 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_5 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_5_lisan"
                                                        name="metode_5[]" value="lisan" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_5_demonstrasi"
                                                        name="metode_5[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_5) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_5_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_5 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->media_5 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_5_leaflet"
                                                        name="media_5[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_5_booklet"
                                                        name="media_5[]" value="booklet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_5_audiovisual"
                                                        name="media_5[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_5) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_5_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_5 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_5 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_5_sudah_paham"
                                                        name="evaluasi_5[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_5) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_5_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_5_re_demonstrasi"
                                                        name="evaluasi_5[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_5) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_5_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_5_re_edukasi"
                                                        name="evaluasi_5[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_5) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_5_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_6 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->pemahaman_awal_6 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_6_hal_baru"
                                                        name="pemahaman_awal_6[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_6) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_6_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_6_edukasi_ulang"
                                                        name="pemahaman_awal_6[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_6) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_6_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_6 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->metode_6 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_6_lisan"
                                                        name="metode_6[]" value="lisan" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_6_demonstrasi"
                                                        name="metode_6[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_6) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_6_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_6 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->media_6 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_6_leaflet"
                                                        name="media_6[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_6_booklet"
                                                        name="media_6[]" value="booklet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_6_audiovisual"
                                                        name="media_6[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_6) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_6_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_6 = isset($edukasi->kebutuhanEdukasi) && $edukasi->kebutuhanEdukasi->evaluasi_6 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_6_sudah_paham"
                                                        name="evaluasi_6[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_6) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_6_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_6_re_demonstrasi"
                                                        name="evaluasi_6[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_6) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_6_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_6_re_edukasi"
                                                        name="evaluasi_6[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_6) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_6_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        <h6 class="card-title">7. Waktu kontrol dan penggunaan obat-obatan di rumah</h6>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tanggal</label>
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_7 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_7 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_7_hal_baru"
                                                        name="pemahaman_awal_7[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_7) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_7_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_7_edukasi_ulang"
                                                        name="pemahaman_awal_7[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_7) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_7_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_7 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_7 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_7_lisan"
                                                        name="metode_7[]" value="lisan" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_7_demonstrasi"
                                                        name="metode_7[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_7) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_7_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_7 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_7 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_7_leaflet"
                                                        name="media_7[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_7_booklet"
                                                        name="media_7[]" value="booklet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_7_audiovisual"
                                                        name="media_7[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_7) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_7_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_7 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_7 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_7_sudah_paham"
                                                        name="evaluasi_7[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_7) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_7_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_7_re_demonstrasi"
                                                        name="evaluasi_7[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_7) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_7_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_7_re_edukasi"
                                                        name="evaluasi_7[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_7) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_7_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_8 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_8 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_8_hal_baru"
                                                        name="pemahaman_awal_8[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_8_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_8_edukasi_ulang"
                                                        name="pemahaman_awal_8[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_8_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_8 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_8 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_8_lisan"
                                                        name="metode_8[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_8_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_8_demonstrasi"
                                                        name="metode_8[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_8_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_8 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_8 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_8_leaflet"
                                                        name="media_8[]" value="leaflet" disabled
                                                        {{ in_array('leaflet', $media_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_8_leaflet">Leaflet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_8_booklet"
                                                        name="media_8[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_8_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_8_audiovisual"
                                                        name="media_8[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_8_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_8 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_8 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_8_sudah_paham"
                                                        name="evaluasi_8[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_8_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_8_re_demonstrasi"
                                                        name="evaluasi_8[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_8_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_8_re_edukasi"
                                                        name="evaluasi_8[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_8) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_8_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_9 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_9 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_9_hal_baru"
                                                        name="pemahaman_awal_9[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_9_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_9_edukasi_ulang"
                                                        name="pemahaman_awal_9[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_9_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_9 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_9 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_9_lisan"
                                                        name="metode_9[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_9_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_9_demonstrasi"
                                                        name="metode_9[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_9_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_9 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_9 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_9_leaflet"
                                                        name="media_9[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_9_booklet"
                                                        name="media_9[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_9_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_9_audiovisual"
                                                        name="media_9[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_9_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_9 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_9 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_9_sudah_paham"
                                                        name="evaluasi_9[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_9_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_9_re_demonstrasi"
                                                        name="evaluasi_9[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_9_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_9_re_edukasi"
                                                        name="evaluasi_9[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_9) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_9_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        <h6 class="card-title">10. Penggunaan peralatan medis secara efektif dan aman</h6>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tanggal</label>
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_10 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_10 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_10_hal_baru"
                                                        name="pemahaman_awal_10[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_10_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_10_edukasi_ulang"
                                                        name="pemahaman_awal_10[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_10_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_10 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_10 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_10_lisan"
                                                        name="metode_10[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_10_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_10_demonstrasi"
                                                        name="metode_10[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_10_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_10 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_10 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_10_leaflet"
                                                        name="media_10[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_10_booklet"
                                                        name="media_10[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_10_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_10_audiovisual"
                                                        name="media_10[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_10_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_10 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_10 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_10_sudah_paham"
                                                        name="evaluasi_10[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_10_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_10_re_demonstrasi"
                                                        name="evaluasi_10[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_10_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_10_re_edukasi"
                                                        name="evaluasi_10[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_10) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_10_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_11 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_11 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_11_hal_baru"
                                                        name="pemahaman_awal_11[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_11_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_11_edukasi_ulang"
                                                        name="pemahaman_awal_11[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_11_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_11 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_11 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_11_lisan"
                                                        name="metode_11[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_11_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_11_demonstrasi"
                                                        name="metode_11[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_11_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_11 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_11 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_11_leaflet"
                                                        name="media_11[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_11_booklet"
                                                        name="media_11[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_11_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_11_audiovisual"
                                                        name="media_11[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_11_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_11 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_11 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_11_sudah_paham"
                                                        name="evaluasi_11[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_11_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_11_re_demonstrasi"
                                                        name="evaluasi_11[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_11_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_11_re_edukasi"
                                                        name="evaluasi_11[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_11) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_11_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_12 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_12 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_12_hal_baru"
                                                        name="pemahaman_awal_12[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_12_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_12_edukasi_ulang"
                                                        name="pemahaman_awal_12[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_12_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_12 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_12 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_12_lisan"
                                                        name="metode_12[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_12_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_12_demonstrasi"
                                                        name="metode_12[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_12_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_12 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_12 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_12_leaflet"
                                                        name="media_12[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_12_booklet"
                                                        name="media_12[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_12_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_12_audiovisual"
                                                        name="media_12[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_12_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_12 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_12 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_12_sudah_paham"
                                                        name="evaluasi_12[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_12_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_12_re_demonstrasi"
                                                        name="evaluasi_12[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_12_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_12_re_edukasi"
                                                        name="evaluasi_12[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_12) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_12_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_13 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_13 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_13_hal_baru"
                                                        name="pemahaman_awal_13[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_13_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_13_edukasi_ulang"
                                                        name="pemahaman_awal_13[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_13_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_13 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_13 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_13_lisan"
                                                        name="metode_13[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_13_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_13_demonstrasi"
                                                        name="metode_13[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_13_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_13 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_13 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_13_leaflet"
                                                        name="media_13[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_13_booklet"
                                                        name="media_13[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_13_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_13_audiovisual"
                                                        name="media_13[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_13_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_13 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_13 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_13_sudah_paham"
                                                        name="evaluasi_13[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_13_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_13_re_demonstrasi"
                                                        name="evaluasi_13[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_13_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_13_re_edukasi"
                                                        name="evaluasi_13[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_13) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_13_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_14 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_14 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_14_hal_baru"
                                                        name="pemahaman_awal_14[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_14_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_14_edukasi_ulang"
                                                        name="pemahaman_awal_14[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_14_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_14 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_14 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_14_lisan"
                                                        name="metode_14[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_14_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_14_demonstrasi"
                                                        name="metode_14[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_14_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_14 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_14 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_14_leaflet"
                                                        name="media_14[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_14_booklet"
                                                        name="media_14[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_14_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_14_audiovisual"
                                                        name="media_14[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_14_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_14 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_14 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_14_sudah_paham"
                                                        name="evaluasi_14[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_14_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_14_re_demonstrasi"
                                                        name="evaluasi_14[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_14_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_14_re_edukasi"
                                                        name="evaluasi_14[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_14) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_14_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_15 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_15 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_15_hal_baru"
                                                        name="pemahaman_awal_15[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_15_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_15_edukasi_ulang"
                                                        name="pemahaman_awal_15[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_15_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_15 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_15 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_15_lisan"
                                                        name="metode_15[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_15_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_15_demonstrasi"
                                                        name="metode_15[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_15_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_15 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_15 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_15_leaflet"
                                                        name="media_15[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_15_booklet"
                                                        name="media_15[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_15_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_15_audiovisual"
                                                        name="media_15[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_15_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_15 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_15 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_15_sudah_paham"
                                                        name="evaluasi_15[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_15_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_15_re_demonstrasi"
                                                        name="evaluasi_15[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_15_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_15_re_edukasi"
                                                        name="evaluasi_15[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_15) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_15_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card edukasi-card mb-4">
                                    <div class="card-body">
                                        <h6 class="card-title">16. Preferensi Pasien (Keinginan/Permintaan Pasien)</h6>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Tingkat Pemahaman Awal</label>
                                            @php
                                                $pemahaman_awal_16 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->pemahaman_awal_16 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_16_hal_baru"
                                                        name="pemahaman_awal_16[]" value="hal_baru" disabled
                                                        {{ in_array('hal_baru', $pemahaman_awal_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_16_hal_baru">Hal Baru</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="pemahaman_awal_16_edukasi_ulang"
                                                        name="pemahaman_awal_16[]" value="edukasi_ulang" disabled
                                                        {{ in_array('edukasi_ulang', $pemahaman_awal_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="pemahaman_awal_16_edukasi_ulang">Edukasi Ulang</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Metode</label>
                                            @php
                                                $metode_16 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->metode_16 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_16_lisan"
                                                        name="metode_16[]" value="lisan" disabled
                                                        {{ in_array('lisan', $metode_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_16_lisan">Lisan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="metode_16_demonstrasi"
                                                        name="metode_16[]" value="demonstrasi" disabled
                                                        {{ in_array('demonstrasi', $metode_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="metode_16_demonstrasi">Demonstrasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Media</label>
                                            @php
                                                $media_16 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->media_16 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_16_leaflet"
                                                        name="media_16[]" value="leaflet" disabled
                                                ...
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_16_booklet"
                                                        name="media_16[]" value="booklet" disabled
                                                        {{ in_array('booklet', $media_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_16_booklet">Booklet</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="media_16_audiovisual"
                                                        name="media_16[]" value="audiovisual" disabled
                                                        {{ in_array('audiovisual', $media_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="media_16_audiovisual">Audiovisual</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="min-width: 200px;">Evaluasi/Edukasi Ulang</label>
                                            @php
                                                $evaluasi_16 = isset($edukasi->kebutuhanEdukasiLanjutan) && $edukasi->kebutuhanEdukasiLanjutan->evaluasi_16 ?
                                            ...
                                            <div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_16_sudah_paham"
                                                        name="evaluasi_16[]" value="sudah_paham" disabled
                                                        {{ in_array('sudah_paham', $evaluasi_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_16_sudah_paham">Sudah Paham</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_16_re_demonstrasi"
                                                        name="evaluasi_16[]" value="re_demonstrasi" disabled
                                                        {{ in_array('re_demonstrasi', $evaluasi_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_16_re_demonstrasi">Re-demonstrasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input" id="evaluasi_16_re_edukasi"
                                                        name="evaluasi_16[]" value="re_edukasi" disabled
                                                        {{ in_array('re_edukasi', $evaluasi_16) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="evaluasi_16_re_edukasi">Re-edukasi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="d-flex justify-content-end mt-4 px-3">
                        {{-- <div>
                            <p><strong>Dibuat oleh:</strong>
                                {{ $edukasi->userCreate ? $edukasi->userCreate->name : '-' }}</p>
                            <p><strong>Tanggal dibuat:</strong>
                                {{ $edukasi->created_at ? date('d-m-Y H:i', strtotime($edukasi->created_at)) : '-' }}
                            </p>
                        </div> --}}
                        {{-- <div>
                            <a href="#" class="btn btn-danger" target="_blank">
