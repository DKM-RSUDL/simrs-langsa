            ...
            <div class="container-fluid">
               <form id="resepForm" action="{{ route('rawat-jalan.farmasi.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" method="POST">
                                        ...
                                        <tbody>
                                            @forelse ($riwayatObat as $resep)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @include('unit-pelayanan.rawat-jalan.pelayanan.farmasi.copyobat')
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="{{ route('rawat-jalan.farmasi.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
