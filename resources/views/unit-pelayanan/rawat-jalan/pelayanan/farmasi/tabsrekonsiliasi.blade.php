    ...
    <div class="d-flex justify-content-start align-items-center m-3">
        <div class="row g-3 w-100">
            ...
            <div class="col-md-2">
                ...
                @include('unit-pelayanan.rawat-jalan.pelayanan.farmasi.modalrekonsiliasi')
            </div>
        </div>
    </div>
                ...
                $(document).on('click', '.btn-delete-rekonsiliasi', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            const url = "{{ route('rawat-jalan.farmasi.rekonsiliasiObatDelete', [$dataMedis->kd_pasien, $dataMedis->kd_unit, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}";
