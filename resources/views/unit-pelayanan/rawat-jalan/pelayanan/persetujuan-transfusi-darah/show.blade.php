        ...
        <div class="col-md-9">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('rawat-jalan.persetujuan-transfusi-darah.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $persetujuan->id]) }}"
                        class="btn btn-warning btn-action">
                        <i class="ti-pencil"></i> Edit
                    </a>
                    <a href="{{ route('rawat-jalan.persetujuan-transfusi-darah.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $persetujuan->id]) }}"
