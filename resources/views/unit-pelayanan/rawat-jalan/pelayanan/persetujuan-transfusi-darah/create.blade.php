...
@include('unit-pelayanan.rawat-jalan.pelayanan.persetujuan-transfusi-darah.include-create')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="transfusi_form" method="POST"
                action="{{ route('rawat-jalan.persetujuan-transfusi-darah.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
