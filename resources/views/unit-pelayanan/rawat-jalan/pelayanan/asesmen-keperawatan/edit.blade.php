...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form
                action="{{ route('rawat-jalan.asesmen-keperawatan.update', [
                    'kd_unit' => $kd_unit,
                    'kd_pasien' => $kd_pasien,
                    'tgl_masuk' => $tgl_masuk,
                                ...
                                <div>
                                    ...
                                    <div class="section-separator" id="riwayat-kesehatan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="keluhan_utama" rows="3">{{ old('keluhan_utama', $asesmen->asesmenKepRajal->keluhan_utama ?? '') }}</textarea>
                                        </div>
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="psikologis_permasalahan_yang_dikonsulkan" rows="3">{{ old('psikologis_permasalahan_yang_dikonsulkan', $asesmen->asesmenKepRajal->psikologis_permasalahan_yang_dikonsulkan ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="sosial_budaya_kesulitan_memenuhi_kebutuhan_dasar" rows="3">{{ old('sosial_budaya_kesulitan_memenuhi_kebutuhan_dasar', $asesmen->asesmenKepRajalSosialBudaya->kesulitan_memenuhi_kebutuhan_dasar ?? '') }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 300px;">Budaya/Adat istiadat yang dipercaya
                                                pasien</label>
                                            <textarea class="form-control" name="sosial_budaya_budaya_atau_yang_dipercaya" rows="3">{{ old('sosial_budaya_budaya_atau_yang_dipercaya', $asesmen->asesmenKepRajalSosialBudaya->budaya_atau_yang_dipercaya ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="spiritual_nilai" rows="3">{{ old('spiritual_nilai', $asesmen->asesmenKepRajal->spiritual_nilai ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 300px;">Lainnya</label>
                                            <textarea class="form-control" name="kebutuhan_edukasi_keterangan_lain" rows="3">{{ old('lainnya', $asesmen->asesmenKepRajalPendidikan->lainnya ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary" id="simpan">Update
                                            Asesmen</button>
                                    </div>
                                </div>
                            </div>
