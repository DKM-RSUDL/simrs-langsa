...
@section('content')
    @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-keperawatan.include-edit')
    ...
    @include('unit-pelayanan.rawat-jalan.pelayanan.asesmen-keperawatan.modal-tindakankeperawatan-edit')
@endsection
