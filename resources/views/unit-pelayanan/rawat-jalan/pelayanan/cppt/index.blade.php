                            ...
                            @foreach ($cppt as $key => $value)
                                ...
                                id="v-pills-home-{{ $j }}" role="tabpanel">
                                    ...
                                    <div class="d-flex justify-content-between mt-4">
                                        ...
                                        @else
                                            <form action="{{ route('rawat-jalan.cppt.verifikasi', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}" method="post">
                                                @csrf
                                                @method('put')
...
<script>
    ...
    $('.btn-edit-cppt').click(function(e) {
        ...
        let url = "{{ route('rawat-jalan.cppt.get-cppt-ajax', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}";
