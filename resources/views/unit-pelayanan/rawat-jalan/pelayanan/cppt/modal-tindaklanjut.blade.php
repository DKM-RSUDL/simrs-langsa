...
<div class="modal fade second-modal" id="kontrolModal" tabindex="-1" aria-labelledby="kontrolModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
...
{{-- START: RS LAIN MODAL --}}
<div class="modal fade second-modal" id="rsLainModal" tabindex="-1" aria-labelledby="rsLainModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
