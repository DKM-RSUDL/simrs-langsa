        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Tindakan Rehab Medik',
                    'description' => 'Form untuk memperbarui tindakan rehab medik pada pasien rawat jalan.',
                ])
                <form
                    action="{{ route('rawat-jalan.tindakan-rehab-medik.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, encrypt($tindakan->id)]) }}"
