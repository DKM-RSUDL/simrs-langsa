        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Tindakan Rehab Medik',
                    'description' => 'Form untuk menambahkan tindakan rehab medik pada pasien rawat jalan.',
                ])

                <form
                    action="{{ route('rawat-jalan.tindakan-rehab-medik.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="ppa" id="ppa"
                                    ...
                                    @foreach ($petugas as $ptg)
                                        <option value="{{ $ptg->kd_karyawan }}" @selected($ptg->kd_karyawan == auth()->user()->kd_karyawan)>
