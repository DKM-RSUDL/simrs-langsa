            ...
            <div class="col-md-12">
                ...
                <div class="row g-3 align-items-start">
                    ...
                    <div class="col-12 col-md-6">
                        <h4 class="fw-bold m-0">{{ $unit->nama_unit }} (Semua Pasien)</h4>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <a href="{{ route('rawat-jalan.unit.selesai', $unit->kd_unit) }}"
                                ...
                                <div class="rounded bg-success text-white">
                                    <div class="rounded card-body d-flex align-items-center gap-3 px-3">
                                        <img src="{{ asset('assets/img/icons/Sick.png') }}" alt="Icon" width="36"
                                            height="36">
                                        <div class="text-start">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `
                                <a href="#" class="edit btn btn-primary btn-sm m-2">
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `
                                <div class="rm-reg">
                                    RM: ${row.kd_pasien ?? 'N/A'}<br>
                                    Reg: ${row.reg_number ?? 'N/A'}
                                </div>
                            `;
                        },
                        defaultContent: ''
