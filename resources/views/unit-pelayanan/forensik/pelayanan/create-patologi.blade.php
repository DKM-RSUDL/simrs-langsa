                    ...
                    <div class="card-body">
                        ...
                        <div class="px-3">
                            <div>
                                ...
                                <!-- C. Pemeriksaan Umum -->
                                <div class="section-separator">
                                    <h5 class="section-title">C. Pemeriksaan Umum</h5>
                                ...
                                <div class="section-separator">
                                    <h5 class="section-title">D. Pemeriksaan Identitas</h5>
                                ...
                                <div class="section-separator">
                                    <h5 class="section-title">E. Pemeriksaan Tanatologi</h5>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="perkiraan_kematian">
                                    </div>
                                </div>
