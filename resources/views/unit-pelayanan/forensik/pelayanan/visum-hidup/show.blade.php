                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" 
                                                           ...
                                                           value="{{ $visumHidup->tanggal ? $visumHidup->tanggal->format('Y-m-d') : '' }}" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="time" class="form-control" 
                                                           id="jam" name="jam"
                                                           value="{{ $visumHidup->jam ? \Carbon\Carbon::parse($visumHidup->jam)->format('H:i') : '' }}" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" 
                                                           ...
                                                           value="{{ $visumHidup->nomor_ver }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" 
                                                          ...
                                                          placeholder="Kepolisian Resor Langsa" disabled>{{ $visumHidup->permintaan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" 
                                                       ...
                                                       placeholder="B/49/XII/2024/LL" value="{{ $visumHidup->nomor_surat }}" disabled>
                                            </div>
                                            <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap justify-content-between mt-4">
                                <div class="mb-2">
                                    <a href="{{ route('forensik.unit.pelayanan.visum-hidup.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $visumHidup->id]) }}" 
                                        class="btn btn-warning mb-2">
                                        <i class="ti-pencil"></i> Edit
                                    </a>
                                </div>
                                <div class="mb-2">
                                    <a href="{{ route('forensik.unit.pelayanan.visum-hidup.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $visumHidup->id]) }}" class="btn btn-primary mb-2" target="_blank">
