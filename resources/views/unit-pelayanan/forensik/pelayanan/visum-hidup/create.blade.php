        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 col-md-12">
                <x-content-card>
                    ...
                    <form id="visumHidupForm" method="POST"
                        action="{{ route('forensik.unit.pelayanan.visum-hidup.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                        @csrf
                        <!-- Header Section -->
                        <div class="text-center mb-4">
                            <div class="header-asesmen">
                                <h3 class="font-weight-bold mb-2">VISUM HIDUP REPERTUM</h3>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('nomor_ver') is-invalid @enderror"
                                                    id="nomor_ver" name="nomor_ver" placeholder="VeR/003/I/2025"
                                                    value="{{ old('nomor_ver', $nomorVer ?? '') }}" required>
                                                @error('nomor_ver')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('permintaan') is-invalid @enderror" id="permintaan" name="permintaan"
                                                rows="3" placeholder="Kepolisian Resor Langsa">{{ old('permintaan') }}</textarea>
                                            @error('permintaan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nomor_surat" name="nomor_surat" placeholder="B/49/XII/2024/LL"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('menerangkan') is-invalid @enderror" id="menerangkan" name="menerangkan"
                                        rows="2" placeholder="Menerangkan pada tanggal...">{{ old('menerangkan') }}</textarea>
                                    @error('menerangkan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="hasil_pemeriksaan" class="form-label fw-bold">Hasil
                                        Pemeriksaan</label>
                                    <input id="hasil_pemeriksaan" type="hidden" name="hasil_pemeriksaan"
                                        value="{{ old('hasil_pemeriksaan') }}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select id="dokter_pemeriksa" name="dokter_pemeriksa"
                                                class="form-select @error('dokter_pemeriksa') is-invalid @enderror"
                                                required>
                                                <option value="">--Pilih Dokter Pemeriksa--</option>
                                                @foreach ($dokter as $item)
                                                    <option value="{{ $item->kd_dokter }}"
                                                        {{ old('dokter_pemeriksa') == $item->kd_dokter ? 'selected' : '' }}>
                                                        {{ $item->nama_lengkap }}
                                                    </option>
                                                @endforeach
                                            </select>
