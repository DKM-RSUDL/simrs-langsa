                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('tanggal', $visumHidup->tanggal ? $visumHidup->tanggal->format('Y-m-d') : '') }}"
                                                    required>
                                                @error('tanggal')
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="time"
                                                    ...
                                                    name="jam"
                                                    value="{{ old('jam', $visumHidup->jam ? \Carbon\Carbon::parse($visumHidup->jam)->format('H:i') : '') }}"
                                                    required>
                                                @error('jam')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('permintaan') is-invalid @enderror" id="permintaan" name="permintaan"
                                                rows="3" placeholder="Kepolisian Resor Langsa">{{ old('permintaan', $visumHidup->permintaan) }}</textarea>
                                            @error('permintaan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nomor_surat', $visumHidup->nomor_surat) }}">
                                            @error('nomor_surat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('menerangkan') is-invalid @enderror" id="menerangkan" name="menerangkan"
                                        rows="2" placeholder="Menerangkan pada tanggal...">{{ old('menerangkan', $visumHidup->menerangkan) }}</textarea>
                                    @error('menerangkan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
