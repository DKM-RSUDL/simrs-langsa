        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Pemeriksaan Forensik Klinik',
                    'description' =>
                        'Perbarui data Pemeriksaan Forensik Klinik dengan mengisi formulir di bawah ini.',
                ])
                <form
                    action="{{ route('forensik.unit.pelayanan.pemeriksaan-klinik.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $pemeriksaan->id]) }}"
                    method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="section-separator mt-0">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="diantar_keluarga" name="cara_datang"
                                        value="2" @checked($pemeriksaan->cara_datang == '2')>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex flex-column gap-2">
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="laka_lantas" name="jenis_kasus"
                                            value="1" @checked($pemeriksaan->jenis_kasus == '1')>
                                        <label class="form-check-label" for="laka_lantas">Laka
                                            lantas</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="pemukulan" name="jenis_kasus"
                                            value="2" @checked($pemeriksaan->jenis_kasus == '2')>
                                    ...
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="kdrt" name="jenis_kasus"
                                            value="4" @checked($pemeriksaan->jenis_kasus == '4')>
                                        <label class="form-check-label" for="kdrt">KDRT</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="keracunan" name="jenis_kasus"
                                            value="5" @checked($pemeriksaan->jenis_kasus == '5')>
                                    ...
                                    <div class="d-flex gap-2 align-items-center">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-input" id="kasus_lainnya"
                                                name="jenis_kasus" value="99" @checked($pemeriksaan->jenis_kasus == '99')>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tgl_penyidik"
                                value="{{ $pemeriksaan->tgl_penyidik ? date('Y-m-d', strtotime($pemeriksaan->tgl_penyidik)) : '' }}">
                        </div>
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="molekuler" name="pemeriksaan[]"
                                        value="molekuler" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('molekuler', $pemeriksaan->pemeriksaan))>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="ct_scan" name="pemeriksaan[]"
                                        value="ct_scan" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('ct_scan', $pemeriksaan->pemeriksaan))>
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <input type="text" class="form-control" name="penatalaksanaan_lainnya"
                                        value="{{ $pemeriksaan->penatalaksanaan_lainnya }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tgl_pulang"
                                value="{{ $pemeriksaan->tgl_pulang ? date('Y-m-d', strtotime($pemeriksaan->tgl_pulang)) : '' }}">
                        </div>
