                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                                    ...
                                    <div class="datetime-container">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <label for="tanggal" class="form-label">Tanggal Pemeriksaan <span class="required">*</span></label>
                                                    @error('tanggal')
                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <label for="jam" class="form-label">Jam Pemeriksaan <span class="required">*</span></label>
                                                    @error('jam')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                            ...
                                            <div class="col-lg-4 col-md-12 col-sm-12">
                                                <div class="mb-3">
                                                    <label for="nomor_ver" class="form-label">Nomor VeR <span class="required">*</span></label>
                                                    @error('nomor_ver')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                    <input type="text" class="form-control" id="nomor_ver" name="nomor_ver" 
                                                           placeholder="VeR/003/I/2025" value="{{ old('nomor_ver') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="patient-info-card">
                                        <div class="patient-info-item">
                                            ...
                                            <span class="patient-info-value">{{ $dataMedis->nm_pasien ?? '-' }}</span>
                                        </div>
                                        <div class="patient-info-item">
                                            <span class="patient-info-label">Tempat/Tanggal Lahir:</span>
                                            <span class="patient-info-value">{{ $dataMedis->tmp_lahir ?? '-' }} / {{ $dataMedis->tgl_lahir ?? '-' }}</span>
                                        </div>
                                        <div class="patient-info-item">
                                            <span class="patient-info-label">Jenis Kelamin:</span>
                                            <span class="patient-info-value">{{ $dataMedis->jk == 'L' ? 'Laki-laki' : 'Perempuan' }}</span>
                                        </div>
                                        <div class="patient-info-item">
                                            <span class="patient-info-label">Suku/Agama:</span>
                                            <span class="patient-info-value">{{ $dataMedis->suku ?? '-' }} / {{ $dataMedis->agama ?? '-' }}</span>
                                        </div>
                                        <div class="patient-info-item">
                                            <span class="patient-info-label">Pekerjaan:</span>
                                            <span class="patient-info-value">{{ $dataMedis->pekerjaan ?? '-' }}</span>
                                        </div>
                                        <div class="patient-info-item">
                                            <span class="patient-info-label">Alamat:</span>
                                            <span class="patient-info-value">{{ $dataMedis->alamat ?? '-' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="examination-section">
                                        ...
                                        <div class="mb-3">
                                            <label for="pembungkus_mayat" class="form-label">Pembungkus Mayat</label>
                                            @error('pembungkus_mayat')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <input id="pembungkus_mayat" type="hidden" name="pembungkus_mayat" value="{{ old('pembungkus_mayat') }}">
                                            <trix-editor input="pembungkus_mayat" placeholder="Deskripsi pembungkus mayat..."></trix-editor>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @error('benda_disamping')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <input id="benda_disamping" type="hidden" name="benda_disamping" value="{{ old('benda_disamping') }}">
                                            <trix-editor input="benda_disamping" placeholder="Benda-benda yang ditemukan di samping mayat..."></trix-editor>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="perhiasan_mayat" class="form-label">Perhiasan Mayat</label>
                                            @error('perhiasan_mayat')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <input id="perhiasan_mayat" type="hidden" name="perhiasan_mayat" value="{{ old('perhiasan_mayat') }}">
                                            <trix-editor input="perhiasan_mayat" placeholder="Perhiasan yang ditemukan pada mayat..."></trix-editor>
                                        </div>

                                        <div class="mb-3">
                                            <label for="identifikasi_umum" class="form-label">Identifikasi Umum</label>
                                            @error('identifikasi_umum')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <input id="identifikasi_umum" type="hidden" name="identifikasi_umum" value="{{ old('identifikasi_umum') }}">
                                            <trix-editor input="identifikasi_umum" placeholder="Deskripsi umum mayat (tinggi, postur, rambut, kulit, dll)..."></trix-editor>
                                        </div>

                                        <div class="mb-3">
                                            <label for="identifikasi_khusus" class="form-label">Identifikasi Khusus</label>
                                            @error('identifikasi_khusus')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <input id="identifikasi_khusus" type="hidden" name="identifikasi_khusus" value="{{ old('identifikasi_khusus') }}">
                                            <trix-editor input="identifikasi_khusus" placeholder="Tanda-tanda khusus (tato, bekas luka, dll)..."></trix-editor>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="gigi_geligi" class="form-label">Gigi-geligi</label>
                                            @error('gigi_geligi')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <input id="gigi_geligi" type="hidden" name="gigi_geligi" value="{{ old('gigi_geligi') }}">
                                            <trix-editor input="gigi_geligi" placeholder="Kondisi gigi dan rongga mulut..."></trix-editor>
                                        </div>

                                        <div class="mb-3">
                                            <label for="luka_luka" class="form-label">Luka-luka</label>
                                            @error('luka_luka')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <input id="luka_luka" type="hidden" name="luka_luka" value="{{ old('luka_luka') }}">
                                            <trix-editor input="luka_luka" placeholder="Deskripsi detail luka-luka yang ditemukan..."></trix-editor>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="pada_jenazah" class="form-label">Pada Jenazah</label>
                                        @error('pada_jenazah')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                        <input id="pada_jenazah" type="hidden" name="pada_jenazah" value="{{ old('pada_jenazah') }}">
                                        <trix-editor input="pada_jenazah" placeholder="Kesimpulan umum tentang jenazah..."></trix-editor>
                                    </div>

                                    <div class="mb-3">
                                        <label for="pemeriksaan_luar_kesimpulan" class="form-label">Pada Pemeriksaan Luar</label>
                                        @error('pemeriksaan_luar_kesimpulan')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                        <input id="pemeriksaan_luar_kesimpulan" type="hidden" name="pemeriksaan_luar_kesimpulan" value="{{ old('pemeriksaan_luar_kesimpulan') }}">
                                        <trix-editor input="pemeriksaan_luar_kesimpulan" placeholder="Kesimpulan dari pemeriksaan luar..."></trix-editor>
                                    </div>

                                    <div class="mb-3">
                                        <label for="dijumpai_kesimpulan" class="form-label">Dijumpai</label>
                                        @error('dijumpai_kesimpulan')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                        <input id="dijumpai_kesimpulan" type="hidden" name="dijumpai_kesimpulan" value="{{ old('dijumpai_kesimpulan') }}">
                                        <trix-editor input="dijumpai_kesimpulan" placeholder="Temuan-temuan penting..."></trix-editor>
                                    </div>

                                    <div class="mb-3">
                                        <label for="hasil_kesimpulan" class="form-label">Hasil Kesimpulan</label>
                                        @error('hasil_kesimpulan')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                        <input id="hasil_kesimpulan" type="hidden" name="hasil_kesimpulan" value="{{ old('hasil_kesimpulan') }}">
                                        <trix-editor input="hasil_kesimpulan" placeholder="Kesimpulan akhir mengenai perkiraan lama kematian, cara kematian, dan penyebab kematian..."></trix-editor>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="dokter_pemeriksa" class="form-label">Dokter Pemeriksa <span class="required">*</span></label>
                                                @error('dokter_pemeriksa')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                                <select class="form-control" id="dokter_pemeriksa" name="dokter_pemeriksa" required>
                                                    <option value="">-- Pilih Dokter Pemeriksa --</option>
                                                    <option value="Dr.dr.Netty Herawati, M.Ked(For), Sp.F.M.,M.H" {{ old('dokter_pemeriksa') == 'Dr.dr.Netty Herawati, M.Ked(For), Sp.F.M.,M.H' ? 'selected' : '' }}>Dr.dr.Netty Herawati, M.Ked(For), Sp.F.M.,M.H</option>
                            ...
                            <div class="d-flex flex-wrap justify-content-between mt-4">
                                <div class="mb-2">
                                    <button type="button" class="btn btn-secondary mr-2 mb-2" id="print_form">
                                ...
                                <div class="mb-2">
                                    <button type="submit" class="btn btn-primary mb-2" id="simpan">
                                        <i class="ti-save"></i> Simpan Visum et Repertum
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    if (!confirm('Apakah Anda yakin ingin menyimpan Visum et Repertum ini?')) {
                        e.preventDefault();
                    }
                });
            }
        ...
        window.addEventListener('beforeunload', function(e) {
            ...
            for (let [key, value] of formData) {
                if (value && value.trim() !== '' && key !== 'tanggal' && key !== 'jam') {
                    hasData = true;
                    break;
                }
            }
