...
@section('content')
    @include('unit-pelayanan.forensik.pelayanan.visum-exit.include-visum-exit')
                    ...
                    <form id="edukasiForm" method="POST"
                        ...
                        <div class="text-center mb-4">
                            <div class="header-asesmen">
                                <h3 class="font-weight-bold mb-2">EDIT VISUM EXIT REPERTUM</h3>
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="tanggal" name="tanggal"
                                                    value="{{ old('tanggal', $visumExit->tanggal ? $visumExit->tanggal->format('Y-m-d') : '') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="time" class="form-control" id="jam" name="jam"
                                                    value="{{ old('jam', $visumExit->jam ? \Carbon\Carbon::parse($visumExit->jam)->format('H:i') : '') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nomor_ver" name="nomor_ver"
                                                    ...
                                                    value="{{ old('nomor_ver', $visumExit->nomor_ver) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            @error('permintaan')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                            <textarea class="form-control" id="permintaan" name="permintaan" rows="3" placeholder="Kepolisian Resor Langsa">{{ old('permintaan', $visumExit->permintaan) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nomor_surat" name="nomor_surat"
                                                ...
                                                value="{{ old('nomor_surat', $visumExit->nomor_surat) }}">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="registrasi" name="registrasi"
                                                value="{{ old('registrasi', $visumExit->registrasi ?: $dataMedis->kd_pasien) }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="menerangkan" name="menerangkan" rows="2"
                                        placeholder="Menerangkan pada tanggal...">{{ old('menerangkan', $visumExit->menerangkan) }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="wawancara" type="hidden" name="wawancara"
                                        value="{{ old('wawancara', $visumExit->wawancara) }}">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="examination-section">
                                    ...
                                    <div class="mb-3">
                                        <label for="pembungkus_mayat" class="form-label fw-bold">Pembungkus
                                            Mayat</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="benda_disamping" class="form-label fw-bold">Benda di Samping
                                            Mayat</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="penutup_mayat" class="form-label fw-bold">Penutup
                                            Mayat</label>
                                        @error('penutup_mayat')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        <label for="pakaian_mayat" class="form-label fw-bold">Pakaian
                                            Mayat</label>
                                        @error('pakaian_mayat')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        <label for="perhiasan_mayat" class="form-label fw-bold">Perhiasan
                                            Mayat</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="identifikasi_umum" class="form-label fw-bold">Identifikasi
                                            Umum</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="identifikasi_khusus" class="form-label fw-bold">Identifikasi
                                            Khusus</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="tanda_kematian" class="form-label fw-bold">Tanda-tanda
                                            Kematian</label>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="pemeriksaan_luar_kesimpulan" class="form-label fw-bold">Pada
                                        Pemeriksaan
                                        Luar</label>
                                ...
                                <div class="mb-3">
                                    <label for="hasil_kesimpulan" class="form-label fw-bold">Hasil
                                        Kesimpulan</label>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const calculateCompletion = function() {
                const allFields = document.querySelectorAll(
                    'input[type="text"], input[type="date"], input[type="time"], select, textarea, input[type="hidden"]'
                );
                let filledFields = 0;
                let totalFields = 0;
