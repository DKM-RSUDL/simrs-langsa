        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Data Pemeriksaan Forensik Patologi',
                    'description' => 'Tambah Data Pemeriksaan Forensik Patologi dengan mengisi formulir di bawah ini.',
                ])
                <form
                    action="{{ route('forensik.unit.pelayanan.pemeriksaan-patologi.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                    method="post">
                    @csrf
                    <div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="penatalaksanaan_lainnya"
                                                name="penatalaksanaan[]" value="lainnya">
