        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Data Pemeriksaan Forensik Patologi',
                    'description' =>
                        'Perbarui Data Pemeriksaan Forensik Patologi dengan mengisi formulir di bawah ini.',
                ])

                <form
                    action="{{ route('forensik.unit.pelayanan.pemeriksaan-patologi.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $pemeriksaan->id]) }}"
                    method="post">
                    @csrf
                    @method('put')
                    <div>
                        <div class="section-separator mt-0">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="sendiri" name="cara_datang"
                                            value="1" @checked($pemeriksaan->cara_datang == '1')>
                                    ...
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="ambulance" name="cara_datang"
                                            value="3" @checked($pemeriksaan->cara_datang == '3')>
                                        <label class="form-check-label" for="ambulance">Ambulance</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="polisi" name="cara_datang"
                                            value="4" @checked($pemeriksaan->cara_datang == '4')>
                                        <label class="form-check-label" for="polisi">Polisi</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="pmi" name="cara_datang"
                                            value="5" @checked($pemeriksaan->cara_datang == '5')>
                                        <label class="form-check-label" for="pmi">PMI</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="lainnya" name="cara_datang"
                                            value="99" @checked($pemeriksaan->cara_datang == '99')>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_meninggal" id="tgl_meninggal" class="form-control"
                                    value="{{ date('Y-m-d', strtotime($pemeriksaan->tgl_meninggal)) }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_pemeriksaan" id="tgl_pemeriksaan" class="form-control"
                                    value="{{ date('Y-m-d', strtotime($pemeriksaan->tgl_pemeriksaan)) }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" name="jam_pemeriksaan" id="jam_pemeriksaan" class="form-control"
                                    value="{{ date('H:i', strtotime($pemeriksaan->jam_pemeriksaan)) }}">
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Jam Pemeriksaan Akhir</label>
                                <input type="time" name="jam_pemeriksaan_akhir" id="jam_pemeriksaan_akhir"
                                    class="form-control"
                                    value="{{ date('H:i', strtotime($pemeriksaan->jam_pemeriksaan_akhir)) }}">
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Diagnosis Meninggal</label>
                                <input type="text" name="diagnosis_meninggal" id="diagnosis_meninggal"
                                    class="form-control" value="{{ $pemeriksaan->diagnosis_meninggal }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="asal_rujukan" id="asal_rujukan" class="form-control"
                                    value="{{ $pemeriksaan->asal_rujukan }}">
                            </div>
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="trauma"
                                                name="jenis_kasus_patologi[]" value="trauma" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('trauma', $pemeriksaan->jenis_kasus_patologi))>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="non_trauma"
                                                ...
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('non_trauma', $pemeriksaan->jenis_kasus_patologi))>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="penyakit"
                                                ...
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('penyakit', $pemeriksaan->jenis_kasus_patologi))>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="abortus"
                                                ...
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('abortus', $pemeriksaan->jenis_kasus_patologi))>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="kematian_mendadak"
                                                ...
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('kematian_mendadak', $pemeriksaan->jenis_kasus_patologi))>
                                            <label class="form-check-label" for="kematian_mendadak">Kematian
                                                Mendadak</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="kesusilaan"
                                                name="jenis_kasus_patologi[]" value="kesusilaan"
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('kesusilaan', $pemeriksaan->jenis_kasus_patologi))>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="asfiksia"
                                                ...
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('asfiksia', $pemeriksaan->jenis_kasus_patologi))>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="keracunan"
                                                ...
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('keracunan', $pemeriksaan->jenis_kasus_patologi))>
                                            <label class="form-check-label" for="keracunan">Keracunan</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="kasus_lainnya"
                                                name="jenis_kasus_patologi[]" value="lainnya"
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('lainnya', $pemeriksaan->jenis_kasus_patologi))>
                                            <label class="form-check-label" for="kasus_lainnya">Lainnya</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="doa"
                                                name="jenis_kasus_patologi[]" value="doa"
                                                @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('doa', $pemeriksaan->jenis_kasus_patologi))>
                                            <label class="form-check-label" for="doa">Death On Arrival
                                                (DOA)</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="pemeriksaan_luar"
                                            name="pemeriksaan[]" value="luar" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('luar', $pemeriksaan->pemeriksaan))>
                                        <label class="form-check-label" for="pemeriksaan_luar">Pemeriksaan
                                            Luar</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="pemeriksaan_dalam"
                                            name="pemeriksaan[]" value="dalam" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('dalam', $pemeriksaan->pemeriksaan))>
                                        <label class="form-check-label" for="pemeriksaan_dalam">Pemeriksaan
                                            Dalam</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="identifikasi"
                                            name="pemeriksaan[]" value="identifikasi" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('identifikasi', $pemeriksaan->pemeriksaan))>
                                        <label class="form-check-label" for="identifikasi">Pemeriksaan
                                            Identifikasi</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="darah"
                                            name="pemeriksaan[]" value="darah" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('darah', $pemeriksaan->pemeriksaan))>
                                        <label class="form-check-label" for="darah">Pemeriksaan Sampel
                                            Darah</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="urine"
                                            name="pemeriksaan[]" value="urine" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('urine', $pemeriksaan->pemeriksaan))>
                                        <label class="form-check-label" for="urine">Pemeriksaan Sampel
                                            Urine</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="organ"
                                            name="pemeriksaan[]" value="organ" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('organ', $pemeriksaan->pemeriksaan))>
                                        <label class="form-check-label" for="organ">Pemeriksaan Sampel
                                            Organ</label>
                                    </div>
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="toksinologi"
                                            name="pemeriksaan[]" value="toksinologi" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('toksinologi', $pemeriksaan->pemeriksaan))>
                                        <label class="form-check-label" for="toksinologi">Pemeriksaan
                                            Toksikologi</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="serologi"
                                            name="pemeriksaan[]" value="serologi" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('serologi', $pemeriksaan->pemeriksaan))>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="kerangka"
                                            name="pemeriksaan[]" value="kerangka" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('kerangka', $pemeriksaan->pemeriksaan))>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="pemeriksaan_lainnya">Pemeriksaan
                                            Lainnya</label>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column gap-3">
                                            @foreach ($chunk as $item)
                                                @php
                                                    $pemeriksaanData = $pemeriksaan->fisik
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="autopsi"
                                            name="penatalaksanaan[]" value="autopsi" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('autopsi', $pemeriksaan->penatalaksanaan))>
                                        <label class="form-check-label" for="autopsi">Autopsi</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="tkp"
                                            name="penatalaksanaan[]" value="tkp" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('tkp', $pemeriksaan->penatalaksanaan))>
                                        <label class="form-check-label" for="tkp">Pemeriksaan di TKP</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="kuburan"
                                            name="penatalaksanaan[]" value="kuburan" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('kuburan', $pemeriksaan->penatalaksanaan))>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="sk_medis"
                                            name="penatalaksanaan[]" value="sk_medis" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('sk_medis', $pemeriksaan->penatalaksanaan))>
                                        <label class="form-check-label" for="sk_medis">Pembuatan Surat Keterangan
                                            Medis</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="sk_kematian"
                                            name="penatalaksanaan[]" value="sk_kematian" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('sk_kematian', $pemeriksaan->penatalaksanaan))>
                                        <label class="form-check-label" for="sk_kematian">Pembuatan Surat
                                            Kematian</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="embalming"
                                            name="penatalaksanaan[]" value="embalming" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('embalming', $pemeriksaan->penatalaksanaan))>
                                        <label class="form-check-label" for="embalming">Pembuatan Surat
                                            Embalming</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="bukti"
                                            name="penatalaksanaan[]" value="bukti" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('bukti', $pemeriksaan->penatalaksanaan))>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="asuransi"
                                            name="penatalaksanaan[]" value="asuransi" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('asuransi', $pemeriksaan->penatalaksanaan))>
                                        <label class="form-check-label" for="asuransi">Pembuatan Surat Keterangan
                                            Asuransi</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="kerangka"
                                            name="penatalaksanaan[]" value="kerangka" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('kerangka', $pemeriksaan->penatalaksanaan))>
                                        <label class="form-check-label" for="kerangka">Pemeriksaan Indentifikasi
                                            Kerangka</label>
                                    </div>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="toksikologi_penatalaksanaan">Pemeriksaan
                                            Toksikologi</label>
                                    </div>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="penatalaksanaan_lainnya"
                                                name="penatalaksanaan[]" value="lainnya" @checked(is_array($pemeriksaan->penatalaksanaan) && in_array('lainnya', $pemeriksaan->penatalaksanaan))>
                                            <label class="form-check-label" for="penatalaksanaan_lainnya">Pemeriksaan
                                                Lainnya:</label>
                                        </div>
                                        <input type="text" class="form-control" name="penatalaksanaan_lainnya"
                                            style="width: 300px;" value="{{ $pemeriksaan->penatalaksanaan_lainnya }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="dibawa_lainnya">Lain-lain:</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
