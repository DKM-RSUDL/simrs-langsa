        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Detail Pemeriksaan Forensik Klinik',
                ])
                <div>
                    <div class="section-separator mt-0">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="sendiri" name="cara_datang"
                                        value="1" @checked($pemeriksaan->cara_datang == '1') disabled>
                                    <label class="form-check-label" for="sendiri">Sendiri</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="diantar_keluarga" name="cara_datang"
                                        value="2" @checked($pemeriksaan->cara_datang == '2') disabled>
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="ambulance" name="cara_datang"
                                        value="3" @checked($pemeriksaan->cara_datang == '3') disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_meninggal" id="tgl_meninggal" class="form-control"
                                value="{{ date('Y-m-d', strtotime($pemeriksaan->tgl_meninggal)) }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_pemeriksaan" id="tgl_pemeriksaan" class="form-control"
                                value="{{ date('Y-m-d', strtotime($pemeriksaan->tgl_pemeriksaan)) }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" name="jam_pemeriksaan" id="jam_pemeriksaan" class="form-control"
                                value="{{ date('H:i', strtotime($pemeriksaan->jam_pemeriksaan)) }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" name="jam_pemeriksaan_akhir" id="jam_pemeriksaan_akhir"
                                class="form-control"
                                value="{{ date('H:i', strtotime($pemeriksaan->jam_pemeriksaan_akhir)) }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="diagnosis_meninggal" id="diagnosis_meninggal" class="form-control"
                                value="{{ $pemeriksaan->diagnosis_meninggal }}" disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="asal_rujukan" id="asal_rujukan" class="form-control"
                                value="{{ $pemeriksaan->asal_rujukan }}" disabled>
                        </div>
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="non_trauma"
                                            name="jenis_kasus_patologi[]" value="non_trauma" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('non_trauma', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                                        <label class="form-check-label" for="non_trauma">Non
                                            Trauma</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="penyakit"
                                            name="jenis_kasus_patologi[]" value="penyakit" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('penyakit', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                                        <label class="form-check-label" for="penyakit">Penyakit</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="abortus"
                                            name="jenis_kasus_patologi[]" value="abortus" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('abortus', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="kematian_mendadak"
                                            ...
                                            @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('kematian_mendadak', $pemeriksaan->jenis_kasus_patologi)) disabled>
                                        <label class="form-check-label" for="kematian_mendadak">Kematian
                                            Mendadak</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="kesusilaan"
                                            name="jenis_kasus_patologi[]" value="kesusilaan" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('kesusilaan', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                                        <label class="form-check-label" for="kesusilaan">Kesusilaan</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="asfiksia"
                                            name="jenis_kasus_patologi[]" value="asfiksia" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('asfiksia', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                                        <label class="form-check-label" for="asfiksia">Asfiksia</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="keracunan"
                                            name="jenis_kasus_patologi[]" value="keracunan" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('keracunan', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                                        <label class="form-check-label" for="keracunan">Keracunan</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="kasus_lainnya"
                                            name="jenis_kasus_patologi[]" value="lainnya" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('lainnya', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                                        <label class="form-check-label" for="kasus_lainnya">Lainnya</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="doa"
                                            name="jenis_kasus_patologi[]" value="doa" @checked(is_array($pemeriksaan->jenis_kasus_patologi) && in_array('doa', $pemeriksaan->jenis_kasus_patologi))
                                            disabled>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="darah" name="pemeriksaan[]"
                                        value="darah" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('darah', $pemeriksaan->pemeriksaan)) disabled>
                                    <label class="form-check-label" for="darah">Pemeriksaan Sampel
                                        Darah</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="urine" name="pemeriksaan[]"
                                        value="urine" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('urine', $pemeriksaan->pemeriksaan)) disabled>
                                    <label class="form-check-label" for="urine">Pemeriksaan Sampel
                                        Urine</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="organ" name="pemeriksaan[]"
                                        value="organ" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('organ', $pemeriksaan->pemeriksaan)) disabled>
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="serologi" name="pemeriksaan[]"
                                        value="serologi" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('serologi', $pemeriksaan->pemeriksaan)) disabled>
                                    <label class="form-check-label" for="serologi">Pemeriksaan
                                        Serologi</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="molekuler" name="pemeriksaan[]"
                                        value="molekuler" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('molekuler', $pemeriksaan->pemeriksaan)) disabled>
                                    <label class="form-check-label" for="molekuler">Pemeriksaan
                                        Molekuler</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="kerangka" name="pemeriksaan[]"
                                        value="kerangka" @checked(is_array($pemeriksaan->pemeriksaan) && in_array('kerangka', $pemeriksaan->pemeriksaan)) disabled>
                                    <label class="form-check-label" for="kerangka">Pemeriksaan
                                        Kerangka</label>
                                </div>
                                <div class="form-check">
                        ...
                        <div class="form-group">
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="tkp">Pemeriksaan di
                                        TKP</label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="kuburan">Penggalian
                                        Kuburan</label>
                                </div>
                                <div class="form-check">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="sk_medis">Pembuatan Surat
                                        Keterangan Medis</label>
                                </div>
                                <div class="form-check">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="bukti">Pemaketan Barang
                                        Bukti</label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="asuransi">Pembuatan Surat
                    ...
                    <div class="section-separator">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="diagnosos"
                                value="{{ $pemeriksaan->diagnosos }}" disabled>
                        </div>
