                    ...
                    <tbody>
                        @foreach ($pemeriksaan as $item)
                            <tr>
                                ...
                                <td align="middle">
                                    <a href="{{ route('forensik.unit.pelayanan.pemeriksaan-patologi.show', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                                        class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a>
                                    <a href="{{ route('forensik.unit.pelayanan.pemeriksaan-patologi.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
