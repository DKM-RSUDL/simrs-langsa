                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nomor" name="nomor"
                                                    placeholder="Masukkan nomor visum"
                                                    value="{{ old('nomor', $visumOtopsi->nomor) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="lampiran" name="lampiran"
                                                placeholder="B/49/XII/2024/LL"
                                                value="{{ old('lampiran', $visumOtopsi->lampiran) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="visum_et_repertum" type="hidden" name="visum_et_repertum"
                                        value="{{ old('visum_et_repertum', $visumOtopsi->visum_et_repertum) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="wawancara" type="hidden" name="wawancara"
                                        value="{{ old('wawancara', $visumOtopsi->wawancara) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="penutup_mayat" type="hidden" name="penutup_mayat"
                                        value="{{ old('penutup_mayat', $visumOtopsi->penutup_mayat) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="label_mayat" type="hidden" name="label_mayat"
                                        value="{{ old('label_mayat', $visumOtopsi->label_mayat) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="pakaian_mayat" type="hidden" name="pakaian_mayat"
                                        value="{{ old('pakaian_mayat', $visumOtopsi->pakaian_mayat) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="identifikasi_umum_keterangan" type="hidden"
                                        ...
                                        value="{{ old('identifikasi_umum_keterangan', $visumOtopsi->identifikasi_umum_keterangan) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="tanda_kematian" type="hidden" name="tanda_kematian"
                                        value="{{ old('tanda_kematian', $visumOtopsi->tanda_kematian) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="identifikasi_khusus_keterangan" type="hidden"
                                        ...
                                        value="{{ old('identifikasi_khusus_keterangan', $visumOtopsi->identifikasi_khusus_keterangan) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="kepala_luar" type="hidden" name="kepala_luar"
                                        value="{{ old('kepala_luar', $visumOtopsi->kepala_luar) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('wajah')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    <input id="wajah" type="hidden" name="wajah"
                                        value="{{ old('wajah', $visumOtopsi->wajah) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('mata')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    <input id="mata" type="hidden" name="mata"
                                        value="{{ old('mata', $visumOtopsi->mata) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('mulut')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    <input id="mulut" type="hidden" name="mulut"
                                        value="{{ old('mulut', $visumOtopsi->mulut) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="leher_luar" type="hidden" name="leher_luar"
                                        value="{{ old('leher_luar', $visumOtopsi->leher_luar) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="dada_luar" type="hidden" name="dada_luar"
                                        value="{{ old('dada_luar', $visumOtopsi->dada_luar) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('punggung')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    <input id="punggung" type="hidden" name="punggung"
                                        value="{{ old('punggung', $visumOtopsi->punggung) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="perut_luar" type="hidden" name="perut_luar"
                                        value="{{ old('perut_luar', $visumOtopsi->perut_luar) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="anggota_gerak_atas" type="hidden" name="anggota_gerak_atas"
                                        value="{{ old('anggota_gerak_atas', $visumOtopsi->anggota_gerak_atas) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="anggota_gerak_bawah" type="hidden" name="anggota_gerak_bawah"
                                        value="{{ old('anggota_gerak_bawah', $visumOtopsi->anggota_gerak_bawah) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('kemaluan')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    <input id="kemaluan" type="hidden" name="kemaluan"
                                        value="{{ old('kemaluan', $visumOtopsi->kemaluan) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('anus')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                    <input id="anus" type="hidden" name="anus"
                                        value="{{ old('anus', $visumOtopsi->anus) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="kepala_dalam" type="hidden" name="kepala_dalam"
                                        value="{{ old('kepala_dalam', $visumOtopsi->kepala_dalam) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="leher_dalam" type="hidden" name="leher_dalam"
                                        value="{{ old('leher_dalam', $visumOtopsi->leher_dalam) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="dada_dalam" type="hidden" name="dada_dalam"
                                        value="{{ old('dada_dalam', $visumOtopsi->dada_dalam) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="perut_dalam" type="hidden" name="perut_dalam"
                                        value="{{ old('perut_dalam', $visumOtopsi->perut_dalam) }}">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input id="kesimpulan" type="hidden" name="kesimpulan"
                                        value="{{ old('kesimpulan', $visumOtopsi->kesimpulan) }}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (resetButton) {
                resetButton.addEventListener('click', function(e) {
                    if (confirm(
                            'Apakah Anda yakin ingin mereset seluruh form ini? Data yang sudah diubah akan kembali ke data asli.'
                        )) {
                        ...
                        document.getElementById('benda_disamping').value =
