                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <a href="{{ route('operasi.pelayanan.ceklist-anasthesi.edit', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $ceklistKesiapanAnesthesi->id]) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="mesin_anesthesia_listrik" value="mesin_anesthesia_listrik"
                                                        name="mesin_anesthesia_listrik[]" disabled {{ in_array('mesin_anesthesia_listrik', $listrik) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="layar_pemantauan_listrik" value="layar_pemantauan_listrik"
                                                        name="mesin_anesthesia_listrik[]" disabled {{ in_array('layar_pemantauan_listrik', $listrik) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="syringe_pump_listrik" value="syringe_pump_listrik"
                                                        name="mesin_anesthesia_listrik[]" disabled {{ in_array('syringe_pump_listrik', $listrik) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="defibrilator_listrik" value="defibrilator_listrik"
                                                        name="mesin_anesthesia_listrik[]" disabled {{ in_array('defibrilator_listrik', $listrik) ? 'checked' : '' }}>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="selang_oksigen"
                                                        name="gas_medis[]" value="selang_oksigen" disabled {{ in_array('selang_oksigen', $gasMedis) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="selang_oksigen">
                                                        Selang oksigen terhubung antara sumber gas dengan mesin anestesi
                                                    </label>
                                                </div>
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="flow_meter_o2"
                                                        name="gas_medis[]" value="flow_meter_o2" disabled {{ in_array('flow_meter_o2', $gasMedis) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="compressed_air"
                                                        name="gas_medis[]" value="compressed_air" disabled {{ in_array('compressed_air', $gasMedis) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="n2o_terhubung"
                                                        name="gas_medis[]" value="n2o_terhubung" disabled {{ in_array('n2o_terhubung', $gasMedis) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="n2o_terhubung">
                                                        N2O terhubung antara sumber gas dengan mesin anestesi
                                                    </label>
                                                </div>
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="flow_meter_n2o"
                                                        name="gas_medis[]" value="flow_meter_n2o" disabled {{ in_array('flow_meter_n2o', $gasMedis) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="power_on"
                                                        name="mesin_anesthesia[]" value="power_on" disabled {{ in_array('power_on', $mesinAnasthesia) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="mesin_anesthesia[]" id="self_calibration"
                                                        value="self_calibration" disabled {{ in_array('self_calibration', $mesinAnasthesia) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="absorber_co2"
                                                        name="mesin_anesthesia[]" value="absorber_co2" disabled {{ in_array('absorber_co2', $mesinAnasthesia) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="tidak_kebocoran"
                                                        name="mesin_anesthesia[]" value="tidak_kebocoran" disabled {{ in_array('tidak_kebocoran', $mesinAnasthesia) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="zat_volatil"
                                                        name="mesin_anesthesia[]" value="zat_volatil" disabled {{ in_array('zat_volatil', $mesinAnasthesia) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="sungkup_muka" disabled {{ in_array('sungkup_muka', $manajemenJalanNafas) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="oropharyngeal_airway" disabled {{ in_array('oropharyngeal_airway', $manajemenJalanNafas) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="batang_laringoskop" disabled {{ in_array('batang_laringoskop', $manajemenJalanNafas) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="bilah_laringoskop" disabled {{ in_array('bilah_laringoskop', $manajemenJalanNafas) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="gagang_bilah_laringoskop" disabled {{ in_array('gagang_bilah_laringoskop', $manajemenJalanNafas) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="ett_datai_mma" disabled {{ in_array('ett_datai_mma', $manajemenJalanNafas) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="stilet_introduser" disabled {{ in_array('stilet_introduser', $manajemenJalanNafas) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="semprit_cuff" disabled {{ in_array('semprit_cuff', $manajemenJalanNafas) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="forceps_magill" disabled {{ in_array('forceps_magill', $manajemenJalanNafas) ? 'checked' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="pemantauan[]"
                                                        id="kabel_ekg" value="kabel_ekg" disabled {{ in_array('kabel_ekg', $Pemantauan) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="pemantauan[]"
                                                        id="elektroda_ekg" value="elektroda_ekg" disabled {{ in_array('elektroda_ekg', $Pemantauan) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="pemantauan[]"
                                                        id="nibp_terhubung" value="nibp_terhubung" disabled {{ in_array('nibp_terhubung', $Pemantauan) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="pemantauan[]"
                                                        id="spo2_terhubung" value="spo2_terhubung" disabled {{ in_array('spo2_terhubung', $Pemantauan) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="pemantauan[]"
                                                        id="pemantau_suhu" value="pemantau_suhu" disabled {{ in_array('pemantau_suhu', $Pemantauan) ? 'checked' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="stetoskop_tersedia" value="stetoskop_tersedia" disabled {{ in_array('stetoskop_tersedia', $lainLain) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="suction_berfungsi" value="suction_berfungsi" disabled {{ in_array('suction_berfungsi', $lainLain) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="selang_suction" value="selang_suction" disabled {{ in_array('selang_suction', $lainLain) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="plester_fiksasi" value="plester_fiksasi" disabled {{ in_array('plester_fiksasi', $lainLain) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="blanket_roll" value="blanket_roll" disabled {{ in_array('blanket_roll', $lainLain) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="blanket_roll_alas" value="blanket_roll_alas" disabled {{ in_array('blanket_roll_alas', $lainLain) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="lidocain_spray" value="lidocain_spray" disabled {{ in_array('lidocain_spray', $lainLain) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="lain_lain[]"
                                                        id="defibrillator_jelly" value="defibrillator_jelly" disabled {{ in_array('defibrillator_jelly', $lainLain) ? 'checked' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                                        id="epinefrin" value="epinefrin" disabled {{ in_array('epinefrin', $obatObatan) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                                        id="atrofin" value="atrofin" disabled {{ in_array('atrofin', $obatObatan) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                                        id="sedatif" value="sedatif" disabled {{ in_array('sedatif', $obatObatan) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                                        id="opiat_opioid" value="opiat_opioid" disabled {{ in_array('opiat_opioid', $obatObatan) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                                        id="pelumpuh_otot" value="pelumpuh_otot" disabled {{ in_array('pelumpuh_otot', $obatObatan) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                                        id="antibiotik" value="antibiotik" disabled {{ in_array('antibiotik', $obatObatan) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                <div class="mb-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="pemeriksa" disabled
                                            value="{{$ceklistKesiapanAnesthesi->pemeriksa ?? '' }}">
                                    </div>

                                    <div class="form-group">
                                        <label style="min-width: 200px;">Supervisor</label>
                                        <input type="text" class="form-control" name="supervisor" disabled
                                            value="{{$ceklistKesiapanAnesthesi->supervisor ?? '' }}">
                                    </div>
