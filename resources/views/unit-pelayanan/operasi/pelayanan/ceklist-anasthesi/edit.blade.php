        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Checklist Kesiapan Anesthesi',
                    'description' => 'Perbarui formulir ceklist kesiapan anesthesi dengan benar.',
                ])
                <form method="POST"
                    ...
                    <div class="d-flex flex-column gap-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="mesin_anesthesia_listrik"
                                                value="mesin_anesthesia_listrik" name="mesin_anesthesia_listrik[]"
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="layar_pemantauan_listrik"
                                                value="layar_pemantauan_listrik" name="mesin_anesthesia_listrik[]"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="syringe_pump_listrik"
                                                value="syringe_pump_listrik" name="mesin_anesthesia_listrik[]"
                                        ...
                                        <div class="form-check mb-3">
                                            <input class="form-check-input" type="checkbox" id="defibrilator_listrik"
                                                value="defibrilator_listrik" name="mesin_anesthesia_listrik[]"
                        ...
                        <div>
                            ...
                            <div class="row">
                                @php
                                    $gasMedis =
                                        isset($ceklistKesiapanAnesthesi->gas_medis) &&
                                        $ceklistKesiapanAnesthesi->gas_medis
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="selang_oksigen"
                                            name="gas_medis[]" value="selang_oksigen"
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="flow_meter_o2"
                                            name="gas_medis[]" value="flow_meter_o2"
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="compressed_air"
                                            name="gas_medis[]" value="compressed_air"
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="n2o_terhubung"
                                            name="gas_medis[]" value="n2o_terhubung"
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="flow_meter_n2o"
                                            name="gas_medis[]" value="flow_meter_n2o"
                                            {{ in_array('flow_meter_n2o', $gasMedis) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="flow_meter_n2o">
                                            Flow meter N2O di mesin anestesi berfungsi, aliran gas
                                            keluar
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="power_on"
                                            name="mesin_anesthesia[]" value="power_on"
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="absorber_co2"
                                            name="mesin_anesthesia[]" value="absorber_co2"
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="tidak_kebocoran"
                                            name="mesin_anesthesia[]" value="tidak_kebocoran"
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="zat_volatil"
                                            name="mesin_anesthesia[]" value="zat_volatil"
                        ...
                        <div>
                            ...
                            <div class="row">
                                @php
                                    $lainLain =
                                        isset($ceklistKesiapanAnesthesi->lain_lain) &&
                                        $ceklistKesiapanAnesthesi->lain_lain
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                            ...
                                            {{ in_array('atrofin', $obatObatan) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" name="obat_obatan[]"
                                            ...
                                            {{ in_array('sedatif', $obatObatan) ? 'checked' : '' }}>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <label style="min-width: 300px;">Pemeriksa (Residen/perawat
                                    anestesi)</label>
                                <select class="form-select" name="pemeriksa" required>
