            ...
            <div class="col-md-9">
                <x-content-card>
                    ...
                    @include('components.page-header', [
                        'title' => 'Tambah Checklist Keselamatan (Time Out)',
                        'description' =>
                            'Tambah data operasi Checklist Keselamatan (Time Out) pasien dengan mengisi formulir di bawah ini.',
                    ])
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="konfirmasi_tim"
                                                value="1" id="konfirmasiTimYa" required>
                                            <label class="form-check-label" for="konfirmasiTimYa">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="konfirmasi_tim"
                                                value="0" id="konfirmasiTimTidak">
                                                    ...
                                                    <td>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                ...
                                                                id="konfirmasiLokasiYa" required>
                                                            <label class="form-check-label"
                                ...
                                <div class="card mb-3 checklist-card">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="antibiotik_profilaksis" value="0" id="antibiotikTidak">
                                    ...
                                    <div class="card-body">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="foto_rontgen"
                                                value="1" id="fotoRontgenYa" required>
                                            <label class="form-check-label" for="fotoRontgenYa">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="foto_rontgen"
                                                value="0" id="fotoRontgenTidak">
