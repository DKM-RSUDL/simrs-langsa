                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Edit Checklist Keselamatan (Time Out)</h5>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="ahli_bedah" required>
                                                    ...
                                                    @foreach ($dokter as $d)
                                                        <option value="{{ $d->kd_dokter }}" {{ $timeout->ahli_bedah == $d->kd_dokter ? 'selected' : '' }}>{{ $d->nama_lengkap }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="dokter_anastesi" required>
                                                    ...
                                                    @foreach ($dokterAnastesi as $dokter)
                                                        <option value="{{ $dokter->kd_dokter }}" {{ $timeout->ahli_anastesi == $dokter->kd_dokter ? 'selected' : '' }}>{{ $dokter->dokter->nama_lengkap }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div>
                                                ...
                                                <select class="form-select" name="perawat" required>
                                                    ...
                                                    @foreach ($perawat as $p)
                                                        <option value="{{ $p->kd_perawat }}" {{ $timeout->perawat == $p->kd_perawat ? 'selected' : '' }}>{{ $p->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    {{ $timeout->konfirmasi_tim == 1 ? 'checked' : '' }}
                                                    required>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    {{ $timeout->konfirmasi_tim == 0 ? 'checked' : '' }}
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="konfirmasi_prosedur" value="1" id="konfirmasiProsedurYa"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio"
                                                                    name="konfirmasi_lokasi" value="1" id="konfirmasiLokasiYa"
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                        ...
                                                        {{ $timeout->antibiotik_profilaksis == 1 ? 'checked' : '' }}
                                                        required>
                                                    <label class="form-check-label"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_antibiotik" value="{{ $timeout->nama_antibiotik }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">b. Dosis antibiotik yang diberikan</label>
                                                    <input type="text" class="form-control" name="dosis_antibiotik" value="{{ $timeout->dosis_antibiotik }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    {{ $timeout->foto_rontgen == 1 ? 'checked' : '' }}
                                                    required>
                                                <label class="form-check-label"
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    {{ $timeout->foto_rontgen == 0 ? 'checked' : '' }}
                                                    id="fotoRontgenTidak">
                                                <label class="form-check-label"
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Ahli Bedah</td>
                                                        <td>
                                                            <span class="text-muted">{{ $timeout->dokterBedah->nama_lengkap ?? 'Diisi otomatis saat disimpan' }}</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>Ahli Anestesi</td>
                                                        <td>
                                                            <span class="text-muted">{{ $timeout->dokterAnastesi->dokter->nama_lengkap ?? 'Diisi otomatis saat disimpan' }}</span>
                                                        </td>
                                                        <td>
                                                            <span class="text-muted">Digital</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>Perawat</td>
                                                        <td>
                                                            <span class="text-muted">{{ $timeout->perawatData->nama ?? 'Diisi otomatis saat disimpan' }}</span>
                                                        </td>
                                                        <td>
                                                            <span class="text-muted">Digital</span>
                                                        </td>
