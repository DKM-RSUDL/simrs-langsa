            ...
            <div class="col-md-9">
                <x-content-card>
                    ...
                    @include('components.page-header', [
                        'title' => 'Tambah Checklist Keselamatan (Sign Out)',
                        'description' =>
                            'Tambah data operasi Checklist Keselamatan (Sign Out) pasien dengan mengisi formulir di bawah ini.',
                    ])
                    ...
                    <form method="POST" id="signOutForm"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="ahli_bedah" required>
                                                ...
                                                @foreach ($dokter as $d)
                                                    <option value="{{ $d->kd_dokter }}">{{ $d->nama_lengkap }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-header bg-white">
                                ...
                                <small class="text-muted">Diisi oleh Perawat, Dokter Anastesi dan Operator Sebelum
                                    Tutup Luka Operasi</small>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <strong>Perawat melakukan konfirmasi secara verbal dengan
                                                        tim:</strong>
                                                </td>
                                                <td colspan="2"></td>
                                            </tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            id="konfirmasiProsedurYa" required>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>b. Instrument, sponge, dan jarum telah dihitung dengan benar
                                                </td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                                        <input class="form-check-input" type="radio"
                                                            name="konfirmasi_instrumen" value="1"
                                                            id="konfirmasiInstrumenYa" required>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>c. Spesimen telah diberi label (termasuk nama pasien dan asal
                                                    jaringan specimen)</td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                                        <input class="form-check-input" type="radio"
                                                            name="konfirmasi_spesimen" value="1"
                                                            id="konfirmasiSpesimenYa" required>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                                ...
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            id="masalahPeralatanYa" required>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <strong>Dokter bedah, dokter Anastesi, dan perawat melakukan
                                                        review masalah utama apa yang harus diperhatikan untuk
                                                        penyembuhan dan manajemen pasien selanjutnya.</strong>
                                                </td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                                        <input class="form-check-input" type="radio" name="review_tim"
                                                            value="1" id="reviewTimYa" required>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                    <div class="form-check d-flex justify-content-center">
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <textarea class="form-control" name="catatan_penting" rows="4"
                                                        placeholder="Tuliskan hal-hal yang harus diperhatikan..."></textarea>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <p class="text-muted mb-3">Catatan: Tanda tangan akan ditambahkan secara
                                    digital saat menyimpan form.</p>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Ahli Bedah</td>
                                            <td>
                                                <span class="text-muted">Diisi otomatis saat
                                                    disimpan</span>
                                            </td>
                                            <td>
