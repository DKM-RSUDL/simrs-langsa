                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Edit Checklist Keselamatan (Sign Out)</h5>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="ahli_bedah" required>
                                                    ...
                                                    @foreach ($dokter as $d)
                                                        <option value="{{ $d->kd_dokter }}" {{ $signout->ahli_bedah == $d->kd_dokter ? 'selected' : '' }}>{{ $d->nama_lengkap }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="dokter_anastesi" required>
                                                    ...
                                                    @foreach ($dokterAnastesi as $dokter)
                                                        <option value="{{ $dokter->kd_dokter }}" {{ $signout->ahli_anastesi == $dokter->kd_dokter ? 'selected' : '' }}>{{ $dokter->dokter->nama_lengkap }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div>
                                                ...
                                                <select class="form-select" name="perawat" required>
                                                    ...
                                                    @foreach ($perawat as $p)
                                                        <option value="{{ $p->kd_perawat }}" {{ $signout->perawat == $p->kd_perawat ? 'selected' : '' }}>{{ $p->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="konfirmasi_prosedur" value="1" id="konfirmasiProsedurYa" {{ $signout->konfirmasi_prosedur == 1 ? 'checked' : '' }} required>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="konfirmasi_prosedur" value="0" id="konfirmasiProsedurTidak" {{ $signout->konfirmasi_prosedur == 0 ? 'checked' : '' }}>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="konfirmasi_instrumen" value="1" id="konfirmasiInstrumenYa" {{ $signout->konfirmasi_instrumen == 1 ? 'checked' : '' }} required>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="konfirmasi_instrumen" value="0" id="konfirmasiInstrumenTidak" {{ $signout->konfirmasi_instrumen == 0 ? 'checked' : '' }}>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="konfirmasi_spesimen" value="1" id="konfirmasiSpesimenYa" {{ $signout->konfirmasi_spesimen == 1 ? 'checked' : '' }} required>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="konfirmasi_spesimen" value="0" id="konfirmasiSpesimenTidak" {{ $signout->konfirmasi_spesimen == 0 ? 'checked' : '' }}>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="masalah_peralatan" value="1" id="masalahPeralatanYa" {{ $signout->masalah_peralatan == 1 ? 'checked' : '' }} required>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="masalah_peralatan" value="0" id="masalahPeralatanTidak" {{ $signout->masalah_peralatan == 0 ? 'checked' : '' }}>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="review_tim" value="1" id="reviewTimYa" {{ $signout->review_tim == 1 ? 'checked' : '' }} required>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-check d-flex justify-content-center">
                                                            <input class="form-check-input" type="radio" name="review_tim" value="0" id="reviewTimTidak" {{ $signout->review_tim == 0 ? 'checked' : '' }}>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <textarea class="form-control" name="catatan_penting" rows="4" placeholder="Tuliskan hal-hal yang harus diperhatikan...">{{ $signout->catatan_penting }}</textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="card mt-4">
                                        ...
                                        <div class="card-body">
                                            <p class="text-muted mb-3">Catatan: Tanda tangan akan diperbarui secara digital saat menyimpan form.</p>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Ahli Bedah</td>
                                                        <td>
                                                            <span class="text-muted">{{ $signout->dokterBedah->nama_lengkap ?? 'Diisi otomatis saat disimpan' }}</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>Ahli Anestesi</td>
                                                        <td>
                                                            <span class="text-muted">{{ $signout->dokterAnastesi->dokter->nama_lengkap ?? 'Diisi otomatis saat disimpan' }}</span>
                                                        </td>
                                                        <td>
                                                            <span class="text-muted">Digital</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>Perawat</td>
                                                        <td>
                                                            <span class="text-muted">{{ $signout->perawatData->nama ?? 'Diisi otomatis saat disimpan' }}</span>
                                                        </td>
                                                        <td>
                                                            <span class="text-muted">Digital</span>
                                                        </td>
    ...
    <script>
        ...
        document.getElementById('signOutForm').addEventListener('submit', function(e) {
            if (confirm('Apakah perubahan data checklist sudah benar?')) {
                ...
                document.getElementById('submitBtn').innerHTML = '<i class="ti-reload me-1"></i> Menyimpan Perubahan...';
            } else {
                e.preventDefault();
            }
        });
