                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="cito" name="cito">
                                    <option value="0"
                                        {{ old('cito', $operasi->cito ?? '') == '0' ? 'selected' : '' }}>Tidak
                                    </option>
                                    <option value="1"
                                        {{ old('cito', $operasi->cito ?? '') == '1' ? 'selected' : '' }}>Ya
                                    </option>
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="kesadaran" id="kesadaran" class="form-select select2" disabled>
                                            ...
                                            <option value="Sopor" @selected(old('kesadaran', $transfer->kesadaran) == 'Sopor')>Sopor
                                            </option>
                                            <option value="Coma" @selected(old('kesadaran', $transfer->kesadaran) == 'Coma')>Coma
                                            </option>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><input type="radio" name="kursi_roda_kemandirian"
                                                    ...
                                                    disabled></td>
                                            <td class="text-center"><input type="radio"
                                                    name="kursi_roda_kemandirian" value="tidak_bisa"
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select name="derajat_pasien" id="derajat_pasien" class="form-select" disabled>
                                    <option value="">--Pilih--</option>
                                    <option value="Derajat 1" @selected(old('derajat_pasien', $transfer->derajat_pasien) == 'Derajat 1')>
                                        Derajat 1 - Transporter - Perawat
                                    </option>
                                    <option value="Derajat 2" @selected(old('derajat_pasien', $transfer->derajat_pasien) == 'Derajat 2')>
                                        Derajat 2 - Transporter - Perawat - Dokter
                                    </option>
                                    <option value="Derajat 3" @selected(old('derajat_pasien', $transfer->derajat_pasien) == 'Derajat 3')>
                                        Derajat 3 - Transporter - Perawat - Dokter yang kompeten
                                    </option>
                                    <option value="Derajat 4" @selected(old('derajat_pasien', $transfer->derajat_pasien) == 'Derajat 4')>
                                        Derajat 4 - Transporter - Perawat - Dokter yang kompeten menangani pasien kritis dan
                                        berpengalaman minimal 6 bulan bekerja di IGD/ ICU
                                    </option>
                                </select>
