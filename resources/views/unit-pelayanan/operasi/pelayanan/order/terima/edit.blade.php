...
<div class="row">
    ...
    <div class="col-md-9">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select select2" id="jenis_tindakan" name="jenis_tindakan" required>
                                ...
                                <option value="{{ $prod->kd_produk }}" {{ old('jenis_tindakan', $operasi->kd_produk) ==
                                    $prod->kd_produk ? 'selected' : '' }}>
                                    {{ $prod->deskripsi }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select select2" id="kamar_operasi" name="kamar_operasi" required>
                                ...
                                <option value="{{ $kr->no_kamar }}" {{ old('kamar_operasi', $operasi->no_kamar ??
                                    $operasi->kd_unit_kamar) == $kr->no_kamar ? 'selected' : '' }}>
                                    {{ $kr->nama_kamar }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="cito" name="cito">
                                <option value="0" {{ old('cito', $operasi->cito ?? '') == '0' ? 'selected' : '' }}>Tidak
                                </option>
                                <option value="1" {{ old('cito', $operasi->cito ?? '') == '1' ? 'selected' : '' }}>Ya
                                </option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select select2" id="dokter" name="dokter" required>
                                ...
                                <option value="{{ $d->kd_dokter }}" {{ old('dokter', $operasi->kd_dokter) ==
                                    $d->kd_dokter ? 'selected' : '' }}>
                                    {{ $d->nama }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="catatan" name="catatan" rows="4"
                                placeholder="Masukkan catatan...">{{ old('catatan', $operasi->catatan ?? '') }}</textarea>
                        </div>
                    </div>
                    <div class="text-end">
        ...
        <x-content-card>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="dokter_merawat" class="form-select select2" disabled>
                                    ...
                                    <option value="{{ $item->kd_dokter }}" @selected(old('dokter_merawat', $transfer->
                                        dokter_merawat) == $item->kd_dokter)>
                                        {{ $item->nama_lengkap }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="diagnosis_utama" class="form-control" rows="3"
                                    disabled>{{ old('diagnosis_utama', $transfer->diagnosis_utama) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="diagnosis_sekunder" class="form-control" rows="3"
                                    disabled>{{ old('diagnosis_sekunder', $transfer->diagnosis_sekunder) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="dpjp" class="form-select select2" disabled>
                                    <option value="">--Pilih--</option>
                                    @foreach ($dokterAll as $item)
                                    <option value="{{ $item->kd_dokter }}" @selected(old('dpjp', $transfer->dpjp) ==
                                        $item->kd_dokter)>
                                        {{ $item->nama_lengkap }}
                                    </option>
                                    @endforeach
            ...
            <div class="form-section">
                ...
                <div class="section-content">
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="persetujuan" value="ya"
                                        id="setuju_ya" @checked(old('persetujuan', $transfer->persetujuan) == 'ya')
                                    required
                                    disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="persetujuan" value="tidak"
                                        id="setuju_tidak" @checked(old('persetujuan', $transfer->persetujuan) ==
                                    'tidak')
                                    required disabled>
                        ...
                        @php
                        $alasan = is_string($transfer->alasan) ? json_decode($transfer->alasan, true) :
                        ($transfer->alasan
                        ?? []);
                        @endphp
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="alasan[]"
                                        value="kondisi_pasien" id="kondisi" @checked(is_array(old('alasan', $alasan)) &&
                                        in_array('kondisi_pasien', old('alasan', $alasan))) disabled>
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="alasan[]" value="fasilitas"
                                        id="fasilitas" @checked(is_array(old('alasan', $alasan)) &&
                                        in_array('fasilitas', old('alasan', $alasan))) disabled>
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="alasan[]" value="tenaga"
                                        id="tenaga" @checked(is_array(old('alasan', $alasan)) && in_array('tenaga',
                                        old('alasan', $alasan))) disabled>
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="alasan[]"
                                        value="lainnya_alasan" id="lainnya_alasan" @checked(is_array(old('alasan',
                                        $alasan)) && in_array('lainnya_alasan', old('alasan', $alasan)))
                        ...
                        <div class="checkbox-group d-flex gap-3 flex-wrap">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="metode[]" value="kursi_roda"
                                    id="kursi_roda" @checked(is_array(old('metode', $metode)) && in_array('kursi_roda',
                                    old('metode', $metode))) disabled>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="metode[]" value="brankar"
                                    id="brankar" @checked(is_array(old('metode', $metode)) && in_array('brankar',
                                    old('metode', $metode))) disabled>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="metode[]" value="tempat_tidur"
                                    id="tempat_tidur" @checked(is_array(old('metode', $metode)) &&
                                    in_array('tempat_tidur', old('metode', $metode))) disabled>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="kesadaran" id="kesadaran" class="form-select select2" disabled>
                                    <option value="">--Pilih--</option>
                                    <option value="Compos Mentis" @selected(old('kesadaran', $transfer->kesadaran) ==
                                        'Compos Mentis')>Compos Mentis</option>
                                    <option value="Apatis" @selected(old('kesadaran', $transfer->kesadaran) ==
                                        'Apatis')>Apatis</option>
                                    <option value="Sopor" @selected(old('kesadaran', $transfer->kesadaran) ==
                                        'Sopor')>Sopor
                                    </option>
                                    <option value="Coma" @selected(old('kesadaran', $transfer->kesadaran) ==
                                        'Coma')>Coma
                                    </option>
                                    <option value="Somnolen" @selected(old('kesadaran', $transfer->kesadaran) ==
                                        'Somnolen')>Somnolen</option>
                                </select>
                                @error('kesadaran')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="status_nyeri" id="status_nyeri" class="form-select select2"
                                            disabled>
                                            <option value="">--Pilih--</option>
                                            <option value="tidak_ada" @selected(old('status_nyeri', $transfer->
                                                status_nyeri)
                                                == 'tidak_ada')>Tidak Ada</option>
                                            <option value="ringan" @selected(old('status_nyeri', $transfer->
                                                status_nyeri) ==
                                                'ringan')>Ringan</option>
                                            <option value="sedang" @selected(old('status_nyeri', $transfer->
                                                status_nyeri) ==
                                                'sedang')>Sedang</option>
                                            <option value="berat" @selected(old('status_nyeri', $transfer->status_nyeri)
                                                ==
                                                'berat')>Berat</option>
                                        </select>
                                        @error('status_nyeri')
            ...
            @php
            $info_medis = is_string($transfer->info_medis) ? json_decode($transfer->info_medis, true) :
            ($transfer->info_medis ?? []);
            $peralatan = is_string($transfer->peralatan) ? json_decode($transfer->peralatan, true) :
            ($transfer->peralatan
            ?? []);
            @endphp
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="info_medis[]"
                                        value="disabilitas" id="disabilitas" @checked(is_array(old('info_medis',
                                        $info_medis)) && in_array('disabilitas', old('info_medis', $info_medis)))
                                        disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="info_medis[]" value="amputasi"
                                        id="amputasi" @checked(is_array(old('info_medis', $info_medis)) &&
                                        in_array('amputasi', old('info_medis', $info_medis))) disabled>
                                    <label class="form-check-label" for="amputasi">Amputasi</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="info_medis[]"
                                        value="paralisis" id="paralisis" @checked(is_array(old('info_medis',
                                        $info_medis)) && in_array('paralisis', old('info_medis', $info_medis)))
                                        disabled>
                                    <label class="form-check-label" for="paralisis">Paralisis</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="info_medis[]"
                                        value="kontraktur" id="kontraktur" @checked(is_array(old('info_medis',
                                        $info_medis)) && in_array('kontraktur', old('info_medis', $info_medis)))
                                        disabled>
                                    <label class="form-check-label" for="kontraktur">Kontraktur</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="info_medis[]"
                                        value="ulkus_dekubitus" id="ulkus_dekubitus" @checked(is_array(old('info_medis',
                                        $info_medis)) && in_array('ulkus_dekubitus', old('info_medis', $info_medis)))
                                        disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="info_medis[]" value="lainnya"
                                        id="lainnya_info_medis" @checked(is_array(old('info_medis', $info_medis)) &&
                                        in_array('lainnya', old('info_medis', $info_medis)))
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]"
                                        value="portable_o2" id="portable_o2" @checked(is_array(old('peralatan',
                                        $peralatan)) && in_array('portable_o2', old('peralatan', $peralatan)))
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]" value="ngt"
                                        id="ngt" @checked(is_array(old('peralatan', $peralatan)) && in_array('ngt',
                                        old('peralatan', $peralatan))) disabled>
                                    <label class="form-check-label" for="ngt">NGT</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]"
                                        value="alat_penghisap" id="alat_penghisap" @checked(is_array(old('peralatan',
                                        $peralatan)) && in_array('alat_penghisap', old('peralatan', $peralatan)))
                                        disabled>
                                    <label class="form-check-label" for="alat_penghisap">Alat Penghisap</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]"
                                        value="ventilator" id="ventilator" @checked(is_array(old('peralatan',
                                        $peralatan)) && in_array('ventilator', old('peralatan', $peralatan))) disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]" value="bagging"
                                        id="bagging" @checked(is_array(old('peralatan', $peralatan)) &&
                                        in_array('bagging', old('peralatan', $peralatan))) disabled>
                                    <label class="form-check-label" for="bagging">Bagging</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]"
                                        value="kateter_urin" id="kateter_urin" @checked(is_array(old('peralatan',
                                        $peralatan)) && in_array('kateter_urin', old('peralatan', $peralatan)))
                                        disabled>
                                    <label class="form-check-label" for="kateter_urin">Kateter Urin</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]"
                                        value="pompa_infus" id="pompa_infus" @checked(is_array(old('peralatan',
                                        $peralatan)) && in_array('pompa_infus', old('peralatan', $peralatan))) disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="peralatan[]" value="lainnya"
                                        id="lainnya_peralatan" @checked(is_array(old('peralatan', $peralatan)) &&
                                        in_array('lainnya', old('peralatan', $peralatan)))
            ...
            ??
            []);
            $inkontinensia = is_string($transfer->inkontinensia) ? json_decode($transfer->inkontinensia, true) :
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="gangguan[]" value="mental"
                                            id="mental" @checked(is_array(old('gangguan', $gangguan)) &&
                                            in_array('mental', old('gangguan', $gangguan))) disabled>
                                        <label class="form-check-label" for="mental">Mental</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="gangguan[]"
                                            value="pendengaran" id="pendengaran" @checked(is_array(old('gangguan',
                                            $gangguan)) && in_array('pendengaran', old('gangguan', $gangguan)))
                                            disabled>
                                        <label class="form-check-label" for="pendengaran">Pendengaran</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="gangguan[]"
                                            value="sensasi" id="sensasi" @checked(is_array(old('gangguan', $gangguan))
                                            && in_array('sensasi', old('gangguan', $gangguan))) disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="gangguan[]" value="bicara"
                                            id="bicara" @checked(is_array(old('gangguan', $gangguan)) &&
                                            in_array('bicara', old('gangguan', $gangguan))) disabled>
                                        <label class="form-check-label" for="bicara">Bicara</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="gangguan[]"
                                            value="penglihatan" id="penglihatan" @checked(is_array(old('gangguan',
                                            $gangguan)) && in_array('penglihatan', old('gangguan', $gangguan)))
                                            disabled>
                                        <label class="form-check-label" for="penglihatan">Penglihatan</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="gangguan[]"
                                            value="lainnya" id="lainnya_gangguan" @checked(is_array(old('gangguan',
                                            $gangguan)) && in_array('lainnya', old('gangguan', $gangguan)))
                            ...
                            <div class="mt-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="inkontinensia[]"
                                                value="urine" id="urine" @checked(is_array(old('inkontinensia',
                                                $inkontinensia)) && in_array('urine', old('inkontinensia',
                                                $inkontinensia))) disabled>
                                            <label class="form-check-label" for="urine">Urine</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="inkontinensia[]"
                                                value="saliva" id="saliva" @checked(is_array(old('inkontinensia',
                                                $inkontinensia)) && in_array('saliva', old('inkontinensia',
                                                $inkontinensia))) disabled>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="inkontinensia[]"
                                                value="alvi" id="alvi" @checked(is_array(old('inkontinensia',
                                                $inkontinensia)) && in_array('alvi', old('inkontinensia',
                                                $inkontinensia))) disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="inkontinensia[]"
                                                ...
                                                @checked(is_array(old('inkontinensia', $inkontinensia)) &&
                                                in_array('lainnya', old('inkontinensia', $inkontinensia)))
                            ...
                            <div class="mt-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="rehabilitasi" value="sedang"
                                        id="rehab_sedang" @checked(old('rehabilitasi', $transfer->rehabilitasi) ==
                                    'sedang')
                                    disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="rehabilitasi" value="buruk"
                                        id="rehab_buruk" @checked(old('rehabilitasi', $transfer->rehabilitasi) ==
                                    'buruk')
                                    disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="rehabilitasi" value="lainnya"
                                        id="lainnya_rehabilitasi" @checked(old('rehabilitasi', $transfer->rehabilitasi)
                                    ==
                                    'lainnya')
                                    onchange="toggleOtherInputRadio('lainnya_rehabilitasi',
                                    'rehabilitasi_lainnya_input',
                                    'rehabilitasi')" disabled>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="petugas1" class="form-select select2" disabled>
                                        ...
                                        <option value="{{ $item->kd_karyawan }}" @selected(old('petugas1', $transfer->
                                            petugas1) == $item->kd_karyawan)>
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="petugas2" class="form-select select2" disabled>
                                        ...
                                        @foreach ($petugas as $item)
                                        @if ($item->kd_karyawan != auth()->user()->kd_karyawan)
                                        <option value="{{ $item->kd_karyawan }}" @selected(old('petugas2', $transfer->
                                            petugas2) == $item->kd_karyawan)>
                                            {{ $item->gelar_depan . ' ' . str()->title($item->nama) . ' ' .
                                            $item->gelar_belakang }}
                                        </option>
                                        @endif
                                ...
                                <div class="mb-2">
                                    ...
                                    <select name="petugas3" class="form-select select2" disabled>
                                        ...
                                        @foreach ($petugas as $item)
                                        @if ($item->kd_karyawan != auth()->user()->kd_karyawan)
                                        <option value="{{ $item->kd_karyawan }}" @selected(old('petugas3', $transfer->
                                            petugas3) == $item->kd_karyawan)>
                                            {{ $item->gelar_depan . ' ' . str()->title($item->nama) . ' ' .
                                            $item->gelar_belakang }}
                                        </option>
                                        @endif
                            ...
                            <div class="mt-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="status_generalis" class="form-control" rows="3"
                                        placeholder="Tuliskan temuan pemeriksaan fisik generalis yang signifikan"
                                        disabled>{{ old('status_generalis', $transfer->status_generalis) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="status_lokalis" class="form-control" rows="3"
                                        placeholder="Tuliskan temuan pemeriksaan fisik lokalis yang signifikan"
                                        disabled>{{ old('status_lokalis', $transfer->status_lokalis) }}</textarea>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="berguling" value="mandiri"
                                            class="form-check-input" @checked(old('berguling', $transfer->berguling) ==
                                        'mandiri') disabled></td>
                                    ...
                                    <td class="text-center"><input type="radio" name="berguling" value="tidak_bisa"
                                            class="form-check-input" @checked(old('berguling', $transfer->berguling) ==
                                        'tidak_bisa') disabled></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;Duduk</td>
                                    <td class="text-center"><input type="radio" name="duduk" value="mandiri"
                                            class="form-check-input" @checked(old('duduk', $transfer->duduk) ==
                                        'mandiri')
                                        disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="higiene_wajah" value="mandiri"
                                            class="form-check-input" @checked(old('higiene_wajah',
                                            $transfer->higiene_wajah)
                                        == 'mandiri') disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="higiene_tubuh" value="mandiri"
                                            class="form-check-input" @checked(old('higiene_tubuh',
                                            $transfer->higiene_tubuh)
                                        == 'mandiri') disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="higiene_ekstremitas_bawah"
                                            value="mandiri" class="form-check-input"
                                            @checked(old('higiene_ekstremitas_bawah',
                                            $transfer->higiene_ekstremitas_bawah)
                                        == 'mandiri') disabled></td>
                                    <td class="text-center"><input type="radio" name="higiene_ekstremitas_bawah"
                                            value="bantuan" class="form-check-input"
                                            @checked(old('higiene_ekstremitas_bawah',
                                            $transfer->higiene_ekstremitas_bawah)
                                        == 'bantuan') disabled></td>
                                    <td class="text-center"><input type="radio" name="higiene_ekstremitas_bawah"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="traktus_digestivus"
                                            value="mandiri" class="form-check-input" @checked(old('traktus_digestivus',
                                            $transfer->traktus_digestivus) == 'mandiri') disabled></td>
                                    <td class="text-center"><input type="radio" name="traktus_digestivus"
                                            value="bantuan" class="form-check-input" @checked(old('traktus_digestivus',
                                            $transfer->traktus_digestivus) == 'bantuan') disabled></td>
                                    <td class="text-center"><input type="radio" name="traktus_digestivus"
                                            value="tidak_bisa" class="form-check-input"
                                            @checked(old('traktus_digestivus', $transfer->traktus_digestivus) ==
                                        'tidak_bisa') disabled></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;Traktus urinarius</td>
                                    <td class="text-center"><input type="radio" name="traktus_urinarius" value="mandiri"
                                            class="form-check-input" @checked(old('traktus_urinarius',
                                            $transfer->traktus_urinarius) == 'mandiri') disabled></td>
                                    <td class="text-center"><input type="radio" name="traktus_urinarius" value="bantuan"
                                            class="form-check-input" @checked(old('traktus_urinarius',
                                            $transfer->traktus_urinarius) == 'bantuan') disabled></td>
                                    <td class="text-center"><input type="radio" name="traktus_urinarius"
                                            value="tidak_bisa" class="form-check-input"
                                            @checked(old('traktus_urinarius', $transfer->traktus_urinarius) ==
                                        'tidak_bisa') disabled></td>
                                </tr>
                                @error('higiene_wajah')
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="pakaian_atas" value="mandiri"
                                            class="form-check-input" @checked(old('pakaian_atas',
                                            $transfer->pakaian_atas)
                                        == 'mandiri') disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="pakaian_tubuh" value="mandiri"
                                            class="form-check-input" @checked(old('pakaian_tubuh',
                                            $transfer->pakaian_tubuh)
                                        == 'mandiri') disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="pakaian_bawah" value="mandiri"
                                            class="form-check-input" @checked(old('pakaian_bawah',
                                            $transfer->pakaian_bawah)
                                        == 'mandiri') disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="makan" value="mandiri"
                                            class="form-check-input" @checked(old('makan', $transfer->makan) ==
                                        'mandiri')
                                        disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="jalan_kaki" value="mandiri"
                                            class="form-check-input" @checked(old('jalan_kaki', $transfer->jalan_kaki)
                                        ==
                                        'mandiri') disabled></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><input type="radio" name="kursi_roda_kemandirian"
                                            value="mandiri" class="form-check-input"
                                            @checked(old('kursi_roda_kemandirian', $transfer->kursi_roda_kemandirian) ==
                                        'mandiri') disabled></td>
                                    <td class="text-center"><input type="radio" name="kursi_roda_kemandirian"
                                            value="bantuan" class="form-check-input"
                                            @checked(old('kursi_roda_kemandirian', $transfer->kursi_roda_kemandirian) ==
                    ...
                    <div class="mt-4">
                        <div class="mb-3">
                            ...
                            <textarea name="pemeriksaan_penunjang" class="form-control" rows="3"
                                disabled>{{ old('pemeriksaan_penunjang', $transfer->pemeriksaan_penunjang) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="intervensi" class="form-control" rows="3"
                                disabled>{{ old('intervensi', $transfer->intervensi) }}</textarea>
                            @error('intervensi')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="diet" class="form-control" rows="3"
                                disabled>{{ old('diet', $transfer->diet) }}</textarea>
                            @error('diet')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="rencana_perawatan" class="form-control" rows="3"
                                disabled>{{ old('rencana_perawatan', $transfer->rencana_perawatan) }}</textarea>
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <select name="derajat_pasien" id="derajat_pasien" class="form-select" disabled>
                            <option value="">--Pilih--</option>
                            <option value="Derajat 1" @selected(old('derajat_pasien', $transfer->derajat_pasien) ==
                                'Derajat
                                1')>Derajat 1 - Transporter - Perawat</option>
                            <option value="Derajat 2" @selected(old('derajat_pasien', $transfer->derajat_pasien) ==
                                'Derajat
                                2')>Derajat 2 - Transporter - Perawat - Dokter</option>
                            <option value="Derajat 3" @selected(old('derajat_pasien', $transfer->derajat_pasien) ==
                                'Derajat
                                3')>Derajat 3 - Transporter - Perawat - Dokter yang kompeten</option>
                            <option value="Derajat 4" @selected(old('derajat_pasien', $transfer->derajat_pasien) ==
                                'Derajat
                                4')>Derajat 4 - Transporter - Perawat - Dokter yang kompeten menangani pasien kritis dan
                                berpengalaman minimal 6 bulan bekerja di IGD/ ICU</option>
                        </select>
