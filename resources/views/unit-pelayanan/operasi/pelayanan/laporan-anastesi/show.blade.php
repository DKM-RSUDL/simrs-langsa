                        ...
                        <div class="mb-5">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($drainData as $drain)
                                                @if(!empty($drain['tipe_drain']) || !empty($drain['jenis_drain']) || !empty($drain['ukuran']) || !empty($drain['keterangan']))
                                                    <tr>
                            ...
                            <div class="row g-3 mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-medium">
                                        {{ $laporanAnastesiDtl2->pemakaian_cairan }}
                                        @if($laporanAnastesiDtl2->banyak_pemakaian_cairan)
                                            ({{ $laporanAnastesiDtl2->banyak_pemakaian_cairan }} Liter)
                                        @endif
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-medium">
                                        @php
                                            $dokterBedah = $dokter->where('kd_dokter', $laporanAnastesi->dokter_bedah)->first();
                                        @endphp
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-medium">
                                        @php
                                            $dokterAnastesiObj = $dokterAnastesi->where('kd_dokter', $laporanAnastesi->dokter_anastesi)->first();
                                        @endphp
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-medium">
                                        @php
                                            $penataraAnastesi = $perawat->where('kd_perawat', $laporanAnastesi->penatara_anastesi)->first();
                                        @endphp
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-medium">{{ $laporanAnastesiDtl2->pemeriksaan_kondisi_kulit_pra_operasi }}</p>
                                </div>
                                <div class="col-md-6">
                                    <label class="fw-bold text-muted">Kondisi Kulit Pasca Operasi</label>
                                    <p class="fw-medium">{{ $laporanAnastesiDtl2->pemeriksaan_kondisi_kulit_pasca_operasi }}</p>
                                </div>
                                <div class="col-md-6">
                                ...
                                @if($laporanAnastesiDtl2->spesimen)
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="fw-medium">{{ $laporanAnastesiDtl2->total_jaringan_cairan_pemeriksaan }}</p>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="card-body p-4">
                                    <div class="row g-4 align-items-center">
                                        ...
                                        <div class="col-md-8 text-center">
                                            @php
                                                $perawatInstrumen = $perawat->where('kd_perawat', $laporanAnastesi->perawat_instrumen)->first();
                                            @endphp
                                            <p class="mb-2">
                                                <span class="d-block fw-medium">{{ $perawatInstrumen ? $perawatInstrumen->nama : 'Tidak ada data' }}</span>
                                    ...
                                    <div class="row g-4 align-items-center mt-4">
                                        ...
                                        <div class="col-md-8 text-center">
                                            @php
                                                $perawatSirkuler = $perawat->where('kd_perawat', $laporanAnastesi->perawat_sirkuler)->first();
                                            @endphp
                                            <p class="mb-2">
                                                <span class="d-block fw-medium">{{ $perawatSirkuler ? $perawatSirkuler->nama : 'Tidak ada data' }}</span>
                                                <span class="badge bg-primary-subtle text-primary px-3 py-1">
