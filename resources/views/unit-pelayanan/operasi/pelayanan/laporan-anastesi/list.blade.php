<div class="d-flex flex-column gap-3">
    @include('components.page-header', [
        'title' => 'Daftar Laporan Operasi Anestesi',
        'description' => 'Berikut daftar data laporan operasi anestesi.',
    ])
    <div class="row">
        <div class="col-md-9">
            <div class="row g-2">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('operasi.pelayanan.laporan-anastesi.edit', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                     ...
                     <a href="{{ route('operasi.pelayanan.laporan-anastesi.print', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
