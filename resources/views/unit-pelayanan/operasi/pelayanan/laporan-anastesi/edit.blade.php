                                    ...
                                    <div class="section-separator" id="penggunaanAlat">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select me-3" name="instrumen">
                                                <option disabled
                                                    {{ $laporanAnastesiDtl->instrument == null ? 'selected' : '' }}>
                                                    --Pilih--</option>
                                                <option value="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select me-3" name="prothese">
                                                <option disabled
                                                    {{ $laporanAnastesiDtl->prothese == null ? 'selected' : '' }}>--Pilih--
                                                </option>
                                                <option value="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="diathermy">
                                                <option disabled
                                                    {{ $laporanAnastesiDtl->pemakaian_diathermy == null ? 'selected' : '' }}>
                                                    --Pilih--</option>
                                                <option value="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="lokasi_diathermy">
                                                <option disabled
                                                    {{ $laporanAnastesiDtl->lokasi_diathermy == null ? 'selected' : '' }}>
                                                    --Pilih--</option>
                                                <option value="Paha"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="unit_pemasangan">
                                                <option disabled
                                                    {{ $laporanAnastesiDtl->unit_pemasangan == null ? 'selected' : '' }}>
                                                    --Pilih--</option>
                                                <option value="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="pemakaian_tomiquet">
                                                <option disabled
                                                    {{ $laporanAnastesiDtl->pemakaian_tomiquet == null ? 'selected' : '' }}>
                                                    --Pilih--</option>
                                                <option value="1"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="pemakaian_laser">
                                                <option disabled
                                                    {{ $laporanAnastesiDtl->pemakaian_laser == null ? 'selected' : '' }}>
                                                    --Pilih--</option>
                                                <option value="1"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="kassa2" class="form-control"
                                                                placeholder="jumlah"
                                                                value="{{ $laporanAnastesiDtl2->kassa_dua ?? '' }}"></td>
                                                        <td><input type="text" name="jarum2" class="form-control"
                                                                placeholder="jumlah"
                                                                value="{{ $laporanAnastesiDtl2->jarum_dua ?? '' }}"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2 align-items-center">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="instrumen_tidak_lengkap"
                                                                    id="instrumen_tidak_lengkap" value="Tidak Lengkap"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2 align-items-center">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="kassa_tidak_perlu" id="kassa_tidak_perlu"
                                                                    value="Tidak perlu"
                                                                    {{ $laporanAnastesiDtl2 && !$laporanAnastesiDtl2->kassa_satu && !$laporanAnastesiDtl2->kassa_dua && !$laporanAnastesiDtl2->kassa_tiga ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2 align-items-center">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="jarum_tidak_perlu" id="jarum_tidak_perlu"
                                                                    value="Tidak perlu"
                                                                    {{ $laporanAnastesiDtl2 && !$laporanAnastesiDtl2->jarum_satu && !$laporanAnastesiDtl2->jarum_dua && !$laporanAnastesiDtl2->jarum_tiga ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2 align-items-center">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="instrumen_tidak_perlu"
                                                                    id="instrumen_tidak_perlu" value="Tidak perlu"
                                                                    {{ $laporanAnastesiDtl2 && !$laporanAnastesiDtl2->instrumen_satu && !$laporanAnastesiDtl2->instrumen_dua && !$laporanAnastesiDtl2->instrumen_tiga ? 'checked' : '' }}>
                                                                <label class="form-check-label"
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex gap-3 align-items-center">
                                                <input type="date" class="form-control me-3"
                                                    name="waktu_mulai_operasi" value="{{ $waktuMulaiOperasi ?? '' }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select2" name="dokter_bedah">
                                                <option value=""
                                                    {{ !$laporanAnastesi->dokter_bedah ? 'selected' : '' }}>--Pilih--
                                                </option>
                                                @foreach ($dokter as $d)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="dokter_anastesi">
                                                <option value=""
                                                    {{ !$laporanAnastesi->dokter_anastesi ? 'selected' : '' }}>--Pilih--
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select2" name="penatara_anastesi">
                                                <option value=""
                                                    {{ !$laporanAnastesi->penatara_anastesi ? 'selected' : '' }}>--Pilih--
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select2" name="perawat_instrumen">
                                                <option value=""
                                                    {{ !$laporanAnastesi->perawat_instrumen ? 'selected' : '' }}>--Pilih--
                                                </option>
                                                @foreach ($perawat as $p)
                                                    <option value="{{ $p->kd_perawat }}"
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="spesimen">
                                                <option value=""
                                                    {{ !$laporanAnastesiDtl2 || !$laporanAnastesiDtl2->spesimen ? 'selected' : '' }}>
                                                    --Pilih--</option>
                                                <option value="Sodium Chloride 0,9%"
                                                    {{ $laporanAnastesiDtl2 && $laporanAnastesiDtl2->spesimen == 'Sodium Chloride 0,9%' ? 'selected' : '' }}>
                                                    Sodium Chloride 0,9%</option>
                                                <option value="AntiWolik Spray"
                                                    {{ $laporanAnastesiDtl2 && $laporanAnastesiDtl2->spesimen == 'AntiWolik Spray' ? 'selected' : '' }}>
                                                    AntiWolik Spray</option>
                                                <option value="Anbilotik"
                                                    {{ $laporanAnastesiDtl2 && $laporanAnastesiDtl2->spesimen == 'Anbilotik' ? 'selected' : '' }}>
                                                    Anbilotik</option>
                                                <option value="H2O2"
                                                    {{ $laporanAnastesiDtl2 && $laporanAnastesiDtl2->spesimen == 'H2O2' ? 'selected' : '' }}>
                                                    H2O2</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
