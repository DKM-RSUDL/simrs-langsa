                                ...
                                <div>
                                    ...
                                    <div class="section-separator" id="periapanPasien">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="jam_masuk" id="jam_time_out" class="form-control">
                                        </div>
                                    ...
                                    <div class="section-separator" id="penggunaanAlat">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" name="jam_mulai" class="form-control me-3">
                                            <input type="time" name="jam_selesai" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label style="min-width: 300px;">Pemakaian Tomiquet</label>
                                            <select class="form-select" name="pemakaian_tomiqet">
                                                <option selected disabled>--Pilih--</option>
                                                <option value="Ya">Ya</option>
                                                <option value="Tidak">Tidak</option>
                                            </select>
                                    ...
                                    <div class="section-separator" id="penghitunganAlat">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="dilakukan-xray">
                                                <option selected disabled>--Pilih--</option>
                                                <option value="Ya">Ya</option>
                                                <option value="Tidak">Tidak</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="penggunaan-tampon">
                                                <option selected disabled>--Pilih--</option>
                                                <option value="Ya">Ya</option>
                                                <option value="Tidak">Tidak</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jenis-tampon">
                                        </div>
                                    </div>
                                    ...
                                    <div class="section-separator" id="penggunaanCairan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select me-3" name="irigasi_luka">
                                                <option selected disabled>--Pilih--</option>
                                                <option value="Sodium Chloride 0,9%">Sodium Chloride 0,9%</option>
                                            ...
                                            <input type="text" class="form-control" name="pemakaian-cairan"
                                                placeholder="Liter">
                                        </div>
                                    ...
                                    <div class="section-separator">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="pemeriksaan_kondisi_kulit">
                                                <option selected disabled>--Pilih--</option>
                                        ...
                                        <div class="form-group">
                                            <label style="min-width: 300px;">Jumlah Total Jaringan/Cairan
                                                Pemeriksaan</label>
                                            <input type="text" class="form-control" name="jumlah_spesimen">
                                        </div>
                                        <div class="form-group">
