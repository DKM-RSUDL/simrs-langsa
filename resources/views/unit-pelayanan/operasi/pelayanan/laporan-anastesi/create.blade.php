        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    ...
                    'description' =>
                        'Tambah data Asesmen Catatan Perioperatif dengan mengisi formulir di bawah ini.',
                ])
                <form method="POST"
                    ...
                    <div class="section-separator" id="periapanPasien">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="persiapan_kulit">
                                ...
                                <option value="Povidone-loclinHibiscrub">Povidone-loclinHibiscrub
                                </option>
                                <!-- Tambahkan opsi lain sesuai kebutuhan -->
                            </select>
                        </div>
                    ...
                    <div class="section-separator" id="penggunaanAlat">
                        ...
                        <div class="form-group">
                            <label style="min-width: 300px;">Pemasangan Diathermy
                                (Elektrokauter)</label>
                        ...
                        <div class="form-group">
                            <label style="min-width: 300px;">Bila Ada, Kode Unit
                                Elektrosurgical</label>
                            <input type="text" class="form-control" name="kode_unit_elektrosurgical">
                        </div>

                        <!-- Unit Pemasangan / Pendingin Operasi -->
                        <div class="form-group">
                            <label style="min-width: 300px;">Unit Pemasangan / Pendingin
                                Operasi</label>
                        ...
                        <div class="form-group">
                            <label style="min-width: 300px;">Bila Ya, Pengaturan Temperatur
                                Mulai</label>
                    ...
                    <div class="section-separator" id="penghitunganAlat">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <input class="form-check-input" type="checkbox" name="kassa4"
                                                    id="kassa_tidak_lengkap" value="1">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <input class="form-check-input" type="checkbox" name="jarum4"
                                                    id="jarum_tidak_lengkap" value="1">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <input class="form-check-input" type="checkbox" name="instrumen4"
                                                    id="instrumen_tidak_lengkap" value="1">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <input class="form-check-input" type="checkbox" name="kassa5"
                                                    id="kassa_tidak_perlu" value="1">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <input class="form-check-input" type="checkbox" name="jarum5"
                                                    id="jarum_tidak_perlu" value="1">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 align-items-center">
                                                <input class="form-check-input" type="checkbox" name="instrumen5"
                                                    id="instrumen_tidak_perlu" value="1">
                        ...
                        <h6>Catatan :</h6>
                        <p class="text-small">Jika dihitung tidak lengkap, setelah dicari tidak
                            ditemukan.
                            Dilakukan nya X-Ray
                        </p>
