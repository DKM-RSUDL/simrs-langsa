        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    ...
                    'description' =>
                        'Tambah data laporan operasi pasien rawat inap dengan mengisi formulir di bawah ini.',
                ])

                <form method="POST"
                    action="{{ route('operasi.pelayanan.laporan-operasi.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                    class="">
                    @csrf
                    <div class="section-separator mt-0" id="jenisAnestesi">
                        <h5 class="section-title">1. Informasi Operasi</h5>
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="nama_tindakan_operasi"
                                style="min-width: 200px;">Nama Tindakan Operasi</label>
                            <input placeholder="Nama Tindakan Operasi" type="text" class="form-control"
                                name="nama_tindakan_operasi" id="nama_tindakan_operasi" required>
                        </div>

                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="kd_jenis_anastesi" style="min-width: 200px;">Jenis
                                Anestesi Yang Digunakan</label>
                            <select name="kd_jenis_anastesi" id="kd_jenis_anastesi" class="form-select" required>
                    ...
                    <div class="section-separator" id="persetujuanPasien">
                        <h5 class="section-title">3. Pemeriksaan Laboratorium & Patologi Anatomi (PA)
                        </h5>

                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="pa" style="min-width: 200px;">Dikirim
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="kultur" style="max-width: 200px;">Dikirim
                                Untuk kultur</label>
                    ...
                    <div class="section-separator" id="persetujuanPasien">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kd_dokter_bedah" id="kd_dokter_bedah" class="form-select select2">
                                ...
                                @foreach ($dokter as $dok)
                                    <option value="{{ $dok->kd_dokter }}">{{ $dok->nama_lengkap }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="kd_perawat_bedah"
                                style="min-width: 200px;">Perawat Bedah</label>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="kd_dokter_anastesi"
                                style="min-width: 200px;">Dokter Ahli Anestesi</label>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="kd_penata_anastesi"
                                style="min-width: 200px;">Penata Anestesi</label>
                            <select name="kd_penata_anastesi" id="kd_penata_anastesi" class="form-select select2">
                                <option value="">--Pilih--</option>
                                @foreach ($perawat as $prw)
                                    <option value="{{ $prw->kd_perawat }}">{{ $prw->nama }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="section-separator" id="persetujuanPasien">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="transfusi_darah"
                                style="min-width: 200px;">Transfusi Darah</label>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="wb" style="min-width: 200px;">WB
                                (Whole Blood)</label>
                            <div class="input-group">
                                <input placeholder="Isi seberapa banyak WB (Whole Blood)" type="number"
                                    class="form-control" name="wb" id="wb">
                                <span class="input-group-text">cc</span>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-3 col-form-label" for="prc" style="min-width: 200px;">PRC
                                (Packed Red Cells)</label>
                            <div class="input-group">
                                <input placeholder="Isi seberapa banyak PRC (Packed Red Cells)" type="number"
                                    class="form-control" name="prc" id="prc">
                                <span class="input-group-text">cc</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input placeholder="Isi seberapa banyak Cryo (Cryoprecipitate)" type="number"
                                    class="form-control" name="cryo" id="cryo">
                                <span class="input-group-text">cc</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="dataMasuk">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" style="min-width: 200px;">Waktu
                                Mulai Operasi</label>
                    ...
                    <div class="section-separator mb-0" id="dataMasuk">
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="Jelaskan deskripsilengkap tentang prosedur bedah yang dilakukan "
                                name="laporan_prosedur_operasi" id="laporan_prosedur_operasi" class="form-control"></textarea>
                        </div>
                    </div>
