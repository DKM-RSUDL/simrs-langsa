            ...
            <x-content-card>
                ...
                <form method="POST"
                    ...
                    <div class="section-separator mt-0" id="jenisAnestesi">
                        ...
                        <div class="form-group">
                            ...
                            <input placeholder="Nama Tindakan Operasi" type="text" class="form-control"
                                ...
                                value="{{ $laporan->nama_tindakan_operasi }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input placeholder="Isi seberapa banyak WB (Whole Blood)" type="number"
                                    class="form-control" name="wb" id="wb" value="{{ $laporan->wb }}">
                                <span class="input-group-text">cc</span>
                            </div>
                        </div>
                    ...
                    <div class="section-separator" id="dataMasuk">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" style="min-width: 200px;">Waktu Mulai
                                Operasi</label>

                            <input type="date" name="tgl_mulai" id="tgl_mulai" class="form-control me-3"
                                value="{{ date('Y-m-d', strtotime($laporan->tgl_mulai)) }}">
                            <input type="time" name="jam_mulai" id="jam_mulai" class="form-control"
                                value="{{ date('H:i', strtotime($laporan->jam_mulai)) }}">
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 col-form-label" style="min-width: 200px;">Waktu Selesai
                                Operasi</label>

                            <input type="date" name="tgl_selesai" id="tgl_selesai" class="form-control me-3"
                                value="{{ date('Y-m-d', strtotime($laporan->tgl_selesai)) }}">
                            <input type="time" name="jam_selesai" id="jam_selesai" class="form-control"
                                value="{{ date('H:i', strtotime($laporan->jam_selesai)) }}">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="lama_operasi" id="lama_operasi" class="form-control"
                                placeholder="Cth : 1 jam" value="{{ $laporan->lama_operasi }}">
                        </div>
                    </div>
