...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form method="POST" action="{{ route('operasi.pelayanan.laporan-operasi.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                @csrf
                @method('put')
                                ...
                                <div>
                                    ...
                                    <div class="section-separator" id="jenisAnestesi">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input placeholder="Nama Tindakan Operasi" type="text" class="form-control" name="nama_tindakan_operasi" id="nama_tindakan_operasi" value="{{ $laporan->nama_tindakan_operasi }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kd_jenis_anastesi" id="kd_jenis_anastesi" class="form-select">
                                                ...
                                                @foreach ($jenisAnastesi as $item)
                                                    <option value="{{ $item->kd_jenis_anastesi }}" @selected($item->kd_jenis_anastesi == $laporan->kd_jenis_anastesi)>{{ $item->jenis_anastesi }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="section-separator" id="edukasiPasien">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input placeholder="isi Diagnosa Pra-Operasi" type="text" class="form-control" name="diagnosa_pra_operasi" id="diagnosa_pra_operasi" value="{{ $laporan->diagnosa_pra_operasi }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 col-form-label" for="diagnosa_pasca_operasi" style="min-width: 200px;">Diagnosa Pasca-Operasi</label>
                                            <input placeholder="isi Diagnosa Pasca-Operasi" type="text" class="form-control" name="diagnosa_pasca_operasi" id="diagnosa_pasca_operasi" value="{{ $laporan->diagnosa_pasca_operasi }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 col-form-label" for="komplikasi" style="min-width: 200px;">Bila Ada Komplikasi Selama Pembedahan</label>
                                            <input placeholder="isi Komplikasi Selama Pembedahan" type="text" class="form-control" name="komplikasi" id="komplikasi" value="{{ $laporan->komplikasi }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kd_dokter_bedah" id="kd_dokter_bedah" class="form-select select2">
                                                ...
                                                @foreach ($dokter as $dok)
                                                    <option value="{{ $dok->kd_dokter }}" @selected($dok->kd_dokter == $laporan->kd_dokter_bedah)>{{ $dok->nama_lengkap }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="kd_perawat_bedah" id="kd_perawat_bedah" class="form-select select2">
                                                ...
                                                @foreach ($perawat as $prw)
                                                    <option value="{{ $prw->kd_perawat }}" @selected($prw->kd_perawat == $laporan->kd_perawat_bedah)>{{ $prw->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="kd_dokter_anastesi" id="kd_dokter_anastesi" class="form-select select2">
                                                ...
                                                @foreach ($dokterAnastesi as $da)
                                                    <option value="{{ $da->kd_dokter }}" @selected($da->kd_dokter == $laporan->kd_dokter_anastesi)>{{ $da->dokter->nama_lengkap }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="kd_penata_anastesi" id="kd_penata_anastesi" class="form-select select2">
                                                <option value="">--Pilih--</option>
                                                @foreach ($perawat as $prw)
                                                    <option value="{{ $prw->kd_perawat }}" @selected($prw->kd_perawat == $laporan->kd_penata_anastesi)>{{ $prw->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="section-separator" id="persetujuanPasien">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input placeholder="isi seberapa banyak pendarahan selama operasi" type="number" class="form-control" name="pendarahan" id="pendarahan" value="{{ $laporan->pendarahan }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input placeholder="Isi seberapa banyak WB (Whole Blood)" type="number" class="form-control" name="wb" id="wb" value="{{ $laporan->wb }}">
                                                <span class="input-group-text">cc</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input placeholder="Isi seberapa banyak PRC (Packed Red Cells)" type="number" class="form-control" name="prc" id="prc" value="{{ $laporan->prc }}">
                                                <span class="input-group-text">cc</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input placeholder="Isi seberapa banyak Cryo (Cryoprecipitate)" type="number" class="form-control" name="cryo" id="cryo" value="{{ $laporan->cryo }}">
                                                <span class="input-group-text">cc</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="section-separator" id="dataMasuk">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tgl_mulai" id="tgl_mulai" class="form-control me-3" value="{{ date('Y-m-d', strtotime($laporan->tgl_mulai)) }}">
                                            <input type="time" name="jam_mulai" id="jam_mulai" class="form-control" value="{{ date('H:i', strtotime($laporan->jam_mulai)) }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 col-form-label" style="min-width: 200px;">Waktu Selesai Operasi</label>

                                            <input type="date" name="tgl_selesai" id="tgl_selesai" class="form-control me-3" value="{{ date('Y-m-d', strtotime($laporan->tgl_selesai)) }}">
                                            <input type="time" name="jam_selesai" id="jam_selesai" class="form-control" value="{{ date('H:i', strtotime($laporan->jam_selesai)) }}">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 col-form-label" style="min-width: 200px;">Lama Operasi</label>
                                            <input type="text" name="lama_operasi" id="lama_operasi" class="form-control" placeholder="Cth : 1 jam" value="{{ $laporan->lama_operasi }}">
                                        </div>
                                    </div>
                                    <div class="section-separator" id="dataMasuk">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Jelaskan deskripsilengkap tentang prosedur bedah yang dilakukan " name="laporan_prosedur_operasi" id="laporan_prosedur_operasi" class="form-control">{{ $laporan->laporan_prosedur_operasi }}</textarea>
                                        </div>
                                    </div>
