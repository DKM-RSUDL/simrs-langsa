                            ...
                            <div>
                                ...
                                <div class="section-separator" id="jenisAnestesi">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Nama Tindakan Operasi" type="text" class="form-control" name="nama_tindakan_operasi" id="nama_tindakan_operasi" value="{{ $laporan->nama_tindakan_operasi }}" disabled>
                                    </div>
                                ...
                                <div class="section-separator" id="edukasiPasien">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input placeholder="isi Diagnosa Pra-Operasi" type="text" class="form-control" name="diagnosa_pra_operasi" id="diagnosa_pra_operasi" value="{{ $laporan->diagnosa_pra_operasi }}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-form-label" for="diagnosa_pasca_operasi" style="min-width: 200px;">Diagnosa Pasca-Operasi</label>
                                        <input placeholder="isi Diagnosa Pasca-Operasi" type="text" class="form-control" name="diagnosa_pasca_operasi" id="diagnosa_pasca_operasi" value="{{ $laporan->diagnosa_pasca_operasi }}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-form-label" for="komplikasi" style="min-width: 200px;">Bila Ada Komplikasi Selama Pembedahan</label>
                                        <input placeholder="isi Komplikasi Selama Pembedahan" type="text" class="form-control" name="komplikasi" id="komplikasi" value="{{ $laporan->komplikasi }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="persetujuanPasien">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input placeholder="isi seberapa banyak pendarahan selama operasi" type="number" class="form-control" name="pendarahan" id="pendarahan" value="{{ $laporan->pendarahan }}" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input placeholder="Isi seberapa banyak WB (Whole Blood)" type="number" class="form-control" name="wb" id="wb" value="{{ $laporan->wb }}" disabled>
                                            <span class="input-group-text">cc</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input placeholder="Isi seberapa banyak PRC (Packed Red Cells)" type="number" class="form-control" name="prc" id="prc" value="{{ $laporan->prc }}" disabled>
                                            <span class="input-group-text">cc</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input placeholder="Isi seberapa banyak Cryo (Cryoprecipitate)" type="number" class="form-control" name="cryo" id="cryo" value="{{ $laporan->cryo }}" disabled>
                                            <span class="input-group-text">cc</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="section-separator" id="dataMasuk">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_mulai" id="tgl_mulai" class="form-control me-3" value="{{ date('Y-m-d', strtotime($laporan->tgl_mulai)) }}" disabled>
                                        <input type="time" name="jam_mulai" id="jam_mulai" class="form-control" value="{{ date('H:i', strtotime($laporan->jam_mulai)) }}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-form-label" style="min-width: 200px;">Waktu Selesai Operasi</label>

                                        <input type="date" name="tgl_selesai" id="tgl_selesai" class="form-control me-3" value="{{ date('Y-m-d', strtotime($laporan->tgl_selesai)) }}" disabled>
                                        <input type="time" name="jam_selesai" id="jam_selesai" class="form-control" value="{{ date('H:i', strtotime($laporan->jam_selesai)) }}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-form-label" style="min-width: 200px;">Lama Operasi</label>
                                        <input type="text" name="lama_operasi" id="lama_operasi" class="form-control" placeholder="Cth : 1 jam" value="{{ $laporan->lama_operasi }}" disabled>
                                    </div>
                                </div>
                                <div class="section-separator" id="dataMasuk">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea placeholder="Jelaskan deskripsilengkap tentang prosedur bedah yang dilakukan " name="laporan_prosedur_operasi" id="laporan_prosedur_operasi" class="form-control" disabled>{{ $laporan->laporan_prosedur_operasi }}</textarea>
                                    </div>
                                </div>
