        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah Pra Operasi Medis',
                    'description' =>
                        'Tambah data pra operasi medis dengan mengisi formulir di bawah ini.',
                ])

                <form method="POST"
                    action="{{ route('operasi.pelayanan.asesmen.pra-anestesi.medis.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                    @csrf
                    ...
                    <div class="section-separator" id="diagnosaPraOperatif">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="diagnosa_pra_operatif" id="diagnosa_pra_operatif" class="form-control"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="timing_tindakan" style="min-width: 200px;">Timing Tindakan</label>
                            <textarea name="timing_tindakan" id="timing_tindakan" class="form-control"></textarea>
                        </div>
                    ...
                    <div class="section-separator" id="rencanaTindakan">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="rencana_tindakan" id="rencana_tindakan" class="form-control"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="prosedur_tindakan" style="min-width: 200px;">Prosedur Tindakan</label>
                            <textarea name="prosedur_tindakan" id="prosedur_tindakan" class="form-control"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="timingDanAlternatifTindakan">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="alternatif_lain" id="alternatif_lain" class="form-control"></textarea>
                        </div>
                    </div>
