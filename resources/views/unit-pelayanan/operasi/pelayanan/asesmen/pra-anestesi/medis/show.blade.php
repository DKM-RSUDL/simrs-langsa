                            ...
                            <div>
                                ...
                                <div class="section-separator" id="dataMasuk">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_masuk" id="tgl_masuk" value="{{ date('Y-m-d', strtotime($asesmen->praOperatifMedis->tgl_op)) }}" class="form-control me-3" disabled>
                                        <input type="time" name="jam_masuk" id="jam_masuk" value="{{ date('H:i', strtotime($asesmen->praOperatifMedis->tgl_op)) }}" class="form-control" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="timingDanAlternatifTindakan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_tindakan" id="tgl_tindakan" class="form-control me-3" value="{{ date('Y-m-d', strtotime($asesmen->praOperatifMedis->waktu_tindakan)) }}" disabled>
                                        <input type="time" name="jam_tindakan" id="jam_tindakan" class="form-control" value="{{ date('H:i', strtotime($asesmen->praOperatifMedis->waktu_tindakan)) }}" disabled>
                                    </div>
                                ...
                                <div class="section-separator" id="rencanaTindakan">
                                    ...
                                    <div class="form-group align-items-center">
                                        ...
                                        <div class="me-4">
                                            ...
                                            <input type="number" name="sistole" id="sistole" class="form-control" value="{{ $asesmen->praOperatifMedis->sistole }}" disabled>
                                        </div>

                                        <div class="">
                                            <label for="diastole" class="form-label">Diastole</label>
                                            <input type="number" name="diastole" id="diastole" class="form-control" value="{{ $asesmen->praOperatifMedis->diastole }}" disabled>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="nadi" style="min-width: 200px;">Nadi (Per Menit)</label>
                                        <input type="number" name="nadi" id="nadi" class="form-control" value="{{ $asesmen->praOperatifMedis->nadi }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="nafas" style="min-width: 200px;">Nafas (Per Menit)</label>
                                        <input type="number" name="nafas" id="nafas" class="form-control" value="{{ $asesmen->praOperatifMedis->nafas }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="suhu" style="min-width: 200px;">Suhu (C)</label>
                                        <input type="number" name="suhu" id="suhu" class="form-control" value="{{ $asesmen->praOperatifMedis->suhu }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="evaluasi" style="min-width: 200px;">Evaluasi Luka Operasi</label>
                                        <textarea name="evaluasi" id="evaluasi" class="form-control" disabled>{{ $asesmen->praOperatifMedis->evaluasi }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="penanganan_nyeri" style="min-width: 200px;">Penanganan Nyeri Pasca Operasi</label>
                                        <textarea name="penanganan_nyeri" id="penanganan_nyeri" class="form-control" disabled>{{ $asesmen->praOperatifMedis->penanganan_nyeri }}</textarea>
                                    </div>
                                </div>
