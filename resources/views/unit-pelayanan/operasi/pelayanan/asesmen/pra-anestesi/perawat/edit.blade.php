                            ...
                            <div class="px-3">
                                <div>
                                    ...
                                    <div class="section-separator" id="dataMasuk">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control me-3"
                                                value="{{ date('Y-m-d', strtotime($asesmen->praOperatifPerawat->tgl_op)) }}">
                                            <input type="time" name="jam_masuk" id="jam_masuk" class="form-control"
                                                value="{{ date('H:i', strtotime($asesmen->praOperatifPerawat->jam_op)) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="section-separator" id="rencanaTindakan">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="skala_nyeri" id="skala_nyeri" min="0"
                                                ...
                                                value="{{ $asesmen->praOperatifPerawat->skala_nyeri }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-control"
                                                value="{{ $asesmen->praOperatifPerawat->tinggi_badan }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="lpt" id="lpt" class="form-control"
                                                value="{{ $asesmen->praOperatifPerawat->lpt }}" readonly>
                                        </div>
                                            ...
                                            <div class="row w-100">
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#penyakitSekarangModal"><i
                                                        ...
                                                        @foreach ($asesmen->praOperatifPerawat->penyakit_sekarang ?? [] as $ps)
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <p
                                                                    ...
                                                                    {{ $ps }}</p>
                                                                <input type="hidden" name="penyakitsekarang[]"
                                                                    value="{{ $ps }}">
                                                                <button type="button"
                                                                    class="btn text-danger btn-sm btn-delete-list">
                                                        ...
                                                        @foreach ($asesmen->praOperatifPerawat->penyakit_dahulu ?? [] as $pd)
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <p
                                                                    class="fw-bold text-primary m-0 text-decoration-underline">
                                                                    {{ $pd }}</p>
                                                                <input type="hidden" name="penyakitdahulu[]"
                                                                    value="{{ $pd }}">
                                                                <button type="button"
                                                                    class="btn text-danger btn-sm btn-delete-list">
                                                                    <i class="fas fa-trash"></i>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="alat_bantu" id="alat_bantu" class="form-select">
                                                ...
                                                <option value="4" @selected($asesmen->praOperatifPerawat->alat_bantu == '4')>Alat Bantu Dengar
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row w-100">
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#jenisOperasiModal"><i
                                                            class="bi bi-plus-square"></i> Tambah</button>
                                                        ...
                                                        @foreach ($asesmen->praOperatifPerawat->jenis_operasi ?? [] as $jo)
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <p
                                                                    class="fw-bold text-primary m-0 text-decoration-underline">
                                                                    {{ $jo }}</p>
                                                                <input type="hidden" name="jenisoperasi[]"
                                                                    value="{{ $jo }}">
                                                                <button type="button"
                                                                    class="btn text-danger btn-sm btn-delete-list">
                                                                    <i class="fas fa-trash"></i>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tgl_bedah" id="tgl_bedah"
                                                ...
                                                value="{{ date('Y-m-d', strtotime($asesmen->praOperatifPerawat->tgl_bedah)) }}">
                                            <input type="text" name="tempat_bedah" id="tempat_bedah"
                                                placeholder="Jelaskan" class="form-control"
                                                value="{{ $asesmen->praOperatifPerawat->tempat_bedah }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row w-100">
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#alergiModal"><i class="bi bi-plus-square"></i>
                                                        Tambah</button>
                                                        ...
                                                        <tbody>
                                                            @foreach ($asesmen->praOperatifPerawat->alergi ?? [] as $alergi)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button type="button"
                                                                            class="btn btn-sm btn-danger btn-delete-alergi">
                                                                            <i class="fas fa-trash"></i>
                                                                        </button>
                                                                        <input type='hidden' name='alergi[]'
                                                                            value='{{ '{"alergen" : "' . $alergi['alergen'] . '", "reaksi" : "' . $alergi['reaksi'] . '", "severe" : "' . $alergi['severe'] . '"}' }}'>
                                                                    </td>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <input type="checkbox" name="hasil_lab[]" id="hb" value="HB"
                                                    @checked(in_array('HB', $asesmen->praOperatifPerawat->hasil_lab))>
                                                <label for="hb">HB</label>
                                            </div>
                                            <div class="">
                                                <input type="checkbox" name="hasil_lab[]" id="bt" value="BT"
                                                    @checked(in_array('BT', $asesmen->praOperatifPerawat->hasil_lab))>
                                                <label for="bt">BT</label>
                                            </div>
                                            <div class="">
                                                <input type="checkbox" name="hasil_lab[]" id="ct" value="CT/APTT"
                                                    @checked(in_array('CT/APTT', $asesmen->praOperatifPerawat->hasil_lab))>
                                                <label for="ct">CT/APTT</label>
                                            </div>
                                            <div class="">
                                                <input type="checkbox" name="hasil_lab[]" id="gol_darah"
                                                    value="Gol Darah" @checked(in_array('Gol Darah', $asesmen->praOperatifPerawat->hasil_lab))>
                                                <label for="gol_darah">Gol Darah</label>
                                            </div>
                                            <div class="">
                                                <input type="checkbox" name="hasil_lab[]" id="urine" value="Urine"
                                                    @checked(in_array('Urine', $asesmen->praOperatifPerawat->hasil_lab))>
                                                <label for="urine">Urine</label>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="hasil_lab_lainnya" style="min-width: 200px;">Hasil Lab
                                                Lainnya</label>
                                            <input type="text" class="form-control" name="hasil_lab_lainnya"
                                                id="hasil_lab_lainnya"
                                                value="{{ $asesmen->praOperatifPerawat->hasil_lab_lainnya }}">
                                        </div>
                                    ...
                                    <div class="section-separator" id="rencanaTindakan">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('identitas_pasien', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('periksa_gelang', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('ipri', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('lokasi_pembedahan', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="verifikasi[]" id=""
                                                            value="persetujuan_operasi" @checked(in_array('persetujuan_operasi', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="verifikasi[]" id=""
                                                            value="persetujuan_anestesi" @checked(in_array('persetujuan_anestesi', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('cardiologi', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2. Pulmonology</td>
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('pulmonology', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3. Rehab Medik</td>
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('rehab_medik', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>4. Dietation</td>
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('dietation', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('surat_icu', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('kelengkapan_ranap', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('kelengkapan_xray', $asesmen->praOperatifPerawat->verifikasi_pasien))>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="persiapan_fisik[]" id="" value="puasa"
                                                            @checked(in_array('puasa', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('prothese_luar', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            value="prothese_dalam" @checked(in_array('prothese_dalam', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="persiapan_fisik[]" id="" value="perhiasan"
                                                            @checked(in_array('perhiasan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="persiapan_fisik[]" id="" value="kulit_cukur"
                                                            @checked(in_array('kulit_cukur', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="persiapan_fisik[]" id="" value="clysma"
                                                            @checked(in_array('clysma', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="persiapan_fisik[]" id=""
                                                            value="persediaan_darah" @checked(in_array('persediaan_darah', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="persiapan_fisik[]" id=""
                                                            value="alat_bantu_disimpan" @checked(in_array('alat_bantu_disimpan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="persiapan_fisik[]" id=""
                                                            value="obat_disertakan" @checked(in_array('obat_disertakan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('obat_terakhir', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="middle">
                                                        <input type="checkbox" class="form-check-input"
                                                            ...
                                                            @checked(in_array('vaskulerakses', $asesmen->praOperatifPerawat->persiapan_fisik_pasien))>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <div class="form-group">
                                            <label for="perawat_penerima" style="min-width: 200px;">Perawat
                                                Penerima</label>
                                            <select name="perawat_penerima" id="perawat_penerima"
                                                class="form-select select2">
                                                <option value="">--Pilih Perawat--</option>
                                                @foreach ($perawat as $prwt)
                                                    <option value="{{ $prwt->kd_karyawan }}"
                                                        @selected($asesmen->praOperatifPerawat->id_perawat_penerima == $prwt->kd_karyawan)>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="tgl_periksa"
                                                id="tgl_diperiksa"
                                                value="{{ date('Y-m-d', strtotime($asesmen->praOperatifPerawat->tgl_periksa)) }}">
                                            <input type="time" class="form-control" name="jam_periksa"
                                                id="jam_diperiksa"
                                                value="{{ date('H:i', strtotime($asesmen->praOperatifPerawat->jam_periksa)) }}">
                                        </div>
