                                ...
                                <div class="section-separator" id="rencanaTindakan">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="skala_nyeri" id="skala_nyeri" min="0"
                                            ...
                                            value="{{ $asesmen->praOperatifPerawat->skala_nyeri }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tempat_bedah" id="tempat_bedah"
                                            ...
                                            value="{{ $asesmen->praOperatifPerawat->tempat_bedah }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($asesmen->praOperatifPerawat->hasil_lab as $lab)
                                            <div class="">
                                                <input type="checkbox" name="hasil_lab[]" id="hb"
                                                    value="{{ $lab }}" checked disabled>
                                            ...
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]"
                                                        ...
                                                        @checked(in_array('identitas_pasien', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]"
                                                        ...
                                                        @checked(in_array('periksa_gelang', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]"
                                                        ...
                                                        @checked(in_array('lokasi_pembedahan', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]"
                                                        ...
                                                        @checked(in_array('persetujuan_operasi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]"
                                                        ...
                                                        @checked(in_array('persetujuan_anestesi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]"
                                                        ...
                                                        @checked(in_array('kelengkapan_ranap', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]"
                                                        ...
                                                        @checked(in_array('kelengkapan_xray', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('puasa', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('prothese_luar', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('prothese_dalam', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('perhiasan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('kulit_cukur', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('clysma', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('persediaan_darah', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        value="alat_bantu_disimpan" @checked(in_array('alat_bantu_disimpan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('obat_disertakan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('obat_terakhir', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input"
                                                        ...
                                                        @checked(in_array('vaskulerakses', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
