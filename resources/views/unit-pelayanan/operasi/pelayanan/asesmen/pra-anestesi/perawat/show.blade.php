...
@push('css')
    <style>
        .select2-container .select2-dropdown {
            z-index: 2000;
            /* Sesuaikan dengan z-index modal Bootstrap */
        }
    </style>
@endpush
        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Rincian Asesmen Pra Operatif Perawat',
                    'description' =>
                        'Rincian data asesmen pra operatif perawat dengan mengisi formulir di bawah ini.',
                ])
                ...
                <div class="section-separator mt-0" id="dataMasuk">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control me-3"
                            value="{{ date('Y-m-d', strtotime($asesmen->praOperatifPerawat->tgl_op)) }}" disabled>
                        <input type="time" name="jam_masuk" id="jam_masuk" class="form-control"
                            value="{{ date('H:i', strtotime($asesmen->praOperatifPerawat->jam_op)) }}" disabled>
                    </div>
                </div>
                ...
                <div class="section-separator" id="rencanaTindakan">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="skala_nyeri" id="skala_nyeri" min="0" max="10"
                            class="form-control" value="{{ $asesmen->praOperatifPerawat->skala_nyeri }}" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-control"
                            value="{{ $asesmen->praOperatifPerawat->tinggi_badan }}" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($asesmen->praOperatifPerawat->hasil_lab as $lab)
                            <div class="">
                                <input type="checkbox" name="hasil_lab[]" id="hb" value="{{ $lab }}"
                                    checked disabled>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="hasil_lab_lainnya" id="hasil_lab_lainnya"
                            value="{{ $asesmen->praOperatifPerawat->hasil_lab_lainnya }}" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="haid" style="min-width: 200px;">Pasien Sedang Haid /
                            Menstruasi</label>
                ...
                <div class="section-separator mb-0" id="rencanaTindakan">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="identitas_pasien" @checked(in_array('identitas_pasien', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="periksa_gelang" @checked(in_array('periksa_gelang', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="ipri" @checked(in_array('ipri', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="ipri_ruangan" @checked(in_array('ipri_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="lokasi_pembedahan" @checked(in_array('lokasi_pembedahan', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="lokasi_pembedahan_ruangan" @checked(in_array('lokasi_pembedahan_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? []))
                                        disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="persetujuan_operasi" @checked(in_array('persetujuan_operasi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="persetujuan_operasi_ruangan" @checked(in_array('persetujuan_operasi_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? []))
                                        disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="persetujuan_anestesi" @checked(in_array('persetujuan_anestesi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="persetujuan_anestesi_ruangan" @checked(in_array('persetujuan_anestesi_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? []))
                                        disabled>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="cardiologi" @checked(in_array('cardiologi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="cardiologi_ruangan" @checked(in_array('cardiologi_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                <td>2. Pulmonology</td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="pulmonology" @checked(in_array('pulmonology', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="pulmonology_ruangan" @checked(in_array('pulmonology_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                <td>3. Rehab Medik</td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="rehab_medik" @checked(in_array('rehab_medik', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="rehab_medik_ruangan" @checked(in_array('rehab_medik_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                <td>4. Dietation</td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="dietation" @checked(in_array('dietation', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="dietation_ruangan" @checked(in_array('dietation_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="surat_icu" @checked(in_array('surat_icu', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="surat_icu_ruangan" @checked(in_array('surat_icu_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="kelengkapan_ranap" @checked(in_array('kelengkapan_ranap', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                                        id="" value="kelengkapan_ranap_ruangan" @checked(in_array('kelengkapan_ranap_ruangan', $asesmen->praOperatifPerawat->verifikasi_pasien_ruangan ?? []))
                                        disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id=""
                                        value="kelengkapan_xray" @checked(in_array('kelengkapan_xray', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="verifikasi_ruangan[]"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                                        id="" value="puasa_ruangan" @checked(in_array('puasa_ruangan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="prothese_luar" @checked(in_array('prothese_luar', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                            ...
                            <tr>
                                <td>Menggunakan prothese dalam (pacemaker, implant, prothese, panggul, VP
                                    shunt)</td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="prothese_dalam" @checked(in_array('prothese_dalam', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="perhiasan" @checked(in_array('perhiasan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                                        id="" value="perhiasan_ruangan" @checked(in_array('perhiasan_ruangan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="kulit_cukur" @checked(in_array('kulit_cukur', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                                        id="" value="kulit_cukur_ruangan" @checked(in_array('kulit_cukur_ruangan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="clysma" @checked(in_array('clysma', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                                        id="" value="clysma_ruangan" @checked(in_array('clysma_ruangan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien_ruangan ?? [])) disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="persediaan_darah" @checked(in_array('persediaan_darah', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="alat_bantu_disimpan" @checked(in_array('alat_bantu_disimpan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                                        id="" value="alat_bantu_disimpan_ruangan" @checked(in_array('alat_bantu_disimpan_ruangan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien_ruangan ?? []))
                                        disabled>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="obat_disertakan" @checked(in_array('obat_disertakan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="obat_terakhir" @checked(in_array('obat_terakhir', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                            ...
                            <tr>
                                ...
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]"
                                        id="" value="vaskulerakses" @checked(in_array('vaskulerakses', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                </td>
                                <td align="middle">
                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik_ruangan[]"
                    ...
                    <div class="form-group">
                        ...
                        <select name="perawat_penerima" id="perawat_penerima" class="form-select select2" disabled>
                            ...
                            @foreach ($perawat as $prwt)
                                <option value="{{ $prwt->kd_karyawan }}" @selected($asesmen->praOperatifPerawat->id_perawat_penerima == $prwt->kd_karyawan)>
                    ...
                    <div class="form-group">
                        <label for="site_marking" style="min-width: 200px;">Site Marking
                            (Terlampir)</label>
