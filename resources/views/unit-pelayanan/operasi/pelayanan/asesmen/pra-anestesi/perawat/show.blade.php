                            ...
                            <div>
                                ...
                                <div class="section-separator" id="dataMasuk">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control me-3" value="{{ date('Y-m-d', strtotime($asesmen->praOperatifPerawat->tgl_op)) }}" disabled>
                                        <input type="time" name="jam_masuk" id="jam_masuk" class="form-control" value="{{ date('H:i', strtotime($asesmen->praOperatifPerawat->jam_op)) }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="rencanaTindakan">
                                    ...
                                    <div class="form-group align-items-center">
                                        ...
                                        <div class="me-4">
                                            ...
                                            <input type="number" name="sistole" id="sistole" class="form-control" value="{{ $asesmen->praOperatifPerawat->sistole }}" disabled>
                                        </div>

                                        <div class="">
                                            <label for="diastole" class="form-label">Diastole</label>
                                            <input type="number" name="diastole" id="diastole" class="form-control" value="{{ $asesmen->praOperatifPerawat->diastole }}" disabled>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="nadi" style="min-width: 200px;">Nadi (Per Menit)</label>
                                        <input type="number" name="nadi" id="nadi" class="form-control" value="{{ $asesmen->praOperatifPerawat->nadi }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="nafas" style="min-width: 200px;">Nafas (Per Menit)</label>
                                        <input type="number" name="nafas" id="nafas" class="form-control" value="{{ $asesmen->praOperatifPerawat->nafas }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="suhu" style="min-width: 200px;">Suhu (C)</label>
                                        <input type="number" name="suhu" id="suhu" class="form-control" value="{{ $asesmen->praOperatifPerawat->suhu }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="skala_nyeri" style="min-width: 200px;">Nilai Skala Nyeri VAS</label>
                                        <input type="number" name="skala_nyeri" id="skala_nyeri" min="0" max="10" class="form-control" value="{{ $asesmen->praOperatifPerawat->skala_nyeri }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="tinggi_badan" style="min-width: 200px;">Tinggi Badan (Cm)</label>
                                        <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-control" value="{{ $asesmen->praOperatifPerawat->tinggi_badan }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="berat_badan" style="min-width: 200px;">Berat Badan (Kg)</label>
                                        <input type="number" name="berat_badan" id="berat_badan" class="form-control" value="{{ $asesmen->praOperatifPerawat->berat_badan }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="imt" style="min-width: 200px;">Indeks Masa Tubuh (IMT)</label>
                                        <input type="number" name="imt" id="imt" class="form-control" value="{{ $asesmen->praOperatifPerawat->imt }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="lpt" style="min-width: 200px;">Luas Permukaan Tubuh (LPT)</label>
                                        <input type="number" name="lpt" id="lpt" class="form-control" value="{{ $asesmen->praOperatifPerawat->lpt }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="status_mental" style="min-width: 200px;">Status Mental</label>
                                        <select name="status_mental" id="status_mental" class="form-select" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_bedah" id="tgl_bedah" class="form-control me-3" value="{{ date('Y-m-d', strtotime($asesmen->praOperatifPerawat->tgl_bedah)) }}" disabled>
                                        <input type="text" name="tempat_bedah" id="tempat_bedah" placeholder="Jelaskan" class="form-control" value="{{ $asesmen->praOperatifPerawat->tempat_bedah }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($asesmen->praOperatifPerawat->hasil_lab as $lab)
                                            <div class="">
                                                <input type="checkbox" name="hasil_lab[]" id="hb" value="{{ $lab }}" checked disabled>
                                                <label for="hb">{{ $lab }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="hasil_lab_lainnya" id="hasil_lab_lainnya" value="{{ $asesmen->praOperatifPerawat->hasil_lab_lainnya }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="batuk" style="min-width: 200px;">Batuk / Flu / Demam</label>
                                        <select name="batuk" id="batuk" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="haid" id="haid" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                ...
                                <div class="section-separator" id="rencanaTindakan">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="identitas_pasien" @checked(in_array('identitas_pasien', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Periksa gelang identitas / gelang operasi / gelang alergi</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="periksa_gelang" @checked(in_array('periksa_gelang', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>IPRI dan surat pengantar rawat</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="ipri" @checked(in_array('ipri', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Jenis dan lokasi pembedahan dipastikan bersama pasien</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="lokasi_pembedahan" @checked(in_array('lokasi_pembedahan', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Periksa kelengkapan persetujuan pembedahan surat ijin operasi</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="persetujuan_operasi" @checked(in_array('persetujuan_operasi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Periksa kelengkapan persetujuan anestesi</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="persetujuan_anestesi" @checked(in_array('persetujuan_anestesi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>1. Cardiologi</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="cardiologi" @checked(in_array('cardiologi', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2. Pulmonology</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="pulmonology" @checked(in_array('pulmonology', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>3. Rehab Medik</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="rehab_medik" @checked(in_array('rehab_medik', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>4. Dietation</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="dietation" @checked(in_array('dietation', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Surat ketersediaan ICU bila dibutuhkan</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="surat_icu" @checked(in_array('surat_icu', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Periksa kelengkapan status rawat inap / rawat jalan</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="kelengkapan_ranap" @checked(in_array('kelengkapan_ranap', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Periksa kelengkapan X-ray / CT-Scan / MRI / EKG / Angiografi / Echo</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="verifikasi[]" id="" value="kelengkapan_xray" @checked(in_array('kelengkapan_xray', $asesmen->praOperatifPerawat->verifikasi_pasien)) disabled>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="puasa" @checked(in_array('puasa', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Prothese luar dilepaskan (gigi palsu, lensa kontak)</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="prothese_luar" @checked(in_array('prothese_luar', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Menggunakan prothese dalam (pacemaker, implant, prothese, panggul, VP shunt)</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="prothese_dalam" @checked(in_array('prothese_dalam', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Penjepit rambut / cat kuku / perhiasan dilepaskan</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="perhiasan" @checked(in_array('perhiasan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Persiapan kulit / cukur</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="kulit_cukur" @checked(in_array('kulit_cukur', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Pengosongan kandung kemih / clysma</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="clysma" @checked(in_array('clysma', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Memastikan persediaan darah</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="persediaan_darah" @checked(in_array('persediaan_darah', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Alat bantu (kacamata, alat bantu dengar) disimpan</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="alat_bantu_disimpan" @checked(in_array('alat_bantu_disimpan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Obat yang disertakan</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="obat_disertakan" @checked(in_array('obat_disertakan', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Obat terakhir yang diberikan</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="obat_terakhir" @checked(in_array('obat_terakhir', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Vaskulerakses (cimino), dll</td>
                                                <td align="middle">
                                                    <input type="checkbox" class="form-check-input" name="persiapan_fisik[]" id="" value="vaskulerakses" @checked(in_array('vaskulerakses', $asesmen->praOperatifPerawat->persiapan_fisik_pasien)) disabled>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="perawat_penerima" id="perawat_penerima" class="form-select select2" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tgl_periksa" id="tgl_diperiksa" value="{{ date('Y-m-d', strtotime($asesmen->praOperatifPerawat->tgl_periksa)) }}" disabled>
                                        <input type="time" class="form-control" name="jam_periksa" id="jam_diperiksa" value="{{ date('H:i', strtotime($asesmen->praOperatifPerawat->jam_periksa)) }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="site_marking" id="site_marking" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="penjelasan_prosedur" id="penjelasan_prosedur" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
