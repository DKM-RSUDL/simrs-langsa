                            ...
                            <div>
                                ...
                                <div class="section-separator" id="dataMasuk">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control me-3" value="{{ date('Y-m-d', strtotime($asesmen->edukasiAnestesi->tgl_op)) }}" disabled>
                                        <input type="time" name="jam_masuk" id="jam_masuk" class="form-control"value="{{ date('H:i', strtotime($asesmen->edukasiAnestesi->jam_op)) }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="persetujuanPasien">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_keluarga" id="nama_keluarga" value="{{ $asesmen->edukasiAnestesi->nama_keluarga }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="usia_keluarga" style="min-width: 200px;">Usia (tahun)</label>
                                        <input type="number" class="form-control" name="usia_keluarga" id="usia_keluarga" value="{{ $asesmen->edukasiAnestesi->usia_keluarga }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="no_telepon" id="no_telepon" value="{{ $asesmen->edukasiAnestesi->no_telepon }}" disabled>
                                    </div>

                                    <div class="form-group">
                                        <label for="dokter_edukasi" style="max-width: 200px;">Dokter Yang Memberikan Edukasi</label>
                                        <select name="dokter_edukasi" id="dokter_edukasi" class="form-select select2" disabled>
                                            <option value="">--Pilih--</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tgl_dilakukan" id="tgl_dilakukan" value="{{ date('Y-m-d', strtotime($asesmen->edukasiAnestesi->tgl_dilakukan)) }}" disabled>
                                        <input type="time" class="form-control" name="jam_dilakukan" id="jam_dilakukan" value="{{ date('H:i', strtotime($asesmen->edukasiAnestesi->jam_dilakukan)) }}" disabled>
                                    </div>
