                            ...
                            <div>
                                ...
                                <div class="section-separator" id="dataMasuk">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_masuk" id="tgl_masuk" class="form-control me-3"
                                            value="{{ date('Y-m-d', strtotime($asesmen->edukasiAnestesi->tgl_op)) }}"
                                            disabled>
                                        <input type="time" name="jam_masuk" id="jam_masuk"
                                            class="form-control"value="{{ date('H:i', strtotime($asesmen->edukasiAnestesi->jam_op)) }}"
                                            disabled>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="jenisAnestesi">
                                    ...
                                    <div class="form-group">
                                        <label for="jenis_anestesi" style="min-width: 200px;">Jenis Anestesi Yang
                                            Digunakan</label>
                                        <select name="jenis_anestesi" id="jenis_anestesi" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                            @foreach ($jenisAnastesi as $item)
                                                <option value="{{ $item->kd_jenis_anastesi }}" @selected($item->kd_jenis_anastesi == $asesmen->edukasiAnestesi->jenis_anestesi)>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    Pasien tidak sadar sepenuhnya selama operasi dan memerlukan alat bantu
                                                    napas.
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    Membius sebagian tubuh, pasien tetap sadar tetapi tidak merasakan nyeri
                                                    di area tertentu.
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    Anestesi regional yang diberikan di sekitar saraf tertentu untuk membius
                                                    bagian tubuh tertentu tanpa mempengaruhi kesadaran pasien.
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    Membius area kecil tanpa mempengaruhi kesadaran pasien, misalnya untuk
                                                    operasi kecil.
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="section-separator" id="edukasiPasien">
                                    ...
                                    <div class="form-group">
                                        <label for="edukasi_prosedur" style="min-width: 200px;">Edukasi tentang prosedur
                                            operasi</label>
                                        <select name="edukasi_prosedur" id="edukasi_prosedur" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                ...
                                <div class="section-separator" id="persetujuanPasien">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="pemahaman_pasien" id="pemahaman_pasien" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="informed_consent" id="informed_consent" class="form-select" disabled>
                                            <option value="">--Pilih--</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_keluarga" id="nama_keluarga"
                                            value="{{ $asesmen->edukasiAnestesi->nama_keluarga }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="usia_keluarga" id="usia_keluarga"
                                            value="{{ $asesmen->edukasiAnestesi->usia_keluarga }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="no_telepon" id="no_telepon"
                                            value="{{ $asesmen->edukasiAnestesi->no_telepon }}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="dokter_edukasi" id="dokter_edukasi" class="form-select select2"
                                            ...
                                            @foreach ($dokterAnastesi as $item)
                                                <option value="{{ $item->kd_dokter }}" @selected($asesmen->edukasiAnestesi->dokter_edukasi == $item->kd_dokter)>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tgl_dilakukan"
                                            id="tgl_dilakukan"
                                            value="{{ date('Y-m-d', strtotime($asesmen->edukasiAnestesi->tgl_dilakukan)) }}"
                                            disabled>
                                        <input type="time" class="form-control" name="jam_dilakukan"
                                            id="jam_dilakukan"
                                            value="{{ date('H:i', strtotime($asesmen->edukasiAnestesi->jam_dilakukan)) }}"
                                            disabled>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="file_persetujuan" style="min-width: 200px;">HardCopy Form
                                            Persetujuan</label>
                                        <a href="{{ asset('storage/' . $asesmen->edukasiAnestesi->file_persetujuan) }}"
                                ...
                                <div class="section-separator" id="persetujuanPasien">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="pertanyaan_pasien" id="pertanyaan_pasien" class="form-control" disabled>{{ $asesmen->edukasiAnestesi->pertanyaan_pasien }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="rekomendasi_dokter" style="max-width: 200px;">Rekomendasi Tambahan
                                            Dari Dokter</label>
                                        <textarea name="rekomendasi_dokter" id="rekomendasi_dokter" class="form-control" disabled>{{ $asesmen->edukasiAnestesi->rekomendasi_dokter }}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="lainnya" style="min-width: 200px;">Lain-Lain</label>
                                        <textarea name="lainnya" id="lainnya" class="form-control" disabled>{{ $asesmen->edukasiAnestesi->lainnya }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
