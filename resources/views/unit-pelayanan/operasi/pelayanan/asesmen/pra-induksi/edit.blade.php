        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Edit Perbarui Pra Induksi',
                    'description' => 'Perbarui data pra induksi pasien dengan mengisi formulir di bawah ini.',
                ])
                <form method="POST"
                    ...
                    <div>
                        ...
                        <div class="section-separator" id="praInduksi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="diagnosis" id="diagnosis"
                                    value="{{ $okPraInduksi->diagnosis ?? '' }}" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tindakan" id="tindakan"
                                    value="{{ $okPraInduksi->tindakan ?? '' }}" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="spesialis_anestesi" id="spesialis_anestesi"
                                    value="{{ $okPraInduksi->spesialis_anestesi ?? '' }}" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Penata Anestesi</label>
                                <input type="text" name="penata_anestesi" id="penata_anestesi"
                                    value="{{ $okPraInduksi->penata_anestesi ?? '' }}" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="spesialis_bedah" id="spesialis_bedah"
                                    value="{{ $okPraInduksi->spesialis_bedah ?? '' }}" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="rencanaAnestesi">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ras_tingkat_anestesi" id="tingkat_anestesi" class="form-control">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->ras_tingkat_anestesi ? 'selected' : '' }}>pilih</option>
                                    <option value="Moderat"
                                        {{ $okPraInduksi->ras_tingkat_anestesi == 'Moderat' ? 'selected' : '' }}>Moderat
                                    </option>
                                    <option value="Dalam"
                                        {{ $okPraInduksi->ras_tingkat_anestesi == 'Dalam' ? 'selected' : '' }}>Dalam
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="ras_jenis_sedasi" id="jenis_sedasi" class="form-control">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->ras_jenis_sedasi ? 'selected' : '' }}>pilih</option>
                                    <option value="Oral"
                                        {{ $okPraInduksi->ras_jenis_sedasi == 'Oral' ? 'selected' : '' }}>Oral</option>
                                    <option value="IM" {{ $okPraInduksi->ras_jenis_sedasi == 'IM' ? 'selected' : '' }}>
                                        IM</option>
                                    <option value="IV" {{ $okPraInduksi->ras_jenis_sedasi == 'IV' ? 'selected' : '' }}>
                                        IV</option>
                                    <option value="Rektal"
                                        {{ $okPraInduksi->ras_jenis_sedasi == 'Rektal' ? 'selected' : '' }}>Rektal</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="ras_analgesia_pasca" id="analgesia_pasca" class="form-control">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->ras_analgesia_pasca ? 'selected' : '' }}>pilih</option>
                                    <option value="Oral"
                                        {{ $okPraInduksi->ras_analgesia_pasca == 'Oral' ? 'selected' : '' }}>Oral</option>
                                    <option value="IM"
                                        {{ $okPraInduksi->ras_analgesia_pasca == 'IM' ? 'selected' : '' }}>IM</option>
                                    <option value="IV"
                                        {{ $okPraInduksi->ras_analgesia_pasca == 'IV' ? 'selected' : '' }}>IV</option>
                                    <option value="Rektal"
                                        {{ $okPraInduksi->ras_analgesia_pasca == 'Rektal' ? 'selected' : '' }}>Rektal
                                    </option>
                                    <option value="Tidak Diberikan"
                                        {{ $okPraInduksi->ras_analgesia_pasca == 'Tidak Diberikan' ? 'selected' : '' }}>
                                        Tidak Diberikan</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ras_obat_digunakan" id="obat_digunakan"
                                    value="{{ $okPraInduksi->ras_obat_digunakan ?? '' }}" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="evaluasiPraAnestesi">
                            ...
                            <div class="form-group">
                                ...
                                <select name="respirasi" class="form-control">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiEpas->respirasi ? 'selected' : '' }}>pilih</option>
                                    <option value="Spontan"
                                        {{ $okPraInduksi->okPraInduksiEpas->respirasi == 'Spontan' ? 'selected' : '' }}>
                                        Spontan</option>
                                    <option value="Assisted"
                                        {{ $okPraInduksi->okPraInduksiEpas->respirasi == 'Assisted' ? 'selected' : '' }}>
                                        Assisted</option>
                                    <option value="Controlled"
                                        {{ $okPraInduksi->okPraInduksiEpas->respirasi == 'Controlled' ? 'selected' : '' }}>
                                        Controlled</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="avpu">
                                    <option value=""
                                        {{ !isset($okPraInduksi->okPraInduksiEpas->avpu) ? 'selected' : '' }} disabled>
                                        pilih</option>
                                    <option value="0"
                                        {{ $okPraInduksi->okPraInduksiEpas->avpu == '0' ? 'selected' : '' }}>Sadar
                                        Baik/Alert : 0</option>
                                    <option value="1"
                                        {{ $okPraInduksi->okPraInduksiEpas->avpu == '1' ? 'selected' : '' }}>Berespon
                                        dengan kata-kata/Voice: 1</option>
                                    <option value="2"
                                        {{ $okPraInduksi->okPraInduksiEpas->avpu == '2' ? 'selected' : '' }}>Hanya berespon
                                        jika dirangsang nyeri/pain: 2</option>
                                    <option value="3"
                                        {{ $okPraInduksi->okPraInduksiEpas->avpu == '3' ? 'selected' : '' }}>Pasien tidak
                                        sadar/unresponsive: 3</option>
                                    <option value="4"
                                        {{ $okPraInduksi->okPraInduksiEpas->avpu == '4' ? 'selected' : '' }}>Gelisah atau
                                        bingung: 4</option>
                                    <option value="5"
                                        {{ $okPraInduksi->okPraInduksiEpas->avpu == '5' ? 'selected' : '' }}>Acute
                                        Confusional States: 5</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_fisik_asa" class="form-control">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiEpas->status_fisik_asa ? 'selected' : '' }}>pilih
                                    </option>
                                    <option value="I"
                                        {{ $okPraInduksi->okPraInduksiEpas->status_fisik_asa == 'I' ? 'selected' : '' }}>I
                                    </option>
                                    <option value="II"
                                        {{ $okPraInduksi->okPraInduksiEpas->status_fisik_asa == 'II' ? 'selected' : '' }}>
                                        II</option>
                                    <option value="III"
                                        {{ $okPraInduksi->okPraInduksiEpas->status_fisik_asa == 'III' ? 'selected' : '' }}>
                                        III</option>
                                    <option value="IV"
                                        {{ $okPraInduksi->okPraInduksiEpas->status_fisik_asa == 'IV' ? 'selected' : '' }}>
                                        IV</option>
                                    <option value="V"
                                        {{ $okPraInduksi->okPraInduksiEpas->status_fisik_asa == 'V' ? 'selected' : '' }}>V
                                    </option>
                                    <option value="VI"
                                        {{ $okPraInduksi->okPraInduksiEpas->status_fisik_asa == 'VI' ? 'selected' : '' }}>
                                        VI</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="dukungan_pemberian_oksigen" class="form-control">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiEpas->dukungan_pemberian_oksigen ? 'selected' : '' }}>
                                        pilih</option>
                                    <option value="1"
                                        {{ $okPraInduksi->okPraInduksiEpas->dukungan_pemberian_oksigen == '1' ? 'selected' : '' }}>
                                        Udara Bebas</option>
                                    <option value="2"
                                        {{ $okPraInduksi->okPraInduksiEpas->dukungan_pemberian_oksigen == '2' ? 'selected' : '' }}>
                                        Kanul Nasal</option>
                                    <option value="3"
                                        {{ $okPraInduksi->okPraInduksiEpas->dukungan_pemberian_oksigen == '3' ? 'selected' : '' }}>
                                        Simple Mark</option>
                                    <option value="4"
                                        {{ $okPraInduksi->okPraInduksiEpas->dukungan_pemberian_oksigen == '4' ? 'selected' : '' }}>
                                        Rebreathing Mark</option>
                                    <option value="5"
                                        {{ $okPraInduksi->okPraInduksiEpas->dukungan_pemberian_oksigen == '5' ? 'selected' : '' }}>
                                        No-Rebreathing Mark</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="antropometri_imt" class="form-control bg-light"
                                    value="{{ $okPraInduksi->okPraInduksiEpas->antropometri_imt ?? '' }}" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="antropometri_lpt" class="form-control bg-light"
                                    value="{{ $okPraInduksi->okPraInduksiEpas->antropometri_lpt ?? '' }}" readonly>
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Obat Dan Pemantauan Selama Prosedur Dengan Anestesi Dan
                                    Sedasi</label>
                        ...
                        <div class="section-separator" id="pemantauanAnestesiPAS">
                            ...
                            <form id="monitoringFormPAS" class="pas-form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="time" name="waktu_pemantauan_pas" id="waktu_pemantauan_pas"
                                                class="form-control pas-input">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label style="min-width: 200px;">Hal Penting Yang Terjadi Selama Anestesi Dan
                                    Sedasi :</label>
                                <textarea name="hal_penting" id="hal_penting_pas" class="form-control pas-textarea" rows="3"
                            ...
                            <div class="form-group">
                                ...
                                <select name="kedalaman_anestesi" id="kedalaman_anestesi_pas"
                                    ...
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiPsas->kedalaman_anestesi ? 'selected' : '' }}>pilih
                                    </option>
                                    <option value="Tak Tersedia"
                                        {{ $okPraInduksi->okPraInduksiPsas->kedalaman_anestesi == 'Tak Tersedia' ? 'selected' : '' }}>
                                        Tak Tersedia (typical response/ cooperation for this patient)</option>
                                    <option value="Ringan"
                                        {{ $okPraInduksi->okPraInduksiPsas->kedalaman_anestesi == 'Ringan' ? 'selected' : '' }}>
                                        Ringan (anxiolysis)</option>
                                    <option value="Sedang"
                                        {{ $okPraInduksi->okPraInduksiPsas->kedalaman_anestesi == 'Sedang' ? 'selected' : '' }}>
                                        Sedang (purpaseful response to verbal commands/ light toctie secsation)</option>
                                    <option value="Dalam"
                                        {{ $okPraInduksi->okPraInduksiPsas->kedalaman_anestesi == 'Dalam' ? 'selected' : '' }}>
                                        Dalam (purpaseful response after repeated verbal/ painful stumutation)</option>
                                    <option value="Anastesi Umum"
                                        {{ $okPraInduksi->okPraInduksiPsas->kedalaman_anestesi == 'Anastesi Umum' ? 'selected' : '' }}>
                                        Anastesi Umum (Unarousable)</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Respon Terhadap Anestesi Dan Sedasi</label>
                                <select name="respon_anestesi" id="respon_anestesi_pas" class="form-control pas-select">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiPsas->respon_anestesi ? 'selected' : '' }}>pilih
                                    </option>
                                    <option value="Sangat baik"
                                        {{ $okPraInduksi->okPraInduksiPsas->respon_anestesi == 'Sangat baik' ? 'selected' : '' }}>
                                        Sangat baik, tenang dan kooperatif</option>
                                    <option value="Baik"
                                        {{ $okPraInduksi->okPraInduksiPsas->respon_anestesi == 'Baik' ? 'selected' : '' }}>
                                        Baik (kadang-kadang mengigil/ rasa penuruhi nafas berkurang)</option>
                                    <option value="Cukup"
                                        {{ $okPraInduksi->okPraInduksiPsas->respon_anestesi == 'Cukup' ? 'selected' : '' }}>
                                        Cukup (meringis/menangis dan prosedur terganggu/tertunda)</option>
                                    <option value="Kurang"
                                        {{ $okPraInduksi->okPraInduksiPsas->respon_anestesi == 'Kurang' ? 'selected' : '' }}>
                                        Kurang (agitasi/stres yang menganggu prosedur)</option>
                                    <option value="Jelek"
                                        {{ $okPraInduksi->okPraInduksiPsas->respon_anestesi == 'Jelek' ? 'selected' : '' }}>
                                        Jelek (gerakan aktif, mengigil, menangis, prosedur tertunda)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="catatanKamarPemulihanCKP">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <input type="time" name="jam_masuk_pemulihan_ckp" id="jam_masuk_pemulihan_ckp"
                                            class="form-control ckp-input"
                            ...
                            <div class="form-group">
                                ...
                                <select name="jalan_nafas_ckp" id="jalan_nafas_ckp" class="form-control ckp-select">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiCtkp->jalan_nafas_ckp ? 'selected' : '' }}>pilih
                                    </option>
                                    <option value="Spontan"
                                        {{ $okPraInduksi->okPraInduksiCtkp->jalan_nafas_ckp == 'Spontan' ? 'selected' : '' }}>
                                        Spontan</option>
                                    <option value="Dibantu"
                                        {{ $okPraInduksi->okPraInduksiCtkp->jalan_nafas_ckp == 'Dibantu' ? 'selected' : '' }}>
                                        Dibantu</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="nafas_spontan_ckp" id="nafas_spontan_ckp" class="form-control ckp-select">
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiCtkp->nafas_spontan_ckp ? 'selected' : '' }}>pilih
                                    </option>
                                    <option value="Adekuat Bersuara"
                                        {{ $okPraInduksi->okPraInduksiCtkp->nafas_spontan_ckp == 'Adekuat Bersuara' ? 'selected' : '' }}>
                                        Adekuat Bersuara</option>
                                    <option value="Penyumbatan"
                                        {{ $okPraInduksi->okPraInduksiCtkp->nafas_spontan_ckp == 'Penyumbatan' ? 'selected' : '' }}>
                                        Penyumbatan</option>
                                    <option value="Membutuhkan Bantuan Alat"
                                        {{ $okPraInduksi->okPraInduksiCtkp->nafas_spontan_ckp == 'Membutuhkan Bantuan Alat' ? 'selected' : '' }}>
                                        Membutuhkan Bantuan Alat</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kesadaran_pemulihan_ckp" id="kesadaran_pemulihan_ckp"
                                    ...
                                    <option value="" disabled
                                        {{ !$okPraInduksi->okPraInduksiCtkp->kesadaran_pemulihan_ckp ? 'selected' : '' }}>
                                        pilih</option>
                                    <option value="Sadar Penuh"
                                        {{ $okPraInduksi->okPraInduksiCtkp->kesadaran_pemulihan_ckp == 'Sadar Penuh' ? 'selected' : '' }}>
                                        Sadar Penuh</option>
                                    <option value="Belum Sadar Penuh"
                                        {{ $okPraInduksi->okPraInduksiCtkp->kesadaran_pemulihan_ckp == 'Belum Sadar Penuh' ? 'selected' : '' }}>
                                        Belum Sadar Penuh</option>
                                    <option value="Tidur Dalam"
                                        {{ $okPraInduksi->okPraInduksiCtkp->kesadaran_pemulihan_ckp == 'Tidur Dalam' ? 'selected' : '' }}>
                                        Tidur Dalam</option>
                                    <option value="VAS"
                                        {{ $okPraInduksi->okPraInduksiCtkp->kesadaran_pemulihan_ckp == 'VAS' ? 'selected' : '' }}>
                                        VAS</option>
                                </select>
                            </div>
                            ...
                            <div id="observasiFormCKP" class="ckp-form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <input type="time" name="waktu_observasi_ckp" id="waktu_observasi_ckp"
                                                class="form-control ckp-input">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="tanda_vital_stabil_ckp" id="tanda_vital_stabil_ckp"
                                        class="form-control ckp-input" placeholder="nilai">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" id="jenisSkalaSelect" name="jenis_skala_nyeri">
                                    <option value=""
                                        {{ !isset($okPraInduksi->okPraInduksiCtkp->jenis_skala_nyeri) ? 'selected' : '' }}>
                                        Pilih</option>
                                    <option value="nrs"
                                        {{ $okPraInduksi->okPraInduksiCtkp->jenis_skala_nyeri == 'nrs' ? 'selected' : '' }}>
                                        Scale NRS, VAS, VRS</option>
                                    <option value="flacc"
                                        {{ $okPraInduksi->okPraInduksiCtkp->jenis_skala_nyeri == 'flacc' ? 'selected' : '' }}>
                                        Face, Legs, Activity, Cry, Consolability (FLACC)</option>
                                    <option value="cries"
                                        {{ $okPraInduksi->okPraInduksiCtkp->jenis_skala_nyeri == 'cries' ? 'selected' : '' }}>
                            ...
                            <input type="hidden" id="painScaleDataJSON" name="pain_scale_data_json"
                                value="{{ $okPraInduksi->okPraInduksiCtkp->pain_scale_data_json ?? '{}' }}">

                            <div id="selectedScaleInfo"
                                class="mt-3 {{ isset($okPraInduksi->okPraInduksiCtkp->jenis_skala_nyeri) ? '' : 'd-none' }}">
                                <button id="scaleInfoBtn" type="button" class="btn btn-info">
                                    <i class="fas fa-info-circle"></i> Edit Skala Nyeri
                                </button>
                            </div>

                            <div id="selectedScaleDisplay"
                                class="mt-3 {{ isset($okPraInduksi->okPraInduksiCtkp->jenis_skala_nyeri) ? '' : 'd-none' }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" name="skala_nyeri" id="skala_nyeri_main"
                                    value="{{ $okPraInduksi->okPraInduksiCtkp->nilai_skala_vas ?? 0 }}" min="0"
                                    max="10" readonly>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="lanjut_ruang" class="form-control">
                                    <option value="" disabled
                                        {{ !isset($okPraInduksi->okPraInduksiCtkp->lanjut_ruang) ? 'selected' : '' }}>
                                        pilih</option>
                                    <option value="ICU"
                                        {{ $okPraInduksi->okPraInduksiCtkp->lanjut_ruang == 'ICU' ? 'selected' : '' }}>ICU
                                    </option>
                                    <option value="PICU"
                                        {{ $okPraInduksi->okPraInduksiCtkp->lanjut_ruang == 'PICU' ? 'selected' : '' }}>
                                        PICU</option>
                                    <option value="NICU"
                                        {{ $okPraInduksi->okPraInduksiCtkp->lanjut_ruang == 'NICU' ? 'selected' : '' }}>
                                        NICU</option>
                                    <option value="Lanjutkan pulang"
                                        {{ $okPraInduksi->okPraInduksiCtkp->lanjut_ruang == 'Lanjutkan pulang' ? 'selected' : '' }}>
                                        Lanjutkan pulang</option>
                                    <option value="Bangsal"
                                        {{ $okPraInduksi->okPraInduksiCtkp->lanjut_ruang == 'Bangsal' ? 'selected' : '' }}>
                                        Bangsal</option>
                                </select>
                            </div>
                        ...
                        <div class="section-separator mb-0" id="instruksiPascaBedah">
                                ...
                                <select name="dokter_edukasi" id="dokter_edukasi" class="form-select select2">
                                    ...
                                    @foreach ($dokterAnastesi as $item)
                                        <option value="{{ $item->kd_dokter }}"
                                            {{ ($okPraInduksi->okPraInduksiIpb->dokter_edukasi ?? '') == $item->kd_dokter ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="lain_lain" class="form-control" rows="3" placeholder="Lain-lain">{{ $okPraInduksi->okPraInduksiIpb->lain_lain ?? '' }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($okPraInduksi->okPraInduksiIpb->hardcopyform) && $okPraInduksi->okPraInduksiIpb->hardcopyform)
                                    <div class="mt-2">
                                        ...
                                        <input type="hidden" name="hardcopyform_existing"
                                            value="{{ $okPraInduksi->okPraInduksiIpb->hardcopyform }}">
                                    </div>
                                @endif
                            </div>
                        </div>
