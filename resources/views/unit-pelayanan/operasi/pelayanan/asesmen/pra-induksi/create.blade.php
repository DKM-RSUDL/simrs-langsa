        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                <form method="POST"
                    ...
                    enctype="multipart/form-data" id="praInduksiForm">
                    @csrf
                    ...
                    <div>
                        <div class="section-separator mt-0" id="dataMasuk">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_masuk_pra_induksi" id="tgl_masuk" class="form-control me-3">
                        ...
                        <div class="section-separator" id="dataMasuk">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="spesialis_anestesi" id="spesialis_anestesi" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Penata Anestesi</label>
                                <input type="text" name="penata_anestesi" id="penata_anestesi" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Spesialis Bedah</label>
                                <input type="text" name="spesialis_bedah" id="spesialis_bedah" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="rencanaAnestesi">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="date" name="ras_tanggal" id="tanggal_rencana" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ras_obat_digunakan" id="obat_digunakan" class="form-control"
                                    placeholder="obat yang digunakan">
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="evaluasiPraAnestesi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="antropometri_imt" class="form-control bg-light" readonly>
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Luas Permukaan Tubuh (LPT)</label>
                                <input type="text" name="antropometri_lpt" class="form-control bg-light" readonly>
                            </div>
                        ...
                        <div class="section-separator" id="catatanKamarPemulihanCKP">
                            ...
                            <div id="observasiFormCKP" class="ckp-form">
                                ...
                                <div class="form-group">
                                    <label style="min-width: 200px;">Tek Darah (mmHg)</label>
                                    <div class="d-flex gap-2 w-100">
                                        <input type="number" name="sistole_ckp" id="sistole_ckp" class="form-control"
                                            placeholder="Sistole">
                                        <input type="number" name="diastole_ckp" id="diastole_ckp" class="form-control"
                                            placeholder="Diastole">
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" name="skala_nyeri" id="skala_nyeri_main"
                                    value="{{ old('skala_nyeri', 0) }}" min="0" max="10" readonly>
                            </div>
                        ...
                        <div class="section-separator mb-0" id="instruksiPascaBedah">
                                ...
                                <div class="obat-search-wrapper">
                                    <div class="input-group">
                                        <input type="text" class="form-control obat-search"
                                            data-target="selectedKesakitanId"
                                            data-dropdown="kesakitanList"
                                            data-clear="clearKesakitan"
                                            id="cariKesakitan"
                                            name="bila_kesakitan"
                                            placeholder="Ketik nama obat..."
                                            autocomplete="off">
                                        <button class="btn btn-outline-secondary obat-clear"
                                                type="button"
                                                id="clearKesakitan"
                                                data-input="cariKesakitan"
                                                data-hidden="selectedKesakitanId"
                                                style="display:none;">
                                            <i class="bi bi-x"></i>
                                        </button>
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="obat-search-wrapper">
                                    <div class="input-group">
                                        <input type="text" class="form-control obat-search"
                                            data-target="selectedMualId"
                                            data-dropdown="mualList"
                                            data-clear="clearMual"
                                            id="cariMual"
                                            name="bila_mual_muntah"
                                            placeholder="Ketik nama obat..."
                                            autocomplete="off">
                                        <button class="btn btn-outline-secondary obat-clear"
                                                type="button"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="obat-search-wrapper">
                                    <div class="input-group">
                                        <input type="text" class="form-control obat-search"
                                            data-target="selectedAntibiotikaId"
                                            data-dropdown="antibiotikaList"
                                        ...
                                        <button class="btn btn-outline-secondary obat-clear"
                                                type="button"
                                                id="clearAntibiotika"
                                                data-input="cariAntibiotika"
                                                data-hidden="selectedAntibiotikaId"
                                                style="display:none;">
                                            <i class="bi bi-x"></i>
                                        </button>
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="obat-search-wrapper">
                                    <div class="input-group">
                                        <input type="text" class="form-control obat-search"
                                            data-target="selectedObatLainId"
                                            data-dropdown="obatLainList"
                                        ...
                                        <button class="btn btn-outline-secondary obat-clear"
                                                type="button"
                                                id="clearObatLain"
                                                data-input="cariObatLain"
                                                data-hidden="selectedObatLainId"
                                                style="display:none;">
                                            <i class="bi bi-x"></i>
                                        </button>
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="obat-search-wrapper">
                                    <div class="input-group">
                                        <input type="text" class="form-control obat-search"
                                            data-target="selectedCairanId"
                                            data-dropdown="cairanList"
                                            data-clear="clearCairan"
                                            id="cariCairan"
                                            name="cairan_infus"
                                            placeholder="Ketik nama cairan..."
                                            autocomplete="off">
                                        <button class="btn btn-outline-secondary obat-clear"
                                                type="button"
                                                id="clearCairan"
                                                data-input="cariCairan"
                                                data-hidden="selectedCairanId"
                                                style="display:none;">
                                            <i class="bi bi-x"></i>
                                        </button>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="lain_lain" class="form-control" rows="3" placeholder="Lain-lain"></textarea>
                            </div>
