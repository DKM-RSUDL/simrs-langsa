                        ...
                        <div>
                            ...
                            <div class="section-separator" id="dataMasuk">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" name="jam_masuk" id="jam_masuk"
                                        value="{{ date('H:i', strtotime($okPraInduksi->jam_masuk)) }}"
                            ...
                            <div class="section-separator" id="praInduksi">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $okPraInduksi->diagnosis ?? '' }}" class="form-control"
                                        disabled>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Tindakan</label>
                                    <input type="text" value="{{ $okPraInduksi->tindakan ?? '' }}" class="form-control"
                                        disabled>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Spesialis Anestesi</label>
                                    <input type="text" value="{{ $okPraInduksi->spesialis_anestesi ?? '' }}"
                                        class="form-control" disabled>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Penata Anestesi</label>
                                    <input type="text" value="{{ $okPraInduksi->penata_anestesi ?? '' }}"
                                        class="form-control" disabled>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Spesialis Bedah</label>
                                    <input type="text" value="{{ $okPraInduksi->spesialis_bedah ?? '' }}"
                                        class="form-control" disabled>
                                </div>
                            </div>
                            ...
                            <div class="section-separator" id="rasTable">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $okPraInduksi->ras_tingkat_anestesi ?? '' }}"
                                        class="form-control" disabled>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Jenis Sedasi</label>
                                    <input type="text" value="{{ $okPraInduksi->ras_jenis_sedasi ?? '' }}"
                                        class="form-control" disabled>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Analgesia Pasca</label>
                                    <input type="text" value="{{ $okPraInduksi->ras_analgesia_pasca ?? '' }}"
                                        class="form-control" disabled>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Obat Digunakan</label>
                                    <input type="text" value="{{ $okPraInduksi->ras_obat_digunakan ?? '' }}"
                                        class="form-control" disabled>
                                </div>
                            </div>
                            ...
                            <div class="section-separator" id="evaluasiPraAnestesi">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ $okPraInduksi->okPraInduksiEpas->status_fisik_asa ?? '' }}"
                                        class="form-control" disabled>
                                </div>
                            ...
                            <div class="section-separator" id="pemantauanAnestesiPAS">
                                ...
                                <div class="table-responsive mb-4">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @php
                                            $jsonData =
                                            $okPraInduksi->okPraInduksiPsas->all_monitoring_data ??
                                            '[]';
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3"
                                        disabled>{{ $okPraInduksi->okPraInduksiPsas->hal_penting ?? '' }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Kedalaman Anestesi Dan Sedasi</label>
                                    <input type="text" class="form-control"
                                        value="{{ $okPraInduksi->okPraInduksiPsas->kedalaman_anestesi ?? '' }}"
                                        disabled>
                                </div>
                            ...
                            <div class="section-separator" id="catatanKamarPemulihanCKP">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ $okPraInduksi->okPraInduksiCtkp->jalan_nafas_ckp ?? '' }}"
                                        class="form-control" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        value="{{ $okPraInduksi->okPraInduksiCtkp->nafas_spontan_ckp ?? '' }}"
                                        class="form-control" disabled>
                                </div>
                                ...
                                <div class="section-separator mt-4">
                                    ...
                                    @if (isset($painScaleData) && is_array($painScaleData) &&
                                    isset($painScaleData['selectedScale']))
                                    <div class="form-group">
                                        <label style="min-width: 200px;">Skala yang Digunakan</label>
                                        <input type="text" class="form-control" value="@if ($painScaleData['selectedScale'] == 'nrs') Scale NRS, VAS, VRS
                                            @elseif($painScaleData['selectedScale'] == 'flacc') Face, Legs, Activity, Cry, Consolability (FLACC)
                                            @elseif($painScaleData['selectedScale'] == 'cries') Crying, Requires, Increased, Expression, Sleepless (CRIES)
                                            @endif" disabled>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $painScaleData['nrs']['nilai'] ?? '0' }}"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="p-2 rounded-3
                                                    @if(isset($painScaleData['nrs']['kategori']))
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tfoot class="table-light">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="p-2 rounded-3
                                                                    @if(isset($painScaleData['flacc']['kategori']))
                                                                        @if($painScaleData['flacc']['kategori'] == 'NYERI RINGAN')
                                                                            bg-success text-white
                                                                    ...
                                                                    @else
                                                                        bg-success text-white
                                                                    @endif">
                                                                    <strong>{{ $painScaleData['flacc']['kategori'] ??
                                                                        'NYERI RINGAN' }}</strong>
                                                                </div>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                Denyut jantung dan TD meningkata < 20% dari baseline
                                                                    @elseif($painScaleData['cries']['increased']==2)
                                                                    Denyut jantung dan TD meningkata> 20% dari baseline
                                                                    @endif
                                                                    @else
                                                                    -
                                                    ...
                                                    <tfoot class="table-light">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="p-2 rounded-3
                                            @if(isset($painScaleData['cries']['kategori']))
                                                @if($painScaleData['cries']['kategori'] == 'NYERI RINGAN')
                                                    bg-success text-white
                                            ...
                                            @else
                                                bg-success text-white
                                            @endif">
                                                                    <strong>{{ $painScaleData['cries']['kategori'] ??
                                                                        'NYERI RINGAN' }}</strong>
                                                                </div>
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="@if ($painScaleData['selectedScale'] == 'nrs') {{ $painScaleData['nrs']['nilai'] ?? '0' }}
                                       @elseif($painScaleData['selectedScale'] == 'flacc') {{ $painScaleData['flacc']['total'] ?? '0' }}
                                       @elseif($painScaleData['selectedScale'] == 'cries') {{ $painScaleData['cries']['total'] ?? '0' }}
                                       @endif" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $patientScoreData['bromage_data']['gerakan_penuh']['jam'] ?? '-' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['gerakan_penuh']['checked_15'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['gerakan_penuh']['checked_30'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['gerakan_penuh']['checked_45'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['gerakan_penuh']['checked_1'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['gerakan_penuh']['checked_2'] ? '✓' : '' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tak mampu ekstensi tungkai</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_ekstensi']['jam'] ?? '-' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_ekstensi']['checked_15'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_ekstensi']['checked_30'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_ekstensi']['checked_45'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_ekstensi']['checked_1'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_ekstensi']['checked_2'] ? '✓' : '' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tak mampu fleksi/lutut</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_fleksi']['jam'] ?? '-' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_fleksi']['checked_15'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_fleksi']['checked_30'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_fleksi']['checked_45'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_fleksi']['checked_1'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_fleksi']['checked_2'] ? '✓' : '' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tak mampu fleksi/pergerakan kaki</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_pergerakan']['jam'] ?? '-' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_pergerakan']['checked_15'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_pergerakan']['checked_30'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_pergerakan']['checked_45'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_pergerakan']['checked_1'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['tak_pergerakan']['checked_2'] ? '✓' : '' }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Jam Pindah Ruang Perawatan</td>
                                                                <td>{{ $patientScoreData['bromage_data']['jam_pindah']['jam'] ?? '-' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['jam_pindah']['checked_15'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['jam_pindah']['checked_30'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['jam_pindah']['checked_45'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['jam_pindah']['checked_1'] ? '✓' : '' }}</td>
                                                                <td>{{ $patientScoreData['bromage_data']['jam_pindah']['checked_2'] ? '✓' : '' }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="table-responsive mt-3">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                @if (isset($patientScoreData['aldrete_data']['interval_data']) && is_array($patientScoreData['aldrete_data']['interval_data']))
                                                                ...
                                                                @else
                                                                    <tr>
                                                                        <td>{{ $patientScoreData['aldrete_data']['interval_jam_1'] ?? '-' }}</td>
                                                                        <td>{{ $patientScoreData['aldrete_data']['skor_1'] ?? '-' }}</td>
                                                                        <td>{{ $patientScoreData['aldrete_data']['keterangan_1'] ?? '-' }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>{{ $patientScoreData['aldrete_data']['interval_jam_2'] ?? '-' }}</td>
                                                                        <td>{{ $patientScoreData['aldrete_data']['skor_2'] ?? '-' }}</td>
                                                                        <td>{{ $patientScoreData['aldrete_data']['keterangan_2'] ?? '-' }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>{{ $patientScoreData['aldrete_data']['interval_jam_3'] ?? '-' }}</td>
                                                                        <td>{{ $patientScoreData['aldrete_data']['skor_3'] ?? '-' }}</td>
                                                                        <td>{{ $patientScoreData['aldrete_data']['keterangan_3'] ?? '-' }}</td>
                                                                    </tr>
                                                                @endif
                                                            </tbody>
                                                        </table>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text">{{ $patientScoreData['padds_data']['padds_tanda_vital'] ?? '0' }}</span>
                                                                    <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text">{{ $patientScoreData['padds_data']['padds_aktivitas'] ?? '0' }}</span>
                                                                    <input type="text" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text">{{ $patientScoreData['padds_data']['padds_mual_muntah'] ?? '0' }}</span>
                                                                    <input type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text">{{ $patientScoreData['padds_data']['padds_perdarahan'] ?? '0' }}</span>
                                                                    <input type="text" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text">{{ $patientScoreData['padds_data']['padds_nyeri'] ?? '0' }}</span>
                                                                    <input type="text" class="form-control"
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @else
                                                                        @for ($i = 1; $i <= 3; $i++)
                                                                            <tr>
                                                                                <td>{{ $patientScoreData['padds_data']['time_' . $i] ?? '-' }}</td>
                                                                                <td>{{ $patientScoreData['padds_data']['skor_' . $i] ?? '-' }}</td>
                                                                                <td>{{ $patientScoreData['padds_data']['kesimpulan_' . $i] ?? '-' }}</td>
                                                                            </tr>
                                                                        @endfor
                                                                    @endif
                                                                </tbody>
                                                    ...
                                                    <div class="form-group mb-3 mt-4">
                                                        <label class="d-block mb-2" style="background-color: #177F75; color: white; padding: 8px;">Kesimpulan Akhir</label>
                                                        <div class="p-3 text-white rounded" style="background-color: #177F75;">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="2"
                                        disabled>{{ $okPraInduksi->okPraInduksiCtkp->catatan_pemulihan ?? '' }}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" rows="3"
                                                disabled>{{ $okPraInduksi->okPraInduksiIpb->lain_lain ?? '-' }}</textarea>
                                        </div>
