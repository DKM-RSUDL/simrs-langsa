    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                <form
                    action="{{ route('rehab-medis.pelayanan.layanan.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                    method="post">
                    @csrf
                            ...
                            <div class="d-flex gap-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="suspek_penyakit" id="suspekYa"
                                        value="1" onclick="toggleSuspekDetails(true)">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="suspek_penyakit" id="suspekTidak"
                                        value="0" onclick="toggleSuspekDetails(false)">
