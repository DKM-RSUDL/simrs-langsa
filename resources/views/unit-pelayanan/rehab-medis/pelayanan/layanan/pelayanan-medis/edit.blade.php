    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <x-content-card>
                <x-button-previous />
                <form
                    action="{{ route('rehab-medis.pelayanan.layanan.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, encrypt($layanan->id)]) }}"
                    method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="row mb-4 mt-2">
                        ...
                        <div class="col-sm-9 d-flex">
                            ...
                            <input type="time" name="jam_pelayanan" class="form-control ms-3" style="max-width: 200px;"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" name="anamnesa" id="anamnesa" style="height: 100px">{{ $layanan->anamnesa }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" name="pemeriksaan_fisik" id="pemeriksaan_fisik" style="height: 100px">{{ $layanan->pemeriksaan_fisik }}</textarea>
                            ...
                            <div class="form-floating">
                                <strong class="fw-bold">
                                    ...
                                    <a href="javascript:void(0)" class="text-secondary text-decoration-none fw-bold ms-3"
                                        id="btn-diagnosis-medis-icd10"><i class="bi bi-plus-square"></i>
                                        Tambah</a>
                                </strong>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" name="pemeriksaan_penunjang" id="pemeriksaan_penunjang" style="height: 100px">{{ $layanan->pemeriksaan_penunjang }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                ...
                                <div class="bg-light p-1 border rounded">
                                    <div style="max-height: 150px; overflow-y: auto;" id="diagnoseDisplaytatalaksanakfr">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="suspek_penyakit" id="suspekYa"
                                        value="1" onclick="toggleSuspekDetails(true)" @checked($layanan->suspek_penyakit == 1)>
                                    <label class="form-check-label" for="suspekYa">Ya</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="suspek_penyakit" id="suspekTidak"
                                        value="0" onclick="toggleSuspekDetails(false)" @checked($layanan->suspek_penyakit == 0)>
                            ...
                            <div class="col-12 mt-2">
                                <div class="form-floating">
                                    <textarea class="form-control" name="diagnosa" id="diagnosa" style="height: 100px">{{ $layanan->diagnosa }}</textarea>
                                    <label for="diagnosa">Diagnosa</label>
                                </div>
                            </div>
                            <div class="col-12 mt-2">
                                <div class="form-floating">
                                    <textarea class="form-control" name="permintaan_terapi" id="permintaan_terapi" style="height: 100px">{{ $layanan->permintaan_terapi }}</textarea>
