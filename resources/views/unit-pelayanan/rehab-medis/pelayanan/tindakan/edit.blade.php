...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form action="{{ route('rehab-medis.pelayanan.tindakan.update', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, encrypt($tindakan->id)]) }}" method="post">
                @csrf
                @method('put')
