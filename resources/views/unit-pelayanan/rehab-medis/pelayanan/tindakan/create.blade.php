        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Tambah KFR/Asesmen/RE-Asesmen/Protokol Terapi',
                    'description' =>
                        'Tambah Data KFR/Asesmen/RE-Asesmen/Protokol Terapi dengan mengisi formulir di bawah ini.',
                ])
                <form
                    action="{{ route('rehab-medis.pelayanan.tindakan.store', [$dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                    method="post" class="d-flex flex-column gap-4">
                    @csrf

                    <!-- Waktu Pelayanan -->
                    <div class="row">
                        <label class="col-md-6" for="tgl_tindakan">Waktu Pelayanan</label>
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row g-2">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="planning_goal" id="planning_goal" style="height: 70px"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label for="planning_tindakan">b. Tindakan/Program Rehabilitasi Medik</label>
                                    <textarea class="form-control" name="planning_tindakan" id="planning_tindakan" style="height: 70px"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label for="planning_edukasi">c. Edukasi</label>
                                    <textarea class="form-control" name="planning_edukasi" id="planning_edukasi" style="height: 70px"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label for="planning_frekuensi">d. Frekuensi Kunjungan</label>
                                    <textarea class="form-control" name="planning_frekuensi" id="planning_frekuensi" style="height: 70px"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="rencana_tindak_lanjut" id="rencana_tindak_lanjut" style="height: 100px"></textarea>
                        </div>
                    </div>
