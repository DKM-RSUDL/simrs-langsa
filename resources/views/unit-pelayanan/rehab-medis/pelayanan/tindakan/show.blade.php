                            ...
                            <div class="col-7">
                                <div class="form-group">
                                    ...
                                    <select name="ppa" id="ppa"
                                        class="form-control @error('ppa') is-invalid @enderror" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            <input type="date" name="tgl_tindakan" id="tgl_tindakan"
                                                class="form-control @error('tgl_tindakan') is-invalid @enderror" value="{{ date('Y-m-d', strtotime($tindakan->tgl_tindakan)) }}" disabled>
                                        </div>
                                        <div class="col-5">
                                            <input type="time" name="jam_tindakan" id="jam_tindakan"
                                                class="form-control @error('jam_tindakan') is-invalid @enderror" value="{{ date('H:i', strtotime($tindakan->jam_tindakan)) }}" disabled>
                                        </div>
                                    </div>
