        ...
        <li class="list-group-item d-flex justify-content-between align-items-center" data-id="{{ $item->id }}"
            ...
            <div class="d-flex gap-2">
                ...
                @if ($item->kategori == 2 && $item->sub_kategori == 7)
                    ...
                    <a id="btnPrintAsesmen"
                        href="{{ route('rawat-inap.asesmen.keperawatan.anak.print', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                        target="_blank" class="btn btn-primary btn-sm">
                        <i class="bi bi-printer"></i> Print
                    </a>
                ...
                @if ($item->kategori == 2 && $item->sub_kategori == 2)
                    ...
                    <a id="btnPrintAsesmen"
                        href="{{ route('rawat-inap.asesmen.keperawatan.perinatology.print', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                        target="_blank" class="btn btn-primary btn-sm">
                        <i class="bi bi-printer"></i> Print
                    </a>
                ...
                @if ($item->kategori == 1 && $item->sub_kategori == 14)
                    ...
                    <a id="btnPrintAsesmen"
                        href="{{ route('rawat-inap.asesmen.medis.medis-neonatologi.print', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
                        target="_blank" class="btn btn-primary btn-sm">
                        <i class="bi bi-printer"></i> Print
                    </a>
