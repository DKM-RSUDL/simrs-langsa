        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <div>
                        <input type="radio" name="editTindakLanjut" value="kamarOperasi" id="editKamarOperasi"> Kamar
                        Operasi
                    </div>
                    <div>
                        <input type="radio" name="editTindakLanjut" value="rujukKeluar" id="editRujukKeluar"> Rujuk
                        Keluar RS
                    </div>
                    <div>
                        <input type="radio" name="editTindakLanjut" value="pulangKontrol" id="editPulangKontrol">
                        Pulang Kontrol di Klinik
                    </div>
                    <div>
                        <input type="radio" name="editTindakLanjut" value="menolakRawatInap"
                            id="editMenolakRawatInap"> Menolak Rawat Inap
                    </div>
                    <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function editTindakLanjut() {
            if (editTindakLanjutData) {
                // Set radio button
                document.querySelector(`input[name="editTindakLanjut"][value="${editTindakLanjutData.option}"]`)
                    .checked = true;
