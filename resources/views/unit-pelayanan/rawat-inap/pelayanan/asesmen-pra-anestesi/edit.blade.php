                                        ...
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                    ...
                                                    {{ old('jenis_kelamin', $asesmenPraAnestesi->jenis_kelamin) == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="laki_laki">Laki-laki</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="jenis_kelamin"
                                                    id="perempuan" value="0"
                                                    {{ old('jenis_kelamin', $asesmenPraAnestesi->jenis_kelamin) == '0' ? 'checked' : '' }}>
                                        ...
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="menikah" id="menikah_ya"
                                                    value="Ya" 
                                                    {{ old('menikah', $asesmenPraAnestesi->menikah) == 'Ya' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="menikah"
                                                    ...
                                                    {{ old('menikah', $asesmenPraAnestesi->menikah) == 'Tidak' ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="merokok" value="{{ old('merokok', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->merokok) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
