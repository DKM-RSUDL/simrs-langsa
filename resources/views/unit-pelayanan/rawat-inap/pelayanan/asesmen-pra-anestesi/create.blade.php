            ...
            <div class="col-md-9">
                <x-content-card>
                    ...
                    @include('components.page-header', [
                        'title' => 'Tambah Asesmen Pra Anestesi dan Sedasi',
                        'description' =>
                            'Tambah data asesmen pra anestesi dan sedasi pasien rawat inap dengan mengisi formulir di bawah ini.',
                    ])
                    ...
                    <form id="praAnestesiForm" method="POST"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="obat_resep" rows="3" placeholder="Nama obat dan dosis"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label fw-bold">Obat Bebas (Vitamin, Herbal)</label>
                                            <textarea class="form-control" name="obat_bebas" rows="3" placeholder="Nama obat dan dosis"></textarea>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="d-flex gap-3 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="aspirin_rutin"
                                                            id="aspirin_ya" value="Ya">
                                                        <label class="form-check-label" for="aspirin_ya">Ya</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="aspirin_rutin"
                                                            id="aspirin_tidak" value="Tidak">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" name="alergi_obat_detail" rows="3" placeholder="Daftar obat dan tipe reaksi"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                        ...
                        <div class="card mb-4 shadow-sm">
                            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-users me-2"></i>Riwayat
                                    Keluarga
                                </h6>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="rk_penyakit_lain" value="Ya">
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="rk_penyakit_lain" value="Tidak">
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label fw-bold">Jelaskan Penyakit Keluarga Apabila Dijawab
                                        "Ya"</label>
                                    <textarea class="form-control" name="rk_keterangan" rows="4" placeholder="Jelaskan detail penyakit keluarga"></textarea>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="rp_penyakit_lain" value="Ya">
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="rp_penyakit_lain" value="Tidak">
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-4">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="lensa_kontak" value="Ya">
                                                        <label class="form-check-label small">Ya</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="lensa_kontak" value="Tidak">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="menyusui"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="hilangnya_gigi"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="masalah_mobilitas_leher" value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="masalah_mobilitas_leher" value="Tidak">
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="leher_pendek"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="batuk"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label fw-bold">Sesak Nafas</label>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="sesak_nafas"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="baru_saja_infeksi"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        @if ($dataMedis->pasien->jenis_kelamin == 0)
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="menstruasi_tidak_normal" value="Ya">
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio"
                                                        name="menstruasi_tidak_normal" value="Tidak">
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        @endif
                                        <div class="form-group mb-3">
                                            <label class="form-label fw-bold">Pingsan</label>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pingsan"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="sakit_dada"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="denyut_jantung_tidak_normal" value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="denyut_jantung_tidak_normal" value="Tidak">
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="muntah"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="susaah_bak"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kejang"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        @if ($dataMedis->pasien->jenis_kelamin == 0)
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="sedang_hamil"
                                                        value="Ya">
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="stroke"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="obesitas"
                                                    value="Ya">
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                        ...
                        <div class="card mb-4 shadow-sm">
                            <div class="card-header bg-light">
                                <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-heartbeat me-2"></i>Keadaan
                                    Umum
                                </h6>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="asa_klasifikasi"
                                            value="ASA 2">
                                        <label class="form-check-label">ASA 2 - Pasien dengan penyakit sitemik
                                            ringan</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="asa_klasifikasi"
                                            value="ASA 3">
                                        <label class="form-check-label">ASA 3 - Pasien dengan penyakit sitemik
                                            berat</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="asa_klasifikasi"
                                            value="ASA 4">
                                        <label class="form-check-label">ASA 4 - Pasien dengan penyakit sitamik berat
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                name="rekomendasi_tindakan_anestesi[]" value="Anestesi umum Intravena"
                                                id="anestesi_umum_intravena"
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                name="rekomendasi_tindakan_anestesi[]" value="Laringeal mask airway"
                                                id="laringeal_mask_airway"
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                name="rekomendasi_tindakan_anestesi[]" value="Pipa endotrakeal tube"
                                                id="pipa_endotrakeal_tube"
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                name="rekomendasi_tindakan_anestesi[]" value="Epidural" id="epidural"
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                name="rekomendasi_tindakan_anestesi[]" value="Kombinasi Spinal Epidural"
                                                id="kombinasi_spinal_epidural"
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                name="rekomendasi_tindakan_anestesi[]" value="Peripheral Nerve Block"
