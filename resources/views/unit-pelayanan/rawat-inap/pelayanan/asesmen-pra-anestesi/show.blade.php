            ...
            <div class="col-md-9">
                <x-content-card>
                    ...
                    @include('components.page-header', [
                        'title' => 'Rincian Asesmen Pra Anestesi dan Sedasi',
                        'description' =>
                            'Rincian data asesmen pra anestesi dan sedasi pasien rawat inap dengan mengisi formulir di bawah ini.',
                    ])
                    <div id="praAnestesiForm" method="" action="#">
                        <!-- Kebiasaan -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('merokok') is-invalid @enderror" name="merokok"
                                                value="{{ old('merokok', $asesmenPraAnestesi->merokok ?? '') }}" disabled>
                                            @error('merokok')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('alkohol') is-invalid @enderror" name="alkohol"
                                                value="{{ old('alkohol', $asesmenPraAnestesi->alkohol ?? '') }}" disabled>
                                            @error('alkohol')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('obat_resep') is-invalid @enderror" name="obat_resep" rows="3" disabled>{{ old('obat_resep', $asesmenPraAnestesi->obat_resep ?? '') }}</textarea>
                                            @error('obat_resep')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('obat_bebas') is-invalid @enderror" name="obat_bebas" rows="3" disabled>{{ old('obat_bebas', $asesmenPraAnestesi->obat_bebas ?? '') }}</textarea>
                                            @error('obat_bebas')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                                ...
                                                <div class="d-flex gap-3 mb-2">
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            type="radio" name="aspirin_rutin" id="aspirin_ya"
                                                            value="Ya"
                                                    ...
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            value="Tidak"
                                                            {{ old('aspirin_rutin', $asesmenPraAnestesi->aspirin_rutin ?? '') == 'Tidak' ? 'checked' : '' }}
                                                            disabled>
                                                        <label class="form-check-label" for="aspirin_tidak">Tidak</label>
                                                    </div>
                                                </div>
                                                @error('aspirin_rutin')
                                                ...
                                                <div class="d-flex gap-3 mb-2">
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            value="Ya"
                                                            {{ old('obat_anti_sakit', $asesmenPraAnestesi->obat_anti_sakit ?? '') == 'Ya' ? 'checked' : '' }}
                                                            disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            value="Tidak"
                                                            {{ old('obat_anti_sakit', $asesmenPraAnestesi->obat_anti_sakit ?? '') == 'Tidak' ? 'checked' : '' }}
                                                            disabled>
                                                        <label class="form-check-label" for="anti_sakit_tidak">Tidak</label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-flex gap-3 mb-2">
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="injeksi_steroid" id="steroid_ya" value="Ya"
                                                    {{ old('injeksi_steroid', $asesmenPraAnestesi->injeksi_steroid ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                            ...
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('injeksi_steroid') is-invalid @enderror"
                                                    type="radio" name="injeksi_steroid" id="steroid_tidak"
                                                    value="Tidak"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="d-flex gap-3 mb-2">
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            value="Ya"
                                                            {{ old('alergi_obat', $asesmenPraAnestesi->alergi_obat ?? '') == 'Ya' ? 'checked' : '' }}
                                                            disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            value="Tidak"
                                                            {{ old('alergi_obat', $asesmenPraAnestesi->alergi_obat ?? '') == 'Tidak' ? 'checked' : '' }}
                                                            disabled>
                                                ...
                                                @enderror
                                                <textarea class="form-control @error('alergi_obat_detail') is-invalid @enderror" name="alergi_obat_detail"
                                                    rows="3" disabled>{{ old('alergi_obat_detail', $asesmenPraAnestesi->alergi_obat_detail ?? '') }}</textarea>
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                value="Ya"
                                                                {{ old('alergi_lateks', $asesmenPraAnestesi->alergi_lateks ?? '') == 'Ya' ? 'checked' : '' }}
                                                                disabled>
                                                        ...
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                value="Tidak"
                                                                {{ old('alergi_lateks', $asesmenPraAnestesi->alergi_lateks ?? '') == 'Tidak' ? 'checked' : '' }}
                                                                disabled>
                                                            <label class="form-check-label small"
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                value="Ya"
                                                                {{ old('alergi_plester', $asesmenPraAnestesi->alergi_plester ?? '') == 'Ya' ? 'checked' : '' }}
                                                                disabled>
                                                            <label class="form-check-label small"
                                                        ...
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                value="Tidak"
                                                                {{ old('alergi_plester', $asesmenPraAnestesi->alergi_plester ?? '') == 'Tidak' ? 'checked' : '' }}
                                                                disabled>
                                                            <label class="form-check-label small"
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                value="Ya"
                                                                {{ old('alergi_makanan', $asesmenPraAnestesi->alergi_makanan ?? '') == 'Ya' ? 'checked' : '' }}
                                                                disabled>
                                                            <label class="form-check-label small"
                                                        ...
                                                        <div class="form-check">
                                                            <input
                                                                ...
                                                                value="Tidak"
                                                                {{ old('alergi_makanan', $asesmenPraAnestesi->alergi_makanan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                                disabled>
                                                            <label class="form-check-label small"
                            ...
                            <div class="card-body">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_perdarahan" value="Ya"
                                                        {{ old('rk_perdarahan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_perdarahan ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                ...
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_perdarahan') is-invalid @enderror"
                                                        type="radio" name="rk_perdarahan" value="Tidak"
                                                        {{ old('rk_perdarahan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_perdarahan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_pembekuan" value="Ya"
                                                        {{ old('rk_pembekuan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_pembekuan ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_pembekuan') is-invalid @enderror"
                                                        type="radio" name="rk_pembekuan" value="Tidak"
                                                        {{ old('rk_pembekuan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_pembekuan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_anestesi" value="Ya"
                                                        {{ old('rk_anestesi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_anestesi ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_anestesi') is-invalid @enderror"
                                                        type="radio" name="rk_anestesi" value="Tidak"
                                                        {{ old('rk_anestesi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_anestesi ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_operasi_jantung" value="Ya"
                                                        {{ old('rk_operasi_jantung', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_operasi_jantung ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_operasi_jantung') is-invalid @enderror"
                                                        type="radio" name="rk_operasi_jantung" value="Tidak"
                                                        {{ old('rk_operasi_jantung', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_operasi_jantung ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_diabetes" value="Ya"
                                                        {{ old('rk_diabetes', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_diabetes ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_diabetes') is-invalid @enderror"
                                                        type="radio" name="rk_diabetes" value="Tidak"
                                                        {{ old('rk_diabetes', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_diabetes ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_serangan_jantung" value="Ya"
                                                        {{ old('rk_serangan_jantung', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_serangan_jantung ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_serangan_jantung') is-invalid @enderror"
                                                        type="radio" name="rk_serangan_jantung" value="Tidak"
                                                        {{ old('rk_serangan_jantung', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_serangan_jantung ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_hipertensi" value="Ya"
                                                        {{ old('rk_hipertensi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_hipertensi ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_hipertensi') is-invalid @enderror"
                                                        type="radio" name="rk_hipertensi" value="Tidak"
                                                        {{ old('rk_hipertensi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_hipertensi ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_tuberkulosis" value="Ya"
                                                        {{ old('rk_tuberkulosis', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_tuberkulosis ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_tuberkulosis') is-invalid @enderror"
                                                        type="radio" name="rk_tuberkulosis" value="Tidak"
                                                        {{ old('rk_tuberkulosis', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_tuberkulosis ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rk_penyakit_lain" value="Ya"
                                                        {{ old('rk_penyakit_lain', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_penyakit_lain ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rk_penyakit_lain') is-invalid @enderror"
                                                        type="radio" name="rk_penyakit_lain" value="Tidak"
                                                        {{ old('rk_penyakit_lain', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->rk_penyakit_lain ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label fw-bold">Jelaskan Penyakit Keluarga Apabila Dijawab
                                        "Ya"</label>
                                    <textarea class="form-control @error('rk_keterangan') is-invalid @enderror" name="rk_keterangan" rows="4"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('bahasa') is-invalid @enderror"
                                                    type="radio" name="bahasa" id="bahasa_indonesia"
                                                    value="Indonesia"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('bahasa') is-invalid @enderror"
                                                    type="radio" name="bahasa" id="bahasa_lain"
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="gangguan_penglihatan" value="Ya"
                                                        {{ old('gangguan_penglihatan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->gangguan_penglihatan ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('gangguan_penglihatan') is-invalid @enderror"
                                                        type="radio" name="gangguan_penglihatan" value="Tidak"
                                                        {{ old('gangguan_penglihatan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->gangguan_penglihatan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="gangguan_pendengaran" value="Ya"
                                                        {{ old('gangguan_pendengaran', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->gangguan_pendengaran ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('gangguan_pendengaran') is-invalid @enderror"
                                                        type="radio" name="gangguan_pendengaran" value="Tidak"
                                                        {{ old('gangguan_pendengaran', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->gangguan_pendengaran ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="gangguan_bicara" value="Ya"
                                                        {{ old('gangguan_bicara', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->gangguan_bicara ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('gangguan_bicara') is-invalid @enderror"
                                                        type="radio" name="gangguan_bicara" value="Tidak"
                                                        {{ old('gangguan_bicara', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRiwayatKeluarga->gangguan_bicara ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_perdarahan" value="Ya"
                                                        {{ old('rp_perdarahan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_perdarahan ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_perdarahan') is-invalid @enderror"
                                                        type="radio" name="rp_perdarahan" value="Tidak"
                                                        {{ old('rp_perdarahan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_perdarahan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_pembekuan" value="Ya"
                                                        {{ old('rp_pembekuan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_pembekuan ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_pembekuan') is-invalid @enderror"
                                                        type="radio" name="rp_pembekuan" value="Tidak"
                                                        {{ old('rp_pembekuan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_pembekuan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input @error('rp_maag') is-invalid @enderror"
                                                        type="radio" name="rp_maag" value="Ya"
                                                        {{ old('rp_maag', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_maag ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input @error('rp_maag') is-invalid @enderror"
                                                        type="radio" name="rp_maag" value="Tidak"
                                                        {{ old('rp_maag', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_maag ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_anemia" value="Ya"
                                                        {{ old('rp_anemia', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_anemia ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_anemia') is-invalid @enderror"
                                                        type="radio" name="rp_anemia" value="Tidak"
                                                        {{ old('rp_anemia', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_anemia ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_sesak" value="Ya"
                                                        {{ old('rp_sesak', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_sesak ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_sesak') is-invalid @enderror"
                                                        type="radio" name="rp_sesak" value="Tidak"
                                                        {{ old('rp_sesak', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_sesak ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input @error('rp_asma') is-invalid @enderror"
                                                        type="radio" name="rp_asma" value="Ya"
                                                        {{ old('rp_asma', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_asma ?? '') == 'Ya' ? 'checked' : '' }}disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input @error('rp_asma') is-invalid @enderror"
                                                        type="radio" name="rp_asma" value="Tidak"
                                                        {{ old('rp_asma', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_asma ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_diabetes" value="Ya"
                                                        {{ old('rp_diabetes', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_diabetes ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_diabetes') is-invalid @enderror"
                                                        type="radio" name="rp_diabetes" value="Tidak"
                                                        {{ old('rp_diabetes', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_diabetes ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_pingsan" value="Ya"
                                                        {{ old('rp_pingsan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_pingsan ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_pingsan') is-invalid @enderror"
                                                        type="radio" name="rp_pingsan" value="Tidak"
                                                        {{ old('rp_pingsan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_pingsan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_serangan_jantung" value="Ya"
                                                        {{ old('rp_serangan_jantung', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_serangan_jantung ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_serangan_jantung') is-invalid @enderror"
                                                        type="radio" name="rp_serangan_jantung" value="Tidak"
                                                        {{ old('rp_serangan_jantung', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_serangan_jantung ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_hepatitis" value="Ya"
                                                        {{ old('rp_hepatitis', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_hepatitis ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_hepatitis') is-invalid @enderror"
                                                        type="radio" name="rp_hepatitis" value="Tidak"
                                                        {{ old('rp_hepatitis', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_hepatitis ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_hipertensi" value="Ya"
                                                        {{ old('rp_hipertensi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_hipertensi ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_hipertensi') is-invalid @enderror"
                                                        type="radio" name="rp_hipertensi" value="Tidak"
                                                        {{ old('rp_hipertensi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_hipertensi ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_sumbatan_nafas" value="Ya"
                                                        {{ old('rp_sumbatan_nafas', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_sumbatan_nafas ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_sumbatan_nafas') is-invalid @enderror"
                                                        type="radio" name="rp_sumbatan_nafas" value="Tidak"
                                                        {{ old('rp_sumbatan_nafas', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_sumbatan_nafas ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_mengorok" value="Ya"
                                                        {{ old('rp_mengorok', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_mengorok ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_mengorok') is-invalid @enderror"
                                                        type="radio" name="rp_mengorok" value="Tidak"
                                                        {{ old('rp_mengorok', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_mengorok ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="rp_penyakit_lain" value="Ya"
                                                        {{ old('rp_penyakit_lain', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_penyakit_lain ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('rp_penyakit_lain') is-invalid @enderror"
                                                        type="radio" name="rp_penyakit_lain" value="Tidak"
                                                        {{ old('rp_penyakit_lain', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->rp_penyakit_lain ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group mb-3">
                                    <label class="form-label fw-bold">Jelaskan Penyakit Pasien Apabila Dijawab
                                        "Ya"</label>
                                    <textarea class="form-control @error('rp_keterangan') is-invalid @enderror" name="rp_keterangan" rows="4"
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                            ...
                                            <div class="d-flex gap-3 mb-2">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="transfusi_darah" value="Ya"
                                                        {{ old('transfusi_darah', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->transfusi_darah ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('transfusi_darah') is-invalid @enderror"
                                                        type="radio" name="transfusi_darah" value="Tidak"
                                                        {{ old('transfusi_darah', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->transfusi_darah ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex gap-3 mb-2">
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="periksa_hiv" value="Ya"
                                                        {{ old('periksa_hiv', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->periksa_hiv ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('periksa_hiv') is-invalid @enderror"
                                                        type="radio" name="periksa_hiv" value="Tidak"
                                                        {{ old('periksa_hiv', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->periksa_hiv ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('hasil_hiv') is-invalid @enderror"
                                                    type="radio" name="hasil_hiv" value="Positif"
                                                    {{ old('hasil_hiv', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->hasil_hiv ?? '') == 'Positif' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Positif</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('hasil_hiv') is-invalid @enderror"
                                                    type="radio" name="hasil_hiv" value="Negatif"
                                                    {{ old('hasil_hiv', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->hasil_hiv ?? '') == 'Negatif' ? 'checked' : '' }}
                                                    disabled>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            type="radio" name="lensa_kontak" value="Ya"
                                                            {{ old('lensa_kontak', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->lensa_kontak ?? '') == 'Ya' ? 'checked' : '' }}
                                                            disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input
                                                            class="form-check-input @error('lensa_kontak') is-invalid @enderror"
                                                            type="radio" name="lensa_kontak" value="Tidak"
                                                            {{ old('lensa_kontak', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->lensa_kontak ?? '') == 'Tidak' ? 'checked' : '' }}
                                                            disabled>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            type="radio" name="alat_bantu_dengar" value="Ya"
                                                            {{ old('alat_bantu_dengar', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->alat_bantu_dengar ?? '') == 'Ya' ? 'checked' : '' }}
                                                            disabled>
                                                        <label class="form-check-label small">Ya</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input
                                                            class="form-check-input @error('alat_bantu_dengar') is-invalid @enderror"
                                                            type="radio" name="alat_bantu_dengar" value="Tidak"
                                                            {{ old('alat_bantu_dengar', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->alat_bantu_dengar ?? '') == 'Tidak' ? 'checked' : '' }}
                                                            disabled>
                                                        <label class="form-check-label small">Tidak</label>
                                                    </div>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="form-check">
                                                        <input
                                                            ...
                                                            type="radio" name="gigi_palsu" value="Ya"
                                                            {{ old('gigi_palsu', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->gigi_palsu ?? '') == 'Ya' ? 'checked' : '' }}
                                                            disabled>
                                                        <label class="form-check-label small">Ya</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input
                                                            class="form-check-input @error('gigi_palsu') is-invalid @enderror"
                                                            type="radio" name="gigi_palsu" value="Tidak"
                                                            {{ old('gigi_palsu', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->gigi_palsu ?? '') == 'Tidak' ? 'checked' : '' }}
                                                            disabled>
                                                        <label class="form-check-label small">Tidak</label>
                                                    </div>
                                                    @error('gigi_palsu')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('riwayat_operasi') is-invalid @enderror" name="riwayat_operasi" rows="3"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('jenis_anestesi_sebelum') is-invalid @enderror" name="jenis_anestesi_sebelum"
                                        rows="3" disabled>{{ old('jenis_anestesi_sebelum', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->jenis_anestesi_sebelum ?? '') }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('gangguan_periksa') is-invalid @enderror" name="gangguan_periksa"
                                        rows="3" disabled>{{ old('gangguan_periksa', $asesmenPraAnestesi->rmeAsesmenPraAnestesiRppRml->gangguan_periksa ?? '') }}</textarea>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('menyusui') is-invalid @enderror"
                                                    type="radio" name="menyusui" value="Ya"
                                                    {{ old('menyusui', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->menyusui ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('menyusui') is-invalid @enderror"
                                                    type="radio" name="menyusui" value="Tidak"
                                                    {{ old('menyusui', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->menyusui ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('menyusui')
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="hilangnya_gigi" value="Ya"
                                                    {{ old('hilangnya_gigi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->hilangnya_gigi ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('hilangnya_gigi') is-invalid @enderror"
                                                    type="radio" name="hilangnya_gigi" value="Tidak"
                                                    {{ old('hilangnya_gigi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->hilangnya_gigi ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="masalah_mobilitas_leher" value="Ya"
                                                    {{ old('masalah_mobilitas_leher', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->masalah_mobilitas_leher ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('masalah_mobilitas_leher') is-invalid @enderror"
                                                    type="radio" name="masalah_mobilitas_leher" value="Tidak"
                                                    {{ old('masalah_mobilitas_leher', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->masalah_mobilitas_leher ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="leher_pendek" value="Ya"
                                                    {{ old('leher_pendek', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->leher_pendek ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('leher_pendek') is-invalid @enderror"
                                                    type="radio" name="leher_pendek" value="Tidak"
                                                    {{ old('leher_pendek', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->leher_pendek ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('leher_pendek')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('batuk') is-invalid @enderror"
                                                    type="radio" name="batuk" value="Ya"
                                                    {{ old('batuk', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->batuk ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('batuk') is-invalid @enderror"
                                                    type="radio" name="batuk" value="Tidak"
                                                    {{ old('batuk', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->batuk ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('batuk')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="sesak_nafas" value="Ya"
                                                    {{ old('sesak_nafas', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->sesak_nafas ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('sesak_nafas') is-invalid @enderror"
                                                    type="radio" name="sesak_nafas" value="Tidak"
                                                    {{ old('sesak_nafas', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->sesak_nafas ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('sesak_nafas')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="baru_saja_infeksi" value="Ya"
                                                    {{ old('baru_saja_infeksi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->baru_saja_infeksi ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('baru_saja_infeksi') is-invalid @enderror"
                                                    type="radio" name="baru_saja_infeksi" value="Tidak"
                                                    {{ old('baru_saja_infeksi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->baru_saja_infeksi ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        type="radio" name="menstruasi_tidak_normal" value="Ya"
                                                        {{ old('menstruasi_tidak_normal', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->menstruasi_tidak_normal ?? '') == 'Ya' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('menstruasi_tidak_normal') is-invalid @enderror"
                                                        type="radio" name="menstruasi_tidak_normal" value="Tidak"
                                                        {{ old('menstruasi_tidak_normal', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->menstruasi_tidak_normal ?? '') == 'Tidak' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('pingsan') is-invalid @enderror"
                                                    type="radio" name="pingsan" value="Ya"
                                                    {{ old('pingsan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->pingsan ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('pingsan') is-invalid @enderror"
                                                    type="radio" name="pingsan" value="Tidak"
                                                    {{ old('pingsan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->pingsan ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('pingsan')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="sakit_dada" value="Ya"
                                                    {{ old('sakit_dada', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->sakit_dada ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('sakit_dada') is-invalid @enderror"
                                                    type="radio" name="sakit_dada" value="Tidak"
                                                    {{ old('sakit_dada', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->sakit_dada ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('sakit_dada')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="denyut_jantung_tidak_normal" value="Ya"
                                                    {{ old('denyut_jantung_tidak_normal', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->denyut_jantung_tidak_normal ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('denyut_jantung_tidak_normal') is-invalid @enderror"
                                                    type="radio" name="denyut_jantung_tidak_normal" value="Tidak"
                                                    {{ old('denyut_jantung_tidak_normal', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->denyut_jantung_tidak_normal ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('muntah') is-invalid @enderror"
                                                    type="radio" name="muntah" value="Ya"
                                                    {{ old('muntah', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->muntah ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('muntah') is-invalid @enderror"
                                                    type="radio" name="muntah" value="Tidak"
                                                    {{ old('muntah', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->muntah ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('muntah')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    ...
                                                    type="radio" name="susaah_bak" value="Ya"
                                                    {{ old('susaah_bak', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->susaah_bak ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('susaah_bak') is-invalid @enderror"
                                                    type="radio" name="susaah_bak" value="Tidak"
                                                    {{ old('susaah_bak', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->susaah_bak ?? '') == 'Tidak' ? 'checked' : '' }}>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('susaah_bak')
                                                <div class="invalid-feedback d-block">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('kejang') is-invalid @enderror"
                                                    type="radio" name="kejang" value="Ya"
                                                    {{ old('kejang', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->kejang ?? '') == 'Ya' ? 'checked' : '' }}>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('kejang') is-invalid @enderror"
                                                    type="radio" name="kejang" value="Tidak"
                                                    {{ old('kejang', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->kejang ?? '') == 'Tidak' ? 'checked' : '' }}>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('kejang')
                                                <div class="invalid-feedback d-block">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-check">
                                                    <inpu t
                                                        ...
                                                        type="radio" name="sedang_hamil" value="Ya"
                                                        {{ old('sedang_hamil', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->sedang_hamil ?? '') == 'Ya' ? 'checked' : '' }}>
                                                        <label class="form-check-label">Ya</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input @error('sedang_hamil') is-invalid @enderror"
                                                        type="radio" name="sedang_hamil" value="Tidak"
                                                        {{ old('sedang_hamil', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->sedang_hamil ?? '') == 'Tidak' ? 'checked' : '' }}>
                                                    <label class="form-check-label">Tidak</label>
                                                </div>
                                            </div>
                                        @endif
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('stroke') is-invalid @enderror"
                                                    type="radio" name="stroke" value="Ya"
                                                    {{ old('stroke', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->stroke ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('stroke') is-invalid @enderror"
                                                    type="radio" name="stroke" value="Tidak"
                                                    {{ old('stroke', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->stroke ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('stroke')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('obesitas') is-invalid @enderror"
                                                    type="radio" name="obesitas" value="Ya"
                                                    {{ old('obesitas', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->obesitas ?? '') == 'Ya' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('obesitas') is-invalid @enderror"
                                                    type="radio" name="obesitas" value="Tidak"
                                                    {{ old('obesitas', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->obesitas ?? '') == 'Tidak' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">Tidak</label>
                                            </div>
                                            @error('obesitas')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('saluran_nafas_atas') is-invalid @enderror" name="saluran_nafas_atas"
                                        rows="4" disabled>{{ old('saluran_nafas_atas', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKppKs->saluran_nafas_atas ?? '') }}</textarea>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-select" name="kesadaran" disabled>
                                                ...
                                                <option value="Compos Mentis"
                                                    {{ old('kesadaran', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->kesadaran ?? '') == 'Compos Mentis' ? 'selected' : '' }}>
                                                    Compos Mentis</option>
                                                <option value="Apatis"
                                                    {{ old('kesadaran', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->kesadaran ?? '') == 'Apatis' ? 'selected' : '' }}>
                                                    Apatis</option>
                                                <option value="Sopor"
                                                    {{ old('kesadaran', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->kesadaran ?? '') == 'Sopor' ? 'selected' : '' }}>
                                                    Sopor</option>
                                                <option value="Coma"
                                                    {{ old('kesadaran', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->kesadaran ?? '') == 'Coma' ? 'selected' : '' }}>
                                                    Coma</option>
                                                <option value="Somnolen"
                                                    {{ old('kesadaran', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->kesadaran ?? '') == 'Somnolen' ? 'selected' : '' }}>
                                                    Somnolen</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('visus') is-invalid @enderror"
                                                name="visus"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('faring') is-invalid @enderror"
                                                name="faring"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('keadaan_umum_keterangan') is-invalid @enderror"
                                                name="keadaan_umum_keterangan" rows="4" disabled>{{ old('keadaan_umum_keterangan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->keadaan_umum_keterangan ?? '') }}
                                        </textarea>
                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control @error('bb') is-invalid @enderror" name="bb"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="number"
                                                        class="form-control @error('distole') is-invalid @enderror"
                                                        name="distole"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('paru') is-invalid @enderror"
                                                        name="paru"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label class="form-label fw-bold">Neurologi (jika ada
                                                        ditemukan)</label>
                                                    <input type="text"
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label fw-bold">Keterangan:</label>
                                            <textarea class="form-control @error('pemeriksaan_fisik_keterangan') is-invalid @enderror"
                                                name="pemeriksaan_fisik_keterangan" rows="4" disabled>{{ old('pemeriksaan_fisik_keterangan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->pemeriksaan_fisik_keterangan ?? '') }}</textarea>
                                ...
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0 fw-bold text-primary"><i
                                                class="fas fa-vial me-2"></i>Laboratorium
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('ureum') is-invalid @enderror"
                                                        name="ureum"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('ekg') is-invalid @enderror"
                                                        name="ekg"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('mri') is-invalid @enderror"
                                                        name="mri"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control @error('usg') is-invalid @enderror"
                                                        name="usg"
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label fw-bold">Keterangan:</label>
                                            <textarea class="form-control @error('laboratorium_keterangan') is-invalid @enderror"
                                                name="laboratorium_keterangan" rows="4" disabled>{{ old('laboratorium_keterangan', $asesmenPraAnestesi->rmeAsesmenPraAnestesiKuPfLaboratorium->laboratorium_keterangan ?? '') }}</textarea>
                                ...
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0 fw-bold text-primary"><i
                                                class="fas fa-diagnoses me-2"></i>Diagnosis
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('asa_klasifikasi') is-invalid @enderror"
                                                    type="radio" name="asa_klasifikasi" value="ASA 1"
                                                    {{ old('asa_klasifikasi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiDiagnosisPmRtRo->asa_klasifikasi ?? '') == 'ASA 1' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">ASA 1 - Pasien sehat normal dan
                                                    sehat</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('asa_klasifikasi') is-invalid @enderror"
                                                    type="radio" name="asa_klasifikasi" value="ASA 2"
                                                    {{ old('asa_klasifikasi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiDiagnosisPmRtRo->asa_klasifikasi ?? '') == 'ASA 2' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">ASA 2 - Pasien dengan penyakit
                                                    sistemik
                                                    ringan</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('asa_klasifikasi') is-invalid @enderror"
                                                    type="radio" name="asa_klasifikasi" value="ASA 3"
                                                    {{ old('asa_klasifikasi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiDiagnosisPmRtRo->asa_klasifikasi ?? '') == 'ASA 3' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">ASA 3 - Pasien dengan penyakit
                                                    sistemik
                                                    berat</label>
                                            </div>
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('asa_klasifikasi') is-invalid @enderror"
                                                    type="radio" name="asa_klasifikasi" value="ASA 4"
                                                    {{ old('asa_klasifikasi', $asesmenPraAnestesi->rmeAsesmenPraAnestesiDiagnosisPmRtRo->asa_klasifikasi ?? '') == 'ASA 4' ? 'checked' : '' }}
                                                    disabled>
                                                <label class="form-check-label">ASA 4 - Pasien dengan penyakit
                                                    sistemik berat
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label fw-bold">Rekomendasi tindakan anestesi yang
                                                dipilih</label>
                                            <div class="mt-2">
                                                @php
                                                    ...
                                                    if (
                                                        isset(
                                                            $asesmenPraAnestesi->rmeAsesmenPraAnestesiDiagnosisPmRtRo
                                                                ->rekomendasi_tindakan_anestesi,
                                                        )
                                                    ) {
                                                        $jsonData =
                                                            $asesmenPraAnestesi->rmeAsesmenPraAnestesiDiagnosisPmRtRo
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="rekomendasi_tindakan_anestesi[]"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="rekomendasi_tindakan_anestesi[]" value="Sungkup muka"
                                                        id="sungkup_muka"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="rekomendasi_tindakan_anestesi[]"
                                                        value="Regional anestesi: Spinal Anastesi Blok"
                                                        id="regional_spinal"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="rekomendasi_tindakan_anestesi[]" value="Epidural"
                                                        id="epidural"
                                ...
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-calendar me-2"></i>Puasa
                                            mulai
                                        </h6>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0 fw-bold text-primary"><i
                                                class="fas fa-stethoscope me-2"></i>Rencana
                                            tiba di OK</h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                ...
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-light">
                                        <h6 class="mb-0 fw-bold text-primary"><i class="fas fa-syringe me-2"></i>Rencana
                                            Operasi
                                        </h6>
                                    </div>
                                    <div class="card-body">
