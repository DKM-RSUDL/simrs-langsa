        ...
        <div class="col-md-9">
            ...
            <x-content-card>
                ...
                @include('components.page-header', [
                    ...
                    'description' =>
                        'Site marking adalah proses penandaan lokasi pada tubuh pasien untuk mencegah kesalahan dalam identifikasi area yang akan ditangani. Fitur ini memungkinkan tenaga medis untuk:',
                ])
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('rawat-inap.operasi.site-marking.create', ['kd_unit' => $dataMedis->kd_unit, 'kd_pasien' => $dataMedis->kd_pasien, 'tgl_masuk' => date('Y-m-d', strtotime($dataMedis->tgl_masuk)), 'urut_masuk' => $dataMedis->urut_masuk, 'tgl_op' => $operasi->tgl_op, 'jam_op' => $operasi->jam_op]) }}"
