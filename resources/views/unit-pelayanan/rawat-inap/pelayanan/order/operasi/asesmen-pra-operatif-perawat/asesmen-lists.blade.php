...
<div class="d-flex flex-column">
    <div class="d-flex align-items-center justify-content-between">
        @include('components.page-header', [
            'title' => 'Daftar Asesmen Pra Operatif Perawat',
            'description' => 'Berikut daftar data asesmen pra operatif perawat.',
        ])

        <a href="{{ route('rawat-inap.operasi.asesmen.pra-operatif-perawat.create', [
            $dataMedis->kd_unit,
            $dataMedis->kd_pasien,
