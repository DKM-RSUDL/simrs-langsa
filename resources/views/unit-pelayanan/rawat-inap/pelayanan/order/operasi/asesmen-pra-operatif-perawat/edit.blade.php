        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Perbarui Asesmen Pra Operatif Perawat',
                    'description' =>
                    ...
                    <div class="section-separator" id="rencanaTindakan">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="skala_nyeri" id="skala_nyeri" min="0" max="10"
                                class="form-control" value="{{ $asesmen->praOperatifPerawat->skala_nyeri }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row w-100">
                                <div class="col-12">
                                    <button type="button" class="btn btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#jenisOperasiModal"><i class="bi bi-plus-square"></i>
                                        Tambah</button>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_bedah" id="tempat_bedah" placeholder="Jelaskan"
                                class="form-control" value="{{ $asesmen->praOperatifPerawat->tempat_bedah }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="checkbox" name="hasil_lab[]" id="gol_darah" value="Gol Darah"
                                    @checked(in_array('Gol Darah', $asesmen->praOperatifPerawat->hasil_lab))>
