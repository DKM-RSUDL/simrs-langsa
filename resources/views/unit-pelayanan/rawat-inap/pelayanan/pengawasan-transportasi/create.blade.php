    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="edukasiForm" method="POST"
                action="{{ route('rawat-inap.pengawasan-transportasi.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
                            ...
                            <div class="px-3">
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="asal_keberangkatan"
                                            name="asal_keberangkatan" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="keperluan" id="keperluan" class="form-select" required>
                                            ...
                                            <option value="1">Rujuk ke RS</option>
                                            <option value="2">Masuk/alih rawat inap</option>
                                            <option value="3">Pindah RS</option>
                                            <option value="4">Pra/pasca tindakan</option>
                                            <option value="5">Penjemputan</option>
                                            <option value="6">Evakuasi</option>
                                        </select>
                                    </div>

                                    <div class="form-group" id="rs-tujuan-wrap">
                                        <label for="rs_rujuk">RS Tujuan Rujuk</label>
                                        <input type="text" name="rs_rujuk" id="rs_rujuk" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal_berangkat" id="tanggal_berangkat"
                                            class="form-control date" value="{{ date('Y-m-d') }}" required readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="catatan_khusus_berangkat" id="catatan_khusus_berangkat" class="form-control"></textarea>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="sistole_berangkat" id="sistole_berangkat"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="diastole_berangkat" id="diastole_berangkat"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nadi_berangkat" id="nadi_berangkat"
                                            class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="nafas_berangkat">Nafas</label>
                                        <input type="number" name="nafas_berangkat" id="nafas_berangkat"
                                            class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="suhu_berangkat">Suhu</label>
                                        <input type="number" name="suhu_berangkat" id="suhu_berangkat"
                                            class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="skala_nyeri_berangkat">Skala nyeri (VAS)</label>
                                        <input type="number" name="skala_nyeri_berangkat" id="skala_nyeri_berangkat"
                                            class="form-control">
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="gcs_e_berangkat" id="gcs_e_berangkat"
                                                        class="form-select">
                                                        <option value="">--Pilih--</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="gcs_m_berangkat" id="gcs_m_berangkat"
                                                        ...
                                                        <option value="4">4 - Widthdrawal</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="resiko_nafas_berangkat" id="resiko_nafas_berangkat"
                                            class="form-select">
                                            <option value="">--Pilih--</option>
                                            <option value="1">Tidak beresiko</option>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kriteria" id="kriteria" class="form-select" required>
                                            <option value="">--Pilih--</option>
                                            <option value="1">Emergensi</option>
                                            <option value="2">Urgensi</option>
                                            <option value="3">Non-urgensi</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cara_transportasi" id="cara_transportasi" class="form-select">
                                            ...
                                            <option value="2">Brankar RJP</option>
                                            <option value="3">Brankar non RJP</option>
                                            <option value="4">Ambulans</option>
                                            <option value="5">Gawat darurat</option>
                                            <option value="6">Non gawat darurat</option>
                                        </select>
                                    </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="masalah" id="masalah" class="form-control"></textarea>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="gcs_m_pengawasan">Respon Motorik (M)</label>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="gcs_v_pengawasan[]" id="gcs_v_pengawasan"
                                                                    ...
                                                                    <option value="5">5 - Orientasi Baik</option>
                                                                    <option value="4">4 - Bingung</option>
                                                                    <option value="3">3 - Kata-Kata tidak jelas
                                                                    </option>
                                                                    <option value="2">2 - Suara tidak jelas</option>
                                                                    <option value="1">1 - tidak ada respon</option>
                                                                </select>
                                    ...
                                    <div class="text-end">
                                        <button type="button" class="btn btn-sm btn-success" id="btn-add-vitalsign">
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal_sampai" id="tanggal_sampai"
                                            class="form-control date" value="{{ date('Y-m-d') }}" readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="catatan_khusus_sampai" id="catatan_khusus_sampai" class="form-control"></textarea>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="sistole_sampai" id="sistole_sampai"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="diastole_sampai" id="diastole_sampai"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nadi_sampai" id="nadi_sampai" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="nafas_sampai">Nafas</label>
                                        <input type="number" name="nafas_sampai" id="nafas_sampai"
                                            class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="suhu_sampai">Suhu</label>
                                        <input type="number" name="suhu_sampai" id="suhu_sampai" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="skala_nyeri_sampai">Skala nyeri (VAS)</label>
                                        <input type="number" name="skala_nyeri_sampai" id="skala_nyeri_sampai"
                                            class="form-control">
                                    </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            $('#rs-tujuan-wrap,#plat-ambulans-wrap').hide();
            $('#rs-tujuan-wrap,#plat-ambulans-wrap input').prop('required', false);
        });
        ...
        $('#keperluan').change(function() {
            ...
            if (nilai != 1) {
                ...
                $('#rs-tujuan-wrap').show();
                $('#rs-tujuan-wrap input').prop('required', true);
            }
        });

        $('#cara_transportasi').change(function() {
            let nilai = $(this).val();
            ...
            if (nilai != 4) {
                ...
                $('#plat-ambulans-wrap').show();
                $('#plat-ambulans-wrap input').prop('required', true);
            }
        });


        // PENGAWASAN VITALSIGN
        $('#btn-add-vitalsign').on('click', function() {
            // Clone the original card row
            var $originalRow = $('#vitalsign-wrap .card:first-of-type');
            ...
            $newRow.find('.card-footer').append($deleteBtn);
