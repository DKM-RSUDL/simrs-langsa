    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="edukasiForm" method="POST"
                action="{{ route('rawat-inap.pengawasan-transportasi.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, encrypt($pengawasan->id)]) }}">
                @csrf
                @method('put')
                            ...
                            <div class="px-3">
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="asal_keberangkatan"
                                            name="asal_keberangkatan" value="{{ $pengawasan->asal_keberangkatan }}"
                                            required>
                                    </div>
                                ...
                                <div class="section-separator">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="diastole_berangkat"
                                                        value="{{ $pengawasan->diastole_berangkat }}"
                                                        id="diastole_berangkat" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nadi_berangkat"
                                            value="{{ $pengawasan->nadi_berangkat }}" id="nadi_berangkat"
                                            class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="nafas_berangkat">Nafas</label>
                                        <input type="number" name="nafas_berangkat"
                                            value="{{ $pengawasan->nafas_berangkat }}" id="nafas_berangkat"
                                            class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="suhu_berangkat">Suhu</label>
                                        <input type="number" name="suhu_berangkat"
                                            value="{{ $pengawasan->suhu_berangkat }}" id="suhu_berangkat"
                                            class="form-control">
                                    </div>
                                        ...
                                        <div id="vitalsign-wrap">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" class="form-control"
                                                            name="jam_pengawasan[]" id="jam_pengawasan"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="gcs_e_pengawasan[]"
                                                                        id="gcs_e_pengawasan" class="form-select">
                                                                        <option value="">--Pilih--</option>
                                                                        <option value="4"
                                                                            @selected($detail->gcs_e_pengawasan == 4)>4 - Spontan
                                                                        </option>
                                                                        <option value="3"
                                                                            @selected($detail->gcs_e_pengawasan == 3)>3 - Terhadap Suara
                                                                        </option>
                                                                        <option value="2"
                                                                            @selected($detail->gcs_e_pengawasan == 2)>2 - Terhadap Nyeri
                                                                        </option>
                                                                        <option value="1"
                                                                            @selected($detail->gcs_e_pengawasan == 1)>1 - Tidak Ada
                                                                            Respon
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="gcs_m_pengawasan[]"
                                                                        id="gcs_m_pengawasan" class="form-select">
                                                                        <option value="">--Pilih--</option>
                                                                        <option value="6"
                                                                            @selected($detail->gcs_m_pengawasan == 6)>6 - Mengikuti
                                                                            Perintah
                                                                        </option>
                                                                        <option value="5"
                                                                            @selected($detail->gcs_m_pengawasan == 5)>5 - Melokalisasi
                                                                            Nyeri
                                                                        </option>
                                                                        <option value="4"
                                                                            @selected($detail->gcs_m_pengawasan == 4)>4 - Widthdrawal
                                                                        </option>
                                                                        <option value="3"
                                                                            @selected($detail->gcs_m_pengawasan == 3)>3 - Fleksi
                                                                            Abnormal</option>
                                                                        <option value="2"
                                                                            @selected($detail->gcs_m_pengawasan == 2)>2 - Ekstensi
                                                                            Abnormal
                                                                        </option>
                                                                        <option value="1"
                                                                            @selected($detail->gcs_m_pengawasan == 1)>1 - Tidak Ada
                                                                            Respon
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="gcs_v_pengawasan[]"
                                                                        id="gcs_v_pengawasan" class="form-select">
                                                                        <option value="">--Pilih--</option>
                                                                        <option value="5"
                                                                            @selected($detail->gcs_v_pengawasan == 5)>5 - Orientasi Baik
                                                                        </option>
                                                                        <option value="4"
                                                                            @selected($detail->gcs_v_pengawasan == 4)>4 - Bingung
                                                                        </option>
                                                                        <option value="3"
                                                                            @selected($detail->gcs_v_pengawasan == 3)>3 - Kata-Kata
                                                                            tidak jelas
                                                                        </option>
                                                                        <option value="2"
                                                                            @selected($detail->gcs_v_pengawasan == 2)>2 - Suara tidak
                                                                            jelas
                                                                        </option>
                                                                        <option value="1"
                                                                            @selected($detail->gcs_v_pengawasan == 1)>1 - tidak ada
                                                                            respon
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                ...
                                                <div class="card-footer text-end">
                                                    @if ($loop->iteration > 1)
                                                        <button type="button"
                                                            class="btn btn-sm btn-danger btn-del-vitalsign"><i
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="nafas_sampai"
                                            value="{{ $pengawasan->nafas_sampai }}" id="nafas_sampai"
                                            class="form-control">
                                    </div>
...
@push('js')
    <script>
        ...
        $('.btn-del-vitalsign').on('click', function() {
