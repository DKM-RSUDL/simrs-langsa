    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="edukasiForm" method="POST"
                action="{{ route('rawat-inap.observasi.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
                                ...
                                <div class="section-separator">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal" id="tanggal" class="form-control date"
                                            value="{{ $existingObservasi ? $existingObservasi->tanggal->format('Y-m-d') : date('Y-m-d') }}"
                                            required readonly>
                                    </div>
                                </div>
