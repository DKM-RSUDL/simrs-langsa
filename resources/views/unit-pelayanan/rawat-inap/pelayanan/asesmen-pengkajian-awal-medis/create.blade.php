                                            ...
                                            <tbody>
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_kepala" value="1" id="pengkajian_kepala_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_kepala_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_kepala" value="0" id="pengkajian_kepala_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_kepala_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_kepala_keterangan" id="pengkajian_kepala_keterangan"
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_mata" value="1" id="pengkajian_mata_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_mata_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_mata" value="0" id="pengkajian_mata_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_mata_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_mata_keterangan" id="pengkajian_mata_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_tht" value="1" id="pengkajian_tht_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_tht_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_tht" value="0" id="pengkajian_tht_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_tht_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_tht_keterangan" id="pengkajian_tht_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_leher" value="1" id="pengkajian_leher_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_leher_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_leher" value="0" id="pengkajian_leher_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_leher_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_leher_keterangan" id="pengkajian_leher_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_mulut" value="1" id="pengkajian_mulut_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_mulut_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_mulut" value="0" id="pengkajian_mulut_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_mulut_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_mulut_keterangan" id="pengkajian_mulut_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                <label class="fw-semibold">f. Jantung dan pembuluh darah:</label>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_jantung" value="1" id="pengkajian_jantung_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_jantung_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_jantung" value="0" id="pengkajian_jantung_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_jantung_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_jantung_keterangan" id="pengkajian_jantung_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_thorax" value="1" id="pengkajian_thorax_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_thorax_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_thorax" value="0" id="pengkajian_thorax_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_thorax_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_thorax_keterangan" id="pengkajian_thorax_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_abdomen" value="1" id="pengkajian_abdomen_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_abdomen_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_abdomen" value="0" id="pengkajian_abdomen_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_abdomen_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_abdomen_keterangan" id="pengkajian_abdomen_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-md-2">
                                                                <label class="fw-semibold">i. Tulang belakang dan anggota gerak:</label>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_tulang_belakang" value="1" id="pengkajian_tulang_belakang_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_tulang_belakang_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_tulang_belakang" value="0" id="pengkajian_tulang_belakang_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_tulang_belakang_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_tulang_belakang_keterangan" id="pengkajian_tulang_belakang_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_sistem_syaraf" value="1" id="pengkajian_sistem_syaraf_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_sistem_syaraf_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_sistem_syaraf" value="0" id="pengkajian_sistem_syaraf_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_sistem_syaraf_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_sistem_syaraf_keterangan" id="pengkajian_sistem_syaraf_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_genetalia" value="1" id="pengkajian_genetalia_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_genetalia_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_genetalia" value="0" id="pengkajian_genetalia_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_genetalia_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_genetalia_keterangan" id="pengkajian_genetalia_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_status_lokasi" value="1" id="pengkajian_status_lokasi_normal" checked>
                                                                        <label class="form-check-label" for="pengkajian_status_lokasi_normal">Normal</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="pengkajian_status_lokasi" value="0" id="pengkajian_status_lokasi_tidak_normal">
                                                                        <label class="form-check-label" for="pengkajian_status_lokasi_tidak_normal">Tidak Normal</label>
                                                                    </div>
                                                                    <input type="text" class="form-control" name="pengkajian_status_lokasi_keterangan" id="pengkajian_status_lokasi_keterangan"
                                                                        placeholder="Keterangan jika tidak normal..." disabled>
                                                                </div>
                                                            </div>
                                                        </div>
