...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('rawat-inap.asesmen.medis.pengkajian-awal-medis.update', [
        'kd_unit' => request()->route('kd_unit'),
        'kd_pasien' => request()->route('kd_pasien'),
        'tgl_masuk' => request()->route('tgl_masuk'),
        'urut_masuk' => request()->route('urut_masuk'),
                    ...
                    <div class="px-3">
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted">
                                    {{ isset($asesmen) ?
                                    ($readonly ?? false ? 'Detail asesmen yang telah disimpan' : 'Edit asesmen yang
                                    telah disimpan') :
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-asesmen">
                                        <tbody>
                                            ...
                                            ['key' => 'jantung', 'label' => 'f. Jantung dan pembuluh darah:'],
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <div class="d-flex align-items-center gap-3">
                                                                ...
                                                                <span class="text-muted">{{ $currentKeterangan }}</span>
                                                                @endif
                                                            </div>
                                                            @else
                                                            <div class="d-flex align-items-center gap-3">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        id="{{ $fieldName }}_normal" {{ $currentValue==1
                                                                        ? 'checked' : '' }}>
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $currentKeterangan }}" {{ $currentValue==1
                                                                    ? 'disabled' : '' }}>
                                                            </div>
                                                            @endif
                                                        </div>
                                    ...
                                    <div class="d-flex align-items-start gap-4">
                                        <div class="d-flex align-items-center gap-3" style="min-width: 350px;">
                                            ...
                                            <input type="number"
                                                ...
                                                min="0" max="10" placeholder="0-10" {{ ($readonly ?? false) ? 'readonly'
                                                : '' }}>
