...
<div class="modal fade" id="modalTambahMonitoring" tabindex="-1" aria-labelledby="modalTambahMonitoringLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="formTambahMonitoring" method="POST" action="{{ route('rawat-inap.gizi.monitoring.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}">
                @csrf
