...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            <a href="{{ route('rawat-inap.asesmen.medis.geriatri.show', [
                'kd_unit' => $kd_unit,
                'kd_pasien' => $kd_pasien,
                'tgl_masuk' => $tgl_masuk,
                ...
                <div class="card w-100 h-100">
                    <div class="card-body">
                        <div class="px-3">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <h4 class="header-asesmen">Edit Asesmen Medis Geriatri</h4>
                                    <p>
                                        Edit asesmen medis geriatri pasien
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="section-separator" id="anamnesis">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="berat_badan"
                                                id="berat_badan" placeholder="70" step="0.1" min="10"
                                                max="300" value="{{ $asesmenGeriatri->berat_badan }}">
                                        </div>

                                        <div class="form-group">
                                            <label style="min-width: 220px;">Tinggi Badan (Cm)</label>
                                            <input type="number" class="form-control" name="tinggi_badan"
                                                id="tinggi_badan" placeholder="170" step="0.1" min="50"
                                                max="250" value="{{ $asesmenGeriatri->tinggi_badan }}">
                                        </div>
