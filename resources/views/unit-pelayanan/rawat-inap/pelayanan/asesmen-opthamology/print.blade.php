...
<body>
    <div class="a4">
        ...
        <table style="margin-top : 20px;">
            ...
            <!-- Riwayat Pengobatan -->
            <tr>
                <td colspan="2" class="label" style="padding-top: 0px;">Riwayat pengobatan / pemakaian obat saat
                    ini:</td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <table style="width:100%; border-collapse:collapse; margin-top:0px; ">
                        <thead>
                            ...
                            <tr>
                                <td class="value"
                                    style="text-align:left; padding:6px; border-bottom:1px solid #999;">
                                    <img src="{{ $eyeBase64 }}" width="150px" alt="Eye">
                                </td>

                                <td class="label"
                                    style="text-align:center; font-weight:bold; border-bottom:1px solid #999;">
                                    Gambar
                                </td>

                                <td class="value"
                                    style="text-align:right; padding:6px; border-bottom:1px solid #999;">
                                    <img src="{{ $eyeBase64 }}" width="150px" alt="Eye">
                                </td>
                            </tr>
                        ...
                        @foreach ($rows as $label => [$od, $os])
                            <tr style="">
                                <td class="value"
                                    style="text-align:left; height: 25px; padding:6px; border-bottom:1px solid #999;">
                                    {{ $ophtamology_komprehensif->$od ?? '' }}
                                </td>

                                <td class="label"
                                    style="text-align:center; height: 25px; font-weight:bold; border-bottom:1px solid #999;">
                                    {{ $label }}
                                </td>

                                <td class="value"
                                    style="text-align:right; height: 25px; padding:6px; border-bottom:1px solid #999;">
            ...
            <tr>
                ...
                <td class="value" style="padding:10px 6px;">
                    {{ !empty($diagnosisBanding) && count($diagnosisBanding) > 0 ? implode(', ', $diagnosisBanding) : '–' }}
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="value" style="padding:14px 6px 10px;">
                    {{ !empty($diagnosisKerja) && count($diagnosisKerja) > 0 ? implode(', ', $diagnosisKerja) : '–' }}
                </td>
            </tr>
            ...
            <tr>
                <td class="label" style="padding:18px 6px 8px; font-weight:bold;">
                    RENCANA PENATALAKSANAAN DAN PENGOBATAN
                </td>
            ...
            <tr>
                <td colspan="2" style="height:32px; padding:6px 8px; border-bottom:1px solid #999;">
                </td>
            </tr>
