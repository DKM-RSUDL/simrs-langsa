        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Asesmen Awal dan Ulang Pasien Terminal dan Keluarganya',
                    'description' =>
                        'Isikan Asesmen Keperawatan dalam 24 jam sejak pasien masuk ke unit pelayanan',
                ])

                <form method="POST"
                    action="{{ route('rawat-inap.asesmen.keperawatan.terminal.index', [
                        'kd_unit' => $kd_unit,
                        'kd_pasien' => $kd_pasien,
                        'tgl_masuk' => $tgl_masuk,
                    ...
                    <div class="px-3">
                        ...
                        <div class="form-section">
                            ...
                            <div class="checkbox-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="nafas_cepat_dangkal" id="nafas_cepat_dangkal"
                                                value="1">
                                            <label for="nafas_cepat_dangkal">Nafas cepat dan dangkal</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="nafas_melalui_mulut" id="nafas_melalui_mulut"
                                                value="1">
                            ...
                            <div class="checkbox-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="sulit_menelan" id="sulit_menelan" value="1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="penurunan_pergerakan" id="penurunan_pergerakan"
                                                value="1">
                        ...
                        <div class="form-section">
                            ...
                            <div class="checkbox-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="melakukan_aktivitas" id="melakukan_aktivitas"
                                                value="1">
                        ...
                        <div class="form-section">
                            ...
                            <div class="checkbox-group">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="masalah_nyeri_kronis" id="masalah_nyeri_kronis"
                                                value="1">
                        ...
                        <div class="form-section">
                            ...
                            <div class="radio-group">
                                <div class="radio-item">
                                    <input type="radio" name="perlu_bimbingan_rohani" id="bimbingan_tidak"
                                        value="0">
                                    <label for="bimbingan_tidak">Tidak</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" name="perlu_bimbingan_rohani" id="bimbingan_ya"
                                        value="1">
                            ...
                            <div class="radio-group">
                                <div class="radio-item">
                                    <input type="radio" name="perlu_pendampingan_rohani" id="pendampingan_tidak"
                                        value="0">
                                    <label for="pendampingan_tidak">Tidak</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" name="perlu_pendampingan_rohani" id="pendampingan_ya"
                                        value="1">
                        ...
                        <div class="form-section">
                            ...
                            <div class="radio-group">
                                <div class="radio-item">
                                    <input type="radio" name="orang_dihubungi" id="orang_dihubungi_tidak"
                                        value="0">
                            ...
                            <div class="checkbox-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="tetap_dirawat_rs" id="tetap_dirawat_rs"
                                                value="1">
                                            <label for="tetap_dirawat_rs">Tetap dirawat di RS</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="dirawat_rumah" id="dirawat_rumah"
                                                value="1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="radio-group mt-2">
                                                <div class="radio-item">
                                                    <input type="radio" name="lingkungan_rumah_siap" id="lingkungan_ya"
                                                        value="1">
                                                    <label for="lingkungan_ya">Ya</label>
                                                </div>
                                                <div class="radio-item">
                                                    <input type="radio" name="lingkungan_rumah_siap"
                                                        id="lingkungan_tidak" value="0">
                                ...
                                <div class="text-input-group mt-3">
                                    <label class="form-label">Jika Ya, apakah ada yang mampu merawat pasien di
                                        rumah?</label>
                                    <div class="radio-group mt-2">
                                        <div class="radio-item">
                                            <input type="radio" name="mampu_merawat_rumah" id="mampu_merawat_ya"
                                                value="1">
                                            <label for="mampu_merawat_ya">Ya, oleh:</label>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" name="mampu_merawat_rumah" id="mampu_merawat_tidak"
                                                value="0">
                                ...
                                <div class="text-input-group mt-3">
                                    ...
                                    <div class="radio-group mt-2">
                                        <div class="radio-item">
                                            <input type="radio" name="perlu_home_care" id="home_care_ya"
                                                value="1">
                                            <label for="home_care_ya">Ya</label>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" name="perlu_home_care" id="home_care_tidak"
                                                value="0">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="checkbox-group mt-2">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="reaksi_menyangkal" id="reaksi_menyangkal"
                                                value="1">
                                ...
                                <div class="col-md-6">
                                    <div class="checkbox-group mt-4">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="reaksi_sedih_menangis"
                                                id="reaksi_sedih_menangis" value="1">
                                            <label for="reaksi_sedih_menangis">Sedih / menangis</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="reaksi_rasa_bersalah" id="reaksi_rasa_bersalah"
                                                value="1">
                                            <label for="reaksi_rasa_bersalah">Rasa bersalah</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="reaksi_ketidak_berdayaan"
                                                id="reaksi_ketidak_berdayaan" value="1">
                            ...
                            <div class="text-input-group mt-3">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="reaksi_anxietas" id="reaksi_anxietas"
                                                value="1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="reaksi_distress_spiritual"
                                                id="reaksi_distress_spiritual" value="1">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="checkbox-group mt-2">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="keluarga_marah" id="keluarga_marah"
                                                value="1">
                                            <label for="keluarga_marah">Marah</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="keluarga_gangguan_tidur"
                                                id="keluarga_gangguan_tidur" value="1">
                                        ...
                                        <div class="checkbox-item">
                                            ...
                                            <label for="keluarga_ketidakmampuan_memenuhi_peran">Ketidakmampuan memenuhi
                                        ...
                                        <div class="checkbox-item">
                                            ...
                                            <label for="keluarga_kurang_berkomunikasi">Keluarga kurang berkomunikasi dengan
                                                pasien</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="checkbox-group mt-4">
                                        ...
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="keluarga_rasa_bersalah"
                                                id="keluarga_rasa_bersalah" value="1">
                                        ...
                                        <div class="checkbox-item">
                                            ...
                                            <label for="keluarga_perubahan_pola_komunikasi">Perubahan kebiasaan pola
                                                komunikasi</label>
                                        </div>
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="keluarga_kurang_berpartisipasi"
                                                id="keluarga_kurang_berpartisipasi" value="1">
                                            <label for="keluarga_kurang_berpartisipasi">Keluarga kurang berpartisipasi
                                                membuat keputusan dalam perawatan pasien</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-input-group mt-3">
                                ...
                                <div class="checkbox-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="checkbox-item">
                                                <input type="checkbox" name="masalah_koping_individu_tidak_efektif"
                                                    id="masalah_koping_individu_tidak_efektif" value="1">
                                                <label for="masalah_koping_individu_tidak_efektif">Koping individu tidak
                                                    efektif</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="checkbox-item">
                                                <input type="checkbox" name="masalah_distress_spiritual"
                                                    id="masalah_distress_spiritual" value="1">
                    ...
                    <div class="form-section">
                        ...
                        <div class="checkbox-group">
                            <div class="checkbox-item">
                                <input type="checkbox" name="pasien_perlu_didampingi" id="pasien_perlu_didampingi"
                                    value="1">
                                <label for="pasien_perlu_didampingi">Pasien perlu didampingi keluarga</label>
                            </div>
                            <div class="checkbox-item">
                                <input type="checkbox" name="keluarga_dapat_mengunjungi_luar_waktu"
                                    id="keluarga_dapat_mengunjungi_luar_waktu" value="1">
                                <label for="keluarga_dapat_mengunjungi_luar_waktu">Keluarga dapat mengunjungi pasien di
                                    luar waktu berkunjung</label>
                            </div>
                            <div class="checkbox-item">
                                <input type="checkbox" name="sahabat_dapat_mengunjungi" id="sahabat_dapat_mengunjungi"
                                    value="1">
                                <label for="sahabat_dapat_mengunjungi">Sahabat dapat mengunjungi pasien di luar waktu
                                    berkunjung</label>
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="checkbox-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="alternatif_tidak" id="alternatif_tidak"
                                            value="0">
                                        <label for="alternatif_tidak">Tidak</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="alternatif_autopsi" id="alternatif_autopsi"
                                            value="1">
                                ...
                                <div class="col-md-6">
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="alternatif_donasi_organ"
                                            id="alternatif_donasi_organ" value="1">
                                        <label for="alternatif_donasi_organ">Donasi Organ:</label>
                                    </div>
                                    <!-- Field keterangan donasi organ langsung di bawah checkbox -->
                                    <div class="text-input-group mt-2" id="donasi_organ_keterangan"
                                        style="display: none;">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="checkbox-group mt-2">
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_marah" id="faktor_resiko_marah"
                                            value="1">
                                        <label for="faktor_resiko_marah">Marah</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_depresi" id="faktor_resiko_depresi"
                                            value="1">
                                        <label for="faktor_resiko_depresi">Depresi</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_rasa_bersalah"
                                            id="faktor_resiko_rasa_bersalah" value="1">
                                        <label for="faktor_resiko_rasa_bersalah">Rasa bersalah</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_perubahan_kebiasaan"
                                            id="faktor_resiko_perubahan_kebiasaan" value="1">
                                        <label for="faktor_resiko_perubahan_kebiasaan">Perubahan kebiasaan pola
                                            komunikasi</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_tidak_mampu_memenuhi"
                                            id="faktor_resiko_tidak_mampu_memenuhi" value="1">
                                        <label for="faktor_resiko_tidak_mampu_memenuhi">Ketidak mampuan memenuhi peran yang
                                            diharapkan</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="checkbox-group mt-4">
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_leth_lelah"
                                            id="faktor_resiko_leth_lelah" value="1">
                                        <label for="faktor_resiko_leth_lelah">Letih/lelah</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_gangguan_tidur"
                                            id="faktor_resiko_gangguan_tidur" value="1">
                                        <label for="faktor_resiko_gangguan_tidur">Gangguan tidur</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_sedih_menangis"
                                            id="faktor_resiko_sedih_menangis" value="1">
                                        <label for="faktor_resiko_sedih_menangis">Sedih/menangis</label>
                                    </div>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="faktor_resiko_penurunan_konsentrasi"
                                            id="faktor_resiko_penurunan_konsentrasi" value="1">
                        ...
                        <div class="text-input-group mt-3">
                            ...
                            <div class="checkbox-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="masalah_koping_keluarga_tidak_efektif"
                                                id="masalah_koping_keluarga_tidak_efektif" value="1">
                                            <label for="masalah_koping_keluarga_tidak_efektif">Koping keluarga tidak
                                                efektif</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="checkbox-item">
                                            <input type="checkbox" name="masalah_distress_spiritual_keluarga"
                                                id="masalah_distress_spiritual_keluarga" value="1">
