...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="">
            <div class="card-body">
                <h4 class="header-asesmen"><span class="text-info">Detail</span> Asesmen Awal Keperawatan Rawat Inap Dewasa</h4>
                <p class="text-muted">
                ...
                <form method="" action="" class="mt-4">
                    ...
                    <div class="section-separator" id="data-umum">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="date" class="form-control" name="tanggal" id="tanggal_masuk"
                                            value="{{ old('tanggal', $asesmen->asesmenKetDewasaRanap->tanggal ?? date('Y-m-d')) }}" required disabled>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="time" class="form-control" name="jam" id="jam_masuk"
                                            value="{{ old('jam', $asesmen->asesmenKetDewasaRanap->jam ? substr($asesmen->asesmenKetDewasaRanap->jam, 0, 5) : date('H:i')) }}" required disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="status[]" id="berdiri" value="berdiri"
                                        {{ in_array('berdiri', old('status', $asesmen->asesmenKetDewasaRanap->status ?? [])) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="berdiri">Berdiri</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="status[]" id="tidur" value="tidur"
                                        {{ in_array('tidur', old('status', $asesmen->asesmenKetDewasaRanap->status ?? [])) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="tidur">Tidur</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="status[]" id="duduk" value="duduk"
                                        {{ in_array('duduk', old('status', $asesmen->asesmenKetDewasaRanap->status ?? [])) ? 'checked' : '' }} disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kondisi_masuk" id="mandiri" value="mandiri"
                                    {{ old('kondisi_masuk', $asesmen->asesmenKetDewasaRanap->kondisi_masuk ?? '') === 'mandiri' ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="mandiri">Mandiri</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kondisi_masuk" id="tempat_tidur" value="tempat_tidur"
                                    {{ old('kondisi_masuk', $asesmen->asesmenKetDewasaRanap->kondisi_masuk ?? '') === 'tempat_tidur' ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="tempat_tidur">Tempat tidur</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="kondisi_masuk" id="lainnya_kondisi" value="lainnya"
                                    {{ old('kondisi_masuk', $asesmen->asesmenKetDewasaRanap->kondisi_masuk ?? '') === 'lainnya' ? 'checked' : '' }} disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="kd_dokter" id="kd_dokter" class="form-select select2" required disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="barang_berharga" id="perhiasan" value="perhiasan"
                                    {{ old('barang_berharga', $asesmen->asesmenKetDewasaRanap->barang_berharga ?? '') === 'perhiasan' ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="perhiasan">Perhiasan</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="barang_berharga" id="uang" value="uang"
                                    {{ old('barang_berharga', $asesmen->asesmenKetDewasaRanap->barang_berharga ?? '') === 'uang' ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="uang">Uang</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="barang_berharga" id="lainnya_barang" value="lainnya"
                                    {{ old('barang_berharga', $asesmen->asesmenKetDewasaRanap->barang_berharga ?? '') === 'lainnya' ? 'checked' : '' }} disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="data_umum_alat_bantu[]" id="kacamata" value="kacamata"
                                    {{ in_array('kacamata', old('data_umum_alat_bantu', $asesmen->asesmenKetDewasaRanap->data_umum_alat_bantu ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="kacamata">Kacamata</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="data_umum_alat_bantu[]" id="lensa_kontak" value="lensa_kontak"
                                    {{ in_array('lensa_kontak', old('data_umum_alat_bantu', $asesmen->asesmenKetDewasaRanap->data_umum_alat_bantu ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="lensa_kontak">Lensa kontak</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="data_umum_alat_bantu[]" id="gigi_palsu" value="gigi_palsu"
                                    {{ in_array('gigi_palsu', old('data_umum_alat_bantu', $asesmen->asesmenKetDewasaRanap->data_umum_alat_bantu ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="gigi_palsu">Gigi palsu</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="data_umum_alat_bantu[]" id="alat_bantu_dengar" value="alat_bantu_dengar"
                                    {{ in_array('alat_bantu_dengar', old('data_umum_alat_bantu', $asesmen->asesmenKetDewasaRanap->data_umum_alat_bantu ?? [])) ? 'checked' : '' }} disabled>
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('hypertensi', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('infark_myiokard', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('stroke', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('jantung_koroner', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('opok', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_pasien_opok">PPOK</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        id="riwayat_pasien_asthma" value="asthma"
                                        {{ in_array('asthma', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_pasien_asthma">Asthma</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        id="riwayat_pasien_tb" value="tb"
                                        {{ in_array('tb', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('penyakit_paru_lainnya', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('diabetes_mellitus', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('hepatitis', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_pasien_hepatitis">Hepatitis</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        id="riwayat_pasien_ulkus" value="ulkus"
                                        {{ in_array('ulkus', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_pasien_ulkus">Ulkus</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        id="riwayat_pasien_gagal_ginjal" value="gagal_ginjal"
                                        {{ in_array('gagal_ginjal', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        ...
                                        {{ in_array('kanker', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_pasien_kanker">Kanker</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        id="riwayat_pasien_kejang" value="kejang"
                                        {{ in_array('kejang', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_pasien_kejang">Kejang</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_pasien[]"
                                        id="riwayat_pasien_jiwa" value="jiwa"
                                        {{ in_array('jiwa', old('riwayat_pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien ?? [])) ? 'checked' : '' }} disabled>
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        ...
                                        {{ in_array('penyakit_jantung', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_penyakit_jantung">Penyakit jantung</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_hypertensi" value="hypertensi"
                                        {{ in_array('hypertensi', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_hypertensi">Hypertensi</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_stroke" value="stroke"
                                        {{ in_array('stroke', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_stroke">Stroke</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_asthma" value="asthma"
                                        {{ in_array('asthma', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        ...
                                        {{ in_array('gangguan_jiwa', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_gangguan_jiwa">Gangguan jiwa</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_gagal_ginjal" value="gagal_ginjal"
                                        {{ in_array('gagal_ginjal', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_gagal_ginjal">Gagal ginjal</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_lainnya_checkbox" value="lainnya"
                                        {{ in_array('lainnya', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_lainnya_checkbox">Lainnya</label>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-wrap gap-3 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        ...
                                        {{ in_array('kanker', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_kanker">Kanker</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_kejang" value="kejang"
                                        {{ in_array('kejang', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        ...
                                        {{ in_array('gangguan_hematologi', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_gangguan_hematologi">Gangguan hematologi</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_diabetes" value="diabetes"
                                        {{ in_array('diabetes', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_diabetes">Diabetes</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_hepatitis" value="hepatitis"
                                        {{ in_array('hepatitis', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                                    <label class="form-check-label" for="riwayat_keluarga_hepatitis">Hepatitis</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="riwayat_keluarga[]"
                                        id="riwayat_keluarga_tb" value="tb"
                                        {{ in_array('tb', old('riwayat_keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_keluarga ?? [])) ? 'checked' : '' }} disabled>
                        ...
                        <div class="section-separator" id="psikososial-ekonomi">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_status_pernikahan"
                                                id="menikah" value="menikah"
                                                {{ old('menikah', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_pernikahan ?? '') === 'menikah' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="menikah">Menikah</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_status_pernikahan"
                                                id="belum_menikah" value="belum_menikah"
                                                {{ old('belum_menikah', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_pernikahan ?? '') === 'belum_menikah' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="belum_menikah">Belum menikah</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_status_pernikahan"
                                                id="duda_janda" value="duda_janda"
                                                {{ old('duda_janda', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_pernikahan ?? '') === 'duda_janda' ? 'checked' : '' }} disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_keluarga"
                                                id="tinggal_serumah" value="tinggal_serumah"
                                                {{ old('tinggal_serumah', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_keluarga ?? '') === 'tinggal_serumah' ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_keluarga"
                                                ...
                                                {{ old('tinggal_sendiri', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_keluarga ?? '') === 'tinggal_sendiri' ? 'checked' : '' }} disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex flex-wrap gap-3 align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_tempat_tinggal"
                                                id="rumah" value="rumah"
                                                {{ old('rumah', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_tempat_tinggal ?? '') === 'rumah' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="rumah">Rumah</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_tempat_tinggal"
                                                id="panti_asuhan" value="panti_asuhan"
                                                {{ old('panti_asuhan', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_tempat_tinggal ?? '') === 'panti_asuhan' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="panti_asuhan">Panti asuhan</label>
                                        </div>
                                        <div class="form-check d-flex align-items-center">
                                            <input class="form-check-input" type="radio" name="psikososial_tempat_tinggal"
                                                id="tempat_tinggal_lainnya" value="lainnya"
                                                {{ old('lainnya', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_tempat_tinggal ?? '') === 'lainnya' ? 'checked' : '' }} disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="purnawaktu" value="purnawaktu"
                                                {{ in_array('purnawaktu', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="purnawaktu">Purnawaktu</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="paruh_waktu" value="paruh_waktu"
                                                {{ in_array('paruh_waktu', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="paruh_waktu">Paruh waktu</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="pensiunan" value="pensiunan"
                                                {{ in_array('pensiunan', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="pensiunan">Pensiunan</label>
                                        </div>
                                        <div class="form-check d-flex align-items-center">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="aktivitas_lainnya" value="lainnya"
                                                {{ in_array('lainnya', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label me-2"
                                    ...
                                    <div class="d-flex flex-wrap gap-3 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                ...
                                                {{ in_array('mandiri', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="aktivitas_mandiri">Mandiri</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="tongkat" value="tongkat"
                                                {{ in_array('tongkat', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="tongkat">Tongkat</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="kursi_roda" value="kursi_roda"
                                                {{ in_array('kursi_roda', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kursi_roda">Kursi roda</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="tirah_baring" value="tirah_baring"
                                                {{ in_array('tirah_baring', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="tirah_baring">Tirah baring</label>
                                        </div>
                                        <div class="form-check d-flex align-items-center">
                                            <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                                id="aktivitas_lainnya2" value="lainnya2"
                                                {{ in_array('lainnya2', old('psikososial_aktivitas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_aktivitas ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label me-2"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_curiga_penganiayaan"
                                                id="curiga_ya" value="ya"
                                                {{ old('ya', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_curiga_penganiayaan ?? '') === 'ya' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="curiga_ya">Ya</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_curiga_penganiayaan"
                                                id="curiga_tidak" value="tidak"
                                                {{ old('tidak', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_curiga_penganiayaan ?? '') === 'tidak' ? 'checked' : '' }} disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_status_emosional"
                                                id="kooperatif" value="kooperatif"
                                                {{ old('kooperatif', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_emosional ?? '') === 'kooperatif' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kooperatif">Kooperatif</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_status_emosional"
                                                id="cemas" value="cemas"
                                                {{ old('cemas', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_emosional ?? '') === 'cemas' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="cemas">Cemas</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_status_emosional"
                                                id="depresi" value="depresi"
                                                {{ old('depresi', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_emosional ?? '') === 'depresi' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="depresi">Depresi</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="psikososial_status_emosional"
                                                id="ingin_mengakhiri_hidup" value="ingin_mengakhiri_hidup"
                                                {{ old('ingin_mengakhiri_hidup', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_emosional ?? '') === 'ingin_mengakhiri_hidup' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check d-flex align-items-center">
                                            <input class="form-check-input" type="radio" name="psikososial_status_emosional"
                                                ...
                                                {{ old('lainnya', $asesmen->asesmenKetDewasaRanapRiwayatPasien->psikososial_status_emosional ?? '') === 'lainnya' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label me-2"
                                    ...
                                    <div class="d-flex flex-wrap gap-3 align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="informasi_didapat_dari"
                                                ...
                                                {{ old('pasien', $asesmen->asesmenKetDewasaRanapRiwayatPasien->informasi_didapat_dari ?? '') === 'pasien' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="pasien">Pasien</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="informasi_didapat_dari"
                                                id="keluarga_info" value="keluarga"
                                                {{ old('keluarga', $asesmen->asesmenKetDewasaRanapRiwayatPasien->informasi_didapat_dari ?? '') === 'keluarga' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="keluarga_info">Keluarga</label>
                                        </div>
                                        <div class="form-check d-flex align-items-center">
                                            <input class="form-check-input" type="radio" name="informasi_didapat_dari"
                                                id="informasi_lainnya" value="lainnya"
                                                {{ old('lainnya', $asesmen->asesmenKetDewasaRanapRiwayatPasien->informasi_didapat_dari ?? '') === 'lainnya' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label me-2"
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="agama[]"
                                                ...
                                                {{ in_array('islam', old('agama', $asesmen->asesmenKetDewasaRanapRiwayatPasien->agama ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="agama_islam">Islam</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="agama[]"
                                                id="agama_katolik" value="katolik"
                                                {{ in_array('katolik', old('agama', $asesmen->asesmenKetDewasaRanapRiwayatPasien->agama ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="agama_katolik">Katolik</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="agama[]"
                                                id="agama_protestan" value="protestan"
                                                {{ in_array('protestan', old('agama', $asesmen->asesmenKetDewasaRanapRiwayatPasien->agama ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="agama_protestan">Protestan</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="agama[]"
                                                id="agama_budha" value="budha"
                                                {{ in_array('budha', old('agama', $asesmen->asesmenKetDewasaRanapRiwayatPasien->agama ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="agama_budha">Budha</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="agama[]"
                                                id="agama_hindu" value="hindu"
                                                {{ in_array('hindu', old('agama', $asesmen->asesmenKetDewasaRanapRiwayatPasien->agama ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="agama_hindu">Hindu</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="agama[]"
                                                id="agama_konghucu" value="konghucu"
                                                {{ in_array('konghucu', old('agama', $asesmen->asesmenKetDewasaRanapRiwayatPasien->agama ?? [])) ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="d-flex flex-wrap gap-3 align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="pandangan_spiritual"
                                                ...
                                                {{ old('takdir', $asesmen->asesmenKetDewasaRanapRiwayatPasien->pandangan_spiritual ?? '') === 'takdir' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="pandangan_takdir">Takdir</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="pandangan_spiritual"
                                                id="pandangan_hukuman" value="hukuman"
                                                {{ old('hukuman', $asesmen->asesmenKetDewasaRanapRiwayatPasien->pandangan_spiritual ?? '') === 'hukuman' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="pandangan_hukuman">Hukuman</label>
                                        </div>
                                        <div class="form-check d-flex align-items-center">
                                            <input class="form-check-input" type="radio" name="pandangan_spiritual"
                                                id="pandangan_lainnya" value="lainnya"
                                                {{ old('lainnya', $asesmen->asesmenKetDewasaRanapRiwayatPasien->pandangan_spiritual ?? '') === 'lainnya' ? 'checked' : '' }} disabled>
                                            <label class="form-check-label me-2"
                    ...
                    <div class="section-separator" id="pemeriksaan-fisik">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="mata_telinga_hidung_normal"
                                        ...
                                        {{ old('mata_telinga_hidung_normal', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung_normal ?? '') == 'normal' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                {{ in_array('gangguan_visus', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="gangguan_visus">Gangguan visus</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="galucoma" value="galucoma"
                                                {{ in_array('galucoma', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                {{ in_array('sulit_mendengar', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="sulit_mendengar">Sulit mendengar</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="gusi" value="gusi"
                                                {{ in_array('gusi', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="gusi">Gusi</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="kemerahan" value="kemerahan"
                                                {{ in_array('kemerahan', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kemerahan">Kemerahan</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="drainase" value="drainase"
                                                {{ in_array('drainase', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="drainase">Drainase</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="buta" value="buta"
                                                {{ in_array('buta', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="buta">Buta</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="tuli" value="tuli"
                                                {{ in_array('tuli', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="tuli">Tuli</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="gigi" value="gigi"
                                                {{ in_array('gigi', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                value="rasa_terbakar"
                                                {{ in_array('rasa_terbakar', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="rasa_terbakar">Rasa terbakar</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="luka" value="luka"
                                                {{ in_array('luka', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="luka">Luka</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="mata_telinga_hidung[]" id="lainnya" value="lainnya"
                                                {{ in_array('lainnya', old('mata_telinga_hidung', $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung ?? [])) ? 'checked' : '' }} disabled>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_paru_normal"
                                        ...
                                        {{ old('pemeriksaan_paru_normal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru_normal ?? '') == 'normal' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                ...
                                                {{ in_array('asimetris', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="asimetris">Asimetris</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="takipnea" value="takipnea"
                                                {{ in_array('takipnea', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="takipnea">Takipnea</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="ronki" value="ronki"
                                                {{ in_array('ronki', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="ronki">Ronki</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="kiri_1" value="kiri_1"
                                                {{ in_array('kiri_1', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kiri_1">Kiri</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="kanan_1" value="kanan_1"
                                                {{ in_array('kanan_1', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kanan_1">Kanan</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="batuk" value="batuk"
                                                {{ in_array('batuk', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="batuk">Batuk</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="barrel_chest" value="barrel_chest"
                                                {{ in_array('barrel_chest', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="barrel_chest">Barrel chest</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="bradipnea_1" value="bradipnea_1"
                                                {{ in_array('bradipnea_1', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="bradipnea_1">Bradipnea</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="mengi_wheezing" value="mengi_wheezing"
                                                {{ in_array('mengi_wheezing', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                ...
                                                {{ in_array('kiri_2', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kiri_2">Kiri</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="kanan_2" value="kanan_2"
                                                {{ in_array('kanan_2', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kanan_2">Kanan</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="warna_dahak" value="warna_dahak"
                                                {{ in_array('warna_dahak', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="warna_dahak">Warna dahak</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="sesak" value="sesak"
                                                {{ in_array('sesak', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="sesak">Sesak</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="dangkal" value="dangkal"
                                                {{ in_array('dangkal', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="dangkal">Dangkal</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="menghilang" value="menghilang"
                                                {{ in_array('menghilang', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="menghilang">Menghilang</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="kiri_3" value="kiri_3"
                                                {{ in_array('kiri_3', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kiri_3">Kiri</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="kanan_3" value="kanan_3"
                                                {{ in_array('kanan_3', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                                            <label class="form-check-label" for="kanan_3">Kanan</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_paru[]"
                                                id="lainnya_paru" value="lainnya"
                                                {{ in_array('lainnya', old('pemeriksaan_paru', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru ?? [])) ? 'checked' : '' }} disabled>
                        ...
                        <div class="form-section mt-3">
                            <div class="section-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check normal-checkbox">
                                    <input class="form-check-input" type="checkbox"
                                        name="pemeriksaan_gastrointestinal_normal" id="pemeriksaan_gastrointestinal_normal" value="normal"
                                        {{ old('pemeriksaan_gastrointestinal_normal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal_normal ?? '') == 'normal' ? 'checked' : '' }} disabled>
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('distensi', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('bising_usus_menurun', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('anoreksia', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('disfagia', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('diare', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('klisma_sput_gliserin', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('mual_muntah', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('bising_usus_menurun2', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('intoleransi_diet', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('konstipasi', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                                        ...
                                        {{ in_array('bab_berakhir', old('pemeriksaan_gastrointestinal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal ?? [])) ? 'checked' : '' }} disabled>
                            ...
                            <div class="section-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="form-check normal-checkbox">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular_normal" id="pemeriksaan_kardiovaskular_normal" value="normal"
                                        {{ old('pemeriksaan_kardiovaskular_normal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular_normal ?? '') == 'normal' ? 'checked' : '' }} disabled>
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_takikardi" value="takikardi"
                                        {{ in_array('takikardi', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_iregular" value="iregular"
                                        {{ in_array('iregular', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_tingling" value="tingling"
                                        {{ in_array('tingling', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_edema" value="edema"
                                        {{ in_array('edema', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_denyutnadilemah" value="denyut_nadi_lemah"
                                        {{ in_array('denyut_nadi_lemah', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_bradikardi" value="bradikardi"
                                        {{ in_array('bradikardi', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_murmur" value="murmur"
                                        {{ in_array('murmur', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_baal" value="baal"
                                        {{ in_array('baal', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_fatique" value="fatique"
                                        {{ in_array('fatique', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular[]" id="pemeriksaan_kardiovaskular_denyuttidakada" value="denyut_tidak_ada"
                                        {{ in_array('denyut_tidak_ada', old('pemeriksaan_kardiovaskular', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular ?? [])) ? 'checked' : '' }} disabled>
                        ...
                        <div class="mb-4 mt-3">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi_normal"
                                        id="pemeriksaan_genitourinaria_ginekologi_normal" value="normal"
                                        {{ old('pemeriksaan_genitourinaria_ginekologi_normal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi_normal ?? '') == 'normal' ? 'checked' : '' }} disabled>
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                id="pemeriksaan_genitourinaria_ginekologi_kateteri" value="kateter"
                                                {{ in_array('kateter', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('hesitansi', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('hematuria', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('menopouse', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('sekret_abnormal', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('urostomy', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('inkontinesia', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('nokturia', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('disuria', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('menstruasi_terakhir', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_genitourinaria_ginekologi[]"
                                                ...
                                                {{ in_array('hamil', old('pemeriksaan_genitourinaria_ginekologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi ?? [])) ? 'checked' : '' }} disabled>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi_normal" id="pemeriksaan_neurologi_normal" value="normal"
                                        {{ old('pemeriksaan_neurologi_normal', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi_normal ?? '') == 'normal' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_neurologi_dalam_sedasi" value="dalam_sedasi"
                                                {{ in_array('dalam_sedasi', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_neurologi_vertigo" value="vertigo"
                                                {{ in_array('vertigo', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_neurologi_afasia" value="afasia"
                                                {{ in_array('afasia', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_neurologi_tremor" value="tremor"
                                                {{ in_array('tremor', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_neurologi_tidak_stabil" value="tidak_stabil"
                                                {{ in_array('tidak_stabil', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_neurologi_letargi" value="letargi"
                                                {{ in_array('letargi', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_sakit_kepala" value="sakit_kepala"
                                                {{ in_array('sakit_kepala', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_Bicara_tidak_jelas" value="Bicara_tidak_jelas"
                                                {{ in_array('Bicara_tidak_jelas', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_baal" value="baal"
                                                {{ in_array('baal', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_paralisis" value="paralisis"
                                                {{ in_array('paralisis', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_semi_koma" value="semi_koma"
                                                {{ in_array('semi_koma', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_pupil_tidak_reaktif" value="pupil_tidak_reaktif"
                                                {{ in_array('pupil_tidak_reaktif', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_kejang" value="kejang"
                                                {{ in_array('kejang', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_tingling" value="tingling"
                                                {{ in_array('tingling', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_genggaman_lemah" value="genggaman_lemah"
                                                {{ in_array('genggaman_lemah', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]" id="pemeriksaan_genitourinaria_lainnya" value="lainnya"
                                                {{ in_array('lainnya', old('pemeriksaan_neurologi', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_neurologi ?? [])) ? 'checked' : '' }} disabled>
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="kesadaran[]"
                                            ...
                                            {{ in_array('compos_mentis', old('kesadaran', $asesmen->asesmenKetDewasaRanapFisik->kesadaran ?? [])) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="kesadaran_compos_mentis">Compos mentis</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="kesadaran[]"
                                            id="kesadaran_apatis" value="apatis"
                                            {{ in_array('apatis', old('kesadaran', $asesmen->asesmenKetDewasaRanapFisik->kesadaran ?? [])) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="kesadaran_apatis">Apatis</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="kesadaran[]"
                                            id="kesadaran_somnolen" value="somnolen"
                                            {{ in_array('somnolen', old('kesadaran', $asesmen->asesmenKetDewasaRanapFisik->kesadaran ?? [])) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="kesadaran_somnolen">Somnolen</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="kesadaran[]"
                                            id="kesadaran_sopor_koma" value="sopor_koma"
                                            {{ in_array('sopor_koma', old('kesadaran', $asesmen->asesmenKetDewasaRanapFisik->kesadaran ?? [])) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="kesadaran_sopor_koma">Sopor Koma</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="kesadaran[]"
                                            id="kesadaran_koma" value="koma"
                                            {{ in_array('koma', old('kesadaran', $asesmen->asesmenKetDewasaRanapFisik->kesadaran ?? [])) ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check mb-2">
                                                ...
                                                {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->bb_turun == 0 ? 'checked' : '' }} disabled>
                                                <label class="form-check-label" for="bb_tidak_ada">Tidak ada <span class="badge bg-secondary ms-2">Skor: 0</span></label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="bb_turun" id="bb_tidak_yakin" value="2"
                                                {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->bb_turun == 2 ? 'checked' : '' }} disabled>
                                                <label class="form-check-label" for="bb_tidak_yakin">Tidak yakin / tidak tahu / terasa baju longgar <span class="badge bg-secondary ms-2">Skor: 2</span></label>
                                            </div>
                                        </div>
                                        <div class="ms-3">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-2">
                                                    <div class="form-check">
                                                        ...
                                                        {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->bb_turun_range == 1 ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="bb_1_5kg">1 sd 5 Kg <span class="badge bg-secondary ms-2">Skor: 1</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="bb_turun_range" id="bb_6_10kg" value="2"
                                                        {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->bb_turun_range == 2 ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="bb_6_10kg">6 sd 10 Kg <span class="badge bg-secondary ms-2">Skor: 2</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="bb_turun_range" id="bb_11_15kg" value="3"
                                                        {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->bb_turun_range == 3 ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="bb_11_15kg">11 sd 15 Kg <span class="badge bg-secondary ms-2">Skor: 3</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-12 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="bb_turun_range" id="bb_lebih_15kg" value="4"
                                                        {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->bb_turun_range == 4 ? 'checked' : '' }} disabled>
                                                        <label class="form-check-label" for="bb_lebih_15kg">> 15 Kg <span class="badge bg-secondary ms-2">Skor: 4</span></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check mb-2">
                                                ...
                                                {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->nafsu_makan == 0 ? 'checked' : '' }} disabled>
                                                <label class="form-check-label" for="nafsu_tidak">Tidak <span class="badge bg-secondary ms-2">Skor: 0</span></label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="radio" name="nafsu_makan" id="nafsu_ya" value="1"
                                                {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->nafsu_makan == 1 ? 'checked' : '' }} disabled>
                                                <label class="form-check-label" for="nafsu_ya">Ya <span class="badge bg-secondary ms-2">Skor: 1</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-check-inline me-4">
                                                ...
                                                {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->diagnosa_khusus == 'ya' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check form-check-inline">
                                                ...
                                                {{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->diagnosa_khusus == 'tidak' ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="mb-3 text-center">
                                            ...
                                            <div class="display-1 text-primary fw-bold" id="total_skor_display">{{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->status_nutrisi_total }}</div>
                                            <input type="hidden" id="total_skor_nutrisi" value="{{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->status_nutrisi_total }}" name="status_nutrisi_total">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="mt-2">
                                    <small class="text-muted">
                                        Nilai: <span id="debugNilai">{{ old('skala_nyeri', $asesmen->asesmenKetDewasaRanapSkalaNyeri->skala_nyeri ?? 0) }}</span> |
                                        Tipe: <span id="debugTipe">{{ old('tipe_skala_nyeri', $asesmen->asesmenKetDewasaRanapSkalaNyeri->tipe_skala_nyeri ?? 'numeric') }}</span>
                                    </small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="btn-group mb-3" role="group">
                                    <button type="button" class="btn btn-sm" id="numericBtn" data-scale="numeric">A. Numeric Rating Pain Scale</button>
                                    <button type="button" class="btn btn-sm" id="wongBakerBtn" data-scale="wong-baker">B. Wong Baker Faces Pain Scale</button>
                                </div>

                                <div class="pain-scale-container">
                                    <div id="numericScale" class="pain-scale-image" style="display: {{ (old('tipe_skala_nyeri', $asesmen->asesmenKetDewasaRanapSkalaNyeri->tipe_skala_nyeri ?? 'numeric') == 'numeric') ? 'block' : 'none' }};">
                                        <div class="card">
                                            <div class="card-body text-center">
                                                <h6 class="card-title">Numeric Rating Pain Scale</h6>
                                                <img src="{{ asset('assets/img/asesmen/numerik.png') }}" alt="Numeric Pain Scale" class="img-fluid" style="max-width: auto; height: auto;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                                    ...
                                    <div id="wongBakerScale" class="pain-scale-image" style="display: {{ (old('tipe_skala_nyeri', $asesmen->asesmenKetDewasaRanapSkalaNyeri->tipe_skala_nyeri ?? 'numeric') == 'wong-baker') ? 'block' : 'none' }};">
                                        <div class="card">
                                            <div class="card-body text-center">
                                                <h6 class="card-title">Wong Baker Faces Pain Scale</h6>
                                                <img src="{{ asset('assets/img/asesmen/asesmen.jpeg') }}" alt="Wong Baker Pain Scale" class="img-fluid" style="max-width: auto; height: auto;" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                                                <div style="display: none; padding: 20px;">
                                                    <p><strong>Wong Baker Faces Pain Rating Scale</strong></p>
                                                    <div class="row">
                                                        <div class="col-2 text-center"><div style="font-size: 24px;">😊</div><small>0<br>Tidak Nyeri</small></div>
                                                        <div class="col-2 text-center"><div style="font-size: 24px;">🙂</div><small>2<br>Sedikit</small></div>
                                                        <div class="col-2 text-center"><div style="font-size: 24px;">😐</div><small>4<br>Sedikit Lebih</small></div>
                                                        <div class="col-2 text-center"><div style="font-size: 24px;">😣</div><small>6<br>Lebih</small></div>
                                                        <div class="col-2 text-center"><div style="font-size: 24px;">😖</div><small>8<br>Sangat</small></div>
                                                        <div class="col-2 text-center"><div style="font-size: 24px;">😭</div><small>10<br>Terburuk</small></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="jenis_nyeri[]" id="jenis_nyeri_akut" value="akut"
                                            {{ in_array('akut', old('jenis_nyeri', $asesmen->asesmenKetDewasaRanapSkalaNyeri->jenis_nyeri ?? [])) ? 'checked' : '' }} disabled>
                                        <label class="form-check-label" for="jenis_nyeri_akut">Akut</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="jenis_nyeri[]" id="jenis_nyeri_kronik" value="kronik"
                                            {{ in_array('kronik', old('jenis_nyeri', $asesmen->asesmenKetDewasaRanapSkalaNyeri->jenis_nyeri ?? [])) ? 'checked' : '' }} disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="frekuensi_nyeri[]" id="frekuensi_jarang" value="jarang"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="frekuensi_nyeri[]" id="frekuensi_hilang_timbul" value="hilang_timbul"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="frekuensi_nyeri[]" id="frekuensi_terus_menerus" value="terus_menerus"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="radio" name="nyeri_menjalar" id="nyeri_menjalar_tidak" value="tidak"
                                        ...
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="radio" name="nyeri_menjalar" id="nyeri_menjalar_ya" value="ya"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="kualitas_nyeri[]" id="kualitas_nyeri_tumpul" value="nyeri_tumpul"
                                                {{ in_array('nyeri_tumpul', old('kualitas_nyeri', $asesmen->asesmenKetDewasaRanapSkalaNyeri->kualitas_nyeri ?? [])) ? 'checked' : '' }}>
                                            <label disabled class="form-check-label" for="kualitas_nyeri_tumpul">Nyeri tumpul</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="kualitas_nyeri[]" id="kualitas_nyeri_tajam" value="nyeri_tajam"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="kualitas_nyeri[]" id="kualitas_nyeri_panas" value="panas_terbakar"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_cahaya" value="cahaya"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_gelap" value="gelap"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_berbaring" value="berbaring"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_gerakan" value="gerakan"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_cahaya" value="cahaya"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_gelap" value="gelap"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_sunyi" value="sunyi"
                                                {{ in_array('sunyi', old('faktor_peringan', $asesmen->asesmenKetDewasaRanapSkalaNyeri->faktor_peringan ?? [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="faktor_peringan_sunyi">Sunyi</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_dingin" value="Dingin"
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_lainnya" value="lainnya"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_mual" value="mual_muntah"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_tidur" value="tidur"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_nafsu_makan" value="nafsu_makan"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check mb-2">
                                            <input disabled class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_emosi" value="emosi"
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_lainnya" value="lainnya"
                    ...
                    <div class="section-separator" id="risiko_jatuh">
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select custom-select" id="risikoJatuhSkala" name="resiko_jatuh_jenis" onchange="showForm(this.value)">
                                <option value="">--Pilih Skala--</option>
                                <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_jatuh_jenis ?? '') == '1' ? 'selected' : '' }}>Skala Umum</option>
                                <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_jatuh_jenis ?? '') == '2' ? 'selected' : '' }}>Skala Morse</option>
                                <option value="4" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_jatuh_jenis ?? '') == '4' ? 'selected' : '' }}>Skala Ontario Modified Stratify Sydney / Lansia</option>
                                <option value="5" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_jatuh_jenis ?? '') == '5' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        </div>

                        <!-- Form Skala Umum -->
                        <div id="skala_umumForm" class="risk-form" style="display: {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_jatuh_jenis ?? '') == '1' ? 'block' : 'none' }};">
                            ...
                            <div class="question-card">
                                ...
                                <select disabled class="form-select custom-select" name="risiko_jatuh_umum_usia" onchange="updateConclusion('umum')">
                                    <option value="">Pilih jawaban</option>
                                    <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_usia ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_usia ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>
                            ...
                            <div class="question-card">
                                ...
                                <select disabled class="form-select custom-select" onchange="updateConclusion('umum')" name="risiko_jatuh_umum_kondisi_khusus">
                                    <option value="">Pilih jawaban</option>
                                    <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_kondisi_khusus ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_kondisi_khusus ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>

                            <div class="question-card">
                                <div class="question-text">Apakah pasien didiagnosis sebagai pasien dengan penyakit parkinson?</div>
                                <select disabled class="form-select custom-select" onchange="updateConclusion('umum')" name="risiko_jatuh_umum_diagnosis_parkinson">
                                    <option value="">Pilih jawaban</option>
                                    <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_diagnosis_parkinson ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_diagnosis_parkinson ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>
                            ...
                            <div class="question-card">
                                ...
                                <select disabled class="form-select custom-select" onchange="updateConclusion('umum')" name="risiko_jatuh_umum_pengobatan_berisiko">
                                    <option value="">Pilih jawaban</option>
                                    <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_pengobatan_berisiko ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_pengobatan_berisiko ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>
                            ...
                            <div class="question-card">
                                ...
                                <select disabled class="form-select custom-select" onchange="updateConclusion('umum')" name="risiko_jatuh_umum_lokasi_berisiko">
                                    <option value="">Pilih jawaban</option>
                                    <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_lokasi_berisiko ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                    <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_lokasi_berisiko ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                </select>
                            </div>

                            <div class="conclusion alert alert-success">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanUmum">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_kesimpulan ?? 'Tidak berisiko jatuh' }}</span></p>
                                <input type="hidden" name="risiko_jatuh_umum_kesimpulan" id="risiko_jatuh_umum_kesimpulan" value="{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_umum_kesimpulan ?? 'Tidak berisiko jatuh' }}">
                            </div>
                        </div>

                        <!-- Form Skala Morse -->
                        <div id="skala_morseForm" class="risk-form" style="display: {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_jatuh_jenis ?? '') == '2' ? 'block' : 'none' }};">
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="risiko_jatuh_morse_riwayat_jatuh" onchange="updateConclusion('morse')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_riwayat_jatuh ?? '') == '0' ? 'selected' : '' }}>Tidak (Skor: 0)</option>
                                            <option value="25" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_riwayat_jatuh ?? '') == '25' ? 'selected' : '' }}>Ya (Skor: 25)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="score_riwayat_jatuh">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_riwayat_jatuh ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="risiko_jatuh_morse_diagnosis_sekunder" onchange="updateConclusion('morse')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_diagnosis_sekunder ?? '') == '0' ? 'selected' : '' }}>Tidak (Skor: 0)</option>
                                            <option value="15" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_diagnosis_sekunder ?? '') == '15' ? 'selected' : '' }}>Ya (Skor: 15)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="score_diagnosis_sekunder">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_diagnosis_sekunder ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="risiko_jatuh_morse_bantuan_ambulasi" onchange="updateConclusion('morse')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_bantuan_ambulasi ?? '') == '0' ? 'selected' : '' }}>Tidak ada / bedrest / bantuan perawat (Skor: 0)</option>
                                            <option value="15" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_bantuan_ambulasi ?? '') == '15' ? 'selected' : '' }}>Kruk / tongkat / alat bantu berjalan (Skor: 15)</option>
                                            <option value="30" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_bantuan_ambulasi ?? '') == '30' ? 'selected' : '' }}>Meja / kursi (Skor: 30)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="score_bantuan_ambulasi">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_bantuan_ambulasi ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="risiko_jatuh_morse_terpasang_infus" onchange="updateConclusion('morse')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_terpasang_infus ?? '') == '0' ? 'selected' : '' }}>Tidak (Skor: 0)</option>
                                            <option value="20" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_terpasang_infus ?? '') == '20' ? 'selected' : '' }}>Ya (Skor: 20)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="score_terpasang_infus">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_terpasang_infus ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="risiko_jatuh_morse_cara_berjalan" onchange="updateConclusion('morse')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_cara_berjalan ?? '') == '0' ? 'selected' : '' }}>Normal / bedrest / kursi roda (Skor: 0)</option>
                                            <option value="10" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_cara_berjalan ?? '') == '10' ? 'selected' : '' }}>Lemah (Skor: 10)</option>
                                            <option value="20" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_cara_berjalan ?? '') == '20' ? 'selected' : '' }}>Terganggu (Skor: 20)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="score_cara_berjalan">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_cara_berjalan ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="risiko_jatuh_morse_status_mental" onchange="updateConclusion('morse')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_status_mental ?? '') == '0' ? 'selected' : '' }}>Berorientasi pada kemampuannya (Skor: 0)</option>
                                            <option value="15" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_status_mental ?? '') == '15' ? 'selected' : '' }}>Lupa akan keterbatasannya (Skor: 15)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="score_status_mental">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_status_mental ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="conclusion alert alert-success">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanMorse">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_kesimpulan ?? 'Risiko Rendah' }}</span></p>
                                <input type="hidden" name="risiko_jatuh_morse_kesimpulan" id="risiko_jatuh_morse_kesimpulan" value="{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_morse_kesimpulan ?? 'Risiko Rendah' }}">
                            </div>
                        </div>

                        <!-- Form Skala Ontario -->
                        <div id="skala_ontarioForm" class="risk-form" style="display: {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_jatuh_jenis ?? '') == '4' ? 'block' : 'none' }};">
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select disabled class="form-select custom-select" name="ontario_jatuh_saat_masuk" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="6" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_jatuh_saat_masuk ?? '') == '6' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_jatuh_saat_masuk ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                                <div class="sub-question-card">
                                    <div class="question-text">Jika tidak, apakah pasien mengalami jatuh dalam 2 bulan terakhir ini?</div>
                                    <select disabled class="form-select custom-select" name="ontario_jatuh_2_bulan" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="6" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_jatuh_2_bulan ?? '') == '6' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_jatuh_2_bulan ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select disabled class="form-select custom-select" name="ontario_delirium" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="14" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_delirium ?? '') == '14' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_delirium ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien disorientasi? (salah menyebutkan waktu, tempat atau orang)</div>
                                    <select disabled class="form-select custom-select" name="ontario_disorientasi" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="14" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_disorientasi ?? '') == '14' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_disorientasi ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien mengalami agitasi? (keresahan, gelisah, dan cemas)</div>
                                    <select disabled class="form-select custom-select" name="ontario_agitasi" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="14" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_agitasi ?? '') == '14' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_agitasi ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select disabled class="form-select custom-select" name="ontario_kacamata" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_kacamata ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_kacamata ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien mengalami adanya penglihatan buram?</div>
                                    <select disabled class="form-select custom-select" name="ontario_penglihatan_buram" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_penglihatan_buram ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_penglihatan_buram ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien mempunyai Glaukoma/katarak/degenerasi makula?</div>
                                    <select disabled class="form-select custom-select" name="ontario_glaukoma" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_glaukoma ?? '') == '1' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_glaukoma ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select disabled class="form-select custom-select" name="ontario_berkemih" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_berkemih ?? '') == '2' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_berkemih ?? '') == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                                </div>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select disabled class="form-select custom-select" name="ontario_transfer" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih kondisi</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_transfer ?? '') == '0' ? 'selected' : '' }}>Mandiri (boleh memakai alat bantu jalan)</option>
                                        <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_transfer ?? '') == '1' ? 'selected' : '' }}>Memerlukan sedikit bantuan (1 orang) / dalam pengawasan</option>
                                        <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_transfer ?? '') == '2' ? 'selected' : '' }}>Memerlukan bantuan yang nyata (2 orang)</option>
                                        <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_transfer ?? '') == '3' ? 'selected' : '' }}>Tidak dapat duduk dengan seimbang, perlu bantuan total</option>
                                    </select>
                                </div>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select disabled class="form-select custom-select" name="ontario_mobilitas" onchange="updateConclusion('ontario')">
                                        <option value="">Pilih kondisi</option>
                                        <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_mobilitas ?? '') == '0' ? 'selected' : '' }}>Mandiri (boleh menggunakan alat bantu jalan)</option>
                                        <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_mobilitas ?? '') == '1' ? 'selected' : '' }}>Berjalan dengan bantuan 1 orang (verbal/fisik)</option>
                                        <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_mobilitas ?? '') == '2' ? 'selected' : '' }}>Menggunakan kursi roda</option>
                                        <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->ontario_mobilitas ?? '') == '3' ? 'selected' : '' }}>Imobilisasi</option>
                                    </select>
                                </div>
                                <div class="text-muted small">
                                    <div>0 = Mandiri</div>
                            ...
                            <div class="conclusion alert alert-success">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanOntario">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_lansia_kesimpulan ?? 'Risiko Rendah' }}</span></p>
                                <input type="hidden" name="risiko_jatuh_lansia_kesimpulan" id="risiko_jatuh_lansia_kesimpulan" value="{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_jatuh_lansia_kesimpulan ?? 'Risiko Rendah' }}">
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="risiko_decubitus">
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select custom-select" id="risikoDecubitusSkala" name="resiko_decubitus_jenis" onchange="showDecubitusForm(this.value)">
                                <option value="">--Pilih Skala--</option>
                                <option value="norton" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_decubitus_jenis ?? '') == 'norton' ? 'selected' : '' }}>Skala Norton</option>
                            </select>
                        </div>

                        <!-- Form Skala Norton -->
                        <div id="skala_nortonForm" class="risk-form" style="display: {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->resiko_decubitus_jenis ?? '') == 'norton' ? 'block' : 'none' }};">
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="norton_kondisi_fisik" onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="4" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_fisik ?? '') == '4' ? 'selected' : '' }}>Baik (Skor: 4)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_fisik ?? '') == '3' ? 'selected' : '' }}>Cukup (Skor: 3)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_fisik ?? '') == '2' ? 'selected' : '' }}>Buruk (Skor: 2)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_fisik ?? '') == '1' ? 'selected' : '' }}>Sangat buruk (Skor: 1)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_kondisi_fisik">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_fisik ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="norton_kondisi_mental" onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="4" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_mental ?? '') == '4' ? 'selected' : '' }}>Compos mentis (Skor: 4)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_mental ?? '') == '3' ? 'selected' : '' }}>Apatis (Skor: 3)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_mental ?? '') == '2' ? 'selected' : '' }}>Delirium (Skor: 2)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_mental ?? '') == '1' ? 'selected' : '' }}>Stupor (Skor: 1)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_kondisi_mental">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_mental ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="norton_aktivitas" onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="4" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_aktivitas ?? '') == '4' ? 'selected' : '' }}>Mandiri (Skor: 4)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_aktivitas ?? '') == '3' ? 'selected' : '' }}>Dipapah (Skor: 3)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_aktivitas ?? '') == '2' ? 'selected' : '' }}>Kursi roda (Skor: 2)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_aktivitas ?? '') == '1' ? 'selected' : '' }}>Tirah baring (Skor: 1)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_aktivitas">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->norton_aktivitas ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="norton_mobilitas" onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="4" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_mobilitas ?? '') == '4' ? 'selected' : '' }}>Baik (Skor: 4)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_mobilitas ?? '') == '3' ? 'selected' : '' }}>Agak terbatas (Skor: 3)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_mobilitas ?? '') == '2' ? 'selected' : '' }}>Sangat terbatas (Skor: 2)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_mobilitas ?? '') == '1' ? 'selected' : '' }}>Immobilisasi (Skor: 1)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_mobilitas">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->norton_mobilitas ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="norton_inkontinensia" onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="4" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_inkontinensia ?? '') == '4' ? 'selected' : '' }}>Tidak (Skor: 4)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_inkontinensia ?? '') == '3' ? 'selected' : '' }}>Terkadang (Skor: 3)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_inkontinensia ?? '') == '2' ? 'selected' : '' }}>Sering (Skor: 2)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_inkontinensia ?? '') == '1' ? 'selected' : '' }}>Selalu (Skor: 1)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_inkontinensia">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->norton_inkontinensia ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="conclusion alert {{
                                ...
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_aktivitas ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_mobilitas ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_inkontinensia ?? 0) < 12 ? 'alert-danger' :
                                (($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_fisik ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_kondisi_mental ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_aktivitas ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_mobilitas ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->norton_inkontinensia ?? 0) <= 15 ? 'alert-warning' : 'alert-success')
                            }}">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanNorton">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_norton_kesimpulan ?? 'Risiko Rendah' }}</span></p>
                                <input type="hidden" name="risiko_norton_kesimpulan" id="risiko_norton_kesimpulan" value="{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->risiko_norton_kesimpulan ?? 'Risiko Rendah' }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="aktivitas_harian">
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select custom-select" id="aktivitasHarianSkala" name="aktivitas_harian_jenis" onchange="showADLForm(this.value)">
                                <option value="">--Pilih Skala--</option>
                                <option value="adl" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->aktivitas_harian_jenis ?? '') == 'adl' ? 'selected' : '' }}>Pengkajian ADL</option>
                            </select>
                        </div>

                        <!-- Form ADL -->
                        <div id="skala_adlForm" class="risk-form" style="display: {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->aktivitas_harian_jenis ?? '') == 'adl' ? 'block' : 'none' }};">
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="adl_makan" onchange="updateConclusion('adl')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? '') == '0' ? 'selected' : '' }}>Mandiri (Skor: 0)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? '') == '1' ? 'selected' : '' }}>25% Dibantu (Skor: 1)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? '') == '2' ? 'selected' : '' }}>50% Dibantu (Skor: 2)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? '') == '3' ? 'selected' : '' }}>75% Dibantu (Skor: 3)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_makan">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="adl_berjalan" onchange="updateConclusion('adl')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? '') == '0' ? 'selected' : '' }}>Mandiri (Skor: 0)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? '') == '1' ? 'selected' : '' }}>25% Dibantu (Skor: 1)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? '') == '2' ? 'selected' : '' }}>50% Dibantu (Skor: 2)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? '') == '3' ? 'selected' : '' }}>75% Dibantu (Skor: 3)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_berjalan">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select disabled class="form-select custom-select" name="adl_mandi" onchange="updateConclusion('adl')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? '') == '0' ? 'selected' : '' }}>Mandiri (Skor: 0)</option>
                                            <option value="1" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? '') == '1' ? 'selected' : '' }}>25% Dibantu (Skor: 1)</option>
                                            <option value="2" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? '') == '2' ? 'selected' : '' }}>50% Dibantu (Skor: 2)</option>
                                            <option value="3" {{ ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? '') == '3' ? 'selected' : '' }}>75% Dibantu (Skor: 3)</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="score-badge" id="skor_mandi">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? '0' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="conclusion alert {{
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? 0) == 0 ? 'alert-success' :
                                (($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? 0) <= 3 ? 'alert-info' :
                                (($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_makan ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_berjalan ?? 0) +
                                ($asesmen->asesmenKetDewasaRanapResikoJatuh->adl_mandi ?? 0) <= 6 ? 'alert-warning' : 'alert-danger'))
                            }}">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanADL">{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->adl_kesimpulan ?? 'Mandiri (Skor: 0)' }}</span></p>
                                <input type="hidden" name="adl_kesimpulan" id="adl_kesimpulan" value="{{ $asesmen->asesmenKetDewasaRanapResikoJatuh->adl_kesimpulan ?? 'Mandiri' }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="pengkajian_edukasi">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="bicara[]" id="bicara_normal" value="normal"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="bicara[]" id="bicara_tidak_normal" value="tidak_normal"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="bahasa_sehari[]" id="bahasa_sehari_indonesia" value="indonesia"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="bahasa_sehari[]" id="bahasa_sehari_daerah" value="daerah"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="bahasa_sehari[]" id="bahasa_sehari_asing" value="asing"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="penerjemah[]" id="tidak_perlu_penerjemah" value="tidak"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="penerjemah[]" id="perlu_penerjemah_ya" value="ya"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="penerjemah[]" id="perlu_penerjemah_bahasa_isyarat" value="bahasa_isyarat"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="hambatan[]" id="belajar_bahasa_hambatan" value="bahasa"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="hambatan[]" id="belajar_menulis" value="menulis"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="hambatan[]" id="belajar_cemas" value="cemas"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="hambatan[]" id="belajar_lain_hambatan" value="lain"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="cara_komunikasi[]" id="komunikasi_audio_visual" value="audio_visual"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="cara_komunikasi[]" id="komunikasi_diskusi" value="diskusi"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="cara_komunikasi[]" id="komunikasi_lain_komunikasi" value="lain"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="pendidikan[]" id="pendidikan_tk" value="tk"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="pendidikan[]" id="pendidikan_sd" value="sd"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="pendidikan[]" id="pendidikan_smp" value="smp"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="pendidikan[]" id="pendidikan_smu" value="smu"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="pendidikan[]" id="pendidikan_akademi" value="akademi"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="pendidikan[]" id="pendidikan_sarjana" value="sarjana"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="potensi_pembelajaran[]" id="potensi_proses_penyakit" value="proses_penyakit"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="potensi_pembelajaran[]" id="potensi_pengobatan_tindakan" value="pengobatan_tindakan"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="checkbox" name="potensi_pembelajaran[]" id="potensi_terapi_obat" value="terapi_obat"
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="potensi_pembelajaran[]" id="potensi_nutrisi" value="nutrisi"
                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="potensi_pembelajaran[]" id="lain_pembelajaran" value="lain"
                    ...
                    <div class="section-separator" id="discharge-planning">
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select" name="usia_lanjut">
                                ...
                                <option value="ya" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->usia_lanjut == 'ya' ? 'selected' : '' }}>Ya</option>
                                <option value="tidak" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->usia_lanjut == 'tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select" name="hambatan_mobilisasi">
                                <option value="" selected disabled>--Pilih--</option>
                                <option value="ya" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->hambatan_mobilisasi == 'ya' ? 'selected' : '' }}>Ya</option>
                                <option value="tidak" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->hambatan_mobilisasi == 'tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select" name="penggunaan_media_berkelanjutan">
                                <option value="" selected disabled>--Pilih--</option>
                                <option value="ya" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->penggunaan_media_berkelanjutan == 'ya' ? 'selected' : '' }}>Ya</option>
                                <option value="tidak" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->penggunaan_media_berkelanjutan == 'tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Keteraturan dalam mengonsumsi obat dalam aktivitas harian</label>
                            <select disabled class="form-select" name="ketergantungan_aktivitas">
                                <option value="" selected disabled>--Pilih--</option>
                                <option value="ya" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->ketergantungan_aktivitas == 'ya' ? 'selected' : '' }}>Ya</option>
                                <option value="tidak" {{ $asesmen->asesmenKetDewasaRanapDischargePlanning->ketergantungan_aktivitas == 'tidak' ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    ...
                    <div class="section-separator" id="diet_khusus">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-4 mb-2">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="pengaruh_perawatan[]" id="pasien_keluarga" value="pasien_keluarga"
                                                {{ in_array('pasien_keluarga', old('pengaruh_perawatan', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->pengaruh_perawatan)
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio" name="pengaruh_ya_tidak_1" id="pengaruh_ya_1" value="ya"
                                            ...
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio" name="pengaruh_ya_tidak_1" id="pengaruh_tidak_1" value="tidak"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio" name="pengaruh_ya_tidak_2" id="pengaruh_ya_2" value="ya"
                                            ...
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio" name="pengaruh_ya_tidak_2" id="pengaruh_tidak_2" value="tidak"
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-2">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="pengaruh_perawatan[]" id="keuangan" value="keuangan"
                                                {{ in_array('keuangan', old('pengaruh_perawatan', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->pengaruh_perawatan)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->pengaruh_perawatan
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->pengaruh_perawatan ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->pengaruh_perawatan, true) : []))) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio" name="pengaruh_ya_tidak_3" id="pengaruh_ya_3" value="ya"
                                            ...
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio" name="pengaruh_ya_tidak_3" id="pengaruh_tidak_3" value="tidak"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="hidup_sendiri" id="hidup_ya" value="1"
                                            {{ old('1', $asesmen->asesmenKetDewasaRanapDietKhusus->hidup_sendiri ?? '') === '1' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="hidup_ya">Ya</label>
                                    </div>
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="hidup_sendiri" id="hidup_tidak" value="tidak"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="antisipasi_masalah" id="antisipasi_tidak" value="0"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="antisipasi_masalah" id="antisipasi_ya" value="1"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="makan_minum" value="makan_minum"
                                                {{ in_array('makan_minum', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="makan_minum">Makan/ minum</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="konsumsi_obat" value="konsumsi_obat"
                                                {{ in_array('konsumsi_obat', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="berpakaian" value="berpakaian"
                                                {{ in_array('berpakaian', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="perawatan_luka" value="perawatan_luka"
                                                {{ in_array('perawatan_luka', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="mandi_berpakaian" value="mandi_berpakaian"
                                                {{ in_array('mandi_berpakaian', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="menyiapkan_makanan" value="menyiapkan_makanan"
                                                {{ in_array('menyiapkan_makanan', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="edukasi_kesehatan" value="edukasi_kesehatan"
                                                {{ in_array('edukasi_kesehatan', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input disabled class="form-check-input" type="checkbox" name="bantuan_hal[]" id="lainnya_bantuan" value="lainnya"
                                                {{ in_array('lainnya', old('bantuan_hal', is_array($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal)
                                                    ? $asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal
                                                    : ($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal ? json_decode($asesmen->asesmenKetDewasaRanapDietKhusus->bantuan_hal, true) : []))) ? 'checked' : '' }}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="peralatan_medis" id="peralatan_tidak" value="0"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="peralatan_medis" id="peralatan_ya" value="ya"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="alat_bantu" id="alat_bantu_tidak" value="0"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="alat_bantu" id="alat_bantu_ya" value="1"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="perawatan_khusus" id="perawatan_khusus_tidak" value="0"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="perawatan_khusus" id="perawatan_khusus_ya" value="1"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="nyeri_kronis" id="nyeri_kronis_tidak" value="0"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="nyeri_kronis" id="nyeri_kronis_ya" value="1"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="keterampilan_khusus" id="keterampilan_tidak" value="0"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="keterampilan_khusus" id="keterampilan_ya" value="1"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="dirujuk_komunitas" id="dirujuk_tidak" value="0"
                                    ...
                                    <div class="form-check">
                                        <input disabled class="form-check-input" type="radio" name="dirujuk_komunitas" id="dirujuk_ya" value="1"
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_bersihan_jalan_nafas" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="monitor_pola_nafas"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="monitor_bunyi_nafas"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="monitor_sputum"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="monitor_tingkat_kesadaran"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="monitor_kemampuan_batuk"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="pertahankan_kepatenan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="posisikan_semi_fowler"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="berikan_minum_hangat"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="fisioterapi_dada"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="keluarkan_benda_padat"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="penghisapan_lendir"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="berikan_oksigen"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="anjuran_asupan_cairan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="ajarkan_teknik_batuk"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_bersihan_jalan_nafas[]" value="kolaborasi_pemberian_obat"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="penurunan_curah_jantung" id="diag_penurunan_curah_jantung" onchange="toggleRencana('penurunan_curah_jantung')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_penurunan_curah_jantung" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="identifikasi_tanda_gejala"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="monitor_tekanan_darah"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="monitor_intake_output"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="monitor_saturasi_oksigen"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="monitor_keluhan_nyeri"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="monitor_aritmia"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="posisikan_pasien"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="berikan_terapi_relaksasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="berikan_dukungan_emosional"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="berikan_oksigen_saturasi"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="anjurkan_beraktifitas"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="anjurkan_berhenti_merokok"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="ajarkan_mengukur_intake"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_penurunan_curah_jantung[]" value="kolaborasi_pemberian_terapi"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="perfusi_perifer" id="diag_perfusi_perifer" onchange="toggleRencana('perfusi_perifer')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_perfusi_perifer" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="periksa_sirkulasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="identifikasi_faktor_risiko"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="monitor_suhu_kemerahan"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="hindari_pemasangan_infus"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="hindari_pengukuran_tekanan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="hindari_penekanan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="lakukan_pencegahan_infeksi"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="perawatan_kaki_kuku"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="anjurkan_berhenti_merokok_perfusi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="anjurkan_berolahraga"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="anjurkan_minum_obat"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_perfusi_perifer[]" value="kolaborasi_terapi_perfusi"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="hipovolemia" id="diag_hipovolemia" onchange="toggleRencana('hipovolemia')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_hipovolemia" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipovolemia[]" value="periksa_tanda_gejala"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipovolemia[]" value="monitor_intake_output_hipovolemia"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipovolemia[]" value="berikan_asupan_cairan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipovolemia[]" value="posisi_trendelenburg"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipovolemia[]" value="anjurkan_memperbanyak_cairan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipovolemia[]" value="hindari_perubahan_posisi"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipovolemia[]" value="kolaborasi_terapi_hipovolemia"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="hipervolemia" id="diag_hipervolemia" onchange="toggleRencana('hipervolemia')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_hipervolemia" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="periksa_tanda_hipervolemia"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="identifikasi_penyebab_hipervolemia"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="monitor_hemodinamik"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="monitor_intake_output_hipervolemia"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="monitor_efek_diuretik"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="timbang_berat_badan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="batasi_asupan_cairan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="tinggi_kepala_tempat_tidur"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="ajarkan_mengukur_cairan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="ajarkan_membatasi_cairan"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipervolemia[]" value="kolaborasi_terapi_hipervolemia"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="diare" id="diag_diare" onchange="toggleRencana('diare')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_diare" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="identifikasi_penyebab_diare"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="identifikasi_riwayat_makanan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="identifikasi_gejala_invaginasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="monitor_warna_volume_tinja"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="monitor_tanda_hipovolemia"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="monitor_iritasi_kulit"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="monitor_jumlah_diare"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="berikan_asupan_cairan_oral"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="pasang_jalur_intravena"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="berikan_cairan_intravena"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="anjurkan_makanan_porsi_kecil"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="hindari_makanan_gas"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="lanjutkan_asi"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_diare[]" value="kolaborasi_terapi_diare"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="retensi_urine" id="diag_retensi_urine" onchange="toggleRencana('retensi_urine')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_retensi_urine" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="identifikasi_tanda_retensi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="identifikasi_faktor_penyebab"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="monitor_eliminasi_urine"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="catat_waktu_berkemih"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="batasi_asupan_cairan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="ambil_sampel_urine"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="ajarkan_tanda_infeksi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="ajarkan_mengukur_asupan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="ajarkan_spesimen_midstream"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="ajarkan_tanda_berkemih"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="ajarkan_minum_cukup"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="kurangi_minum_tidur"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_retensi_urine[]" value="kolaborasi_supositoria"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="nyeri_akut" id="diag_nyeri_akut" onchange="toggleRencana('nyeri_akut')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_nyeri_akut" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="identifikasi_lokasi_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="identifikasi_skala_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="identifikasi_respons_nonverbal"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="identifikasi_faktor_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="identifikasi_pengetahuan_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="identifikasi_pengaruh_budaya"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="identifikasi_pengaruh_kualitas_hidup"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="monitor_keberhasilan_terapi"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="monitor_efek_samping_analgetik"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="berikan_teknik_nonfarmakologis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="kontrol_lingkungan_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="fasilitasi_istirahat"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="pertimbangkan_strategi_nyeri"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="jelaskan_penyebab_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="jelaskan_strategi_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="anjurkan_monitor_nyeri"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="anjurkan_analgetik"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="ajarkan_teknik_nonfarmakologis"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_akut[]" value="kolaborasi_analgetik"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="nyeri_kronis" id="diag_nyeri_kronis" onchange="toggleRencana('nyeri_kronis')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_nyeri_kronis" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="identifikasi_lokasi_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="identifikasi_skala_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="identifikasi_respons_nonverbal_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="identifikasi_faktor_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="identifikasi_pengetahuan_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="identifikasi_pengaruh_budaya_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="identifikasi_pengaruh_kualitas_hidup_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="monitor_keberhasilan_terapi_kronis"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="monitor_efek_samping_analgetik_kronis"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="berikan_teknik_nonfarmakologis_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="kontrol_lingkungan_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="fasilitasi_istirahat_kronis"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="pertimbangkan_strategi_nyeri_kronis"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="jelaskan_penyebab_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="jelaskan_strategi_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="anjurkan_monitor_nyeri_kronis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="anjurkan_analgetik_kronis"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="ajarkan_teknik_nonfarmakologis_kronis"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_nyeri_kronis[]" value="kolaborasi_analgetik_kronis"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="hipertermia" id="diag_hipertermia" onchange="toggleRencana('hipertermia')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_hipertermia" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="identifikasi_penyebab_hipertermia"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="monitor_suhu_tubuh"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="monitor_kadar_elektrolit"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="monitor_haluaran_urine"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="monitor_komplikasi_hipertermia"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="sediakan_lingkungan_dingin"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="longgarkan_pakaian"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="basahi_kipasi_tubuh"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="berikan_cairan_oral_hipertermia"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="ganti_linen_hiperhidrosis"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="pendinginan_eksternal"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="hindari_antipiretik"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="berikan_oksigen_hipertermia"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="anjurkan_tirah_baring"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_hipertermia[]" value="kolaborasi_cairan_elektrolit"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="gangguan_mobilitas_fisik" id="diag_gangguan_mobilitas_fisik" onchange="toggleRencana('gangguan_mobilitas_fisik')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_gangguan_mobilitas_fisik" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="identifikasi_nyeri_keluhan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="identifikasi_toleransi_ambulasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="monitor_frekuensi_jantung_ambulasi"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="monitor_kondisi_umum_ambulasi"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="fasilitasi_aktivitas_ambulasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="fasilitasi_mobilisasi_fisik"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="libatkan_keluarga_ambulasi"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="jelaskan_tujuan_ambulasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="anjurkan_ambulasi_dini"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_mobilitas_fisik[]" value="ajarkan_ambulasi_sederhana"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="resiko_infeksi" id="diag_resiko_infeksi" onchange="toggleRencana('resiko_infeksi')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_resiko_infeksi" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="monitor_tanda_infeksi_sistemik"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="batasi_pengunjung"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="perawatan_kulit_edema"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="cuci_tangan_kontak"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="pertahankan_teknik_aseptik"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="jelaskan_tanda_infeksi_edukasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="ajarkan_cuci_tangan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="ajarkan_etika_batuk"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="ajarkan_periksa_luka"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="anjurkan_asupan_nutrisi"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="anjurkan_asupan_cairan_infeksi"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_infeksi[]" value="kolaborasi_imunisasi"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="konstipasi" id="diag_konstipasi" onchange="toggleRencana('konstipasi')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_konstipasi" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="periksa_tanda_gejala_konstipasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="periksa_pergerakan_usus"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="identifikasi_faktor_risiko_konstipasi"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="anjurkan_diet_tinggi_serat"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="masase_abdomen"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="evakuasi_feses_manual"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="berikan_enema"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="jelaskan_etiologi_konstipasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="anjurkan_peningkatan_cairan_konstipasi"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="ajarkan_mengatasi_konstipasi"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_konstipasi[]" value="kolaborasi_obat_pencahar"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="resiko_jatuh" id="diag_resiko_jatuh" onchange="toggleRencana('resiko_jatuh')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_resiko_jatuh" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="identifikasi_faktor_risiko_jatuh"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="identifikasi_risiko_setiap_shift"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="identifikasi_faktor_lingkungan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="hitung_risiko_jatuh"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="monitor_kemampuan_berpindah"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="orientasikan_ruangan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="pastikan_roda_terkunci"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="pasang_handrail"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="atur_tempat_tidur"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="tempatkan_dekat_perawat"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="gunakan_alat_bantu"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="dekatkan_bel"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="anjurkan_memanggil_perawat"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="anjurkan_alas_kaki"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="anjurkan_berkonsentrasi"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="anjurkan_melebarkan_jarak"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_resiko_jatuh[]" value="ajarkan_bel_pemanggil"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox" name="diagnosis[]" value="gangguan_integritas_kulit" id="diag_gangguan_integritas_kulit" onchange="toggleRencana('gangguan_integritas_kulit')"
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_gangguan_integritas_kulit" style="display: none;">
                                                <strong>Observasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="monitor_karakteristik_luka"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="monitor_tanda_infeksi"
                                                ...
                                                <strong>Terapeutik:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="lepaskan_balutan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="bersihkan_nacl"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="bersihkan_jaringan_nekrotik"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="berikan_salep"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="pasang_balutan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="pertahankan_teknik_steril"
                                                ...
                                                <strong>Edukasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="jelaskan_tanda_infeksi"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="anjurkan_makanan_tinggi_protein"
                                                ...
                                                <strong>Kolaborasi:</strong>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="kolaborasi_debridement"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" name="rencana_gangguan_integritas_kulit[]" value="kolaborasi_antibiotik"
