                ...
                <form method="POST" action="{{ route('rawat-inap.asesmen.keperawatan.umum.create', [
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" rows="2" name="status_nutrisi_lainnya" placeholder="Sebutkan diagnosa khusus jika ada..."></textarea>
                                        </div>
                                        <div class="mb-3 text-center">
                                            <h6 class="card-title mb-2">TOTAL SKOR</h6>
                                            <div class="display-1 text-primary fw-bold" id="total_skor_display">0</div>
                                            <input type="hidden" id="total_skor_nutrisi" value="0" name="status_nutrisi_total">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="section-separator">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="durasi_nyeri_lokasi" placeholder="Sebutkan lokasi...">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            ...
                                            <input type="text" class="form-control mt-2" name="faktor_peringan_lainnya_text" placeholder="Sebutkan...">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="efek_nyeri_lainnya_text" placeholder="Sebutkan efek lainnya...">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="section-separator" id="discharge-planning">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="rencana_pulang_khusus" placeholder="Rencana Pulang Khusus">
                        </div>

                        <div class="mb-4">
                            <label class="form-label">Rencana Lama Perawatan</label>
                            <input type="text" class="form-control" name="rencana_lama_perawatan" placeholder="Rencana Lama Perawatan">
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input type="hidden" id="kesimpulan" name="kesimpulan_planing" value="Tidak membutuhkan rencana pulang khusus">
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="diet_khusus">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="dirujuk_komunitas" id="dirujuk_tidak" value="-">
