                ...
                <div class="section-separator" id="data-umum">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="kondisi_masuk" id="lainnya_kondisi"
                                    value="lainnya">
                                <label class="form-check-label" for="lainnya_kondisi">Lainnya:</label>
                                <input type="text" class="form-control d-inline-block ms-2" name="kondisi_masuk_lainnya"
                                    style="width: 300px;" placeholder="Sebutkan...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="barang_berharga" id="lainnya_barang"
                                    value="lainnya">
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="alkohol_obat" id="alkohol_ya"
                                            value="ya">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                            name="psikososial_status_pernikahan" id="duda_janda" value="duda_janda">
                            ...
                            <div class="col-sm-9">
                                <div class="d-flex flex-wrap gap-3 align-items-center">
                                    ...
                                    <div class="form-check d-flex align-items-center">
                                        <input class="form-check-input" type="radio" name="psikososial_tempat_tinggal"
                                            id="psikososial_tempat_tinggal_lainnya" value="lainnya">
                                        <label class="form-check-label me-2"
                                            for="psikososial_tempat_tinggal_lainnya">Lainnya:</label>
                                        <input type="text" class="form-control form-control-sm"
                                            name="psikososial_lainnya" style="width: 200px;" placeholder="Sebutkan...">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="form-check d-flex align-items-center">
                                        ...
                                        <label class="form-check-label me-2" for="aktivitas_lainnya">Lainnya:</label>
                                        <input type="text" class="form-control form-control-sm"
                                ...
                                <div class="d-flex flex-wrap gap-3 mt-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="psikososial_aktivitas[]"
                                            id="psikososial_aktivitas_mandiri" value="mandiri">
                                    ...
                                    <div class="form-check d-flex align-items-center">
                                        ...
                                        <label class="form-check-label me-2" for="aktivitas_lainnya2">Lainnya:</label>
                                        <input type="text" class="form-control form-control-sm"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                            name="psikososial_curiga_penganiayaan" id="curiga_tidak" value="tidak">
                            ...
                            <div class="col-sm-9">
                                <div class="d-flex flex-wrap gap-3 align-items-center">
                                    ...
                                    <div class="form-check d-flex align-items-center">
                                        ...
                                        <label class="form-check-label me-2" for="informasi_lainnya">Lainnya:</label>
                                        <input type="text" class="form-control form-control-sm"
                    ...
                    <div class="col-12 mb-3 section-separator">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="agama[]" id="agama_islam"
                                            value="islam">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="agama[]" id="agama_budha"
                                            value="budha">
                                        <label class="form-check-label" for="agama_budha">Budha</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="agama[]" id="agama_hindu"
                                            value="hindu">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-3 align-items-center">
                                    ...
                                    <div class="form-check d-flex align-items-center">
                                        ...
                                        <label class="form-check-label me-2" for="pandangan_lainnya">Lainnya:</label>
                                        <input type="text" class="form-control form-control-sm"
                ...
                <div class="section-separator" id="pemeriksaan-fisik">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                <div class="d-flex flex-wrap gap-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="mata_telinga_hidung[]"
                                            id="gangguan_visus" value="gangguan_visus">
                                        <label class="form-check-label" for="gangguan_visus">Gangguan visus</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="mata_telinga_hidung[]"
                                            id="galucoma" value="galucoma">
                                        <label class="form-check-label" for="galucoma">Galucoma</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="mata_telinga_hidung[]"
                                            id="sulit_mendengar" value="sulit_mendengar">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="mata_telinga_hidung[]"
                                            id="rasa_terbakar" value="rasa_terbakar">
                    ...
                    <div class="form-section mt-3">
                        <div class="section-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-check normal-checkbox">
                                <input class="form-check-input" type="checkbox"
                                    name="pemeriksaan_gastrointestinal_normal" id="pemeriksaan_gastrointestinal_normal"
                                    value="normal">
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label"
                                    for="pemeriksaan_gastrointestinal_bisingususmenurun">Bising usus menurun</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" name="fisik_diet_khusus"
                                    placeholder="Diet khusus">
                            </div>
                        </div>

                        <div class="mt-3">
                            <label class="form-label">Catatan:</label>
                            <textarea class="form-control" name="pemeriksaan_gastrointestinal_catatan" rows="2"
                                placeholder="Catatan pemeriksaan"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section mt-3">
                        <div class="section-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-check normal-checkbox">
                                <input class="form-check-input" type="checkbox" name="pemeriksaan_kardiovaskular_normal"
                        ...
                        <div class="mt-3">
                            <label class="form-label">Catatan:</label>
                            <textarea class="form-control" name="pemeriksaan_kardiovaskular_catatan" rows="2"
                                placeholder="Catatan pemeriksaan"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 mt-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="mt-3">
                                <label class="form-label fw-bold">Catatan:</label>
                                <textarea class="form-control" name="pemeriksaan_genitourinaria_ginekologi_catatan"
                                    rows="2" placeholder="Catatan pemeriksaan"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi_normal"
                                    id="pemeriksaan_neurologi_normal" value="normal">
                                <label class="form-check-label fw-bold"
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="pemeriksaan_genitourinaria_genggaman_lemah">Genggaman lemah</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="pemeriksaan_neurologi[]"
                            ...
                            <div class="mt-3">
                                <label class="form-label fw-bold">Catatan:</label>
                                <textarea class="form-control" name="pemeriksaan_neurologi_catatan" rows="2"
                                    placeholder="Catatan pemeriksaan"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="fw-bold mb-3">Apakah pasien mengalami penurunan BB yang tidak diinginkan
                                        dalam 6 bulan terakhir?</h6>
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check mb-2">
                                            ...
                                            <label class="form-check-label" for="bb_tidak_yakin">Tidak yakin / tidak
                                                tahu / terasa baju longgar <span class="badge bg-secondary ms-2">Skor:
                                                    2</span></label>
                                        </div>
                                    </div>
                                    <div class="ms-3">
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="bb_turun_range"
                                                        id="bb_1_5kg" value="1">
                                                    <label class="form-check-label" for="bb_1_5kg">1 sd 5 Kg <span
                                            ...
                                            <div class="col-12 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="bb_turun_range"
                                                        id="bb_6_10kg" value="2">
                                                    <label class="form-check-label" for="bb_6_10kg">6 sd 10 Kg <span
                                            ...
                                            <div class="col-12 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="bb_turun_range"
                                                        id="bb_11_15kg" value="3">
                                                    <label class="form-check-label" for="bb_11_15kg">11 sd 15 Kg <span
                                                            class="badge bg-secondary ms-2">Skor: 3</span></label>
                                                </div>
                                            </div>
                                            <div class="col-12 mb-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="bb_turun_range"
                                                        id="bb_lebih_15kg" value="4">
                                                    <label class="form-check-label" for="bb_lebih_15kg">> 15 Kg <span
                                                            class="badge bg-secondary ms-2">Skor: 4</span></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="fw-bold mb-3">Apakah asupan makanan berkurang karena tidak nafsu makan?
                                    </h6>
                                    <div class="mb-3">
                                        <div class="form-check mb-2">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-check-inline me-4">
                                            <input class="form-check-input" type="radio" name="diagnosa_khusus"
                                                id="diagnosa_ya" value="ya">
                                            <label class="form-check-label" for="diagnosa_ya">Ya</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="diagnosa_khusus"
                                                id="diagnosa_tidak" value="tidak">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="2" name="status_nutrisi_lainnya"
                                            placeholder="Sebutkan diagnosa khusus jika ada..."></textarea>
                                    </div>
                    ...
                    <div class="row mb-4">
                            ...
                            <div class="d-flex align-items-start gap-4">
                                <div class="d-flex align-items-center gap-3" style="min-width: 350px;">
                                    <input type="number"
                                        ...
                                        value="{{ old('skala_nyeri', $asesmenMedis->skala_nyeri ?? 0) }}" min="0"
                                        max="10">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="btn-group mb-3" role="group">
                                <button type="button" class="btn btn-sm btn-primary" id="numericBtn"
                                    data-scale="numeric">
                                    A. Numeric Rating Pain Scale
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" id="wongBakerBtn"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="d-flex flex-wrap gap-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="frekuensi_nyeri[]"
                                        id="frekuensi_hilang_timbul" value="hilang_timbul">
                                    <label class="form-check-label" for="frekuensi_hilang_timbul">Hilang timbul</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="frekuensi_nyeri[]"
                                        id="frekuensi_terus_menerus" value="terus_menerus">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="nyeri_menjalar"
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="kualitas_nyeri[]"
                                            id="kualitas_nyeri_tumpul" value="nyeri_tumpul">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="kualitas_nyeri[]"
                                            id="kualitas_nyeri_tajam" value="nyeri_tajam">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="kualitas_nyeri[]"
                                            id="kualitas_nyeri_panas" value="panas_terbakar">
                                        <label class="form-check-label"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="efek_nyeri[]"
                                            id="efek_nyeri_mual" value="mual_muntah">
                ...
                <div class="section-separator" id="risiko_jatuh">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold">Pilih jenis penilaian risiko jatuh sesuai dengan kondisi
                            pasien:</label>
                        <select class="form-select custom-select" id="risikoJatuhSkala" name="resiko_jatuh_jenis"
                    ...
                    <div id="skala_umumForm" class="risk-form" style="display: none;">
                        ...
                        <div class="question-card">
                            <div class="question-text">Apakah pasien berusia < dari 2 tahun?</div>
                                    <select class="form-select custom-select" name="risiko_jatuh_umum_usia"
                            ...
                            <div class="question-card">
                                <div class="question-text">Apakah pasien dalam kondisi sebagai geriatri, dizziness,
                                    vertigo, gangguan keseimbangan, gangguan penglihatan, penggunaan obat sedasi, status
                                    kesadaran dan atau kejiwaan, konsumsi alkohol?</div>
                                <select class="form-select custom-select" onchange="updateConclusion('umum')"
                            ...
                            <div class="question-card">
                                <div class="question-text">Apakah pasien didiagnosis sebagai pasien dengan penyakit
                                    parkinson?</div>
                                <select class="form-select custom-select" onchange="updateConclusion('umum')"
                            ...
                            <div class="question-card">
                                <div class="question-text">Apakah pasien sedang mendapatkan obat sedasi, riwayat tirah
                                    baring lama, perubahan posisi yang akan meningkatkan risiko jatuh?</div>
                                <select class="form-select custom-select" onchange="updateConclusion('umum')"
                            ...
                            <div class="question-card">
                                <div class="question-text">Apakah pasien saat ini sedang berada pada salah satu lokasi
                                    ini: rehab medik, ruangan dengan penerangan kurang dan bertangga?</div>
                                <select class="form-select custom-select" onchange="updateConclusion('umum')"
                            ...
                            <div class="conclusion alert alert-success">
                                ...
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanUmum">Tidak berisiko
                                        jatuh</span></p>
                                <input type="hidden" name="risiko_jatuh_umum_kesimpulan"
                                    id="risiko_jatuh_umum_kesimpulan" value="Tidak berisiko jatuh">
                            </div>
                        </div>

                        <!-- Form Skala Morse -->
                        <div id="skala_morseForm" class="risk-form" style="display: none;">
                            <h5 class="mb-4 text-center">6.A. PENGKAJIAN RESIKO JATUH SKALA MORSE (USIA 19 s.d 59 Tahun)
                            </h5>
                            ...
                            <div class="conclusion alert alert-success">
                                ...
                                <input type="hidden" name="risiko_jatuh_morse_kesimpulan"
                                    id="risiko_jatuh_morse_kesimpulan" value="Risiko Rendah">
                            </div>
                        </div>

                        <!-- Form Skala Ontario -->
                        <div id="skala_ontarioForm" class="risk-form" style="display: none;">
                            <h5 class="mb-4 text-center">6.B. PENGKAJIAN RESIKO JATUH KHUSUS LANSIA/ GERIATRI (Usia > 60
                                Thn)</h5>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select class="form-select custom-select" name="ontario_jatuh_saat_masuk"
                                ...
                                <div class="sub-question-card">
                                    <div class="question-text">Jika tidak, apakah pasien mengalami jatuh dalam 2 bulan
                                        terakhir ini?</div>
                                    <select class="form-select custom-select" name="ontario_jatuh_2_bulan"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="6">Ya</option>
                                        <option value="0">Tidak</option>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien delirium? (Tidak dapat membuat keputusan,
                                        pola pikir tidak terorganisir, gangguan daya ingat)</div>
                                    <select class="form-select custom-select" name="ontario_delirium"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                ...
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien disorientasi? (salah menyebutkan waktu,
                                        tempat atau orang)</div>
                                    <select class="form-select custom-select" name="ontario_disorientasi"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="14">Ya</option>
                                        <option value="0">Tidak</option>
                                ...
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien mengalami agitasi? (keresahan, gelisah, dan
                                        cemas)</div>
                                    <select class="form-select custom-select" name="ontario_agitasi"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="14">Ya</option>
                                        <option value="0">Tidak</option>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select class="form-select custom-select" name="ontario_kacamata"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="1">Ya</option>
                                        <option value="0">Tidak</option>
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select class="form-select custom-select" name="ontario_penglihatan_buram"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="1">Ya</option>
                                        <option value="0">Tidak</option>
                                ...
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah pasien mempunyai Glaukoma/katarak/degenerasi
                                        makula?</div>
                                    <select class="form-select custom-select" name="ontario_glaukoma"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                                        <option value="1">Ya</option>
                                        <option value="0">Tidak</option>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    <div class="question-text">Apakah terdapat perubahan perilaku berkemih? (frekuensi,
                                        urgensi, inkontinensia, noktura)</div>
                                    <select class="form-select custom-select" name="ontario_berkemih"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih jawaban</option>
                            ...
                            <div class="parameter-section">
                                <div class="parameter-title">5. Transfer (dari tempat tidur ke kursi dan kembali lagi ke
                                    tempat tidur)</div>
                                <div class="sub-question-card">
                                    <div class="question-text">Kemampuan Transfer Pasien:</div>
                                    <select class="form-select custom-select" name="ontario_transfer"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih kondisi</option>
                                        <option value="0">Mandiri (boleh memakai alat bantu jalan)</option>
                                        <option value="1">Memerlukan sedikit bantuan (1 orang) / dalam pengawasan
                                        </option>
                                        <option value="2">Memerlukan bantuan yang nyata (2 orang)</option>
                                        <option value="3">Tidak dapat duduk dengan seimbang, perlu bantuan total
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="parameter-section">
                                ...
                                <div class="sub-question-card">
                                    ...
                                    <select class="form-select custom-select" name="ontario_mobilitas"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">Pilih kondisi</option>
                            ...
                            <div class="conclusion alert alert-success">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanOntario">Risiko Rendah</span>
                                </p>
                                <input type="hidden" name="risiko_jatuh_lansia_kesimpulan"
                                    id="risiko_jatuh_lansia_kesimpulan" value="Risiko Rendah">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="risiko_decubitus">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select custom-select" id="risikoDecubitusSkala"
                        ...
                        <div id="skala_nortonForm" class="risk-form" style="display: none;">
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="norton_kondisi_fisik"
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="norton_kondisi_mental"
                                            onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="norton_aktivitas"
                                            onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="norton_mobilitas"
                                            onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="4">Baik (Skor: 4)</option>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="norton_inkontinensia"
                                            onchange="updateConclusion('norton')">
                                            <option value="">Pilih kondisi</option>
                            ...
                            <div class="conclusion alert alert-success">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanNorton">Risiko Rendah</span>
                                </p>
                                <input type="hidden" name="risiko_norton_kesimpulan" id="risiko_norton_kesimpulan"
                                    value="Risiko Rendah">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="aktivitas_harian">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select custom-select" id="aktivitasHarianSkala"
                        ...
                        <div id="skala_adlForm" class="risk-form" style="display: none;">
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="adl_makan"
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="adl_berjalan"
                                            onchange="updateConclusion('adl')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0">Mandiri (Skor: 0)</option>
                                            <option value="1">25% Dibantu (Skor: 1)</option>
                            ...
                            <div class="factor-card">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <select class="form-select custom-select" name="adl_mandi"
                                            onchange="updateConclusion('adl')">
                                            <option value="">Pilih kondisi</option>
                                            <option value="0">Mandiri (Skor: 0)</option>
                                            <option value="1">25% Dibantu (Skor: 1)</option>
                            ...
                            <div class="conclusion alert alert-success">
                                <h6 class="fw-bold mb-2">Kesimpulan Penilaian:</h6>
                                <p class="conclusion-text mb-0 fs-5"><span id="kesimpulanADL">Mandiri (Skor: 0)</span>
                                </p>
                    ...
                    <div class="section-separator" id="pengkajian_edukasi">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="bicara[]"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="bahasa_sehari[]"
                                            id="bahasa_sehari_indonesia" value="indonesia">
                                        <label class="form-check-label" for="bahasa_sehari_indonesia">Indonesia (aktif/
                                            pasif)</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="bahasa_sehari[]"
                                            id="bahasa_sehari_daerah" value="daerah">
                                        <label class="form-check-label" for="bahasa_sehari_daerah">Daerah</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="bahasa_sehari[]"
                                            id="bahasa_sehari_asing" value="asing">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="penerjemah[]"
                                            id="tidak_perlu_penerjemah" value="tidak">
                                        <label class="form-check-label" for="tidak_perlu_penerjemah">Tidak</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="penerjemah[]"
                                            id="perlu_penerjemah_ya" value="ya">
                                        <label class="form-check-label" for="perlu_penerjemah_ya">Ya, bahasa</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="penerjemah[]"
                                            id="perlu_penerjemah_bahasa_isyarat" value="bahasa_isyarat">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="cara_komunikasi[]"
                                            id="komunikasi_audio_visual" value="audio_visual">
                                        <label class="form-check-label" for="komunikasi_audio_visual">Audio-visual/
                                            gambar</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="cara_komunikasi[]"
                                            id="komunikasi_diskusi" value="diskusi">
                                        <label class="form-check-label" for="komunikasi_diskusi">Diskusi</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="cara_komunikasi[]"
                                            id="komunikasi_lain_komunikasi" value="lain">
                                        <label class="form-check-label"
                                ...
                                <div class="mt-2">
                                    <input type="text" class="form-control" name="cara_komunikasi_lainnya"
                                        placeholder="Sebutkan cara komunikasi lainnya...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="potensi_pembelajaran[]"
                                            id="potensi_proses_penyakit" value="proses_penyakit">
                                        <label class="form-check-label" for="potensi_proses_penyakit">Proses
                                            penyakit</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="potensi_pembelajaran[]"
                                            id="potensi_pengobatan_tindakan" value="pengobatan_tindakan">
                                        <label class="form-check-label"
                                            for="potensi_pengobatan_tindakan">Pengobatan/tindakan</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="potensi_pembelajaran[]"
                                            id="potensi_terapi_obat" value="terapi_obat">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                name="potensi_pembelajaran[]" id="lain_pembelajaran" value="lain">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="catatan_khusus" rows="4"
                                    placeholder="Tulis catatan khusus di sini..."></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="diet_khusus">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-4 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="pengaruh_perawatan[]"
                                                id="pasien_keluarga" value="pasien_keluarga">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pengaruh_ya_tidak_1"
                                                    id="pengaruh_ya_1" value="ya">
                                                <label class="form-check-label" for="pengaruh_ya_1">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pengaruh_ya_tidak_1"
                                                    id="pengaruh_tidak_1" value="tidak">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pengaruh_ya_tidak_2"
                                                    id="pengaruh_ya_2" value="ya">
                                                <label class="form-check-label" for="pengaruh_ya_2">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pengaruh_ya_tidak_2"
                                                    id="pengaruh_tidak_2" value="tidak">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="d-flex gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pengaruh_ya_tidak_3"
                                                    id="pengaruh_ya_3" value="ya">
                                                <label class="form-check-label" for="pengaruh_ya_3">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pengaruh_ya_tidak_3"
                                                    id="pengaruh_tidak_3" value="tidak">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="hidup_sendiri" id="hidup_ya"
                                            value="1">
                                        <label class="form-check-label" for="hidup_ya">Ya</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="hidup_sendiri"
                                            id="hidup_tidak" value="0">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="antisipasi_masalah"
                                            id="antisipasi_tidak" value="0">
                                        <label class="form-check-label" for="antisipasi_tidak">Tidak</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="antisipasi_masalah"
                                            id="antisipasi_ya" value="1">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="makan_minum" value="makan_minum">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="konsumsi_obat" value="konsumsi_obat">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="berpakaian" value="berpakaian">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="perawatan_luka" value="perawatan_luka">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="mandi_berpakaian" value="mandi_berpakaian">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="menyiapkan_makanan" value="menyiapkan_makanan">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="edukasi_kesehatan" value="edukasi_kesehatan">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="bantuan_hal[]"
                                                id="lainnya_bantuan" value="lainnya">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="peralatan_medis"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="alat_bantu"
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-6 col-form-label">Apakah memerlukan bantuan /perawatan khusus di rumah
                                setelah keluar rumah sakit (homecare, home visit)?</label>
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="perawatan_khusus"
                                            id="perawatan_khusus_tidak" value="0">
                                        <label class="form-check-label" for="perawatan_khusus_tidak">Tidak</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="perawatan_khusus"
                                            id="perawatan_khusus_ya" value="1">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="nyeri_kronis"
                                            id="nyeri_kronis_tidak" value="0">
                                        <label class="form-check-label" for="nyeri_kronis_tidak">Tidak</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="nyeri_kronis"
                                            id="nyeri_kronis_ya" value="1">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="keterampilan_khusus"
                                            id="keterampilan_tidak" value="0">
                                        <label class="form-check-label" for="keterampilan_tidak">Tidak</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="keterampilan_khusus"
                                            id="keterampilan_ya" value="1">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex gap-3 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="dirujuk_komunitas"
                                            id="dirujuk_tidak" value="-">
                                        <label class="form-check-label" for="dirujuk_tidak">Tidak</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="dirujuk_komunitas"
                                            id="dirujuk_ya" value="1">
                        ...
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label">CATATAN KHUSUS:</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="catatan_khusus_diet" rows="4"
                                    placeholder="Tulis catatan khusus di sini..."></textarea>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input rencana-perawatan-row-1" type="checkbox"
                                                    name="diagnosis[]" value="bersihan_jalan_nafas"
                                                ...
                                                <label class="form-check-label" for="diag_bersihan_jalan_nafas">
                                                    ...
                                                    dengan spasme jalan nafas, hipersekresi jalan nafas,adanya benda
                                                    asing pada jalan nafas, secret tertahan di saluran nafas, proses
                                                    infeksi.
                                                </label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input rencana-perawatan-row-1" type="checkbox"
                                                    name="diagnosis[]" value="risiko_aspirasi"
                                                ...
                                                <label class="form-check-label" for="diag_risiko_aspirasi">
                                                    ...
                                                    kesadaran, penurunan reflek muntah dan/ atau batuk, gangguan
                                                    menelan, terpasang slang nasogastrik, dan ketidak matangan
                                                    koordinasi menghisap,menelan dan bernafas.
                                                </label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input rencana-perawatan-row-1" type="checkbox"
                                                    name="diagnosis[]" value="pola_nafas_tidak_efektif"
                                                    id="diag_pola_nafas_tidak_efektif">
                                                <label class="form-check-label" for="diag_pola_nafas_tidak_efektif">
                                                    <strong>Pola nafas tidak efekti</strong> berhubungan dengan depresi
                                                    pusat pernafasan, hambatan upaya nafas, deformitas tulang dada,
                                                    posisi tubuh yang menghambat ekspansi paru, kecemasan.
                                                </label>
                                            </div>
                                        </td>
                                        <td class="align-top">
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="hipovolemia" id="diag_hipovolemia"
                                            ...
                                            <div id="rencana_hipovolemia" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Periksa tanda dan gejala hipovolemia
                                                        ...
                                                        penurun, turgor kulit menurun, membran mukosa kering, volume
                                                        urine menurun, haus, lemah)</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="hipervolemia" id="diag_hipervolemia"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="diare" id="diag_diare" onchange="toggleRencana('diare')">
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="retensi_urine" id="diag_retensi_urine"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="nyeri_akut" id="diag_nyeri_akut"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="nyeri_kronis" id="diag_nyeri_kronis"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="hipertermia" id="diag_hipertermia"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="konstipasi" id="diag_konstipasi"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="resiko_jatuh" id="diag_resiko_jatuh"
                                            ...
                                            <div id="rencana_resiko_jatuh" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi faktor lingkungan yang
                                                        meningkatkan risiko jatuh (lantai licin, penerangan
                                                        kurang)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="diagnosis[]"
                                                    value="gangguan_integritas_kulit"
