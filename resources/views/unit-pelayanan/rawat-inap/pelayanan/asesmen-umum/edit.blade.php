        ...
        <x-content-card>
            <x-button-previous />
                @include('components.page-header', [
                    'title' => 'Edit Asesmen Awal Keperawatan Rawat Inap Dewasa',
                    'description' =>
                    'Isikan Asesmen awal dalam 24 jam sejak pasien masuk ke unit pelayanan',
                ])


            <form method="POST" action="{{ route('rawat-inap.asesmen.keperawatan.umum.update', [
                    'kd_unit' => $kd_unit,
                    'kd_pasien' => $kd_pasien,
                    'tgl_masuk' => $tgl_masuk,
                ...
                <div class="section-separator" id="data-umum">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="date" class="form-control" name="tanggal" id="tanggal_masuk"
                                        value="{{ old('tanggal', $asesmen->asesmenKetDewasaRanap->tanggal ?? date('Y-m-d')) }}" required>
                                </div>
                                <div class="col-md-6">
                                    <input type="time" class="form-control" name="jam" id="jam_masuk"
                                        value="{{ old('jam', $asesmen->asesmenKetDewasaRanap->jam ? substr($asesmen->asesmenKetDewasaRanap->jam, 0, 5) : date('H:i')) }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-2">
                                <input type="number" class="form-control" name="nadi" value="{{ $asesmen->asesmenKetDewasaRanap->nadi}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-2">
                                <input type="number" class="form-control" name="sistole" value="{{ $asesmen->asesmenKetDewasaRanap->sistole}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-2">
                                <input type="number" class="form-control" name="nafas" value="{{ $asesmen->asesmenKetDewasaRanap->nafas}}">
                                <span class="input-group-text">kali/mnt</span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-2">
                                <input type="number" step="0.1" class="form-control" name="suhu" value="{{ $asesmen->asesmenKetDewasaRanap->suhu}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-2">
                                <input type="number" class="form-control" name="sao2" value="{{ $asesmen->asesmenKetDewasaRanap->sao2}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-2">
                                <input type="number" class="form-control" name="tb" value="{{ $asesmen->asesmenKetDewasaRanap->tb}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-2">
                                <input type="number" step="0.1" class="form-control" name="bb" value="{{ $asesmen->asesmenKetDewasaRanap->bb}}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="diagnosis_masuk" rows="3">{{ old('diagnosis_masuk', $asesmen->asesmenKetDewasaRanap->diagnosis_masuk ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="keluhan_utama" rows="3">{{ old('keluhan_utama', $asesmen->asesmenKetDewasaRanap->keluhan_utama ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="data_umum_alat_bantu[]" id="kacamata"
                                    value="kacamata"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="data_umum_alat_bantu[]" id="gigi_palsu"
                                    value="gigi_palsu"
                ...
                <div class="section-separator" id="riwayat-pasien">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="riwayat_pasien_lain" value="{{ $asesmen->asesmenKetDewasaRanapRiwayatPasien->riwayat_pasien_lain }}">
                    </div>
                    ...
                    <!-- Spiritual -->
                    <div class="col-12 mb-3 section-separator mt-2">
                ...
                <div class="section-separator" id="pemeriksaan-fisik">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="mt-3">
                                ...
                                <textarea class="form-control" name="mata_telinga_hidung_catatan" rows="2">{{ $asesmen->asesmenKetDewasaRanapFisik->mata_telinga_hidung_catatan ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="mt-3">
                                ...
                                <textarea class="form-control" name="pemeriksaan_paru_catatan" rows="2"
                                    >{{ old('pemeriksaan_paru_catatan', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_paru_catatan ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section mt-3">
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="pemeriksaan_gastrointestinal_bisingusmenurun2">Bising usus meningkat</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="pemeriksaan_gastrointestinal[]"
                        ...
                        <div class="mt-3">
                            ...
                            <textarea class="form-control" name="pemeriksaan_gastrointestinal_catatan" rows="2">{{ old('pemeriksaan_gastrointestinal_catatan', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_gastrointestinal_catatan ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section mt-3">
                        ...
                        <div class="mt-3">
                            <label class="form-label">Catatan:</label>
                            <textarea class="form-control" name="pemeriksaan_kardiovaskular_catatan" rows="2">{{ old('pemeriksaan_kardiovaskular_catatan', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_kardiovaskular_catatan ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 mt-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="mt-3">
                                <label class="form-label fw-bold">Catatan:</label>
                                <textarea class="form-control" name="pemeriksaan_genitourinaria_ginekologi_catatan" rows="2">{{ old('pemeriksaan_genitourinaria_ginekologi_catatan', $asesmen->asesmenKetDewasaRanapFisik->pemeriksaan_genitourinaria_ginekologi_catatan ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="vital_sign[gcs]" id="gcsInput"
                                value="{{ old('vital_sign.gcs', $gcsValue) }}" readonly>
                    ...
                    @push('modals')
                        @include('unit-pelayanan.rawat-inap.pelayanan.asesmen-umum.edit-gcs-modal')
                    @endpush
                </div>
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="2" name="status_nutrisi_lainnya">{{ $asesmen->asesmenKetDewasaRanapStatusNutrisi->status_nutrisi_lainnya }}</textarea>
                                    </div>
                ...
                <div class="section-separator">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="d-flex flex-wrap gap-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="frekuensi_nyeri[]" id="frekuensi_jarang" value="jarang"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="frekuensi_nyeri[]" id="frekuensi_hilang_timbul" value="hilang_timbul"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="frekuensi_nyeri[]" id="frekuensi_terus_menerus" value="terus_menerus"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="nyeri_menjalar" id="nyeri_menjalar_tidak" value="tidak"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="nyeri_menjalar" id="nyeri_menjalar_ya" value="ya"
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="durasi_nyeri_lokasi" id="nyeri_menjalar_lokasi"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="kualitas_nyeri[]" id="kualitas_nyeri_tumpul" value="nyeri_tumpul"
                                ...
                                <div class="col-md-4">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="kualitas_nyeri[]" id="kualitas_nyeri_tajam" value="nyeri_tajam"
                                ...
                                <div class="col-md-4">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="kualitas_nyeri[]" id="kualitas_nyeri_panas" value="panas_terbakar"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_cahaya" value="cahaya"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_gelap" value="gelap"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_berbaring" value="berbaring"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_pemberat[]" id="faktor_pemberat_gerakan" value="gerakan"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_cahaya" value="cahaya"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_gelap" value="gelap"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_sunyi" value="sunyi"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_dingin" value="Dingin"
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="faktor_peringan[]" id="faktor_peringan_lainnya" value="lainnya"
                                        ...
                                        <input type="text" class="form-control mt-2" id="faktor_peringan_lainnya_text" name="faktor_peringan_lainnya_text"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_mual" value="mual_muntah"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_tidur" value="tidur"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_nafsu_makan" value="nafsu_makan"
                                ...
                                <div class="col-md-3">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_emosi" value="emosi"
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="efek_nyeri[]" id="efek_nyeri_lainnya" value="lainnya"
                                        ...
                                        <input type="text" class="form-control mt-2" id="efek_nyeri_lainnya_text" name="efek_nyeri_lainnya_text"
                ...
                <div class="section-separator" id="pengkajian_edukasi">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="bicara_lainnya"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="bahasa_sehari_lainnya"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="penerjemah_bahasa"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="hambatan_lainnya"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="cara_komunikasi_lainnya"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="pendidikan_detail"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="potensi_pembelajaran_lainnya"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="catatan_khusus" rows="4">{{ old('catatan_khusus', $asesmen->asesmenKetDewasaRanapPengkajianEdukasi->catatan_khusus ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-separator" id="diet_khusus">
                    ...
                    <div class="mb-4">
                        <label class="form-label">Diet Khusus:</label>
                        <input type="text" class="form-control" name="diet_khusus"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="hidup_sendiri" id="hidup_ya" value="1"
                                    {{ old('1', $asesmen->asesmenKetDewasaRanapDietKhusus->hidup_sendiri ?? '') === '1' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="hidup_ya">Ya</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="hidup_sendiri" id="hidup_tidak" value="0"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="antisipasi_masalah" id="antisipasi_tidak" value="0"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="antisipasi_masalah" id="antisipasi_ya" value="1"
                            ...
                            <input type="text" class="form-control" name="antisipasi_jelaskan"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mt-2">
                                <input type="text" class="form-control" name="bantuan_lainnya"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="peralatan_medis" id="peralatan_tidak" value="0"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="peralatan_medis" id="peralatan_ya" value="1"
                            ...
                            <input type="text" class="form-control" name="peralatan_jelaskan"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alat_bantu" id="alat_bantu_tidak" value="0"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="alat_bantu" id="alat_bantu_ya" value="1"
                            ...
                            <input type="text" class="form-control" name="alat_bantu_jelaskan"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="perawatan_khusus" id="perawatan_khusus_tidak" value="0"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="perawatan_khusus" id="perawatan_khusus_ya" value="1"
                            ...
                            <input type="text" class="form-control" name="perawatan_khusus_jelaskan"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="nyeri_kronis" id="nyeri_kronis_tidak" value="0"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="nyeri_kronis" id="nyeri_kronis_ya" value="1"
                            ...
                            <input type="text" class="form-control" name="nyeri_kronis_jelaskan"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="keterampilan_khusus" id="keterampilan_tidak" value="0"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="keterampilan_khusus" id="keterampilan_ya" value="1"
                            ...
                            <input type="text" class="form-control" name="keterampilan_jelaskan"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex gap-3 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="dirujuk_komunitas" id="dirujuk_tidak" value="0"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="dirujuk_komunitas" id="dirujuk_ya" value="1"
                            ...
                            <input type="text" class="form-control" name="dirujuk_jelaskan"
                    ...
                    <div class="row mb-4">
                        <label class="col-sm-2 col-form-label">CATATAN KHUSUS:</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="catatan_khusus_diet" rows="4">{{ old('catatan_khusus_diet', $asesmen->asesmenKetDewasaRanapDietKhusus->catatan_khusus_diet ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
