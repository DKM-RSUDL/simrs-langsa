    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-section">
                <form
                    action="{{ route('rawat-inap.asuhan-keperawatan.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, encrypt($asuhan->id)]) }}"
                    method="post">
                    @csrf
                    @method('put')
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 mb-md-0">
                                        ...
                                        <input type="date" class="form-control" name="tgl_implementasi"
                                            value="{{ date('Y-m-d', strtotime($asuhan->tgl_implementasi)) }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <div class="d-flex gap-4">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="waktu" id="pagi"
                                                value="1" @checked($asuhan->waktu == 1)>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="waktu" id="sore"
                                                value="2" @checked($asuhan->waktu == 2)>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="waktu" id="malam"
                                                value="3" @checked($asuhan->waktu == 3)>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="airway[]"
                                                        ...
                                                        @checked(in_array('head_tilt', $asuhan->airway ?? []))>
                                                    <span>Head tilt</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="airway[]"
                                                        type="checkbox" id="jaw_trust" value="jaw_trush"
                                                        @checked(in_array('jaw_trush', $asuhan->airway ?? []))>
                                                    <span>Jaw trust</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="airway[]"
                                                        type="checkbox" id="control_servicalis" value="servicalis"
                                                        @checked(in_array('servicalis', $asuhan->airway ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="airway[]"
                                                        ...
                                                        @checked(in_array('nebulizer', $asuhan->airway ?? []))>
                                                    <span>Nebulizer</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="airway[]"
                                                        type="checkbox" id="batuk__efektif" value="batuk"
                                                        @checked(in_array('batuk', $asuhan->airway ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="airway[]"
                                                        ...
                                                        @checked(in_array('fisiotherapi', $asuhan->airway ?? []))>
                                                    <span>Fisiotherapi dada</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="airway[]"
                                                        type="checkbox" id="suction" value="suction"
                                                        @checked(in_array('suction', $asuhan->airway ?? []))>
                                                    <span>Suction</span>
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="pernafasan[]"
                                                        ...
                                                        @checked(in_array('bunyi_nafas', $asuhan->pernafasan ?? []))>
                                                    <span>Monitoring bunyi nafas</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="pernafasan[]"
                                                        type="checkbox" id="monitoring__sputum" value="sputum"
                                                        @checked(in_array('sputum', $asuhan->pernafasan ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="pernafasan[]"
                                                        ...
                                                        @checked(in_array('fowler', $asuhan->pernafasan ?? []))>
                                                    <span>Posisi semi fowler / fowler</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="pernafasan[]"
                                                        type="checkbox" id="saturasi__oksigen" value="oksigen"
                                                        @checked(in_array('oksigen', $asuhan->pernafasan ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="tanda_vital[]"
                                                        ...
                                                        @checked(in_array('nadi', $asuhan->tanda_vital ?? []))>
                                                    <span>Menghitung nadi</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="tanda_vital[]"
                                                        type="checkbox" id="mengukur__temperature" value="temperature"
                                                        @checked(in_array('temperature', $asuhan->tanda_vital ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="tanda_vital[]"
                                                        ...
                                                        @checked(in_array('observasi', $asuhan->tanda_vital ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="nyeri[]"
                                                        ...
                                                        @checked(in_array('identifikasi', $asuhan->nyeri ?? []))>
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="nyeri[]"
                                                        ...
                                                        @checked(in_array('kompres', $asuhan->nyeri ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="nyeri[]"
                                                        ...
                                                        @checked(in_array('message', $asuhan->nyeri ?? []))>
                                                    <span>Massage</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="nyeri[]"
                                                        type="checkbox" id="distraksi" value="distraksi"
                                                        @checked(in_array('distraksi', $asuhan->nyeri ?? []))>
                                                    <span>Distraksi</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="nyeri[]"
                                                        type="checkbox" id="relaksasi" value="relaksasi"
                                                        @checked(in_array('relaksasi', $asuhan->nyeri ?? []))>
                                                    <span>Relaksasi</span>
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="list-group">
                                                @php
                                                    $nutrisiOld = old('nutrisi', $asuhan->nutrisi ?? []);
                                                    $hasMakan = is_array($nutrisiOld) && in_array('makan', $nutrisiOld);
                                                    $hiddenMakanVal = old('memberi__makan__via', $hasMakan ? 1 : 0);
                                                    $makanViaValue = old('makan_via', $asuhan->makan_via ?? '');
                                                @endphp
                                                <div class="list-group-item d-flex flex-column">
                                                    ...
                                                    <!-- hidden boolean so controller->boolean('memberi__makan__via') works -->
                                                    <input type="hidden" id="memberi__makan__via_hidden"
                                                        name="memberi__makan__via" value="{{ $hiddenMakanVal }}">
                                                    <input type="text" id="makan_via" class="form-control mt-2"
                                                        name="makan_via" placeholder="NGT, OGT, Parenteral, dll"
                                                        value="{{ $makanViaValue }}"
                                                        style="{{ $hasMakan ? '' : 'display:none;' }}"
                                                        {{ $hasMakan ? '' : 'disabled' }}>
                                                </div>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="nutrisi[]"
                                                        type="checkbox" id="memberi__asi" value="asi"
                                                        @checked(in_array('asi', $asuhan->nutrisi ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="eliminasi[]"
                                                        ...
                                                        @checked(in_array('inkontinensia', $asuhan->eliminasi ?? []))>
                                                    <span>Monitor inkontinensia</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="eliminasi[]"
                                                        type="checkbox" id="memberikan__pispot" value="pispot"
                                                        @checked(in_array('pispot', $asuhan->eliminasi ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        ...
                                                        value="mandi" @checked(in_array('mandi', $asuhan->personal_hygiene ?? []))>
                                                    <span>Bantu mandi di tempat tidur</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        name="personal_hygiene[]" type="checkbox" id="bantu__berpakaian"
                                                        value="berpakaian" @checked(in_array('berpakaian', $asuhan->personal_hygiene ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        ...
                                                        value="kulit" @checked(in_array('kulit', $asuhan->personal_hygiene ?? []))>
                                                    <span>Perawatan kulit</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        name="personal_hygiene[]" type="checkbox" id="perawatan__rambut"
                                                        value="rambut" @checked(in_array('rambut', $asuhan->personal_hygiene ?? []))>
                                                    <span>Perawatan rambut</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        name="personal_hygiene[]" type="checkbox" id="perawatan__kuku"
                                                        value="kuku" @checked(in_array('kuku', $asuhan->personal_hygiene ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        ...
                                                        @checked(in_array('oral', $asuhan->personal_hygiene ?? []))>
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        ...
                                                        @checked(in_array('perineon', $asuhan->personal_hygiene ?? []))>
                                                    <span>Perawatan perineon</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0"
                                                        name="personal_hygiene[]" type="checkbox" id="perawatan__vulva"
                                                        value="vulva" @checked(in_array('vulva', $asuhan->personal_hygiene ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="ginekologi[]"
                                                        ...
                                                        @checked(in_array('oksitosin', $asuhan->ginekologi ?? []))>
                                                    <span>Pijat oksitosin</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="ginekologi[]"
                                                        type="checkbox" id="kontraksi__uteri" value="uteri"
                                                        @checked(in_array('uteri', $asuhan->ginekologi ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="ginekologi[]"
                                                        ...
                                                        @checked(in_array('tfu', $asuhan->ginekologi ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="sosial[]"
                                                        ...
                                                        @checked(in_array('dukungan', $asuhan->sosial ?? []))>
                                                    <span>Memberi dukungan</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="sosial[]"
                                                        type="checkbox" id="melibatkan__keluarga" value="keluarga"
                                                        @checked(in_array('keluarga', $asuhan->sosial ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="edukasi[]"
                                                        ...
                                                        @checked(in_array('nyeri', $asuhan->edukasi ?? []))>
                                                    <span>Manajemen nyeri</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="edukasi[]"
                                                        type="checkbox" id="pencegahan__jatuh" value="jatuh"
                                                        @checked(in_array('jatuh', $asuhan->edukasi ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="edukasi[]"
                                                        ...
                                                        @checked(in_array('infeksi', $asuhan->edukasi ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="cedera[]"
                                                        ...
                                                        value="bayi @checked(in_array('bayi', $asuhan->cedera ?? []))">
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="cedera[]"
                                                        ...
                                                        @checked(in_array('roda', $asuhan->cedera ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="cedera[]"
                                                        ...
                                                        @checked(in_array('alat_bantu', $asuhan->cedera ?? []))>
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="cedera[]"
                                                        ...
                                                        @checked(in_array('berjalan', $asuhan->cedera ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="lainnya[]"
                                                        ...
                                                        @checked(in_array('luka', $asuhan->lainnya ?? []))>
                                                    <span>Perawatan luka/GV</span>
                                                </label>
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="lainnya[]"
                                                        type="checkbox" id="perawatan__stoma" value="stoma"
                                                        @checked(in_array('stoma', $asuhan->lainnya ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="lainnya[]"
                                                        ...
                                                        @checked(in_array('infus', $asuhan->lainnya ?? []))>
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="lainnya[]"
                                                        ...
                                                        @checked(in_array('kejang', $asuhan->lainnya ?? []))>
                                            ...
                                            <div class="list-group">
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="lainnya[]"
                                                        ...
                                                        @checked(in_array('gips', $asuhan->lainnya ?? []))>
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="lainnya[]"
                                                        ...
                                                        @checked(in_array('luka_bakar', $asuhan->lainnya ?? []))>
                                                ...
                                                <label class="list-group-item d-flex gap-2">
                                                    <input class="form-check-input flex-shrink-0" name="lainnya[]"
                                                        ...
                                                        @checked(in_array('mata', $asuhan->lainnya ?? []))>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const checkbox = document.getElementById('memberi__makan__via');
            const input = document.getElementById('makan_via');
            const hidden = document.getElementById('memberi__makan__via_hidden');

            function syncMakan() {
                if (!checkbox || !input || !hidden) return;
                if (checkbox.checked) {
                    input.style.display = '';
                    input.disabled = false;
                    hidden.value = '1';
                } else {
                    // do NOT clear input value here so previous value is preserved when re-checking
            ...
            if (checkbox) {
                checkbox.addEventListener('change', syncMakan);
            }
            // init state (covers old() and existing data)
            syncMakan();
        });
    </script>
@endpush
