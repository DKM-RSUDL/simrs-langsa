<div class="modal fade" id="modal-asuhan-show" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel">
                    <i class="bi bi-clipboard2-pulse me-2"></i>LIHAT IMPLEMENTASI ASUHAN KEPERAWATAN RAWAT INAP
                </h5>
...
@push('js')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#btn-asuhan-show').on('click', function() {
                $('#modal-asuhan-show').modal('show');
            });
