                            ...
                            <tbody>
                                @foreach ($permintaanSecondOpinion as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('rawat-inap.permintaan-second-opinion.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $item->id]) }}"
