    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="form-section">
                <form action="{{ route('rawat-inap.permintaan-second-opinion.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $secondOpinion->id]) }}" method="post">
                    @csrf
                    @method('PUT')
