    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="edukasiForm" method="POST"
                action="{{ route('rawat-inap.dnr.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
                ...
                <div class="d-flex justify-content-center">
                    <div class="card w-100 h-100 shadow-sm">
                        <div class="card-body">
                            <div class="px-3">
                                <h4 class="header-asesmen">Tambah Penolakan Resusitasi</h4>
                            </div>
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-control">
                                        <input type="radio" name="dasar_perintah" id="perintah1"
                                            class="form-check-input me-1" value="1" required>
                                        <label for="perintah1">
                                    ...
                                    <div class="form-control">
                                        <input type="radio" name="dasar_perintah" id="perintah2"
                                            class="form-check-input me-1" value="2" required>
                                        <label for="perintah2">
