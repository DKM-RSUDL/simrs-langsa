    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="painAssessmentForm" method="POST"
                action="{{ route('rawat-inap.surveilans-ppi.a1.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}">
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group">
                                    <div class="radio-item">
                                        <input type="radio" name="cara_dirawat" id="emergency" value="Emergency" required>
                                        <label for="emergency">Emergency</label>
                                    </div>
                                    <div class="radio-item">
                                        <input type="radio" name="cara_dirawat" id="elektif" value="Elektif" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group">
                                    <div class="radio-item">
                                        <input type="radio" name="asal_masuk" id="dari_rumah" value="Dari rumah" required>
                                        <label for="dari_rumah">Dari Rumah</label>
                                    </div>
                                    <div class="radio-item">
                                        <input type="radio" name="asal_masuk" id="rujukan" value="Rujukan" required>
                        ...
                        <div class="form-section">
                            ...
                            <div class="tindakan-card">
                                ...
                                <!-- a. Vena Sentral -->
                                <div class="sub-tindakan active">
                                    <div class="sub-tindakan-header">
                                        <span>a. Vena Sentral</span>
                                    </div>
                                    <div class="sub-tindakan-body" style="display: block;">
                            ...
                            <div class="tindakan-card">
                                ...
                                <!-- b. (Empty slot for additional catheter type if needed) -->
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tanggal_implementasi').val(new Date().toISOString().split('T')[0]);
            $('#jam_implementasi').val(new Date().toTimeString().split(' ')[0].substring(0, 5));
