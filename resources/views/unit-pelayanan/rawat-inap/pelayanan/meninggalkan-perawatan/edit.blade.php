            ...
            <form id="edukasiForm" method="POST"
                ...
                <div class="d-flex justify-content-center">
                    <div class="card w-100 h-100 shadow-sm">
                        <div class="card-body">
                            <div class="px-3">
                                <h4 class="header-asesmen">Edit Pernyataan Meninggalkan Perawatan</h4>
                            </div>
                                ...
                                <div class="section-separator">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal" id="tanggal" class="form-control date"
                                            value="{{ date('Y-m-d', strtotime($pernyataan->tanggal)) }}" required readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="keperluan" style="min-width: 200px;">Keperluan</label>
                                        <textarea name="keperluan" id="keperluan" class="form-control" required>{{ $pernyataan->keperluan }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tgl_awal" id="tgl_awal" class="form-control date"
                                            value="{{ date('Y-m-d', strtotime($pernyataan->tgl_awal)) }}" required readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tgl_keluar" id="tgl_keluar" class="form-control date"
                                            value="{{ date('Y-m-d', strtotime($pernyataan->tgl_keluar)) }}" required
                                            readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="jam_keluar" id="jam_keluar" class="form-control"
                                            value="{{ date('H:i', strtotime($pernyataan->jam_keluar)) }}" required>
                                    </div>
