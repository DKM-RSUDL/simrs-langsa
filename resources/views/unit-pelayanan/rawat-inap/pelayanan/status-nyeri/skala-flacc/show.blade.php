...
@section('content')
    <div class="row">
        ...
        {{-- Detail Column --}}
        <div class="col-md-9">
            <a href="{{ route('rawat-inap.status-nyeri.skala-flacc.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('rawat-inap.status-nyeri.skala-flacc.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $skalaFlacc->id]) }}" 
