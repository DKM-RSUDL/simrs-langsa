    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="painAssessmentForm" method="POST"
                action="{{ route('rawat-inap.status-nyeri.skala-numerik.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $skalaNumerik->id]) }}">
                @csrf
                @method('PUT')
