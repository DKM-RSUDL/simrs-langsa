...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('rawat-inap.asesmen.medis.obstetri-maternitas.update', [
                                ...
                                <div class="section-separator" id="data-masuk">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8 d-flex gap-3">
                                            ...
                                            <input type="date" class="form-control" name="tgl_masuk" value="{{ $date }}">
                                            <input type="time" class="form-control" name="jam_masuk" value="{{ $time }}">
                                        </div>
                                    </div>
                                ...
                                <div class="section-separator" id="anamnesis">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="anamnesis_anamnesis" rows="4"
                                            placeholder="keluhan utama pasien">{{ $asesmen->asesmenObstetri->anamnesis_anamnesis ?? '' }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="pemeriksaan-fisik">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="kesadaran">
                                            ...
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kesadaran ?? '') == '1' ? 'selected'
                                                : '' }}>
                                                Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kesadaran ?? '') == '0' ? 'selected'
                                                : '' }}>
                                                Tidak</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="avpu">
                                            ...
                                            <option value="0" {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->avpu ??
                                                '') == '0' ? 'selected' : '' }}>
                                                Sadar Baik/Alert : 0</option>
                                            <option value="1" {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->avpu ??
                                                '') == '1' ? 'selected' : '' }}>
                                                Berespon dengan kata-kata/Voice: 1
                                            </option>
                                            <option value="2" {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->avpu ??
                                                '') == '2' ? 'selected' : '' }}>
                                                Hanya berespon jika dirangsang nyeri/pain:
                                                2</option>
                                            <option value="3" {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->avpu ??
                                                '') == '3' ? 'selected' : '' }}>
                                                Pasien tidak sadar/unresponsive: 3
                                            </option>
                                            <option value="4" {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->avpu ??
                                                '') == '4' ? 'selected' : '' }}>
                                                Gelisah atau bingung: 4</option>
                                            <option value="5" {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->avpu ??
                                                '') == '5' ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="komprehensif_posisi_janin">
                                            <option value="" selected>pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->komprehensif_posisi_janin ?? '') ==
                                                '1' ? 'selected' : '' }}>
                                                Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->komprehensif_posisi_janin ?? '') ==
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="kontraksi_kekuatan">
                                            <option value="" selected>pilih</option>
                                            <option value="baik" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_kekuatan ?? '') == 'baik'
                                                ? 'selected' : '' }}>
                                                Baik</option>
                                            <option value="sedang" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_kekuatan ?? '') ==
                                                'sedang' ? 'selected' : '' }}>
                                                Sedang</option>
                                            <option value="lemah" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_kekuatan ?? '') == 'lemah'
                                                ? 'selected' : '' }}>
                                                Lemah</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="kontraksi_irama">
                                            ...
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_irama ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Teratur</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_irama ?? '') == '0' ?
                                                'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="kontraksi_letak_janin">
                                            <option value="" selected>pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_letak_janin ?? '') == '1'
                                                ? 'selected' : '' }}>
                                                Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_letak_janin ?? '') == '0'
                                                ? 'selected' : '' }}>
                                                Tidak</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="kontraksi_presentasi_janin">
                                            <option value="" selected>pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_presentasi_janin ?? '') ==
                                                '1' ? 'selected' : '' }}>
                                                Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_presentasi_janin ?? '') ==
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="kontraksi_sikap_janin">
                                            <option value="" selected>pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_sikap_janin ?? '') == '1'
                                                ? 'selected' : '' }}>
                                                Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->kontraksi_sikap_janin ?? '') == '0'
                                                ? 'selected' : '' }}>
                                                Tidak</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="djj_irama">
                                            <option value="">pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->djj_irama ?? '') == '1' ? 'selected'
                                                : '' }}>
                                                Teratur</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->djj_irama ?? '') == '0' ? 'selected'
                                                : '' }}>
                                                Tidak Teratur</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="serviks_konsistensi">
                                            <option value="">pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_konsistensi ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Teratur</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_konsistensi ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Tidak Teratur</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="serviks_penurunan">
                                            <option value="">pilih</option>
                                            <option value="<50%" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_penurunan ?? '') == '<50%'
                                                    ? 'selected' : '' }}>
                                                    < 50%</option>
                                            <option value=">50%" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_penurunan ?? '') == '>50%' ?
                                                'selected' : '' }}>
                                                > 50%</option>
                                            <option value="100%" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_penurunan ?? '') == '100%' ?
                                                'selected' : '' }}>
                                                100%</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="time" class="form-control" name="serviks_jam_pembukaan" value="{{ $formatted_time }}">
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="serviks_posisi">
                                            <option value="">pilih</option>
                                            <option value="Belakang" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_posisi ?? '') == 'Belakang'
                                                ? 'selected' : '' }}>
                                                Belakang</option>
                                            <option value="Tengah" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_posisi ?? '') == 'Tengah' ?
                                                'selected' : '' }}>
                                                Tengah</option>
                                            <option value="Depan" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_posisi ?? '') == 'Depan' ?
                                                'selected' : '' }}>
                                                Depan</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="serviks_irama">
                                            <option value="">pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_irama ?? '') == '1' ?
                                                'selected' : '' }}>
                                                Teratur</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->serviks_irama ?? '') == '0' ?
                                                'selected' : '' }}>
                                                Tidak Teratur</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" name="panggul_promontorium">
                                                <option value="">pilih</option>
                                                <option value="1" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_promontorium ?? '') ==
                                                    '1' ? 'selected' : '' }}>
                                                    Teratur</option>
                                                <option value="0" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_promontorium ?? '') ==
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" name="panggul_line_terminalis">
                                                <option value="">pilih</option>
                                                <option value="1" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_line_terminalis ?? '')
                                                    == '1' ? 'selected' : '' }}>
                                                    Teraba = 2/3</option>
                                                <option value="0" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_line_terminalis ?? '')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" name="panggul_spina_ischiadika">
                                                <option value="">pilih</option>
                                                <option value="1" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_spina_ischiadika ?? '')
                                                    == '1' ? 'selected' : '' }}>
                                                    Menonjol</option>
                                                <option value="0" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_spina_ischiadika ?? '')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" name="panggul_arkus_pubis">
                                                <option value="">pilih</option>
                                                <option value="lancip" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_arkus_pubis ?? '') ==
                                                    'lancip' ? 'selected' : '' }}>
                                                    Lancip</option>
                                                <option value="tumpul" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_arkus_pubis ?? '') ==
                                                    'tumpul' ? 'selected' : '' }}>
                                                    Tumpul</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" name="panggul_lengkung_sakrum">
                                                <option value="">pilih</option>
                                                <option value="Cekung" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_lengkung_sakrum ?? '')
                                                    == 'Cekung' ? 'selected' : '' }}>
                                                    Cekung</option>
                                                <option value="Datar" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_lengkung_sakrum ?? '')
                                                    == 'Datar' ? 'selected' : '' }}>
                                                    Datar</option>
                                            </select>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <select class="form-select" name="panggul_dinding_samping">
                                                <option value="">pilih</option>
                                                <option value="Tegak" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_dinding_samping ?? '')
                                                    == 'Tegak' ? 'selected' : '' }}>
                                                    Tegak</option>
                                                <option value="Konvergen" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_dinding_samping ?? '')
                                                    == 'Konvergen' ? 'selected' : '' }}>
                                                    Konvergen</option>
                                                <option value="Diverger" {{ ($asesmen->
                                                    rmeAsesmenObstetriPemeriksaanFisik->panggul_dinding_samping ?? '')
                                                    == 'Diverger' ? 'selected' : '' }}>
                                                    Diverger</option>
                                            </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="panggul_simpulan">
                                            <option value="">pilih</option>
                                            <option value="Normal" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_simpulan ?? '') == 'Normal'
                                                ? 'selected' : '' }}>
                                                Normal</option>
                                            <option value="Sempit" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_simpulan ?? '') == 'Sempit'
                                                ? 'selected' : '' }}>
                                                Sempit</option>
                                            <option value="Borderline" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_simpulan ?? '') ==
                                                'Borderline' ? 'selected' : '' }}>
                                                Borderline</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="panggul_selaput_ketuban">
                                            <option value="">pilih</option>
                                            <option value="Utuh" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_selaput_ketuban ?? '') ==
                                                'Utuh' ? 'selected' : '' }}>
                                                Utuh</option>
                                            <option value="Pecah" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_selaput_ketuban ?? '') ==
                                                'Pecah' ? 'selected' : '' }}>
                                                Pecah</option>
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="panggul_air_ketuban">
                                            <option value="">pilih</option>
                                            <option value="Jernih" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_air_ketuban ?? '') ==
                                                'Jernih' ? 'selected' : '' }}>
                                                Jernih</option>
                                            <option value="Keruh" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_air_ketuban ?? '') ==
                                                'Keruh' ? 'selected' : '' }}>
                                                Keruh</option>
                                            <option value="Bau" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_air_ketuban ?? '') == 'Bau'
                                                ? 'selected' : '' }}>
                                                Bau</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-select" name="panggul_presentasi">
                                            <option value="">pilih</option>
                                            <option value="Belakang Kepala" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_presentasi ?? '') ==
                                                'Belakang Kepala' ? 'selected' : '' }}>
                                                Belakang Kepala</option>
                                            <option value="Puncak Kepala" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_presentasi ?? '') == 'Puncak
                                                Kepala' ? 'selected' : '' }}>
                                                Puncak Kepala</option>
                                            <option value="Dahi" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_presentasi ?? '') == 'Dahi'
                                                ? 'selected' : '' }}>
                                                Dahi</option>
                                            <option value="Muka" {{ ($asesmen->
                                                rmeAsesmenObstetriPemeriksaanFisik->panggul_presentasi ?? '') == 'Muka'
                                                ? 'selected' : '' }}>
                                                Muka</option>
                                        </select>
                                    </div>
                                ...
                                <div class="section-separator" id="status-nyeri">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" id="jenisSkalaSelect" name="jenis_skala_nyeri">
                                            <option value="">Pilih</option>
                                            <option value="nrs" {{ ($asesmen->
                                                rmeAsesmenObstetriStatusNyeri->jenis_skala_nyeri ?? '') == 'nrs' ?
                                                'selected' : '' }}>
                                                Scale NRS, VAS, VRS</option>
                                            <option value="flacc" {{ ($asesmen->
                                                rmeAsesmenObstetriStatusNyeri->jenis_skala_nyeri ?? '') == 'flacc' ?
                                                'selected' : '' }}>
                                                Face, Legs, Activity, Cry,
                                                Consolability (FLACC)</option>
                                            <option value="cries" {{ ($asesmen->
                                                rmeAsesmenObstetriStatusNyeri->jenis_skala_nyeri ?? '') == 'cries' ?
                                                'selected' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div id="kesimpulanNyeri" class="p-3 bg-success text-white rounded">
                                            {{ $asesmen->rmeAsesmenObstetriStatusNyeri->kesimpulan_nyeri ?? 'Nyeri
                                            Ringan' }}
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="jenis_nyeri">
                                                    <option value="">Pilih</option>
                                                    <option value="Akut" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->jenis_nyeri ?? '') == 'Akut' ?
                                                        'selected' : '' }}>
                                                        Akut</option>
                                                    <option value="Kronik" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->jenis_nyeri ?? '') == 'Kronik' ?
                                                        'selected' : '' }}>
                                                        Kronik</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="frekuensi_nyeri">
                                                    <option value="">Pilih</option>
                                                    <option value="Jarang" {{ ($asesmen->rmeAsesmenObstetriStatusNyeri->frekuensi_nyeri ?? '') == 'Jarang' ? 'selected' : '' }}>
                                                        Jarang</option>
                                                    <option value="Hilang Timbul" {{ ($asesmen->rmeAsesmenObstetriStatusNyeri->frekuensi_nyeri ?? '') == 'Hilang Timbul' ? 'selected' : '' }}>
                                                        Hilang Timbul</option>
                                                    <option value="Terus Menerus" {{ ($asesmen->rmeAsesmenObstetriStatusNyeri->frekuensi_nyeri ?? '') == 'Terus Menerus' ? 'selected' : '' }}>
                                                        Terus Menerus</option>
                                                    <option value="Tidak Terbuka" {{ ($asesmen->rmeAsesmenObstetriStatusNyeri->frekuensi_nyeri ?? '') == 'Tidak Terbuka' ? 'selected' : '' }}>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="menjalar">
                                                    <option value="">Pilih</option>
                                                    <option value="1" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->menjalar ?? '') == '1' ?
                                                        'selected' : '' }}>
                                                        Ya</option>
                                                    <option value="0" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->menjalar ?? '') == '0' ?
                                                        'selected' : '' }}>
                                                        Tidak</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="kualitas_nyeri">
                                                    <option value="">Pilih</option>
                                                    <option value="Nyeri Tumpul" {{ ($asesmen->rmeAsesmenObstetriStatusNyeri->kualitas_nyeri ?? '') == 'Nyeri Tumpul' ? 'selected' : '' }}>
                                                        Nyeri Tumpul</option>
                                                    <option value="Nyeri Tajam" {{ ($asesmen->rmeAsesmenObstetriStatusNyeri->kualitas_nyeri ?? '') == 'Nyeri Tajam' ? 'selected' : '' }}>
                                                        Nyeri Tajam</option>
                                                    <option value="Panas/ Terbakar" {{ ($asesmen->rmeAsesmenObstetriStatusNyeri->kualitas_nyeri ?? '') == 'Panas/ Terbakar' ? 'selected' : '' }}>
                                                        Panas/ Terbakar
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="faktor_pemberat">
                                                    <option value="">Pilih</option>
                                                    <option value="Cahaya" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->faktor_pemberat ?? '') ==
                                                        'Cahaya' ? 'selected' : '' }}>
                                                        Cahaya</option>
                                                    <option value="Gelap" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->faktor_pemberat ?? '') == 'Gelap'
                                                        ? 'selected' : '' }}>
                                                        Gelap</option>
                                                    <option value="Berbaring" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->faktor_pemberat ?? '') ==
                                                        'Berbaring' ? 'selected' : '' }}>
                                                        Berbaring</option>
                                                    <option value="Gerakan" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->faktor_pemberat ?? '') ==
                                                        'Gerakan' ? 'selected' : '' }}>
                                                        Gerakan</option>
                                                </select>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="faktor_peringan">
                                                    <option value="">Pilih</option>
                                                    <option value="Cahaya" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->faktor_peringan ?? '') ==
                                                        'Cahaya' ? 'selected' : '' }}>
                                                        Cahaya</option>
                                                    <option value="Gelap" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->faktor_peringan ?? '') == 'Gelap'
                                                        ? 'selected' : '' }}>
                                                        Gelap</option>
                                                    <option value="Berbaring" {{ ($asesmen->
                                                        rmeAsesmenObstetriStatusNyeri->faktor_peringan ?? '') ==
                                    ...
                                    <input type="hidden" name="efek_nyeri" id="efekNyeriInput" value="{{ is_array($asesmen->rmeAsesmenObstetriStatusNyeri->efek_nyeri ?? null) ?
                                ...
                                <div class="section-separator">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <input type="text" class="form-control" name="abortus" placeholder="Abortus"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="siklus">
                                            <option value="" selected>pilih</option>
                                            <option value="Nyeri Tumpul" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->siklus ?? '') == 'Nyeri Tumpul' ?
                                                'selected' : '' }}>Nyeri Tumpul</option>
                                            <option value="Nyeri Tajam" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->siklus ?? '') == 'Nyeri Tajam' ?
                                                'selected' : '' }}>Nyeri Tajam</option>
                                            <option value="Panas/ Terbakar" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->siklus ?? '') == 'Panas/ Terbakar' ?
                                                'selected' : '' }}>Panas/ Terbakar</option>
                                        </select>
                                    </div>
        ...
        ($asesmen->rmeAsesmenObstetriRiwayatKesehatan->kebiasaan_ibu_hamil ?? '') }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="kehamilan_diinginkan">
                                            <option value="" selected>pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->kehamilan_diinginkan ?? '') == '1' ?
                                                'selected' : '' }}>Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->kehamilan_diinginkan ?? '') == '0' ?
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="dukungan_sosial">
                                            <option value="" selected>pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->dukungan_sosial ?? '') == '1' ?
                                                'selected' : '' }}>Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->dukungan_sosial ?? '') == '0' ?
                                                'selected' : '' }}>Tidak</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="hidden" name="pengambilan_keputusan"
                                                id="PengambilanKeputusanlInput" value="{{ is_array($asesmen->rmeAsesmenObstetriRiwayatKesehatan->pengambilan_keputusan ?? null) ?
        ...
        ($asesmen->rmeAsesmenObstetriRiwayatKesehatan->pengambilan_keputusan ?? '') }}">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="hidden" name="pendamping" id="pendampingInput" value="{{ is_array($asesmen->rmeAsesmenObstetriRiwayatKesehatan->pendamping ?? null) ?
        ...
        ($asesmen->rmeAsesmenObstetriRiwayatKesehatan->pendamping ?? '') }}">
                                        ...
                                        <div class="d-flex gap-3">
                                            <select class="form-select" name="riwayat_rawat_inap">
                                                <option value="" {{ ($asesmen->
                                                    rmeAsesmenObstetriRiwayatKesehatan->riwayat_rawat_inap ?? '') == ''
                                                    ? 'selected' : '' }}>pilih</option>
                                                <option value="1" {{ ($asesmen->
                                                    rmeAsesmenObstetriRiwayatKesehatan->riwayat_rawat_inap ?? '') == '1'
                                                    ? 'selected' : '' }}>Ya, Pernah</option>
                                                <option value="0" {{ ($asesmen->
                                                    rmeAsesmenObstetriRiwayatKesehatan->riwayat_rawat_inap ?? '') == '0'
                                                    ? 'selected' : '' }}>Tidak Pernah</option>
                                            </select>
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="d-block mb-2" style="min-width: 200px;">Konsumsi Obat-Obatan (Jika
                                            Ada)</label>
                                        <select class="form-select" name="konsumsi_obat">
                                            <option value="" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->konsumsi_obat ?? '') == '' ?
                                                'selected' : '' }}>pilih</option>
                                            <option value="1" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->konsumsi_obat ?? '') == '1' ?
                                                'selected' : '' }}>Ya</option>
                                            <option value="0" {{ ($asesmen->
                                                rmeAsesmenObstetriRiwayatKesehatan->konsumsi_obat ?? '') == '0' ?
                                                'selected' : '' }}>Tidak</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="hidden" name="riwayat_penyakin_keluarwa"
                                                id="riwayatPenyakinKeluarwaInput" value="{{ is_array($asesmen->rmeAsesmenObstetriRiwayatKesehatan->riwayat_penyakin_keluarwa ?? null) ?
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="antenatal_lain"
                                                    ...
                                                    ($asesmen->rmeAsesmenObstetriRiwayatKesehatan->antenatal_lain ?? '')
                                                == '0' ? 'checked' : '' }}>
                                                        ...
                                                        <div class="d-flex align-items-center flex-grow-1">
                                                            ...
                                                            <div class="file-input-wrapper position-relative w-100">
                                                                ...
                                                                <div class="file-info small text-muted mt-1"
                                                                    id="{{ $key }}FileInfo">
                                                                    @php
                                                                    $file_path = $asesmen->asesmenObstetri->{'hasil_pemeriksaan_penunjang_' . $key} ?? null;
                                                                    $file_url = $file_path ? asset('storage/' . $file_path) : null;
                                                                    @endphp
                                                                    @if($file_path)
        ...
        \Carbon\Carbon::now()->addDays(7)->format('d M Y') }}">
                                ...
                                <div class="section-separator" id="diagnosis">
                                    ...
                                    $diagnosisBanding =
                                    !empty($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->diagnosis_banding)
                                    ? json_decode(
                                    ...
                                    : [];
                                    $diagnosisKerja =
                                    !empty($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->diagnosis_kerja)
                                    ? json_decode(
                                ...
                                <div class="section-separator" style="margin-bottom: 2rem;">
                                    ...
                                    $implementationData = [
                                    'observasi' => !empty($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->observasi)
                                    ? json_decode($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->observasi, true) :
                                    [],
                                    'terapeutik' =>
                                    !empty($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->terapeutik)
                                    ? json_decode($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->terapeutik, true) :
                                    [],
                                    'edukasi' => !empty($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->edukasi)
                                    ? json_decode($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->edukasi, true) :
                                    [],
                                    'kolaborasi' =>
                                    !empty($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->kolaborasi)
                                    ? json_decode($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->kolaborasi, true) :
                                    [],
                                    'prognosis' => !empty($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->prognosis)
                                    ? json_decode($asesmen->rmeAsesmenObstetriDiagnosisImplementasi->prognosis, true) :
                                    []
                                    ];
                                    @endphp
