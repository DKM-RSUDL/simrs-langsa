        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Edit Asesmen Awal Medis Obstetri',
                        ...
                        <div>
                            ...
                            <div class="section-separator" id="pemeriksaan-fisik">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="keadaan_umum" placeholder="jelaskan"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="komprehensif_posisi_janin">
                                        ...
                                        <option value="2"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->komprehensif_posisi_janin ?? '') == '2' ? 'selected' : '' }}>
                                            PUKA
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="kontraksi_letak_janin">
                                        ...
                                        <option value="1"
                                            ...
                                            Memanjang</option>
                                        <option value="2"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->kontraksi_irama ?? '') == '2' ? 'selected' : '' }}>
                                            Lintang</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="kontraksi_letak_janin">
                                        ...
                                        <option value="2"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->kontraksi_letak_janin ?? '') == '2' ? 'selected' : '' }}>
                                            Lintang
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="kontraksi_presentasi_janin">
                                        ...
                                        <option value="1"
                                            ...
                                            Kepala</option>
                                        <option value="2"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->kontraksi_presentasi_janin ?? '') == '2' ? 'selected' : '' }}>
                                            Bokong</option>
                                        <option value="3"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->kontraksi_presentasi_janin ?? '') == '3' ? 'selected' : '' }}>
                                            Bahu</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="kontraksi_sikap_janin">
                                        <option value= "">pilih</option>
                                        <option value="1"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->fkontraksi_sikap_janin ?? '') == '1' ? 'selected' : '' }}>
                                            Fleksi</option>
                                        <option value="2"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->kontraksi_sikap_janin ?? '') == '2' ? 'selected' : '' }}>
                                            Defleksi Ringan</option>
                                        <option value="3"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->kontraksi_sikap_janin ?? '') == '3' ? 'selected' : '' }}>
                                            Defleksi Sedang</option>
                                        <option value="4"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->kontraksi_sikap_janin ?? '') == '4' ? 'selected' : '' }}>
                                            Defleksi Maksimal</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="serviks_konsistensi">
                                        ...
                                        <option value="1"
                                            ...
                                            Lunak</option>
                                        <option value="2"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->serviks_konsistensi ?? '') == '2' ? 'selected' : '' }}>
                                            Kaku</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="panggul_simpulan">
                                        <option value="">pilih</option>
                                        <option value ="1"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->serviks_pembukaan ?? '') == '1' ? 'selected' : '' }}>
                                            &lt; 50%</option>
                                        <option value ="2"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->serviks_pembukaan ?? '') == '2' ? 'selected' : '' }}>
                                            &gt; 50%</option>
                                        <option value ="3"
                                            {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->serviks_pembukaan ?? '') == '3' ? 'selected' : '' }}>
                                            100%</option>
                                    </select>
                                    @php
                                        $jam_pembukaan =
                                    ...
                                    <select class="form-select ms-3" name="serviks_jam_pembukaan">
                                        <option value="" {{ $jam_pembukaan == '' ? 'selected' : '' }}>Penunjuk Pukul
                                        </option>
                                        @for ($i = 1; $i <= 12; $i++)
                                            <option value="{{ $i }}"
                                                {{ $jam_pembukaan == $i ? 'selected' : '' }}>
                                                {{ $i }}
                                            </option>
                                        @endfor
                                    </select>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select class="form-select" name="panggul_promontorium">
                                            ...
                                            <option value="1"
                                                ...
                                                Teraba</option>
                                            <option value="2"
                                                {{ ($asesmen->rmeAsesmenObstetriPemeriksaanFisik->panggul_promontorium ?? '') == '2' ? 'selected' : '' }}>
                                                Tidak Teraba</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-primary" id="btnPilihKebiasaanHamil"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button" class="btn btn-primary"
                                                id="btnPilihPengambilanKeputusan" title="Pilih Pengambilan Keputusan">
                                                <i class="bi bi-list-check me-1"></i> Pilih
                                            </button>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-auto">
                                                <div id="{{ $key }}Preview" class="preview-container">
                                                    @php
                                                        $file_path =
                                                            $asesmen->asesmenObstetri
                                                                ->{'hasil_pemeriksaan_penunjang_' . $key} ?? null;
                                                    @endphp
                                                    @if ($file_path)
                                                        @php
