...
<div class="row">
    ...
    <div class="col-md-9">
        <x-content-card>
            ...
            'title' => 'Asesmen Awal Medis Obstetri',
                    ...
                    <div>
                        <div class="section-separator" id="data-masuk">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-8 d-flex align-items-center gap-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="antenatal_rs" id="rs_tidak"
                                            value="0">
                                        <label class="form-check-label" for="rs_tidak">Tidak</label>
                                    </div>

                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="antenatal_rs" id="rs_ya"
                                            value="1">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-8 d-flex align-items-center gap-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="antenatal_lain" id="lain_ya"
                                            value="1">
                        ...
                        <div class="section-separator" id="pemeriksaan-fisik">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="suhu" placeholder="suhu dalam celcius"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" name="kontraksi_letak_janin">
                                    <option value="" selected>pilih</option>
                                    <option value="1">Memanjang</option>
                                    <option value="2">Lintang</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" name="kontraksi_presentasi_janin">
                                    ...
                                    <option value="2">Bokong</option>
                                    <option value="3">Bahu</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <label class="d-block mb-2" style="min-width: 200px;">Frekuensi</label>
                                <input type="text" class="form-control" name="djj_frekuensi" placeholder="Frekuensi">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="serviks_station" value="0"
                                            id="station0">
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <select class="form-select" name="panggul_promontorium">
                                        <option value="" selected>pilih</option>
                                        <option value="1">Teraba</option>
                                        <option value="2">Tidak Teraba</option>
                                    </select>
                                </div>
                                <div class="col-6">
                        ...
                        <div class="section-separator">
                            ...
                            <div class="row mt-2">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btnPilihPengambilanKeputusan"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="hidden" name="pengambilan_keputusan" id="PengambilanKeputusanlInput">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                <label class="d-block mb-2" style="min-width: 200px;">Defaksi
                                </label>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_rawat" style="flex: 1;">
                                </div>
                            </div>
