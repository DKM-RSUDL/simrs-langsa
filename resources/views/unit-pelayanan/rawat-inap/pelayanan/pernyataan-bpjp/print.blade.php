...
<head>
    ...
    <style>
        ...
        .form-field {
            margin-bottom: 3px;
            /* Mengurangi jarak antar field */
        }

        .form-field-label {
            display: inline-block;
            width: 180px;
            /* Mengurangi lebar label */
            vertical-align: top;
        }
        ...
        .duty-text {
            ...
            width: calc(100% - 20px);
            font-size: 10pt;
            /* Teks tugas sedikit lebih kecil */
        }
...
<body>
    <div class="container">
        <!-- Header/Kop Surat -->
        <div class="header">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('assets/img/logo-dpjp.png'))) }}"
                alt="Logo Kota Langsa" class="logo">
            <div class="kop-text">
        ...
        <div class="content">
            ...
            <div class="form-fields">
                ...
                <div class="form-field">
                    ...
                    <span class="dotted-line">
                        <span
                            class="real-value">{{ $pernyataanDPJP->dokter->spesialis->spesialisasi->spesialisasi ?? '' }}</span>
                    </span>
                </div>

                <div class="form-field">
                    <span class="form-field-label">KSM</span>
                    <span>: </span>
                    <span class="dotted-line">
                        <span
                            class="real-value">{{ $pernyataanDPJP->dokter->spesialis->spesialisasi->spesialisasi ?? '' }}</span>
                    ...
                    <span class="dotted-line">
                        <span class="real-value">
                            @if (isset($dataMedis->pasien->tgl_lahir))
                                <span
                                    class="date-format">{{ date('d/m/Y', strtotime($dataMedis->pasien->tgl_lahir)) }}</span>
                            @endif
                        </span>
                    </span>
                </div>
            ...
            <div class="duties">
                ...
                <div class="duty-item">
                    ...
                    <span class="duty-text">Bila diperlukan, melakukan konsultasi dengan bidang / kompetensi
                        lain;</span>
                </div>

                <div class="duty-item">
                    <span class="duty-number">3.</span>
                    <span class="duty-text">Melaksanakan pembuatan rekam medis dengan lengkap dan benar serta
                        menyerahkannya sesuai aturan yang berlaku.</span>
                </div>
            </div>

            <p>Demikian surat pernyataan ini dibuat untuk digunakan sebagaimana mestinya dengan penuh tanggung jawab.
            </p>
        </div>
