                            ...
                            <div class="mb-3">
                                ...
                                <select name="kd_unit_tujuan" id="kd_unit_tujuan" class="form-select select2" required>
                                    ...
                                    @foreach ($unitTujuan as $item)
                                        <option value="{{ $item->kd_unit }}" @selected(old('kd_unit_tujuan') == $item->kd_unit)>
                                            {{ $item->nama_unit }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="persetujuan" value="tidak"
                                            id="setuju_tidak" @checked(old('persetujuan') == 'tidak') required>
                                ...
                                <div class="checkbox-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="alasan[]" value="tenaga"
                                            id="tenaga" @checked(is_array(old('alasan')) && in_array('tenaga', old('alasan')))>
                            ...
                            <div class="checkbox-group d-flex gap-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="metode[]" value="kursi_roda"
                                        id="kursi_roda" @checked(is_array(old('metode')) && in_array('kursi_roda', old('metode')))>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="metode[]" value="tempat_tidur"
                                        id="tempat_tidur" @checked(is_array(old('metode')) && in_array('tempat_tidur', old('metode')))>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kesadaran" id="kesadaran" class="form-select select2">
                                        <option value="">--Pilih--</option>
                                        <option value="Compos Mentis" @selected(old('kesadaran') == 'Compos Mentis')>Compos Mentis</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="status_nyeri" id="status_nyeri" class="form-select select2">
                                                <option value="">--Pilih--</option>
                                                <option value="tidak_ada" @selected(old('status_nyeri') == 'tidak_ada')>Tidak Ada</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="checkbox-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="info_medis[]"
                                            value="ulkus_dekubitus" id="ulkus_dekubitus" @checked(is_array(old('info_medis')) && in_array('ulkus_dekubitus', old('info_medis')))>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="inkontinensia[]"
                                                    value="urine" id="urine" @checked(is_array(old('inkontinensia')) && in_array('urine', old('inkontinensia')))>
                                                <label class="form-check-label" for="urine">Urine</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="inkontinensia[]"
                                                    value="saliva" id="saliva" @checked(is_array(old('inkontinensia')) && in_array('saliva', old('inkontinensia')))>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="inkontinensia[]"
                                                    value="alvi" id="alvi" @checked(is_array(old('inkontinensia')) && in_array('alvi', old('inkontinensia')))>
