            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <a href="{{ route('rawat-inap.surat-kematian.index', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" 
                               class="btn btn-outline-secondary btn-action">
                                <i class="ti-arrow-left"></i> Kembali
                            </a>
                            <a href="{{ route('rawat-inap.surat-kematian.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $suratKematian->id]) }}" 
                               class="btn btn-warning btn-action">
                                <i class="ti-pencil"></i> Edit
                            </a>
                            <a href="{{ route('rawat-inap.surat-kematian.print', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $suratKematian->id]) }}" 
