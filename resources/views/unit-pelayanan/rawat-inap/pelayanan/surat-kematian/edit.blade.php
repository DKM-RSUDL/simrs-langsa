        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- The Form --}}
                    <form
                        action="{{ route('rawat-inap.surat-kematian.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $suratKematian->id]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
