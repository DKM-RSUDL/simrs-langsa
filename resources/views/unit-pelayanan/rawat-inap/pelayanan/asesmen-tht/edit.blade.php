                        ...
                        <div>
                            ...
                            <div class="section-separator" id="rencana_pengobatan">
                                <h5 class="fw-semibold mb-4">
                                    10. Rencana Penatalaksanaan Dan Pengobatan
                                </h5>

                                @php
                                    $rmeTht = $asesmen->rmeAsesmenTht;
                                    if ($rmeTht instanceof \Illuminate\Support\Collection) {
                                        $rmeTht = $rmeTht->first();
                                    }
                                @endphp

                                <textarea class="form-control" name="rencana_penatalaksanaan" rows="4"
                                    placeholder="Rencana Penatalaksanaan Dan Pengobatan">{{ trim(old('rencana_penatalaksanaan', $rmeTht->rencana_penatalaksanaan ?? '')) }}</textarea>
                            </div>
