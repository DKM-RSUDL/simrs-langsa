                    ...
                    <div>
                        ...
                        <div class="section-separator" id="anamnesis">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="anamnesis_anamnesis" rows="4" placeholder="keluhan utama pasien">{{ $asesmen->rmeAsesmenTht->anamnesis_anamnesis ?? '' }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="penyakit_sekarang"
                                    ...
                                    value="{{ $asesmen->rmeAsesmenTht->penyakit_sekarang ?? '' }}">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="penyakit_terdahulu"
                                    ...
                                    value="{{ $asesmen->rmeAsesmenTht->penyakit_terdahulu ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="section-separator" style="margin-bottom: 2rem;"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="darah"
                                    placeholder="darah" value="{{ $asesmen->rmeAsesmenTht->darah ?? '' }}">
                            </div>
                            <div class="form-group">
                                <label style="min-width: 200px;">Urine</label>
                                <input type="text" class="form-control" name="urine"
                                    placeholder="urine" value="{{ $asesmen->rmeAsesmenTht->urine ?? '' }}">
                            </div>
                        </div>
                        ...
                        <div class="section-separator" style="margin-bottom: 2rem;"
                            id="hasil-pemeriksaan-penunjang">
                            <h5 class="fw-semibold mb-4">9. Hasil Penunjang</h5>
                        ...
                        <div class="section-separator" id="rencana_pengobatan">
                            ...
                            <textarea class="form-control" name="rencana_pengobatan" rows="4"
                                placeholder="Rencana Penatalaksanaan Dan Pengobatan" {{ $readonly ?? false ? 'readonly' : '' }}>{{ old('rencana_pengobatan', isset($asesmen->rmeAsesmenTht) ? $asesmen->rmeAsesmenTht->rencana_pengobatan : '') }}</textarea>
                        </div>
                                ...
                                <div class="col-md-9">
                                    <select class="form-select bg-light" id="diagnosisMedis"
                                        ...
                                        <option value="Penyakit jantung"
                                            {{ ($asesmen->rmeAsesmenThtDischargePlanning[0]->dp_diagnosis_medis ?? '') == 'Penyakit jantung'
                                                ? 'selected'
                                                : '' }}>
                                            Penyakit jantung
                                        </option>
                                        <option value="Penyakit paru"
                                            {{ ($asesmen->rmeAsesmenThtDischargePlanning[0]->dp_diagnosis_medis ?? '') == 'Penyakit paru' ? 'selected' : '' }}>
                                            Penyakit paru
                                        </option>
                                        <option value="Lainnya"
                                            {{ ($asesmen->rmeAsesmenThtDischargePlanning[0]->dp_diagnosis_medis ?? '') == 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya</option>
                                    </select>
                                </div>
                            </div> --}}
