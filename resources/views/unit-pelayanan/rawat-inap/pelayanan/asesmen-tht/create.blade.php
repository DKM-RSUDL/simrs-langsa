                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    <div class="row g-3">
                                        ...
                                        <!-- HTML Progress Bar (sudah ada di halaman) -->
                                        {{-- <div class="col-md-4">
                                            <div class="progress-wrapper" id="progressWrapper" style="background: white;">
                                                ...
                                                <div class="mt-2">
                                                    <small class="text-muted">0/10 bagian telah diisi</small>
                                                </div>
                                            </div>
                                        </div> --}}
