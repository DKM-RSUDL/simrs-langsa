                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="family-disease-input"
                            placeholder="Masukkan nama penyakit keluarga" disabled>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="edit-family-disease-input" disabled>
                    <input type="hidden" id="edit-family-disease-index" disabled>
                </div>
            </div>
            <div class="modal-footer">
