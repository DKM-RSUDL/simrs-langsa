<div class="modal fade" id="addTindakanModal" tabindex="-1" aria-labelledby="addTindakanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form
                action="{{ route('rawat-inap.tindakan.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
...
<div class="modal fade" id="editTindakanModal" tabindex="-1" aria-labelledby="editTindakanModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form
                action="{{ route('rawat-inap.tindakan.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}"
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3">
                    <div class="col-7">
                        <div class="card">
                            <div class="card-body">
                                <p class="text-primary fw-bold">PPAA :</p>
                                <p id="ppa"></p>
                            </div>
                        </div>
                    </div>
