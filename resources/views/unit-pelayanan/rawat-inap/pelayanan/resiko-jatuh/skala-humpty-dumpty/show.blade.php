        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    ...
                    'description' =>
                        'Rincian data pengkajian resiko jatuh - humpty dumpty pasien rawat inap dengan mengisi formulir di bawah ini.',
                ])
                <!-- Informasi Dasar -->
                ...
                <table class="table table-bordered table-sm mb-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <h5 class="mb-0">{{ $dataHumptyDumpty->total_skor }}</h5>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge bg-primary">{{ $dataHumptyDumpty->jenis_kelamin }}</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge bg-primary">{{ $dataHumptyDumpty->diagnosis }}</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge bg-primary">{{ $dataHumptyDumpty->gangguan_kognitif }}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge bg-primary">{{ $dataHumptyDumpty->faktor_lingkungan }}</span></td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge bg-primary">{{ $dataHumptyDumpty->pembedahan_sedasi }}</span></td>
                        </tr>
                        <tr>
                            <td><strong>Penggunaan Medikamentosa</strong></td>
                            <td>
                                @if ($dataHumptyDumpty->penggunaan_medikamentosa == 3)
                                    Penggunaan multiple: sedative, obat hipnosis, barbiturate, fenotiazi, antidepresan,
                            ...
                            <td class="text-center"><span
                                    class="badge bg-primary">{{ $dataHumptyDumpty->penggunaan_medikamentosa }}</span></td>
                        </tr>
                    </tbody>
                </table>
