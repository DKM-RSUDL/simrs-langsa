        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    ...
                    'description' =>
                        'Rincian data pengkajian resiko jatuh - khusus lansian (Geriatri) pasien rawat inap.',
                ])
                <!-- Informasi Dasar -->
                ...
                <table class="table table-bordered table-sm mb-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <h5 class="mb-0">{{ $dataGeriatri->total_skor }}</h5>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered table-sm mb-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge bg-primary">{{ $dataGeriatri->kebiasaan_berkemih_4a }}</span></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span class="badge bg-primary">{{ $dataGeriatri->transfer }}</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span class="badge bg-primary">{{ $dataGeriatri->mobilitas }}</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><span
                                    class="badge bg-info">{{ $dataGeriatri->skor_transfer_mobilitas }}</span></td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <table class="table table-bordered table-sm mb-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Pasang gambar risiko jatuh diatas tempat tidur pasien dan pada pintu kamar pasien
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center">
