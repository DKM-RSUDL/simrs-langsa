                        ...
                        <div class="form-section">
                                ...
                                <div class="datetime-group">
                                    ...
                                    <div class="datetime-item">
                                        ...
                                        <input type="time" class="form-control" name="jam_implementasi"
                                            id="jam_implementasi"
                                            value="{{ date('H:i', strtotime($dataSkalaGeriatri->jam_implementasi)) }}"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="shift" name="shift" required>
                                    ...
                                    <option value="pagi" {{ $dataSkalaGeriatri->shift == 'pagi' ? 'selected' : '' }}>Pagi
                                    </option>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div
                                        ...
                                        <div style="font-weight: 500; margin-bottom: 0.5rem;">Apakah pasien datang kerumah
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div
                                        style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        <div style="font-weight: 500; margin-bottom: 0.5rem;">Apakah pasien delirium? (Tidak
                                    ...
                                    <div
                                        style="margin-bottom: 1rem; padding: 0.5rem; background-color: #f8f9fa; border-radius: 4px;">
                                        <div style="font-weight: 500; margin-bottom: 0.5rem;">Apakah pasien disorientasi?
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->transfer == 0 ? 'selected' : '' }}"
                                            for="transfer_5a">
                                        ...
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->transfer == 1 ? 'selected' : '' }}"
                                            for="transfer_5b">
                                        ...
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->transfer == 2 ? 'selected' : '' }}"
                                            for="transfer_5c">
                                        ...
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->transfer == 3 ? 'selected' : '' }}"
                                            for="transfer_5d">
                            ...
                            <div class="form-group">
                                <div class="radio-group">
                                    ...
                                    <div class="radio-options">
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->mobilitas == 0 ? 'selected' : '' }}"
                                            for="mobilitas_6a">
                                        ...
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->mobilitas == 1 ? 'selected' : '' }}"
                                            for="mobilitas_6b">
                                        ...
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->mobilitas == 2 ? 'selected' : '' }}"
                                            for="mobilitas_6c">
                                        ...
                                        <label
                                            class="radio-item {{ $dataSkalaGeriatri->mobilitas == 3 ? 'selected' : '' }}"
                                            for="mobilitas_6d">
