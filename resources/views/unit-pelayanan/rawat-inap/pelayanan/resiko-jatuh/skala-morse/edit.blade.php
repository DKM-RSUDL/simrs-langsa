             ...
             <x-content-card>
                 ...
                 <form id="resikoJatuh_form" method="POST"
                             ...
                             <div class="col-md-4">
                                 <div class="form-group resiko_jatuh__form-group d-flex flex-column">
                                     ...
                                     <input type="date" class="form-control resiko_jatuh__form-control" id="tanggal"
                                         name="tanggal"
                                         value="{{ old('tanggal', optional($skalaMorse->tanggal)->format('Y-m-d')) }}"
                                         required>
                                 </div>
                             </div>
                             <div class="col-md-4">
                             ...
                             <div class="col-md-4">
                                 <div class="form-group resiko_jatuh__form-group d-flex flex-column">
                                     ...
                                     <select class="form-control resiko_jatuh__form-control" id="shift" name="shift"
                                         ...
                                         <option value="PG"
                                             {{ old('shift', $skalaMorse->shift) == 'PG' ? 'selected' : '' }}>🌅 Pagi (PG)
                                         </option>
                                         <option value="SI"
                                             {{ old('shift', $skalaMorse->shift) == 'SI' ? 'selected' : '' }}>☀️ Siang (SI)
                                         </option>
                                         <option value="ML"
                                             {{ old('shift', $skalaMorse->shift) == 'ML' ? 'selected' : '' }}>🌙 Malam (ML)
                                         </option>
                                     </select>
                                 </div>
                             </div>
                     ...
                     <div class="resiko_jatuh__section-separator">
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('riwayat_jatuh', $skalaMorse->riwayat_jatuh) == '0' ? 'selected' : '' }}"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('riwayat_jatuh', $skalaMorse->riwayat_jatuh) == '25' ? 'selected' : '' }}"
                                 data-group="riwayat_jatuh">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('diagnosa_sekunder', $skalaMorse->diagnosa_sekunder) == '0' ? 'selected' : '' }}"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('diagnosa_sekunder', $skalaMorse->diagnosa_sekunder) == '15' ? 'selected' : '' }}"
                                 data-group="diagnosa_sekunder">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('bantuan_ambulasi', $skalaMorse->bantuan_ambulasi) == '0' ? 'selected' : '' }}"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('bantuan_ambulasi', $skalaMorse->bantuan_ambulasi) == '15' ? 'selected' : '' }}"
                                 data-group="bantuan_ambulasi">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('bantuan_ambulasi', $skalaMorse->bantuan_ambulasi) == '30' ? 'selected' : '' }}"
                                 data-group="bantuan_ambulasi">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('terpasang_infus', $skalaMorse->terpasang_infus) == '0' ? 'selected' : '' }}"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('terpasang_infus', $skalaMorse->terpasang_infus) == '20' ? 'selected' : '' }}"
                                 data-group="terpasang_infus">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('gaya_berjalan', $skalaMorse->gaya_berjalan) == '0' ? 'selected' : '' }}"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('gaya_berjalan', $skalaMorse->gaya_berjalan) == '10' ? 'selected' : '' }}"
                                 data-group="gaya_berjalan">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('gaya_berjalan', $skalaMorse->gaya_berjalan) == '20' ? 'selected' : '' }}"
                                 data-group="gaya_berjalan">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('status_mental', $skalaMorse->status_mental) == '0' ? 'selected' : '' }}"
                             ...
                             <div class="form-check resiko_jatuh__criteria-form-check {{ old('status_mental', $skalaMorse->status_mental) == '15' ? 'selected' : '' }}"
                                 data-group="status_mental">
                                 <input class="form-check-input resiko_jatuh__criteria-form-check-input" type="radio"
                         ...
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="card resiko_jatuh__card resiko_jatuh__result-card bg-light">
                                     <div class="card-body">
                                         <h5>SKOR TOTAL</h5>
                                         <div id="resikoJatuh_skorTotal" class="resiko_jatuh__score-total bg-primary">
                                             {{ old('skor_total', $skalaMorse->skor_total) }}</div>
                                     </div>
                                 </div>
                             </div>
                             <div class="col-md-6">
                     ...
                     <div class="resiko_jatuh__section-separator resiko_jatuh__intervensi-rr"
                         id="resikoJatuh_intervensiRR"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('tingkatkan_observasi', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('orientasi_pasien', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rr[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('pagar_pengaman', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rr[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('tempat_tidur_rendah', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rr[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('edukasi_perilaku', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rr[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('monitor_kebutuhan_pasien', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rr[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('anjurkan_tidak_menggunakan_kaus', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rr[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('lantai_kamar_mandi', old('intervensi_rr', $intervensiRR)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rr[]"
                     ...
                     <div class="resiko_jatuh__section-separator resiko_jatuh__intervensi-rs"
                         id="resikoJatuh_intervensiRS"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('lakukan_semua_intervensi_rendah', old('intervensi_rs', $intervensiRS)) ? 'selected' : '' }}">
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('pakai_gelang_risiko', old('intervensi_rs', $intervensiRS)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rs[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('pasang_gambar_risiko', old('intervensi_rs', $intervensiRS)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rs[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('tempatkan_risiko_jatuh', old('intervensi_rs', $intervensiRS)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rs[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('pertimbangkan_riwayat_obat', old('intervensi_rs', $intervensiRS)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rs[]"
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('gunakan_alat_bantu', old('intervensi_rs', $intervensiRS)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rs[]"
                                     id="rs_intervensi_6" value="gunakan_alat_bantu"
                                     {{ in_array('gunakan_alat_bantu', old('intervensi_rs', $intervensiRS)) ? 'checked' : '' }}>
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('dorong_partisipasi_keluarga', old('intervensi_rs', $intervensiRS)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rs[]"
                                     id="rs_intervensi_7" value="dorong_partisipasi_keluarga"
                                     {{ in_array('dorong_partisipasi_keluarga', old('intervensi_rs', $intervensiRS)) ? 'checked' : '' }}>
                     ...
                     <div class="resiko_jatuh__section-separator resiko_jatuh__intervensi-rt"
                         id="resikoJatuh_intervensiRT"
                         ...
                         <div class="resiko_jatuh__criteria-section">
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('lakukan_semua_intervensi', old('intervensi_rt', $intervensiRT)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rt[]"
                                     id="rt_intervensi_1" value="lakukan_semua_intervensi"
                                     {{ in_array('lakukan_semua_intervensi', old('intervensi_rt', $intervensiRT)) ? 'checked' : '' }}>
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('jangan_tinggalkan_pasien', old('intervensi_rt', $intervensiRT)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rt[]"
                                     id="rt_intervensi_2" value="jangan_tinggalkan_pasien"
                                     {{ in_array('jangan_tinggalkan_pasien', old('intervensi_rt', $intervensiRT)) ? 'checked' : '' }}>
                             ...
                             <div
                                 class="form-check resiko_jatuh__criteria-form-check {{ in_array('penempatan_dekat_nurse_station', old('intervensi_rt', $intervensiRT)) ? 'selected' : '' }}">
                                 <input class="form-check-input" type="checkbox" name="intervensi_rt[]"
                                     id="rt_intervensi_3" value="penempatan_dekat_nurse_station"
                                     {{ in_array('penempatan_dekat_nurse_station', old('intervensi_rt', $intervensiRT)) ? 'checked' : '' }}>
                     ...
                     <div class="text-end">
                         <x-button-submit id="resikoJatuh_simpan">Perbarui</x-button-submit>
                     </div>
                 </form>
                 ...
                 <div class="resiko_jatuh__section-separator mt-3">
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6">
                             <div class="resiko_jatuh__keterangan-box">
                                 <h6 class="resiko_jatuh__keterangan-title"><strong>Pengkajian resiko jatuh dilakukan pada
                                         waktu
                                         :</strong></h6>
                                 <ol type="a">
                                     <li>
