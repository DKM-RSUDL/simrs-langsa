        ...
        <div class="col-md-9">
            ...
            <div class="d-flex justify-content-center">
                <div class="card w-100 h-100 shadow-sm">
                    <div class="card-body">
                        <div class="px-3">
                            <h4 class="header-asesmen">Pernyataan PAPS</h4>
                        </div>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-group">
                                    <label for="alasan" style="min-width: 200px;">Alasan Menghentikan
                                        Perawatan</label>
                                    <textarea name="alasan" id="alasan" class="form-control">{{ $paps->alasan }}</textarea>
                                </div>
                            ...
                            <div class="section-separator" id="identitas-keluarga">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keluarga_nama" id="keluarga_nama" class="form-control"
                                        value="{{ $paps->keluarga_nama }}" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="keluarga_usia" id="keluarga_usia" class="form-control"
                                        value="{{ $paps->keluarga_usia }}" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keluarga_alamat" id="keluarga_alamat" class="form-control" disabled>{{ $paps->keluarga_alamat }}</textarea>
                                </div>
