        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Rincian Laporan Hasil Echocardiography',
                    'description' => 'Rincian data hasil echocardiography pasien rawat inap.',
                ])

                <form id="echocardiography_form" method="" action="">
                    @csrf
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <select id="dokter_pemeriksa" name="dokter_pemeriksa" class="form-select select2"
                                            required disabled>
                                            <option value="{{ $echocardiography->dokter->kd_dokter }}" selected>
                                                {{ $echocardiography->dokter->nama_lengkap }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
