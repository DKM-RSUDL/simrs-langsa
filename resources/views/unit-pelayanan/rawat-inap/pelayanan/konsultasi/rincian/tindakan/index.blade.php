            ...
            <x-content-card>
                <div class="d-flex flex-column gap-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div
                            class="d-flex flex-column flex-md-row flex-wrap flex-md-nowrap gap-2 justify-content-between w-100">
                            <!-- Select Option -->
                            <div>
                            ...
                            <div>
                                <form method="GET"
                                    action="{{ route('rawat-inap.konsultasi.rincian.tindakan.indexTindakan', ['kd_unit' => $dataMedis->kd_unit, 'kd_pasien' => $dataMedis->kd_pasien, 'tgl_masuk' => \Carbon\Carbon::parse($dataMedis->tgl_masuk)->format('Y-m-d'), 'urut_masuk' => $dataMedis->urut_masuk, 'kd_unit_tujuan' => $kd_unit_tujuan, 'kd_pasien_tujuan' => $kd_pasien_tujuan, 'tgl_masuk_tujuan' => $tgl_masuk_tujuan, 'jam_masuk_tujuan' => $jam_masuk_tujuan, 'urut_konsul' => $urut_konsul]) }}">
        ...
        $(document).ready(function() {
            $('#SelectOption').change(function() {
                ...
                window.location.href =
                    "{{ route('rawat-inap.konsultasi.rincian.tindakan.indexTindakan', ['kd_unit' => $dataMedis->kd_unit, 'kd_pasien' => $dataMedis->kd_pasien, 'tgl_masuk' => \Carbon\Carbon::parse($dataMedis->tgl_masuk)->format('Y-m-d'), 'urut_masuk' => $dataMedis->urut_masuk, 'kd_unit_tujuan' => $kd_unit_tujuan, 'kd_pasien_tujuan' => $kd_pasien_tujuan, 'tgl_masuk_tujuan' => $tgl_masuk_tujuan, 'jam_masuk_tujuan' => $jam_masuk_tujuan, 'urut_konsul' => $urut_konsul]) }}" +
                    queryString;
            });
        });
