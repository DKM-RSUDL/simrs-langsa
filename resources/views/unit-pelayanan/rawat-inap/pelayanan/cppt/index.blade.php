                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <a href="{{ route('rawat-inap.pelayanan.cppt.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}"
                                target="_blank" class="btn btn-outline-info">
                                <i class="bi bi-printer me-1"></i> Cetak CPPT
                            </a>
                                                    ...
                                                    <table class="table table-sm table-striped mb-0 align-middle">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @empty
                                                                <tr>
                                                                    <td colspan="3"
                                                                        class="text-center text-muted py-3">Tidak ada
                                                                        instruksi</td>
                                                                </tr>
                                                            @endforelse
                                                        </tbody>
