            ...
            success: function(response) {
                if (response.status == 'success') {
                    ...
                    for (let key in data) {
                        if (data.hasOwnProperty(key)) {
                            ...
                            $(target).find('#skalaNyeriBtn').removeClass('btn-success btn-warning btn-danger').addClass(valColor);
                ...
                setTimeout(() => {
                    try {
                        ...
                        if (window.MASTER_EDIT_INSTRUKSI_PPA && Array.isArray(window.MASTER_EDIT_INSTRUKSI_PPA)) {
                            loadEditInstruksiPpaFromAjaxDataFinal(window.MASTER_EDIT_INSTRUKSI_PPA);
