...
<div class="modal fade" id="addCpptModal" tabindex="-1" aria-labelledby="addCpptModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="{{ route('rawat-inap.cppt.store', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" method="post" id="formAddCppt">
                @csrf
                            ...
                            {{-- <div class="row mt-3">
                                <div class="checkbox-container">
                                    <div class="input-group">
                                        <input type="radio" @error('tindak_lanjut') class="is-invalid" @enderror id="plan_konrol_ulang" name="tindak_lanjut" value="2" @checked(old('tindak_lanjut') == 2) required>
                                        <label for="plan_konrol_ulang">Kontrol ulang, tgl:</label>
                                    </div>
                                    <div class="input-group">
                                        <input type="radio" @error('tindak_lanjut') class="is-invalid" @enderror id="plan_rujuk_internal" name="tindak_lanjut" value="4" @checked(old('tindak_lanjut') == 4) required>
                                        <label for="plan_rujuk_internal">Konsul/Rujuk Internal Ke:</label>
                                    </div>
                                    <div class="input-group">
                                        <input type="radio" @error('tindak_lanjut') class="is-invalid" @enderror id="plan_selesai" name="tindak_lanjut" value="3" @checked(old('tindak_lanjut') == 3) required>
                                        <label for="plan_selesai">Selesai di Klinik ini</label>
                                    </div>

                                    <div class="input-group">
                                        <input type="radio" @error('tindak_lanjut') class="is-invalid" @enderror id="plan_rujuk" name="tindak_lanjut" value="5" @checked(old('tindak_lanjut') == 5) required>
                                        <label for="plan_rujuk">Rujuk RS lain bagian:</label>
                                    </div>
                                    <div class="input-group">
                                        <input type="radio" @error('tindak_lanjut') class="is-invalid" @enderror id="plan_rawat_inap" name="tindak_lanjut" value="1" @checked(old('tindak_lanjut') == 1) required>
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="position-relative">
                                                <input type="text"
                                                    id="instruksi_ppa_search_input"
                                                    class="form-control"
                                                    placeholder="Ketik nama ppa mencari..."
                                                    autocomplete="off">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea id="instruksi_ppa_text_input"
                                                    class="form-control"
                                                    rows="2"
                                                ...
                                                <tbody id="instruksi_ppa_table_body">
                                                    <tr>
                                                        <td colspan="4" class="text-center text-muted py-5">
                                                            ...
                                                            <span class="fs-6">Belum ada instruksi yang ditambahkan</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
<div class="modal fade" id="editCpptModal" tabindex="-1" aria-labelledby="editCpptModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form action="{{ route('rawat-inap.cppt.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk]) }}" method="post" id="formEditCppt">
                @csrf
                @method('put')
                ...
                <div class="modal-body">
                    ...
                    <!-- Perbaikan HTML untuk EDIT MODAL - FINAL VERSION (ganti yang di modal) -->
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header bg-primary text-white">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="position-relative">
                                                <input type="text"
                                                    id="edit_instruksi_ppa_search_input"
                                                    class="form-control"
                                                    placeholder="Ketik nama ppa mencari..."
                                                    autocomplete="off">
                                                <input type="hidden" id="edit_instruksi_ppa_selected_value" name="edit_instruksi_ppa_perawat_select">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea id="edit_instruksi_ppa_text_input"
                                                    class="form-control"
                                                    rows="2"
                                                    placeholder="Masukkan instruksi untuk PPA yang dipilih..."></textarea>
                                        </div>
                                    ...
                                    <div class="border rounded">
                                        <div class="d-flex justify-content-between align-items-center p-3 bg-light border-bottom">
                                            ...
                                            <span class="badge bg-secondary fs-6" id="edit_instruksi_ppa_count_badge">0</span>
                                        </div>
                            ...
                            <!-- Hidden inputs untuk EDIT Modal - TANPA JSON -->
