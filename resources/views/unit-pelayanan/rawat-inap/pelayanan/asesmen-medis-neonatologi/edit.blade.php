...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('rawat-inap.asesmen.medis.medis-neonatologi.update', [
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="px-3">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <h4 class="header-asesmen"><span class="text-warning">Edit</span> Asesmen Pengkajian Awal Medis Neonatologi Bayi Sakit</h4>
                                    <p class="text-muted">
                        ...
                        <div class="px-3">
                            ...
                            <div class="section-separator" id="pemeriksaan-fisik">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="denyut_jantung" min="0" max="300"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->denyut_jantung ?? '' }}" placeholder="0">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="nadi" min="0" max="300"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->nadi ?? '' }}" placeholder="0">
                                                <span class="input-group-text">x/mnt</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="respirasi"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->respirasi ?? '' }}" placeholder="0">
                                                <span class="input-group-text">x/mnt</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" class="form-control" name="spo"
                                                value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->spo ?? '' }}" placeholder="0">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="temperatur"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->temperatur ?? '' }}" placeholder="36.5">
                                                <span class="input-group-text">°C</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="bb_sekarang" step="0.01" min="0"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->bb_sekarang ?? '' }}" placeholder="0.00">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="pb_sekarang" step="0.1" min="0"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->pb_sekarang ?? '' }}" placeholder="0.0">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="lk_sekarang" step="0.1" min="0"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->lk_sekarang ?? '' }}" placeholder="0.0">
                                                <span class="input-group-text">cm</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" class="form-control" name="bollard_score" min="0"
                                                value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->bollard_score ?? '' }}" placeholder="0">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="kepala_lp" step="0.1"
                                                    value="{{ $asesmen->asesmenMedisNeonatologiFisikGeneralis->kepala_lp ?? '' }}" placeholder="0">
                                                <span class="input-group-text">cm</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-11">
                                                    <input type="text" class="form-control" name="diagnosis_ibu_1" placeholder="Diagnosis 1" value="{{ $asesmen->asesmenMedisNeonatologiDtl->diagnosis_ibu_1 ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-1"><strong>2</strong></div>
                                                <div class="col-11">
                                                    <input type="text" class="form-control" name="diagnosis_ibu_2" placeholder="Diagnosis 2" value="{{ $asesmen->asesmenMedisNeonatologiDtl->diagnosis_ibu_2 ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="row mt-2">
                                                <div class="col-1"><strong>3</strong></div>
                                                <div class="col-11">
                                                    <input type="text" class="form-control" name="diagnosis_ibu_3" placeholder="Diagnosis 3" value="{{ $asesmen->asesmenMedisNeonatologiDtl->diagnosis_ibu_3 ?? '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="cara_persalinan[]" id="spontan" value="spontan" {{ in_array('spontan', $asesmen->asesmenMedisNeonatologiDtl->cara_persalinan ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="spontan">Spontan</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="cara_persalinan[]" id="sc" value="sc" {{ in_array('sc', $asesmen->asesmenMedisNeonatologiDtl->cara_persalinan ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="sc">SC</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="cara_persalinan[]" id="vacum" value="vacum" {{ in_array('vacum', $asesmen->asesmenMedisNeonatologiDtl->cara_persalinan ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="vacum">Vacum</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="cara_persalinan[]" id="forceps" value="forceps" {{ in_array('forceps', $asesmen->asesmenMedisNeonatologiDtl->cara_persalinan ?? []) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_mayor[]" id="demam" value="demam" {{ in_array('demam', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_mayor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="demam">Demam (T>38 °C)</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_mayor[]" id="kpd_18" value="kpd_18" {{ in_array('kpd_18', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_mayor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="kpd_18">KPD > 18 Jam</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_mayor[]" id="korioamnionitis" value="korioamnionitis" {{ in_array('korioamnionitis', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_mayor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="korioamnionitis">Korioamnionitis</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_mayor[]" id="fetal_distress" value="fetal_distress" {{ in_array('fetal_distress', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_mayor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="fetal_distress">Fetal distress, DJJ > 160 x/″</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_mayor[]" id="ketuban_berbau" value="ketuban_berbau" {{ in_array('ketuban_berbau', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_mayor ?? []) ? 'checked' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="kpd_12" value="kpd_12" {{ in_array('kpd_12', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="kpd_12">KPD > 12 Jam</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="apgar_skor" value="apgar_skor" {{ in_array('apgar_skor', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="apgar_skor">APGAR Skor 1'<5 atau 5'< 7</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="bblsr" value="bblsr" {{ in_array('bblsr', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="bblsr">BBLSR (<1500 g)</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="gestasi" value="gestasi" {{ in_array('gestasi', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="gestasi">Gestasi < 37 mggu</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="gemelli" value="gemelli" {{ in_array('gemelli', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="gemelli">Gemelli</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="keputihan_tdk_diobati" value="keputihan_tdk_diobati" {{ in_array('keputihan_tdk_diobati', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="keputihan_tdk_diobati">Keputihan tdk diobati</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="isk_susp_isk" value="isk_susp_isk" {{ in_array('isk_susp_isk', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="isk_susp_isk">ISK/ Susp. ISK</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="faktor_resiko_minor[]" id="ibu_demam" value="ibu_demam" {{ in_array('ibu_demam', $asesmen->asesmenMedisNeonatologiDtl->faktor_resiko_minor ?? []) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="d-flex gap-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_moro" id="refleks_moro_ya" value="1" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_moro ?? '') === '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="refleks_moro_ya">Ya</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_moro" id="refleks_moro_tidak" value="0" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_moro ?? '') === '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="d-flex gap-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_rooting" id="refleks_rooting_ya" value="1" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_rooting ?? '') === '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="refleks_rooting_ya">Ya</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_rooting" id="refleks_rooting_tidak" value="0" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_rooting ?? '') === '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="d-flex gap-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_palmar_grasping" id="refleks_palmar_grasping_ya" value="1" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_palmar_grasping ?? '') === '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="refleks_palmar_grasping_ya">Ya</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_palmar_grasping" id="refleks_palmar_grasping_tidak" value="0" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_palmar_grasping ?? '') === '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="d-flex gap-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_sucking" id="refleks_sucking_ya" value="1" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_sucking ?? '') === '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="refleks_sucking_ya">Ya</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_sucking" id="refleks_sucking_tidak" value="0" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_sucking ?? '') === '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="d-flex gap-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_plantar_grasping" id="refleks_plantar_grasping_ya" value="1" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_plantar_grasping ?? '') === '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="refleks_plantar_grasping_ya">Ya</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_plantar_grasping" id="refleks_plantar_grasping_tidak" value="0" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_plantar_grasping ?? '') === '0' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="d-flex gap-3">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_tonic_neck" id="refleks_tonic_neck_ya" value="1" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_tonic_neck ?? '') === '1' ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="refleks_tonic_neck_ya">Ya</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="refleks_tonic_neck" id="refleks_tonic_neck_tidak" value="0" {{ ($asesmen->asesmenMedisNeonatologiDtl->refleks_tonic_neck ?? '') === '0' ? 'checked' : '' }}>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-1"><strong>1</strong></div>
                                            <div class="col-11">
                                                <input type="text" class="form-control mb-2" name="kelainan_bawaan_1" placeholder="Kelainan bawaan 1" value="{{ $asesmen->asesmenMedisNeonatologiDtl->kelainan_bawaan_1 ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1"><strong>2</strong></div>
                                            <div class="col-11">
                                                <input type="text" class="form-control mb-2" name="kelainan_bawaan_2" placeholder="Kelainan bawaan 2" value="{{ $asesmen->asesmenMedisNeonatologiDtl->kelainan_bawaan_2 ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1"><strong>3</strong></div>
                                            <div class="col-11">
                                                <input type="text" class="form-control mb-2" name="kelainan_bawaan_3" placeholder="Kelainan bawaan 3" value="{{ $asesmen->asesmenMedisNeonatologiDtl->kelainan_bawaan_3 ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1"><strong>4</strong></div>
                                            <div class="col-11">
                                                <input type="text" class="form-control mb-2" name="kelainan_bawaan_4" placeholder="Kelainan bawaan 4" value="{{ $asesmen->asesmenMedisNeonatologiDtl->kelainan_bawaan_4 ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="section-separator" id="hasilPemeriksaanPenunjang">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="hasil_laboratorium" placeholder="Hasil Laboratorium" id="laboratorium" style="height: 100px">{{ $asesmen->asesmenMedisNeonatologiDtl->hasil_laboratorium ?? '' }}</textarea>
                                    <label for="laboratorium">1. Laboratorium</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_radiologi" placeholder="Hasil Radiologi" id="radiologi" style="height: 100px">{{ $asesmen->asesmenMedisNeonatologiDtl->hasil_radiologi ?? '' }}</textarea>
                                    <label for="radiologi">2. Radiologi</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_lainnya" placeholder="Hasil Lainnya" id="lainnya" style="height: 100px">{{ $asesmen->asesmenMedisNeonatologiDtl->hasil_lainnya ?? '' }}</textarea>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="usia_menarik_bayi" id="usia_ya" value="ya" {{ ($asesmen->asesmenMedisNeonatologiDtl->usia_menarik_bayi ?? '') === 'ya' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="usia_ya">Ya: Ibu/ Ayah/ Keluarga lainnya</label>
                                                </div>
                                                <input type="text" class="form-control" name="keterangan_usia" placeholder="Sebutkan siapa..." value="{{ $asesmen->asesmenMedisNeonatologiDtl->keterangan_usia ?? '' }}" {{ ($asesmen->asesmenMedisNeonatologiDtl->usia_menarik_bayi ?? '') !== 'ya' ? 'disabled' : '' }}>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check mb-2">
                                                ...
                                                <input type="text" class="form-control" name="keterangan_tidak_usia" placeholder="Jelaskan alasan..." value="{{ $asesmen->asesmenMedisNeonatologiDtl->keterangan_tidak_usia ?? '' }}" {{ ($asesmen->asesmenMedisNeonatologiDtl->usia_menarik_bayi ?? '') !== 'tidak' ? 'disabled' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="masalah_pulang" id="masalah_tidak" value="tidak" {{ ($asesmen->asesmenMedisNeonatologiDtl->masalah_pulang ?? '') === 'tidak' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="masalah_tidak">Tidak</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="masalah_pulang" id="masalah_ya" value="ya" {{ ($asesmen->asesmenMedisNeonatologiDtl->masalah_pulang ?? '') === 'ya' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="masalah_ya">Ya, jelaskan</label>
                                                </div>
                                                <textarea class="form-control" name="keterangan_masalah_pulang" rows="2" placeholder="Jelaskan masalah yang mungkin terjadi..." {{ ($asesmen->asesmenMedisNeonatologiDtl->masalah_pulang ?? '') !== 'ya' ? 'disabled' : '' }}>{{ $asesmen->asesmenMedisNeonatologiDtl->keterangan_masalah_pulang ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="beresiko_finansial" id="finansial_tidak" value="tidak" {{ ($asesmen->asesmenMedisNeonatologiDtl->beresiko_finansial ?? '') === 'tidak' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="finansial_tidak">Tidak</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="beresiko_finansial" id="finansial_ya" value="ya" {{ ($asesmen->asesmenMedisNeonatologiDtl->beresiko_finansial ?? '') === 'ya' ? 'checked' : '' }}>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="edukasi[]" id="edukasi_menyusui" value="menyusui" {{ in_array('menyusui', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="edukasi_menyusui">Menyusui</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="edukasi[]" id="edukasi_memandikan" value="memandikan" {{ in_array('memandikan', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="edukasi_memandikan">Memandikan</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="edukasi[]" id="edukasi_berpakaian" value="berpakaian" {{ in_array('berpakaian', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="edukasi_berpakaian">Berpakaian</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="edukasi[]" id="edukasi_perawatan_bayi" value="perawatan_bayi_dasar" {{ in_array('perawatan_bayi_dasar', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="edukasi_perawatan_bayi">Perawatan bayi dasar (basic infant care)</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="edukasi[]" id="edukasi_mengukur_suhu" value="mengukur_suhu" {{ in_array('mengukur_suhu', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="edukasi_mengukur_suhu">Mengukur suhu</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="edukasi[]" id="edukasi_perawatan_kulit" value="perawatan_kulit_kelamin" {{ in_array('perawatan_kulit_kelamin', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="edukasi_perawatan_kulit">Perawatan kulit/ kelamin</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="edukasi[]" id="edukasi_lainnya" value="lainnya" {{ in_array('lainnya', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="edukasi_lainnya">Lainnya</label>
                                                </div>
                                                <input type="text" class="form-control" name="edukasi_lainnya_keterangan" placeholder="Sebutkan edukasi lainnya..." value="{{ $asesmen->asesmenMedisNeonatologiDtl->edukasi_lainnya_keterangan ?? '' }}" {{ !in_array('lainnya', $asesmen->asesmenMedisNeonatologiDtl->edukasi ?? []) ? 'disabled' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="ada_membantu" id="membantu_tidak" value="tidak" {{ ($asesmen->asesmenMedisNeonatologiDtl->ada_membantu ?? '') === 'tidak' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="membantu_tidak">Tidak</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="ada_membantu" id="membantu_ada" value="ada" {{ ($asesmen->asesmenMedisNeonatologiDtl->ada_membantu ?? '') === 'ada' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="membantu_ada">Ada, siapa</label>
                                                </div>
                                                <input type="text" class="form-control" name="keterangan_membantu" placeholder="Sebutkan siapa yang membantu..." value="{{ $asesmen->asesmenMedisNeonatologiDtl->keterangan_membantu ?? '' }}" {{ ($asesmen->asesmenMedisNeonatologiDtl->ada_membantu ?? '') !== 'ada' ? 'disabled' : '' }}>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="perkiraan_lama_rawat" placeholder="0" min="0" value="{{ $asesmen->asesmenMedisNeonatologiDtl->perkiraan_lama_rawat ?? '' }}">
                                                    <span class="input-group-text">Hari</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Rencana Tanggal Pulang</label>
                                                <input type="date" class="form-control" name="rencana_tanggal_pulang" value="{{ $asesmen->asesmenMedisNeonatologiDtl->rencana_tanggal_pulang ?? '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
