        ...
        <div class="col-md-9">
            ...
            <x-button-previous />
                @include('components.page-header', [
                    'title' => 'Detail Asesmen Pengkajian Awal Medis Neonatologi Bayi Sakit',
            ...
            <form method="" enctype="multipart/form-data" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex gap-3" style="width: 100%;">
                            <input type="number" class="form-control" name="no_hp"
                                value="{{ $asesmen->asesmenMedisNeonatologi->no_hp }}" disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="form-check mb-2">
                                        ...
                                        <input type="text" class="form-control mt-2"
                                            ...
                                            placeholder="Sebutkan lainnya" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="section-separator" id="">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="anamnesis" rows="3" placeholder="Anamnesis" disabled>{{ $asesmen->asesmenMedisNeonatologi->anamnesis }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="keluahan_bayi" rows="3" placeholder="Keluhan Bayi" disabled>{{ $asesmen->asesmenMedisNeonatologi->keluahan_bayi }}</textarea>
                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="usg_kali"
                                    ...
                                    value="{{ $asesmen->asesmenMedisNeonatologi->usg_kali }}" disabled>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="demam_suhu"
                                        ...
                                        value="{{ $asesmen->asesmenMedisNeonatologi->demam_suhu }}" disabled>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" name="terapi_lain" rows="3"
                                    placeholder="Sebutkan riwayat terapi lainnya jika ada..." disabled>{{ $asesmen->terapi_lain }}</textarea>
                            </div>
                        </div>
                ...
                <div class="section-separator" id="hasilPemeriksaanPenunjang">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" name="hasil_laboratorium" placeholder="Hasil Laboratorium" id="laboratorium"
                            style="height: 100px" disabled>{{ $asesmen->asesmenMedisNeonatologiDtl->hasil_laboratorium ?? '' }}</textarea>
                    ...
                    <div class="form-floating mt-3">
                        <textarea class="form-control" name="hasil_radiologi" placeholder="Hasil Radiologi" id="radiologi"
                            style="height: 100px" disabled>{{ $asesmen->asesmenMedisNeonatologiDtl->hasil_radiologi ?? '' }}</textarea>
                        <label for="radiologi">2. Radiologi</label>
                    </div>
                    <div class="form-floating mt-3">
                        <textarea class="form-control" name="hasil_lainnya" placeholder="Hasil Lainnya" id="lainnya"
                            style="height: 100px" disabled>{{ $asesmen->asesmenMedisNeonatologiDtl->hasil_lainnya ?? '' }}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" name="keterangan_masalah_pulang" rows="2"
                                        ...
                                        {{ ($asesmen->asesmenMedisNeonatologiDtl->masalah_pulang ?? '') !== 'ya' ? 'disabled' : '' }} disabled>{{ $asesmen->asesmenMedisNeonatologiDtl->keterangan_masalah_pulang ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
