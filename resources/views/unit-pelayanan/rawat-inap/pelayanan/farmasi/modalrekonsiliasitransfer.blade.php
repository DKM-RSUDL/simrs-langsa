...
<div class="modal fade" id="tambahRekonsiliasiTransfer" tabindex="-1" aria-labelledby="tambahRekonsiliasiTransferLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="rekonsiliasiTransferForm"
                    ...
                    <div class="mb-3">
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="frekuensi_transfer"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="keterangan_transfer" name="keterangan" required>
...
<div class="modal fade" id="editRekonsiliasiTransfer" tabindex="-1" aria-labelledby="editRekonsiliasiTransferLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editRekonsiliasiTransferForm">
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="edit_cariObatRekonTransfer" name="nama_obat"
                                placeholder="Ketik nama obat..." autocomplete="off" required>
                    ...
                    <div class="mb-3">
                        <div class="row g-2">
                            <div class="col-md-6">
                                <label class="form-label">Dosis</label>
                                <input type="text" class="form-control" id="edit_dosis_transfer" name="dosis" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Frekuensi</label>
                                <input type="text" class="form-control" id="edit_frekuensi_transfer" name="frekuensi" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label">Cara Pemberian</label>
                        <select class="form-select" id="edit_keterangan_transfer" name="keterangan" required>
                            <option value="Sebelum Makan">Sebelum Makan</option>
                            <option value="Sesudah Makan">Sesudah Makan</option>
                            <option value="Saat Makan">Saat Makan</option>
                        </select>
        ...
        (function($) {
            $(document).ready(function() {
                ...
                $(document).on('click', function(e) {
                    if (!$(e.target).closest('#cariObatRekonTransfer, #obatListRekonTransfer, #clearObatRekonTransfer').length) {
                        $('#obatListRekonTransfer').hide().empty();
                    }
                    if (!$(e.target).closest('#edit_cariObatRekonTransfer, #edit_obatListRekonTransfer, #edit_clearObatRekonTransfer').length) {
                        $('#edit_obatListRekonTransfer').hide().empty();
                    }
                });
                ...
                $(document).on('click', '.btn-edit-rekonsiliasi-transfer', function() {
                    ...
                    const url = "{{ route('rawat-inap.farmasi.editRekonsiliasiObatTransfer', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, ':id']) }}".replace(':id', id);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#edit_cariObatRekonTransfer').val(data.nama_obat).prop('readonly', true);
                                ...
                                $('#editRekonsiliasiTransfer input[name="tindak_lanjut"][value="' + tindakLanjut + '"]').prop('checked', true);
                ...
                $(document).on('click', '#btnUpdateObatTransfer', function() {
                    ...
                    const url = "{{ route('rawat-inap.farmasi.updateRekonsiliasiObatTransfer', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, ':id']) }}".replace(':id', id);
                ...
                $(document).on('click', '.btn-delete-rekonsiliasi-transfer', function() {
                    const id = $(this).data('id');
                    const url = "{{ route('rawat-inap.farmasi.deleteRekonsiliasiObatTransfer', [$dataMedis->kd_pasien, $dataMedis->kd_unit, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, ':id']) }}".replace(':id', id);
