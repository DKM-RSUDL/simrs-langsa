    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="rekonsiliasiTransferForm" action="{{ route('rawat-inap.farmasi.rekonsiliasiObatTransfer', [
                        $dataMedis->kd_pasien,
                        $dataMedis->kd_unit,
                        ...
                        <div class="card border-light">
                            <div class="card-body">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tindak_lanjut" id="stop_transfer"
                                        value="Stop">
                ...
                <form id="editRekonsiliasiTransferForm">
                    ...
                    <div class="mb-3">
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Frekuensi</label>
                                <input type="text" class="form-control" id="edit_frekuensi_transfer" name="frekuensi"
                                    required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="edit_perubahanpakai_transfer" name="perubahanpakai"
                            rows="3"></textarea>
                        <small class="text-muted">*Opsional - Isi hanya jika ada perubahan</small>
                    </div>
