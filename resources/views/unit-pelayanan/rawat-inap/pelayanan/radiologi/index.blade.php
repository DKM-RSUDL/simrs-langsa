                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active">
                        ...
                        @include('components.page-header', [
                            ...
                            'description' => 'Daftar data order radiologi pasien rawat inap.',
                        ])
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-end">
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#addRadiologiModal" type="button">
                                        <i class="ti-plus"></i> Tambah
                                    </button>
                                    @include('unit-pelayanan.rawat-inap.pelayanan.radiologi.modal')
                                </div>
...
@push('js')
        ...
        $(document).ready(function() {
            $('#SelectOption').change(function() {
                ...
                window.location.href =
                    "{{ route('rawat-inap.radiologi.index', ['kd_unit' => $dataMedis->kd_unit, 'kd_pasien' => $dataMedis->kd_pasien, 'tgl_masuk' => \Carbon\Carbon::parse($dataMedis->tgl_masuk)->format('Y-m-d'), 'urut_masuk' => $dataMedis->urut_masuk]) }}" +
                    queryString;
            });
        });
    ...
    <script>
        ...
        $('.btn-edit-rad').click(function(e) {
            ...
            let $modal = $(target);
            let url =
                "{{ route('rawat-inap.radiologi.get-rad-detail-ajax', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}";
        ...
        $('.btn-delete-rad').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "post",
                        url: "{{ route('rawat-inap.radiologi.delete', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk]) }}",
                        data: {
                            '_method': 'delete',
                            '_token': "{{ csrf_token() }}",
                            'kd_order': kdOrder
