                ...
                <div class="card">
                    <div class="card-body">
                        <div class="px-3">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <h4 class="header-asesmen"><span class="text-warning">Edit</span> Asesmen Pengkajian
                                        Awal Medis Pasien Anak</h4>
                                    <p class="text-muted">
                        ...
                        <div class="px-3">
                            ...
                            <div class="section-separator" id="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="anamnesis" rows="3" placeholder="Anamnesis">{{ $asesmen->asesmenMedisAnak->anamnesis ?? '' }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Keluhan Utama</label>
                                    <textarea class="form-control" name="keluhan_utama" rows="3" placeholder="Keluhan utama pasien">{{ $asesmen->asesmenMedisAnak->keluhan_utama ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="riwayat_penyakit_terdahulu" rows="4"
                                        placeholder="Riwayat penyakit terdahulu">{{ $asesmen->asesmenMedisAnak->riwayat_penyakit_terdahulu ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="riwayat_penyakit_keluarga" rows="4"
                                        placeholder="Riwayat penyakit dalam keluarga">{{ $asesmen->asesmenMedisAnak->riwayat_penyakit_keluarga ?? '' }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Keadaan umum</label>
                                    <textarea class="form-control" name="riwayat_penyakit_sekarang" rows="4" placeholder="Riwayat penyakit sekarang">{{ $asesmen->asesmenMedisAnak->riwayat_penyakit_sekarang ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="section-separator" id="riwayat-pengobatan">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        @php
                                            ...
                                            $gcsValue = '';
                                            if (isset($asesmen->asesmenMedisAnak) && $asesmen) {
                                    ...
                                    <div class="d-flex gap-3" style="width: 100%;">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <input type="number" class="form-control" name="diastole"
                                                ...
                                                value="{{ $asesmen->asesmenMedisAnak->diastole ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="tinggi_badan"
                                        ...
                                        value="{{ $asesmen->asesmenMedisAnak->tinggi_badan ?? '' }}">
                                </div>
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <textarea class="form-control form-control-sm" name="lainnya_keterangan" rows="2"
                                                                                placeholder="Sebutkan lainnya...">{{ old('lainnya_keterangan', $asesmen->asesmenMedisAnakDtl->lainnya_keterangan ?? '') }}</textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                    ...
                                    <div class="row mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm"
                                                        ...
                                                        value="{{ isset($asesmen->asesmenMedisAnakDtl->tanggal_dirawat)
                                                            ? \Carbon\Carbon::parse($asesmen->asesmenMedisAnakDtl->tanggal_dirawat)->format('Y-m-d')
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="jaundice_rds_pjb" rows="2"
                                                placeholder="Sebutkan jika ada masalah neonatus, jaundice, RDS, PJB, atau kelainan kongenital...">{{ old('jaundice_rds_pjb', $asesmen->asesmenMedisAnakDtl->jaundice_rds_pjb ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="milestone_lainnya" rows="3"
                                                placeholder="Contoh: berjalan pada umur ... bulan, berbicara kata pertama pada umur ... bulan, dll.">{{ old('milestone_lainnya', $asesmen->asesmenMedisAnakDtl->milestone_lainnya ?? '') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="hasil_laboratorium" placeholder="hasil Laboratorium" id="laboratorium"
                                        style="height: 100px">{{ old('hasil_laboratorium', $asesmen->asesmenMedisAnakDtl->hasil_laboratorium ?? '') }}</textarea>
                                ...
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_radiologi" placeholder="hasil Radiologi" id="radiologi"
                                        style="height: 100px">{{ old('hasil_radiologi', $asesmen->asesmenMedisAnakDtl->hasil_radiologi ?? '') }}</textarea>
                                    <label for="radiologi">2. Radiologi</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_lainnya" placeholder="hasil Lainnya" id="lainnya"
                                        style="height: 100px">{{ old('hasil_lainnya', $asesmen->asesmenMedisAnakDtl->hasil_lainnya ?? '') }}</textarea>
                            ...
                            <div class="section-separator" id="discharge-planning">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" class="form-control" name="rencana_tgl_pulang"
                                        value="{{ old(
                                            'rencana_tgl_pulang',
                                            isset($asesmen->asesmenMedisAnakDtl->rencana_tgl_pulang)
                                                ? \Carbon\Carbon::parse($asesmen->asesmenMedisAnakDtl->rencana_tgl_pulang)->format('Y-m-d')
                                                : '',
                                        ) }}">
                                </div>
