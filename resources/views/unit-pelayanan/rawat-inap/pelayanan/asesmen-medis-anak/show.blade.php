                        ...
                        <div class="px-3">
                            ...
                            <div class="section-separator" id="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="keluhan_utama" rows="3" placeholder="Keluhan utama pasien" disabled>{{ $asesmen->asesmenMedisAnak->keluhan_utama ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="riwayat_penyakit_terdahulu" rows="4" placeholder="Riwayat penyakit terdahulu"
                                        disabled>{{ $asesmen->asesmenMedisAnak->riwayat_penyakit_terdahulu ?? '' }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="riwayat_penyakit_sekarang" rows="4" placeholder="Riwayat penyakit sekarang"
                                        disabled>{{ $asesmen->asesmenMedisAnak->riwayat_penyakit_sekarang ?? '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="section-separator" id="riwayat-pengobatan">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="kesadaran" disabled>
                                        <option value=""
                                            {{ old('kesadaran', $asesmen->asesmenMedisAnak->kesadaran ?? '') === '' ? 'selected' : '' }}
                                            disabled>--Pilih--</option>
                                        <option value="Compos Mentis"
                                            {{ old('kesadaran', $asesmen->asesmenMedisAnak->kesadaran ?? '') === 'Compos Mentis' ? 'selected' : '' }}>
                                            Compos Mentis</option>
                                        <option value="Apatis"
                                            {{ old('kesadaran', $asesmen->asesmenMedisAnak->kesadaran ?? '') === 'Apatis' ? 'selected' : '' }}>
                                            Apatis</option>
                                        <option value="Sopor"
                                            {{ old('kesadaran', $asesmen->asesmenMedisAnak->kesadaran ?? '') === 'Sopor' ? 'selected' : '' }}>
                                            Sopor</option>
                                        <option value="Coma"
                                            {{ old('kesadaran', $asesmen->asesmenMedisAnak->kesadaran ?? '') === 'Coma' ? 'selected' : '' }}>
                                            Coma</option>
                                        <option value="Somnolen"
                                            {{ old('kesadaran', $asesmen->asesmenMedisAnak->kesadaran ?? '') === 'Somnolen' ? 'selected' : '' }}>
                                            Somnolen</option>
                                    </select>
                                </div>
                                    ...
                                    <div class="d-flex gap-3" style="width: 100%;">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <input type="number" class="form-control" name="sistole"
                                                placeholder="Sistole"
                                                value="{{ $asesmen->asesmenMedisAnak->sistole ?? '' }}" disabled>
                                        </div>
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <input type="number" class="form-control" name="diastole"
                                                ...
                                                value="{{ $asesmen->asesmenMedisAnak->diastole ?? '' }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="nadi" placeholder="Nadi"
                                        value="{{ $asesmen->asesmenMedisAnak->nadi ?? '' }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Suhu (C)</label>
                                    <input type="text" class="form-control" name="suhu" placeholder="Suhu"
                                        value="{{ $asesmen->asesmenMedisAnak->suhu ?? '' }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label style="min-width: 200px;">RR (x/menit)</label>
                                    <input type="number" class="form-control" name="rr" placeholder="rr"
                                        value="{{ $asesmen->asesmenMedisAnak->rr ?? '' }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Berat Badan Kg</label>
                                    <input type="number" class="form-control" name="berat_badan"
                                        placeholder="Berat Badan"
                                        value="{{ $asesmen->asesmenMedisAnak->berat_badan ?? '' }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label style="min-width: 200px;">Tinggi Badan Cm</label>
                                    <input type="number" class="form-control" name="tinggi_badan"
                                        placeholder="Tinggi Badan"
                                        value="{{ $asesmen->asesmenMedisAnak->tinggi_badan ?? '' }}" disabled>
                                </div>
                            ...
                            <div class="section-separator" id="pemeriksaan-fisik">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kepala_bentuk"
                                                placeholder="Isi keterangan bentuk"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kepala_uub"
                                                placeholder="Isi keterangan UUB"
                                                value="{{ old('kepala_uub', $fisik->kepala_uub ?? '') }}" disabled>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">c. Rambut:</label>
                                            <input type="text" class="form-control" name="kepala_rambut"
                                                placeholder="Isi keterangan rambut"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" name="pupil_isokor" disabled>
                                                <option value=""
                                                    {{ old('pupil_isokor', $fisik->pupil_isokor ?? '') === '' ? 'selected' : '' }}
                                                    disabled>--Pilih--</option>
                                                <option value="Isokor"
                                                    {{ old('pupil_isokor', $fisik->pupil_isokor ?? '') === 'Isokor' ? 'selected' : '' }}>
                                                    Isokor</option>
                                                <option value="Anisokor"
                                                    {{ old('pupil_isokor', $fisik->pupil_isokor ?? '') === 'Anisokor' ? 'selected' : '' }}>
                                                    Anisokor</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="mata_lain"
                                                placeholder="Isi keterangan lain-lain mata"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="nafas_cuping"
                                                        id="nafas_cuping_tidak" value="tidak"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="hidung_lain"
                                                placeholder="Isi keterangan lain-lain hidung"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="telinga_cairan"
                                                    id="telinga_cairan_ya" value="ya"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="telinga_cairan"
                                                    id="telinga_cairan_tidak" value="tidak"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Lain-lain:</label>
                                            <input type="text" class="form-control" name="telinga_lain"
                                                placeholder="Isi keterangan lain-lain telinga"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="leher_vena"
                                                        id="leher_vena_ya" value="ya"
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="leher_vena"
                                                        id="leher_vena_tidak" value="tidak"
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="leher_lain"
                                                placeholder="Isi keterangan lain-lain leher"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="thoraks_retraksi"
                                                placeholder="Isi keterangan retraksi"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="thoraks_merintih"
                                                placeholder="Isi keterangan merintih"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="thoraks_murmur"
                                                placeholder="Isi keterangan murmur"
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="thoraks_suara_tambahan"
                                                placeholder="Suara nafas tambahan"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="abdomen_distensi"
                                                placeholder="Isi keterangan distensi"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="abdomen_bising_usus"
                                                placeholder="Isi keterangan bising usus"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12 mb-3">
                                            <input type="text" class="form-control" name="anus_keterangan"
                                                placeholder="Isi keterangan anus"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="d-flex flex-wrap gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="kapiler"
                                                        id="kapiler_2" value="< 2"
                                                        {{ old('kapiler', $fisik->kapiler ?? '') === '< 2' ? 'checked' : '' }}
                                                        disabled>
                                                    <label class="form-check-label" for="kapiler_2">
                                                        < 2"</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="kapiler"
                                                        id="kapiler_lebih2" value=">2"
                                                        {{ old('kapiler', $fisik->kapiler ?? '') === '>2' ? 'checked' : '' }}
                                                        disabled>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="ekstremitas_refleks"
                                                placeholder="Isi keterangan refleks"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kulit_lainnya"
                                                placeholder="Isi keterangan lainnya untuk kulit"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kuku_lainnya"
                                                placeholder="Isi keterangan lainnya untuk kuku"
                                                            ...
                                                            <td class="p-4">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="input-group input-group-sm">
                                                                                    <input type="number"
                                                                                        ...
                                                                                        disabled>
                                                                                    <span
                                                                                        class="input-group-text">bln/mggu</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 mb-3">
                                                                        <label class="form-label mb-2">Masalah
                                                                            maternal:</label>
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="maternal" id="maternal_tidak"
                                                                                value="0"
                                                                                {{ old('maternal', $asesmen->asesmenMedisAnakDtl->maternal ?? '0') == '0' ? 'checked' : '' }}
                                                                                disabled>
                                                                            <label class="form-check-label"
                                                                                for="maternal_tidak">Tidak</label>
                                                                        </div>
                                                                        <div class="form-check mt-1">
                                                                            <input class="form-check-input" type="radio"
                                                                                name="maternal" id="maternal_ya"
                                                                                value="1"
                                                                                {{ old('maternal', $asesmen->asesmenMedisAnakDtl->maternal ?? '0') == '1' ? 'checked' : '' }}
                                                                                disabled>
                                                                            <label class="form-check-label"
                                                                                for="maternal_ya">Ya, sebutkan:</label>
                                                                        </div>
                                                                        <div class="mt-2">
                                                                            <input type="text"
                                                                                class="form-control form-control-sm"
                                                                                name="maternal_keterangan"
                                                                                placeholder="Sebutkan masalah maternal..."
                                                            ...
                                                            <td class="p-4">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input"
                                                                                ...
                                                                                disabled>
                                                                            <label class="form-check-label"
                                                                                for="penyulit_persalinan">Penyulit
                                                                                persalinan</label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-4 mb-3">
                                                                        ...
                                                                        <div class="mt-2">
                                                                            <textarea class="form-control form-control-sm" name="lainnya_keterangan" rows="2"
                                                                                placeholder="Sebutkan lainnya..." disabled>{{ old('lainnya_keterangan', $asesmen->asesmenMedisAnakDtl->lainnya_keterangan ?? '') }}</textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                        ...
                                        <div class="col-12">
                                            <div class="border p-3">
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="hep_b_ii" value="hep_b_ii"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="hep_b_iii" value="hep_b_iii"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="hep_b_iv" value="hep_b_iv"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="hep_b_v" value="hep_b_v"
                                        ...
                                        <div class="col-12">
                                            <div class="border p-3">
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="dpt_ii" value="dpt_ii"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="dpt_iii" value="dpt_iii"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="bcg" value="bcg"
                                        ...
                                        <div class="col-12">
                                            <div class="border p-3">
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="booster_ii" value="booster_ii"
                                                            {{ in_array('booster_ii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }}
                                                            disabled>
                                                        <label class="form-check-label" for="booster_ii">Booster
                                                            II</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                        ...
                                        <div class="col-12">
                                            <div class="border p-3">
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="hib_ii" value="hib_ii"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="hib_iii" value="hib_iii"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="hib_iv" value="hib_iv"
                                        ...
                                        <div class="col-12">
                                            <div class="border p-3">
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="mmr" value="mmr"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="varilrix" value="varilrix"
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="riwayat_imunisasi[]" id="typhim" value="typhim"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="lahir_umur_kehamilan"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.1" class="form-control"
                                                    name="lk_saat_lahir" placeholder="Lingkar kepala"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.1" class="form-control"
                                                    name="bb_saat_lahir" placeholder="Berat badan"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.1" class="form-control"
                                                    name="tb_saat_lahir" placeholder="Tinggi badan"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="jaundice_rds_pjb" rows="2"
                                                placeholder="Sebutkan jika ada masalah neonatus, jaundice, RDS, PJB, atau kelainan kongenital..." disabled>{{ old('jaundice_rds_pjb', $asesmen->asesmenMedisAnakDtl->jaundice_rds_pjb ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="asi_sampai_umur"
                                                    placeholder="Durasi ASI"
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="tengkurap_bulan"
                                                    placeholder="Umur"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="merangkak_bulan"
                                                    placeholder="Umur"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="duduk_bulan"
                                                    placeholder="Umur"
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="berdiri_bulan"
                                                    placeholder="Umur"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Milestone perkembangan lainnya atau keterangan
                                                tambahan:</label>
                                            <textarea class="form-control" name="milestone_lainnya" rows="3"
                                                placeholder="Contoh: berjalan pada umur ... bulan, berbicara kata pertama pada umur ... bulan, dll." disabled>{{ old('milestone_lainnya', $asesmen->asesmenMedisAnakDtl->milestone_lainnya ?? '') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="hasil_laboratorium" placeholder="hasil Laboratorium" id="laboratorium"
                                        style="height: 100px" disabled>{{ old('hasil_laboratorium', $asesmen->asesmenMedisAnakDtl->hasil_laboratorium ?? '') }}</textarea>
                                ...
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_radiologi" placeholder="hasil Radiologi" id="radiologi"
                                        style="height: 100px" disabled>{{ old('hasil_radiologi', $asesmen->asesmenMedisAnakDtl->hasil_radiologi ?? '') }}</textarea>
                                    <label for="radiologi">2. Radiologi</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_lainnya" placeholder="hasil Lainnya" id="lainnya"
                                        style="height: 100px" disabled>{{ old('hasil_lainnya', $asesmen->asesmenMedisAnakDtl->hasil_lainnya ?? '') }}</textarea>
                            ...
                            <div class="section-separator" id="discharge-planning">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="hambatan_mobilisasi" disabled>
                                        <option value="" disabled>--Pilih--</option>
                                        <option value="1"
                                            {{ old('hambatan_mobilisasi', $asesmen->asesmenMedisAnakDtl->hambatan_mobilisasi ?? '') == '1' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="0"
                                            {{ old('hambatan_mobilisasi', $asesmen->asesmenMedisAnakDtl->hambatan_mobilisasi ?? '') == '0' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="penggunaan_media_berkelanjutan" disabled>
                                        <option value="" disabled>--Pilih--</option>
                                        <option value="ya"
                                            {{ old('penggunaan_media_berkelanjutan', $asesmen->asesmenMedisAnakDtl->penggunaan_media_berkelanjutan ?? '') === 'ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="tidak"
                                            {{ old('penggunaan_media_berkelanjutan', $asesmen->asesmenMedisAnakDtl->penggunaan_media_berkelanjutan ?? '') === 'tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="ketergantungan_aktivitas" disabled>
                                        <option value="" disabled>--Pilih--</option>
                                        <option value="ya"
                                            {{ old('ketergantungan_aktivitas', $asesmen->asesmenMedisAnakDtl->ketergantungan_aktivitas ?? '') === 'ya' ? 'selected' : '' }}>
                                            Ya</option>
                                        <option value="tidak"
                                            {{ old('ketergantungan_aktivitas', $asesmen->asesmenMedisAnakDtl->ketergantungan_aktivitas ?? '') === 'tidak' ? 'selected' : '' }}>
                                            Tidak</option>
                                    </select>
                                </div>
