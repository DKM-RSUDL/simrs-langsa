                ...
                <div class="card">
                    <div class="card-body">
                        <div class="px-3">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <h4 class="header-asesmen"><span class="text-info">Detail</span> Asesmen Pengkajian Awal Medis Pasien Anak</h4>
                                    <p class="text-muted">
                        ...
                        <div class="px-3">
                            ...
                            <div class="section-separator" id="">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="anamnesis" rows="3" placeholder="Anamnesis" disabled>{{ $asesmen->anamnesis ?? '' }}</textarea>
                                </div>
                                <div class="form-group">
                            ...
                            @push('modals')
                                @include('unit-pelayanan.rawat-inap.pelayanan.asesmen-medis-anak.modal-show-obat')
                            @endpush
                            ...
                            <div class="section-separator" id="alergi">
                                ...
                                @push('modals')
                                    @include('unit-pelayanan.rawat-inap.pelayanan.asesmen-medis-anak.modal-show-alergi')
                                @endpush
                            </div>
                            ...
                            <div class="section-separator" id="riwayat-pengobatan">
                                ...
                                @push('modals')
                                    @include('unit-pelayanan.rawat-inap.pelayanan.asesmen-medis-anak.show-gcs-modal')
                                @endpush
                        ...
                        <div class="section-separator" id="pemeriksaan-fisik">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kepala_rambut" placeholder="Isi keterangan rambut"
                                            value="{{ old('kepala_rambut', $fisik->kepala_rambut ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kepala_lain" placeholder="Isi keterangan lain-lain"
                                            value="{{ old('kepala_lain', $fisik->kepala_lain ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="mata_pucat" id="mata_pucat" value="1"
                                                    {{ old('mata_pucat', $fisik->mata_pucat ?? false) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                ...
                                                {{ old('mata_ikterik', $fisik->mata_ikterik ?? false) ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" name="pupil_isokor" disabled>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nafas_cuping" id="nafas_cuping_ya" value="ya"
                                                    {{ old('nafas_cuping', $fisik->nafas_cuping ? 'ya' : 'tidak') === 'ya' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nafas_cuping" id="nafas_cuping_tidak" value="tidak"
                                                    {{ old('nafas_cuping', $fisik->nafas_cuping ? 'ya' : 'tidak') === 'tidak' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="hidung_lain" placeholder="Isi keterangan lain-lain hidung"
                                            value="{{ old('hidung_lain', $fisik->hidung_lain ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="telinga_cairan" id="telinga_cairan_ya" value="ya"
                                                {{ old('telinga_cairan', $fisik->telinga_cairan ? 'ya' : 'tidak') === 'ya' ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="telinga_cairan" id="telinga_cairan_tidak" value="tidak"
                                                {{ old('telinga_cairan', $fisik->telinga_cairan ? 'ya' : 'tidak') === 'tidak' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="telinga_lain" placeholder="Isi keterangan lain-lain telinga"
                                            value="{{ old('telinga_lain', $fisik->telinga_lain ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="mulut_sianosis" id="mulut_sianosis_ya" value="ya"
                                                    {{ old('mulut_sianosis', $fisik->mulut_sianosis ? 'ya' : 'tidak') === 'ya' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="mulut_sianosis" id="mulut_sianosis_tidak" value="tidak"
                                                    {{ old('mulut_sianosis', $fisik->mulut_sianosis ? 'ya' : 'tidak') === 'tidak' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="mulut_lidah" placeholder="Isi keterangan lidah"
                                            value="{{ old('mulut_lidah', $fisik->mulut_lidah ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="mulut_tenggorokan" placeholder="Isi keterangan tenggorokan"
                                            value="{{ old('mulut_tenggorokan', $fisik->mulut_tenggorokan ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Lain-lain:</label>
                                        <input type="text" class="form-control" name="mulut_lain" placeholder="Isi keterangan lain-lain mulut"
                                            value="{{ old('mulut_lain', $fisik->mulut_lain ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="leher_kelenjar" id="leher_kelenjar_ya" value="ya"
                                                    {{ old('leher_kelenjar', $fisik->leher_kelenjar ? 'ya' : 'tidak') === 'ya' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="leher_kelenjar" id="leher_kelenjar_tidak" value="tidak"
                                                    {{ old('leher_kelenjar', $fisik->leher_kelenjar ? 'ya' : 'tidak') === 'tidak' ? 'checked' : '' }} disabled>
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="leher_vena" id="leher_vena_ya" value="ya"
                                                    {{ old('leher_vena', $fisik->leher_vena ? 'ya' : 'tidak') === 'ya' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="leher_vena" id="leher_vena_tidak" value="tidak"
                                                    {{ old('leher_vena', $fisik->leher_vena ? 'ya' : 'tidak') === 'tidak' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="leher_lain" placeholder="Isi keterangan lain-lain leher"
                                            value="{{ old('leher_lain', $fisik->leher_lain ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="thoraks_bentuk[]" id="thoraks_simetris" value="simetris"
                                                    {{ old('thoraks_simetris', $fisik->thoraks_simetris ?? false) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="thoraks_bentuk[]" id="thoraks_asimetris" value="asimetris"
                                                    {{ old('thoraks_asimetris', $fisik->thoraks_asimetris ?? false) ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="thoraks_merintih" placeholder="Isi keterangan merintih"
                                            value="{{ old('thoraks_merintih', $fisik->thoraks_merintih ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="thoraks_bunyi_jantung" placeholder="Bunyi jantung"
                                            value="{{ old('thoraks_bunyi_jantung', $fisik->thoraks_bunyi_jantung ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">RR:</label>
                                        <input type="text" class="form-control" name="thoraks_rr" placeholder="Respiratory Rate"
                                            value="{{ old('thoraks_rr', $fisik->thoraks_rr ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="thoraks_murmur" placeholder="Isi keterangan murmur"
                                            value="{{ old('thoraks_murmur', $fisik->thoraks_murmur ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="thoraks_suara_nafas" placeholder="Suara pernafasan"
                                            value="{{ old('thoraks_suara_nafas', $fisik->thoraks_suara_nafas ?? '') }}" disabled>
                                    </div>
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="thoraks_suara_tambahan" placeholder="Suara nafas tambahan"
                                            value="{{ old('thoraks_suara_tambahan', $fisik->thoraks_suara_tambahan ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="abdomen_distensi" placeholder="Isi keterangan distensi"
                                            value="{{ old('abdomen_distensi', $fisik->abdomen_distensi ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="abdomen_bising_usus" placeholder="Isi keterangan bising usus"
                                            value="{{ old('abdomen_bising_usus', $fisik->abdomen_bising_usus ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="abdomen_venekasi" id="abdomen_venekasi_ya" value="ya"
                                                    {{ old('abdomen_venekasi', $fisik->abdomen_venekasi ? 'ya' : 'tidak') === 'ya' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="abdomen_venekasi" id="abdomen_venekasi_tidak" value="tidak"
                                                    {{ old('abdomen_venekasi', $fisik->abdomen_venekasi ? 'ya' : 'tidak') === 'tidak' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="abdomen_hepar" placeholder="Hepar"
                                            value="{{ old('abdomen_hepar', $fisik->abdomen_hepar ?? '') }}" disabled>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">Lien:</label>
                                        <input type="text" class="form-control" name="abdomen_lien" placeholder="Lien"
                                            value="{{ old('abdomen_lien', $fisik->abdomen_lien ?? '') }}" disabled>
                                    </div>
                                </div>
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="genetalia" id="genetalia_laki" value="laki-laki"
                                                    {{ old('genetalia', $fisik->genetalia ?? '') === 'laki-laki' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="genetalia" id="genetalia_perempuan" value="perempuan"
                                                    {{ old('genetalia', $fisik->genetalia ?? '') === 'perempuan' ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="genetalia" id="genetalia_ambigus" value="ambigus"
                                                    {{ old('genetalia', $fisik->genetalia ?? '') === 'ambigus' ? 'checked' : '' }} disabled>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" name="anus_keterangan" placeholder="Isi keterangan anus"
                                            value="{{ old('anus_keterangan', $fisik->anus_keterangan ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="kapiler" id="kapiler_2" value="< 2"
                                                    {{ old('kapiler', $fisik->kapiler ?? '') === '< 2' ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ekstremitas_refleks" placeholder="Isi keterangan refleks"
                                            value="{{ old('ekstremitas_refleks', $fisik->ekstremitas_refleks ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kulit[]" id="kulit_pucat" value="pucat"
                                                    {{ in_array('pucat', (array) old('kulit', $kulit)) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kulit[]" id="kulit_ptekie" value="ptekie"
                                                    {{ in_array('ptekie', (array) old('kulit', $kulit)) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kulit[]" id="kulit_ekimosis" value="ekimosis"
                                                    {{ in_array('ekimosis', (array) old('kulit', $kulit)) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kulit[]" id="kulit_ikterik" value="ikterik"
                                                    {{ in_array('ikterik', (array) old('kulit', $kulit)) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kulit[]" id="kulit_mottled" value="mottled"
                                                    {{ in_array('mottled', (array) old('kulit', $kulit)) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kulit[]" id="kulit_sklerema" value="sklerema"
                                                    {{ in_array('sklerema', (array) old('kulit', $kulit)) ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kulit_lainnya" placeholder="Isi keterangan lainnya untuk kulit"
                                            value="{{ old('kulit_lainnya', $fisik->kulit_lainnya ?? '') }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kuku[]" id="kuku_sianosis" value="sianosis"
                                                    {{ in_array('sianosis', (array) old('kuku', $kuku)) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kuku[]" id="kuku_meconium" value="meconium stain"
                                                    {{ in_array('meconium stain', (array) old('kuku', $kuku)) ? 'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="kuku[]" id="kuku_panjang" value="panjang"
                                                    {{ in_array('panjang', (array) old('kuku', $kuku)) ? 'checked' : '' }} disabled>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kuku_lainnya" placeholder="Isi keterangan lainnya untuk kuku"
                                            value="{{ old('kuku_lainnya', $fisik->kuku_lainnya ?? '') }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="input-group input-group-sm">
                                                                            ...
                                                                            value="{{ old('lama_kehamilan', $asesmen->asesmenMedisAnakDtl->lama_kehamilan ?? '') }}" disabled>
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('komplikasi', $asesmen->asesmenMedisAnakDtl->komplikasi ?? '0') == '0' ? 'checked' : '' }} disabled>
                                                                ...
                                                                <div class="form-check mt-1">
                                                                    ...
                                                                    {{ old('komplikasi', $asesmen->asesmenMedisAnakDtl->komplikasi ?? '0') == '1' ? 'checked' : '' }} disabled>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 mb-3">
                                                                ...
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('maternal', $asesmen->asesmenMedisAnakDtl->maternal ?? '0') == '0' ? 'checked' : '' }} disabled>
                                                                ...
                                                                <div class="form-check mt-1">
                                                                    ...
                                                                    {{ old('maternal', $asesmen->asesmenMedisAnakDtl->maternal ?? '0') == '1' ? 'checked' : '' }} disabled>
                                                                ...
                                                                <div class="mt-2">
                                                                    ...
                                                                    value="{{ old('maternal_keterangan', $asesmen->asesmenMedisAnakDtl->maternal_keterangan ?? '') }}" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('persalinan', $asesmen->asesmenMedisAnakDtl->persalinan ?? false) ? 'checked' : '' }} disabled>
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('penyulit_persalinan', $asesmen->asesmenMedisAnakDtl->penyulit_persalinan ?? false) ? 'checked' : '' }} disabled>
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('lainnya_sebukan', $asesmen->asesmenMedisAnakDtl->lainnya_sebukan ?? false) ? 'checked' : '' }} disabled>
                                                                    <label class="form-check-label" for="lainnya_sebukan">Lainnya sebutkan:</label>
                                                                </div>
                                                                <div class="mt-2">
                                                                    <textarea class="form-control form-control-sm" name="lainnya_keterangan" rows="2" placeholder="Sebutkan lainnya..." disabled>{{ old('lainnya_keterangan', $asesmen->asesmenMedisAnakDtl->lainnya_keterangan ?? '') }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('prematur_aterm', $asesmen->asesmenMedisAnakDtl->prematur_aterm ?? false) ? 'checked' : '' }} disabled>
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('kmk_smk_bmk', $asesmen->asesmenMedisAnakDtl->kmk_smk_bmk ?? false) ? 'checked' : '' }} disabled>
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                <div class="form-check">
                                                                    ...
                                                                    {{ old('pasca_nicu', $asesmen->asesmenMedisAnakDtl->pasca_nicu ?? false) ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="hep_b_ii" value="hep_b_ii"
                                                            {{ in_array('hep_b_ii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="hep_b_iii" value="hep_b_iii"
                                                            {{ in_array('hep_b_iii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="hep_b_iv" value="hep_b_iv"
                                                            {{ in_array('hep_b_iv', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="hep_b_v" value="hep_b_v"
                                                            {{ in_array('hep_b_v', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="dpt_ii" value="dpt_ii"
                                                            {{ in_array('dpt_ii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="dpt_iii" value="dpt_iii"
                                                            {{ in_array('dpt_iii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="bcg" value="bcg"
                                                            {{ in_array('bcg', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="booster_ii" value="booster_ii"
                                                            {{ in_array('booster_ii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="booster_iii" value="booster_iii"
                                                            {{ in_array('booster_iii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="hib_ii" value="hib_ii"
                                                            {{ in_array('hib_ii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="hib_iii" value="hib_iii"
                                                            {{ in_array('hib_iii', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="hib_iv" value="hib_iv"
                                                            {{ in_array('hib_iv', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="d-flex flex-wrap gap-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="mmr" value="mmr"
                                                            {{ in_array('mmr', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="varilrix" value="varilrix"
                                                            {{ in_array('varilrix', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="riwayat_imunisasi[]" id="typhim" value="typhim"
                                                            {{ in_array('typhim', old('riwayat_imunisasi', $riwayatImunisasi)) ? 'checked' : '' }} disabled>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="lahir_umur_kehamilan" placeholder="Masukkan umur kehamilan"
                                                    value="{{ old('lahir_umur_kehamilan', $asesmen->asesmenMedisAnakDtl->lahir_umur_kehamilan ?? '') }}" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.1" class="form-control" name="lk_saat_lahir" placeholder="Lingkar kepala"
                                                    value="{{ old('lk_saat_lahir', $asesmen->asesmenMedisAnakDtl->lk_saat_lahir ?? '') }}" disabled>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.1" class="form-control" name="bb_saat_lahir" placeholder="Berat badan"
                                                    value="{{ old('bb_saat_lahir', $asesmen->asesmenMedisAnakDtl->bb_saat_lahir ?? '') }}" disabled>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.1" class="form-control" name="tb_saat_lahir" placeholder="Tinggi badan"
                                                    value="{{ old('tb_saat_lahir', $asesmen->asesmenMedisAnakDtl->tb_saat_lahir ?? '') }}" disabled>
                                                <span class="input-group-text">cm</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="pernah_dirawat" id="pernah_dirawat_tidak" value="0"
                                                            {{ old('pernah_dirawat', $asesmen->asesmenMedisAnakDtl->pernah_dirawat ?? '0') == '0' ? 'checked' : '' }} disabled>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="pernah_dirawat" id="pernah_dirawat_ya" value="1"
                                                            {{ old('pernah_dirawat', $asesmen->asesmenMedisAnakDtl->pernah_dirawat ?? '0') == '1' ? 'checked' : '' }} disabled>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm" name="tanggal_dirawat"
                                                        value="{{ old('tanggal_dirawat', $asesmen->asesmenMedisAnakDtl->tanggal_dirawat ? $asesmen->asesmenMedisAnakDtl->tanggal_dirawat->format('Y-m-d') : '') }}" disabled>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label small">Jam:</label>
                                                    <input type="time" class="form-control form-control-sm" name="jam_dirawat"
                                                    value="{{ $asesmen->asesmenMedisAnakDtl->jam_masuk ? \Carbon\Carbon::parse($asesmen->asesmenMedisAnakDtl->jam_masuk)->format('H:i') : date('H:i') }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="jaundice_rds_pjb" rows="2" placeholder="Sebutkan jika ada masalah neonatus, jaundice, RDS, PJB, atau kelainan kongenital..." disabled>{{ old('jaundice_rds_pjb', $asesmen->asesmenMedisAnakDtl->jaundice_rds_pjb ?? '') }}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="asi_sampai_umur" placeholder="Durasi ASI"
                                                    value="{{ old('asi_sampai_umur', $asesmen->asesmenMedisAnakDtl->asi_sampai_umur ?? '') }}" disabled>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="pemberian_susu_formula" placeholder="Usia mulai susu formula"
                                                    value="{{ old('pemberian_susu_formula', $asesmen->asesmenMedisAnakDtl->pemberian_susu_formula ?? '') }}" disabled>
                                                <span class="input-group-text">mggu/bln</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="makanan_tambahan_umur" placeholder="Usia mulai MPASI"
                                                    value="{{ old('makanan_tambahan_umur', $asesmen->asesmenMedisAnakDtl->makanan_tambahan_umur ?? '') }}" disabled>
                                                <span class="input-group-text">mggu/bln</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="tengkurap_bulan" placeholder="Umur"
                                                    value="{{ old('tengkurap_bulan', $asesmen->asesmenMedisAnakDtl->tengkurap_bulan ?? '') }}" disabled>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="merangkak_bulan" placeholder="Umur"
                                                    value="{{ old('merangkak_bulan', $asesmen->asesmenMedisAnakDtl->merangkak_bulan ?? '') }}" disabled>
                                                <span class="input-group-text">bulan</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="duduk_bulan" placeholder="Umur"
                                                    value="{{ old('duduk_bulan', $asesmen->asesmenMedisAnakDtl->duduk_bulan ?? '') }}" disabled>
                                                <span class="input-group-text">bulan</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" name="berdiri_bulan" placeholder="Umur"
                                                    value="{{ old('berdiri_bulan', $asesmen->asesmenMedisAnakDtl->berdiri_bulan ?? '') }}" disabled>
                                                <span class="input-group-text">bulan</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <textarea class="form-control" name="milestone_lainnya" rows="3" placeholder="Contoh: berjalan pada umur ... bulan, berbicara kata pertama pada umur ... bulan, dll." disabled>{{ old('milestone_lainnya', $asesmen->asesmenMedisAnakDtl->milestone_lainnya ?? '') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="section-separator">
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" name="hasil_laboratorium" placeholder="hasil Laboratorium" id="laboratorium" style="height: 100px" disabled>{{ old('hasil_laboratorium', $asesmen->asesmenMedisAnakDtl->hasil_laboratorium ?? '') }}</textarea>
                                    <label for="laboratorium">1. Laboratorium</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_radiologi" placeholder="hasil Radiologi" id="radiologi" style="height: 100px" disabled>{{ old('hasil_radiologi', $asesmen->asesmenMedisAnakDtl->hasil_radiologi ?? '') }}</textarea>
                                    <label for="radiologi">2. Radiologi</label>
                                </div>
                                <div class="form-floating mt-3">
                                    <textarea class="form-control" name="hasil_lainnya" placeholder="hasil Lainnya" id="lainnya" style="height: 100px" disabled>{{ old('hasil_lainnya', $asesmen->asesmenMedisAnakDtl->hasil_lainnya ?? '') }}</textarea>
                            ...
                            <div class="section-separator" id="diagnosis">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="rencana_pengobatan" rows="4"
                                        placeholder="Rencana Penatalaksanaan Dan Pengobatan" disabled>{{ old('rencana_pengobatan', $asesmen->asesmenMedisAnakDtl->rencana_pengobatan ?? '') }}</textarea>
                                </div>
                            ...
                            <div class="section-separator" id="discharge-planning">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="diagnosis_medis" placeholder="Diagnosis"
                                        value="{{ old('diagnosis_medis', $asesmen->asesmenMedisAnakDtl->diagnosis_medis ?? '') }}" disabled>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Usia lanjut (>60 th)</label>
                                    <select class="form-select" name="usia_lanjut" disabled>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="hambatan_mobilisasi" disabled>
                                        <option value="" disabled>--Pilih--</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" name="penggunaan_media_berkelanjutan" disabled>
                                        <option value="" disabled>--Pilih--</option>
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Keteraturan dalam mengonsumsi obat dalam aktivitas
                                        harian</label>
                                    <select class="form-select" name="ketergantungan_aktivitas" disabled>
                                        <option value="" disabled>--Pilih--</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="rencana_pulang_khusus"
                                        ...
                                        value="{{ old('rencana_pulang_khusus', $asesmen->asesmenMedisAnakDtl->rencana_pulang_khusus ?? '') }}" disabled>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="rencana_lama_perawatan"
                                        ...
                                        value="{{ old('rencana_lama_perawatan', $asesmen->asesmenMedisAnakDtl->rencana_lama_perawatan ?? '') }}" disabled>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label">Rencana Tanggal Pulang</label>
                                    <input type="date" class="form-control" name="rencana_tgl_pulang"
                                        value="{{ old('rencana_tgl_pulang', $asesmen->asesmenMedisAnakDtl->rencana_tgl_pulang ? $asesmen->asesmenMedisAnakDtl->rencana_tgl_pulang->format('Y-m-d') : '') }}" disabled>
                                </div>
