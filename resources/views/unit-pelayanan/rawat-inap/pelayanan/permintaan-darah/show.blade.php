                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="card w-100 h-100 shadow-sm">
                                <div class="card-body">
                                    <div class="px-3">
                                        <h4 class="header-asesmen text-center font-weight-bold mb-4">PERMINTAAN DARAH/PRODUK
                                            DARAH
                                        </h4>
                                        <p>Isikan data permintaan darah pasien dan keluarga terintegrasi</p>
                                    </div>
                                    ...
                                    <div class="section-separator mb-3">
                                        ...
                                        <div class="card-body">
                                            <ol class="pl-3 mb-0">
                                                ...
                                                <li>Setiap permintaan Darah harus disertai sampel Pasien dalam tabung EDTA 3
                                                    ml</li>
                                        ...
                                        <div class="card-body">
                                            <p class="mb-0">Pastikan Identitas Pasien dan Cocokkan etiket pada Kantong
                                                Darah, Label
                                                dan Formulir, Segera kembalikan bila tidak Cocok Ke Bank Darah Rumah Sakit
                                                (BDRS)
                                    ...
                                    <div class="section-separator mb-3">
                                        <div class="card-header bg-white">
                                            <p class="font-weight-bold mb-0">Harap Diisi LENGKAP oleh Pihak Rumah Sakit:
                                                Untuk
                                            ...
                                            <div class="form-row ml-auto justify-content-end">
                                                <div class="form-check form-check-inline mr-4">
                                                    <input class="form-check-input" type="radio" name="TIPE"
                                                        id="urgensi_biasa" value="0"
                                                        {{ $permintaanDarah->TIPE == 0 ? 'checked' : '' }} disabled
                                                        required>
                                                    <label class="form-check-label" for="urgensi_biasa">Biasa</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="TIPE"
                                                        id="urgensi_cito" value="1"
                                                        {{ $permintaanDarah->TIPE == 1 ? 'checked' : '' }} disabled
                                                        required>
                                    ...
                                    <div class="section-separator mb-3">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" name="KODE_GOLDA" id="golda" disabled
                                                    required>
                                                    <option value="">-- Pilih --</option>
                                                    @foreach ($gologanDarah as $darah)
                                                        <option value="{{ $darah->kode }}"
                                                            {{ $permintaanDarah->kode_golda == $darah->kode ? 'selected' : '' }}>
                                                            {{ $darah->jenis }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label for="kd_dokter" style="min-width: 200px;">Dokter yang
                                                    meminta</label>
                                                <select name="KD_DOKTER" id="kd_dokter" class="form-select" disabled
                                                    required>
                                                    <option value="">--Pilih--</option>
                                        ...
                                        <div class="section-separator mb-3">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label style="min-width: 300px;">Khusus Pasien wanita: Pernah
                                                        hamil?</label>
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="PERNAH_HAMIL" id="radioDefault1Hamil" value="1"
                                                    ...
                                                    <div class="form-check mx-2 mt-2">
                                                        <input class="form-check-input" type="radio"
                                                            name="PERNAH_HAMIL" id="radioDefault2Hamil" value="0"
                                                            {{ !is_numeric($permintaanDarah->pernah_hamil) || $permintaanDarah->pernah_hamil == 0 ? 'checked' : '' }}
                                                            disabled>
                                                ...
                                                <div class="form-group">
                                                    <label style="min-width: 300px;">Pernah Abortus atau Bayi kuning karena
                                                        hemolisis (HDN)?</label>
                                                    <div class="form-check mt-2">
                                        ...
                                        <div class="section-separator mb-3">
                                            <div class="card-body">
                                                ...
                                                <h5 class="font-weight-bold mt-4 mb-3">DARAH MERAHPEKAT (PACKED RED CELL)
                                                </h5>
                                                <div class="input-group mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <label style="min-width: 200px;">PRC Pediatric <br>
                                                        Leukodepleted**</label>
                                        ...
                                        <div class="section-separator mb-3">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    @php
                                                        $waktuPengambilanSampel = \Carbon\Carbon::parse(
                                                            $permintaanDarah->tgl_pengambilan_sampel,
                                                        );
                                                        $tanggal = $waktuPengambilanSampel->format('Y-m-d');
                                                        $jam = $waktuPengambilanSampel->format('H:i');
                                                    @endphp
                                                    <input type="date" class="form-control"
                                                        name="TGL_PENGAMBILAN_SAMPEL" value="{{ $tanggal }}"
                                                        disabled>

                                                    <label class="mx-2">Jam</label>
                                                    <input type="time" class="form-control"
                                                        name="WAKTU_PENGAMBILAN_SAMPEL" value="{{ $jam }}"
                                                        disabled>
                                                </div>
                                        ...
                                        <div class="mb-3 section-separator">
                                            <div class="alert alert-secondary mt-3">
                                                ...
                                                <ol class="pl-3 mb-0">
                                                    <li>Darah dari Donor tidak diperjualbelikan namun memerlukan biaya
                                                        pengolahan
                                                        yang disebut Service Cost atau BPPD (Biaya Pengganti Pengolahan
                                                        Darah)</li>
                                                    <li>Biaya Pengganti Pengolahan Darah (BPPD) berlaku bagi setiap pemakai
                                                        Darah
                                                        tanpa terkecuali</li>
                                                    <li>Pembayaran Biaya Pengganti Pengolahan Darah (BPPD) dilakukan di
                                                        Rumah Sakit
