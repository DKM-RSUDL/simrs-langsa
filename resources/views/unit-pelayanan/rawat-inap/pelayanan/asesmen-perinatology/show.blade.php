        ...
        <div class="col-md-9">
            <x-content-card>
                ...
                @include('components.page-header', [
                    'title' => 'Detail Asesmen Awal Keperawatan Perinatology',
                ...
                <form method="POST" action="">
                    ...
                    <div class="px-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex gap-3" style="width: 100%;">
                                    ...
                                    <input type="time" class="form-control" name="jam_masuk" id="jam_masuk"
                                        value="{{ Carbon\Carbon::parse($asesmen->waktu_asesmen)->format('H:i') }}" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="identitas-bayi">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_bayi" placeholder="Masukkan nama bayi"
                                    value="{{ $asesmen->rmeAsesmenPerinatology->nama_bayi ?? '' }}" disabled>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="jenis_kelamin" disabled>
                                    ...
                                    <option value="0"
                                        {{ ($asesmen->rmeAsesmenPerinatology->jenis_kelamin ?? '') == '0' ? 'selected' : '' }}>
                                        Laki-laki</option>
                                    <option value="1"
                                        {{ ($asesmen->rmeAsesmenPerinatology->jenis_kelamin ?? '') == '1' ? 'selected' : '' }}>
                                        Perempuan</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control" name="nama_ibu"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control" name="nik_ibu"
                            ...
                            <div class="form-group">
                                ...
                                <select disabled class="form-select" name="agama_orang_tua">
                                    <option selected disabled>--Pilih--</option>
                                    <option value="Islam"
                                        {{ ($asesmen->rmeAsesmenPerinatology->agama_orang_tua ?? '') == 'Islam' ? 'selected' : '' }}>
                                        Islam</option>
                                    <option value="Kristen"
                                        {{ ($asesmen->rmeAsesmenPerinatology->agama_orang_tua ?? '') == 'Kristen' ? 'selected' : '' }}>
                                        Kristen</option>
                                    <option value="Katolik"
                                        {{ ($asesmen->rmeAsesmenPerinatology->agama_orang_tua ?? '') == 'Katolik' ? 'selected' : '' }}>
                                        Katolik</option>
                                    <option value="Hindu"
                                        {{ ($asesmen->rmeAsesmenPerinatology->agama_orang_tua ?? '') == 'Hindu' ? 'selected' : '' }}>
                                        Hindu</option>
                                    <option value="Budha"
                                        {{ ($asesmen->rmeAsesmenPerinatology->agama_orang_tua ?? '') == 'Budha' ? 'selected' : '' }}>
                                        Budha</option>
                                </select>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($asesmen->rmeAsesmenPerinatology->sidik_jari_bayi_kiri ?? '')
                                            <div class="d-flex align-items-center mb-2">
                                                <i class="bi bi-check-circle-fill text-success me-2"></i>
                                                <small class="text-success">File sudah diunggah sebelumnya</small>
                                                <a href="{{ asset('storage/' . $asesmen->rmeAsesmenPerinatology->sidik_jari_bayi_kiri) }}"
                                                    class="btn btn-sm btn-info ms-2" target="_blank">
                                                    <i class="bi bi-eye"></i> Lihat
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($asesmen->rmeAsesmenPerinatology->sidik_jari_bayi_kanan ?? '')
                                            <div class="d-flex align-items-center mb-2">
                                                <i class="bi bi-check-circle-fill text-success me-2"></i>
                                                <small class="text-success">File sudah diunggah sebelumnya</small>
                                                <a href="{{ asset('storage/' . $asesmen->rmeAsesmenPerinatology->sidik_jari_bayi_kanan) }}"
                                                    class="btn btn-sm btn-info ms-2" target="_blank">
                                                    <i class="bi bi-eye"></i> Lihat
                                                </a>
                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea disabled class="form-control" name="alamat" rows="4" placeholder="Masukkan alamat">{{ $asesmen->rmeAsesmenPerinatology->alamat ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="section-separator" id="anamnesis">
                            ...
                            <div class="form-group">
                                ...
                                <textarea disabled class="form-control" name="anamnesis" rows="4"
                        ...
                        <div class="section-separator" id="pemeriksaan-fisik">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex gap-3" style="width: 100%;">
                                    <div class="flex-grow-1">
                                        <input disabled type="text" class="form-control" name="frekuensi_nadi"
                                            value="{{ $asesmen->rmeAsesmenPerinatologyFisik->frekuensi_nadi }}"
                                            placeholder="frekuensi nadi per menit">
                                    </div>
                                    <div class="flex-grow-1">
                                        <select disabled class="form-select" name="status_frekuensi">
                                            <option value="" selected disabled>--Pilih--</option>
                                            <option value="kuat"
                                                {{ optional($asesmen->rmeAsesmenPerinatologyFisik)->status_frekuensi == 'kuat' ? 'selected' : '' }}>
                                                kuat</option>
                                            <option value="lemah"
                                                {{ optional($asesmen->rmeAsesmenPerinatologyFisik)->status_frekuensi == 'lemah' ? 'selected' : '' }}>
                                                lemah</option>
                                            <option value="teratur"
                                                {{ optional($asesmen->rmeAsesmenPerinatologyFisik)->status_frekuensi == 'teratur' ? 'selected' : '' }}>
                                                teratur</option>
                                            <option value="tidak teratur"
                                                {{ optional($asesmen->rmeAsesmenPerinatologyFisik)->status_frekuensi == 'tidak teratur' ? 'selected' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="number" class="form-control" name="nafas"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="number" class="form-control" name="suhu"
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex gap-3" style="width: 100%;">
                                    <div class="flex-grow-1">
                                        ...
                                        <input disabled type="number" class="form-control" name="spo2_tanpa_bantuan"
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <input disabled type="number" class="form-control" name="spo2_dengan_bantuan"
                            ...
                            <div class="form-group">
                                ...
                                <select disabled class="form-select" name="kesadaran">
                            ...
                            <div class="form-group">
                                ...
                                <select disabled class="form-select" name="avpu">
                                    <option disabled>--Pilih--</option>
                                    <option value="0"
                            ...
                            <div class="mt-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="warna_kulit">
                                        <option value="" selected>--Pilih--</option>
                                        <option value="Pink"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->warna_kulit == 'Pink' ? 'selected' : '' }}>
                                            Pink</option>
                                        <option value="Kuning"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->warna_kulit == 'Kuning' ? 'selected' : '' }}>
                                            Kuning</option>
                                        <option value="Pucat"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->warna_kulit == 'Pucat' ? 'selected' : '' }}>
                                            Pucat</option>
                                        <option value="Kuning dan Merah"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->warna_kulit == 'Kuning dan Merah' ? 'selected' : '' }}>
                                            Kuning dan Merah</option>
                                        <option value="Kuning dan Hijau"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->warna_kulit == 'Kuning dan Hijau' ? 'selected' : '' }}>
                                            Kuning dan Hijau</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Sianosis</label>
                                    <select disabled class="form-select" name="sianosis">
                                        <option value="" selected>--Pilih--</option>
                                        <option value="Kuku"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sianosis == 'Kuku' ? 'selected' : '' }}>
                                            Kuku</option>
                                        <option value="Sekitar Mulut"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sianosis == 'Sekitar Mulut' ? 'selected' : '' }}>
                                            Sekitar Mulut</option>
                                        <option value="Sekitar Mata"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sianosis == 'Sekitar Mata' ? 'selected' : '' }}>
                                            Sekitar Mata</option>
                                        <option value="Ekstremitas Atas"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sianosis == 'Ekstremitas Atas' ? 'selected' : '' }}>
                                            Ekstremitas Atas</option>
                                        <option value="Ekstremitas Bawah"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sianosis == 'Ekstremitas Bawah' ? 'selected' : '' }}>
                                            Ekstremitas Bawah</option>
                                        <option value="Seluruh Tubuh"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sianosis == 'Seluruh Tubuh' ? 'selected' : '' }}>
                                            Seluruh Tubuh</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Kemerahan/Rash</label>
                                    <select disabled class="form-select" name="kemerahan">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Tidak Ada"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->kemerahan == 'Tidak Ada' ? 'selected' : '' }}>
                                            Tidak Ada</option>
                                        <option value="Ada"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->kemerahan == 'Ada' ? 'selected' : '' }}>
                                            Ada</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="turgor_kulit">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Elastis"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->turgor_kulit == 'Elastis' ? 'selected' : '' }}>
                                            Elastis</option>
                                        <option value="Tidak Elastis"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->turgor_kulit == 'Tidak Elastis' ? 'selected' : '' }}>
                                            Tidak Elastis</option>
                                        <option value="Edema"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->turgor_kulit == 'Edema' ? 'selected' : '' }}>
                                            Edema</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" name="tanda_lahir"
                                        placeholder="sebutkan"
                                        value="{{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->tanda_lahir ?? '' }}">
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Fontanel Anterior</label>
                                    <select disabled class="form-select" name="fontanel_anterior">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Lunak"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->fontanel_anterior == 'Lunak' ? 'selected' : '' }}>
                                            Lunak</option>
                                        <option value="Tegas"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->fontanel_anterior == 'Tegas' ? 'selected' : '' }}>
                                            Tegas</option>
                                        <option value="Datar"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->fontanel_anterior == 'Datar' ? 'selected' : '' }}>
                                            Datar</option>
                                        <option value="Menonjol"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->fontanel_anterior == 'Menonjol' ? 'selected' : '' }}>
                                            Menonjol</option>
                                        <option value="Cekung"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->fontanel_anterior == 'Cekung' ? 'selected' : '' }}>
                                            Cekung</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="sutura_sagitalis">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Tepat"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sutura_sagitalis == 'Tepat' ? 'selected' : '' }}>
                                            Tepat</option>
                                        <option value="Terpisah"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sutura_sagitalis == 'Terpisah' ? 'selected' : '' }}>
                                            Terpisah</option>
                                        <option value="Menjauh"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sutura_sagitalis == 'Menjauh' ? 'selected' : '' }}>
                                            Menjauh</option>
                                        <option value="Tumpang Tindih"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->sutura_sagitalis == 'Tumpang Tindih' ? 'selected' : '' }}>
                                            Tumpang Tindih</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Gambaran Wajah</label>
                                    <select disabled class="form-select" name="gambaran_wajah">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Simetris"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->gambaran_wajah == 'Simetris' ? 'selected' : '' }}>
                                            Simetris</option>
                                        <option value="Asimetris"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->gambaran_wajah == 'Asimetris' ? 'selected' : '' }}>
                                            Asimetris</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="cephalhemeton">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Ada"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->cephalhemeton == 'Ada' ? 'selected' : '' }}>
                                            Ada</option>
                                        <option value="Tidak Ada"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->cephalhemeton == 'Tidak Ada' ? 'selected' : '' }}>
                                            Tidak Ada</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="caput_succedaneun">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Ada"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->caput_succedaneun == 'Ada' ? 'selected' : '' }}>
                                            Ada</option>
                                        <option value="Tidak Ada"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->caput_succedaneun == 'Tidak Ada' ? 'selected' : '' }}>
                                            Tidak Ada</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="mulut">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->mulut == 'Normal' ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="Bibir Sumbing"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->mulut == 'Bibir Sumbing' ? 'selected' : '' }}>
                                            Bibir Sumbing</option>
                                        <option value="Sumbing Platum"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->mulut == 'Sumbing Platum' ? 'selected' : '' }}>
                                            Sumbing Platum</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Mucosa Mulut</label>
                                    <select disabled class="form-select" name="mucosa_mulut">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Lembab"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->mucosa_mulut == 'Lembab' ? 'selected' : '' }}>
                                            Lembab</option>
                                        <option value="Kering"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->mucosa_mulut == 'Kering' ? 'selected' : '' }}>
                                            Kering</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="dada_paru">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Simetris"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->dada_paru == 'Simetris' ? 'selected' : '' }}>
                                            Simetris</option>
                                        <option value="Asimetris"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->dada_paru == 'Asimetris' ? 'selected' : '' }}>
                                            Asimetris</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="suara_nafas">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Kanan Kiri Sama"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->suara_nafas == 'Kanan Kiri Sama' ? 'selected' : '' }}>
                                            Kanan Kiri Sama</option>
                                        <option value="Tidak Sama"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->suara_nafas == 'Tidak Sama' ? 'selected' : '' }}>
                                            Tidak Sama</option>
                                        <option value="Bersih"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->suara_nafas == 'Bersih' ? 'selected' : '' }}>
                                            Bersih</option>
                                        <option value="Wheezing"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->suara_nafas == 'Wheezing' ? 'selected' : '' }}>
                                            Wheezing</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="respirasi">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Spontan tanpa alat bantu"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->respirasi == 'Spontan tanpa alat bantu' ? 'selected' : '' }}>
                                            Spontan tanpa alat bantu
                                        </option>
                                        <option value="Spontan dengan alat bantu"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->respirasi == 'Spontan dengan alat bantu' ? 'selected' : '' }}>
                                            Spontan dengan alat bantu
                                        </option>
                                        <option value="Tidak Spontan"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->respirasi == 'Tidak Spontan' ? 'selected' : '' }}>
                                            Tidak Spontan</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <input disabled type="text" class="form-control" name="down_score"
                                            value="{{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->down_score }}"
                                            id="down_score" readonly>
                                        <button type="button" class="btn btn-primary ms-2" id="btnDownScore"
                                            data-bs-toggle="modal" data-bs-target="#downScoreModal">Skor</button>
                                    </div>
                                </div>
                                <!-- CHECK -->
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="bunyi_jantung">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->bunyi_jantung == 'Normal' ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="Gallop"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->bunyi_jantung == 'Gallop' ? 'selected' : '' }}>
                                            Gallop</option>
                                        <option value="Friction"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->bunyi_jantung == 'Friction' ? 'selected' : '' }}>
                                            Friction</option>
                                        <option value="Rub"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->bunyi_jantung == 'Rub' ? 'selected' : '' }}>
                                            Rub</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="number" class="form-control" name="waktu_pengisian_kapiler"
                                        placeholder="detik"
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="keadaan_perut">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Lunak"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->keadaan_perut == 'Lunak' ? 'selected' : '' }}>
                                            Lunak</option>
                                        <option value="Datar"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->keadaan_perut == 'Datar' ? 'selected' : '' }}>
                                            Datar</option>
                                        <option value="Distensi"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->keadaan_perut == 'Distensi' ? 'selected' : '' }}>
                                            Distensi</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="umbilikus">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Basah"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->umbilikus == 'Basah' ? 'selected' : '' }}>
                                            Basah</option>
                                        <option value="Kering"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->umbilikus == 'Kering' ? 'selected' : '' }}>
                                            Kering</option>
                                        <option value="Bau"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->umbilikus == 'Bau' ? 'selected' : '' }}>
                                            Bau</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="warna_umbilikus">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Putih"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->warna_umbilikus == 'Putih' ? 'selected' : '' }}>
                                            Putih</option>
                                        <option value="Kuning"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->warna_umbilikus == 'Kuning' ? 'selected' : '' }}>
                                            Kuning</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="genitalis">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Perempuan, Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->genitalis == 'Perempuan, Normal' ? 'selected' : '' }}>
                                            Perempuan, Normal</option>
                                        <option value="Laki-Laki, Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->genitalis == 'Laki-Laki, Normal' ? 'selected' : '' }}>
                                            Laki-Laki, Normal</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Gerakan</label>
                                    <select disabled class="form-select" name="gerakan">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->gerakan == 'Normal' ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="Terbatas"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->gerakan == 'Terbatas' ? 'selected' : '' }}>
                                            Terbatas</option>
                                        <option value="Tidak Terkaji"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->gerakan == 'Tidak Terkaji' ? 'selected' : '' }}>
                                            Tidak Terkaji</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label style="min-width: 200px;">Ekstremitas Atas</label>
                                    <select disabled class="form-select" name="ekstremitas_atas">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->ekstremitas_atas == 'Normal' ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="Tidak Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->ekstremitas_atas == 'Tidak Normal' ? 'selected' : '' }}>
                                            Tidak Normal</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="ekstremitas_bawah">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->ekstremitas_bawah == 'Normal' ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="Tidak Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->ekstremitas_bawah == 'Tidak Normal' ? 'selected' : '' }}>
                                            Tidak Normal</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="tulang_belakang">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->tulang_belakang == 'Normal' ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="Tidak Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->tulang_belakang == 'Tidak Normal' ? 'selected' : '' }}>
                                            Tidak Normal</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="refleks">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->refleks == 'Normal' ? 'selected' : '' }}>
                                            Normal</option>
                                        <option value="Tidak Normal"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->refleks == 'Tidak Normal' ? 'selected' : '' }}>
                                            Tidak Normal</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="genggaman">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Kuat"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->genggaman == 'Kuat' ? 'selected' : '' }}>
                                            Kuat</option>
                                        <option value="Lemah"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->genggaman == 'Lemah' ? 'selected' : '' }}>
                                            Lemah</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="menghisap">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Kuat"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->menghisap == 'Kuat' ? 'selected' : '' }}>
                                            Kuat</option>
                                        <option value="Lemah"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->menghisap == 'Lemah' ? 'selected' : '' }}>
                                            Lemah</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="aktivitas">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Aktif"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->aktivitas == 'Aktif' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="Tenang"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->aktivitas == 'Tenang' ? 'selected' : '' }}>
                                            Tenang</option>
                                        <option value="Letargi"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->aktivitas == 'Letargi' ? 'selected' : '' }}>
                                            Letargi</option>
                                        <option value="Kejang"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->aktivitas == 'Kejang' ? 'selected' : '' }}>
                                            Kejang</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled class="form-select" name="menangis">
                                        <option value="" selected disabled>--Pilih--</option>
                                        <option value="Keras"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->menangis == 'Keras' ? 'selected' : '' }}>
                                            Keras</option>
                                        <option value="Lemah"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->menangis == 'Lemah' ? 'selected' : '' }}>
                                            Lemah</option>
                                        <option value="Melengking"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->menangis == 'Melengking' ? 'selected' : '' }}>
                                            Melengking</option>
                                        <option value="Sulit Menangis"
                                            {{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->menangis == 'Sulit Menangis' ? 'selected' : '' }}>
                                            Sulit Menangis</option>
                                    </select>
                                </div>
                        ...
                        <div class="section-separator" id="riwayat-kesehatan">
                            ...
                            <div class="form-group">
                                ...
                                <select disabled class="form-select" name="pemeriksaan_kehamilan">
                                    <option value="" selected disabled>--Pilih--</option>
                                    <option value="teratur"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->pemeriksaan_kehamilan == 'teratur' ? 'selected' : '' }}>
                                        Teratur</option>
                                    <option value="tidak_teratur"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->pemeriksaan_kehamilan == 'tidak_teratur' ? 'selected' : '' }}>
                                        Tidak Teratur</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select disabled class="form-select" name="tempat_pemeriksaan">
                                    <option value="" selected disabled>--Pilih--</option>
                                    <option value="puskesmas"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->tempat_pemeriksaan == 'puskesmas' ? 'selected' : '' }}>
                                        Puskesmas</option>
                                    <option value="rumah_sakit"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->tempat_pemeriksaan == 'rumah_sakit' ? 'selected' : '' }}>
                                        Rumah Sakit</option>
                                    <option value="klinik"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->tempat_pemeriksaan == 'klinik' ? 'selected' : '' }}>
                                        Klinik</option>
                                    <option value="dokter_praktek"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->tempat_pemeriksaan == 'dokter_praktek' ? 'selected' : '' }}>
                                        Dokter Praktek</option>
                                    <option value="bidan"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->tempat_pemeriksaan == 'bidan' ? 'selected' : '' }}>
                                        Bidan</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control" name="usia_kehamilan"
                                    placeholder="Masukkan usia kehamilan"
                                    value="{{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->usia_kehamilan }}">
                            </div>

                            <div class="form-group">
                                <label style="min-width: 200px;">Cara Persalinan</label>
                                <select disabled class="form-select" name="cara_persalinan">
                                    <option value="" selected disabled>--Pilih--</option>
                                    <option value="normal"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->cara_persalinan == 'normal' ? 'selected' : '' }}>
                                        Normal</option>
                                    <option value="sectio_caesaria"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->cara_persalinan == 'sectio_caesaria' ? 'selected' : '' }}>
                                        Sectio Caesaria</option>
                                    <option value="vakum"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->cara_persalinan == 'vakum' ? 'selected' : '' }}>
                                        Vakum</option>
                                    <option value="forcep"
                                        {{ $asesmen->rmeAsesmenPerinatologyRiwayatIbu->cara_persalinan == 'forcep' ? 'selected' : '' }}>
                                        Forcep</option>
                                </select>
                            </div>
                        ...
                        <div class="section-separator" id="status-nyeri">
                            ...
                            <div class="form-group">
                                ...
                                <select disabled class="form-select" name="jenis_skala_nyeri" id="jenis_skala_nyeri">
                                    <option disabled>--Pilih--</option>
                                    <option value="NRS"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control" id="nilai_skala_nyeri"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="hidden" class="form-control" id="kesimpulan_nyeri"
                            ...
                            <div class="mt-4">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <input disabled type="text" class="form-control" name="lokasi_nyeri"
                                            value="{{ $asesmen->rmeAsesmenPerinatologyStatusNyeri->lokasi }}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Durasi</label>
                                        <input disabled type="text" class="form-control" name="durasi_nyeri"
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <select disabled class="form-select" name="jenis_nyeri">
                                            <option disabled>--Pilih--</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select disabled class="form-select" name="frekuensi_nyeri">
                                            <option disabled>--Pilih--</option>
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <select disabled class="form-select" name="nyeri_menjalar">
                                            <option disabled>--Pilih--</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select disabled class="form-select" name="kualitas_nyeri">
                                            <option disabled>--Pilih--</option>
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <select disabled class="form-select" name="faktor_pemberat">
                                            <option disabled>--Pilih--</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select disabled class="form-select" name="faktor_peringan">
                                            <option disabled>--Pilih--</option>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <select disabled class="form-select" name="efek_nyeri">
                                            <option disabled>--Pilih--</option>
                        ...
                        <div class="section-separator" id="risiko_jatuh">
                            ...
                            <div class="mb-4">
                                <label class="form-label">Pilih jenis penilaian risiko jatuh sesuai dengan kondisi
                                    pasien:</label>
                                <select disabled class="form-select" id="risikoJatuhSkala" name="resiko_jatuh_jenis"
                            ...
                            <div id="skala_umumForm" class="risk-form" style="display: none;">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Apakah pasien berusia < dari 2 tahun?</label>
                                            <select disabled class="form-select" name="risiko_jatuh_umum_usia"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" onchange="updateConclusion('umum')"
                                ...
                                <div
                                    ...
                                    <input disabled type="hidden" name="risiko_jatuh_umum_kesimpulan"
                            ...
                            <div id="skala_morseForm" class="risk-form" style="display: none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_morse_riwayat_jatuh"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_morse_diagnosis_sekunder"
                                        onchange="updateConclusion('morse')">
                                        <option value="">pilih</option>
                                        <option value="15"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_morse_bantuan_ambulasi"
                                        onchange="updateConclusion('morse')">
                                        <option value="">pilih</option>
                                        <option value="30"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_morse_terpasang_infus"
                                        onchange="updateConclusion('morse')">
                                        <option value="">pilih</option>
                                        <option value="20"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_morse_cara_berjalan"
                                        onchange="updateConclusion('morse')">
                                        <option value="">pilih</option>
                                        <option value="0"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_morse_status_mental"
                                        onchange="updateConclusion('morse')">
                                        <option value="">pilih</option>
                                        <option value="0"
                                ...
                                <div
                                    ...
                                    <input disabled type="hidden" name="risiko_jatuh_morse_kesimpulan"
                            ...
                            <div id="skala_humptyForm" class="risk-form" style="display: none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_pediatrik_usia_anak"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_pediatrik_jenis_kelamin"
                                        onchange="updateConclusion('humpty')">
                                        <option value="">pilih</option>
                                        <option value="2"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_pediatrik_diagnosis"
                                        onchange="updateConclusion('humpty')">
                                        <option value="">pilih</option>
                                        <option value="4"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_pediatrik_gangguan_kognitif"
                                        onchange="updateConclusion('humpty')">
                                        <option value="">pilih</option>
                                        <option value="3"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_pediatrik_faktor_lingkungan"
                                        onchange="updateConclusion('humpty')">
                                        <option value="">pilih</option>
                                        <option value="4"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_pediatrik_pembedahan"
                                        onchange="updateConclusion('humpty')">
                                        <option value="">pilih</option>
                                        <option value="3"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_pediatrik_penggunaan_mentosa"
                                        onchange="updateConclusion('humpty')">
                                        <option value="">pilih</option>
                                        <option value="3"
                                ...
                                <div
                                    ...
                                    <input disabled type="hidden" name="risiko_jatuh_pediatrik_kesimpulan"
                            ...
                            <div id="skala_ontarioForm" class="risk-form" style="display: none;">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Apakah pasien datang kerumah sakit karena
                                        jatuh?</label>
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_jatuh_saat_masuk_rs"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_riwayat_jatuh_2_bulan"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="6"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_status_bingung"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="14"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_status_disorientasi"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="14"
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Apakah pasien mengalami agitasi? (keresahan, gelisah,
                                        dan cemas)</label>
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_status_agitasi"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="14"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_kacamata"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="1"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_kelainan_penglihatan"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="1"
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Apakah pasien mempunyai glukoma/ katarak/ degenerasi
                                        makula?</label>
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_glukoma"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="1"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_perubahan_berkemih"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="2"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_transfer_mandiri"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="0"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_mobilitas_mandiri"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="0"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select disabled class="form-select" name="risiko_jatuh_lansia_mobilitas_kursi_roda"
                                        onchange="updateConclusion('ontario')">
                                        <option value="">pilih</option>
                                        <option value="2"
                                ...
                                <div
                                    ...
                                    <input disabled type="hidden" name="risiko_jatuh_lansia_kesimpulan"
                            ...
                            <div class="mb-4">
                                ...
                                <div id="selectedTindakanList-risikojatuh" class="d-flex flex-column gap-2">
                                    @if (isset($asesmen->rmeAsesmenPerinatologyRisikoJatuh) &&
                                            $asesmen->rmeAsesmenPerinatologyRisikoJatuh->intervensi_risiko_jatuh)
                                        @php
                                        ...
                                        @foreach ($intervensiList as $index => $item)
                                            <div
                                                ...
                                                <span>{{ $item }}</span>
                                                <button type="button" class="btn btn-sm btn-danger delete-tindakan"
                                ...
                                <input disabled type="hidden" name="intervensi_risiko_jatuh_json"
                                    id="intervensi_risiko_jatuh_json"
                                    value='{{ isset($asesmen->rmeAsesmenPerinatologyRisikoJatuh) ? $asesmen->rmeAsesmenPerinatologyRisikoJatuh->intervensi_risiko_jatuh ?? '[]' : '[]' }}'>
                            </div>
                            <!-- Hidden input for lainnya -->
                            <input disabled type="hidden" id="skala_lainnya" name="risiko_jatuh_lainnya"
                                value="{{ $asesmen->rmeAsesmenPerinatologyRisikoJatuh->resiko_jatuh_lainnya ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="decubitus">
                        ...
                        <div class="form-group mb-4">
                            <select disabled class="form-select" id="skalaRisikoDekubitus"
                                name="jenis_skala_dekubitus">
                                <option value="" disabled>--Pilih Skala--</option>
                                <option value="norton"
                                    {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->jenis_skala == 1 ? 'selected' : '' }}>
                                    Skala Norton</option>
                                <option value="braden"
                                    {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->jenis_skala == 2 ? 'selected' : '' }}>
                                    Skala Braden</option>
                            </select>
                        </div>
                        ...
                        <div id="formNorton" class="decubitus-form" style="display: none;">
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="kondisi_fisik">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_fisik == '4' ? 'selected' : '' }}>
                                        Baik</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_fisik == '3' ? 'selected' : '' }}>
                                        Sedang</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_fisik == '2' ? 'selected' : '' }}>
                                        Buruk</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_fisik == '1' ? 'selected' : '' }}>
                                        Sangat Buruk</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="kondisi_mental">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_mental == '4' ? 'selected' : '' }}>
                                        Sadar</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_mental == '3' ? 'selected' : '' }}>
                                        Apatis</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_mental == '2' ? 'selected' : '' }}>
                                        Bingung</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_kondisi_mental == '1' ? 'selected' : '' }}>
                                        Stupor</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="norton_aktivitas">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_aktivitas == '4' ? 'selected' : '' }}>
                                        Aktif</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_aktivitas == '3' ? 'selected' : '' }}>
                                        Jalan dengan bantuan</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_aktivitas == '2' ? 'selected' : '' }}>
                                        Terbatas di kursi</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_aktivitas == '1' ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="norton_mobilitas">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_mobilitas == '4' ? 'selected' : '' }}>
                                        Bebas bergerak</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_mobilitas == '3' ? 'selected' : '' }}>
                                        Agak terbatas</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_mobilitas == '2' ? 'selected' : '' }}>
                                        Sangat terbatas</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_mobilitas == '1' ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="inkontinensia">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_inkontenesia == '4' ? 'selected' : '' }}>
                                        Tidak ada</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_inkontenesia == '3' ? 'selected' : '' }}>
                                        Kadang-kadang</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_inkontenesia == '2' ? 'selected' : '' }}>
                                        Biasanya urin</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->norton_inkontenesia == '1' ? 'selected' : '' }}>
                        ...
                        <div id="formBraden" class="decubitus-form" style="display: none;">
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="persepsi_sensori">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_persepsi == '1' ? 'selected' : '' }}>
                                        Keterbatasan Penuh</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_persepsi == '2' ? 'selected' : '' }}>
                                        Sangat Terbatas</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_persepsi == '3' ? 'selected' : '' }}>
                                        Keterbatasan Ringan</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_persepsi == '4' ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="kelembapan">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_kelembapan == '1' ? 'selected' : '' }}>
                                        Selalu Lembap</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_kelembapan == '2' ? 'selected' : '' }}>
                                        Umumnya Lembap</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_kelembapan == '3' ? 'selected' : '' }}>
                                        Kadang-Kadang Lembap</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_kelembapan == '4' ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                <label class="form-label">Aktivitas</label>
                                <select disabled class="form-select bg-light" name="braden_aktivitas">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_aktivitas == '1' ? 'selected' : '' }}>
                                        Total di Tempat Tidur</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_aktivitas == '2' ? 'selected' : '' }}>
                                        Dapat Duduk</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_aktivitas == '3' ? 'selected' : '' }}>
                                        Berjalan Kadang-kadang</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_aktivitas == '4' ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                <label class="form-label">Mobilitas</label>
                                <select disabled class="form-select bg-light" name="braden_mobilitas">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_mobilitas == '1' ? 'selected' : '' }}>
                                        Tidak Mampu Bergerak Sama sekali</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_mobilitas == '2' ? 'selected' : '' }}>
                                        Sangat Terbatas</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_mobilitas == '3' ? 'selected' : '' }}>
                                        Tidak Ada Masalah</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_mobilitas == '4' ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="nutrisi">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_nutrisi == '1' ? 'selected' : '' }}>
                                        Sangat Buruk</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_nutrisi == '2' ? 'selected' : '' }}>
                                        Kurang Menucukup</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_nutrisi == '3' ? 'selected' : '' }}>
                                        Mencukupi</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_nutrisi == '4' ? 'selected' : '' }}>
                                        Sangat Baik</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select disabled class="form-select bg-light" name="pergesekan">
                                    <option value="" disabled>--Pilih--</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_pergesekan == '1' ? 'selected' : '' }}>
                                        Bermasalah</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_pergesekan == '2' ? 'selected' : '' }}>
                                        Potensial Bermasalah</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyResikoDekubitus)->braden_pergesekan == '3' ? 'selected' : '' }}>
                                        Keterbatasan Ringan</option>
                                </select>
                            </div>
                    ...
                    <div class="section-separator" id="status_gizi">
                        ...
                        <div class="form-group mb-4">
                            <select disabled class="form-select" name="gizi_jenis" id="nutritionAssessment">
                                <option value="">--Pilih--</option>
                                <option value="1"
                                    {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_jenis == 1 ? 'selected' : '' }}>
                                    Malnutrition Screening Tool (MST)</option>
                                <option value="2"
                                    {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_jenis == 2 ? 'selected' : '' }}>
                                    The Mini Nutritional Assessment (MNA)</option>
                                <option value="3"
                                    {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_jenis == 3 ? 'selected' : '' }}>
                                    Strong Kids (1 bln - 18 Tahun)</option>
                                <option value="5"
                                    {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_jenis == 5 ? 'selected' : '' }}>
                        ...
                        <div id="mst" class="assessment-form" style="display: none;">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Apakah pasien mengalami penurunan BB yang tidak diinginkan dalam
                                    6 bulan terakhir?</label>
                                <select disabled class="form-select" name="gizi_mst_penurunan_bb">
                                    <option value="">pilih</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_penurunan_bb == '0' ? 'selected' : '' }}>
                                        Tidak ada penurunan Berat Badan (BB)</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_penurunan_bb == '2' ? 'selected' : '' }}>
                                        Tidak yakin/ tidak tahu/ terasa baju lebi longgar</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_penurunan_bb == '3' ? 'selected' : '' }}>
                                        Ya ada penurunan BB</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Jika jawaban di atas "Ya ada penurunan BB", berapa penurunan BB
                                    tersebut?</label>
                                <select disabled class="form-select" name="gizi_mst_jumlah_penurunan_bb">
                                    <option value="0">pilih</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_jumlah_penurunan_bb == '1' ? 'selected' : '' }}>
                                        1-5 kg</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_jumlah_penurunan_bb == '2' ? 'selected' : '' }}>
                                        6-10 kg</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_jumlah_penurunan_bb == '3' ? 'selected' : '' }}>
                                        11-15 kg</option>
                                    <option value="4"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_jumlah_penurunan_bb == '4' ? 'selected' : '' }}>
                                        >15 kg</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Apakah asupan makan berkurang karena tidak nafsu makan?</label>
                                <select disabled class="form-select" name="gizi_mst_nafsu_makan_berkurang">
                                    <option value="">pilih</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_nafsu_makan_berkurang == '1' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_nafsu_makan_berkurang == '0' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Pasien didiagnosa khusus seperti: DM, Cancer (kemoterapi),
                                    Geriatri, GGk (hemodialisis), Penurunan Imun</label>
                                <select disabled class="form-select" name="gizi_mst_diagnosis_khusus">
                                    <option value="">pilih</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_diagnosis_khusus == '1' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_diagnosis_khusus == '0' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                            </div>
                            <!-- Nilai -->
                            <div id="mstConclusion" class="risk-indicators mt-4">
                                ...
                                <input disabled type="hidden" name="gizi_mst_kesimpulan" id="gizi_mst_kesimpulan"
                                    value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_kesimpulan }}">
                            </div>
                        </div>
                        ...
                        <div id="mna" class="assessment-form" style="display: none;">
                            ...
                            <div class="mb-3">
                                <label class="form-label">
                                    Apakah pasien mengalami penurunan asupan makanan selama 3 bulan terakhir karena hilang
                                    selera makan, masalah pencernaan, kesulitan mengunyah atau menelan?
                                </label>
                                disabled <select class="form-select" name="gizi_mna_penurunan_asupan_3_bulan">
                                    <option value="">--Pilih--</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_penurunan_asupan_3_bulan == '0' ? 'selected' : '' }}>
                                        Mengalami penurunan asupan makanan yang parah</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_penurunan_asupan_3_bulan == '1' ? 'selected' : '' }}>
                                        Mengalami penurunan asupan makanan sedang</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_penurunan_asupan_3_bulan == '2' ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select disabled class="form-select" name="gizi_mna_kehilangan_bb_3_bulan">
                                    <option value="">-- Pilih --</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kehilangan_bb_3_bulan == '0' ? 'selected' : '' }}>
                                        Kehilangan BB lebih dari 3 Kg</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kehilangan_bb_3_bulan == '1' ? 'selected' : '' }}>
                                        Tidak tahu</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kehilangan_bb_3_bulan == '2' ? 'selected' : '' }}>
                                        Kehilangan BB antara 1 s.d 3 Kg</option>
                                    <option value="3"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kehilangan_bb_3_bulan == '3' ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select disabled class="form-select" name="gizi_mna_mobilisasi">
                                    <option value="">-- Pilih --</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_mobilisasi == '0' ? 'selected' : '' }}>
                                        Hanya di tempat tidur atau kursi roda</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_mobilisasi == '1' ? 'selected' : '' }}>
                                        Dapat turun dari tempat tidur tapi tidak dapat jalan-jalan</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_mobilisasi == '2' ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select disabled class="form-select" name="gizi_mna_stress_penyakit_akut">
                                    <option value="">-- Pilih --</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_stress_penyakit_akut == '0' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_stress_penyakit_akut == '1' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select disabled class="form-select" name="gizi_mna_status_neuropsikologi">
                                    <option value="">-- Pilih --</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_status_neuropsikologi == '0' ? 'selected' : '' }}>
                                        Demensia atau depresi berat</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_status_neuropsikologi == '1' ? 'selected' : '' }}>
                                        Demensia ringan</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_status_neuropsikologi == '2' ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled type="number" name="gizi_mna_berat_badan" class="form-control"
                                    id="mnaWeight" min="1" step="0.1"
                                    placeholder="Masukkan berat badan dalam Kg"
                                    value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_berat_badan }}">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Berapa Tinggi Badan (TB) pasien? (cm)</label>
                                <input disabled type="number" name="gizi_mna_tinggi_badan" class="form-control"
                                    id="mnaHeight" min="1" step="0.1"
                                    placeholder="Masukkan tinggi badan dalam cm"
                                    value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_tinggi_badan }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled type="number" name="gizi_mna_imt" class="form-control bg-light"
                                    id="mnaBMI" readonly placeholder="IMT akan terhitung otomatis"
                                    value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_imt }}">
                            </div>

                            <!-- Kesimpulan -->
                            <div id="mnaConclusion" class="risk-indicators mt-4">
                                <div class="alert alert-info mb-3"
                                    style="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kesimpulan ? 'display: none;' : '' }}">
                                    Silakan isi semua parameter di atas untuk melihat kesimpulan
                                </div>
                                <div class="alert alert-success"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kesimpulan ?? '', 'Tidak Beresiko') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: Total Skor ≥ 12 (Tidak Beresiko Malnutrisi)
                                </div>
                                <div class="alert alert-warning"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kesimpulan ?? '', 'Beresiko') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: Total Skor ≤ 11 (Beresiko Malnutrisi)
                                </div>
                                <input type="hidden" name="gizi_mna_kesimpulan" id="gizi_mna_kesimpulan"
                                    value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_kesimpulan }}">
                            </div>
                        </div>
                        ...
                        <div id="strong-kids" class="assessment-form" style="display: none;">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Apakah anak tampa kurus kehilangan lemak subkutan, kehilangan
                                    massa otot, dan/ atau wajah cekung?</label>
                                <select disabled class="form-select" name="gizi_strong_status_kurus">
                                    <option value="">pilih</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_status_kurus == '1' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_status_kurus == '0' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Apakah terdapat penurunan BB selama satu bulan terakhir (untuk
                                    semua usia)?
                                    (berdasarkan penilaian objektif data BB bila ada/penilaian subjektif dari orang tua
                                    pasien ATAU tidak ada peningkatan berat badan atau tinggi badan (pada bayi < 1 tahun)
                                        selama 3 bulan terakhir)</label>
                                        <select disabled class="form-select" name="gizi_strong_penurunan_bb">
                                            <option value="">pilih</option>
                                            <option value="1"
                                                {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_penurunan_bb == '1' ? 'selected' : '' }}>
                                                Ya</option>
                                            <option value="0"
                                                {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_penurunan_bb == '0' ? 'selected' : '' }}>
                                                Tidak</option>
                                        </select>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Apakah salah satu dari hal berikut ini ada? <br>
                                    - Diare berlabihan (>= 5 kali perhari) dan/atau muntah(>3 klai perhari) selama 1-3 hari
                                    terakhir
                                    ...
                                    selang)</label>
                                <select disabled class="form-select" name="gizi_strong_gangguan_pencernaan">
                                    <option value="">pilih</option>
                                    <option value="1"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_gangguan_pencernaan == '1' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_gangguan_pencernaan == '0' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Apakah terdapat penyakit atau keadaan yang mengakibatkan pasien
                                    berisiko mengalaman mainutrisi? <br>
                                    <a href="#"><i>Lihat penyakit yang berisiko malnutrisi</i></a></label>
                                <select disabled class="form-select" name="gizi_strong_penyakit_berisiko">
                                    <option value="">pilih</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_penyakit_berisiko == '2' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_penyakit_berisiko == '0' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                            </div>
                            <!-- Nilai -->
                            <div id="strongKidsConclusion" class="risk-indicators mt-4">
                                <div class="alert alert-success"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_kesimpulan ?? '', 'rendah') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: 0 (Beresiko rendah)</div>
                                <div class="alert alert-warning"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_kesimpulan ?? '', 'sedang') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: 1-3 (Beresiko sedang)</div>
                                <div class="alert alert-danger"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_kesimpulan ?? '', 'Tinggi') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: 4-5 (Beresiko Tinggi)</div>
                                <input type="hidden" name="gizi_strong_kesimpulan" id="gizi_strong_kesimpulan"
                                    value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_strong_kesimpulan }}">
                            </div>
                        </div>
                        ...
                        <div id="nrs" class="assessment-form" style="display: none;">
                            ...
                            <div class="mb-3">
                                ...
                                <select disabled class="form-select" name="gizi_nrs_jatuh_saat_masuk_rs">
                                    <option value="">pilih</option>
                                    <option value="2"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_nrs_jatuh_saat_masuk_rs == '2' ? 'selected' : '' }}>
                                        Ya</option>
                                    <option value="0"
                                        {{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_nrs_jatuh_saat_masuk_rs == '0' ? 'selected' : '' }}>
                                        Tidak</option>
                                </select>
                            </div>
                            ...
                            <div id="nrsConclusion" class="risk-indicators mt-4">
                                <div class="alert alert-success"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_nrs_kesimpulan ?? '', 'rendah') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: Beresiko rendah</div>
                                <div class="alert alert-warning"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_nrs_kesimpulan ?? '', 'sedang') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: Beresiko sedang</div>
                                <div class="alert alert-danger"
                                    style="{{ strpos(optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_nrs_kesimpulan ?? '', 'Tinggi') !== false ? '' : 'display: none;' }}">
                                    Kesimpulan: Beresiko Tinggi</div>
                                <input type="hidden" name="gizi_nrs_kesimpulan" id="gizi_nrs_kesimpulan"
                                    value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_nrs_kesimpulan }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section-separator" id="status-fungsional">
                        ...
                        <div class="mb-4">
                            <label class="form-label">Pilih jenis Skala Pengkajian Aktivitas Harian (ADL) sesuai kondisi
                                pasien</label>
                            <select disabled class="form-select" name="skala_fungsional" id="skala_fungsional">
                                <option value="" selected disabled>Pilih Skala Fungsional</option>
                                <option value="1"
                                    {{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) && $asesmen->rmeAsesmenPerinatologyStatusFungsional->jenis_skala == 1 ? 'selected' : '' }}>
                                    Pengkajian Aktivitas Harian</option>
                                <option value="2"
                                    {{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) && $asesmen->rmeAsesmenPerinatologyStatusFungsional->jenis_skala == 2 ? 'selected' : '' }}>
                                    Lainnya</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="text" class="form-control" id="adl_total" name="adl_total"
                                readonly
                                value="{{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) ? $asesmen->rmeAsesmenPerinatologyStatusFungsional->nilai_skala_adl : '' }}">
                        </div>

                        <div class="form-group">
                            <label style="min-width: 200px;">Kesimpulan Fungsional</label>
                            <div id="adl_kesimpulan"
                                class="alert {{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) &&
                                $asesmen->rmeAsesmenPerinatologyStatusFungsional->kesimpulan_fungsional
                                    ? (strpos($asesmen->rmeAsesmenPerinatologyStatusFungsional->kesimpulan_fungsional, 'Ketergantungan Total') !== false
                                        ? 'alert-danger'
                                        : (strpos($asesmen->rmeAsesmenPerinatologyStatusFungsional->kesimpulan_fungsional, 'Ketergantungan Berat') !==
                                        false
                                            ? 'alert-warning'
                                            : (strpos(
                                                $asesmen->rmeAsesmenPerinatologyStatusFungsional->kesimpulan_fungsional,
                        ...
                        <input type="hidden" id="adl_makan" name="adl_makan"
                            value="{{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) ? $asesmen->rmeAsesmenPerinatologyStatusFungsional->makan : '' }}">
                        <input type="hidden" id="adl_berjalan" name="adl_berjalan"
                            value="{{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) ? $asesmen->rmeAsesmenPerinatologyStatusFungsional->berjalan : '' }}">
                        <input type="hidden" id="adl_mandi" name="adl_mandi"
                            value="{{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) ? $asesmen->rmeAsesmenPerinatologyStatusFungsional->mandi : '' }}">
                        <input type="hidden" id="adl_kesimpulan_value" name="adl_kesimpulan_value"
                            value="{{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) ? $asesmen->rmeAsesmenPerinatologyStatusFungsional->kesimpulan_fungsional : '' }}">
                    </div>
                    ...
                    <div class="section-separator" id="kebutuhan-edukasi">
                        ...
                        <div class="form-group">
                            ...
                            <select disabled class="form-select" name="gaya_bicara">
                                <option value="" disabled>--Pilih--</option>
                                <option value="normal"
                                    {{ $asesmen->rmeAsesmenPerinatology->gaya_bicara == 'normal' ? 'selected' : '' }}>
                                    Normal</option>
                                <option value="lambat"
                                    {{ $asesmen->rmeAsesmenPerinatology->gaya_bicara == 'lambat' ? 'selected' : '' }}>
                                    Lambat</option>
                                <option value="cepat"
                                    {{ $asesmen->rmeAsesmenPerinatology->gaya_bicara == 'cepat' ? 'selected' : '' }}>Cepat
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select disabled class="form-select" name="bahasa_sehari_hari">
                                <option value="" disabled>--Pilih--</option>
                                <option value="Bahasa Indonesia"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Bahasa Indonesia' ? 'selected' : '' }}>
                                    Bahasa Indonesia</option>
                                <option value="Aceh"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Aceh' ? 'selected' : '' }}>Aceh
                                </option>
                                <option value="Batak"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Batak' ? 'selected' : '' }}>Batak
                                </option>
                                <option value="Minangkabau"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Minangkabau' ? 'selected' : '' }}>
                                    Minangkabau</option>
                                <option value="Melayu"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Melayu' ? 'selected' : '' }}>Melayu
                                </option>
                                <option value="Sunda"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Sunda' ? 'selected' : '' }}>Sunda
                                </option>
                                <option value="Jawa"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Jawa' ? 'selected' : '' }}>Jawa
                                </option>
                                <option value="Madura"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Madura' ? 'selected' : '' }}>Madura
                                </option>
                                <option value="Bali"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Bali' ? 'selected' : '' }}>Bali
                                </option>
                                <option value="Sasak"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Sasak' ? 'selected' : '' }}>Sasak
                                </option>
                                <option value="Banjar"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Banjar' ? 'selected' : '' }}>Banjar
                                </option>
                                <option value="Bugis"
                                    {{ $asesmen->rmeAsesmenPerinatology->bahasa == 'Bugis' ? 'selected' : '' }}>Bugis
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select disabled class="form-select" name="perlu_penerjemah">
                                <option value="" disabled>--Pilih--</option>
                                <option value="ya"
                                    {{ $asesmen->rmeAsesmenPerinatology->perlu_penerjemahan == 'ya' ? 'selected' : '' }}>
                                    Ya</option>
                                <option value="tidak"
                                    {{ $asesmen->rmeAsesmenPerinatology->perlu_penerjemahan == 'tidak' ? 'selected' : '' }}>
                                    Tidak</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select disabled class="form-select" name="hambatan_komunikasi">
                                <option value="" disabled>--Pilih--</option>
                                <option value="tidak_ada"
                                    {{ $asesmen->rmeAsesmenPerinatology->hambatan_komunikasi == 'tidak_ada' ? 'selected' : '' }}>
                                    Tidak Ada</option>
                                <option value="pendengaran"
                                    {{ $asesmen->rmeAsesmenPerinatology->hambatan_komunikasi == 'pendengaran' ? 'selected' : '' }}>
                                    Gangguan Pendengaran</option>
                                <option value="bicara"
                                    {{ $asesmen->rmeAsesmenPerinatology->hambatan_komunikasi == 'bicara' ? 'selected' : '' }}>
                                    Gangguan Bicara</option>
                                <option value="bahasa"
                                    {{ $asesmen->rmeAsesmenPerinatology->hambatan_komunikasi == 'bahasa' ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select disabled class="form-select" name="media_disukai">
                                <option value="" disabled>--Pilih--</option>
                                <option value="cetak"
                                    {{ $asesmen->rmeAsesmenPerinatology->media_disukai == 'cetak' ? 'selected' : '' }}>
                                    Media Cetak</option>
                                <option value="video"
                                    {{ $asesmen->rmeAsesmenPerinatology->media_disukai == 'video' ? 'selected' : '' }}>
                                    Video</option>
                                <option value="diskusi"
                                    {{ $asesmen->rmeAsesmenPerinatology->media_disukai == 'diskusi' ? 'selected' : '' }}>
                                    Diskusi Langsung</option>
                                <option value="demonstrasi"
                                    {{ $asesmen->rmeAsesmenPerinatology->media_disukai == 'demonstrasi' ? 'selected' : '' }}>
                                    Demonstrasi</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select disabled class="form-select" name="tingkat_pendidikan">
                                <option value="" disabled>--Pilih--</option>
                                <option value="SD"
                                    {{ $asesmen->rmeAsesmenPerinatology->tingkat_pendidikan == 'SD' ? 'selected' : '' }}>
                                    SD</option>
                                <option value="SMP"
                                    {{ $asesmen->rmeAsesmenPerinatology->tingkat_pendidikan == 'SMP' ? 'selected' : '' }}>
                                    SMP</option>
                                <option value="SMA"
                                    {{ $asesmen->rmeAsesmenPerinatology->tingkat_pendidikan == 'SMA' ? 'selected' : '' }}>
                                    SMA</option>
                                <option value="Diploma"
                                    {{ $asesmen->rmeAsesmenPerinatology->tingkat_pendidikan == 'Diploma' ? 'selected' : '' }}>
                                    Diploma</option>
                                <option value="Sarjana"
                                    {{ $asesmen->rmeAsesmenPerinatology->tingkat_pendidikan == 'Sarjana' ? 'selected' : '' }}>
                                    Sarjana</option>
                                <option value="Tidak Sekolah"
                                    {{ $asesmen->rmeAsesmenPerinatology->tingkat_pendidikan == 'Tidak Sekolah' ? 'selected' : '' }}>
                    ...
                    <div class="section-separator" id="discharge-planning">
                        ...
                        <div class="mb-4">
                            <label class="form-label">Pasien / Keluarga Memerlukan Keterampilan Khusus Setelah
                                Pulang</label>
                            <select disabled class="form-select" name="keterampilan_khusus">
                                <option value="" disabled>--Pilih--</option>
                                <option value="ya"
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select" name="alat_bantu">
                                <option value="" disabled>--Pilih--</option>
                                <option value="ya"
                        ...
                        <div class="mb-4">
                            ...
                            <select disabled class="form-select" name="nyeri_kronis">
                                <option value="" disabled>--Pilih--</option>
                                <option value="ya"
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input disabled type="text" class="form-control" name="perkiraan_hari"
                                    placeholder="hari"
                            ...
                            <div class="col-md-6">
                                ...
                                <input disabled type="date" class="form-control" name="tanggal_pulang"
                                ...
                                <tbody>
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input rencana-perawatan-row-1"
                                                    type="checkbox" name="diagnosis[]" value="bersihan_jalan_nafas"
                                                ...
                                                <label class="form-check-label" for="diag_bersihan_jalan_nafas">
                                                    <strong>Bersihan jalan nafas tidak efektif</strong> berhubungan dengan
                                                    spasme jalan nafas...
                                                </label>
                                            </div>
                                            <div class="form-check mb-2">
                                            ...
                                            <div id="rencana_bersihan_jalan_nafas" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_bersihan_jalan_nafas[]" value="monitor_pola_nafas"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Monitor bunyi nafas tambahan ( mengi,
                                                        wheezing, rhonchi )</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Monitor sputum ( jumlah, warna, aroma
                                                        )</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Pertahankan kepatenan jalan nafas
                                                        dengan head-tilt dan chin -lift ( jaw – thrust jika curiga trauma
                                                        servikal ) </label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_bersihan_jalan_nafas[]" value="fisioterapi_dada"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_bersihan_jalan_nafas[]" value="penghisapan_lendir"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_bersihan_jalan_nafas[]" value="berikan_oksigen"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Anjuran asupan cairan 2000 ml/hari,
                                                        jika tidak kontra indikasi</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_bersihan_jalan_nafas[]"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Kolaborasi pemberian bronkodilator,
                                                        ekspektoran, mukolitik, jika perlu</label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_penurunan_curah_jantung">
                                                    <strong>Penurunan curah jantung</strong> berhubungan dengan perubahan
                                                    irama jantung, perubahan frekuensi jantung.
                                                </label>
                                            </div>
                                        </td>
                                        <td class="align-top">
                                            <div id="rencana_penurunan_curah_jantung" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi tanda/gejala primer
                                                        penurunan curah jantung (meliputi dipsnea, kelelahan, edema)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_penurunan_curah_jantung[]"
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Monitor aritmia (kelainan irama dan
                                                        frekuensi)</label>
                                                </div>
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Berikan oksigen untuk mempertahankan
                                                        saturasi oksigen >94%</label>
                                                </div>
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Ajarkan pasien dan keluarga mengukur
                                                        intake dan output cairan harian</label>
                                                </div>
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_perfusi_perifer">
                                                    ...
                                                    kurang terpapar informasi tentang proses penyakit (misal: diabetes
                                                    melitus, hiperlipidmia).
                                                </label>
                                            </div>
                                        </td>
                                        <td class="align-top">
                                            <div id="rencana_perfusi_perifer" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi faktor risiko gangguan
                                                        sirkulasi (diabetes, perokok, hipertensi, kadar kolesterol
                                                        tinggi)</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_perfusi_perifer[]" value="monitor_suhu_kemerahan"
                                                    ...
                                                    <label class="form-check-label">Monitor suhu, kemerahan, nyeri atau
                                                        bengkak pada ekstremitas.</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Hindari pengukuran tekanan darah pada
                                                        ekstremitas dengan keterbatasan perfusi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_perfusi_perifer[]" value="anjurkan_berolahraga"
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Anjurkan minum obat pengontrol tekanan
                                                        darah secara teratur</label>
                                                </div>
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_hipovolemia">
                                                    <strong>Hipovolemia</strong> berhubungan dengan kehilangan cairan aktif,
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_hipovolemia" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Periksa tanda dan gejala hipovolemia
                                                        (frekuensi nadi meningkat, nadi teraba lemah, tekanan darah penurun,
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Anjurkan memperbanyak asupan cairan
                                                        oral</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipovolemia[]" value="hindari_perubahan_posisi"
                                                    ...
                                                    <label class="form-check-label">Anjurkan menghindari perubahan posisi
                                                        mendadak</label>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_hipervolemia" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipervolemia[]" value="periksa_tanda_hipervolemia"
                                                    ...
                                                    <label class="form-check-label">Periksa tanda dan gejala hipervolemia
                                                        (dipsnea, edema, suara nafas tambahan)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Monitor status hemodinamik (frekuensi
                                                        jantung, tekanan darah)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipervolemia[]"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Timbang berat badan setiap hari pada
                                                        waktu yang sama</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipervolemia[]" value="tinggi_kepala_tempat_tidur"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipervolemia[]" value="ajarkan_mengukur_cairan"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipervolemia[]" value="ajarkan_membatasi_cairan"
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_diare">
                                                    <strong>Diare</strong> berhubungan dengan inflamasi gastrointestinal,
                                                    iritasi gastrointestinal, proses infeksi, malabsorpsi.
                                                </label>
                                            </div>
                                        </td>
                                        <td class="align-top">
                                            <div id="rencana_diare" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi penyebab diare (inflamasi
                                                        gastrointestinal, iritasi gastrointestinal, proses infeksi,
                                                        malabsorpsi, ansietas, stres, efek samping obat)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_diare[]" value="identifikasi_gejala_invaginasi"
                                                    ...
                                                    <label class="form-check-label">Identifikasi riwayat gejala invaginasi
                                                        (tangisan keras, kepucatan pada bayi)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Monitor warna, volume, frekuensi dan
                                                        konsistensi tinja</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Monitor tanda dan gejala hipovolemia
                                                        (takikardi, nadi teraba lemah, tekanan darah turun, turgor kulit
                                                        turun, mukosa mulit kering, CRT melambat, BB menurun)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Monitor iritasi dan ulserasi kulit di
                                                        daerah perianal</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Berikan asupan cairan oral (larutan
                                                        garam gula, oralit, pedialyte)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Anjurkan menghindari makanan pembentuk
                                                        gas, pedas dan mengandung laktosa</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox"
                                                    name="diagnosis[]" value="retensi_urine" id="diag_retensi_urine"
                                                ...
                                                <label class="form-check-label" for="diag_retensi_urine">
                                                    <strong>Retensi urine</strong> berhubungan dengan peningkatan tekanan
                                                    uretra, kerusakan arkus refleks, Blok spingter, disfungsi neurologis
                                                    (trauma, penyakit saraf), efek agen farmakologis (atropine, belladona,
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_retensi_urine" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi tanda dan gejala retensi
                                                        atau inkontinensia urine</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_retensi_urine[]"
                                                    ...
                                                    <label class="form-check-label">Identifikasi faktor yang menyebabkan
                                                        retensi atau inkontinensia urine</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_retensi_urine[]" value="monitor_eliminasi_urine"
                                                    ...
                                                    <label class="form-check-label">Monitor eliminasi urine (frekuensi,
                                                        konsistensi, aroma, volume dan warna)</label>
                                                </div>
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Ambil sampel urine tengah (midstream)
                                                        atau kultur</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_retensi_urine[]" value="ajarkan_mengukur_asupan"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_retensi_urine[]" value="ajarkan_tanda_berkemih"
                                                    ...
                                                    <label class="form-check-label">Ajarkan mengenali tanda berkemih dan
                                                        waktu yang tepat untuk berkemih</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Ajarkan minum yang cukup, jika tidak
                                                        ada kontraindikasi</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Anjurkan mengurangi minum menjelang
                                                        tidur</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_retensi_urine[]" value="kolaborasi_supositoria"
                                                    ...
                                                    <label class="form-check-label">Kolaborasi pemberian obat supositoria
                                                        uretra, jika perlu</label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_nyeri_akut" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_nyeri_akut[]" value="identifikasi_lokasi_nyeri"
                                                    ...
                                                    <label class="form-check-label">Identifikasi lokasi, karakteristik,
                                                        durasi, frekuensi, kualitas, intensitas nyeri</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_nyeri_akut[]" value="identifikasi_faktor_nyeri"
                                                    ...
                                                    <label class="form-check-label">Identifikasi faktor yang memperberat
                                                        dan memperingan nyeri</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_nyeri_akut[]"
                                                    ...
                                                    <label class="form-check-label">Identifikasi pengetahuan dan keyaninan
                                                        tentang nyeri</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_nyeri_akut[]" value="identifikasi_pengaruh_budaya"
                                                    ...
                                                    <label class="form-check-label">Identifikasi pengaruh budaya terhadap
                                                        respon nyeri</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_nyeri_akut[]" value="monitor_keberhasilan_terapi"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Berikan teknik nonfarmakologis untuk
                                                        mengurangi rasa nyeri (TENS, hipnosis, akupresur, terapi musik,
                                                        biofeedback, terapi pijat, aromaterapi, teknik imajinasi terbimbing,
                                                        kompres hangat/dingin, terapi bermain)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Kontrol lingkungan yang memperberat
                                                        rasa nyeri (suhu ruangan, pencahayaan, kebisingan)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_nyeri_akut[]" value="pertimbangkan_strategi_nyeri"
                                                    ...
                                                    <label class="form-check-label">Pertimbangkan jenis dan sumber nyeri
                                                        dalam pemilihan strategi meredakan nyeri</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Jelaskan penyebab, periode, dan pemicu
                                                        nyeri</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Anjurkan menggunakan analgetik secara
                                                        tepat</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Ajarkan teknik nonfarmakologis untuk
                                                        mengurangin rasa nyeri</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Kolaborasi pemberian analgetik, jika
                                                        perlu</label>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_nyeri_kronis" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_nyeri_kronis[]" value="anjurkan_analgetik_kronis"
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_hipertermia">
                                                    <strong>Hipertermia</strong> b.d dehidrasi, terpapar lingkungan panas,
                                                    peroses penyakit (infeksi, kanker), ketidaksesuaian pakaian dengan suhu
                                            ...
                                            <div id="rencana_hipertermia" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi penyebab hipertermia
                                                        (dehidrasi, terpapar lingkungan panas, penggunaan inkubator)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipertermia[]" value="monitor_kadar_elektrolit"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipertermia[]" value="sediakan_lingkungan_dingin"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipertermia[]" value="ganti_linen_hiperhidrosis"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Lakukan pendinginan eksternal (selimut
                                                ...
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_hipertermia[]" value="berikan_oksigen_hipertermia"
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_gangguan_mobilitas_fisik">
                                                    ...
                                                    diatas persentil ke-75 seusai usia, efek agen farmakologis, program
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_gangguan_mobilitas_fisik" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Indetifikasi toleransi fisik melakukan
                                                        ambulasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Monitor frekuensi jantung dan tekanan
                                                        darah sebelum memulai ambulasi</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_gangguan_mobilitas_fisik[]"
                                                    ...
                                                    <label class="form-check-label">Monitor kondiri umum selama melakukan
                                                        ambulasi</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Fasilitasi aktivitas ambulasi dengan
                                                        alat bantu (tongkat, kruk)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_gangguan_mobilitas_fisik[]"
                                                    ...
                                                    <label class="form-check-label">Fasilitasi melakukan mobilisasi fisik,
                                                        jika perlu</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Ajarkan ambulasi sederhana yang harus
                                                        dilakukan (berjalan dari tempat tidur ke kursi roda, berjalan dari
                                                        tempat tidur ke kamar mandi, berjalan sesuai toleransi)</label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                <input disabled class="form-check-input" type="checkbox"
                                                    name="diagnosis[]" value="resiko_infeksi" id="diag_resiko_infeksi"
                                                ...
                                                <label class="form-check-label" for="diag_resiko_infeksi">
                                                    ...
                                                    patogen lingkungan, ketidakadekuatan pertahanan tubuh primer (gangguan
                                                    persitaltik, kerusakan integritas kulit, perubahan sekresi PH, penurunan
                                                    ...
                                                    sekunder (penurunan hemoglobin, imununosupresi, leukopenia, supresi
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_resiko_infeksi" style="display: none;">
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Monitor tanda dan gejala infeksi lokal
                                                        dan sistemik</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_infeksi[]" value="perawatan_kulit_edema"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Cuci tangan sebelum dan sesudah kontak
                                                        dengan pasien dan lingkungan pasien</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_infeksi[]"
                                                    ...
                                                    <label class="form-check-label">Pertahankan teknik aseptik pada pasien
                                                        beresiko tinggi</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Ajarkan cara memeriksa kondisi luka
                                                        atau luka operasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_infeksi[]" value="anjurkan_asupan_nutrisi"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Kolaborasi pemberian imunisasi, jika
                                                        perlu.</label>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_konstipasi">
                                                    <strong>Konstipasi</strong> b.d penurunan motilitas gastrointestinal,
                                                    ketidaadekuatan pertumbuhan gigi, ketidakcukupan diet, ketidakcukupan
                                                    asupan serat, ketidakcukupan asupan serat, ketidakcukupan asupan cairan,
                                                    aganglionik (penyakit Hircsprung), kelemahan otot abdomen.
                                                </label>
                                            </div>
                                        </td>
                                        <td class="align-top">
                                            <div id="rencana_konstipasi" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Periksa pergerakan usus, karakteristik
                                                        feses</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_konstipasi[]" value="anjurkan_diet_tinggi_serat"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Lakukan evakuasi feses secara manual,
                                                        jika perlu</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_konstipasi[]" value="jelaskan_etiologi_konstipasi"
                                                    ...
                                                    <label class="form-check-label">Jelaskan etiologi masalah dan alasan
                                                        tindakan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Anjurkan peningkatan asupan cairan,
                                                        jika tidak ada kontraindikasi</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_konstipasi[]" value="ajarkan_mengatasi_konstipasi"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Kolaborasi penggunaan obat pencahar,
                                                        jika perlu</label>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_resiko_jatuh">
                                                    <strong>Resiko jatuh</strong> b.d usia lebih dari sama dengan 65 tahun
                                                    (pada dewasa) atau kurang dari sama dengan 2 tahun (pada anak) Riwayat
                                                    jatuh, anggota gerak bawah prostesis (buatan), penggunaan alat bantu
                                                    berjalan, penurunan tingkat kesadaran, perubahan fungsi kognitif,
                                                    lingkungan tidak aman (licin, gelap, lingkungan asing), kondisi pasca
                                                    ...
                                                    gangguan penglihatan (glaukoma, katarak, ablasio retina, neuritis
                                                    optikus), neuropati, efek agen farmakologis (sedasi, alkohol, anastesi
                                                    umum).
                                                </label>
                                            </div>
                                        </td>
                                        <td class="align-top">
                                            <div id="rencana_resiko_jatuh" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi faktor risiko jatuh (usia
                                                        >65 tahun, penurunan tingkat kesadaran, defisit kognitif, hipotensi
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Identifikasi risiko jatuh setidaknya
                                                        sekali setiap shift atau sesuai dengan kebijakan institusi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_jatuh[]"
                                                    ...
                                                    <label class="form-check-label">Identifikasi faktor lingkungan yang
                                                        meningkatkan risiko jatuh (lantai licin, penerangan kurang)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Hitung risiko jatuh dengan menggunakan
                                                        skala (Fall Morse Scale, humpty dumpty scale), jika perlu</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_jatuh[]"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Orientasikan ruangan pada pasien dan
                                                        keluarga</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Pastikan roda tempat tidur dan kursi
                                                        roda selalu dalam kondisi terkunci</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Atur tempat tidur mekanis pada posisi
                                                        terendah</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_jatuh[]" value="tempatkan_dekat_perawat"
                                                    ...
                                                    <label class="form-check-label">Tempatkan pasien berisiko tinggi jatuh
                                                        dekat dengan pantauan perawat dari nurse station</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Dekatkan bel pemanggil dalam jangkauan
                                                        pasien</label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_jatuh[]" value="anjurkan_memanggil_perawat"
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Anjurkan menggunakan alas kaki yang
                                                        tidak licin</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_jatuh[]" value="anjurkan_berkonsentrasi"
                                                    ...
                                                    <label class="form-check-label">Anjurkan berkonsentrasi untuk menjaga
                                                        keseimbangan tubuh</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                        name="rencana_resiko_jatuh[]" value="anjurkan_melebarkan_jarak"
                                                    ...
                                                    <label class="form-check-label">Anjurkan melebarkan jarak kedua kaki
                                                        untuk meningkatkan keseimbangan saat berdiri</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                    ...
                                                    <label class="form-check-label">Ajarkan cara menggunakan bel pemanggil
                                                        untuk memanggil perawat</label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td class="align-top">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label" for="diag_gangguan_integritas_kulit">
                                                    ...
                                                    iritatif, suhu lingkungan yang ekstream, faktor mekanis (penekanan pada
                                                    tonjolan tulang, gesekan) atau faktor elektris (elektrodiatermi, energi
                                                    listrik bertegangan tinggi), efek samping terapi radiasi, kelembapan,
                                                    proses penuaan, neuropati perifer, perubahan pigmentasi, perubahan
                                                    hormonal, kurang terpapar informasi tentang upaya
                                        ...
                                        <td class="align-top">
                                            <div id="rencana_gangguan_integritas_kulit" style="display: none;">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">Lepaskan balutan dan plester secara
                                                        perlahan</label>
                                                </div>
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox"
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label">Anjurkan mengkonsumsi makanan tinggi
                                                        kalori dan protein</label>
                                                </div>
