    ...
    <div class="row">
                ...
                <div class="card w-100 h-100">
                    <div class="card-body">
                        <div class="px-3">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <h4 class="header-asesmen"><span class="text-info">Detail</span> Asesmen Awal Keperawatan Perinatology</h4>
                                    <p>
                            ...
                            <div class="px-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-3" style="width: 100%;">
                                            <input type="date" class="form-control" name="tanggal_masuk"
                                                id="tanggal_masuk"
                                                value="{{ Carbon\Carbon::parse($asesmen->waktu_asesmen)->format('Y-m-d') }}" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-3" style="width: 100%;">
                                            <input type="date" class="form-control" name="tanggal_lahir"
                                                value="{{ Carbon\Carbon::parse($asesmen->tgl_lahir_bayi)->format('Y-m-d') }}" disabled>
                                            <input type="time" class="form-control" name="jam_lahir"
                                                value="{{ Carbon\Carbon::parse($asesmen->tgl_lahir_bayi)->format('H:i') }}" disabled>
                                        </div>
                                    </div>
                                ...
                                <div class="section-separator" id="pemeriksaan-fisik">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex gap-3" style="width: 100%;">
                                            <div class="flex-grow-1">
                                                ...
                                                <input disabled type="number" class="form-control" name="saturasi_o2_tanpa"
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <input disabled type="number" class="form-control" name="saturasi_o2_dengan"
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input disabled type="text" class="form-control" name="tanda_lahir" placeholder="sebutkan" value="{{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->tanda_lahir ?? '' }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <input disabled type="text" class="form-control" name="down_score" value="{{ $asesmen->rmeAsesmenPerinatologyPemeriksaanLanjut->down_score }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input disabled type="number" class="form-control" name="waktu_pengisian_kapiler" placeholder="detik"
                                ...
                                <div class="section-separator" id="risiko_jatuh">
                                    ...
                                    <div id="skala_ontarioForm" class="risk-form" style="display: none;">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select disabled class="form-select" name="risiko_jatuh_lansia_transfer_bantuan_nyata"
                                                onchange="updateConclusion('ontario')">
                                                <option value="">pilih</option>
                                                <option value="2"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Tidak dapat duduk dengan seimbang, perlu bantuan
                                                total</label>
                                            <select disabled class="form-select" name="risiko_jatuh_lansia_transfer_bantuan_total"
                                                onchange="updateConclusion('ontario')">
                                                <option value="">pilih</option>
                                                <option value="3"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select disabled class="form-select" name="risiko_jatuh_lansia_mobilitas_imobilisasi"
                                                onchange="updateConclusion('ontario')">
                                                <option value="">pilih</option>
                                                <option value="3"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input disabled type="hidden" name="intervensi_risiko_jatuh_json" id="intervensi_risiko_jatuh_json" value='{{ isset($asesmen->rmeAsesmenPerinatologyRisikoJatuh) ? ($asesmen->rmeAsesmenPerinatologyRisikoJatuh->intervensi_risiko_jatuh ?? "[]") : "[]" }}'>
                                    </div>
                                    <!-- Hidden input for lainnya -->
                                    <input disabled type="hidden" id="skala_lainnya" name="risiko_jatuh_lainnya" value="{{ $asesmen->rmeAsesmenPerinatologyRisikoJatuh->resiko_jatuh_lainnya ?? '' }}">
                                    </div>
                                </div>
                                ...
                                <div class="section-separator" id="decubitus">
                                    ...
                                    <div class="form-group mb-4">
                                        <select disabled class="form-select" id="skalaRisikoDekubitus" name="jenis_skala_dekubitus">
                                ...
                                <div class="section-separator" id="status_gizi">
                                    ...
                                    <div id="mst" class="assessment-form" style="display: none;">
                                        ...
                                        <div id="mstConclusion" class="risk-indicators mt-4">
                                            ...
                                            <input disabled type="hidden" name="gizi_mst_kesimpulan" id="gizi_mst_kesimpulan" value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mst_kesimpulan }}">
                                        </div>
                                    </div>
        ...
        disabled                                     <select class="form-select" name="gizi_mna_penurunan_asupan_3_bulan">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input disabled type="number" name="gizi_mna_berat_badan" class="form-control" id="mnaWeight" min="1" step="0.1" placeholder="Masukkan berat badan dalam Kg" value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_berat_badan }}">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Berapa Tinggi Badan (TB) pasien? (cm)</label>
                                            <input disabled type="number" name="gizi_mna_tinggi_badan" class="form-control" id="mnaHeight" min="1" step="0.1" placeholder="Masukkan tinggi badan dalam cm" value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_tinggi_badan }}">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input disabled type="number" name="gizi_mna_imt" class="form-control bg-light" id="mnaBMI" readonly placeholder="IMT akan terhitung otomatis" value="{{ optional($asesmen->rmeAsesmenPerinatologyGizi)->gizi_mna_imt }}">
                                        </div>
                                ...
                                <div class="section-separator" id="status-fungsional">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input disabled type="text" class="form-control" id="adl_total" name="adl_total" readonly value="{{ isset($asesmen->rmeAsesmenPerinatologyStatusFungsional) ? $asesmen->rmeAsesmenPerinatologyStatusFungsional->nilai_skala_adl : '' }}">
                                        </div>
