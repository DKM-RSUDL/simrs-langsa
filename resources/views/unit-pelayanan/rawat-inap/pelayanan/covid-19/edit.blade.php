    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="covid_form" method="POST"
                action="{{ route('rawat-inap.covid-19.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $covidData->id]) }}">
                @csrf
                @method('PUT')
        ...
        $(document).ready(function() {
            ...
            function updateConclusion() {
                ...
                if (!demam && !ispa && !ispaBerat && kontakErat) {
                    ...
                    title.html('<i class="fas fa-exclamation-triangle text-danger"></i> SUSPEK');
                    desc.html('• Gejala No.4 DAN tidak ada penyebab lain berdasarkan gambaran klinis yang meyakinkan');
                    kesimpulanInput.val('suspek');
            ...
            // Trigger conclusion update when checkboxes change
