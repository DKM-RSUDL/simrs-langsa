    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-start mb-3 no-print">
                ...
                <a href="{{ route('rawat-inap.covid-19.edit', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $covidData->id]) }}"
                    class="btn-edit me-2">
                    <i class="ti-pencil"></i> Edit Data
                </a>
                <a href="{{ route('rawat-inap.covid-19.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $covidData->id]) }}"
