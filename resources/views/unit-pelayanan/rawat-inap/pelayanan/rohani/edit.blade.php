    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="edukasiForm" method="POST"
                action="{{ route('rawat-inap.rohani.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, encrypt($rohani->id)]) }}">
                @csrf
                @method('put')
                ...
                <div class="d-flex justify-content-center">
                    <div class="card w-100 h-100 shadow-sm">
                        <div class="card-body">
                            <div class="px-3">
                                <h4 class="header-asesmen">Edit Permintaan Pelayanan Rohani</h4>
                            </div>
                                ...
                                <div class="section-separator">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal" id="tanggal" class="form-control date"
                                            value="{{ date('Y-m-d', strtotime($rohani->tanggal)) }}" required readonly>
                                    </div>
                                ...
                                <div class="section-separator" id="identitas-keluarga">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keluarga_nama" id="keluarga_nama" class="form-control"
                                            value="{{ $rohani->keluarga_nama }}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keluarga_tempat_lahir" id="keluarga_tempat_lahir"
                                            class="form-control" value="{{ $rohani->keluarga_tempat_lahir }}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keluarga_tgl_lahir" id="keluarga_tgl_lahir"
                                            ...
                                            value="{{ date('Y-m-d', strtotime($rohani->keluarga_tgl_lahir)) }}" required
                                            readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keluarga_hubungan_pasien" id="keluarga_hubungan_pasien"
                                            class="form-control" value="{{ $rohani->keluarga_hubungan_pasien }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="keluarga_agama" style="min-width: 200px;">Agama</label>
                                        <select name="keluarga_agama" id="keluarga_agama" class="form-select" required>
                                            <option value="">--Pilih--</option>
                                            ...
                                            <div class="">
                                                <div class="">
                                                    <input type="checkbox" name="kondisi_pasien[]" id="pre_operasi"
                                                        ...
                                                        @checked(in_array('Pre Operasi Besar', $rohani->kondisi_pasien))>
                                                    <label for="pre_operasi">Pre Operasi Besar</label>
                                                </div>
                                                <div class="">
                                                    <input type="checkbox" name="kondisi_pasien[]" id="kritis"
                                                        class="form-check-input" value="Kritis"
                                                        @checked(in_array('Kritis', $rohani->kondisi_pasien))>
                                                ...
                                                <div class="">
                                                    <input type="checkbox" name="kondisi_pasien[]" id="menjelang_ajal"
                                                        ...
                                                        @checked(in_array('Menjelang Ajal', $rohani->kondisi_pasien))>
                                                ...
                                                <div class="">
                                                    <input type="checkbox" name="kondisi_pasien[]" id="penyakit_terminal"
                                                        ...
                                                        @checked(in_array('Penyakit terminal: Kanker, GGK stage V, HIV', $rohani->kondisi_pasien))>
                                                ...
                                                <div class="">
                                                    <input type="checkbox" name="kondisi_pasien[]" id="pasien_cemas"
                                                        ...
                                                        @checked(in_array('Pasien cemas/ gangguan emosi', $rohani->kondisi_pasien))>
                                                    <label for="pasien_cemas">Pasien cemas/ gangguan emosi</label>
                                                </div>
                                                <div class="">
                                                    <input type="checkbox" name="kondisi_pasien[]"
                                                        id="perhatian_keluarga" class="form-check-input"
                                                        value="Kurang mendapat perhatian keluarga"
                                                        @checked(in_array('Kurang mendapat perhatian keluarga', $rohani->kondisi_pasien))>
