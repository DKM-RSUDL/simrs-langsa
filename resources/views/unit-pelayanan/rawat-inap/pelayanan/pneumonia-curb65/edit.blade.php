    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form id="curb65Form" method="POST"
                action="{{ route('rawat-inap.pneumonia.curb-65.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, $dataMedis->tgl_masuk, $dataMedis->urut_masuk, $dataCurb65->id]) }}">
                @csrf
                @method('PUT')

                <div class="card shadow-sm">
                    <div class="card-body">
                        <h4 class="text-center text-primary fw-bold mb-4">Edit Form Kriteria CURB-65</h4>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="tanggal_implementasi"
                                                id="tanggal_implementasi" value="{{ date('Y-m-d', strtotime($dataCurb65->tanggal_implementasi)) }}" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label text-muted small">Jam</label>
                                            <input type="time" class="form-control" name="jam_implementasi"
                                                id="jam_implementasi" value="{{ date('H:i', strtotime($dataCurb65->jam_implementasi)) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                ...
                                                <td class="text-center">
                                                    <div class="form-check">
                                                        <input class="form-check-input curb-item" type="checkbox" 
                                                               ...
                                                               {{ $dataCurb65->respiratory ? 'checked' : '' }}>
                                                ...
                                                <td class="text-center">
                                                    <div class="form-check">
                                                        <input class="form-check-input curb-item" type="checkbox" 
                                                               ...
                                                               {{ $dataCurb65->blood_pressure ? 'checked' : '' }}>
                                            ...
                                            <tr class="table-warning">
                                                ...
                                                <td class="text-center">
                                                    <span id="total_skor" class="fw-bold fs-5 text-primary">{{ $dataCurb65->total_skor }}</span>
                                                    <input type="hidden" name="total_skor" id="total_skor_input" value="{{ $dataCurb65->total_skor }}">
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="card bg-light border-0 mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div id="current_result" class="mt-3 p-3 border rounded bg-white">
                                    <h6 class="fw-bold text-primary mb-2">Hasil Penilaian:</h6>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <strong>Skor:</strong> <span id="display_skor" class="text-primary">{{ $dataCurb65->total_skor }}</span>
                                        </div>
                                        <div class="col-md-3">
                                            <strong>Mortalitas:</strong> <span id="display_mortalitas">{{ $dataCurb65->mortalitas }}</span>
                                        </div>
                                        <div class="col-md-3">
                                            <strong>Resiko:</strong> 
                                            <span id="display_resiko">
                                                @php
                                        ...
                                        <div class="col-md-3">
                                            <strong>Perawatan:</strong> <span id="display_perawatan">{{ $dataCurb65->perawatan_disarankan }}</span>
                                        </div>
                                    </div>
                                </div>

                                <!-- Hidden inputs for interpretation -->
                                <input type="hidden" name="mortalitas" id="mortalitas_input" value="{{ $dataCurb65->mortalitas }}">
                                <input type="hidden" name="level_resiko" id="level_resiko_input" value="{{ $dataCurb65->level_resiko }}">
                                <input type="hidden" name="perawatan_disarankan" id="perawatan_input" value="{{ $dataCurb65->perawatan_disarankan }}">
                            </div>
                        </div>

                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-success px-4" id="simpan">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initial calculation on page load to show existing data
    calculateTotal();
});
</script>
@endpush