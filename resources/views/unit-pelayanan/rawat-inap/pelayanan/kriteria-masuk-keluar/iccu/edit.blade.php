            ...
            <div class="iccu-form">
                <div class="form-header mt-3">
                    <h5>
                        ...
                        Edit Formulir Kriteria Masuk/Keluar ICCU
                    </h5>
                </div>

                <form
                    action="{{ route('rawat-inap.kriteria-masuk-keluar.iccu.update', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $dataIccu->id]) }}"
                    method="post">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <input type="date" name="iccu_tanggal" id="iccu_tanggal" class="form-control"
                                        value="{{ $dataIccu->iccu_tanggal ? date('Y-m-d', strtotime($dataIccu->iccu_tanggal)) : date('Y-m-d') }}">
                                </div>
                                <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <input type="time" name="iccu_jam" id="iccu_jam" class="form-control"
                                        value="{{ $dataIccu->iccu_jam ? date('H:i', strtotime($dataIccu->iccu_jam)) : date('H:i') }}">
                                </div>
                            </div>
                        </div>
