    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between">
                ...
                <a href="{{ route('rawat-inap.kriteria-masuk-keluar.iccu.print-pdf', [$dataMedis->kd_unit, $dataMedis->kd_pasien, date('Y-m-d', strtotime($dataMedis->tgl_masuk)), $dataMedis->urut_masuk, $dataIccu->id]) }}"
            ...
            <div class="iccu-form">
                ...
                <div class="kriteria-section mt-5">
                    ...
                    <!-- Nilai Tanda Vital -->
                    <div class="kriteria-item {{ $dataIccu->vita_kriteria_masuk ? 'checked' : '' }}"
                        data-kriteria="tanda_vital">
                    ...
                    <!-- Infark Miocard Akut -->
                    <div class="kriteria-item {{ $dataIccu->infark_kriteria_masuk ? 'checked' : '' }}"
                        data-kriteria="infark_miocard">
                        <div class="kriteria-desc">
                    ...
                    <!-- Angina Tidak Stabil -->
                    <div class="kriteria-item {{ $dataIccu->angina_kriteria_masuk ? 'checked' : '' }}"
                        data-kriteria="angina_tidak_stabil">
                        <div class="kriteria-desc">
                    ...
                    <!-- Aritmia yang gawat -->
                    <div class="kriteria-item {{ $dataIccu->aritmia_kriteria_masuk ? 'checked' : '' }}"
                        data-kriteria="aritmia_gawat">
                        <div class="kriteria-desc">
                    ...
                    <div class="kriteria-item sub-kriteria {{ $dataIccu->blokav_kriteria_masuk ? 'checked' : '' }}"
                        data-kriteria="blok_av">
                        <div class="kriteria-desc">
                        ...
                        <div class="kriteria-item sub-kriteria {{ $dataIccu->sinus_kriteria_masuk ? 'checked' : '' }}"
                            data-kriteria="sinus_bradikardi">
                            <div class="kriteria-desc">
                            ...
                            <div class="kriteria-item sub-kriteria {{ $dataIccu->sick_kriteria_masuk ? 'checked' : '' }}"
                                data-kriteria="sick_sinus">
                                <div class="kriteria-desc">
                            ...
                            <div class="kriteria-item sub-kriteria {{ $dataIccu->takikardia_kriteria_masuk ? 'checked' : '' }}"
                                data-kriteria="takikardia_artrial">
                                <div class="kriteria-desc">
                            ...
                            <div class="kriteria-item sub-kriteria {{ $dataIccu->fibrilasi_kriteria_masuk ? 'checked' : '' }}"
                                data-kriteria="fibrilasi_ventrikuler">
                                <div class="kriteria-desc">
                            ...
                            <!-- Edema Paru Akut -->
                            <div class="kriteria-item {{ $dataIccu->edema_kriteria_masuk ? 'checked' : '' }}"
                                data-kriteria="edema_paru">
                                <div class="kriteria-desc">
                                    4. Edema Paru Akut
                                </div>
                                <div class="kriteria-checkbox">
                            ...
                            <!-- Miokarditis -->
                            <div class="kriteria-item {{ $dataIccu->miokarditis_kriteria_masuk ? 'checked' : '' }}"
                                data-kriteria="miokarditis">
                                <div class="kriteria-desc">
                                    5. Miokarditis
                                </div>
                                <div class="kriteria-checkbox">
                            ...
                            <!-- Krisis Hipertensi -->
                            <div class="kriteria-item {{ $dataIccu->krisis_kriteria_masuk ? 'checked' : '' }}"
                                data-kriteria="krisis_hipertensi">
                                <div class="kriteria-desc">
                                    6. Krisis Hipertensi
                                </div>
                                <div class="kriteria-checkbox">
                            ...
                            <div class="kriteria-item {{ $dataIccu->penyakit_kriteria_masuk ? 'checked' : '' }}"
                                data-kriteria="penyakit_jantung_lain">
                                <div class="kriteria-desc">
                        ...
                        <div class="kriteria-section">
                            ...
                            <!-- Kriteria Keluar 1 -->
                            <div class="kriteria-item {{ $dataIccu->dirawat_kriteria_keluar ? 'checked' : '' }}"
                                data-kriteria="tidak_perlu_intensive">
                                <div class="kriteria-desc">
                                    1. Dianggap keadaan penderita sudah tidak memerlukan perawatan intensive dan dapat
                            ...
                            <!-- Kriteria Keluar 2 -->
                            <div class="kriteria-item {{ $dataIccu->kegawatan_kriteria_keluar ? 'checked' : '' }}"
                                data-kriteria="bukan_penyakit_jantung">
                                <div class="kriteria-desc">
                            ...
                            <!-- Kriteria Keluar 3 -->
                            <div class="kriteria-item {{ $dataIccu->penderita_kriteria_keluar ? 'checked' : '' }}"
                                data-kriteria="penyakit_menular">
                                <div class="kriteria-desc">
                            ...
                            <!-- Kriteria Keluar 4 -->
                            <div class="kriteria-item {{ $dataIccu->iccu_kriteria_keluar ? 'checked' : '' }}"
                                data-kriteria="meninggal">
                                <div class="kriteria-desc">
                            ...
                            <!-- Kriteria Keluar 5 -->
                            <div class="kriteria-item {{ $dataIccu->rslain_kriteria_keluar ? 'checked' : '' }}"
                                data-kriteria="pindah_rs_lain">
                                <div class="kriteria-desc">
                            ...
                            <!-- Kriteria Keluar 6 -->
                            <div class="kriteria-item {{ $dataIccu->rsud_kriteria_keluar ? 'checked' : '' }}"
                                data-kriteria="pulang_paksa">
                                <div class="kriteria-desc">
