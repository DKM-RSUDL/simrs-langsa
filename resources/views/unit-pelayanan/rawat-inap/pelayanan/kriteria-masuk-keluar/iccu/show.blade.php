        ...
        <div class="col-md-9">
            ...
            <div class="iccu-form">
                ...
                <div class="kriteria-section mt-5">
                    ...
                    <!-- Infark Miocard Akut -->
                    <div class="kriteria-item sub-kriteria {{ $dataIccu->infark_kriteria_masuk ? 'checked' : '' }}"
                    ...
                    <!-- Angina Tidak Stabil -->
                    <div class="kriteria-item sub-kriteria {{ $dataIccu->angina_kriteria_masuk ? 'checked' : '' }}"
