...
<!-- Modal untuk Edit -->
<div class="modal fade modal-add-labor" id="addLaborModal{{ str_replace('.', '_', $laborPK->kd_order) }}" tabindex="-1"
    aria-labelledby="addLaborModalLabel{{ str_replace('.', '_', $laborPK->kd_order) }}" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form
                action="{{ route('rawat-inap.lab-patologi-klinik.update', [
                ...
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="addLaborModalLabel{{ $laborPK->kd_order }}">
...
@push('js')
    <script>
        ...
        $('.modal-add-labor').on('shown.bs.modal', function(e) {
            let $this = $(this);
