    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="operasiInput" placeholder="Masukkan nama/jenis operasi">
                ...
                <div id="modalOperasiList" class="d-flex flex-column gap-2">
                    <div id="modalEmptyStateOperasi" class="border border-dashed border-secondary rounded p-3 text-center text-muted">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="simpanOperasi">Simpan</button>
            </div>
        </div>
    </div>
</div>
...
function updateModalOperasiList() {
    ...
    const modalEmptyState = document.getElementById('modalEmptyStateOperasi');
...
function saveOperasi() {
    if (tempOperasiList.length > 0) {
        ...
        // Close modal
        const modal = bootstrap.Modal.getInstance(document.getElementById('operasiModal'));
        modal.hide();
    }
}
